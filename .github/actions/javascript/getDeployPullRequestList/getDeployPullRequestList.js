...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var inputTag_1, isProductionDeploy_1, deployEnv, priorTag_1, foundCurrentRelease_1, prList, mobileExpensifyPRList, error_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, GitUtils_1.default.getPullRequestsDeployedBetween(priorTag_1, inputTag_1, CONST_1.default.APP_REPO)];
                case 2:
                    prList = _a.sent();
                    console.log('Found the pull request list: ', prList);
                    core.setOutput('PR_LIST', prList);
                    mobileExpensifyPRList = [];
                    _a.label = 3;
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, GitUtils_1.default.getPullRequestsDeployedBetween(priorTag_1, inputTag_1, CONST_1.default.MOBILE_EXPENSIFY_REPO)];
                case 4:
                    mobileExpensifyPRList = _a.sent();
                ...
                case 5:
                    ...
                    if (process.env.GITHUB_REPOSITORY !== "".concat(CONST_1.default.GITHUB_OWNER, "/").concat(CONST_1.default.APP_REPO)) {
                        ...
                        console.error('Failed to fetch Mobile-Expensify PRs from main repository:', error_1);
