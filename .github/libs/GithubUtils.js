...
var GithubUtils = /** @class */ (function () {
    ...
    GithubUtils.generateStagingDeployCashBodyAndAssignees = function (tag, PRList, PRListMobileExpensify, verifiedPRList, verifiedPRListMobileExpensify, deployBlockers, resolvedDeployBlockers, resolvedInternalQAPRs, isFirebaseChecked, isGHStatusChecked) {
        ...
        return this.fetchAllPullRequests(PRList.map(function (pr) { return _this.getPullRequestNumberFromURL(pr); }))
            ...
            return Promise.all(internalQAPRs.map(function (pr) { return _this.getPullRequestMergerLogin(pr.number).then(function (mergerLogin) { return ({ url: pr.html_url, mergerLogin: mergerLogin }); }); })).then(function (results) {
                ...
                var verifiedOrNoQAPRs = new Set(__spreadArray(__spreadArray(__spreadArray([], verifiedPRList, true), verifiedPRListMobileExpensify, true), noQAPRs, true));
    ...
    GithubUtils.getFileContents = function (path_1) {
        return __awaiter(this, arguments, void 0, function (path, ref) {
            var data;
            if (ref === void 0) { ref = CONST_1.default.DEFAULT_BASE_REF; }
    ...
    GithubUtils.getPullRequestChangedSVGFileNames = function (pullRequestNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var files;
            return __generator(this, function (_a) {
                files = this.paginate(this.octokit.pulls.listFiles, {
                    owner: CONST_1.default.GITHUB_OWNER,
                    repo: CONST_1.default.APP_REPO,
                    pull_number: pullRequestNumber,
                    per_page: 100,
                }, function (response) { return response.data.filter(function (file) { return file.filename.endsWith('.svg') && (file.status === 'added' || file.status === 'modified'); }).map(function (file) { return file.filename; }); });
    ...
    GithubUtils.getPullRequestDiff = function (pullRequestNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.internalOctokit.request('GET /repos/{owner}/{repo}/pulls/{pull_number}', {
                                owner: CONST_1.default.GITHUB_OWNER,
                                repo: CONST_1.default.APP_REPO,
                                pull_number: pullRequestNumber,
                                mediaType: {
