...
var reactNativeOnyxMock = __assign(__assign({}, react_native_onyx_1.default), { connectWithoutView: function (mapping) {
        ...
        return react_native_onyx_1.default.connectWithoutView(__assign(__assign({}, mapping), { callback: callback }));
