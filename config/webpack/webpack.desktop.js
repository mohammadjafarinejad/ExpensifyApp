...
var getConfiguration = function (environment) {
    ...
    var mainProcessConfig = {
        ...
        externals: __spreadArray(__spreadArray(__spreadArray([], Object.keys(package_json_1.dependencies), true), Object.keys(package_json_1.optionalDependencies), true), ['fsevents'], false),
        node: {
            /**
