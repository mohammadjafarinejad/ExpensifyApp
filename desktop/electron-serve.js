...
function electronServe(options) {
    ...
    var handler = function (request) { return __awaiter(_this, void 0, void 0, function () {
        var filePath, resolvedPath, mimeType, data, _a;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    resolvedPath = (_b = (_c.sent())) !== null && _b !== void 0 ? _b : path_1.default.join(mandatoryOptions.directory, "".concat(mandatoryOptions.file, ".html"));
                ...
                case 3:
                    data = _c.sent();
                    return [2 /*return*/, new Response(Buffer.from(data), {
                            headers: {
