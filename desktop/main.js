...
var locationPermission_1 = require("@src/libs/getCurrentPosition/locationPermission");
...
var MAC_PERMISSION_STATUSES = {
    AUTHORIZED: 'authorized',
    DENIED: 'denied',
    RESTRICTED: 'restricted',
    NOT_DETERMINED: 'not determined',
};
var macGetAuthStatusPromise;
var logMacPermissionsWarning = function (message, error) {
    if (error instanceof Error) {
        electron_log_1.default.warn(message, error.message);
    }
    else if (typeof error === 'string') {
        electron_log_1.default.warn(message, error);
    }
    else {
        electron_log_1.default.warn(message);
    }
};
var loadMacGetAuthStatus = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (!!macGetAuthStatusPromise) return [3 /*break*/, 4];
                if (!(process.platform !== 'darwin')) return [3 /*break*/, 1];
                macGetAuthStatusPromise = Promise.resolve(undefined);
                return [3 /*break*/, 4];
            case 1:
                _c.trys.push([1, 3, , 4]);
            ...
            case 2:
                macGetAuthStatusPromise = _b.apply(_a, [(_c.sent()).getAuthStatus]);
                return [3 /*break*/, 4];
            case 3:
                error_1 = _c.sent();
                logMacPermissionsWarning('node-mac-permissions not available, defaulting to denied:', error_1);
                return [2 /*return*/, undefined];
            case 4: return [2 /*return*/, macGetAuthStatusPromise];
        }
    });
}); };
var resolveLocationPermissionStatus = function (status) {
    switch (status) {
        case MAC_PERMISSION_STATUSES.AUTHORIZED:
            return locationPermission_1.LOCATION_PERMISSION_STATES.GRANTED;
        case MAC_PERMISSION_STATUSES.NOT_DETERMINED:
            return locationPermission_1.LOCATION_PERMISSION_STATES.PROMPT;
        case MAC_PERMISSION_STATUSES.DENIED:
        case MAC_PERMISSION_STATUSES.RESTRICTED:
        default:
            return locationPermission_1.LOCATION_PERMISSION_STATES.DENIED;
    }
};
...
var mainWindow = function () {
    ...
    return (electron_1.app
        ...
        electron_1.ipcMain.handle(ELECTRON_EVENTS_1.default.CHECK_LOCATION_PERMISSION, function () { return __awaiter(void 0, void 0, void 0, function () {
            var getAuthStatus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadMacGetAuthStatus()];
                    case 1:
                        getAuthStatus = _a.sent();
                        if (!getAuthStatus) {
                            return [2 /*return*/, locationPermission_1.LOCATION_PERMISSION_STATES.DENIED];
                        }
                        try {
                            return [2 /*return*/, resolveLocationPermissionStatus(getAuthStatus('location'))];
                        }
                        catch (error) {
                            electron_log_1.default.warn('node-mac-permissions threw while checking location permission, defaulting to denied:', error === null || error === void 0 ? void 0 : error.message);
                            return [2 /*return*/, locationPermission_1.LOCATION_PERMISSION_STATES.DENIED];
                        }
                        return [2 /*return*/];
                }
