...
var ChatGPTTranslator = /** @class */ (function (_super) {
    ...
    ChatGPTTranslator.prototype.performTranslation = function (targetLang, text, context) {
        return __awaiter(this, void 0, void 0, function () {
            var systemPrompt, attempt, result, fixedResult, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        result = _a.sent();
                        fixedResult = this.fixChineseBracketsInMarkdown(result);
                        if (this.validateTemplatePlaceholders(text, fixedResult) && this.validateTemplateHTML(text, fixedResult)) {
                            ...
                            return [2 /*return*/, fixedResult];
                        }
                        console.warn("\u26A0\uFE0F Translation for \"".concat(text, "\" failed validation (attempt ").concat(attempt + 1, "/").concat(ChatGPTTranslator.MAX_RETRIES + 1, ")"));
