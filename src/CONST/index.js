...
exports.FRAUD_PROTECTION_EVENT = exports.TASK_TO_FEATURE = exports.CONTINUATION_DETECTION_SEARCH_FILTER_KEYS = void 0;
...
var CONST = {
    ...
    POPOVER_ACCOUNT_SWITCHER_POSITION: {
        horizontal: 12 + variables_1.default.navigationTabBarSize,
        vertical: 72,
    },
    ...
    DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL: 'https://help.expensify.com/articles/new-expensify/reports-and-expenses/Create-an-Expense#how-do-i-enable-camera-access-for-mobile-browsers-so-i-can-take-photos-of-my-receipts',
    BANK_ACCOUNT_PERSONAL_DOCUMENTATION_INFO_URL: 'https://community.expensify.com/discussion/6983/faq-why-do-i-need-to-provide-personal-documentation-when-setting-up-updating-my-bank-account',
    ...
    COMPANY_CARDS_AMEX_COMMERCIAL_CARD_HELP: 'https://help.expensify.com/articles/new-expensify/connect-credit-cards/company-cards/Commercial-feeds#how-to-set-up-an-american-express-corporate-feed',
    ...
    OLDDOT_URLS: {
        ...
        POLICY_CONNECTIONS_URL_ENCODED: function (policyID) { return "policy?param=%7B%22policyID%22%3A%22".concat(policyID, "%22%7D#connections"); },
        SIGN_OUT: 'signout',
    ...
    POLICY: {
        ...
        CONNECTIONS: {
            ...
            AUTH_HELP_LINKS: {
                intacct: "https://help.expensify.com/articles/expensify-classic/connections/sage-intacct/Sage-Intacct-Troubleshooting#:~:text=First%20make%20sure%20that%20you,your%20company's%20Web%20Services%20authorizations.",
                netsuite: 'https://help.expensify.com/articles/expensify-classic/connections/netsuite/Netsuite-Troubleshooting#expensierror-ns0109-failed-to-login-to-netsuite-please-verify-your-credentials',
            },
            SYNC_STAGE_NAME: {
    ...
    AVATAR_CROP_MODAL: {
        ...
        CONTAINER_VERTICAL_MARGIN: variables_1.default.componentSizeNormal,
    },
    ...
    PLAID_EXCLUDED_COUNTRIES: ['IR', 'CU', 'SY', 'UA', 'KP'],
    PLAID_SUPPORT_COUNTRIES: ['US', 'CA', 'GB', 'AT', 'BE', 'DK', 'EE', 'FI', 'FR', 'DE', 'IE', 'IT', 'LV', 'LT', 'NL', 'NO', 'PL', 'PT', 'ES', 'SE'],
    ...
    EXCLUDE_FROM_LAST_VISITED_PATH: [SCREENS_1.default.NOT_FOUND, SCREENS_1.default.SAML_SIGN_IN, SCREENS_1.default.VALIDATE_LOGIN, SCREENS_1.default.MIGRATED_USER_WELCOME_MODAL.ROOT, SCREENS_1.default.MONEY_REQUEST.STEP_SCAN],
    CANCELLATION_TYPE: {
        MANUAL: 'manual',
        AUTOMATIC: 'automatic',
        NONE: 'none',
    ...
    get UPGRADE_FEATURE_INTRO_MAPPING() {
        ...
        return _a = {
            ...
            _a.taxCodes = {
                ...
                alias: 'tax-codes',
                name: 'Tax codes',
                title: 'workspace.upgrade.taxCodes.title',
            ...
            _a.companyCards = {
                ...
                alias: 'company-cards',
                name: 'Company Cards',
                title: 'workspace.upgrade.companyCards.title',
            ...
            _a.rules = {
                ...
                alias: 'rules',
                name: 'Rules',
                title: 'workspace.upgrade.rules.title',
            ...
            _a.perDiem = {
                ...
                alias: 'per-diem',
                name: 'Per diem',
                title: 'workspace.upgrade.perDiem.title',
            ...
            _a.travel = {
                ...
                alias: 'travel',
                name: 'Travel',
                title: 'workspace.upgrade.travel.title',
            ...
            _a.distanceRates = {
                ...
                name: 'Distance Rates',
                title: 'workspace.upgrade.distanceRates.title',
                description: 'workspace.upgrade.distanceRates.description',
                icon: 'CarIce',
            },
            _a.auditor = {
                id: 'auditor',
                alias: 'auditor',
                name: 'Auditor',
                title: 'workspace.upgrade.auditor.title',
                description: 'workspace.upgrade.auditor.description',
                icon: 'BlueShield',
            },
            _a.reports = {
                id: 'reports',
                alias: 'reports',
                name: 'Reports',
                title: 'workspace.upgrade.reports.title',
                description: 'workspace.upgrade.reports.description',
                icon: 'ReportReceipt',
            },
            _a;
    },
    ...
    CORPAY_FIELDS: {
        EXCLUDED_COUNTRIES: ['IR', 'CU', 'SY', 'UA', 'KP', 'RU'],
        EXCLUDED_CURRENCIES: ['IRR', 'CUP', 'SYP', 'UAH', 'KPW', 'RUB'],
        ...
        BANK_INFORMATION_FIELDS: ['bankName', 'bankAddressLine1', 'bankAddressLine2', 'bankCity', 'bankRegion', 'bankPostal', 'BeneficiaryBankBranchName'],
        ...
        SPECIAL_LIST_REGION_KEYS: ['bankRegion', 'accountHolderRegion'],
        SPECIAL_LIST_ADDRESS_KEYS: ['bankAddressLine1', 'accountHolderAddress1'],
        STEPS_NAME: {
    ...
    SKIPPABLE_COLLECTION_MEMBER_IDS: [String(DEFAULT_NUMBER_ID), '-1', 'undefined', 'null', 'NaN'],
...
var TASK_TO_FEATURE = (_q = {},
    _q[CONST.ONBOARDING_TASK_TYPE.SETUP_CATEGORIES] = CONST.POLICY.MORE_FEATURES.ARE_CATEGORIES_ENABLED,
    _q[CONST.ONBOARDING_TASK_TYPE.ADD_ACCOUNTING_INTEGRATION] = CONST.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED,
    _q[CONST.ONBOARDING_TASK_TYPE.CONNECT_CORPORATE_CARD] = CONST.POLICY.MORE_FEATURES.ARE_COMPANY_CARDS_ENABLED,
    _q[CONST.ONBOARDING_TASK_TYPE.SETUP_TAGS] = CONST.POLICY.MORE_FEATURES.ARE_TAGS_ENABLED,
    _q);
exports.TASK_TO_FEATURE = TASK_TO_FEATURE;
var FRAUD_PROTECTION_EVENT = {
...
exports.FRAUD_PROTECTION_EVENT = FRAUD_PROTECTION_EVENT;
