...
function Expensify() {
    ...
    var linkingChangeListener = (0, react_1.useRef)(null);
    ...
    var _h = (0, useOnyx_1.default)(ONYXKEYS_1.default.SESSION, { canBeMissing: true }), session = _h[0], sessionMetadata = _h[1];
    ...
    var _j = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_CHECKING_PUBLIC_ROOM, { initWithStoredValues: false, canBeMissing: true })[0], isCheckingPublicRoom = _j === void 0 ? true : _j;
    ...
    var _k = (0, useOnyx_1.default)(ONYXKEYS_1.default.STASHED_CREDENTIALS, { canBeMissing: true })[0], stashedCredentials = _k === void 0 ? CONST_1.default.EMPTY_OBJECT : _k;
    var stashedSession = (0, useOnyx_1.default)(ONYXKEYS_1.default.STASHED_SESSION, { canBeMissing: true })[0];
    (0, useDebugShortcut_1.default)();
    (0, usePriorityChange_1.default)();
    var _l = (0, react_1.useState)(null), initialUrl = _l[0], setInitialUrl = _l[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        Fullstory_1.default.getSessionId().then(function (sessionId) {
            if (!sessionId) {
                return;
            }
            Sentry.setContext(CONST_1.default.TELEMETRY.CONTEXT_FULLSTORY, { sessionId: sessionId });
        });
    }, [userMetadata]);
    ...
    (0, react_1.useEffect)(function () {
        if ((0, isLoadingOnyxValue_1.default)(sessionMetadata)) {
            return;
        }
        setTimeout(function () {
        ...
        react_native_1.Linking.getInitialURL().then(function (url) {
            setInitialUrl(url);
            if (url) {
                (0, Link_1.openReportFromDeepLink)(url, currentOnboardingPurposeSelected, currentOnboardingCompanySize, onboardingInitialPath, allReports, isAuthenticated);
            }
            else {
        ...
        linkingChangeListener.current = react_native_1.Linking.addEventListener('url', function (state) {
            var isCurrentlyAuthenticated = (0, Session_1.hasAuthToken)();
            (0, Link_1.openReportFromDeepLink)(state.url, currentOnboardingPurposeSelected, currentOnboardingCompanySize, onboardingInitialPath, allReports, isCurrentlyAuthenticated);
        });
    ...
    }, [sessionMetadata === null || sessionMetadata === void 0 ? void 0 : sessionMetadata.status]);
    ...
    (0, react_1.useEffect)(function () {
        ...
        (0, Delegate_1.disconnect)({ stashedCredentials: stashedCredentials, stashedSession: stashedSession });
    }, [(_a = account === null || account === void 0 ? void 0 : account.delegatedAccess) === null || _a === void 0 ? void 0 : _a.delegates, (_b = account === null || account === void 0 ? void 0 : account.delegatedAccess) === null || _b === void 0 ? void 0 : _b.delegate, stashedCredentials, stashedSession]);
