...
function AccountSwitcher(_a) {
    ...
    var _h = (0, useOnyx_1.default)(ONYXKEYS_1.default.STASHED_CREDENTIALS, { canBeMissing: true })[0], stashedCredentials = _h === void 0 ? CONST_1.default.EMPTY_OBJECT : _h;
    ...
    var _j = (0, react_1.useState)(false), shouldShowDelegatorMenu = _j[0], setShouldShowDelegatorMenu = _j[1];
    var _k = (0, react_1.useState)(false), shouldShowOfflineModal = _k[0], setShouldShowOfflineModal = _k[1];
    ...
    var _l = (0, ProductTrainingContext_1.useProductTrainingContext)(CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.ACCOUNT_SWITCHER, isScreenFocused && canSwitchAccounts), shouldShowProductTrainingTooltip = _l.shouldShowProductTrainingTooltip, renderProductTrainingTooltip = _l.renderProductTrainingTooltip, hideProductTrainingTooltip = _l.hideProductTrainingTooltip;
        ...
        var delegatorMenuItems = delegators
            ...
            return createBaseMenuItem(personalDetails, error, {
                ...
                onSelected: function () {
                    ...
                    (0, Delegate_1.connect)({ email: email, delegatedAccess: account === null || account === void 0 ? void 0 : account.delegatedAccess, credentials: credentials, session: session, activePolicyID: activePolicyID });
                },
            });
        });
    ...
    var hideDelegatorMenu = function () {
        ...
        (0, Delegate_1.clearDelegatorErrors)({ delegatedAccess: account === null || account === void 0 ? void 0 : account.delegatedAccess });
    };
    return (<>
