...
var STATE_MACHINE = (_a = {},
    ...
    _a[States.POPOVER_OPEN] = (_c = {},
        ...
        _c[Actions.TRANSITION_POPOVER] = States.TRANSITIONING_POPOVER,
        _c),
    ...
    _a[States.KEYBOARD_POPOVER_OPEN] = (_f = {},
        ...
        _f[Actions.CLOSE_POPOVER] = States.KEYBOARD_CLOSING_POPOVER,
        _f[Actions.OPEN_KEYBOARD] = States.KEYBOARD_OPEN,
        _f[Actions.TRANSITION_POPOVER] = States.TRANSITIONING_POPOVER_KEYBOARD_OPEN,
        _f),
    _a[States.KEYBOARD_POPOVER_CLOSED] = (_g = {},
        _g[Actions.OPEN_KEYBOARD] = States.KEYBOARD_OPEN,
        _g),
    _a[States.KEYBOARD_CLOSING_POPOVER] = (_h = {},
        _h[Actions.OPEN_KEYBOARD] = States.KEYBOARD_OPEN,
        _h[Actions.END_TRANSITION] = States.KEYBOARD_OPEN,
        _h),
    _a[States.TRANSITIONING_POPOVER] = (_j = {},
        _j[Actions.CLOSE_POPOVER] = States.TRANSITIONING_POPOVER_DONE,
        _j),
    _a[States.TRANSITIONING_POPOVER_KEYBOARD_OPEN] = (_k = {},
        _k[Actions.CLOSE_POPOVER] = States.TRANSITIONING_POPOVER_KEYBOARD_OPEN_DONE,
        _k),
    _a[States.TRANSITIONING_POPOVER_DONE] = (_l = {},
        _l[Actions.CLOSE_POPOVER] = States.POPOVER_CLOSED,
        _l[Actions.MEASURE_POPOVER] = States.POPOVER_OPEN,
        _l[Actions.POPOVER_ANY_ACTION] = States.POPOVER_CLOSED,
        _l[Actions.HIDE_WITHOUT_ANIMATION] = States.IDLE,
        _l),
    _a[States.TRANSITIONING_POPOVER_KEYBOARD_OPEN_DONE] = (_m = {},
        _m[Actions.MEASURE_POPOVER] = States.KEYBOARD_POPOVER_OPEN,
        _m[Actions.CLOSE_POPOVER] = States.KEYBOARD_CLOSING_POPOVER,
        _m),
    _a);
