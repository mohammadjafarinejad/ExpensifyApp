...
function PaymentCardChangeCurrencyForm(_a) {
    ...
    var currencyOptions = (0, react_1.useMemo)(function () {
        return availableCurrencies.map(function (currencyItem) { return ({
            text: currencyItem,
            value: currencyItem,
    ...
    return (<react_native_1.View style={[styles.mh5, styles.flexGrow1]}>
        ...
        }} style={{ containerStyle: styles.mhn5 }} initiallyFocusedItemKey={currency} customListHeader={<PaymentCardCurrencyHeader_1.default isSectionList/>} shouldStopPropagation/>
        </react_native_1.View>);
}
