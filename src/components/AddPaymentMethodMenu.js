...
function AddPaymentMethodMenu(_a) {
    ...
    var _f = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_INTRO_SELECTED, { canBeMissing: true }), introSelected = _f[0], introSelectedStatus = _f[1];
    ...
    (0, react_1.useEffect)(function () {
        if (!isVisible || !isPersonalOnlyOption || (0, isLoadingOnyxValue_1.default)(introSelectedStatus)) {
            return;
        }
        (0, IOU_1.completePaymentOnboarding)(CONST_1.default.PAYMENT_SELECTED.PBA, introSelected);
