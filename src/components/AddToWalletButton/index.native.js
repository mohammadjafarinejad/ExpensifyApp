...
function AddToWalletButton(_a) {
    var card = _a.card, cardHolderName = _a.cardHolderName, cardDescription = _a.cardDescription, style = _a.style;
    ...
    if (isLoading) {
        return <ActivityIndicator_1.default size={CONST_1.default.ACTIVITY_INDICATOR_SIZE.LARGE}/>;
    }
    if (isInWallet) {
    ...
    return (<react_native_wallet_1.AddToWalletButton style={[styles.addToWalletButtonStyles, style]} buttonType="badge" buttonStyle="blackOutline" onPress={handleOnPress}/>);
}
