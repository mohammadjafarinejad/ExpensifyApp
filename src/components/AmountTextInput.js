...
function AmountTextInput(_a) {
    ...
    autoCapitalize="words" submitBehavior="submit" selection={selection} onSelectionChange={onSelectionChange} role={CONST_1.default.ROLE.PRESENTATION} onKeyPress={onKeyPress} touchableInputWrapperStyle={touchableInputWrapperStyle} 
