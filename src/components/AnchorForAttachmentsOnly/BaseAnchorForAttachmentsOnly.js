...
function BaseAnchorForAttachmentsOnly(_a) {
    ...
    return (<ShowContextMenuContext_1.ShowContextMenuContext.Consumer>
            ...
            return (<PressableWithoutFeedback_1.default style={[style, (isOffline || !sourceID) && styles.cursorDefault]} onPress={function () {
                    ...
                    <AttachmentView_1.default source={source} file={{ name: displayName }} shouldShowDownloadIcon={!!sourceID && !isOffline} shouldShowLoadingSpinnerIcon={isDownloading} isUsedAsChatAttachment isDeleted={!!isDeleted} isUploading={!sourceID} isAuthTokenRequired={!!sourceID} isUploaded={!(0, EmptyObject_1.isEmptyObject)(report)}/>
