 ...
 */
var processAssetWithFallbacks = function (asset) {
    var _a, _b;
    // Generate fallback name: extract from URI if available, otherwise use timestamped default
    var fallbackName = asset.uri
        ? asset.uri
            .substring(asset.uri.lastIndexOf('/') + 1)
            .split('?')
            .at(0)
        : "image_".concat(Date.now(), ".jpeg");
    var fileName = (_a = asset.fileName) !== null && _a !== void 0 ? _a : fallbackName;
    return __assign(__assign({}, asset), { fileName: fileName, 
        // Default to JPEG if no type specified
        type: (_b = asset.type) !== null && _b !== void 0 ? _b : 'image/jpeg' });
};
/**
                    ...
                    if ((_a = asset.type) === null || _a === void 0 ? void 0 : _a.startsWith('image')) {
                        (0, FileUtils_1.verifyFileFormat)({ fileUri: asset.uri, formatSignatures: CONST_1.default.HEIC_SIGNATURES })
                            ...
                            if (isHEIC && asset.uri) {
                                ...
                                var processedAsset = processAssetWithFallbacks(asset);
    ...
    var showDocumentPicker = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    localCopies = _a.sent();
                    return [2 /*return*/, pickedFiles.map(function (file) {
                            var localCopy = localCopies.find(function (copy) { return copy.sourceUri === file.uri; });
        ...
        var filesToProcess = attachments.map(function (fileData) {
            ...
            if (!shouldValidateImage && fileDataName && expensify_common_1.Str.isImage(fileDataName)) {
                return getDataForUpload(fileDataObject)
                    .then(function (file) { return (0, FileUtils_1.resizeImageIfNeeded)(file); })
                    .then(function (resizedFile) {
                    var _a;
                    return react_native_image_size_1.default.getSize((_a = resizedFile.uri) !== null && _a !== void 0 ? _a : '').then(function (_a) {
                        var width = _a.width, height = _a.height;
                        return (__assign(__assign({}, resizedFile), { width: width, height: height }));
                    });
                })
                    .catch(function () {
