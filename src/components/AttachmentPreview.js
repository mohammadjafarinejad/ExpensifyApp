...
function AttachmentPreview(_a) {
    var source = _a.source, _b = _a.aspectRatio, aspectRatio = _b === void 0 ? 1 : _b, onPress = _a.onPress, onLoadError = _a.onLoadError;
    var styles = (0, useThemeStyles_1.default)();
    var fillStyle = aspectRatio < 1 ? styles.h100 : styles.w100;
    var _c = (0, react_1.useState)(false), isEncryptedPDF = _c[0], setIsEncryptedPDF = _c[1];
    var fileName = (0, react_1.useMemo)(function () {
        var rawFileName = (0, FileUtils_1.getFileName)(source);
        return (0, FileUtils_1.cleanFileName)(rawFileName);
    }, [source]);
    var _d = (0, react_1.useState)(null), thumbnail = _d[0], setThumbnail = _d[1];
    var videoPlayer = (0, expo_video_1.useVideoPlayer)({ uri: source });
    (0, react_1.useEffect)(function () {
        videoPlayer.generateThumbnailsAsync(1).then(function (thumbnails) { var _a; return setThumbnail((_a = thumbnails.at(0)) !== null && _a !== void 0 ? _a : null); });
    }, [videoPlayer]);
    if (typeof source === 'string' && expensify_common_1.Str.isVideo(source)) {
        return (<Pressable_1.PressableWithFeedback accessibilityRole="button" style={[fillStyle, styles.br2, styles.overflowHidden, styles.alignSelfStart, { aspectRatio: aspectRatio }]} onPress={onPress} accessible accessibilityLabel="Attachment Thumbnail">
                {!!thumbnail && (<Image_1.default source={thumbnail} style={[fillStyle, { aspectRatio: aspectRatio }]} resizeMode="cover"/>)}
