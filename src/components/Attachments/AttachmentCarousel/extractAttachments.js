...
function extractAttachments(type, _a) {
    var _b, _c, _d;
    var privateNotes = _a.privateNotes, accountID = _a.accountID, parentReportAction = _a.parentReportAction, reportActions = _a.reportActions, report = _a.report, isReportArchived = _a.isReportArchived;
    ...
    var attachments = [];
    var canUserPerformAction = (0, ReportUtils_1.canUserPerformWriteAction)(report, isReportArchived);
    var currentLink = '';
