...
function AttachmentCarousel(_a) {
    var report = _a.report, attachmentID = _a.attachmentID, source = _a.source, onNavigate = _a.onNavigate, setDownloadButtonVisibility = _a.setDownloadButtonVisibility, type = _a.type, accountID = _a.accountID, onSwipeDown = _a.onSwipeDown, attachmentLink = _a.attachmentLink, onAttachmentError = _a.onAttachmentError;
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (type === CONST_1.default.ATTACHMENT_TYPE.NOTE && accountID) {
            newAttachments = (0, extractAttachments_1.default)(CONST_1.default.ATTACHMENT_TYPE.NOTE, { privateNotes: report.privateNotes, accountID: accountID, report: report, isReportArchived: isReportArchived });
        }
        else if (type === CONST_1.default.ATTACHMENT_TYPE.ONBOARDING) {
            newAttachments = (0, extractAttachments_1.default)(CONST_1.default.ATTACHMENT_TYPE.ONBOARDING, { parentReportAction: parentReportAction, reportActions: reportActions !== null && reportActions !== void 0 ? reportActions : undefined, report: report, isReportArchived: isReportArchived });
        }
        else {
            newAttachments = (0, extractAttachments_1.default)(CONST_1.default.ATTACHMENT_TYPE.REPORT, { parentReportAction: parentReportAction, reportActions: reportActions !== null && reportActions !== void 0 ? reportActions : undefined, report: report, isReportArchived: isReportArchived });
        }
    ...
    return (<AttachmentCarouselView_1.default page={page} setPage={setPage} attachments={attachments} shouldShowArrows={shouldShowArrows} autoHideArrows={autoHideArrows} cancelAutoHideArrow={cancelAutoHideArrows} setShouldShowArrows={setShouldShowArrows} onSwipeDown={onSwipeDown} onAttachmentError={onAttachmentError} report={report} attachmentID={attachmentID} source={source} onNavigate={onNavigate}/>);
}
