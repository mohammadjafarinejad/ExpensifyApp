...
function AttachmentViewImage(_a) {
    var _b;
    var attachmentID = _a.attachmentID, url = _a.url, file = _a.file, isAuthTokenRequired = _a.isAuthTokenRequired, loadComplete = _a.loadComplete, onPress = _a.onPress, onError = _a.onError, isImage = _a.isImage;
    var translate = (0, useLocalize_1.default)().translate;
    var styles = (0, useThemeStyles_1.default)();
    var children = (<ImageView_1.default attachmentID={attachmentID} onError={onError} url={url} fileName={(_b = file === null || file === void 0 ? void 0 : file.name) !== null && _b !== void 0 ? _b : ''} isAuthTokenRequired={isImage && isAuthTokenRequired}/>);
