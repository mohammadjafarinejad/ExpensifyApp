...
function AttachmentView(_a) {
    var _b, _c;
    var attachmentID = _a.attachmentID, source = _a.source, previewSource = _a.previewSource, file = _a.file, isAuthTokenRequired = _a.isAuthTokenRequired, onPress = _a.onPress, shouldShowLoadingSpinnerIcon = _a.shouldShowLoadingSpinnerIcon, shouldShowDownloadIcon = _a.shouldShowDownloadIcon, containerStyles = _a.containerStyles, onToggleKeyboard = _a.onToggleKeyboard, _d = _a.onPDFLoadError, onPDFLoadErrorProp = _d === void 0 ? function () { } : _d, isFocused = _a.isFocused, isUsedInAttachmentModal = _a.isUsedInAttachmentModal, isWorkspaceAvatar = _a.isWorkspaceAvatar, maybeIcon = _a.maybeIcon, fallbackSource = _a.fallbackSource, _e = _a.transactionID, transactionID = _e === void 0 ? '-1' : _e, reportActionID = _a.reportActionID, isHovered = _a.isHovered, duration = _a.duration, isUsedAsChatAttachment = _a.isUsedAsChatAttachment, _f = _a.isUploaded, isUploaded = _f === void 0 ? true : _f, isDeleted = _a.isDeleted, _g = _a.isUploading, isUploading = _g === void 0 ? false : _g, reportID = _a.reportID, transactionProp = _a.transaction;
    var transactionFromOnyx = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat((0, getNonEmptyStringOnyxID_1.default)(transactionID)), { canBeMissing: true })[0];
    var transaction = transactionProp !== null && transactionProp !== void 0 ? transactionProp : transactionFromOnyx;
    var translate = (0, useLocalize_1.default)().translate;
    var _h = (0, PlaybackContext_1.usePlaybackContext)(), updateCurrentURLAndReportID = _h.updateCurrentURLAndReportID, currentlyPlayingURL = _h.currentlyPlayingURL, playVideo = _h.playVideo;
    ...
    (0, react_1.useEffect)(function () {
        ...
        var videoSource = isVideo && typeof source === 'string' ? source : undefined;
    ...
    if ((0, TransactionUtils_1.isDistanceRequest)(transaction) && !(0, TransactionUtils_1.isManualDistanceRequest)(transaction) && transaction) {
        ...
        var isImageReceiptSource = checkIsFileImage(source, file === null || file === void 0 ? void 0 : file.name);
        if (!(0, TransactionUtils_1.hasReceiptSource)(transaction) || isImageReceiptSource) {
    ...
    if (isImage) {
        ...
        if (isHighResolution) {
            if (!isUploaded) {
                return (<>
                        <react_native_1.View style={[styles.imageModalImageCenterContainer, styles.ph10]}>
            ...
            imageSource = (0, SafeString_1.default)(previewSource) || imageSource;
        }
        return (<>
                <react_native_1.View style={styles.imageModalImageCenterContainer}>
                    <AttachmentViewImage_1.default attachmentID={attachmentID} url={imageSource} file={file} isAuthTokenRequired={isAuthTokenRequired} loadComplete={loadComplete} isImage={isImage} onPress={onPress} onError={function () {
                if (isOffline) {
                    return;
                }
                setImageError(true);
