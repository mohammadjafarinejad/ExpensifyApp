...
function BaseAutoCompleteSuggestions(_a) {
    ...
    return (<react_native_reanimated_1.default.View style={[styles.autoCompleteSuggestionsContainer, animatedStyles]} onPointerDown={function (e) {
            ...
            <ColorSchemeWrapper_1.default>
                <react_native_gesture_handler_1.FlatList ref={scrollRef} keyboardShouldPersistTaps="handled" data={suggestions} renderItem={renderItem} keyExtractor={keyExtractor} removeClippedSubviews={false} showsVerticalScrollIndicator={innerHeight > rowHeight.get()} extraData={[highlightedSuggestionIndex, renderSuggestionMenuItem]} style={styles.overscrollBehaviorContain}/>
            </ColorSchemeWrapper_1.default>
