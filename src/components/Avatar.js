...
function Avatar(_a) {
    ...
    var source = isWorkspace ? originalSource : (0, UserAvatarUtils_1.getAvatar)({ avatarSource: originalSource, accountID: userAccountID });
    var optimizedSource = source;
    var maybeDefaultAvatarName = (0, UserAvatarUtils_1.getPresetAvatarNameFromURL)(source);
    if (maybeDefaultAvatarName) {
        optimizedSource = (0, PresetAvatarCatalog_1.getAvatarLocal)(maybeDefaultAvatarName);
    }
    ...
    var avatarSource = useFallBackAvatar ? fallbackAvatar : optimizedSource;
