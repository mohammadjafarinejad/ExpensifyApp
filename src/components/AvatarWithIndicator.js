    ...
    return (<Tooltip_1.default text={tooltipText}>
            <react_native_1.View style={[styles.sidebarAvatar]}>
                {isLoading ? (<AvatarSkeleton_1.default />) : (<>
                        <Avatar_1.default size={CONST_1.default.AVATAR_SIZE.SMALL} source={(0, UserAvatarUtils_1.getSmallSizeAvatar)({ avatarSource: source, accountID: accountID })} fallbackIcon={fallbackIcon} avatarID={accountID} type={CONST_1.default.ICON_TYPE_AVATAR}/>
                        <Indicator_1.default />
                    </>)}
            </react_native_1.View>
        </Tooltip_1.default>);
