...
function Badge(_a) {
    ...
    return (<Wrapper style={pressable ? wrapperStyles : wrapperStyles({ focused: false, hovered: false, isDisabled: false, isScreenReaderActive: false, pressed: false })} onPress={onPress} role={pressable ? CONST_1.default.ROLE.BUTTON : CONST_1.default.ROLE.PRESENTATION} accessibilityLabel={pressable ? text : undefined} aria-label={!pressable ? text : undefined} accessible={false}>
            {!!icon && (<react_native_1.View style={[styles.mr2, iconStyles]}>
                    <Icon_1.default width={shouldUseXXSmallIcon ? variables_1.default.iconSizeXXSmall : variables_1.default.iconSizeExtraSmall} height={shouldUseXXSmallIcon ? variables_1.default.iconSizeXXSmall : variables_1.default.iconSizeExtraSmall} src={icon} fill={iconColor}/>
                </react_native_1.View>)}
            <Text_1.default style={[styles.badgeText, styles.textStrong, textStyles, isDeleted ? styles.offlineFeedbackDeleted : {}]} numberOfLines={1}>
                {text}
            </Text_1.default>
        </Wrapper>);
}
