...
function CategoryPicker(_a) {
    ...
    }, [policyCategories, policyCategoriesDraft, policyRecentlyUsedCategories, debouncedSearchValue, selectedOptions, localeCompare, translate]), sections = _e[0], headerMessage = _e[1], shouldShowTextInput = _e[2];
    var selectedOptionKey = (0, react_1.useMemo)(function () { var _a, _b, _c; return (_c = ((_b = (_a = sections === null || sections === void 0 ? void 0 : sections.at(0)) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : []).find(function (category) { return category.searchText === selectedCategory; })) === null || _c === void 0 ? void 0 : _c.keyForList; }, [sections, selectedCategory]);
