...
function CategorySelector(_a) {
    ...
    var decodedCategoryName = (0, CategoryUtils_1.getDecodedCategoryName)(defaultValue);
    var descStyle = decodedCategoryName.length === 0 ? styles.textNormal : null;
    return (<react_native_1.View>
            <MenuItemWithTopDescription_1.default shouldShowRightIcon title={decodedCategoryName} description={label} descriptionTextStyle={descStyle} onPress={showPickerModal} wrapperStyle={wrapperStyle} focused={focused}/>
