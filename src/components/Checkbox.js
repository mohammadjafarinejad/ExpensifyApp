...
function Checkbox(_a) {
    ...
    return (<PressableWithFeedback_1.default testID={testID} disabled={disabled} onPress={firePressHandlerOnClick} onMouseDown={function (e) {
