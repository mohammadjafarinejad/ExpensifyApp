...
function CheckboxWithLabel(_a, ref) {
    ...
    var isActuallyChecked = value !== undefined && typeof value === 'boolean' ? value : isChecked;
    var toggleCheckbox = function () {
        var newValue = !isActuallyChecked;
    ...
    return (<react_native_1.View style={style}>
            <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.breakWord]}>
                <Checkbox_1.default isChecked={isActuallyChecked} onPress={toggleCheckbox} style={[styles.checkboxWithLabelCheckboxStyle]} hasError={!!errorText} ref={ref} accessibilityLabel={(_b = accessibilityLabel !== null && accessibilityLabel !== void 0 ? accessibilityLabel : label) !== null && _b !== void 0 ? _b : ''}/>
