...
var getFileSize_1 = require("@pages/Share/getFileSize");
...
function Composer(_a, ref) {
    ...
    var pasteFile = (0, react_1.useCallback)(function (e) {
        ...
        var _f = (0, FileUtils_1.splitExtensionFromFileName)(baseFileName), stem = _f.fileName, originalFileExtension = _f.fileExtension;
        ...
        var file = { uri: fileURI, name: fileName, type: mimeType, size: 0 };
        (0, getFileSize_1.default)((_e = file.uri) !== null && _e !== void 0 ? _e : '')
            .then(function (size) { return (file = __assign(__assign({}, file), { size: size })); })
            .finally(function () { return onPasteFile(file); });
    }, [onPasteFile]);
