...
function ConfirmationPage(_a) {
    var _b, _c, _d, _e;
    var _f = _a.illustration, illustration = _f === void 0 ? LottieAnimations_1.default.Fireworks : _f, heading = _a.heading, description = _a.description, descriptionComponent = _a.descriptionComponent, cta = _a.cta, ctaComponent = _a.ctaComponent, _g = _a.buttonText, buttonText = _g === void 0 ? '' : _g, _h = _a.onButtonPress, onButtonPress = _h === void 0 ? function () { } : _h, _j = _a.shouldShowButton, shouldShowButton = _j === void 0 ? false : _j, _k = _a.secondaryButtonText, secondaryButtonText = _k === void 0 ? '' : _k, _l = _a.onSecondaryButtonPress, onSecondaryButtonPress = _l === void 0 ? function () { } : _l, _m = _a.shouldShowSecondaryButton, shouldShowSecondaryButton = _m === void 0 ? false : _m, headingStyle = _a.headingStyle, illustrationStyle = _a.illustrationStyle, descriptionStyle = _a.descriptionStyle, ctaStyle = _a.ctaStyle, footerStyle = _a.footerStyle, containerStyle = _a.containerStyle, innerContainerStyle = _a.innerContainerStyle;
