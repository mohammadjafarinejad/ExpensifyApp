...
var MapboxToken_1 = require("@userActions/MapboxToken");
...
function ConfirmedRoute(_a) {
    ...
    var transaction = _a.transaction, isSmallerIcon = _a.isSmallerIcon, _k = _a.shouldHaveBorderRadius, shouldHaveBorderRadius = _k === void 0 ? true : _k, _l = _a.requireRouteToDisplayMap, requireRouteToDisplayMap = _l === void 0 ? false : _l, interactive = _a.interactive;
    ...
    var mapboxAccessToken = (0, useOnyx_1.default)(ONYXKEYS_1.default.MAPBOX_ACCESS_TOKEN, { canBeMissing: true })[0];
