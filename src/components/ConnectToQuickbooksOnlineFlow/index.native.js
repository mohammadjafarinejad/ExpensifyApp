...
function ConnectToQuickbooksOnlineFlow(_a) {
    ...
    return (<Modal_1.default onClose={function () { return setIsWebViewOpen(false); }} fullscreen isVisible={isWebViewOpen} type={CONST_1.default.MODAL.MODAL_TYPE.CENTERED_UNSWIPEABLE}>
