...
function ConnectToXeroFlow(_a) {
    ...
    return (<>
            {!is2FAEnabled && (<RequireTwoFactorAuthenticationModal_1.default onSubmit={function () {
                ...
                (0, Modal_2.close)(function () {
                    var backTo = ROUTES_1.default.POLICY_ACCOUNTING.getRoute(policyID);
                    var validatedUserForwardTo = (0, Xero_1.getXeroSetupLink)(policyID);
                    if (isUserValidated) {
                        Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_2FA_ROOT.getRoute(backTo, validatedUserForwardTo));
                        return;
                    }
                    Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_2FA_VERIFY_ACCOUNT.getRoute({
                        backTo: backTo,
                        forwardTo: ROUTES_1.default.SETTINGS_2FA_ROOT.getRoute(backTo, validatedUserForwardTo),
                    }));
                });
            ...
            <Modal_1.default onClose={function () { return setIsWebViewOpen(false); }} fullscreen isVisible={isWebViewOpen} type={CONST_1.default.MODAL.MODAL_TYPE.CENTERED_UNSWIPEABLE}>
