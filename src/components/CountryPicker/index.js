...
function CountryPicker(_a) {
    ...
    return (<>
            ...
            <CountrySelectorModal_1.default isVisible={isPickerVisible} currentCountry={value !== null && value !== void 0 ? value : ''} onCountrySelected={updateInput} onClose={hidePickerModal} label={translate('common.country')} onBackdropPress={hidePickerModal}/>
        </>);
}
