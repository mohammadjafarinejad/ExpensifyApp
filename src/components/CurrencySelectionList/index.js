...
var SelectableListItem_1 = require("@components/SelectionListWithSections/SelectableListItem");
...
function CurrencySelectionList(_a) {
    var searchInputLabel = _a.searchInputLabel, initiallySelectedCurrencyCode = _a.initiallySelectedCurrencyCode, onSelect = _a.onSelect, _b = _a.didScreenTransitionEnd, didScreenTransitionEnd = _b === void 0 ? true : _b, _c = _a.selectedCurrencies, selectedCurrencies = _c === void 0 ? [] : _c, _d = _a.canSelectMultiple, canSelectMultiple = _d === void 0 ? false : _d, recentlyUsedCurrencies = _a.recentlyUsedCurrencies, _e = _a.excludedCurrencies, excludedCurrencies = _e === void 0 ? [] : _e, restProps = __rest(_a, ["searchInputLabel", "initiallySelectedCurrencyCode", "onSelect", "didScreenTransitionEnd", "selectedCurrencies", "canSelectMultiple", "recentlyUsedCurrencies", "excludedCurrencies"]);
    ...
    }, [currencyList, recentlyUsedCurrencies, searchValue, getUnselectedOptions, translate, initiallySelectedCurrencyCode, selectedCurrencies, excludedCurrencies]), sections = _g.sections, headerMessage = _g.headerMessage;
    return (<SelectionListWithSections_1.default 
