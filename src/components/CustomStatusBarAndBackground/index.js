...
function CustomStatusBarAndBackground(_a) {
    ...
    var _e = (0, useOnyx_1.default)(ONYXKEYS_1.default.HYBRID_APP, { selector: HybridApp_1.isClosingReactNativeAppSelector, canBeMissing: true })[0], closingReactNativeApp = _e === void 0 ? false : _e;
    ...
    var isDisabled = (!isNested && !isRootStatusBarEnabled) || closingReactNativeApp;
