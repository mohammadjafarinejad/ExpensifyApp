...
function YearPickerModal(_a) {
    ...
    return (<Modal_1.default type={CONST_1.default.MODAL.MODAL_TYPE.RIGHT_DOCKED} isVisible={isVisible} onClose={function () { return onClose === null || onClose === void 0 ? void 0 : onClose(); }} onModalHide={onClose} shouldHandleNavigationBack shouldUseCustomBackdrop onBackdropPress={onClose} enableEdgeToEdgeBottomSafeAreaPadding>
            <ScreenWrapper_1.default style={[styles.pb0]} includePaddingTop={false} enableEdgeToEdgeBottomSafeAreaPadding testID={YearPickerModal.displayName}>
                ...
                <SelectionListWithSections_1.default textInputLabel={translate('yearPickerPage.selectYear')} textInputValue={searchText} textInputMaxLength={4} onChangeText={function (text) { return setSearchText(text.replace(CONST_1.default.REGEX.NON_NUMERIC, '').trim()); }} inputMode={CONST_1.default.INPUT_MODE.NUMERIC} headerMessage={headerMessage} sections={sections} onSelectRow={function (option) {
