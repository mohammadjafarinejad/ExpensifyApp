...
function CalendarPicker(_a) {
    ...
    var onYearSelected = function (year) {
        ...
        requestAnimationFrame(function () { return setIsYearPickerVisible(false); });
    };
    /**
    ...
    var monthNames = DateUtils_1.default.getMonthNames().map(function (month) { return expensify_common_1.Str.UCFirst(month); });
