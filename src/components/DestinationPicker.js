...
function DestinationPicker(_a) {
    ...
    var policyRecentlyUsedDestinations = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.POLICY_RECENTLY_USED_DESTINATIONS).concat(policyID), { canBeMissing: true })[0];
    ...
    var _c = (0, react_1.useMemo)(function () {
        var _a, _b, _c, _d;
        var destinationOptions = (0, PerDiemRequestUtils_1.getDestinationListSections)({
        ...
        var header = (0, OptionsListUtils_1.getHeaderMessageForNonUserList)(destinationData.length > 0, debouncedSearchValue);
    ...
    }, [debouncedSearchValue, selectedOptions, customUnit === null || customUnit === void 0 ? void 0 : customUnit.rates, policyRecentlyUsedDestinations, translate]), sections = _c[0], headerMessage = _c[1], shouldShowTextInput = _c[2];
    var selectedOptionKey = (0, react_1.useMemo)(function () { var _a, _b, _c; return (_c = ((_b = (_a = sections === null || sections === void 0 ? void 0 : sections.at(0)) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : []).find(function (destination) { return destination.keyForList === selectedDestination; })) === null || _c === void 0 ? void 0 : _c.keyForList; }, [sections, selectedDestination]);
    return (<SelectionListWithSections_1.default sections={sections} headerMessage={headerMessage} textInputValue={searchValue} textInputLabel={shouldShowTextInput ? translate('common.search') : undefined} onChangeText={setSearchValue} onSelectRow={onSubmit} ListItem={RadioListItem_1.default} initiallyFocusedOptionKey={selectedOptionKey !== null && selectedOptionKey !== void 0 ? selectedOptionKey : undefined} isRowMultilineSupported shouldHideKeyboardOnScroll={false}/>);
}
