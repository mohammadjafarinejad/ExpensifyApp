...
function DisplayNamesWithToolTip(_a) {
    var _b, _c;
    var shouldUseFullTitle = _a.shouldUseFullTitle, fullTitle = _a.fullTitle, displayNamesWithTooltips = _a.displayNamesWithTooltips, _d = _a.shouldAddEllipsis, shouldAddEllipsis = _d === void 0 ? false : _d, _e = _a.textStyles, textStyles = _e === void 0 ? [] : _e, _f = _a.numberOfLines, numberOfLines = _f === void 0 ? 1 : _f, renderAdditionalText = _a.renderAdditionalText, forwardedFSClass = _a.forwardedFSClass;
