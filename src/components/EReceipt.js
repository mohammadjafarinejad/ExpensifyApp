...
function EReceipt(_a) {
    var _b, _c;
    var transactionID = _a.transactionID, transactionItem = _a.transactionItem, onLoad = _a.onLoad, _d = _a.isThumbnail, isThumbnail = _d === void 0 ? false : _d;
    ...
    var cardDescription = (_c = (0, CardUtils_1.getCompanyCardDescription)(transactionCardName, transactionCardID, cardList)) !== null && _c !== void 0 ? _c : (transactionCardID ? (0, CardUtils_1.getCardDescription)(cardList === null || cardList === void 0 ? void 0 : cardList[transactionCardID]) : '');
