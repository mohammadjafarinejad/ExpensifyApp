...
var PerDiemEReceipt_1 = require("./PerDiemEReceipt");
...
function EReceiptWithSizeCalculation(props) {
    ...
    style={[
            ...
            (props.receiptType === 'perDiem' ? true : props.shouldUseAspectRatio) && { aspectRatio: eReceiptAspectRatio },
                ...
                {props.receiptType === 'perDiem' && props.transactionID ? (<PerDiemEReceipt_1.default transactionID={props.transactionID}/>) : (<EReceipt_1.default transactionID={props.transactionID} transactionItem={props.transactionItem} onLoad={props.onLoad} isThumbnail/>)}
            </react_native_1.View>
