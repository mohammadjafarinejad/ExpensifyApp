...
_a) {
    var _b = _a.isDisabled, isDisabled = _b === void 0 ? false : _b, _c = _a.withoutOverlay, withoutOverlay = _c === void 0 ? false : _c, onModalHide = _a.onModalHide, onInputChange = _a.onInputChange, value = _a.value, disabled = _a.disabled, style = _a.style, ref = _a.ref, otherProps = __rest(_a, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ["isDisabled", "withoutOverlay", "onModalHide", "onInputChange", "value", "disabled", "style", "ref"]);
    ...
    var onPress = function () {
        ...
        keyboard_1.default.dismissKeyboardAndExecute(function () {
            (0, EmojiPickerAction_1.showEmojiPicker)({
                onModalHide: onModalHide,
                onEmojiSelected: function (emoji) { return onInputChange(emoji); },
...
exports.default = EmojiPickerButtonDropdown;
