...
function EmptySelectionListContent(_a) {
    ...
    return (<ScrollView_1.default contentContainerStyle={[styles.flexGrow1]}>
            <react_native_1.View style={[styles.flex1, styles.overflowHidden, styles.minHeight65]}>
                <BlockingView_1.default icon={Illustrations.ToddWithPhones} iconWidth={variables_1.default.emptySelectionListIconWidth} iconHeight={variables_1.default.emptySelectionListIconHeight} title={translate("emptyList.".concat(translationKeyContentType, ".title"))} CustomSubtitle={EmptySubtitle} containerStyle={[styles.mb8, styles.ph15]}/>
            </react_native_1.View>
