...
function CustomFlatList(_a) {
    ...
    var originalMaintainVisibleContentPosition = props.maintainVisibleContentPosition, shouldDisableVisibleContentPosition = props.shouldDisableVisibleContentPosition, rest = __rest(props, ["maintainVisibleContentPosition", "shouldDisableVisibleContentPosition"]);
    var _b = (0, react_1.useState)(false), isScrolling = _b[0], setIsScrolling = _b[1];
    ...
    var maintainVisibleContentPosition = isScrolling || shouldDisableVisibleContentPosition ? undefined : originalMaintainVisibleContentPosition;
