...
function MVCPFlatList(_a) {
    var maintainVisibleContentPosition = _a.maintainVisibleContentPosition, _b = _a.horizontal, horizontal = _b === void 0 ? false : _b, onScroll = _a.onScroll, initialNumToRender = _a.initialNumToRender, ref = _a.ref, props = __rest(_a, ["maintainVisibleContentPosition", "horizontal", "onScroll", "initialNumToRender", "ref"]);
    ...
    {...props} maintainVisibleContentPosition={maintainVisibleContentPosition} horizontal={horizontal} onScroll={onScrollInternal} scrollEventThrottle={1} ref={onRef} initialNumToRender={Math.max(0, initialNumToRender !== null && initialNumToRender !== void 0 ? initialNumToRender : 0) || undefined} onLayout={function (e) {
            var _a;
