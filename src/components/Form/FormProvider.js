...
function FormProvider(_a) {
    var formID = _a.formID, validate = _a.validate, _b = _a.shouldValidateOnBlur, shouldValidateOnBlur = _b === void 0 ? true : _b, _c = _a.shouldValidateOnChange, shouldValidateOnChange = _c === void 0 ? true : _c, children = _a.children, _d = _a.enabledWhenOffline, enabledWhenOffline = _d === void 0 ? false : _d, onSubmit = _a.onSubmit, _e = _a.shouldTrimValues, shouldTrimValues = _e === void 0 ? true : _e, _f = _a.allowHTML, allowHTML = _f === void 0 ? false : _f, _g = _a.isLoading, isLoading = _g === void 0 ? false : _g, _h = _a.shouldRenderFooterAboveSubmit, shouldRenderFooterAboveSubmit = _h === void 0 ? false : _h, _j = _a.shouldUseStrictHtmlTagValidation, shouldUseStrictHtmlTagValidation = _j === void 0 ? false : _j, _k = _a.shouldPreventDefaultFocusOnPressSubmit, shouldPreventDefaultFocusOnPressSubmit = _k === void 0 ? false : _k, ref = _a.ref, rest = __rest(_a, ["formID", "validate", "shouldValidateOnBlur", "shouldValidateOnChange", "children", "enabledWhenOffline", "onSubmit", "shouldTrimValues", "allowHTML", "isLoading", "shouldRenderFooterAboveSubmit", "shouldUseStrictHtmlTagValidation", "shouldPreventDefaultFocusOnPressSubmit", "ref"]);
    ...
    var onValidate = (0, react_1.useCallback)(function (values, shouldClearServerError) {
        ...
        var validateErrors = (_a = validate === null || validate === void 0 ? void 0 : validate(trimmedStringValues, translate)) !== null && _a !== void 0 ? _a : {};
        if (!allowHTML) {
