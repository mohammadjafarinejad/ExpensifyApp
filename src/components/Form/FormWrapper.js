...
function FormWrapper(_a) {
    var onSubmit = _a.onSubmit, children = _a.children, errors = _a.errors, inputRefs = _a.inputRefs, submitButtonText = _a.submitButtonText, footerContent = _a.footerContent, _b = _a.isSubmitButtonVisible, isSubmitButtonVisible = _b === void 0 ? true : _b, style = _a.style, submitButtonStyles = _a.submitButtonStyles, _c = _a.submitFlexEnabled, submitFlexEnabled = _c === void 0 ? true : _c, enabledWhenOffline = _a.enabledWhenOffline, _d = _a.isSubmitActionDangerous, isSubmitActionDangerous = _d === void 0 ? false : _d, formID = _a.formID, _e = _a.shouldUseScrollView, shouldUseScrollView = _e === void 0 ? true : _e, _f = _a.scrollContextEnabled, scrollContextEnabled = _f === void 0 ? false : _f, _g = _a.shouldHideFixErrorsAlert, shouldHideFixErrorsAlert = _g === void 0 ? false : _g, _h = _a.disablePressOnEnter, disablePressOnEnter = _h === void 0 ? false : _h, _j = _a.enterKeyEventListenerPriority, enterKeyEventListenerPriority = _j === void 0 ? 1 : _j, _k = _a.isSubmitDisabled, isSubmitDisabled = _k === void 0 ? false : _k, _l = _a.shouldRenderFooterAboveSubmit, shouldRenderFooterAboveSubmit = _l === void 0 ? false : _l, _m = _a.isLoading, isLoading = _m === void 0 ? false : _m, _o = _a.shouldScrollToEnd, shouldScrollToEnd = _o === void 0 ? false : _o, addBottomSafeAreaPadding = _a.addBottomSafeAreaPadding, addOfflineIndicatorBottomSafeAreaPadding = _a.addOfflineIndicatorBottomSafeAreaPadding, shouldSubmitButtonStickToBottomProp = _a.shouldSubmitButtonStickToBottom, _p = _a.shouldSubmitButtonBlendOpacity, shouldSubmitButtonBlendOpacity = _p === void 0 ? false : _p, _q = _a.shouldPreventDefaultFocusOnPressSubmit, shouldPreventDefaultFocusOnPressSubmit = _q === void 0 ? false : _q, _r = _a.onScroll, onScroll = _r === void 0 ? function () { } : _r, forwardedFSClass = _a.forwardedFSClass;
    ...
    var onFixTheErrorsLinkPressed = (0, react_1.useCallback)(function () {
        ...
        var focusKey = Object.keys((_b = inputRefs.current) !== null && _b !== void 0 ? _b : {}).find(function (key) { return key in errorFields; });
        if (!focusKey) {
            return;
        }
