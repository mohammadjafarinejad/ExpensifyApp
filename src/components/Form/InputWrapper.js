...
var textInputBasedComponents = new Set([TextInput_1.default, RoomNameInput_1.default]);
...
function InputWrapper(_a) {
    ...
    var _b = props, InputComponent = _b.InputComponent, inputID = _b.inputID, _c = _b.valueType, valueType = _c === void 0 ? 'string' : _c, propShouldSubmitForm = _b.shouldSubmitForm, rest = __rest(_b, ["InputComponent", "inputID", "valueType", "shouldSubmitForm"]);
    var registerInput = (0, react_1.useContext)(FormContext_1.default).registerInput;
    var _d = computeComponentSpecificRegistrationParams(props), shouldSetTouchedOnBlurOnly = _d.shouldSetTouchedOnBlurOnly, blurOnSubmit = _d.blurOnSubmit, shouldSubmitForm = _d.shouldSubmitForm;
    // eslint-disable-next-line react-compiler/react-compiler
    var _e = registerInput(inputID, shouldSubmitForm, __assign(__assign({ ref: ref, valueType: valueType }, rest), { shouldSetTouchedOnBlurOnly: shouldSetTouchedOnBlurOnly, blurOnSubmit: blurOnSubmit })), key = _e.key, registerInputProps = __rest(_e, ["key"]);
