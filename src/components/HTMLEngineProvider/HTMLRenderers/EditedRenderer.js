...
function EditedRenderer(_a) {
    ...
    {...defaultRendererProps} fontSize={variables_1.default.fontSizeSmall} color={theme.textSupporting} style={[styles.editedLabelStyles, isPendingDelete && styles.offlineFeedbackDeleted]}>
