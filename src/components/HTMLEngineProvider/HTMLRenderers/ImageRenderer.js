...
function ImageRenderer(_a) {
    ...
    (0, useOnyx_1.default)(ONYXKEYS_1.default.SHOULD_USE_STAGING_SERVER, { canBeMissing: true });
    ...
    return imagePreviewModalDisabled ? (thumbnailImageComponent) : (<ShowContextMenuContext_1.ShowContextMenuContext.Consumer>
            ...
            return (<AttachmentContext_1.AttachmentContext.Consumer>
                    ...
                    return (<PressableWithoutFocus_1.default style={[styles.noOutline]} onPress={function () {
                            ...
                            var route = (_c = ROUTES_1.default.REPORT_ATTACHMENTS) === null || _c === void 0 ? void 0 : _c.getRoute({
...
exports.default = (0, react_1.memo)(ImageRenderer, function (prevProps, nextProps) { return prevProps.tnode.attributes === nextProps.tnode.attributes; });
