...
function MentionUserRenderer(_a) {
    ...
    if (!(0, isEmpty_1.default)(htmlAttribAccountID) && (personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails[htmlAttribAccountID])) {
        ...
        mentionDisplayText = formatPhoneNumber((_b = user === null || user === void 0 ? void 0 : user.login) !== null && _b !== void 0 ? _b : '') || (0, PersonalDetailsUtils_1.getDisplayNameOrDefault)(user);
    ...
    return (<ShowContextMenuContext_1.ShowContextMenuContext.Consumer>
            ...
            {...defaultRendererProps} style={[
                    ...
                    styles.breakWord,
                    styles.textWrap,
                ]} role={CONST_1.default.ROLE.LINK} testID="mention-user" href={"/".concat(navigationRoute)}>
                            {htmlAttribAccountID ? "@".concat(mentionDisplayText) : <react_native_render_html_1.TNodeChildrenRenderer tnode={tnodeClone !== null && tnodeClone !== void 0 ? tnodeClone : tnode}/>}
                        </Text_1.default>
