 ...
 */
function isChildOfTagName(tnode, tagName) {
    if (!tnode.parent) {
        return false;
    }
...
function isChildOfLabelText(tnode) {
 ...
 */
function isChildOfAlertText(tnode) {
