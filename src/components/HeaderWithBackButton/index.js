...
function HeaderWithBackButton(_a) {
    var icon = _a.icon, iconFill = _a.iconFill, iconWidth = _a.iconWidth, iconHeight = _a.iconHeight, iconStyles = _a.iconStyles, _b = _a.onBackButtonPress, onBackButtonPress = _b === void 0 ? function () { return Navigation_1.default.goBack(); } : _b, _c = _a.onCloseButtonPress, onCloseButtonPress = _c === void 0 ? function () { return Navigation_1.default.dismissModal(); } : _c, _d = _a.onDownloadButtonPress, onDownloadButtonPress = _d === void 0 ? function () { } : _d, _e = _a.onThreeDotsButtonPress, onThreeDotsButtonPress = _e === void 0 ? function () { } : _e, report = _a.report, policyAvatar = _a.policyAvatar, _f = _a.shouldShowReportAvatarWithDisplay, shouldShowReportAvatarWithDisplay = _f === void 0 ? false : _f, shouldDisplayStatus = _a.shouldDisplayStatus, _g = _a.shouldShowBackButton, shouldShowBackButton = _g === void 0 ? true : _g, _h = _a.shouldShowBorderBottom, shouldShowBorderBottom = _h === void 0 ? false : _h, _j = _a.shouldShowCloseButton, shouldShowCloseButton = _j === void 0 ? false : _j, _k = _a.shouldShowDownloadButton, shouldShowDownloadButton = _k === void 0 ? false : _k, _l = _a.isDownloading, isDownloading = _l === void 0 ? false : _l, _m = _a.shouldShowPinButton, shouldShowPinButton = _m === void 0 ? false : _m, _o = _a.shouldSetModalVisibility, shouldSetModalVisibility = _o === void 0 ? true : _o, _p = _a.shouldShowThreeDotsButton, shouldShowThreeDotsButton = _p === void 0 ? false : _p, _q = _a.shouldDisableThreeDotsButton, shouldDisableThreeDotsButton = _q === void 0 ? false : _q, _r = _a.shouldUseHeadlineHeader, shouldUseHeadlineHeader = _r === void 0 ? false : _r, stepCounter = _a.stepCounter, _s = _a.subtitle, subtitle = _s === void 0 ? '' : _s, _t = _a.title, title = _t === void 0 ? '' : _t, titleColor = _a.titleColor, _u = _a.threeDotsAnchorAlignment, threeDotsAnchorAlignment = _u === void 0 ? {
        horizontal: CONST_1.default.MODAL.ANCHOR_ORIGIN_HORIZONTAL.RIGHT,
        vertical: CONST_1.default.MODAL.ANCHOR_ORIGIN_VERTICAL.TOP,
    } : _u, _v = _a.threeDotsMenuItems, threeDotsMenuItems = _v === void 0 ? [] : _v, threeDotsMenuIcon = _a.threeDotsMenuIcon, threeDotsMenuIconFill = _a.threeDotsMenuIconFill, _w = _a.shouldEnableDetailPageNavigation, shouldEnableDetailPageNavigation = _w === void 0 ? false : _w, _x = _a.children, children = _x === void 0 ? null : _x, _y = _a.shouldOverlayDots, shouldOverlayDots = _y === void 0 ? false : _y, _z = _a.shouldOverlay, shouldOverlay = _z === void 0 ? false : _z, _0 = _a.shouldNavigateToTopMostReport, shouldNavigateToTopMostReport = _0 === void 0 ? false : _0, _1 = _a.shouldDisplayHelpButton, shouldDisplayHelpButton = _1 === void 0 ? true : _1, _2 = _a.shouldDisplaySearchRouter, shouldDisplaySearchRouter = _2 === void 0 ? false : _2, progressBarPercentage = _a.progressBarPercentage, style = _a.style, _3 = _a.subTitleLink, subTitleLink = _3 === void 0 ? '' : _3, _4 = _a.shouldMinimizeMenuButton, shouldMinimizeMenuButton = _4 === void 0 ? false : _4, _5 = _a.openParentReportInCurrentTab, openParentReportInCurrentTab = _5 === void 0 ? false : _5;
    var theme = (0, useTheme_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var StyleUtils = (0, useStyleUtils_1.default)();
    var _6 = (0, useThrottledButtonState_1.default)(), isDownloadButtonActive = _6[0], temporarilyDisableDownloadButton = _6[1];
    ...
    dataSet={{ dragArea: false }} style={[
            ...
            (!isDownloading ? (<Tooltip_1.default text={translate('common.download')}>
                    ...
                    temporarilyDisableDownloadButton();
                                ...
                                </Tooltip_1.default>) : (<ActivityIndicator_1.default style={[styles.touchableButtonImage]}/>))}
