...
function HighlightableMenuItem(_a, ref) {
    ...
    var animatedHighlightStyle = (0, useAnimatedHighlightStyle_1.default)({
        ...
        highlightEndDelay: CONST_1.default.ANIMATED_HIGHLIGHT_WORKSPACE_FEATURE_ITEM_END_DELAY,
        highlightEndDuration: CONST_1.default.ANIMATED_HIGHLIGHT_WORKSPACE_FEATURE_ITEM_END_DURATION,
    });
