...
function Icon(_a) {
    var src = _a.src, _b = _a.width, width = _b === void 0 ? variables_1.default.iconSizeNormal : _b, _c = _a.height, height = _c === void 0 ? variables_1.default.iconSizeNormal : _c, _d = _a.fill, fill = _d === void 0 ? undefined : _d, _e = _a.extraSmall, extraSmall = _e === void 0 ? false : _e, _f = _a.small, small = _f === void 0 ? false : _f, _g = _a.large, large = _g === void 0 ? false : _g, _h = _a.medium, medium = _h === void 0 ? false : _h, _j = _a.inline, inline = _j === void 0 ? false : _j, _k = _a.additionalStyles, additionalStyles = _k === void 0 ? [] : _k, _l = _a.hovered, hovered = _l === void 0 ? false : _l, _m = _a.pressed, pressed = _m === void 0 ? false : _m, _o = _a.testID, testID = _o === void 0 ? '' : _o, _p = _a.contentFit, contentFit = _p === void 0 ? 'cover' : _p, _q = _a.isButtonIcon, isButtonIcon = _q === void 0 ? false : _q, _r = _a.enableMultiGestureCanvas, enableMultiGestureCanvas = _r === void 0 ? false : _r;
    var StyleUtils = (0, useStyleUtils_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var _s = StyleUtils.getIconWidthAndHeightStyle(extraSmall, small, medium, large, width, height, isButtonIcon), iconWidth = _s.width, iconHeight = _s.height;
    ...
    var _t = (0, react_1.useState)(), canvasSize = _t[0], setCanvasSize = _t[1];
    ...
    }, [attachmentCarouselPagerContext, isScrollingEnabledFallback]), onTap = _u.onTap, onSwipeDown = _u.onSwipeDown, pagerRef = _u.pagerRef, isScrollEnabled = _u.isScrollEnabled;
    if (!src) {
        return null;
    }
    if (inline) {
