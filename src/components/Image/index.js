...
function Image(_a) {
    var propsSource = _a.source, _b = _a.shouldCalculateAspectRatioForWideImage, shouldCalculateAspectRatioForWideImage = _b === void 0 ? false : _b, _c = _a.isAuthTokenRequired, isAuthTokenRequired = _c === void 0 ? false : _c, onLoad = _a.onLoad, _d = _a.objectPosition, objectPosition = _d === void 0 ? CONST_1.default.IMAGE_OBJECT_POSITION.INITIAL : _d, style = _a.style, loadingIconSize = _a.loadingIconSize, loadingIndicatorStyles = _a.loadingIndicatorStyles, imageWidthToCalculateHeight = _a.imageWidthToCalculateHeight, forwardedProps = __rest(_a, ["source", "shouldCalculateAspectRatioForWideImage", "isAuthTokenRequired", "onLoad", "objectPosition", "style", "loadingIconSize", "loadingIndicatorStyles", "imageWidthToCalculateHeight"]);
    var _e = (0, react_1.useState)(null), aspectRatio = _e[0], setAspectRatio = _e[1];
    ...
    var aspectRatioStyle = (0, react_1.useMemo)(function () {
    ...
    {...forwardedProps} onLoad={handleLoad} style={[style, aspectRatioStyle, shouldOpacityBeZero && { opacity: 0 }]} source={source}/>);
}
Image.displayName = 'Image';
exports.default = react_1.default.memo(Image, function (prevProps, nextProps) { return prevProps.source === nextProps.source && prevProps.imageWidthToCalculateHeight === nextProps.imageWidthToCalculateHeight; });
