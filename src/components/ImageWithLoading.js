...
function ImageWithLoading(_a) {
    var onError = _a.onError, containerStyles = _a.containerStyles, _b = _a.shouldShowOfflineIndicator, shouldShowOfflineIndicator = _b === void 0 ? true : _b, loadingIconSize = _a.loadingIconSize, waitForSession = _a.waitForSession, loadingIndicatorStyles = _a.loadingIndicatorStyles, resizeMode = _a.resizeMode, onLoad = _a.onLoad, onLayout = _a.onLayout, rest = __rest(_a, ["onError", "containerStyles", "shouldShowOfflineIndicator", "loadingIconSize", "waitForSession", "loadingIndicatorStyles", "resizeMode", "onLoad", "onLayout"]);
    ...
    return (<react_native_1.View style={[styles.w100, styles.h100, containerStyles]} onLayout={onLayout}>
            <Image_1.default 
...
exports.default = react_1.default.memo(ImageWithLoading);
