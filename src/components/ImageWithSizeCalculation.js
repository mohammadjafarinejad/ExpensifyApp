...
function ImageWithSizeCalculation(_a) {
    var url = _a.url, altText = _a.altText, style = _a.style, onMeasure = _a.onMeasure, onLoadFailure = _a.onLoadFailure, isAuthTokenRequired = _a.isAuthTokenRequired, _b = _a.objectPosition, objectPosition = _b === void 0 ? CONST_1.default.IMAGE_OBJECT_POSITION.INITIAL : _b, loadingIconSize = _a.loadingIconSize, loadingIndicatorStyles = _a.loadingIndicatorStyles, onLoad = _a.onLoad;
    ...
    return (<ImageWithLoading_1.default containerStyles={[styles.w100, styles.h100, style]} style={[styles.w100, styles.h100]} source={source} aria-label={altText} isAuthTokenRequired={isAuthTokenRequired} resizeMode={resizeModes_1.default.cover} onError={onError} onLoad={function (event) {
        ...
        }} objectPosition={objectPosition} loadingIconSize={loadingIconSize} loadingIndicatorStyles={loadingIndicatorStyles}/>);
}
