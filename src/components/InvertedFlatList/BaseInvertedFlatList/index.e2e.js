...
function BaseInvertedFlatListE2e(_a) {
    var _b;
    ...
    var maintainVisibleContentPosition = (0, react_1.useMemo)(function () {
        ...
        return config;
    }, [shouldEnableAutoScrollToTopThreshold, (_b = rest.data) === null || _b === void 0 ? void 0 : _b.length]);
...
exports.default = BaseInvertedFlatListE2e;
