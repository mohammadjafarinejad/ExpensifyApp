...
function BaseInvertedFlatList(_a) {
    var ref = _a.ref, props = __rest(_a, ["ref"]);
    var shouldEnableAutoScrollToTopThreshold = props.shouldEnableAutoScrollToTopThreshold, initialScrollKey = props.initialScrollKey, data = props.data, onStartReached = props.onStartReached, renderItem = props.renderItem, _b = props.keyExtractor, keyExtractor = _b === void 0 ? defaultKeyExtractor : _b, rest = __rest(props, ["shouldEnableAutoScrollToTopThreshold", "initialScrollKey", "data", "onStartReached", "renderItem", "keyExtractor"]);
    ...
    var _c = (0, react_1.useState)(function () {
        ...
        return null;
    }), currentDataId = _c[0], setCurrentDataId = _c[1];
    var _d = (0, react_1.useState)(true), isInitialData = _d[0], setIsInitialData = _d[1];
    var _e = (0, react_1.useState)(false), isQueueRendering = _e[0], setIsQueueRendering = _e[1];
    ...
    var renderQueue = (0, react_1.useMemo)(function () { return new RenderTaskQueue_1.default(setIsQueueRendering); }, []);
...
exports.default = BaseInvertedFlatList;
