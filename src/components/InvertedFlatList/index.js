...
function InvertedFlatList(_a) {
    var _b = _a.onScroll, onScrollProp = _b === void 0 ? function () { } : _b, ref = _a.ref, props = __rest(_a, ["onScroll", "ref"]);
...
exports.default = InvertedFlatList;
