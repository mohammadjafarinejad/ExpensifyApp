...
function LHNOptionsList(_a) {
    ...
    var _e = (0, useLocalize_1.default)(), translate = _e.translate, preferredLocale = _e.preferredLocale, localeCompare = _e.localeCompare;
    ...
    var renderItem = (0, react_1.useCallback)(function (_a) {
        ...
        var hasDraftComment = !!(draftComments === null || draftComments === void 0 ? void 0 : draftComments["".concat(ONYXKEYS_1.default.COLLECTION.REPORT_DRAFT_COMMENT).concat(reportID)]) &&
            !((_d = draftComments === null || draftComments === void 0 ? void 0 : draftComments["".concat(ONYXKEYS_1.default.COLLECTION.REPORT_DRAFT_COMMENT).concat(reportID)]) === null || _d === void 0 ? void 0 : _d.match(CONST_1.default.REGEX.EMPTY_COMMENT));
        var isReportArchived = !!(itemReportNameValuePairs === null || itemReportNameValuePairs === void 0 ? void 0 : itemReportNameValuePairs.private_isArchived);
        var canUserPerformWrite = (0, ReportUtils_1.canUserPerformWriteAction)(item, isReportArchived);
        ...
        var lastReportActionTransactionID = (0, ReportActionsUtils_1.isMoneyRequestAction)(lastReportAction)
            ? ((_f = (_e = (0, ReportActionsUtils_1.getOriginalMessage)(lastReportAction)) === null || _e === void 0 ? void 0 : _e.IOUTransactionID) !== null && _f !== void 0 ? _f : CONST_1.default.DEFAULT_NUMBER_ID)
            : CONST_1.default.DEFAULT_NUMBER_ID;
        ...
        if (!lastActorDetails && lastReportAction) {
            var lastActorDisplayName = (_h = (_g = lastReportAction === null || lastReportAction === void 0 ? void 0 : lastReportAction.person) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.text;
        ...
        var movedFromReport = reports === null || reports === void 0 ? void 0 : reports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, ModifiedExpenseMessage_1.getMovedReportID)(lastReportAction, CONST_1.default.REPORT.MOVE_TYPE.FROM))];
        var movedToReport = reports === null || reports === void 0 ? void 0 : reports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, ModifiedExpenseMessage_1.getMovedReportID)(lastReportAction, CONST_1.default.REPORT.MOVE_TYPE.TO))];
        var lastMessageTextFromReport = (0, OptionsListUtils_1.getLastMessageTextForReport)({
            report: item,
            lastActorDetails: lastActorDetails,
            movedFromReport: movedFromReport,
            movedToReport: movedToReport,
            policy: itemPolicy,
            isReportArchived: !!(itemReportNameValuePairs === null || itemReportNameValuePairs === void 0 ? void 0 : itemReportNameValuePairs.private_isArchived),
        ...
        if (!itemReportActions || !item) {
            ...
            var canUserPerformWriteAction_1 = (0, ReportUtils_1.canUserPerformWriteAction)(item, isReportArchived);
            var actionsArray = (0, ReportActionsUtils_1.getSortedReportActions)(Object.values(itemReportActions));
            var reportActionsForDisplay = actionsArray.filter(function (reportAction) { return (0, ReportActionsUtils_1.shouldReportActionBeVisibleAsLastAction)(reportAction, canUserPerformWriteAction_1) && reportAction.actionName !== CONST_1.default.REPORT.ACTIONS.TYPE.CREATED; });
            lastAction = reportActionsForDisplay.at(-1);
        }
        var lastActionReport;
        if ((0, ReportActionsUtils_1.isInviteOrRemovedAction)(lastAction)) {
