...
function Lightbox(_a) {
    var attachmentID = _a.attachmentID, _b = _a.isAuthTokenRequired, isAuthTokenRequired = _b === void 0 ? false : _b, uri = _a.uri, onScaleChangedProp = _a.onScaleChanged, onError = _a.onError, style = _a.style, _c = _a.zoomRange, zoomRange = _c === void 0 ? MultiGestureCanvas_1.DEFAULT_ZOOM_RANGE : _c;
    ...
    var _d = (0, react_1.useMemo)(function () {
        ...
        var foundPage = attachmentCarouselPagerContext.pagerItems.findIndex(function (item) { return item.attachmentID === attachmentID; });
    ...
    return (<react_native_1.View style={[react_native_1.StyleSheet.absoluteFill, style]} onLayout={updateCanvasSize}>
            {!isCanvasLoading && (<>
                    ...
                    {isLoading && (!isOffline || isALocalFile) && (<ActivityIndicator_1.default size={CONST_1.default.ACTIVITY_INDICATOR_SIZE.LARGE} style={react_native_1.StyleSheet.absoluteFill}/>)}
