...
function BaseLocationErrorMessage(_a) {
    ...
    return (<react_native_1.View style={[styles.dotIndicatorMessage, styles.mt4]}>
            ...
            <react_native_1.View style={styles.offlineFeedbackTextContainer}>
                {isPermissionDenied ? (<Text_1.default>
                    ...
                    </Text_1.default>) : (<Text_1.default style={styles.offlineFeedbackText}>{translate('location.notFound')}</Text_1.default>)}
            </react_native_1.View>
            <react_native_1.View>
