 ...
 */
var useMagicCodePaste = function (inputRef, onChangeText) {
    (0, react_1.useEffect)(function () {
        ...
        var handlePaste = function (event) {
            ...
            var isFocused = (_c = (_b = (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.isFocused) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : false;
            if (!isFocused) {
                return;
            }
            event.preventDefault();
            var plainText = (_d = event.clipboardData) === null || _d === void 0 ? void 0 : _d.getData('text/plain');
            if (plainText) {
...
function MagicCodeInput(_a, ref) {
    ...
    var onFocus = function (e) {
        ...
        onFocusProps === null || onFocusProps === void 0 ? void 0 : onFocusProps();
        e.preventDefault();
    };
    /**
    ...
    var cursorOpacity = (0, react_native_reanimated_1.useSharedValue)(1);
    (0, react_1.useEffect)(function () {
    ...
    var animatedCursorStyle = (0, react_native_reanimated_1.useAnimatedStyle)(function () { return ({
    ...
    return (<>
            ...
            var _a, _b;
            var char = (_b = (_a = decomposeString(value, maxLength).at(index)) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : '';
            var cursorMargin = char ? { marginLeft: 2 } : {};
