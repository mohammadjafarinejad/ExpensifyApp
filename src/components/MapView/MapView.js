...
function MapView(_a) {
    var _b, _c;
    var accessToken = _a.accessToken, style = _a.style, mapPadding = _a.mapPadding, styleURL = _a.styleURL, pitchEnabled = _a.pitchEnabled, initialState = _a.initialState, waypoints = _a.waypoints, directionCoordinates = _a.directionCoordinates, onMapReady = _a.onMapReady, _d = _a.interactive, interactive = _d === void 0 ? true : _d, distanceInMeters = _a.distanceInMeters, unit = _a.unit, ref = _a.ref;
