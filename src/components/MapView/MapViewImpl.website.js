...
function MapViewImpl(_a) {
    var _b, _c, _d, _e;
    var style = _a.style, styleURL = _a.styleURL, waypoints = _a.waypoints, mapPadding = _a.mapPadding, accessToken = _a.accessToken, directionCoordinates = _a.directionCoordinates, _f = _a.initialState, initialState = _f === void 0 ? { location: CONST_1.default.MAPBOX.DEFAULT_COORDINATE, zoom: CONST_1.default.MAPBOX.DEFAULT_ZOOM } : _f, _g = _a.interactive, interactive = _g === void 0 ? true : _g, distanceInMeters = _a.distanceInMeters, unit = _a.unit, ref = _a.ref;
