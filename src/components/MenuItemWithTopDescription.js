...
function MenuItemWithTopDescription(_a) {
    var highlighted = _a.highlighted, outerWrapperStyle = _a.outerWrapperStyle, ref = _a.ref, props = __rest(_a, ["highlighted", "outerWrapperStyle", "ref"]);
