...
function MigratedUserWelcomeModal() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        Log_1.default.hmmm("[MigratedUserWelcomeModal] useEffect triggered - hasBeenAddedToNudgeMigration: ".concat(hasBeenAddedToNudgeMigration, ", hasDismissedTraining: ").concat(!!(dismissedProductTraining === null || dismissedProductTraining === void 0 ? void 0 : dismissedProductTraining.migratedUserWelcomeModal), ", shouldOpenSearch: ").concat(shouldOpenSearch));
    ...
    }, [dismissedProductTraining === null || dismissedProductTraining === void 0 ? void 0 : dismissedProductTraining.migratedUserWelcomeModal, setIsModalDisabled, tryNewDotMetadata, dismissedProductTrainingMetadata, tryNewDot, shouldOpenSearch, typeMenuSections]);
