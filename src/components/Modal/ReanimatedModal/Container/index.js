...
var GestureHandler_1 = require("./GestureHandler");
function Container(_a) {
    var style = _a.style, _b = _a.animationInTiming, animationInTiming = _b === void 0 ? CONST_1.default.MODAL.ANIMATION_TIMING.DEFAULT_IN : _b, _c = _a.animationOutTiming, animationOutTiming = _c === void 0 ? CONST_1.default.MODAL.ANIMATION_TIMING.DEFAULT_OUT : _c, onCloseCallBack = _a.onCloseCallBack, onOpenCallBack = _a.onOpenCallBack, animationIn = _a.animationIn, animationOut = _a.animationOut, type = _a.type, onSwipeComplete = _a.onSwipeComplete, swipeDirection = _a.swipeDirection, _d = _a.swipeThreshold, swipeThreshold = _d === void 0 ? 100 : _d, props = __rest(_a, ["style", "animationInTiming", "animationOutTiming", "onCloseCallBack", "onOpenCallBack", "animationIn", "animationOut", "type", "onSwipeComplete", "swipeDirection", "swipeThreshold"]);
