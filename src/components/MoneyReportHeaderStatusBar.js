...
function MoneyReportHeaderStatusBar(_a) {
    ...
    var messageContent = (0, react_1.useMemo)(function () {
        var messageArray = nextStep === null || nextStep === void 0 ? void 0 : nextStep.message;
        return (0, NextStepUtils_1.parseMessage)(messageArray);
    }, [nextStep === null || nextStep === void 0 ? void 0 : nextStep.message]);
    return (<react_native_1.View style={[styles.dFlex, styles.flexRow, styles.alignItemsCenter, styles.overflowHidden, styles.w100, styles.headerStatusBarContainer]}>
            <react_native_1.View style={[styles.mr3]}>
                <Icon_1.default src={(_b = ((nextStep === null || nextStep === void 0 ? void 0 : nextStep.icon) && (iconMap === null || iconMap === void 0 ? void 0 : iconMap[nextStep.icon]))) !== null && _b !== void 0 ? _b : Expensicons.Hourglass} height={variables_1.default.iconSizeSmall} width={variables_1.default.iconSizeSmall} fill={theme.icon}/>
            </react_native_1.View>
