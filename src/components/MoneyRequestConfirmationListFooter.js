...
function MoneyRequestConfirmationListFooter(_a) {
    ...
    var outstandingReportsByPolicyID = (0, useOnyx_1.default)(ONYXKEYS_1.default.DERIVED.OUTSTANDING_REPORTS_BY_POLICY_ID, {
        canBeMissing: true,
    })[0];
    var _r = (0, usePolicyForMovingExpenses_1.default)(), policyForMovingExpensesID = _r.policyForMovingExpensesID, shouldSelectPolicy = _r.shouldSelectPolicy;
    ...
    var decodedCategoryName = (0, react_1.useMemo)(function () { return (0, CategoryUtils_1.getDecodedCategoryName)(iouCategory); }, [iouCategory]);
    var allOutstandingReports = (0, react_1.useMemo)(function () {
        var outstandingReports = Object.values(outstandingReportsByPolicyID !== null && outstandingReportsByPolicyID !== void 0 ? outstandingReportsByPolicyID : {}).flatMap(function (outstandingReportsPolicy) { return Object.values(outstandingReportsPolicy !== null && outstandingReportsPolicy !== void 0 ? outstandingReportsPolicy : {}); });
        return outstandingReports.filter(function (report) {
            var reportNameValuePair = reportNameValuePairs === null || reportNameValuePairs === void 0 ? void 0 : reportNameValuePairs["".concat(ONYXKEYS_1.default.COLLECTION.REPORT_NAME_VALUE_PAIRS).concat(report === null || report === void 0 ? void 0 : report.reportID)];
            return !(0, ReportUtils_1.isArchivedReport)(reportNameValuePair);
        });
    }, [outstandingReportsByPolicyID, reportNameValuePairs]);
    var shouldShowTags = (0, react_1.useMemo)(function () { return (isPolicyExpenseChat || isUnreported || isCreatingTrackExpense) && (0, TagsOptionsListUtils_1.hasEnabledTags)(policyTagLists); }, [isCreatingTrackExpense, isPolicyExpenseChat, isUnreported, policyTagLists]);
    ...
    var shouldShowMap = isDistanceRequest && !isManualDistanceRequest && !!(hasErrors || hasPendingWaypoints || iouType !== CONST_1.default.IOU.TYPE.SPLIT || !isReadOnly);
     ...
     */
    var transactionReport = (transaction === null || transaction === void 0 ? void 0 : transaction.reportID) ? Object.values(allReports !== null && allReports !== void 0 ? allReports : {}).find(function (report) { return (report === null || report === void 0 ? void 0 : report.reportID) === transaction.reportID; }) : undefined;
    ...
    var selectedPolicy = allPolicies === null || allPolicies === void 0 ? void 0 : allPolicies["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID)];
    var shouldUseTransactionReport = (!!transactionReport && (0, ReportUtils_1.isReportOutstanding)(transactionReport, policyID, undefined, false)) || isUnreported;
    var availableOutstandingReports = (0, ReportUtils_1.getOutstandingReportsForUser)(policyID, (_e = selectedParticipants === null || selectedParticipants === void 0 ? void 0 : selectedParticipants.at(0)) === null || _e === void 0 ? void 0 : _e.ownerAccountID, allReports, reportNameValuePairs, false).sort(function (a, b) { var _a, _b, _c, _d; return localeCompare((_b = (_a = a === null || a === void 0 ? void 0 : a.reportName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '', (_d = (_c = b === null || b === void 0 ? void 0 : b.reportName) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : ''); });
    var iouReportID = (_f = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)]) === null || _f === void 0 ? void 0 : _f.iouReportID;
    var outstandingReportID = isPolicyExpenseChat ? (iouReportID !== null && iouReportID !== void 0 ? iouReportID : (_g = availableOutstandingReports.at(0)) === null || _g === void 0 ? void 0 : _g.reportID) : reportID;
    var _s = (0, react_1.useMemo)(function () {
        var reportIDToUse = shouldUseTransactionReport ? transaction === null || transaction === void 0 ? void 0 : transaction.reportID : outstandingReportID;
        if (!reportIDToUse) {
            // Even if we have no report to use we still need a report id for proper navigation
            return [(0, ReportUtils_1.generateReportID)(), undefined];
        }
        var reportToUse = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportIDToUse)];
        return [reportIDToUse, reportToUse];
    }, [allReports, shouldUseTransactionReport, transaction === null || transaction === void 0 ? void 0 : transaction.reportID, outstandingReportID]), selectedReportID = _s[0], selectedReport = _s[1];
    var reportName = (0, react_1.useMemo)(function () {
        var name = (0, ReportUtils_1.getReportName)(selectedReport, selectedPolicy);
        if (!name) {
    ...
    var shouldReportBeEditable = (isFromGlobalCreate ? allOutstandingReports.length > 1 : availableOutstandingReports.length > 1) && !(0, ReportUtils_1.isMoneyRequestReport)(reportID, allReports);
    var taxRates = (_h = policy === null || policy === void 0 ? void 0 : policy.taxRates) !== null && _h !== void 0 ? _h : null;
    // In Send Money and Split Bill with Scan flow, we don't allow the Merchant or Date to be edited. For distance requests, don't show the merchant as there's already another "Distance" menu item
    var shouldShowDate = shouldShowSmartScanFields || isDistanceRequest;
    ...
    var shouldShowBillable = ((_j = policy === null || policy === void 0 ? void 0 : policy.disabledFields) === null || _j === void 0 ? void 0 : _j.defaultBillable) === false;
    var shouldShowReimbursable = isPolicyExpenseChat && ((_k = policy === null || policy === void 0 ? void 0 : policy.disabledFields) === null || _k === void 0 ? void 0 : _k.reimbursable) !== true && !(0, TransactionUtils_1.isManagedCardTransaction)(transaction) && !isTypeInvoice;
    ...
    var shouldDisplayTagError = formError === 'violations.tagOutOfPolicy';
    ...
    var _t = receiptPath && receiptFilename ? (0, ReceiptUtils_1.getThumbnailAndImageURIs)(transaction, receiptPath, receiptFilename) : {}, receiptImage = _t.image, receiptThumbnail = _t.thumbnail, isThumbnail = _t.isThumbnail, fileExtension = _t.fileExtension, isLocalFile = _t.isLocalFile;
    ...
    var shouldNavigateToUpgradePath = !policyForMovingExpensesID && !shouldSelectPolicy;
    ...
    var previousTagsVisibility = (_l = (0, usePrevious_1.default)(tagVisibility.map(function (v) { return v.shouldShow; }))) !== null && _l !== void 0 ? _l : [];
    ...
    var fields = __spreadArray(__spreadArray([
        ...
        },
        {
            item: (<react_native_1.View key={translate('common.description')}>
                ...
                }} style={[styles.moneyRequestMenuItem]} titleStyle={styles.flex1} disabled={didConfirm} interactive={!isReadOnly} numberOfLinesTitle={2} rightLabel={isDescriptionRequired ? translate('common.required') : ''}/>
        ...
        },
        {
            item: (<MenuItemWithTopDescription_1.default key={translate('common.distance')} shouldShowRightIcon={!isReadOnly} title={DistanceRequestUtils_1.default.getDistanceForDisplay(hasRoute, distance, unit, rate, translate)} description={translate('common.distance')} style={[styles.moneyRequestMenuItem]} titleStyle={styles.flex1} onPress={function () {
                    ...
                    if (isManualDistanceRequest) {
                        Navigation_1.default.navigate(ROUTES_1.default.MONEY_REQUEST_STEP_DISTANCE_MANUAL.getRoute(action, iouType, transactionID, reportID, Navigation_1.default.getActiveRoute(), reportActionID));
                        return;
                    }
            ...
            item: (<MenuItemWithTopDescription_1.default key={translate('common.rate')} shouldShowRightIcon={!!rate && !isReadOnly} title={DistanceRequestUtils_1.default.getRateForDisplay(unit, rate, currency, translate, toLocaleDigit, isOffline)} description={translate('common.rate')} style={[styles.moneyRequestMenuItem]} titleStyle={styles.flex1} onPress={function () {
                    ...
                    if (!isPolicyExpenseChat) {
                        Navigation_1.default.navigate(ROUTES_1.default.MONEY_REQUEST_UPGRADE.getRoute({
                            ...
                            reportID: reportID,
                            upgradePath: CONST_1.default.UPGRADE_PATHS.DISTANCE_RATES,
                            backTo: Navigation_1.default.getActiveRoute(),
                ...
                }} brickRoadIndicator={shouldDisplayDistanceRateError ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined} disabled={didConfirm} interactive={!!rate && !isReadOnly}/>),
            shouldShow: isDistanceRequest,
        },
        {
        ...
        {
            item: (<MenuItemWithTopDescription_1.default key={translate('common.category')} shouldShowRightIcon={!isReadOnly} title={decodedCategoryName} description={translate('common.category')} numberOfLinesTitle={2} onPress={function () {
                    if (!transactionID) {
                        return;
                    }
                    if (shouldNavigateToUpgradePath) {
                        Navigation_1.default.navigate(ROUTES_1.default.MONEY_REQUEST_UPGRADE.getRoute({
                            ...
                            transactionID: transactionID,
                            reportID: reportID,
                            backTo: ROUTES_1.default.MONEY_REQUEST_STEP_CATEGORY.getRoute(action, iouType, transactionID, reportID, Navigation_1.default.getActiveRoute(), reportActionID),
                            upgradePath: CONST_1.default.UPGRADE_PATHS.CATEGORIES,
                        }));
                    }
                    else if (!policy && shouldSelectPolicy) {
                        Navigation_1.default.navigate(ROUTES_1.default.SET_DEFAULT_WORKSPACE.getRoute(ROUTES_1.default.MONEY_REQUEST_STEP_CATEGORY.getRoute(action, iouType, transactionID, reportID, Navigation_1.default.getActiveRoute(), reportActionID)));
                    }
                    else {
        ...
        return {
            item: (<MenuItemWithTopDescription_1.default highlighted={shouldShow && !(0, TransactionUtils_1.getTagForDisplay)(transaction, index) && !prevShouldShow} key={name} shouldShowRightIcon={!isReadOnly} title={(0, TransactionUtils_1.getTagForDisplay)(transaction, index)} description={name} shouldShowBasicTitle shouldShowDescriptionOnTop numberOfLinesTitle={2} onPress={function () {
                ...
                }} style={[styles.moneyRequestMenuItem]} brickRoadIndicator={shouldDisplayTagError && !!(0, TransactionUtils_1.getTagForDisplay)(transaction, index) ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined} errorText={shouldDisplayTagError && !!(0, TransactionUtils_1.getTagForDisplay)(transaction, index) ? translate(formError) : ''} disabled={didConfirm} interactive={!isReadOnly} rightLabel={isTagRequired ? translate('common.required') : ''}/>),
        ...
        },
        {
            item: (<react_native_1.View key={expensify_common_1.Str.UCFirst(translate('iou.reimbursable'))} style={[styles.flexRow, styles.justifyContentBetween, styles.alignItemsCenter, styles.ml5, styles.mr8, styles.optionRow]}>
                    <ToggleSettingsOptionRow_1.default switchAccessibilityLabel={expensify_common_1.Str.UCFirst(translate('iou.reimbursable'))} title={expensify_common_1.Str.UCFirst(translate('iou.reimbursable'))} onToggle={function (isOn) { return onToggleReimbursable === null || onToggleReimbursable === void 0 ? void 0 : onToggleReimbursable(isOn); }} isActive={iouIsReimbursable} disabled={isReadOnly} wrapperStyle={styles.flex1}/>
                </react_native_1.View>),
    ...
    var _u = (0, PerDiemRequestUtils_1.getTimeDifferenceIntervals)(transaction), firstDay = _u.firstDay, tripDays = _u.tripDays, lastDay = _u.lastDay;
    ...
    // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
    var hasReceiptImageOrThumbnail = receiptImage || receiptThumbnail;
    return (<>
            ...
            {(!shouldShowMap || isManualDistanceRequest) && (<react_native_1.View style={!hasReceiptImageOrThumbnail && !showReceiptEmptyState ? undefined : styles.mv3}>
                    {hasReceiptImageOrThumbnail
                ? receiptThumbnailContent
                : showReceiptEmptyState && (<ReceiptEmptyState_1.default onPress={function () {
                        if (!transactionID) {
                            return;
                        }
