...
function MoneyRequestViewReportFields(_a) {
    ...
    var sortedPolicyReportFields = (0, react_1.useMemo)(function () {
        ...
        return fields
            ...
            var isFieldDisabled = (0, ReportUtils_1.isReportFieldDisabledForUser)(report, field, policy);
            var fieldKey = (0, ReportUtils_1.getReportFieldKey)(field.fieldID);
            var violation = isFieldDisabled ? undefined : (0, ReportUtils_1.getFieldViolation)(violations, field);
