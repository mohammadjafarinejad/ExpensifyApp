...
function SearchSidebar(_a) {
    ...
    var currentSearchResults = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.SNAPSHOT).concat(currentSearchResultsKey), {
        canBeMissing: true,
        selector: Snapshot_1.searchResultsSelector,
    })[0];
    (0, react_1.useEffect)(function () {
        if (!(currentSearchResults === null || currentSearchResults === void 0 ? void 0 : currentSearchResults.type)) {
            return;
        }
        setLastSearchType(currentSearchResults.type);
    }, [lastSearchType, queryJSON, setLastSearchType, currentSearchResults]);
    var shouldShowLoadingState = (route === null || route === void 0 ? void 0 : route.name) === SCREENS_1.default.SEARCH.MONEY_REQUEST_REPORT ? false : !isOffline && !!(currentSearchResults === null || currentSearchResults === void 0 ? void 0 : currentSearchResults.isLoading);
