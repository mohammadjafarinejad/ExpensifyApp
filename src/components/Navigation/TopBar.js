...
var authTokenTypeSelector = function (session) { return session && { authTokenType: session.authTokenType }; };
function TopBar(_a) {
    ...
    var session = (0, useOnyx_1.default)(ONYXKEYS_1.default.SESSION, { selector: authTokenTypeSelector, canBeMissing: true })[0];
