...
function OfflineWithFeedback(_a) {
    ...
    var applyStrikeThrough = (0, react_1.useCallback)(function (childrenProp) {
        var strikeThroughChildren = (0, mapChildrenFlat_1.default)(childrenProp, function (child) {
            ...
            var props = {
                style: StyleUtils.combineStyles((_a = childProps.style) !== null && _a !== void 0 ? _a : [], styles.offlineFeedbackDeleted, styles.userSelectNone),
            };
    ...
    return (<react_native_1.View style={style}>
            ...
            {!hideChildren && (<react_native_1.View style={[needsOpacity ? styles.offlineFeedbackPending : styles.offlineFeedbackDefault, contentContainerStyle]} needsOffscreenAlphaCompositing={shouldRenderOffscreen_1.default ? needsOpacity && needsOffscreenAlphaCompositing : undefined}>
                    <CustomStylesForChildrenProvider_1.default style={needsStrikeThrough ? [styles.offlineFeedbackDeleted, styles.userSelectNone] : null}>{children}</CustomStylesForChildrenProvider_1.default>
                </react_native_1.View>)}
            {shouldShowErrorMessages && !shouldDisplayErrorAbove && (<ErrorMessageRow_1.default errors={errors} errorRowStyles={errorRowStyles} onClose={onClose} canDismissError={canDismissError} dismissError={dismissError}/>)}
        </react_native_1.View>);
}
