...
function OptionsListContextProvider(_a) {
    ...
    }, [changedReportActions, personalDetails, reportAttributes === null || reportAttributes === void 0 ? void 0 : reportAttributes.reports]);
    /**
    ...
    (0, react_1.useEffect)(function () {
        ...
        Object.keys(personalDetails).forEach(function (accountID) {
            ...
            Object.values(reports !== null && reports !== void 0 ? reports : {})
                .filter(function (report) { var _a; return accountID in ((_a = report === null || report === void 0 ? void 0 : report.participants) !== null && _a !== void 0 ? _a : {}) || ((0, ReportUtils_1.isSelfDM)(report) && (report === null || report === void 0 ? void 0 : report.ownerAccountID) === Number(accountID)); })
...
var useOptionsList = function (options) {
    ...
    var prevIsInitialized = (0, usePrevious_1.default)(areOptionsInitialized);
    (0, react_1.useEffect)(function () {
        ...
        prevOptions.current = optionsList;
        var hasInitializedChanged = prevIsInitialized !== areOptionsInitialized;
        if (areOptionsEqual) {
