...
function OptionRow(_a) {
    ...
    var option = _a.option, onSelectRow = _a.onSelectRow, style = _a.style, hoverStyle = _a.hoverStyle, selectedStateButtonText = _a.selectedStateButtonText, keyForList = _a.keyForList, _j = _a.isDisabled, isOptionDisabled = _j === void 0 ? false : _j, _k = _a.isMultilineSupported, isMultilineSupported = _k === void 0 ? false : _k, _l = _a.shouldShowSelectedStateAsButton, shouldShowSelectedStateAsButton = _l === void 0 ? false : _l, _m = _a.highlightSelected, highlightSelected = _m === void 0 ? false : _m, _o = _a.shouldHaveOptionSeparator, shouldHaveOptionSeparator = _o === void 0 ? false : _o, _p = _a.showTitleTooltip, showTitleTooltip = _p === void 0 ? false : _p, _q = _a.optionIsFocused, optionIsFocused = _q === void 0 ? false : _q, _r = _a.boldStyle, boldStyle = _r === void 0 ? false : _r, _s = _a.onSelectedStatePressed, onSelectedStatePressed = _s === void 0 ? function () { } : _s, backgroundColor = _a.backgroundColor, _t = _a.isSelected, isSelected = _t === void 0 ? false : _t, _u = _a.showSelectedState, showSelectedState = _u === void 0 ? false : _u, _v = _a.shouldDisableRowInnerPadding, shouldDisableRowInnerPadding = _v === void 0 ? false : _v, _w = _a.shouldPreventDefaultFocusOnSelectRow, shouldPreventDefaultFocusOnSelectRow = _w === void 0 ? false : _w;
    var theme = (0, useTheme_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var StyleUtils = (0, useStyleUtils_1.default)();
    var _x = (0, useLocalize_1.default)(), translate = _x.translate, localeCompare = _x.localeCompare;
    var pressableRef = (0, react_1.useRef)(null);
    var _y = (0, react_1.useState)(isOptionDisabled), isDisabled = _y[0], setIsDisabled = _y[1];
    ...
    var displayNamesWithTooltips = (0, ReportUtils_1.getDisplayNamesWithTooltips)(((_g = option.participantsList) !== null && _g !== void 0 ? _g : (option.accountID ? [option] : [])).slice(0, 10), shouldUseShortFormInTooltip, localeCompare);
    var subscriptColor = theme.appBG;
    if (optionIsFocused) {
        subscriptColor = focusedBackgroundColor;
    }
    // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
    var reportID = ((_h = option.iouReportID) !== null && _h !== void 0 ? _h : option.reportID) || undefined;
