 ...
 * anchor position.
 */
function PopoverWithMeasuredContentBase(_a) {
    ...
    } : _c, children = _a.children, _d = _a.withoutOverlay, withoutOverlay = _d === void 0 ? false : _d, _e = _a.fullscreen, fullscreen = _e === void 0 ? true : _e, _f = _a.shouldSetModalVisibility, shouldSetModalVisibility = _f === void 0 ? true : _f, _g = _a.statusBarTranslucent, statusBarTranslucent = _g === void 0 ? true : _g, _h = _a.navigationBarTranslucent, navigationBarTranslucent = _h === void 0 ? true : _h, _j = _a.avoidKeyboard, avoidKeyboard = _j === void 0 ? false : _j, _k = _a.hideModalContentWhileAnimating, hideModalContentWhileAnimating = _k === void 0 ? false : _k, _l = _a.anchorDimensions, anchorDimensions = _l === void 0 ? {
        height: 0,
        width: 0,
    } : _l, _m = _a.shouldSwitchPositionIfOverflow, shouldSwitchPositionIfOverflow = _m === void 0 ? false : _m, _o = _a.shouldHandleNavigationBack, shouldHandleNavigationBack = _o === void 0 ? false : _o, shouldEnableNewFocusManagement = _a.shouldEnableNewFocusManagement, _p = _a.shouldMeasureAnchorPositionFromTop, shouldMeasureAnchorPositionFromTop = _p === void 0 ? false : _p, _q = _a.shouldSkipRemeasurement, shouldSkipRemeasurement = _q === void 0 ? false : _q, props = __rest(_a, ["popoverDimensions", "anchorPosition", "isVisible", "anchorAlignment", "children", "withoutOverlay", "fullscreen", "shouldSetModalVisibility", "statusBarTranslucent", "navigationBarTranslucent", "avoidKeyboard", "hideModalContentWhileAnimating", "anchorDimensions", "shouldSwitchPositionIfOverflow", "shouldHandleNavigationBack", "shouldEnableNewFocusManagement", "shouldMeasureAnchorPositionFromTop", "shouldSkipRemeasurement"]);
    ...
    var _r = (0, useWindowDimensions_1.default)(), windowWidth = _r.windowWidth, windowHeight = _r.windowHeight;
    var _s = (0, react_1.useState)(popoverDimensions.width), popoverWidth = _s[0], setPopoverWidth = _s[1];
    var _t = (0, react_1.useState)(popoverDimensions.height), popoverHeight = _t[0], setPopoverHeight = _t[1];
    var _u = (0, react_1.useState)(popoverWidth > 0 && popoverHeight > 0), isContentMeasured = _u[0], setIsContentMeasured = _u[1];
    var prevIsVisible = (0, usePrevious_1.default)(isVisible);
    var prevAnchorPosition = (0, usePrevious_1.default)(anchorPosition);
    var shouldHideSidePanel = (0, useSidePanel_1.default)().shouldHideSidePanel;
    var availableWidth = windowWidth - (shouldHideSidePanel ? 0 : variables_1.default.sideBarWidth);
    var prevWindowDimensions = (0, usePrevious_1.default)({ availableWidth: availableWidth, windowHeight: windowHeight });
    ...
    if (!prevIsVisible && isVisible && isContentMeasured && !shouldSkipRemeasurement) {
        ...
        var hasWindowSizeChanged = !(0, fast_equals_1.deepEqual)(prevWindowDimensions, { availableWidth: availableWidth, windowHeight: windowHeight });
        // Only reset if:
    ...
    var positionCalculations = (0, react_1.useMemo)(function () {
        var horizontalShift = PopoverWithMeasuredContentUtils_1.default.computeHorizontalShift(adjustedAnchorPosition.left, popoverWidth, availableWidth);
    ...
    return isContentMeasured ? (<Popover_1.default shouldHandleNavigationBack={shouldHandleNavigationBack} popoverDimensions={{ height: popoverHeight, width: popoverWidth }} anchorAlignment={anchorAlignment} isVisible={isVisible} withoutOverlay={withoutOverlay} fullscreen={fullscreen} shouldSetModalVisibility={shouldSetModalVisibility} statusBarTranslucent={statusBarTranslucent} navigationBarTranslucent={navigationBarTranslucent} avoidKeyboard={avoidKeyboard} hideModalContentWhileAnimating={hideModalContentWhileAnimating} modalId={modalId} shouldEnableNewFocusManagement={shouldEnableNewFocusManagement} 
...
exports.default = react_1.default.memo(PopoverWithMeasuredContentBase, function (prevProps, nextProps) {
