...
function NativeGenericPressable(_a) {
    var _b;
    var ref = _a.ref, props = __rest(_a, ["ref"]);
    return (<BaseGenericPressable_1.default focusable accessible accessibilityHint={(_b = props.accessibilityHint) !== null && _b !== void 0 ? _b : props.accessibilityLabel} 
