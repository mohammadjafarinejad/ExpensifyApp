...
function PressableWithFeedback(_a) {
    var children = _a.children, _b = _a.wrapperStyle, wrapperStyle = _b === void 0 ? [] : _b, _c = _a.needsOffscreenAlphaCompositing, needsOffscreenAlphaCompositing = _c === void 0 ? false : _c, _d = _a.pressDimmingValue, pressDimmingValue = _d === void 0 ? variables_1.default.pressDimValue : _d, _e = _a.hoverDimmingValue, hoverDimmingValue = _e === void 0 ? variables_1.default.hoverDimValue : _e, dimAnimationDuration = _a.dimAnimationDuration, shouldBlendOpacity = _a.shouldBlendOpacity, ref = _a.ref, rest = __rest(_a, ["children", "wrapperStyle", "needsOffscreenAlphaCompositing", "pressDimmingValue", "hoverDimmingValue", "dimAnimationDuration", "shouldBlendOpacity", "ref"]);
