...
function PrevNextButtons(_a) {
    ...
    return (<react_native_1.View style={styles.flexRow}>
            <PressableWithFeedback_1.default accessible accessibilityRole={CONST_1.default.ROLE.BUTTON} accessibilityLabel={CONST_1.default.ROLE.BUTTON} disabled={isPrevButtonDisabled} style={[styles.h7, styles.mr1, styles.alignItemsCenter, styles.justifyContentCenter]} onPress={onPrevious}>
            ...
            <PressableWithFeedback_1.default accessible accessibilityRole={CONST_1.default.ROLE.BUTTON} accessibilityLabel={CONST_1.default.ROLE.BUTTON} disabled={isNextButtonDisabled} style={[styles.h7, styles.alignItemsCenter, styles.justifyContentCenter]} onPress={onNext}>
