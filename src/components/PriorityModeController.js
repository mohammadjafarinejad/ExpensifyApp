...
var isInFocusModeSelector = function (priorityMode) { return priorityMode === CONST_1.default.PRIORITY_MODE.GSD; };
/**
...
function PriorityModeController() {
    ...
    var _a = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_PRIORITY_MODE, { selector: isInFocusModeSelector, canBeMissing: true }), isInFocusMode = _a[0], isInFocusModeMetadata = _a[1];
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_TRY_FOCUS_MODE, { canBeMissing: true }), hasTriedFocusMode = _b[0], hasTriedFocusModeMetadata = _b[1];
    ...
    var _c = (0, react_1.useState)(false), shouldShowModal = _c[0], setShouldShowModal = _c[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (isLoadingReportData !== false ||
            !accountID ||
            (0, isLoadingOnyxValue_1.default)(isInFocusModeMetadata, hasTriedFocusModeMetadata) ||
    ...
    (0, react_1.useEffect)(function () {
        ...
        var isNavigatingToPriorityModePage = currentRouteName === SCREENS_1.default.SETTINGS.PREFERENCES.PRIORITY_MODE;
