...
function PushRowModal(_a) {
    ...
    return (<Modal_1.default onClose={handleClose} isVisible={isVisible} type={CONST_1.default.MODAL.MODAL_TYPE.RIGHT_DOCKED} onModalHide={handleClose} shouldUseCustomBackdrop shouldHandleNavigationBack>
            <ScreenWrapper_1.default includePaddingTop={false} includeSafeAreaPaddingBottom={false} testID={PushRowModal.displayName}>
                ...
                <SelectionListWithSections_1.default headerMessage={headerMessage} textInputLabel={searchInputTitle} textInputValue={searchValue} onChangeText={setSearchValue} onSelectRow={handleSelectRow} sections={[{ data: searchResults }]} initiallyFocusedOptionKey={selectedOption} showScrollIndicator shouldShowTooltips={false} ListItem={RadioListItem_1.default}/>
