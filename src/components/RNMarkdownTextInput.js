...
function RNMarkdownTextInputWithRef(_a) {
    var maxLength = _a.maxLength, parser = _a.parser, ref = _a.ref, _b = _a.forwardedFSClass, forwardedFSClass = _b === void 0 ? CONST_1.default.FULLSTORY.CLASS.MASK : _b, props = __rest(_a, ["maxLength", "parser", "ref", "forwardedFSClass"]);
    var theme = (0, useTheme_1.default)();
    var _c = (0, useShortMentionsList_1.default)(), availableLoginsList = _c.availableLoginsList, currentUserMentions = _c.currentUserMentions;
    var mentionsSharedVal = (0, react_native_reanimated_1.useSharedValue)(availableLoginsList);
