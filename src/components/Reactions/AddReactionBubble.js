    ...
    var onPress = function () {
        ...
        var openPicker = function (refParam, anchorOrigin) {
            ...
            (0, EmojiPickerAction_1.showEmojiPicker)({
                ...
                onEmojiSelected: function (emojiCode, emojiObject) {
                    onSelectEmoji(emojiObject);
                },
                emojiPopoverAnchor: refParam !== null && refParam !== void 0 ? refParam : ref,
                anchorOrigin: anchorOrigin,
                onWillShow: onWillShowPicker,
                id: reportAction.reportActionID,
                composerToRefocusOnClose: (_a = ReportActionContextMenu_1.contextMenuRef.current) === null || _a === void 0 ? void 0 : _a.composerToRefocusOnCloseEmojiPicker,
            });
        };
