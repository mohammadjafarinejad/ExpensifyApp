...
function MiniQuickEmojiReactions(_a) {
    ...
    var _e = (0, useOnyx_1.default)(ONYXKEYS_1.default.PREFERRED_EMOJI_SKIN_TONE, { canBeMissing: true })[0], preferredSkinTone = _e === void 0 ? CONST_1.default.EMOJI_DEFAULT_SKIN_TONE : _e;
    var _f = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS_REACTIONS).concat(reportActionID), { canBeMissing: true })[0], emojiReactions = _f === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _f;
    var openEmojiPicker = function () {
        onPressOpenPicker();
        (0, EmojiPickerAction_1.showEmojiPicker)({
            onModalHide: onEmojiPickerClosed,
            onEmojiSelected: function (_emojiCode, emojiObject) {
