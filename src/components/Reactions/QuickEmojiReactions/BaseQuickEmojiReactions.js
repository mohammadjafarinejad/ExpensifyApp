...
function BaseQuickEmojiReactions(_a) {
    ...
    var _e = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS_REACTIONS).concat(reportActionID), { canBeMissing: true })[0], emojiReactions = _e === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _e;
