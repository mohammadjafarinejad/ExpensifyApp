...
function BaseRecordTroubleshootDataToolMenu(_a) {
    ...
    var _g = (0, react_1.useState)(), profileTracePath = _g[0], setProfileTracePath = _g[1];
    ...
    var onToggleProfiling = (0, react_1.useCallback)(function () {
        ...
        (0, ProfilingTool_1.default)(shouldProfiling);
        return function () {
            Performance_1.default.disableMonitoring();
        };
        ...
        if ((0, getPlatform_1.default)() === CONST_1.default.PLATFORM.WEB) {
            ...
            onStopProfiling(true, newFileName).then(function (path) {
                ...
                react_native_blob_util_1.default.fs
                    ...
                    .stat(!path.startsWith('content://media/') && path.match(/\/downloads\/\d+$/) ? "content://media/".concat(path) : path)
                    .then(function (_a) {
                    var realPath = _a.path;
                    return setProfileTracePath(realPath);
                })
                    .catch(function () { return setProfileTracePath(path); });
                getAppInfo().then(function (appInfo) {
                    var _a;
                    (_a = zipRef.current) === null || _a === void 0 ? void 0 : _a.file(infoFileName, appInfo);
                    onDisableLogging(logsWithParsedMessages).then(function () {
    ...
    (0, react_1.useEffect)(function () {
        ...
        setShareUrls(["file://".concat(profileTracePath), "file://".concat(file === null || file === void 0 ? void 0 : file.path)]);
