...
function MoneyRequestAction(_a) {
    var allReports = _a.allReports, action = _a.action, chatReportID = _a.chatReportID, requestReportID = _a.requestReportID, reportID = _a.reportID, isMostRecentIOUReportAction = _a.isMostRecentIOUReportAction, contextMenuAnchor = _a.contextMenuAnchor, _b = _a.checkIfContextMenuActive, checkIfContextMenuActive = _b === void 0 ? function () { } : _b, _c = _a.isHovered, isHovered = _c === void 0 ? false : _c, style = _a.style, _d = _a.isWhisper, isWhisper = _d === void 0 ? false : _d, _e = _a.shouldDisplayContextMenu, shouldDisplayContextMenu = _e === void 0 ? true : _e;
    var _f = (0, react_1.useContext)(ReportActionItemContext_1.default), shouldOpenReportInRHP = _f.shouldOpenReportInRHP, onPreviewPressed = _f.onPreviewPressed;
    ...
    var iouReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(requestReportID)];
    ...
    var onMoneyRequestPreviewPressed = function () {
        var _a, _b;
        if (onPreviewPressed && (action === null || action === void 0 ? void 0 : action.childReportID)) {
            onPreviewPressed(action === null || action === void 0 ? void 0 : action.childReportID);
            return;
        }
        ...
        if (!(action === null || action === void 0 ? void 0 : action.childReportID) && transactionID && action.reportActionID) {
            var transactionThreadReport = (0, Report_1.createTransactionThreadReport)(iouReport, action);
            if (shouldOpenReportInRHP) {
                Navigation_1.default.navigate(ROUTES_1.default.SEARCH_REPORT.getRoute({ reportID: transactionThreadReport === null || transactionThreadReport === void 0 ? void 0 : transactionThreadReport.reportID, backTo: Navigation_1.default.getActiveRoute() }));
                return;
            }
            Navigation_1.default.navigate(ROUTES_1.default.REPORT_WITH_ID.getRoute(transactionThreadReport === null || transactionThreadReport === void 0 ? void 0 : transactionThreadReport.reportID, undefined, undefined, Navigation_1.default.getActiveRoute()));
            return;
        }
        if (shouldOpenReportInRHP) {
            Navigation_1.default.navigate(ROUTES_1.default.SEARCH_REPORT.getRoute({ reportID: action === null || action === void 0 ? void 0 : action.childReportID, backTo: Navigation_1.default.getActiveRoute() }));
            return;
        }
        Navigation_1.default.navigate(ROUTES_1.default.REPORT_WITH_ID.getRoute(action === null || action === void 0 ? void 0 : action.childReportID, undefined, undefined, Navigation_1.default.getActiveRoute()));
    };
