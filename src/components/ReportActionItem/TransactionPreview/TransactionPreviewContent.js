...
var UserInfoCellsWithArrow_1 = require("@components/SelectionListWithSections/Search/UserInfoCellsWithArrow");
...
function TransactionPreviewContent(_a) {
    ...
    var isParentPolicyExpenseChat = (0, ReportUtils_1.isPolicyExpenseChat)(chatReport);
    var transactionDetails = (0, react_1.useMemo)(function () { var _a; return (_a = (0, ReportUtils_1.getTransactionDetails)(transaction, undefined, policy, isParentPolicyExpenseChat)) !== null && _a !== void 0 ? _a : {}; }, [transaction, policy, isParentPolicyExpenseChat]);
    ...
    var canEdit = isIOUActionType && (0, ReportUtils_1.canEditMoneyRequest)(action, isChatReportArchived, report, policy, transaction);
    ...
    var violationMessage = firstViolation ? ViolationsUtils_1.default.getViolationTranslation(firstViolation, translate, canEdit, undefined, companyCardPageURL) : undefined;
    ...
    var transactionWrapperStyles = [styles.border, styles.moneyRequestPreviewBox, (isIOUSettled || isApproved) && isSettlementOrApprovalPartial && styles.offlineFeedbackPending];
                ...
                styles.gap2,
                        ...
                        styles.flexShrink1,
                                                    ...
                                                    <Text_1.default numberOfLines={1} style={[isDeleted && styles.lineThrough, styles.textMicroSupporting, styles.pre, styles.flexShrink1]}>
                                                        {(0, CategoryUtils_1.getDecodedCategoryName)(category !== null && category !== void 0 ? category : '')}
                                                    </Text_1.default>
                                                </react_native_1.View>)}
