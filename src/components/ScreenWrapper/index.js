...
var HybridApp_2 = require("@userActions/HybridApp");
...
function ScreenWrapper(_a) {
    ...
    var _g = (0, useSafeAreaPaddings_1.default)(isUsingEdgeToEdgeMode), insets = _g.insets, safeAreaPaddingBottomStyle = _g.safeAreaPaddingBottomStyle;
    ...
    var _h = (0, react_1.useContext)(ScreenWrapperOfflineIndicatorContext_1.default), addSafeAreaPadding = _h.addSafeAreaPadding, showOnSmallScreens = _h.showOnSmallScreens, showOnWideScreens = _h.showOnWideScreens, originalValues = _h.originalValues;
    ...
    var displayWideScreenOfflineIndicator = !isSmallScreenWidth && ((_c = shouldShowWideScreenOfflineIndicator !== null && shouldShowWideScreenOfflineIndicator !== void 0 ? shouldShowWideScreenOfflineIndicator : showOnWideScreens) !== null && _c !== void 0 ? _c : false);
    ...
    var _j = (0, useOnyx_1.default)(ONYXKEYS_1.default.HYBRID_APP, { selector: HybridApp_1.isSingleNewDotEntrySelector, canBeMissing: true })[0], isSingleNewDotEntry = _j === void 0 ? false : _j;
    (0, native_1.usePreventRemove)(isSingleNewDotEntry && !!(initialURL === null || initialURL === void 0 ? void 0 : initialURL.endsWith(Navigation_1.default.getActiveRouteWithoutParams())), function () {
        if (!CONFIG_1.default.IS_HYBRID_APP) {
            return;
        }
        (0, HybridApp_2.closeReactNativeApp)({ shouldSetNVP: false });
    });
