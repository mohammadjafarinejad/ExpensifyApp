...
function SearchMultipleSelectionPicker(_a) {
    ...
    var _e = (0, react_1.useState)(initiallySelectedItems !== null && initiallySelectedItems !== void 0 ? initiallySelectedItems : []), selectedItems = _e[0], setSelectedItems = _e[1];
    ...
    var _f = (0, react_1.useMemo)(function () {
        var selectedItemsSection = selectedItems
            ...
            .sort(function (a, b) { return (0, SearchQueryUtils_1.sortOptionsWithEmptyValue)(a.value.toString(), b.value.toString(), localeCompare); })
    ...
    }, [selectedItems, items, pickerTitle, debouncedSearchTerm, localeCompare]), sections = _f.sections, noResultsFound = _f.noResultsFound;
