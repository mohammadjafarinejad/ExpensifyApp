...
function SearchPageHeaderInput(_a) {
    ...
    var queryText = (0, SearchQueryUtils_1.buildUserReadableQueryString)(queryJSON, personalDetails, reports, taxRates, allCards, allFeeds, policies, currentUserAccountID);
    ...
    (0, react_1.useEffect)(function () {
        var substitutionsMap = (0, buildSubstitutionsMap_1.buildSubstitutionsMap)(originalInputQuery, personalDetails, reports, taxRates, allCards, allFeeds, policies, currentUserAccountID);
    ...
    var submitSearch = (0, react_1.useCallback)(function (queryString, shouldSkipAmountConversion) {
        ...
        var updatedQuery = (0, SearchQueryUtils_1.getQueryWithUpdatedValues)(queryWithSubstitutions, shouldSkipAmountConversion);
        if (!updatedQuery) {
            return;
        }
