...
function SearchTypeMenuPopover(_a) {
    ...
    return (<>
            ...
            {!delayPopoverMenuFirstRender && (<PopoverMenu_1.default menuItems={allMenuItems} isVisible={isPopoverVisible} anchorPosition={styles.createMenuPositionSearchBar(windowHeight)} onClose={closeMenu} onItemSelected={closeMenu} anchorRef={buttonRef} shouldUseScrollView shouldUseModalPaddingStyle={false} innerContainerStyle={{ paddingBottom: unmodifiedPaddings.bottom }} shouldAvoidSafariException scrollContainerStyle={styles.pv0}/>)}
