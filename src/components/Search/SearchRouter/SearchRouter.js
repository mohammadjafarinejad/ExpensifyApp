...
function getContextualSearchAutocompleteKey(item) {
    ...
    if (item.roomType === CONST_1.default.SEARCH.DATA_TYPES.EXPENSE) {
        return "".concat(CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.POLICY_ID, ":").concat(item.policyID ? (0, PolicyUtils_1.getPolicyNameByID)(item.policyID) : '');
    }
}
function getContextualSearchQuery(item) {
    ...
    switch (item.roomType) {
        case CONST_1.default.SEARCH.DATA_TYPES.EXPENSE:
            additionalQuery += " ".concat(CONST_1.default.SEARCH.SEARCH_USER_FRIENDLY_KEYS.POLICY_ID, ":").concat((0, SearchQueryUtils_1.sanitizeSearchValue)(item.policyID ? (0, PolicyUtils_1.getPolicyNameByID)(item.policyID) : ''));
            break;
...
function SearchRouter(_a) {
    var onRouterClose = _a.onRouterClose, shouldHideInputCaret = _a.shouldHideInputCaret, isSearchRouterDisplayed = _a.isSearchRouterDisplayed, ref = _a.ref;
    ...
    var getAdditionalSections = (0, react_1.useCallback)(function (_a) {
        ...
        if (!reportForContextualSearch) {
            var report = reports === null || reports === void 0 ? void 0 : reports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(contextualReportID)];
            if (!report) {
                return undefined;
            }
            var option = (0, OptionsListUtils_1.createOptionFromReport)(report, personalDetails);
            ...
            if ((0, SearchQueryListItem_1.isSearchQueryItem)(item)) {
                ...
                if (item.searchItemType === CONST_1.default.SEARCH.SEARCH_ROUTER_ITEM_TYPE.CONTEXTUAL_SUGGESTION) {
                    ...
                    if (isNameField && fieldKey) {
                        ...
                        if (keyIndex !== -1) {
                            var afterFieldKey = textInputValue.substring(keyIndex + fieldPattern.length);
    ...
    var updateAndScrollToFocusedIndex = (0, react_1.useCallback)(function () { var _a; return (_a = listRef.current) === null || _a === void 0 ? void 0 : _a.updateAndScrollToFocusedIndex(1, true); }, []);
