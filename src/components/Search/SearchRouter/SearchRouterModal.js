...
function SearchRouterModal() {
    ...
    return (<Modal_1.default type={modalType} isVisible={isSearchRouterDisplayed} innerContainerStyle={{ paddingTop: viewportOffsetTop }} popoverAnchorPosition={{ right: 6, top: 6 }} fullscreen swipeDirection={shouldUseNarrowLayout ? CONST_1.default.SWIPE_DIRECTION.RIGHT : undefined} onClose={closeSearchRouter} onModalHide={function () { return setShouldHideInputCaret(isMobileWebIOS); }} onModalShow={function () { return setShouldHideInputCaret(false); }} shouldApplySidePanelOffset={!shouldUseNarrowLayout} enableEdgeToEdgeBottomSafeAreaPadding>
