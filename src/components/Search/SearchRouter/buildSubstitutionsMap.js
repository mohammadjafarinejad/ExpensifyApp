 ...
 * }
 */
function buildSubstitutionsMap(query, personalDetails, reports, allTaxRates, cardList, cardFeeds, policies, currentUserAccountID) {
    ...
    var substitutionsMap = searchAutocompleteQueryRanges.reduce(function (map, range) {
        ...
        if (filterKey === CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.TAX_RATE) {
            ...
            var displayValue = (0, SearchQueryUtils_1.getFilterDisplayValue)(filterKey, filterValue, personalDetails, reports, cardList, cardFeeds, policies, currentUserAccountID);
