...
function SearchBar(_a) {
    ...
    return (<>
            <react_native_1.View style={[styles.searchBarMargin, styles.searchBarWidth(shouldUseNarrowLayout), style]}>
            ...
            {!!shouldShowEmptyState && inputValue.length !== 0 && (<react_native_1.View style={[styles.ph5, styles.pt3, styles.pb5]}>
                    <Text_1.default style={[styles.textNormal, styles.colorMuted]}>{translate('common.noResultsFoundMatching', inputValue)}</Text_1.default>
                </react_native_1.View>)}
        </>);
}
