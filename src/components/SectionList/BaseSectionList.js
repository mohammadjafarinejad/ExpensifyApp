...
function BaseSectionList(_a) {
    var addBottomSafeAreaPadding = _a.addBottomSafeAreaPadding, addOfflineIndicatorBottomSafeAreaPadding = _a.addOfflineIndicatorBottomSafeAreaPadding, contentContainerStyleProp = _a.contentContainerStyle, ref = _a.ref, restProps = __rest(_a, ["addBottomSafeAreaPadding", "addOfflineIndicatorBottomSafeAreaPadding", "contentContainerStyle", "ref"]);
