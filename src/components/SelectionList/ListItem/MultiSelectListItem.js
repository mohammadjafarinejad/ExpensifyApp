...
function MultiSelectListItem(_a) {
    ...
    var checkboxComponent = (0, react_1.useCallback)(function () {
        var _a;
        return (<Checkbox_1.default shouldSelectOnPressEnter isChecked={item.isSelected} accessibilityLabel={(_a = item.text) !== null && _a !== void 0 ? _a : ''} onPress={function () { return onSelectRow(item); }}/>);
    }, [item, onSelectRow]);
