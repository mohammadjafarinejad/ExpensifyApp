 ...
 */
function SingleSelectListItem(_a) {
    var item = _a.item, isFocused = _a.isFocused, showTooltip = _a.showTooltip, isDisabled = _a.isDisabled, onSelectRow = _a.onSelectRow, onDismissError = _a.onDismissError, shouldPreventEnterKeySubmit = _a.shouldPreventEnterKeySubmit, _b = _a.isMultilineSupported, isMultilineSupported = _b === void 0 ? false : _b, _c = _a.isAlternateTextMultilineSupported, isAlternateTextMultilineSupported = _c === void 0 ? false : _c, _d = _a.alternateTextNumberOfLines, alternateTextNumberOfLines = _d === void 0 ? 2 : _d, onFocus = _a.onFocus, shouldSyncFocus = _a.shouldSyncFocus, wrapperStyle = _a.wrapperStyle, titleStyles = _a.titleStyles, _e = _a.shouldHighlightSelectedItem, shouldHighlightSelectedItem = _e === void 0 ? true : _e;
    var styles = (0, useThemeStyles_1.default)();
    var radioCheckboxComponent = (0, react_1.useCallback)(function () {
        return (<Checkbox_1.default shouldSelectOnPressEnter containerBorderRadius={999} accessibilityLabel="SingleSelectListItem" isChecked={item.isSelected} onPress={function () { return onSelectRow(item); }}/>);
    }, [item, onSelectRow]);
    return (<RadioListItem_1.default item={item} keyForList={item.keyForList} isFocused={isFocused} showTooltip={showTooltip} isDisabled={isDisabled} rightHandSideComponent={radioCheckboxComponent} onSelectRow={onSelectRow} onDismissError={onDismissError} shouldPreventEnterKeySubmit={shouldPreventEnterKeySubmit} isMultilineSupported={isMultilineSupported} isAlternateTextMultilineSupported={isAlternateTextMultilineSupported} alternateTextNumberOfLines={alternateTextNumberOfLines} onFocus={onFocus} shouldSyncFocus={shouldSyncFocus} wrapperStyle={[wrapperStyle, styles.optionRowCompact]} titleStyles={titleStyles} shouldHighlightSelectedItem={shouldHighlightSelectedItem}/>);
}
