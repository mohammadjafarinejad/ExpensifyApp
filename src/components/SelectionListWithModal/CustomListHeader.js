...
function CustomListHeader(_a) {
    var canSelectMultiple = _a.canSelectMultiple, _b = _a.leftHeaderText, leftHeaderText = _b === void 0 ? '' : _b, _c = _a.rightHeaderText, rightHeaderText = _c === void 0 ? '' : _c, _d = _a.rightHeaderMinimumWidth, rightHeaderMinimumWidth = _d === void 0 ? 60 : _d, _e = _a.shouldShowRightCaret, shouldShowRightCaret = _e === void 0 ? false : _e;
    ...
    var header = (<react_native_1.View style={[
            ...
            <react_native_1.View style={[StyleUtils.getMinimumWidth(rightHeaderMinimumWidth), shouldShowRightCaret && styles.mr6]}>
