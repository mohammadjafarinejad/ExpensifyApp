...
function SelectionListWithModal(_a, ref) {
    var _b;
    var turnOnSelectionModeOnLongPress = _a.turnOnSelectionModeOnLongPress, onTurnOnSelectionMode = _a.onTurnOnSelectionMode, onLongPressRow = _a.onLongPressRow, _c = _a.isScreenFocused, isScreenFocused = _c === void 0 ? false : _c, sections = _a.sections, isSelected = _a.isSelected, selectedItemsProp = _a.selectedItems, rest = __rest(_a, ["turnOnSelectionModeOnLongPress", "onTurnOnSelectionMode", "onLongPressRow", "isScreenFocused", "sections", "isSelected", "selectedItems"]);
    var _d = (0, react_1.useState)(false), isModalVisible = _d[0], setIsModalVisible = _d[1];
    var _e = (0, react_1.useState)(null), longPressedItem = _e[0], setLongPressedItem = _e[1];
    ...
    var sectionData = (_b = sections[0]) === null || _b === void 0 ? void 0 : _b.data;
    var selectedItems = (0, react_1.useMemo)(function () {
        var _a;
        return (_a = selectedItemsProp !== null && selectedItemsProp !== void 0 ? selectedItemsProp : sectionData === null || sectionData === void 0 ? void 0 : sectionData.filter(function (item) {
            if (isSelected) {
    ...
    (0, useHandleSelectionMode_1.default)(selectedItems);
    ...
    return (<>
            <SelectionListWithSections_1.default ref={ref} sections={sections} selectedItems={selectedItemsProp} onLongPressRow={handleLongPressRow} isScreenFocused={isScreenFocused} isSmallScreenWidth={isSmallScreenWidth} 
