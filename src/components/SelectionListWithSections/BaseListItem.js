    ...
    {...bind} ref={pressableRef} onLongPress={function () {
            ...
            isFocused &&
                ...
                StyleUtils.getItemBackgroundColorStyle(!!item.isSelected, !!isFocused, !!item.isDisabled, theme.activeComponentBG, theme.hoverComponentBG),
                    ...
                    {shouldShowRightCaret && (<react_native_1.View style={[styles.justifyContentCenter, styles.alignItemsCenter, styles.ml2]}>
                            <Icon_1.default src={Expensicons.ArrowRight} fill={theme.icon} additionalStyles={[styles.alignSelfCenter, !hovered && styles.opacitySemiTransparent]} isButtonIcon medium/>
                        </react_native_1.View>)}
                </react_native_1.View>
                {FooterComponent}
            </PressableWithFeedback_1.default>
