...
function BaseSelectionListWithSections(_a) {
    var sections = _a.sections, ListItem = _a.ListItem, shouldUseUserSkeletonView = _a.shouldUseUserSkeletonView, _b = _a.canSelectMultiple, canSelectMultiple = _b === void 0 ? false : _b, onSelectRow = _a.onSelectRow, _c = _a.shouldSingleExecuteRowSelect, shouldSingleExecuteRowSelect = _c === void 0 ? false : _c, onCheckboxPress = _a.onCheckboxPress, onSelectAll = _a.onSelectAll, onDismissError = _a.onDismissError, _d = _a.getItemHeight, getItemHeight = _d === void 0 ? getDefaultItemHeight : _d, _e = _a.textInputLabel, textInputLabel = _e === void 0 ? '' : _e, _f = _a.textInputPlaceholder, textInputPlaceholder = _f === void 0 ? '' : _f, _g = _a.textInputValue, textInputValue = _g === void 0 ? '' : _g, textInputStyle = _a.textInputStyle, textInputHint = _a.textInputHint, textInputMaxLength = _a.textInputMaxLength, _h = _a.inputMode, inputMode = _h === void 0 ? CONST_1.default.INPUT_MODE.TEXT : _h, onChangeText = _a.onChangeText, _j = _a.initiallyFocusedOptionKey, initiallyFocusedOptionKey = _j === void 0 ? '' : _j, onScroll = _a.onScroll, onScrollBeginDrag = _a.onScrollBeginDrag, _k = _a.headerMessage, headerMessage = _k === void 0 ? '' : _k, _l = _a.confirmButtonText, confirmButtonText = _l === void 0 ? '' : _l, onConfirm = _a.onConfirm, headerContent = _a.headerContent, footerContent = _a.footerContent, listFooterContent = _a.listFooterContent, footerContentAbovePagination = _a.footerContentAbovePagination, listEmptyContent = _a.listEmptyContent, _m = _a.showScrollIndicator, showScrollIndicator = _m === void 0 ? true : _m, _o = _a.showLoadingPlaceholder, showLoadingPlaceholder = _o === void 0 ? false : _o, _p = _a.LoadingPlaceholderComponent, LoadingPlaceholderComponent = _p === void 0 ? OptionsListSkeletonView_1.default : _p, _q = _a.showConfirmButton, showConfirmButton = _q === void 0 ? false : _q, _r = _a.isConfirmButtonDisabled, isConfirmButtonDisabled = _r === void 0 ? false : _r, _s = _a.shouldUseDefaultTheme, shouldUseDefaultTheme = _s === void 0 ? false : _s, _t = _a.shouldPreventDefaultFocusOnSelectRow, shouldPreventDefaultFocusOnSelectRow = _t === void 0 ? false : _t, containerStyle = _a.containerStyle, sectionListStyle = _a.sectionListStyle, _u = _a.disableKeyboardShortcuts, disableKeyboardShortcuts = _u === void 0 ? false : _u, children = _a.children, autoCorrect = _a.autoCorrect, _v = _a.shouldStopPropagation, shouldStopPropagation = _v === void 0 ? false : _v, _w = _a.shouldPreventDefault, shouldPreventDefault = _w === void 0 ? true : _w, _x = _a.shouldShowTooltips, shouldShowTooltips = _x === void 0 ? true : _x, _y = _a.shouldUseDynamicMaxToRenderPerBatch, shouldUseDynamicMaxToRenderPerBatch = _y === void 0 ? false : _y, rightHandSideComponent = _a.rightHandSideComponent, _z = _a.isLoadingNewOptions, isLoadingNewOptions = _z === void 0 ? false : _z, onLayout = _a.onLayout, customListHeader = _a.customListHeader, _0 = _a.customListHeaderHeight, customListHeaderHeight = _0 === void 0 ? 0 : _0, listHeaderWrapperStyle = _a.listHeaderWrapperStyle, _1 = _a.isRowMultilineSupported, isRowMultilineSupported = _1 === void 0 ? false : _1, _2 = _a.isAlternateTextMultilineSupported, isAlternateTextMultilineSupported = _2 === void 0 ? false : _2, _3 = _a.alternateTextNumberOfLines, alternateTextNumberOfLines = _3 === void 0 ? 2 : _3, textInputRef = _a.textInputRef, headerMessageStyle = _a.headerMessageStyle, confirmButtonStyles = _a.confirmButtonStyles, _4 = _a.shouldHideListOnInitialRender, shouldHideListOnInitialRender = _4 === void 0 ? true : _4, textInputIconLeft = _a.textInputIconLeft, sectionTitleStyles = _a.sectionTitleStyles, _5 = _a.textInputAutoFocus, textInputAutoFocus = _5 === void 0 ? true : _5, _6 = _a.shouldShowTextInputAfterHeader, shouldShowTextInputAfterHeader = _6 === void 0 ? false : _6, _7 = _a.shouldShowHeaderMessageAfterHeader, shouldShowHeaderMessageAfterHeader = _7 === void 0 ? false : _7, _8 = _a.includeSafeAreaPaddingBottom, includeSafeAreaPaddingBottom = _8 === void 0 ? true : _8, _9 = _a.shouldTextInputInterceptSwipe, shouldTextInputInterceptSwipe = _9 === void 0 ? false : _9, listHeaderContent = _a.listHeaderContent, onEndReached = _a.onEndReached, onEndReachedThreshold = _a.onEndReachedThreshold, _10 = _a.windowSize, windowSize = _10 === void 0 ? 5 : _10, _11 = _a.updateCellsBatchingPeriod, updateCellsBatchingPeriod = _11 === void 0 ? 50 : _11, _12 = _a.removeClippedSubviews, removeClippedSubviews = _12 === void 0 ? true : _12, _13 = _a.shouldDelayFocus, shouldDelayFocus = _13 === void 0 ? true : _13, _14 = _a.onArrowFocus, onArrowFocus = _14 === void 0 ? function () { } : _14, _15 = _a.shouldUpdateFocusedIndex, shouldUpdateFocusedIndex = _15 === void 0 ? false : _15, onLongPressRow = _a.onLongPressRow, _16 = _a.shouldShowTextInput, shouldShowTextInput = _16 === void 0 ? !!textInputLabel || !!textInputIconLeft : _16, _17 = _a.shouldShowListEmptyContent, shouldShowListEmptyContent = _17 === void 0 ? true : _17, listItemWrapperStyle = _a.listItemWrapperStyle, _18 = _a.shouldIgnoreFocus, shouldIgnoreFocus = _18 === void 0 ? false : _18, scrollEventThrottle = _a.scrollEventThrottle, contentContainerStyle = _a.contentContainerStyle, _19 = _a.shouldKeepFocusedItemAtTopOfViewableArea, shouldKeepFocusedItemAtTopOfViewableArea = _19 === void 0 ? false : _19, _20 = _a.shouldDebounceScrolling, shouldDebounceScrolling = _20 === void 0 ? false : _20, _21 = _a.shouldPreventActiveCellVirtualization, shouldPreventActiveCellVirtualization = _21 === void 0 ? false : _21, _22 = _a.shouldScrollToFocusedIndex, shouldScrollToFocusedIndex = _22 === void 0 ? true : _22, isSmallScreenWidth = _a.isSmallScreenWidth, onContentSizeChange = _a.onContentSizeChange, listItemTitleStyles = _a.listItemTitleStyles, _23 = _a.initialNumToRender, initialNumToRender = _23 === void 0 ? 12 : _23, listItemTitleContainerStyles = _a.listItemTitleContainerStyles, _24 = _a.isScreenFocused, isScreenFocused = _24 === void 0 ? false : _24, _25 = _a.shouldSubscribeToArrowKeyEvents, shouldSubscribeToArrowKeyEvents = _25 === void 0 ? true : _25, _26 = _a.shouldClearInputOnSelect, shouldClearInputOnSelect = _26 === void 0 ? true : _26, addBottomSafeAreaPadding = _a.addBottomSafeAreaPadding, addOfflineIndicatorBottomSafeAreaPadding = _a.addOfflineIndicatorBottomSafeAreaPadding, fixedNumItemsForLoader = _a.fixedNumItemsForLoader, loaderSpeed = _a.loaderSpeed, errorText = _a.errorText, shouldUseDefaultRightHandSideCheckmark = _a.shouldUseDefaultRightHandSideCheckmark, _27 = _a.selectedItems, selectedItems = _27 === void 0 ? (0, getEmptyArray_1.default)() : _27, isSelected = _a.isSelected, canShowProductTrainingTooltip = _a.canShowProductTrainingTooltip, renderScrollComponent = _a.renderScrollComponent, shouldShowRightCaret = _a.shouldShowRightCaret, _28 = _a.shouldHighlightSelectedItem, shouldHighlightSelectedItem = _28 === void 0 ? true : _28, ref = _a.ref;
    ...
    var _29 = (0, react_1.useState)(shouldUseDynamicMaxToRenderPerBatch ? 0 : CONST_1.default.MAX_TO_RENDER_PER_BATCH.DEFAULT), maxToRenderPerBatch = _29[0], setMaxToRenderPerBatch = _29[1];
    var _30 = (0, react_1.useState)(true), isInitialSectionListRender = _30[0], setIsInitialSectionListRender = _30[1];
    var isKeyboardShown = (0, useKeyboardState_1.default)().isKeyboardShown;
    var _31 = (0, react_1.useState)(null), itemsToHighlight = _31[0], setItemsToHighlight = _31[1];
    ...
    var calculateInitialCurrentPage = (0, react_1.useCallback)(function () {
        ...
        for (var _i = 0, sections_1 = sections; _i < sections_1.length; _i++) {
            ...
            if (section.data) {
                for (var _a = 0, _b = section.data; _a < _b.length; _a++) {
                    var item = _b[_a];
    ...
    var _32 = (0, react_1.useState)(function () { return calculateInitialCurrentPage(); }), currentPage = _32[0], setCurrentPage = _32[1];
    var isTextInputFocusedRef = (0, react_1.useRef)(false);
    var singleExecution = (0, useSingleExecution_1.default)().singleExecution;
    var itemHeights = (0, react_1.useRef)({});
    var pendingScrollIndexRef = (0, react_1.useRef)(null);
    var onItemLayout = function (event, itemKey) {
        ...
        itemHeights.current = __assign(__assign({}, itemHeights.current), (_a = {}, _a[itemKey] = height, _a));
    };
    var canShowProductTrainingTooltipMemo = (0, react_1.useMemo)(function () {
    ...
    var flattenedSections = (0, react_1.useMemo)(function () {
        ...
        sections.forEach(function (section, sectionIndex) {
            ...
            (_a = section.data) === null || _a === void 0 ? void 0 : _a.forEach(function (item, optionIndex) {
                ...
                var fullItemHeight = (item === null || item === void 0 ? void 0 : item.keyForList) && itemHeights.current[item.keyForList] ? itemHeights.current[item.keyForList] : getItemHeight(item);
    ...
    var incrementPage = (0, react_1.useCallback)(function () {
    ...
    var slicedSections = (0, react_1.useMemo)(function () {
        var remainingOptionsLimit = CONST_1.default.MAX_SELECTION_LIST_PAGE_LENGTH * currentPage;
        return (0, getSectionsWithIndexOffset_1.default)(sections.map(function (section) {
    ...
    var scrollToIndex = (0, react_1.useCallback)(function (index, animated) {
        ...
        var requiredPage = Math.ceil((index + 1) / CONST_1.default.MAX_SELECTION_LIST_PAGE_LENGTH);
        ...
        if (shouldKeepFocusedItemAtTopOfViewableArea) {
            ...
            var firstPreviousItemHeight = firstPreviousItem && firstPreviousItem.keyForList ? itemHeights.current[firstPreviousItem.keyForList] : 0;
            var secondPreviousItem = index > 1 ? flattenedSections.allOptions.at(index - 2) : undefined;
            var secondPreviousItemHeight = secondPreviousItem && (secondPreviousItem === null || secondPreviousItem === void 0 ? void 0 : secondPreviousItem.keyForList) ? itemHeights.current[secondPreviousItem.keyForList] : 0;
    ...
    var scrollToFocusedInput = (0, react_1.useCallback)(function (index) {
        if (!listRef.current) {
            return;
        }
        if (index < 0) {
    ...
    var _33 = (0, react_1.useState)(flattenedSections.disabledArrowKeyOptionsIndexes), disabledArrowKeyIndexes = _33[0], setDisabledArrowKeyIndexes = _33[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        var indexToScroll = pendingScrollIndexRef.current;
        var targetItem = flattenedSections.allOptions.at(indexToScroll);
    ...
    var _34 = (0, useArrowKeyFocusManager_1.default)(__assign(__assign({ initialFocusedIndex: flattenedSections.allOptions.findIndex(function (option) { return option.keyForList === initiallyFocusedOptionKey; }), maxIndex: Math.min(flattenedSections.allOptions.length - 1, CONST_1.default.MAX_SELECTION_LIST_PAGE_LENGTH * currentPage - 1), disabledIndexes: disabledArrowKeyIndexes, isActive: shouldSubscribeToArrowKeyEvents && isFocused, onFocusedIndexChange: function (index) {
        ...
        } }, (!hasKeyBeenPressed.current && { setHasKeyBeenPressed: setHasKeyBeenPressed })), { isFocused: isFocused })), focusedIndex = _34[0], setFocusedIndex = _34[1];
    (0, react_1.useEffect)(function () {
        ...
        return (<>
            {!headerMessage && canSelectMultiple && shouldShowSelectAll && (<react_native_1.View style={[styles.userSelectNone, styles.peopleRow, styles.ph5, styles.pb3, listHeaderWrapperStyle, styles.selectionListStickyHeader]}>
                    <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter]}>
                        <Checkbox_1.default testID="selection-list-select-all-checkbox" accessibilityLabel={translate('workspace.people.selectAll')} isChecked={flattenedSections.allSelected} isIndeterminate={flattenedSections.someSelected} onPress={selectAllRow} disabled={flattenedSections.allOptions.length === flattenedSections.disabledOptionsIndexes.length}/>
    ...
    var renderInput = function () {
        return (<react_native_1.View style={[styles.ph5, styles.pb3, textInputStyle]}>
            ...
            }} onFocus={function () { return (isTextInputFocusedRef.current = true); }} onBlur={function () { return (isTextInputFocusedRef.current = false); }} label={textInputLabel} accessibilityLabel={textInputLabel} hint={textInputHint} role={CONST_1.default.ROLE.PRESENTATION} value={textInputValue} placeholder={textInputPlaceholder} autoCorrect={autoCorrect} maxLength={textInputMaxLength} onChangeText={onChangeText} inputMode={inputMode} selectTextOnFocus spellCheck={false} iconLeft={textInputIconLeft} onSubmitEditing={selectFocusedOption} submitBehavior={flattenedSections.allOptions.length ? 'blurAndSubmit' : 'submit'} isLoading={isLoadingNewOptions} testID="selection-list-text-input" shouldInterceptSwipe={shouldTextInputInterceptSwipe} errorText={errorText}/>
            </react_native_1.View>);
    };
    ...
    var updateAndScrollToFocusedIndex = (0, react_1.useCallback)(function (newFocusedIndex, shouldSkipWhenIndexNonZero) {
        if (shouldSkipWhenIndexNonZero === void 0) { shouldSkipWhenIndexNonZero = false; }
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (prevTextInputValue !== '' && textInputValue === '') {
            var foundSelectedItemIndex = flattenedSections.allOptions.findIndex(isItemSelected);
            var singleSectionList = slicedSections.length < 2;
            if (foundSelectedItemIndex !== -1 && singleSectionList && !canSelectMultiple) {
                var requiredPage = Math.ceil((foundSelectedItemIndex + 1) / CONST_1.default.MAX_SELECTION_LIST_PAGE_LENGTH);
                setCurrentPage(requiredPage);
    ...
    (0, react_1.useImperativeHandle)(ref, function () { return ({
        scrollAndHighlightItem: scrollAndHighlightItem,
        clearInputAfterSelect: clearInputAfterSelect,
        updateAndScrollToFocusedIndex: updateAndScrollToFocusedIndex,
        updateExternalTextInputFocus: updateExternalTextInputFocus,
    ...
    var handleOnEndReached = (0, react_1.useCallback)(function () {
    ...
    return (<react_native_1.View style={[styles.flex1, !addBottomSafeAreaPadding && paddingBottomStyle, containerStyle]}>
            ...
            {flattenedSections.allOptions.length === 0 && (showLoadingPlaceholder || shouldShowListEmptyContent) ? (renderListEmptyContent()) : (<>
                    ...
                    <SectionList_1.default renderScrollComponent={renderScrollComponent} removeClippedSubviews={removeClippedSubviews} ref={listRef} sections={slicedSections} stickySectionHeadersEnabled={false} renderSectionHeader={function (arg) { return (<>
...
exports.default = BaseSelectionListWithSections;
