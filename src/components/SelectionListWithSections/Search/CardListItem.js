                ...
                {!!item.bankIcon && (<react_native_1.View style={[styles.mr3]}>
                    ...
                    displayName: (_l = item.cardOwnerPersonalDetails) === null || _l === void 0 ? void 0 : _l.displayName,
                                ...
                                <react_native_1.View style={[styles.cardItemSecondaryIconStyle, StyleUtils.getBorderColorStyle(theme.componentBG)]}>
                                    {!!(item === null || item === void 0 ? void 0 : item.plaidUrl) && (<PlaidCardFeedIcon_1.default plaidUrl={item.plaidUrl} isSmall/>)}
                                    {!(item === null || item === void 0 ? void 0 : item.plaidUrl) && (<Icon_1.default src={item.bankIcon.icon} width={variables_1.default.cardMiniatureWidth} height={variables_1.default.cardMiniatureHeight} additionalStyles={styles.cardMiniature}/>)}
                                </react_native_1.View>
                            </react_native_1.View>) : (<>
                                {!!(item === null || item === void 0 ? void 0 : item.plaidUrl) && <PlaidCardFeedIcon_1.default plaidUrl={item.plaidUrl}/>}
                                {!(item === null || item === void 0 ? void 0 : item.plaidUrl) && (<Icon_1.default src={item.bankIcon.icon} width={variables_1.default.cardIconWidth} height={variables_1.default.cardIconHeight} additionalStyles={styles.cardIcon}/>)}
                            </>)}
                    </react_native_1.View>)}
