...
function UserInfoAndActionButtonRow(_a) {
    ...
    var item = _a.item, handleActionButtonPress = _a.handleActionButtonPress, shouldShowUserInfo = _a.shouldShowUserInfo, containerStyles = _a.containerStyles, isInMobileSelectionMode = _a.isInMobileSelectionMode;
    ...
    var isLoading = 'isActionLoading' in item ? item === null || item === void 0 ? void 0 : item.isActionLoading : isActionLoading;
    return (<react_native_1.View style={[
            ...
            {shouldShowUserInfo && (<UserInfoCellsWithArrow_1.default shouldShowToRecipient={shouldShowToRecipient} participantFrom={item === null || item === void 0 ? void 0 : item.from} participantFromDisplayName={participantFromDisplayName} participantToDisplayName={participantToDisplayName} participantTo={item === null || item === void 0 ? void 0 : item.to} avatarSize={!isLargeScreenWidth ? CONST_1.default.AVATAR_SIZE.SMALL_SUBSCRIPT : CONST_1.default.AVATAR_SIZE.MID_SUBSCRIPT} style={[styles.flexRow, styles.alignItemsCenter, styles.gap1]} infoCellsTextStyle={{ lineHeight: 14 }} infoCellsAvatarStyle={styles.pr1} fromRecipientStyle={!shouldShowToRecipient ? styles.mw100 : {}} shouldUseArrowIcon={false}/>)}
            <react_native_1.View style={[{ width: isLargeScreenWidth ? variables_1.default.w80 : variables_1.default.w72 }, styles.alignItemsEnd]}>
                <ActionCell_1.default action={item.action} goToItem={handleActionButtonPress} isSelected={item.isSelected} isLoading={isLoading} policyID={item.policyID} reportID={item.reportID} hash={item.hash} amount={(_q = item === null || item === void 0 ? void 0 : item.amount) !== null && _q !== void 0 ? _q : item === null || item === void 0 ? void 0 : item.total} extraSmall={!isLargeScreenWidth} shouldDisablePointerEvents={isInMobileSelectionMode}/>
            </react_native_1.View>
        </react_native_1.View>);
}
