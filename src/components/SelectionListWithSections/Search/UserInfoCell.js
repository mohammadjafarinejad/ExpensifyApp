...
function UserInfoCell(_a) {
    var avatar = _a.avatar, accountID = _a.accountID, displayName = _a.displayName, avatarSize = _a.avatarSize, containerStyle = _a.containerStyle, textStyle = _a.textStyle, avatarStyle = _a.avatarStyle;
    ...
    return (<react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, containerStyle]}>
            ...
            <Text_1.default numberOfLines={1} style={[isLargeScreenWidth ? styles.themeTextColor : styles.textMicroSupporting, styles.flexShrink1, textStyle]}>
                {displayName}
            </Text_1.default>
        </react_native_1.View>);
}
