...
function SingleSelectListItem(_a) {
    ...
    var radioCheckboxComponent = (0, react_1.useCallback)(function () {
        return (<Checkbox_1.default shouldSelectOnPressEnter containerBorderRadius={999} accessibilityLabel="SingleSelectListItem" isChecked={isSelected} onPress={function () { return onSelectRow(item); }}/>);
