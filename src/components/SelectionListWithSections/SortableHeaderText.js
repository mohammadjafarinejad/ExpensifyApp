...
function SortableHeaderText(_a) {
    var text = _a.text, icon = _a.icon, sortOrder = _a.sortOrder, isActive = _a.isActive, textStyle = _a.textStyle, containerStyle = _a.containerStyle, _b = _a.isSortable, isSortable = _b === void 0 ? true : _b, onPress = _a.onPress;
    ...
    if (!isSortable) {
        return (<react_native_1.View style={containerStyle}>
                <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.gap1]}>
                    {!!icon && (<Icon_1.default src={icon} fill={theme.icon} height={16} width={16}/>)}
                    {!!text && (<Text_1.default numberOfLines={1} style={[styles.textMicroSupporting, textStyle]}>
                            {text}
                        </Text_1.default>)}
                </react_native_1.View>
            </react_native_1.View>);
    }
    var sortArrowIcon = sortOrder === CONST_1.default.SEARCH.SORT_ORDER.ASC ? Expensicons.ArrowUpLong : Expensicons.ArrowDownLong;
    ...
    return (<react_native_1.View style={containerStyle}>
            <PressableWithFeedback_1.default onPress={function () { return onPress(nextSortOrder); }} role={CONST_1.default.ROLE.BUTTON} accessibilityLabel={CONST_1.default.ROLE.BUTTON} accessible disabled={!isSortable}>
                <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.gap1]}>
                    {!!icon && (<Icon_1.default src={icon} fill={theme.icon} height={16} width={16}/>)}
                    {!!text && (<Text_1.default numberOfLines={1} style={[styles.textMicroSupporting, activeColumnStyle, textStyle]}>
                            {text}
                        </Text_1.default>)}
                    {displayIcon && (<Icon_1.default src={sortArrowIcon} fill={theme.icon} height={12} width={12}/>)}
                </react_native_1.View>
