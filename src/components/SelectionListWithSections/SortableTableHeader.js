...
function SortableTableHeader(_a) {
    var columns = _a.columns, sortBy = _a.sortBy, sortOrder = _a.sortOrder, shouldShowColumn = _a.shouldShowColumn, dateColumnSize = _a.dateColumnSize, containerStyles = _a.containerStyles, shouldShowSorting = _a.shouldShowSorting, onSortPress = _a.onSortPress, amountColumnSize = _a.amountColumnSize, taxAmountColumnSize = _a.taxAmountColumnSize, areAllOptionalColumnsHidden = _a.areAllOptionalColumnsHidden;
    ...
    return (<react_native_1.View style={[styles.flex1]}>
            ...
            var columnName = _a.columnName, translationKey = _a.translationKey, icon = _a.icon, isColumnSortable = _a.isColumnSortable;
            ...
            return (<SortableHeaderText_1.default key={columnName} text={translationKey ? translate(translationKey) : ''} icon={icon} textStyle={textStyle} sortOrder={sortOrder !== null && sortOrder !== void 0 ? sortOrder : CONST_1.default.SEARCH.SORT_ORDER.ASC} isActive={isActive} containerStyle={[
