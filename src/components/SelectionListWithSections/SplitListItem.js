...
function SplitListItem(_a) {
    ...
    var _g = (0, react_1.useState)(CONST_1.default.CHARACTER_WIDTH), prefixCharacterMargin = _g[0], setPrefixCharacterMargin = _g[1];
    var inputMarginLeft = prefixCharacterMargin + styles.pl1.paddingLeft;
    var contentWidth = (formattedOriginalAmount.length + 1) * CONST_1.default.CHARACTER_WIDTH;
    ...
    return (<BaseListItem_1.default item={item} wrapperStyle={[styles.flex1, styles.justifyContentBetween, styles.userSelectNone, styles.p3, styles.br3]} isFocused={isFocused} containerStyle={[styles.mh4, styles.mv1, styles.reportPreviewBoxHoverBorder, styles.br2, splitItem.isSelected && StyleUtils.getBackgroundColorStyle(theme.messageHighlightBG)]} hoverStyle={[styles.br2]} pressableStyle={[styles.br2]} isDisabled={isDisabled} showTooltip={showTooltip} onSelectRow={onSelectRow} shouldPreventEnterKeySubmit={shouldPreventEnterKeySubmit} rightHandSideComponent={rightHandSideComponent} shouldUseDefaultRightHandSideCheckmark={false} keyForList={item.keyForList} onFocus={onFocus} pendingAction={item.pendingAction}>
                ...
                <react_native_1.View style={[styles.flex1]}>
                    ...
                    {isBottomVisible && (<react_native_1.View style={[styles.splitItemBottomContent]}>
                            {!!splitItem.category && (<react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.gap1, styles.pr1, styles.flexShrink1, !!((_c = splitItem.tags) === null || _c === void 0 ? void 0 : _c.at(0)) && styles.mw50]}>
                                    ...
                                    <Text_1.default numberOfLines={1} style={[styles.textMicroSupporting, styles.pre, styles.flexShrink1]}>
                                        {(0, CategoryUtils_1.getDecodedCategoryName)(splitItem.category)}
                                    </Text_1.default>
                                </react_native_1.View>)}
