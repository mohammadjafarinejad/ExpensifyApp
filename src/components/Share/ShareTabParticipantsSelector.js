...
function ShareTabParticipantsSelectorComponent(_a, ref) {
    var detailsPageRouteObject = _a.detailsPageRouteObject;
    return (<MoneyRequestParticipantsSelector_1.default ref={ref} iouType={CONST_1.default.IOU.TYPE.SUBMIT} onParticipantsAdded={function (value) {
            var _a;
