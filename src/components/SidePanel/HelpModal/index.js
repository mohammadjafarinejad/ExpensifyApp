...
function Help(_a) {
    ...
    var _d = (0, useOnyx_1.default)(ONYXKEYS_1.default.MODAL, { selector: Modal_1.isRHPVisibleSelector, canBeMissing: true })[0], isRHPVisible = _d === void 0 ? false : _d;
    ...
    (0, useKeyboardShortcut_1.default)(CONST_1.default.KEYBOARD_SHORTCUTS.DEBUG, function () { return closeSidePanel(); }, { shouldBubble: true });
    ...
    return (<ModalPortal_1.default>
            ...
            { transform: [{ translateX: sidePanelTranslateX.current }], paddingTop: paddingTop, paddingBottom: paddingBottom },
        ]}>
