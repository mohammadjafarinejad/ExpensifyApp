...
var signIn = function (response, preferredLocale) {
    (0, Session_1.beginGoogleSignIn)(response.credential, preferredLocale);
};
/**
    ...
    var loadScript = (0, react_1.useCallback)(function () {
        ...
        if (google) {
            google.accounts.id.initialize({
                ...
                callback: function (response) { return signIn(response, preferredLocale); },
            });
