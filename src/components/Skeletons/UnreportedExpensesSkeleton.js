...
function UnreportedExpensesSkeleton(_a) {
    ...
    return (<react_native_1.View style={styles.flex1} ref={containerRef}>
            <ItemListSkeletonView_1.default itemViewHeight={64} itemViewStyle={[styles.highlightBG, styles.mb2, styles.br2, styles.ml5, styles.mr5]} shouldAnimate fixedNumItems={fixedNumberOfItems} renderSkeletonItem={skeletonItem}/>
        </react_native_1.View>);
}
