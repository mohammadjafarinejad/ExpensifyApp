...
function StatePicker(_a) {
    ...
    return (<>
            ...
            <StateSelectorModal_1.default isVisible={isPickerVisible} currentState={value !== null && value !== void 0 ? value : ''} onStateSelected={updateInput} onClose={hidePickerModal} label={translate('common.state')} onBackdropPress={hidePickerModal}/>
        </>);
}
