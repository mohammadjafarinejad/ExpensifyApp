...
function TestToolMenu() {
    ...
    var _a = (0, useOnyx_1.default)(ONYXKEYS_1.default.SHOULD_USE_STAGING_SERVER, { canBeMissing: true })[0], shouldUseStagingServer = _a === void 0 ? (0, ApiUtils_1.isUsingStagingApi)() : _a;
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_DEBUG_MODE_ENABLED, { canBeMissing: true })[0], isDebugModeEnabled = _b === void 0 ? false : _b;
