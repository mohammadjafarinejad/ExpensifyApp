...
function BaseTextInput(_a) {
    ...
    var _14 = inputProps.hasError, hasError = _14 === void 0 ? false : _14;
    ...
    var _16 = (0, react_1.useState)(inputProps.secureTextEntry), passwordHidden = _16[0], setPasswordHidden = _16[1];
    var _17 = (0, react_1.useState)(0), textInputWidth = _17[0], setTextInputWidth = _17[1];
    var _18 = (0, react_1.useState)(0), textInputHeight = _18[0], setTextInputHeight = _18[1];
    var _19 = (0, react_1.useState)(null), width = _19[0], setWidth = _19[1];
    var _20 = (0, react_1.useState)(CONST_1.default.CHARACTER_WIDTH), prefixCharacterPadding = _20[0], setPrefixCharacterPadding = _20[1];
    var _21 = (0, react_1.useState)(function () { return !prefixCharacter; }), isPrefixCharacterPaddingCalculated = _21[0], setIsPrefixCharacterPaddingCalculated = _21[1];
...
to prevent text overlapping with label when scrolling */}
            ...
            }} tabIndex={-1} style={[styles.textInputPrefix, !hasLabel && styles.pv0, styles.pointerEventsNone, prefixStyle]} dataSet={_b = {}, _b[CONST_1.default.SELECTION_SCRAPER_HIDDEN_ELEMENT] = true, _b} shouldUseDefaultLineHeight={shouldUseDefaultLineHeightForPrefix}>
                                        {prefixCharacter}
                                    </Text_1.default>
                                </react_native_1.View>)}
    ...
    {...inputProps} autoCorrect={inputProps.secureTextEntry ? false : autoCorrect} placeholder={newPlaceholder} placeholderTextColor={placeholderTextColor !== null && placeholderTextColor !== void 0 ? placeholderTextColor : theme.placeholderText} underlineColorAndroid="transparent" style={__spreadArray(__spreadArray([
            ...
            styles.pointerEventsAuto,
                            ...
                            {((isFocused && !isReadOnly && shouldShowClearButton) || !shouldHideClearButton) && !!value && !inputProps.isLoading && (<react_native_1.View onLayout={function () {
                ...
                didScrollToEndRef.current = true;
                                    ...
                                    <TextInputClearButton_1.default onPressButton={function () {
                setValue('');
                ...
                StyleUtils.getOpacityStyle(inputProps.isLoading ? 1 : 0),
                            ...
                            {!!inputProps.secureTextEntry && (<Checkbox_1.default style={StyleUtils.getTextInputIconContainerStyles(hasLabel, true, verticalPaddingDiff)} onPress={togglePasswordVisibility} onMouseDown={function (e) {
                e.preventDefault();
