...
function BaseTextInput(_a) {
    ...
    var _12 = inputProps.hasError, hasError = _12 === void 0 ? false : _12;
    ...
    var _14 = (0, react_1.useState)(inputProps.secureTextEntry), passwordHidden = _14[0], setPasswordHidden = _14[1];
    var _15 = (0, react_1.useState)(0), textInputWidth = _15[0], setTextInputWidth = _15[1];
    var _16 = (0, react_1.useState)(0), textInputHeight = _16[0], setTextInputHeight = _16[1];
    var _17 = (0, react_1.useState)(variables_1.default.componentSizeLarge), height = _17[0], setHeight = _17[1];
    var _18 = (0, react_1.useState)(null), width = _18[0], setWidth = _18[1];
    var _19 = (0, react_1.useState)(CONST_1.default.CHARACTER_WIDTH), prefixCharacterPadding = _19[0], setPrefixCharacterPadding = _19[1];
    ...
    var verticalPaddingDiff = StyleUtils.getVerticalPaddingDiffFromStyle(newTextInputContainerStyles);
...
to prevent text overlapping with label when scrolling */}
                        ...
                        <react_native_1.View style={[styles.textInputAndIconContainer, styles.flex1, isMultiline && hasLabel && styles.textInputMultilineContainer, styles.pointerEventsBoxNone]}>
                            ...
                            {!!prefixCharacter && (<react_native_1.View style={[styles.textInputPrefixWrapper, prefixContainerStyle, shouldApplyHeight && { height: height }]}>
            ...
            }} tabIndex={-1} style={[styles.textInputPrefix, !hasLabel && styles.pv0, styles.pointerEventsNone, prefixStyle]} dataSet={_b = {}, _b[CONST_1.default.SELECTION_SCRAPER_HIDDEN_ELEMENT] = true, _b} shouldUseDefaultLineHeight={!!shouldUseDefaultLineHeightForPrefix && !shouldApplyHeight}>
                                        {prefixCharacter}
                                    </Text_1.default>
                                </react_native_1.View>)}
    ...
    {...inputProps} autoCorrect={inputProps.secureTextEntry ? false : autoCorrect} placeholder={placeholderValue} placeholderTextColor={placeholderTextColor !== null && placeholderTextColor !== void 0 ? placeholderTextColor : theme.placeholderText} underlineColorAndroid="transparent" style={__spreadArray(__spreadArray([
            ...
            styles.pointerEventsAuto,
                            ...
                            {((isFocused && !isReadOnly && shouldShowClearButton) || !shouldHideClearButton) && !!value && !inputProps.isLoading && (<TextInputClearButton_1.default onPressButton={function () {
                setValue('');
                onClearInput === null || onClearInput === void 0 ? void 0 : onClearInput();
                            ...
                            {inputProps.isLoading !== undefined && !shouldShowClearButton && (<ActivityIndicator_1.default color={theme.iconSuccessFill} style={[
                ...
                StyleUtils.getOpacityStyle(inputProps.isLoading ? 1 : 0),
                            ...
                            {!!inputProps.secureTextEntry && (<Checkbox_1.default style={StyleUtils.getTextInputIconContainerStyles(hasLabel, true, verticalPaddingDiff)} onPress={togglePasswordVisibility} onMouseDown={function (event) {
