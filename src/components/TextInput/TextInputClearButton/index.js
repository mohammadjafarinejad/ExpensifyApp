...
function TextInputClearButton(_a) {
    ...
    return (<Tooltip_1.default text={translate('common.clear')}>
            <Pressable_1.PressableWithoutFeedback style={[styles.mt4, styles.mh1, style]} accessibilityRole={CONST_1.default.ROLE.BUTTON} accessibilityLabel={translate('common.clear')} onMouseDown={function (e) {
            e.preventDefault();
