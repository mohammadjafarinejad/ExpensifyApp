...
function TextInput(_a) {
    ...
    {...props} ref={function (element) {
            ...
            ref.current = element;
        }} inputStyle={[styles.baseTextInput, styles.textInputDesktop, isLabeledMultiline ? styles.textInputMultiline : {}, props.inputStyle]} textInputContainerStyles={[labelAnimationStyle, props.textInputContainerStyles, styles.cursorText]}/>);
}
