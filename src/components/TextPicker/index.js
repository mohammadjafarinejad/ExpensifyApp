...
function TextPicker(_a, forwardedRef) {
    var _b;
    var value = _a.value, description = _a.description, _c = _a.placeholder, placeholder = _c === void 0 ? '' : _c, _d = _a.errorText, errorText = _d === void 0 ? '' : _d, onInputChange = _a.onInputChange, onValueCommitted = _a.onValueCommitted, furtherDetails = _a.furtherDetails, rightLabel = _a.rightLabel, _e = _a.disabled, disabled = _e === void 0 ? false : _e, _f = _a.interactive, interactive = _f === void 0 ? true : _f, _g = _a.required, required = _g === void 0 ? false : _g, rest = __rest(_a, ["value", "description", "placeholder", "errorText", "onInputChange", "onValueCommitted", "furtherDetails", "rightLabel", "disabled", "interactive", "required"]);
    ...
    var updateInput = function (updatedValue) {
        ...
        onValueCommitted === null || onValueCommitted === void 0 ? void 0 : onValueCommitted(updatedValue);
        hidePickerModal();
    };
