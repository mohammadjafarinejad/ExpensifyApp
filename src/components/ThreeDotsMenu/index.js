...
function ThreeDotsMenu(_a) {
    var _b;
    var _c = _a.iconTooltip, iconTooltip = _c === void 0 ? 'common.more' : _c, icon = _a.icon, iconFill = _a.iconFill, iconStyles = _a.iconStyles, _d = _a.onIconPress, onIconPress = _d === void 0 ? function () { } : _d, menuItems = _a.menuItems, anchorPosition = _a.anchorPosition, _e = _a.anchorAlignment, anchorAlignment = _e === void 0 ? {
    ...
    } : _e, getAnchorPosition = _a.getAnchorPosition, _f = _a.shouldOverlay, shouldOverlay = _f === void 0 ? false : _f, _g = _a.shouldSetModalVisibility, shouldSetModalVisibility = _g === void 0 ? true : _g, _h = _a.disabled, disabled = _h === void 0 ? false : _h, hideProductTrainingTooltip = _a.hideProductTrainingTooltip, renderProductTrainingTooltipContent = _a.renderProductTrainingTooltipContent, _j = _a.shouldShowProductTrainingTooltip, shouldShowProductTrainingTooltip = _j === void 0 ? false : _j, _k = _a.isNested, isNested = _k === void 0 ? false : _k, _l = _a.shouldSelfPosition, shouldSelfPosition = _l === void 0 ? false : _l, threeDotsMenuRef = _a.threeDotsMenuRef;
    ...
    var expensifyIcons = (0, useLazyAsset_1.useMemoizedLazyExpensifyIcons)(['ThreeDots']);
    ...
    var _q = (0, useWindowDimensions_1.default)(), windowWidth = _q.windowWidth, windowHeight = _q.windowHeight;
    ...
    var calculateAndSetThreeDotsMenuPosition = (0, react_1.useCallback)(function () { return calculatePopoverPosition(buttonRef, anchorAlignment); }, [anchorAlignment, calculatePopoverPosition]);
    var getMenuPosition = shouldSelfPosition ? calculateAndSetThreeDotsMenuPosition : getAnchorPosition;
    (0, react_1.useLayoutEffect)(function () {
        if (!getMenuPosition || !isPopupMenuVisible) {
            return;
        }
        getMenuPosition === null || getMenuPosition === void 0 ? void 0 : getMenuPosition().then(function (value) {
            setPosition(value);
        });
    ...
    return (<>
            ...
            e.preventDefault();
                        ...
                        <Icon_1.default src={icon !== null && icon !== void 0 ? icon : expensifyIcons.ThreeDots} fill={(iconFill !== null && iconFill !== void 0 ? iconFill : isPopupMenuVisible) ? theme.success : theme.icon}/>
