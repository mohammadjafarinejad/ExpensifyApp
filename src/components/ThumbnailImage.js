...
function ThumbnailImage(_a) {
    var _b, _c;
    var previewSourceURL = _a.previewSourceURL, altText = _a.altText, style = _a.style, isAuthTokenRequired = _a.isAuthTokenRequired, _d = _a.imageWidth, imageWidth = _d === void 0 ? 200 : _d, _e = _a.imageHeight, imageHeight = _e === void 0 ? 200 : _e, _f = _a.shouldDynamicallyResize, shouldDynamicallyResize = _f === void 0 ? true : _f, loadingIconSize = _a.loadingIconSize, _g = _a.fallbackIcon, fallbackIcon = _g === void 0 ? Expensicons.Gallery : _g, _h = _a.fallbackIconSize, fallbackIconSize = _h === void 0 ? variables_1.default.iconSizeSuperLarge : _h, fallbackIconColor = _a.fallbackIconColor, fallbackIconBackground = _a.fallbackIconBackground, _j = _a.objectPosition, objectPosition = _j === void 0 ? CONST_1.default.IMAGE_OBJECT_POSITION.INITIAL : _j, isDeleted = _a.isDeleted, onLoadFailure = _a.onLoadFailure, onMeasure = _a.onMeasure, loadingIndicatorStyles = _a.loadingIndicatorStyles, onLoad = _a.onLoad;
    ...
    return (<react_native_1.View style={[styles.thumbnailImageContainerHighlight, style, styles.overflowHidden]}>
        ...
        }} isAuthTokenRequired={isAuthTokenRequired} objectPosition={objectPosition} loadingIconSize={loadingIconSize} loadingIndicatorStyles={loadingIndicatorStyles} onLoad={onLoad}/>
            </react_native_1.View>
        </react_native_1.View>);
}
