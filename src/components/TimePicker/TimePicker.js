...
function TimePicker(_a, ref) {
    ...
    var _h = (0, react_1.useState)(function () { return DateUtils_1.default.get12HourTimeObjectFromDate(value, showFullFormat).hour; }), hours = _h[0], setHours = _h[1];
    var _j = (0, react_1.useState)(function () { return DateUtils_1.default.get12HourTimeObjectFromDate(value, showFullFormat).minute; }), minutes = _j[0], setMinutes = _j[1];
    var _k = (0, react_1.useState)(function () { return DateUtils_1.default.get12HourTimeObjectFromDate(value, showFullFormat).seconds; }), seconds = _k[0], setSeconds = _k[1];
    var _l = (0, react_1.useState)(function () { return DateUtils_1.default.get12HourTimeObjectFromDate(value, showFullFormat).milliseconds; }), milliseconds = _l[0], setMilliseconds = _l[1];
    var _m = (0, react_1.useState)(function () { return DateUtils_1.default.get12HourTimeObjectFromDate(value, showFullFormat).period; }), amPmValue = _m[0], setAmPmValue = _m[1];
    var _o = (0, react_1.useState)(false), isError = _o[0], setError = _o[1];
    var _p = (0, react_1.useState)(''), errorMessage = _p[0], setErrorMessage = _p[1];
    var _q = (0, react_1.useState)({ start: 0, end: 0 }), selectionHour = _q[0], setSelectionHour = _q[1];
    var _r = (0, react_1.useState)(showFullFormat ? { start: 0, end: 0 } : { start: minutes.length, end: minutes.length }), selectionMinute = _r[0], setSelectionMinute = _r[1]; // we focus it by default so need to have selection on the end
    var _s = (0, react_1.useState)({ start: 0, end: 0 }), selectionSecond = _s[0], setSelectionSecond = _s[1];
    var _t = (0, react_1.useState)(showFullFormat ? { start: milliseconds.length, end: milliseconds.length } : { start: 0, end: 0 }), selectionMillisecond = _t[0], setSelectionMillisecond = _t[1];
