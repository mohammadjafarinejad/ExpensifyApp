...
function BaseEducationalTooltip(_a) {
    var children = _a.children, _b = _a.shouldRender, shouldRender = _b === void 0 ? false : _b, _c = _a.shouldHideOnNavigate, shouldHideOnNavigate = _c === void 0 ? true : _c, _d = _a.shouldHideOnScroll, shouldHideOnScroll = _d === void 0 ? false : _d, uniqueID = _a.uniqueID, props = __rest(_a, ["children", "shouldRender", "shouldHideOnNavigate", "shouldHideOnScroll", "uniqueID"]);
    ...
    var shouldSuppressTooltip = !isFocused && shouldHideOnNavigate;
    ...
    (0, react_1.useLayoutEffect)(function () {
        ...
        var scrollingListener = react_native_1.DeviceEventEmitter.addListener(CONST_1.default.EVENTS.SCROLLING, function (isScrolling) {
