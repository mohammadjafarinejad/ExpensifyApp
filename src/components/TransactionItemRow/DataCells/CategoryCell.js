...
var TextWithIconCell_1 = require("@components/SelectionListWithSections/Search/TextWithIconCell");
...
function CategoryCell(_a) {
    ...
    var categoryForDisplay = (0, CategoryUtils_1.isCategoryMissing)(transactionItem === null || transactionItem === void 0 ? void 0 : transactionItem.category) ? '' : (0, CategoryUtils_1.getDecodedCategoryName)((_b = transactionItem === null || transactionItem === void 0 ? void 0 : transactionItem.category) !== null && _b !== void 0 ? _b : '');
