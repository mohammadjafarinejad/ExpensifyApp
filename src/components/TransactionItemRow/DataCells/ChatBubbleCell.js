...
function ChatBubbleCell(_a) {
    ...
    var nonEmptyStringTransactionReportID = (0, getNonEmptyStringOnyxID_1.default)(transaction.reportID);
    var getIOUActionForTransactionIDSelector = (0, react_1.useCallback)(function (reportActions) {
        return (0, ReportActionsUtils_1.getIOUActionForTransactionID)(Object.values(reportActions !== null && reportActions !== void 0 ? reportActions : {}), transaction.transactionID);
    }, [transaction.transactionID]);
    var iouReportAction = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(nonEmptyStringTransactionReportID), {
        selector: getIOUActionForTransactionIDSelector,
        canBeMissing: true,
    }, [getIOUActionForTransactionIDSelector])[0];
    ...
    var parentReport = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(nonEmptyStringTransactionReportID), {
        canBeMissing: false,
    })[0];
