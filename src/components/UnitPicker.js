...
var RadioListItem_1 = require("./SelectionList/ListItem/RadioListItem");
...
function UnitPicker(_a) {
    ...
    return (<SelectionList_1.default data={unitOptions} ListItem={RadioListItem_1.default} onSelectRow={onOptionSelected} initiallyFocusedItemKey={(_b = unitOptions.find(function (unit) { return unit.isSelected; })) === null || _b === void 0 ? void 0 : _b.keyForList}/>);
}
