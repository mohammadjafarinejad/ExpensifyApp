...
function BaseUserDetailsTooltip(_a) {
    ...
    var userDisplayName = (0, ReportUtils_1.getUserDetailTooltipText)(accountID, userDetails.displayName ? userDetails.displayName.trim() : '');
    ...
    if (delegateAccountID && delegateAccountID > 0) {
        ...
        var delegateUserDisplayName = (0, ReportUtils_1.getUserDetailTooltipText)(delegateAccountID);
    ...
    var subtitle = userLogin.trim() && formatPhoneNumber(userLogin) !== userDisplayName ? expensify_common_1.Str.removeSMSDomain(userLogin) : '';
