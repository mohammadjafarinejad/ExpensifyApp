...
function BaseValidateCodeForm(_a) {
    ...
    var _h = (0, useOnyx_1.default)(ONYXKEYS_1.default.ACCOUNT, {
        canBeMissing: true,
    })[0], account = _h === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _h;
    ...
    var defaultValidateCodeError = (0, ErrorUtils_1.getLatestErrorField)(validateCodeAction, 'actionVerified');
    var timerRef = (0, react_1.useRef)(undefined);
    var clearDefaultValidationCodeError = (0, react_1.useCallback)(function () {
        // Clear "Failed to send magic code" error
        if ((0, EmptyObject_1.isEmptyObject)(defaultValidateCodeError)) {
            return;
        }
        (0, User_1.clearValidateCodeActionError)('actionVerified');
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (wideRHPRouteKeys.length > 0 && !(0, Browser_1.isMobileSafari)()) {
            focusTimeoutRef.current = setTimeout(function () {
                var _a;
    ...
    return (<>
            ...
            {shouldShowTimer && (<react_native_1.View style={[styles.mt5, styles.flexRow, styles.renderHTML]}>
                    <RenderHTML_1.default html={translate('validateCodeForm.requestNewCode', {
                timeRemaining: "00:".concat(String(timeRemaining).padStart(2, '0')),
            })}/>
                </react_native_1.View>)}
        ...
        messages={{ 0: translate('validateCodeModal.successfulNewCodeRequest') }}/>)}
            ...
            <OfflineWithFeedback_1.default shouldDisplayErrorAbove pendingAction={validatePendingAction} errors={canShowError ? (finalValidateError !== null && finalValidateError !== void 0 ? finalValidateError : defaultValidateCodeError) : defaultValidateCodeError} errorRowStyles={[styles.mt2, styles.textWrap]} onClose={function () {
            clearError();
            ...
            clearDefaultValidationCodeError();
                ...
                {!hideSubmitButton && (<Button_1.default isDisabled={isOffline} text={submitButtonText !== null && submitButtonText !== void 0 ? submitButtonText : translate('common.verify')} onPress={validateAndSubmitForm} style={[shouldShowSkipButton ? styles.mt3 : styles.mt4]} success large 
