...
function ValueSelectionList(_a) {
    ...
    var options = (0, react_1.useMemo)(function () { return items.map(function (item) { var _a, _b; return ({ value: item.value, alternateText: item.description, text: (_a = item.label) !== null && _a !== void 0 ? _a : '', isSelected: item === selectedItem, keyForList: (_b = item.value) !== null && _b !== void 0 ? _b : '' }); }); }, [items, selectedItem]);
    return (<SelectionList_1.default data={options} onSelectRow={function (item) { return onItemSelected === null || onItemSelected === void 0 ? void 0 : onItemSelected(item); }} initiallyFocusedItemKey={selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.value} shouldStopPropagation shouldShowTooltips={shouldShowTooltips} shouldUpdateFocusedIndex ListItem={RadioListItem_1.default} addBottomSafeAreaPadding/>);
}
