...
function VideoPlayerControls(_a) {
    var duration = _a.duration, position = _a.position, url = _a.url, videoPlayerRef = _a.videoPlayerRef, videoViewRef = _a.videoViewRef, isPlaying = _a.isPlaying, _b = _a.small, small = _b === void 0 ? false : _b, style = _a.style, showPopoverMenu = _a.showPopoverMenu, togglePlayCurrentVideo = _a.togglePlayCurrentVideo, _c = _a.controlsStatus, controlsStatus = _c === void 0 ? CONST_1.default.VIDEO_PLAYER.CONTROLS_STATUS.SHOW : _c, reportID = _a.reportID;
    ...
    var enterFullScreenMode = (0, react_1.useCallback)(function () {
        ...
        (_a = videoViewRef.current) === null || _a === void 0 ? void 0 : _a.enterFullscreen();
    ...
    var durationFormatted = (0, react_1.useMemo)(function () { return (0, utils_1.convertSecondsToTime)(duration); }, [duration]);
            ...
            {controlsStatus === CONST_1.default.VIDEO_PLAYER.CONTROLS_STATUS.SHOW && (<react_native_1.View style={[styles.videoPlayerControlsButtonContainer, !small && styles.mb4]}>
                    <react_native_1.View style={[styles.videoPlayerControlsRow]}>
                        ...
                        {shouldShowTime && (<react_native_1.View style={[styles.videoPlayerControlsRow]}>
                                <Text_1.default style={[styles.videoPlayerText, styles.videoPlayerTimeComponentWidth]}>{(0, utils_1.convertSecondsToTime)(position)}</Text_1.default>
