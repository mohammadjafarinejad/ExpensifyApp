...
function PlaybackContextProvider(_a) {
    ...
    var mountedVideoPlayersRef = (0, react_1.useRef)([]);
    ...
    var shareVideoPlayerElements = (0, react_1.useCallback)(function (videoPlayerRef, videoViewRef, parent, child, shouldNotAutoPlay, _a) {
    ...
    var contextValue = (0, react_1.useMemo)(function () { return ({
        ...
        mountedVideoPlayersRef: mountedVideoPlayersRef,
