...
function VideoPopoverMenuContextProvider(_a) {
    ...
    var updateVideoPopoverMenuPlayerRef = function (videoPlayer) {
    ...
    var contextValue = (0, react_1.useMemo)(function () { return ({ menuItems: menuItems, updateVideoPopoverMenuPlayerRef: updateVideoPopoverMenuPlayerRef, updatePlaybackSpeed: updatePlaybackSpeed, updateSource: setSource }); }, [menuItems, updatePlaybackSpeed, setSource]);
