...
function WorkspaceMembersSelectionList(_a) {
    ...
    var sections = (0, react_1.useMemo)(function () {
        ...
        var filteredApprovers = (0, tokenizedSearch_1.default)(approvers, (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)(debouncedSearchTerm, countryCode), function (approver) { var _a, _b; return [(_a = approver.text) !== null && _a !== void 0 ? _a : '', (_b = approver.login) !== null && _b !== void 0 ? _b : '']; });
        return [
            {
                title: undefined,
    ...
    }, [policy === null || policy === void 0 ? void 0 : policy.employeeList, policy === null || policy === void 0 ? void 0 : policy.owner, debouncedSearchTerm, countryCode, localeCompare, personalDetails, selectedApprover]);
