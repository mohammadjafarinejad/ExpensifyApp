...
function useAccountTabIndicatorStatus() {
    ...
    var errorChecking = (_a = {},
        ...
        _a[CONST_1.default.INDICATOR_STATUS.HAS_PAYMENT_METHOD_ERROR] = (0, PaymentMethods_1.hasPaymentMethodError)(bankAccountList, fundList, allCards),
        ...
        _a[CONST_1.default.INDICATOR_STATUS.HAS_PHONE_NUMBER_ERROR] = !!((_f = privatePersonalDetails === null || privatePersonalDetails === void 0 ? void 0 : privatePersonalDetails.errorFields) === null || _f === void 0 ? void 0 : _f.phoneNumber),
        _a[CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_ERRORS] = (0, SubscriptionUtils_1.hasSubscriptionRedDotError)(stripeCustomerId, retryBillingSuccessful, billingDisputePending, retryBillingFailed),
        _a);
    var infoChecking = (_b = {},
        _b[CONST_1.default.INDICATOR_STATUS.HAS_LOGIN_LIST_INFO] = !!loginList && (0, UserUtils_1.hasLoginListInfo)(loginList, session === null || session === void 0 ? void 0 : session.email),
        _b[CONST_1.default.INDICATOR_STATUS.HAS_SUBSCRIPTION_INFO] = (0, SubscriptionUtils_1.hasSubscriptionGreenDotInfo)(stripeCustomerId, retryBillingSuccessful, billingDisputePending, retryBillingFailed),
        _b);
    var error = ((_g = Object.entries(errorChecking).find(function (_a) {
        var value = _a[1];
        return value;
    })) !== null && _g !== void 0 ? _g : [])[0];
    var info = ((_h = Object.entries(infoChecking).find(function (_a) {
        var value = _a[1];
        return value;
    })) !== null && _h !== void 0 ? _h : [])[0];
