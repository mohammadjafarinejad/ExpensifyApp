...
function useCancellationType() {
    var cancellationDetails = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_PRIVATE_CANCELLATION_DETAILS, { canBeMissing: true })[0];
    ...
    var memoizedCancellationType = (0, react_1.useMemo)(function () {
        ...
        var noneCancellation = cancellationDetails === null || cancellationDetails === void 0 ? void 0 : cancellationDetails.find(function (detail) { return detail.cancellationType === CONST_1.default.CANCELLATION_TYPE.NONE; });
        if (noneCancellation) {
