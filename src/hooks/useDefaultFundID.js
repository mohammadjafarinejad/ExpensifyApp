...
function useDefaultFundID(policyID) {
    ...
    var lastSelectedCardSettings = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.PRIVATE_EXPENSIFY_CARD_SETTINGS).concat(lastSelectedExpensifyCardFeed), { canBeMissing: true })[0];
    var getDomainFundID = (0, react_1.useCallback)(function (cardSettings) {
        var _a;
    ...
    if (lastSelectedExpensifyCardFeed && (lastSelectedCardSettings === null || lastSelectedCardSettings === void 0 ? void 0 : lastSelectedCardSettings.paymentBankAccountID)) {
