...
function useDeleteSavedSearch() {
    ...
    var DeleteConfirmModal = (<ConfirmModal_1.default title={translate('search.deleteSavedSearch')} onConfirm={handleDelete} onCancel={function () { return setIsDeleteModalVisible(false); }} isVisible={isDeleteModalVisible} prompt={translate('search.deleteSavedSearchConfirm')} confirmText={translate('common.delete')} cancelText={translate('common.cancel')} danger/>);
