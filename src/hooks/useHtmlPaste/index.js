...
var useHtmlPaste = function (textInputRef, preHtmlPasteCallback, isActive, maxLength) {
    ...
    var handlePastedHTML = (0, react_1.useCallback)(function (html) {
        paste(Parser_1.default.htmlToMarkdown(html, {}));
    }, [paste]);
    /**
    ...
    var handlePastePlainText = (0, react_1.useCallback)(function (event) {
        ...
        var clipboardText = ((_b = (_a = event.clipboardData) === null || _a === void 0 ? void 0 : _a.getData('text/plain')) === null || _b === void 0 ? void 0 : _b.trim()) || ((_d = (_c = event.clipboardData) === null || _c === void 0 ? void 0 : _c.getData('text/uri-list')) === null || _d === void 0 ? void 0 : _d.trim());
        if (!clipboardText) {
            return;
        }
        var selection = (_e = window.getSelection) === null || _e === void 0 ? void 0 : _e.call(window);
        var selectedText = (_f = selection === null || selection === void 0 ? void 0 : selection.toString()) !== null && _f !== void 0 ? _f : '';
        if ((0, MarkdownLinkHelpers_1.isStandaloneURL)(clipboardText) && selectedText) {
            paste((0, MarkdownLinkHelpers_1.toMarkdownLink)(selectedText, clipboardText));
            return;
        }
        paste(clipboardText);
    }, [paste]);
    ...
    var handlePasteRef = (0, react_1.useRef)(handlePaste);
    ...
    return {
        handlePastePlainText: handlePastePlainText,
    };
};
