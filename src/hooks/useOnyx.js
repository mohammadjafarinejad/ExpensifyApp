...
var getKeyData = function (snapshotData, key) {
    var _a;
    if (key.endsWith('_')) {
        ...
        return (Object.keys(result_1).length > 0 ? result_1 : undefined);
    }
    return getDataByPath(snapshotData === null || snapshotData === void 0 ? void 0 : snapshotData.data, key);
};
/**
...
var useOnyx = function (key, options, dependencies) {
    var isSnapshotCompatibleKey = (0, react_1.useMemo)(function () { return !key.startsWith(ONYXKEYS_1.default.COLLECTION.SNAPSHOT) && CONST_1.default.SEARCH.SNAPSHOT_ONYX_KEYS.some(function (snapshotKey) { return key.startsWith(snapshotKey); }); }, [key]);
    ...
    var _a = useOnyxOptions !== null && useOnyxOptions !== void 0 ? useOnyxOptions : {}, selectorProp = _a.selector, optionsWithoutSelector = __rest(_a, ["selector"]);
    // Determine if we should use snapshot data based on search state and key
    var shouldUseSnapshot = isOnSearch && !!currentSearchHash && isSnapshotCompatibleKey;
    ...
    var result = (0, react_1.useMemo)(function () {
        ...
        var keyData = getKeyData(originalResult[0], key);
