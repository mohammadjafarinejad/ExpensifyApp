...
function usePaymentOptions(_a) {
    ...
    var lastPaymentMethodSelector = (0, react_1.useCallback)(function (paymentMethod) {
    ...
    }, [lastPaymentMethodSelector]), lastPaymentMethod = _k[0], lastPaymentMethodResult = _k[1];
    var isLoadingLastPaymentMethod = (0, isLoadingOnyxValue_1.default)(lastPaymentMethodResult);
    var _l = (0, useOnyx_1.default)(ONYXKEYS_1.default.BANK_ACCOUNT_LIST, { canBeMissing: true })[0], bankAccountList = _l === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _l;
    var _m = (0, useOnyx_1.default)(ONYXKEYS_1.default.FUND_LIST, { canBeMissing: true })[0], fundList = _m === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _m;
    ...
    var paymentButtonOptions = (0, react_1.useMemo)(function () {
        ...
        if (isInvoiceReport) {
            var formattedPaymentMethods_1 = (0, PaymentUtils_1.formatPaymentMethods)(bankAccountList, fundList, styles, translate);
            ...
            if ((0, ReportUtils_1.isIndividualInvoiceRoom)(chatReport)) {
                buttonOptions.push({
                    ...
                    subMenuItems: __spreadArray(__spreadArray(__spreadArray([], (isCurrencySupported ? getPaymentSubitems(false) : []), true), [
                        {
                    ...
                    ], false), (isCurrencySupported ? [addBankAccountItem] : []), true),
                });
            }
            buttonOptions.push({
                text: translate('iou.settleBusiness', { formattedAmount: formattedAmount }),
                ...
                subMenuItems: __spreadArray(__spreadArray(__spreadArray([], (isCurrencySupported ? getPaymentSubitems(true) : []), true), (isCurrencySupported ? [addBankAccountItem] : []), true), [
                    {
                        text: translate('iou.payElsewhere', { formattedAmount: '' }),
                        icon: Expensicons.Cash,
                        value: CONST_1.default.IOU.PAYMENT_TYPE.ELSEWHERE,
