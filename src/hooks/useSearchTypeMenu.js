...
function useSearchTypeMenu(queryJSON) {
    ...
    var _c = (0, useOnyx_1.default)(ONYXKEYS_1.default.SESSION, { selector: Session_1.accountIDSelector, canBeMissing: false })[0], currentUserAccountID = _c === void 0 ? -1 : _c;
    var _d = (0, react_1.useState)(false), isPopoverVisible = _d[0], setIsPopoverVisible = _d[1];
    ...
    var _e = (0, react_1.useState)(true), delayPopoverMenuFirstRender = _e[0], setDelayPopoverMenuFirstRender = _e[1];
    ...
    var _f = (0, react_1.useMemo)(function () {
        ...
        var menuItems = Object.entries(savedSearches).map(function (_a, index) {
            ...
            if (savedSearchTitle === item.query) {
                ...
                savedSearchTitle = (0, SearchQueryUtils_1.buildUserReadableQueryString)(jsonQuery, personalDetails, reports, taxRates, allCards, allFeeds, allPolicies, currentUserAccountID);
            }
    ...
    }, [savedSearches, hash, getOverflowMenu, personalDetails, reports, taxRates, allCards, allFeeds, allPolicies, currentUserAccountID]), savedSearchesMenuItems = _f.savedSearchesMenuItems, isSavedSearchActive = _f.isSavedSearchActive;
