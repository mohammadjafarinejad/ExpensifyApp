...
var translations = {
    common: {
        ...
        view: 'Voir',
        review: function (reviewParams) { return "R\u00E9viser".concat((reviewParams === null || reviewParams === void 0 ? void 0 : reviewParams.amount) ? " ".concat(reviewParams === null || reviewParams === void 0 ? void 0 : reviewParams.amount) : ''); },
        not: 'Pas',
        signIn: 'Se connecter',
        ...
        acceptTermsAndPrivacy: "J'accepte le <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Conditions d'utilisation d'Expensify</a> et <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Politique de confidentialit\u00E9</a>"),
        acceptTermsAndConditions: "J'accepte le <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.ACH_TERMS_URL, "\">termes et conditions</a>"),
        acceptTermsOfService: "J'accepte le <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Conditions d'utilisation d'Expensify</a>"),
        remove: 'Supprimer',
        admin: 'Admin',
        owner: 'Propriétaire',
        ...
        noResultsFoundMatching: function (searchString) { return "Aucun r\u00E9sultat trouv\u00E9 correspondant \u00E0 \"".concat(searchString, "\""); },
        ...
        error: {
            ...
            phoneNumber: "Veuillez entrer un num\u00E9ro de t\u00E9l\u00E9phone complet\n(par exemple, ".concat(CONST_1.default.FORMATTED_EXAMPLE_PHONE_NUMBER, ")"),
        ...
        leaveWorkspaceConfirmationApprover: function (_a) {
            ...
            return "Si vous quittez cet espace de travail, vous serez remplac\u00E9 dans le flux d\u2019approbation par ".concat(workspaceOwner, ", le propri\u00E9taire de l\u2019espace de travail.");
        },
        leaveWorkspaceConfirmationExporter: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Si vous quittez cet espace de travail, vous serez remplac\u00E9 en tant qu\u2019exportateur pr\u00E9f\u00E9r\u00E9 par ".concat(workspaceOwner, ", le propri\u00E9taire de l\u2019espace de travail.");
        },
        leaveWorkspaceConfirmationTechContact: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Si vous quittez cet espace de travail, vous serez remplac\u00E9 en tant que contact technique par ".concat(workspaceOwner, ", le propri\u00E9taire de l\u2019espace de travail.");
        },
        leaveWorkspaceReimburser: 'Vous ne pouvez pas quitter cet espace de travail en tant que rembourseur. Veuillez définir un nouveau rembourseur dans Espaces de travail > Effectuer ou suivre des paiements, puis réessayez.',
    ...
    supportalNoAccess: {
        ...
        descriptionWithCommand: function (_a) {
            ...
            return "Vous n'\u00EAtes pas autoris\u00E9 \u00E0 effectuer cette action lorsque le support est connect\u00E9 (commande : ".concat(command !== null && command !== void 0 ? command : '', "). Si vous pensez que Success devrait pouvoir effectuer cette action, veuillez entamer une conversation sur Slack.");
        },
    },
    lockedAccount: {
    ...
    reportActionContextMenu: {
        ...
        deleteConfirmation: function (_a) {
            ...
            return "\u00CAtes-vous s\u00FBr de vouloir supprimer ce ".concat(type, " ?");
        },
    ...
    reportActionsView: {
        beginningOfArchivedRoom: function (_a) {
            ...
            return "Vous avez rat\u00E9 la f\u00EAte \u00E0 <strong><a class=\"no-style-link\" href=\"".concat(reportDetailsLink, "\">").concat(reportName, "</a></strong>, il n'y a rien \u00E0 voir ici.");
        },
        beginningOfChatHistoryDomainRoom: function (_a) {
            var domainRoom = _a.domainRoom;
            return "Ce chat est destin\u00E9 \u00E0 tous les membres d'Expensify sur le domaine <strong>".concat(domainRoom, "</strong>. Utilisez-le pour discuter avec vos coll\u00E8gues, partager des astuces et poser des questions.");
        },
        beginningOfChatHistoryAdminRoom: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Ce chat est avec l'administrateur <strong>".concat(workspaceName, "</strong>. Utilisez-le pour discuter de la configuration de l'espace de travail et d'autres sujets.");
        },
        beginningOfChatHistoryAnnounceRoom: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Cette discussion est ouverte \u00E0 tous les membres de <strong>".concat(workspaceName, "</strong>. Utilisez-le pour les annonces les plus importantes.");
        },
        beginningOfChatHistoryUserRoom: function (_a) {
            var reportName = _a.reportName, reportDetailsLink = _a.reportDetailsLink;
            return "Ce salon de discussion est destin\u00E9 \u00E0 tout ce qui concerne <strong><a class=\"no-style-link\" href=\"".concat(reportDetailsLink, "\">").concat(reportName, "</a></strong>.");
        },
        beginningOfChatHistoryInvoiceRoom: function (_a) {
            var invoicePayer = _a.invoicePayer, invoiceReceiver = _a.invoiceReceiver;
            return "Ce chat concerne les factures entre <strong>".concat(invoicePayer, "</strong> et <strong>").concat(invoiceReceiver, "</strong>. Utilisez le bouton + pour envoyer une facture.");
        },
        ...
        beginningOfChatHistoryPolicyExpenseChat: function (_a) {
            ...
            return "C'est ici que <strong>".concat(submitterDisplayName, "</strong> soumettra ses d\u00E9penses \u00E0 <strong>").concat(workspaceName, "</strong>. Il suffit d'utiliser le bouton +.");
        },
    ...
    spreadsheet: {
        ...
        dragAndDrop: '<muted-link>Faites glisser et déposez votre feuille de calcul ici, ou choisissez un fichier ci-dessous. Formats pris en charge : .csv, .txt, .xls et .xlsx.</muted-link>',
        dragAndDropMultiLevelTag: "<muted-link>Faites glisser et d\u00E9posez votre feuille de calcul ici, ou choisissez un fichier ci-dessous. <a href=\"".concat(CONST_1.default.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK, "\">En savoir plus</a> sur les formats de fichier pris en charge.</muted-link>"),
        ...
        chooseSpreadsheetMultiLevelTag: "<muted-link>S\u00E9lectionnez un fichier de feuille de calcul \u00E0 importer. <a href=\"".concat(CONST_1.default.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK, "\">En savoir plus</a> sur les formats de fichier pris en charge.</muted-link>"),
        ...
        importMemberConfirmation: function () { return ({
            ...
            other: function (count) {
                return "Veuillez confirmer les informations ci-dessous pour les ".concat(count, " nouveaux membres de l\u2019espace de travail qui seront ajout\u00E9s dans le cadre de cet import. Les membres existants ne recevront aucune mise \u00E0 jour de r\u00F4le ni de message d\u2019invitation.");
            },
        }); },
    },
    receipt: {
        ...
        alternativeMethodsDownloadApp: function (_a) {
            ...
            return "<label-text><a href=\"".concat(downloadUrl, "\">T\u00E9l\u00E9charger l\u2019application</a> pour scanner depuis votre t\u00E9l\u00E9phone</label-text>");
        },
        alternativeMethodsForwardReceipts: function (_a) {
            var email = _a.email;
            return "<label-text>Transf\u00E9rez les re\u00E7us \u00E0 <a href=\"mailto:".concat(email, "\">").concat(email, "</a></label-text>");
        },
        alternativeMethodsAddPhoneNumber: function (_a) {
            var phoneNumber = _a.phoneNumber, contactMethodsUrl = _a.contactMethodsUrl;
            return "<label-text><a href=\"".concat(contactMethodsUrl, "\">Ajoutez votre num\u00E9ro</a> pour envoyer des re\u00E7us par SMS au ").concat(phoneNumber, "</label-text>");
        },
        alternativeMethodsTextReceipts: function (_a) {
            var phoneNumber = _a.phoneNumber;
            return "<label-text>Envoyez des re\u00E7us par SMS au ".concat(phoneNumber, " (num\u00E9ros US uniquement)</label-text>");
        },
        takePhoto: 'Prendre une photo',
        cameraAccess: "L'accès à la caméra est requis pour prendre des photos des reçus.",
        deniedCameraAccess: "L'acc\u00E8s \u00E0 la cam\u00E9ra n'a toujours pas \u00E9t\u00E9 accord\u00E9, veuillez suivre <a href=\"".concat(CONST_1.default.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL, "\">ces instructions</a>."),
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "supprim\u00E9 une d\u00E9pense (".concat(amount, " pour ").concat(merchant, ")");
        },
        ...
        unreportedTransaction: function (_a) {
            ...
            return "d\u00E9plac\u00E9 cette d\u00E9pense vers votre <a href=\"".concat(reportUrl, "\">espace personnel</a>");
        },
        movedAction: function (_a) {
            ...
            if (shouldHideMovedReportUrl) {
                return "a d\u00E9plac\u00E9 ce rapport vers l\u2019espace de travail <a href=\"".concat(newParentReportUrl, "\">").concat(toPolicyName, "</a>");
            }
            return "a d\u00E9plac\u00E9 ce <a href=\"".concat(movedReportUrl, "\">rapport</a> vers l\u2019espace de travail <a href=\"").concat(newParentReportUrl, "\">").concat(toPolicyName, "</a>");
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Payer ".concat(formattedAmount, " en tant qu'individu") : "Payer avec un compte personnel");
        },
        settleWallet: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Payer ".concat(formattedAmount, " avec le portefeuille") : "Payer avec le portefeuille");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Payer ".concat(formattedAmount, " en tant qu'entreprise") : "Payer avec un compte professionnel");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Marquer ".concat(formattedAmount, " comme pay\u00E9") : "Marquer comme pay\u00E9");
        },
        settleInvoicePersonal: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return (amount ? "Pay\u00E9 ".concat(amount, " avec le compte personnel ").concat(last4Digits) : "Pay\u00E9 avec le compte personnel");
        },
        settleInvoiceBusiness: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return amount ? "Pay\u00E9 ".concat(amount, " avec le compte professionnel ").concat(last4Digits) : "Pay\u00E9 avec le compte professionnel";
        },
        payWithPolicy: function (_a) {
            var formattedAmount = _a.formattedAmount, policyName = _a.policyName;
            return (formattedAmount ? "Payer ".concat(formattedAmount, " via ").concat(policyName) : "Payer via ".concat(policyName));
        },
        businessBankAccount: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return amount ? "pay\u00E9 ".concat(amount, " avec le compte bancaire ").concat(last4Digits, ".") : "pay\u00E9 avec le compte bancaire ".concat(last4Digits);
        },
        automaticallyPaidWithBusinessBankAccount: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return "pay\u00E9 ".concat(amount ? "".concat(amount, " ") : '', "avec le compte bancaire se terminant par ").concat(last4Digits, " via les <a href=\"").concat(CONST_1.default.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL, "\">r\u00E8gles de l\u2019espace de travail</a>");
        },
        invoicePersonalBank: function (_a) {
            var lastFour = _a.lastFour;
            return "Compte personnel \u2022 ".concat(lastFour);
        },
        invoiceBusinessBank: function (_a) {
            var lastFour = _a.lastFour;
            return "Compte professionnel \u2022 ".concat(lastFour);
        },
        ...
        submitted: function (_a) {
            var memo = _a.memo;
            return "soumis".concat(memo ? ", en disant ".concat(memo) : '');
        },
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "a commenc\u00E9 le paiement, mais attend que ".concat(submitterDisplayName, " ajoute un compte bancaire.");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', "marqu\u00E9 comme pay\u00E9");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "pay\u00E9 avec le portefeuille");
        },
        ...
        changeApprover: {
            ...
            description: function (_a) {
                ...
                return "Vous pouvez \u00E9galement modifier l'approbateur de mani\u00E8re permanente pour tous les rapports dans vos <a href=\"".concat(workflowSettingLink, "\">param\u00E8tres de flux de travail</a>.");
            },
            changedApproverMessage: function (_a) {
                var managerID = _a.managerID;
                return "a chang\u00E9 l'approbateur en <mention-user accountID=\"".concat(managerID, "\"/>");
            },
            actions: {
    ...
    transactionMerge: {
        listPage: {
            ...
            noEligibleExpenseFoundSubtitle: "<muted-text><centered-text>Vous n\u2019avez aucune d\u00E9pense pouvant \u00EAtre fusionn\u00E9e avec celle-ci. <a href=\"".concat(CONST_1.default.HELP_DOC_LINKS.MERGE_EXPENSES, "\">En savoir plus</a> sur les d\u00E9penses \u00E9ligibles.</centered-text></muted-text>"),
            selectTransactionToMerge: function (_a) {
                var reportName = _a.reportName;
                return "S\u00E9lectionnez une <a href=\"".concat(CONST_1.default.HELP_DOC_LINKS.MERGE_EXPENSES, "\">d\u00E9pense \u00E9ligible</a> \u00E0 fusionner <strong>").concat(reportName, "</strong>.");
            },
        },
        receiptPage: {
        ...
        detailsPage: {
            ...
            pleaseSelectError: function (_a) {
                var field = _a.field;
                return "Veuillez s\u00E9lectionner un/une ".concat(field);
            },
    ...
    contacts: {
        ...
        helpText: function (_a) {
            var email = _a.email;
            return "Ajoutez plus de moyens pour envoyer des re\u00E7us. Transf\u00E9rez-les \u00E0 <copy-text text=\"".concat(email, "\"/> ou envoyez-les par SMS au 47777 (num\u00E9ros am\u00E9ricains uniquement).");
        },
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            description: "<muted-text>Utilisez les outils ci-dessous pour vous aider à résoudre les problèmes liés à l'utilisation d'Expensify. Si vous rencontrez des problèmes, veuillez <concierge-link>soumettre un bug</concierge-link>.</muted-text>",
        ...
        versionLetter: 'v',
        readTheTermsAndPrivacy: "<muted-text-micro>Lisez les <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Conditions d'utilisation</a> et de <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Confidentialit\u00E9</a>.</muted-text-micro>"),
        help: 'Aide',
    ...
    mergeAccountsPage: {
        ...
        accountDetails: {
            accountToMergeInto: function (_a) {
                var login = _a.login;
                return "Saisissez le compte que vous souhaitez fusionner dans <strong>".concat(login, "</strong>.");
            },
        ...
        accountValidate: {
            ...
            lossOfUnsubmittedData: function (_a) {
                var login = _a.login;
                return "La fusion de vos comptes est irr\u00E9versible et entra\u00EEnera la perte de toutes les d\u00E9penses non soumises pour <strong>".concat(login, "</strong>.");
            },
            enterMagicCode: function (_a) {
                var login = _a.login;
                return "Pour continuer, veuillez saisir le code magique envoy\u00E9 \u00E0 <strong>".concat(login, "</strong>.");
            },
            errors: {
        ...
        mergeSuccess: {
            ...
            description: function (_a) {
                ...
                return "<muted-text><centered-text>Vous avez fusionn\u00E9 avec succ\u00E8s toutes les donn\u00E9es de <strong>".concat(from, "</strong> dans <strong>").concat(to, "</strong>. Pour la suite, vous pouvez utiliser n'importe quel login pour ce compte.</centered-text></muted-text>");
            },
        },
        mergePendingSAML: {
        ...
        mergeFailureSAMLDomainControlDescription: function (_a) {
            var _b;
            var email = _a.email;
            return "<muted-text><centered-text>Vous ne pouvez pas fusionner <strong>".concat(email, "</strong> car il est contr\u00F4l\u00E9 par <strong>").concat((_b = email.split('@').at(1)) !== null && _b !== void 0 ? _b : '', "</strong>. Veuillez <concierge-link>contacter le Concierge</concierge-link> pour obtenir de l'aide.</centered-text></muted-text>");
        },
        mergeFailureSAMLAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Vous ne pouvez pas fusionner <strong>".concat(email, "</strong> iavec d'autres comptes car votre administrateur de domaine l'a d\u00E9fini comme votre login principal. Veuillez fusionner d'autres comptes \u00E0 la place.</centered-text></muted-text>");
        },
        mergeFailure2FA: {
            description: function (_a) {
                var email = _a.email;
                return "<muted-text><centered-text>Vous ne pouvez pas fusionner les comptes car l'authentification \u00E0 deux facteurs (2FA) est activ\u00E9e sur <strong>".concat(email, "</strong>. Veuillez d\u00E9sactiver l'authentification \u00E0 deux facteurs pour <strong>").concat(email, "</strong> et r\u00E9essayer.</centered-text></muted-text>");
            },
            learnMore: 'En savoir plus sur la fusion des comptes.',
        },
        mergeFailureAccountLockedDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Vous ne pouvez pas fusionner <strong>".concat(email, "</strong> parce qu'il est verrouill\u00E9. Veuillez <concierge-link>contacter le Concierge</concierge-link> pour obtenir de l'aide.</centered-text></muted-text>");
        },
        mergeFailureUncreatedAccountDescription: function (_a) {
            var email = _a.email, contactMethodLink = _a.contactMethodLink;
            return "<muted-text><centered-text>Vous ne pouvez pas fusionner les comptes car <strong>".concat(email, "</strong> n'a pas de compte Expensify. Veuillez <a href=\"").concat(contactMethodLink, "\">l'ajouter comme m\u00E9thode de contact</a> \u00E0 la place.</centered-text></muted-text>");
        },
        mergeFailureSmartScannerAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Vous ne pouvez pas fusionner <strong>".concat(email, "</strong> avec d'autres comptes. Veuillez fusionner d'autres comptes \u00E0 la place.</centered-text></muted-text>");
        },
        mergeFailureInvoicedAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Vous ne pouvez pas fusionner des comptes dans <strong>".concat(email, "</strong> parce que ce compte poss\u00E8de une relation de facturation.</centered-text></muted-text>");
        },
    ...
    billingCurrency: {
        ...
        note: "Note : Changer la devise de paiement peut avoir un impact sur le montant que vous paierez pour Expensify. Consultez notre <a href=\"".concat(CONST_1.default.PRICING, "\">page de tarification</a> pour plus de d\u00E9tails."),
    },
    addDebitCardPage: {
    ...
    cardPage: {
        ...
        missingPrivateDetails: function (_a) {
            ...
            return "Veuillez <a href=\"".concat(missingDetailsLink, "\">ajouter vos informations personnelles</a>, puis r\u00E9essayez.");
        },
        ...
        cardFraudAlert: {
            ...
            clearedMessage: function (_a) {
                ...
                return "a effac\u00E9 l'activit\u00E9 suspecte et r\u00E9activ\u00E9 la carte x".concat(cardLastFour, ". Tout est pr\u00EAt pour continuer \u00E0 faire des d\u00E9penses !");
            },
            deactivatedMessage: function (_a) {
                var cardLastFour = _a.cardLastFour;
                return "d\u00E9sactiv\u00E9 la carte se terminant par ".concat(cardLastFour);
            },
            alertMessage: function (_a) {
                var cardLastFour = _a.cardLastFour, amount = _a.amount, merchant = _a.merchant, date = _a.date;
                return "activit\u00E9 suspecte identifi\u00E9e sur la carte se terminant par ".concat(cardLastFour, ". Reconnaissez-vous cette transaction ?\n\n").concat(amount, " pour ").concat(merchant, " - ").concat(date);
            },
        },
    },
    workflowsPage: {
    ...
    termsOfUse: {
        terms: "<muted-text-xs>En vous connectant, vous acceptez les <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Conditions de service</a> et de <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Confidentialit\u00E9</a>.</muted-text-xs>"),
        license: "<muted-text-xs>Le transfert de fonds est assur\u00E9 par ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " (NMLS ID:2017010) conform\u00E9ment \u00E0 ses <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.LICENSES_URL, "\">licences</a>.</muted-text-xs>"),
    },
    validateCodeForm: {
        ...
        requestNewCode: function (_a) {
            ...
            return "Demander un nouveau code dans <a>".concat(timeRemaining, "</a>");
        },
        ...
        tasks: {
            ...
            addExpenseApprovalsTask: {
                ...
                description: function (_a) {
                    ...
                    return "*Ajoutez des validations de d\u00E9penses* pour examiner les d\u00E9penses de votre \u00E9quipe et les garder sous contr\u00F4le.\n" +
                        '\n' +
                        "Voici comment faire :\n" +
                        '\n' +
                        ...
                        '\n' +
                        "[Aller \u00E0 plus de fonctionnalit\u00E9s](".concat(workspaceMoreFeaturesLink, ").");
                },
            },
            ...
            addAccountingIntegrationTask: {
                ...
                description: function (_a) {
                    ...
                    return "Connectez".concat(integrationName === CONST_1.default.ONBOARDING_ACCOUNTING_MAPPING.other ? '-vous à votre' : '-vous à', " ").concat(integrationName, " pour automatiser le codage et la synchronisation des d\u00E9penses. La cl\u00F4ture mensuelle devient un jeu d\u2019enfant.\n") +
                        ...
                        "4. Trouvez ".concat(integrationName, ".\n") +
            ...
            setupCategoriesAndTags: {
                title: function (_a) {
                    ...
                    return "Configurer les [cat\u00E9gories](".concat(workspaceCategoriesLink, ") et [tags](").concat(workspaceTagsLink, ")");
                },
                description: function (_a) {
            ...
            setupTagsTask: {
                title: function (_a) {
                    ...
                    return "Configurer les [tags](".concat(workspaceTagsLink, ")");
                },
                description: function (_a) {
                    var workspaceMoreFeaturesLink = _a.workspaceMoreFeaturesLink;
            ...
            reviewWorkspaceSettingsTask: {
                ...
                description: function (_a) {
                    ...
                    return 'Voici comment vérifier et mettre à jour vos paramètres :\n' +
                        ...
                        "[Acc\u00E9der \u00E0 votre espace de travail.](".concat(workspaceSettingsLink, ")");
                },
            },
            createReportTask: {
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: function (_a) {
            var login = _a.login;
            return "<strong>Confirmez que ".concat(login, " est orthographi\u00E9 correctement et qu'il s'agit d'une adresse e-mail r\u00E9elle et valide.</strong> Les alias d'e-mail tels que \"expenses@domain.com\" doivent avoir acc\u00E8s \u00E0 leur propre bo\u00EEte de r\u00E9ception pour \u00EAtre un identifiant Expensify valide.");
        },
        ensureYourEmailClient: "<strong>Assurez-vous que votre client de messagerie autorise les emails de expensify.com.</strong> Vous trouverez des instructions sur la mani\u00E8re de r\u00E9aliser cette \u00E9tape <a href=\"".concat(CONST_1.default.SET_NOTIFICATION_LINK, "\">ici</a> mais vous aurez peut-\u00EAtre besoin de l'aide de votre service informatique pour configurer vos param\u00E8tres de messagerie."),
        onceTheAbove: "Une fois les \u00E9tapes ci-dessus termin\u00E9es, veuillez contacter <a href=\"mailto:".concat(CONST_1.default.EMAIL.CONCIERGE, "\">").concat(CONST_1.default.EMAIL.CONCIERGE, "</a> pour d\u00E9bloquer votre connexion."),
    },
    ...
    focusModeUpdateModal: {
        ...
        prompt: function (_a) {
            ...
            return "Restez au courant des choses en ne voyant que les discussions non lues ou celles qui n\u00E9cessitent votre attention. Ne vous inqui\u00E9tez pas, vous pouvez changer cela \u00E0 tout moment dans <a href=\"".concat(priorityModePageUrl, "\">param\u00E8tres</a>.");
        },
    },
    notFound: {
    ...
    bankAccount: {
        ...
        error: {
            ...
            deletePaymentBankAccount: 'Ce compte bancaire ne peut pas être supprimé car il est utilisé pour les paiements par carte Expensify. Si vous souhaitez toujours supprimer ce compte, veuillez contacter le Concierge.',
        },
    },
    ...
    additionalDetailsStep: {
        ...
        failedKYCMessage: function (_a) {
            ...
            return "Nous n'avons pas pu v\u00E9rifier votre identit\u00E9. Veuillez r\u00E9essayer plus tard ou contacter <a href=\"mailto:".concat(conciergeEmail, "\">").concat(conciergeEmail, "</a> si vous avez des questions.");
        },
    },
    termsStep: {
        ...
        haveReadAndAgree: "J'ai lu et j'accepte de recevoir des <a href=\"".concat(CONST_1.default.ELECTRONIC_DISCLOSURES_URL, "\">divulgations \u00E9lectroniques</a>."),
        ...
        agreeToThe: function (_a) {
            ...
            return "J'accepte l'accord sur le respect de la <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">vie priv\u00E9e</a> et le <a href=\"").concat(walletAgreementUrl, "\">Wallet</a>.");
        },
        ...
        shortTermsForm: {
            ...
            generalInfo: "Pour des informations g\u00E9n\u00E9rales sur les comptes pr\u00E9pay\u00E9s, visitez <a href=\"".concat(CONST_1.default.CFPB_PREPAID_URL, "\">").concat(CONST_1.default.TERMS.CFPB_PREPAID, "</a>."),
            conditionsDetails: "Pour conna\u00EEtre les d\u00E9tails et les conditions de tous les frais et services, consultez le site <a href=\"".concat(CONST_1.default.FEES_URL, "\">").concat(CONST_1.default.FEES_URL, "</a> ou appelez le +1 833-400-0904."),
        ...
        longTermsForm: {
            ...
            electronicFundsStandardDetails: "Il n'y a pas de frais pour transférer des fonds de votre Portefeuille Expensify vers votre compte bancaire en utilisant l'option standard. Ce transfert est généralement effectué dans un délai de 1 à 3 jours ouvrables.",
            electronicFundsInstantDetails: function (_a) {
                var percentage = _a.percentage, amount = _a.amount;
                return "Il y a des frais pour transférer des fonds de votre Portefeuille Expensify à votre carte de débit liée en utilisant l'option de transfert instantané." +
                    " Ce transfert s'effectue g\u00E9n\u00E9ralement en quelques minutes. Les frais s'\u00E9l\u00E8vent \u00E0 ".concat(percentage, "% du montant du transfert (avec un minimum de ").concat(amount, ").");
            },
            fdicInsuranceBancorp: function (_a) {
                var amount = _a.amount;
                return "Vos fonds sont \u00E9ligibles \u00E0 l'assurance FDIC. Vos fonds seront conserv\u00E9s ou transf\u00E9r\u00E9s \u00E0 ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", une institution assur\u00E9e par le FDIC.") +
                    " Une fois sur place, vos fonds sont assur\u00E9s \u00E0 hauteur de ".concat(amount, " par la FDIC en cas de faillite de ").concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", si les conditions sp\u00E9cifiques d'assurance-d\u00E9p\u00F4t sont remplies et si votre carte est enregistr\u00E9e.") +
                    " Voir ".concat(CONST_1.default.TERMS.FDIC_PREPAID, " pour plus de d\u00E9tails.");
            },
            contactExpensifyPayments: "Contactez ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " en appelant le +1 833-400-0904, par courriel \u00E0 ").concat(CONST_1.default.EMAIL.CONCIERGE, " ou en vous connectant \u00E0 ").concat(CONST_1.default.NEW_EXPENSIFY_URL, "."),
            generalInformation: "Pour des informations g\u00E9n\u00E9rales sur les comptes pr\u00E9pay\u00E9s, visitez ".concat(CONST_1.default.TERMS.CFPB_PREPAID, ". Si vous avez une plainte \u00E0 formuler au sujet d'un compte pr\u00E9pay\u00E9, appelez le Consumer Financial Protection Bureau au 1-855-411-2372 ou visitez ").concat(CONST_1.default.TERMS.CFPB_COMPLAINT, "."),
    ...
    beneficialOwnerInfoStep: {
        ...
        areThereMoreIndividualsWhoOwn25percent: function (_a) {
            var companyName = _a.companyName;
            return "Y a-t-il d'autres personnes qui d\u00E9tiennent 25 % ou plus de ".concat(companyName, " ?");
        },
    ...
    signerInfoStep: {
        ...
        areYouDirector: function (_a) {
            var companyName = _a.companyName;
            return "\u00CAtes-vous un directeur chez ".concat(companyName, " ?");
        },
        ...
        enterOneEmail: function (_a) {
            var companyName = _a.companyName;
            return "Entrez l'email du directeur chez ".concat(companyName);
        },
        ...
        enterTwoEmails: function (_a) {
            var companyName = _a.companyName;
            return "Entrez les e-mails de deux directeurs chez ".concat(companyName);
        },
        ...
        isConnecting: function (_a) {
            ...
            return "connecte un compte bancaire professionnel en ".concat(currency, " se terminant par ").concat(bankAccountLastFour, " \u00E0 Expensify pour payer les employ\u00E9s en ").concat(currency, ". L'\u00E9tape suivante n\u00E9cessite les informations d\u2019un signataire, tel qu\u2019un directeur.");
        },
        error: {
    ...
    docusignStep: {
        ...
        pleaseComplete: 'Veuillez remplir le formulaire d’autorisation ACH via le lien Docusign ci-dessous, puis téléversez une copie signée ici afin que nous puissions prélever les fonds directement de votre compte bancaire.',
        ...
        pleaseCompleteTheDirect: 'Veuillez remplir l’accord de prélèvement automatique via le lien Docusign ci-dessous, puis téléversez une copie signée ici afin que nous puissions prélever les fonds directement de votre compte bancaire.',
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: "Veuillez accepter les <a href=\"".concat(CONST_1.default.TRAVEL_TERMS_URL, "\">conditions g\u00E9n\u00E9rales</a> d'Expensify Travel."),
        ...
        phoneError: function (_a) {
            ...
            return "<rbr>Veuillez <a href=\"".concat(phoneErrorMethodsRoute, "\">ajouter un courriel professionnel comme identifiant principal</a> pour r\u00E9server un voyage.</rbr>");
        },
        domainSelector: {
            title: 'Domaine',
        ...
        domainPermissionInfo: {
            ...
            restriction: function (_a) {
                ...
                return "Vous n'avez pas l'autorisation d'activer Expensify Travel pour le domaine <strong>".concat(domain, "</strong>. Vous devrez demander \u00E0 quelqu'un de ce domaine d'activer Travel \u00E0 votre place.");
            },
            accountantInvitation: "Si vous \u00EAtes comptable, pensez \u00E0 rejoindre le <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.EXPENSIFY_APPROVED_PROGRAM_URL, "\">programme ExpensifyApproved! pour les comptables</a> afin d'activer les d\u00E9placements pour ce domaine."),
        },
        publicDomainError: {
        ...
        verifyCompany: {
            ...
            conciergeMessage: function (_a) {
                var domain = _a.domain;
                return "L'activation du voyage a \u00E9chou\u00E9 pour le domaine : ".concat(domain, ". Veuillez v\u00E9rifier et activer le voyage pour ce domaine.");
            },
        },
        updates: {
    ...
    workspace: {
        common: {
            ...
            shareNote: {
                ...
                content: function (_a) {
                    ...
                    return "Partagez ce code QR ou copiez le lien ci-dessous pour permettre aux membres de demander facilement l'acc\u00E8s \u00E0 votre espace de travail. Toutes les demandes d'adh\u00E9sion \u00E0 l'espace de travail s'afficheront dans la salle <a href=\"".concat(adminsRoomLink, "\">").concat(CONST_1.default.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS, "</a> pour que vous puissiez les examiner.");
                },
            },
            ...
            deepDiveExpensifyCard: "<muted-text-label>Les transactions Expensify Card seront automatiquement export\u00E9es vers un \u00AB Expensify Card Liability Account \u00BB cr\u00E9\u00E9 avec <a href=\"".concat(CONST_1.default.DEEP_DIVE_EXPENSIFY_CARD, "\">notre int\u00E9gration</a>.</muted-text-label>"),
        },
        receiptPartners: {
            ...
            uber: {
                subtitle: function (_a) {
                    ...
                    return organizationName ? "Connect\u00E9 \u00E0 ".concat(organizationName) : 'Automatisez les frais de voyage et de livraison de repas dans toute votre organisation.';
                },
                sendInvites: 'Inviter des membres',
                sendInvitesDescription: "Ces membres de l'espace de travail n'ont pas encore de compte Uber for Business. Désélectionnez les membres que vous ne souhaitez pas inviter pour le moment.",
                ...
                status: (_e = {
                    ...
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.LINKED] = 'Lié',
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.LINKED_PENDING_APPROVAL] = 'En attente',
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.SUSPENDED] = 'Suspendu',
                    _e),
        ...
        perDiem: {
            subtitle: "<muted-text>D\u00E9finissez des taux de per diem pour contr\u00F4ler les d\u00E9penses quotidiennes des employ\u00E9s. <a href=\"".concat(CONST_1.default.DEEP_DIVE_PER_DIEM, "\">En savoir plus</a>.</muted-text>"),
            amount: 'Montant',
        ...
        qbd: {
            ...
            accounts: (_g = {},
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Carte de crédit',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Facture fournisseur',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Écriture comptable',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Vérifier',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = "Nous créerons un chèque détaillé pour chaque rapport Expensify et l'enverrons depuis le compte bancaire ci-dessous.",
                ...
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = "Nous créerons une facture fournisseur détaillée pour chaque rapport Expensify avec la date de la dernière dépense, et l'ajouterons au compte ci-dessous. Si cette période est clôturée, nous la publierons au 1er de la prochaine période ouverte.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Choisissez où exporter les transactions par carte de crédit.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Choisissez un fournisseur à appliquer à toutes les transactions par carte de crédit.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = "Choisissez d'où envoyer les chèques.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = "Les factures des fournisseurs ne sont pas disponibles lorsque les emplacements sont activés. Veuillez choisir une autre option d'exportation.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = "Les chèques sont indisponibles lorsque les emplacements sont activés. Veuillez choisir une autre option d'exportation.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = "Les écritures de journal ne sont pas disponibles lorsque les taxes sont activées. Veuillez choisir une autre option d'exportation.",
                _g),
            ...
            setupPage: {
                ...
                setupErrorBody: function (_a) {
                    ...
                    return "<muted-text><centered-text>La connexion \u00E0 QuickBooks Desktop ne fonctionne pas pour le moment. Veuillez r\u00E9essayer plus tard ou <a href=\"".concat(conciergeLink, "\">contacter le Concierge</a> si le probl\u00E8me persiste.</centered-text></muted-text>");
                },
            },
            ...
            accountingMethods: {
                ...
                values: (_h = {},
                    ...
                    _h[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Espèces',
                    _h),
                alternateText: (_j = {},
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Les dépenses hors de la poche seront exportées une fois approuvées définitivement.',
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = "Les dépenses personnelles seront exportées lorsqu'elles seront payées.",
                    _j),
            },
        },
        qbo: {
            ...
            accounts: (_l = {},
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = 'Carte de débit',
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Carte de crédit',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Facture fournisseur',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Écriture comptable',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Vérifier',
                ...
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "Nous associerons automatiquement le nom du commerçant sur la transaction par carte de crédit à tout fournisseur correspondant dans QuickBooks. Si aucun fournisseur n'existe, nous créerons un fournisseur « Crédit Carte Divers » pour l'association.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = "Nous créerons une facture fournisseur détaillée pour chaque rapport Expensify avec la date de la dernière dépense, et l'ajouterons au compte ci-dessous. Si cette période est clôturée, nous la publierons au 1er de la prochaine période ouverte.",
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Choisissez où exporter les transactions par carte de débit.',
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Choisissez où exporter les transactions par carte de crédit.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Choisissez un fournisseur à appliquer à toutes les transactions par carte de crédit.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = "Les factures des fournisseurs ne sont pas disponibles lorsque les emplacements sont activés. Veuillez choisir une autre option d'exportation.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = "Les chèques sont indisponibles lorsque les emplacements sont activés. Veuillez choisir une autre option d'exportation.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = "Les écritures de journal ne sont pas disponibles lorsque les taxes sont activées. Veuillez choisir une autre option d'exportation.",
                _l),
            exportDestinationAccountsMisconfigurationError: (_m = {},
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = "Choisissez un compte valide pour l'exportation de la facture fournisseur",
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = "Choisissez un compte valide pour l'exportation de l'écriture de journal",
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = "Choisissez un compte valide pour l'exportation de chèques",
                _m),
            exportDestinationSetupAccountsInfo: (_o = {},
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = "Pour utiliser l'exportation de factures fournisseurs, configurez un compte de comptes fournisseurs dans QuickBooks Online.",
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = "Pour utiliser l'exportation d'écritures de journal, configurez un compte de journal dans QuickBooks Online.",
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = "Pour utiliser l'exportation de chèques, configurez un compte bancaire dans QuickBooks Online.",
                _o),
            noAccountsFound: 'Aucun compte trouvé',
            ...
            accountingMethods: {
                ...
                values: (_p = {},
                    ...
                    _p[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Espèces',
                    _p),
                alternateText: (_q = {},
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Les dépenses hors de la poche seront exportées une fois approuvées définitivement.',
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = "Les dépenses personnelles seront exportées lorsqu'elles seront payées.",
                    _q),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_r = {},
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Xero contact par défaut',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = 'Tags',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = 'Champs de rapport',
                _r),
            ...
            invoiceStatus: {
                ...
                values: (_t = {},
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = 'Brouillon',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = "En attente d'approbation",
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = 'En attente de paiement',
                    _t),
            },
            noAccountsFound: 'Aucun compte trouvé',
            ...
            accountingMethods: {
                ...
                values: (_u = {},
                    ...
                    _u[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Espèces',
                    _u),
                alternateText: (_v = {},
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Les dépenses hors de la poche seront exportées une fois approuvées définitivement.',
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = "Les dépenses personnelles seront exportées lorsqu'elles seront payées.",
                    _v),
            },
        },
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_x = {},
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = 'Rapports de dépenses',
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Factures fournisseurs',
                    _x),
            },
            nonReimbursableExpenses: {
                description: "Définissez comment les achats par carte d'entreprise sont exportés vers Sage Intacct.",
                values: (_y = {},
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = 'Cartes de crédit',
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Factures fournisseurs',
                    _y),
            },
            creditCardAccount: 'Compte de carte de crédit',
        ...
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: (_1 = {},
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = 'Entrée unique et détaillée pour chaque rapport',
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = 'Une seule entrée pour chaque dépense',
                    _1),
            },
            invoiceItem: {
            ...
            exportDestination: {
                values: (_4 = {},
                    ...
                    _4),
                expenseReportDestinationConfirmDescription: 'Si vous changez le paramètre d’exportation des cartes d’entreprise vers les rapports de frais, les fournisseurs NetSuite et les comptes de publication pour les cartes individuelles seront désactivés.\n\nNe vous inquiétez pas, nous sauvegarderons toujours vos sélections précédentes au cas où vous voudriez revenir en arrière plus tard.',
            },
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_5 = {},
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'Préférence par défaut de NetSuite',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = 'Approuvé uniquement par le superviseur',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = 'Seulement la comptabilité approuvée',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = 'Superviseur et comptabilité approuvés',
                        _5),
                },
                accountingMethods: {
                    label: 'Quand exporter',
                    ...
                    values: (_6 = {},
                        ...
                        _6[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Espèces',
                        _6),
                    alternateText: (_7 = {},
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Les dépenses hors de la poche seront exportées une fois approuvées définitivement.',
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = "Les dépenses personnelles seront exportées lorsqu'elles seront payées.",
                        _7),
                },
                exportVendorBillsTo: {
                    ...
                    values: (_8 = {},
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'Préférence par défaut de NetSuite',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = "En attente d'approbation",
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = 'Approuvé pour publication',
                        _8),
                },
                exportJournalsTo: {
                    ...
                    values: (_9 = {},
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'Préférence par défaut de NetSuite',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = "En attente d'approbation",
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = 'Approuvé pour publication',
                        _9),
                },
                error: {
        ...
        intacct: {
            ...
            toggleImportTitle: function (_a) {
                ...
                return "Choisissez comment g\u00E9rer Sage Intacct <strong>".concat(mappingTitle, "</strong> dans Expensify.");
            },
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                learnMoreAboutOptions: "<muted-text>En savoir plus sur ces <a href=\"".concat(CONST_1.default.COMPANY_CARDS_CONNECT_CREDIT_CARDS_HELP_URL, "\">options</a>.</muted-text>"),
            ...
            statementCloseDate: (_11 = {},
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Dernier jour du mois',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Dernier jour ouvrable du mois',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Jour personnalisé du mois',
                _11),
            ...
            chooseCardFor: function (_a) {
                ...
                return "Choisissez une carte pour <strong>".concat(assignee, "</strong>. Vous ne trouvez pas la carte que vous cherchez ? <concierge-link>Faites-le nous savoir.</concierge-link>");
            },
            noActiveCards: 'Aucune carte active dans ce flux',
            somethingMightBeBroken: "<muted-text><centered-text>Ou quelque chose pourrait être cassé. Dans tous les cas, si vous avez des questions, n'hésitez pas à <concierge-link>contacter le Concierge</concierge-link>.</centered-text></muted-text>",
        ...
        expensifyCard: {
            ...
            settlementAccountInfo: function (_a) {
                ...
                return "Assurez-vous que ce compte correspond \u00E0 votre <a href=\"".concat(reconciliationAccountSettingsLink, "\">compte de r\u00E9conciliation</a> (").concat(accountNumber, ") afin que le r\u00E9conciliation continu fonctionne correctement.");
            },
            settlementFrequency: 'Fréquence de règlement',
            ...
            cardPending: function (_a) {
                var name = _a.name;
                return "La carte est en attente et sera \u00E9mise une fois que le compte de ".concat(name, " aura \u00E9t\u00E9 valid\u00E9.");
            },
            virtual: 'Virtuel',
            physical: 'Physique',
            ...
            issuedCardNoShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "a d\u00E9livr\u00E9 une Expensify Card \u00E0 ".concat(assignee, " ! La carte sera exp\u00E9di\u00E9e une fois que les d\u00E9tails d'exp\u00E9dition auront \u00E9t\u00E9 confirm\u00E9s.");
            },
            ...
            addedShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "".concat(assignee, " a ajout\u00E9 les informations d\u2019exp\u00E9dition. La carte Expensify arrivera dans 2 \u00E0 3 jours ouvr\u00E9s.");
            },
        ...
        categories: {
            ...
            emptyCategories: {
                ...
                subtitleWithAccounting: function (_a) {
                    ...
                    return "<muted-text><centered-text>Vos cat\u00E9gories sont actuellement import\u00E9es \u00E0 partir d'une connexion comptable. Allez dans la <a href=\"".concat(accountingPageURL, "\">comptabilit\u00E9</a> pour faire des changements.</centered-text></muted-text>");
                },
            },
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                integrationExportTitle: function (_a) {
                    ...
                    return "Choisissez le compte ".concat(integration, " vers lequel les transactions doivent \u00EAtre export\u00E9es. S\u00E9lectionnez une autre <a href=\"").concat(exportPageLink, "\">option d'exportation</a> pour modifier les comptes disponibles.");
                },
        ...
        reports: {
            ...
            customReportNamesSubtitle: "<muted-text>Personnalisez les titres des rapports \u00E0 l'aide de nos <a href=\"".concat(CONST_1.default.CUSTOM_REPORT_NAME_HELP_URL, "\">formules compl\u00E8tes</a>.</muted-text>"),
            customNameTitle: 'Titre de rapport par défaut',
            customNameDescription: "Choisissez un nom personnalis\u00E9 pour vos notes de frais \u00E0 l'aide de nos <a href=\"".concat(CONST_1.default.CUSTOM_REPORT_NAME_HELP_URL, "\">formules compl\u00E8tes</a>."),
        ...
        tags: {
            ...
            dependentMultiLevelTagsSubtitle: function (_a) {
                ...
                return "<muted-text>Vous utilisez des <a href=\"".concat(CONST_1.default.IMPORT_TAGS_EXPENSIFY_URL_DEPENDENT_TAGS, "\">balises d\u00E9pendantes</a>. Vous pouvez <a href=\"").concat(importSpreadsheetLink, "\">r\u00E9importer une feuille de calcul</a> pour mettre \u00E0 jour vos balises.</muted-text>");
            },
            emptyTags: {
                ...
                subtitleHTML: "<muted-text><centered-text>Importez une feuille de calcul pour ajouter des balises permettant de suivre les projets, les lieux, les services, etc. <a href=\"".concat(CONST_1.default.IMPORT_TAGS_EXPENSIFY_URL, "\">En savoir plus</a> sur le formatage des fichiers de balises.</centered-text></muted-text>"),
                subtitleWithAccounting: function (_a) {
                    var accountingPageURL = _a.accountingPageURL;
                    return "<muted-text><centered-text>Vos \u00E9tiquettes sont actuellement import\u00E9es \u00E0 partir d'une connexion comptable. Allez dans la <a href=\"".concat(accountingPageURL, "\">comptabilit\u00E9</a> pour faire des changements.</centered-text></muted-text>");
                },
            },
        ...
        duplicateWorkspace: {
            ...
            confirmTitle: function (_a) {
                ...
                return "Vous \u00EAtes sur le point de cr\u00E9er et de partager ".concat(newWorkspaceName !== null && newWorkspaceName !== void 0 ? newWorkspaceName : '', " avec ").concat(totalMembers !== null && totalMembers !== void 0 ? totalMembers : 0, " membres de l'espace de travail d'origine.");
            },
        ...
        people: {
            ...
            workspaceMembersCount: function (_a) {
                var count = _a.count;
                return "Nombre total de membres de l\u2019espace de travail : ".concat(count);
            },
            ...
            removeMemberPromptApprover: function (_a) {
                ...
                return "Si vous retirez ".concat(approver, " de cet espace de travail, nous remplacerons cette personne dans le workflow d'approbation par ").concat(workspaceOwner, ", le propri\u00E9taire de l'espace de travail.");
            },
            removeMemberPromptPendingApproval: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " a des rapports de d\u00E9penses en attente d\u2019approbation. Veuillez lui demander de les approuver, ou prenez le contr\u00F4le de ses rapports avant de retirer cette personne de l\u2019espace de travail.");
            },
            removeMemberPromptReimburser: function (_a) {
                var memberName = _a.memberName;
                return "Vous ne pouvez pas retirer ".concat(memberName, " de cet espace de travail. Veuillez d\u00E9finir un nouveau rembourseur dans Flux de travail > Effectuer ou suivre des paiements, puis r\u00E9essayez.");
            },
            removeMemberPromptExporter: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Si vous supprimez ".concat(memberName, " de cet espace de travail, nous le remplacerons en tant qu'exportateur pr\u00E9f\u00E9r\u00E9 par ").concat(workspaceOwner, ", le propri\u00E9taire de l'espace de travail.");
            },
            removeMemberPromptTechContact: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Si vous retirez ".concat(memberName, " de cet espace de travail, nous le/la remplacerons en tant que contact technique par ").concat(workspaceOwner, ", propri\u00E9taire de l\u2019espace de travail.");
            },
            cannotRemoveUserDueToReport: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " a un rapport en cours de traitement n\u00E9cessitant une intervention. Veuillez lui demander d\u2019effectuer l\u2019action requise avant de supprimer cette personne de l\u2019espace de travail.");
            },
        },
        card: {
            getStartedIssuing: 'Commencez en émettant votre première carte virtuelle ou physique.',
            ...
            issueNewCard: {
                ...
                name: 'Nom',
                disabledApprovalForSmartLimitError: 'Veuillez activer les approbations dans <strong>Workflows > Ajouter des approbations</strong> avant de configurer les limites intelligentes',
            },
            deactivateCardModal: {
        ...
        accounting: {
            ...
            errorODIntegration: function (_a) {
                ...
                return "Il y a une erreur avec une connexion qui a \u00E9t\u00E9 configur\u00E9e dans Expensify Classic. [Allez sur Expensify Classic pour r\u00E9soudre ce probl\u00E8me.](".concat(oldDotPolicyConnectionsURL, ")");
            },
            ...
            importTypes: (_12 = {},
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = 'Importé',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Importé en tant que tags',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Importé',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'Non importé',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'Non importé',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Importé en tant que champs de rapport',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'Employé par défaut de NetSuite',
                _12),
            ...
            enableContinuousReconciliation: function (_a) {
                ...
                return "<muted-text-label>Pour activer la r\u00E9conciliation continue, veuillez activer la <a href=\"".concat(accountingAdvancedSettingsLink, "\">synchronisation automatique</a> pour ").concat(connectionName, ".</muted-text-label>");
            },
            chooseReconciliationAccount: {
                ...
                settlementAccountReconciliation: function (_a) {
                    ...
                    return "Assurez-vous que ce compte correspond \u00E0 votre <a href=\"".concat(settlementAccountUrl, "\">Compte de r\u00E8glement de la carte Expensify</a> (terminant par ").concat(lastFourPAN, ") afin que la R\u00E9conciliation Continue fonctionne correctement.");
                },
            },
        },
        export: {
        ...
        bankAccount: {
            ...
            disconnectYourBankAccount: function (_a) {
                var bankName = _a.bankName;
                return "D\u00E9connectez votre <strong>".concat(bankName, "</strong> compte bancaire. Toutes les transactions en cours pour ce compte seront toujours effectu\u00E9es.");
            },
            ...
            yourWorkspace: "Votre espace de travail est configur\u00E9 avec une devise non prise en charge. Consultez la <a href=\"".concat(CONST_1.default.CONNECT_A_BUSINESS_BANK_ACCOUNT_HELP_URL, "\">liste des devises prises en charge</a>."),
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptText: "<muted-text-micro>Lisez et acceptez les <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">termes</a> et la <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">politique de confidentialit\u00E9</a> pour ajouter votre carte.</muted-text-micro>"),
            ...
            addPaymentCardLearnMore: "<muted-text>LEn savoir plus sur notre <a href=\"".concat(CONST_1.default.PERSONAL_DATA_PROTECTION_INFO_URL, "\">s\u00E9curit\u00E9</a>.</muted-text>"),
        ...
        upgrade: (_13 = {
                reportFields: {
                    ...
                    onlyAvailableOnPlan: function (_a) {
                        ...
                        return "<muted-text>Les champs de rapport ne sont disponibles que sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                    },
                }
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.NETSUITE] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Notre int\u00E9gration NetSuite est uniquement disponible avec le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.SAGE_INTACCT] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Notre int\u00E9gration Sage Intacct est uniquement disponible avec le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.QBD] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Notre int\u00E9gration QuickBooks Desktop est uniquement disponible avec le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les approbations avanc\u00E9es ne sont disponibles que sur le plan Control, qui commence \u00E0 <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.categories = {
                title: 'Catégories',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les cat\u00E9gories sont disponibles sur le plan Collect, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.glCodes = {
                title: 'Codes GL',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les codes GL sont uniquement disponibles sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.glAndPayrollCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les codes GL et de paie sont uniquement disponibles sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.taxCodes = {
                title: 'Codes fiscaux',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les codes fiscaux sont uniquement disponibles avec le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.companyCards = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Ceci est uniquement disponible sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.rules = {
                title: 'Règles',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les r\u00E8gles sont uniquement disponibles sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.perDiem = {
                title: 'Per diem',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les indemnit\u00E9s journali\u00E8res ne sont disponibles que sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.travel = {
                title: 'Voyage',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Le voyage est disponible sur le plan Collect, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.reports = {
                title: 'Rapports',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les rapports sont disponibles sur le plan Collect, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.multiLevelTags = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les balises multi-niveaux sont uniquement disponibles sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.distanceRates = {
                title: 'Tarifs de distance',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les tarifs de distance sont disponibles sur le plan Collect, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.auditor = {
                title: 'Auditeur',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les auditeurs sont disponibles uniquement avec le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id] = {
                title: "Niveaux d'approbation multiples",
                description: "Les niveaux d'approbation multiples sont un outil de flux de travail pour les entreprises qui exigent que plus d'une personne approuve un rapport avant qu'il ne puisse être remboursé.",
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Les niveaux d'approbation multiples sont uniquement disponibles sur le plan Control, \u00E0 partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", "</muted-text>");
                },
            },
            _13.pricing = {
            ...
            _13.note = function (_a) {
                ...
                return "<muted-text>Mettez \u00E0 niveau pour acc\u00E9der \u00E0 cette fonctionnalit\u00E9, ou <a href=\"".concat(subscriptionLink, "\">en savoir plus sur</a> nos offres et tarifs.</muted-text>");
            },
            _13.upgradeToUnlock = 'Débloquez cette fonctionnalité',
            _13.completed = {
                ...
                successMessage: function (_a) {
                    ...
                    return "<centered-text>Vous avez r\u00E9ussi \u00E0 passer de ".concat(policyName, " au forfait Control ! <a href=\"").concat(subscriptionLink, "\">Consultez votre abonnement</a> pour plus de d\u00E9tails.</centered-text>");
                },
            ...
            _13.commonFeatures = {
                ...
                benefits: {
                    startsAtFull: function (_a) {
                        ...
                        return "<muted-text>Le plan Control commence \u00E0 <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "par membre par mois." : "par membre actif par mois.", " <a href=\"").concat(learnMoreMethodsRoute, "\">En savoir plus</a> \u00E0 propos de nos plans et tarifs.</muted-text>");
                    },
        ...
        payAndDowngrade: {
            ...
            description1: function (_a) {
                var formattedAmount = _a.formattedAmount;
                return "Votre facture finale pour cet abonnement sera de <strong>".concat(formattedAmount, "</strong>");
            },
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: function (_a) {
                    ...
                    return "<muted-text>D\u00E9finissez des contr\u00F4les de d\u00E9penses et des valeurs par d\u00E9faut pour chaque d\u00E9pense. Vous pouvez \u00E9galement cr\u00E9er des r\u00E8gles pour les <a href=\"".concat(categoriesPageLink, "\">cat\u00E9gories</a> et <a href=\"").concat(tagsPageLink, "\">tags</a>.</muted-text>");
                },
                ...
                billableDefaultDescription: function (_a) {
                    ...
                    return "<muted-text>Choisissez si les d\u00E9penses en esp\u00E8ces et par carte de cr\u00E9dit doivent \u00EAtre facturables par d\u00E9faut. Les d\u00E9penses facturables sont activ\u00E9es ou d\u00E9sactiv\u00E9es dans les <a href=\"".concat(tagsPageLink, "\">tags</a>.</muted-text>");
                },
                billable: 'Facturable',
                ...
                eReceipts: 'eReceipts',
                eReceiptsHint: "Les re\u00E7us \u00E9lectroniques sont cr\u00E9\u00E9s automatiquement [pour la plupart des transactions de cr\u00E9dit en USD](".concat(CONST_1.default.DEEP_DIVE_ERECEIPTS, ")."),
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "Acc\u00E9dez \u00E0 [plus de fonctionnalit\u00E9s](".concat(moreFeaturesLink, ") et activez les workflows, puis ajoutez ").concat(featureName, " pour d\u00E9bloquer cette fonctionnalit\u00E9.");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName, moreFeaturesLink = _a.moreFeaturesLink;
                    return "Acc\u00E9dez \u00E0 [plus de fonctionnalit\u00E9s](".concat(moreFeaturesLink, ") et activez ").concat(featureName, " pour d\u00E9bloquer cette fonctionnalit\u00E9.");
                },
            },
            categoryRules: {
                ...
                enableWorkflows: function (_a) {
                    ...
                    return "Acc\u00E9dez \u00E0 [Plus de fonctionnalit\u00E9s](".concat(moreFeaturesLink, ") et activez les workflows, puis ajoutez des approbations pour d\u00E9bloquer cette fonctionnalit\u00E9.");
                },
            },
            customRules: {
    ...
    workspaceActions: {
        ...
        updateDefaultReimbursable: function (_a) {
            var oldValue = _a.oldValue, newValue = _a.newValue;
            return "mis \u00E0 jour \"D\u00E9pense en esp\u00E8ces par d\u00E9faut\" en \"".concat(newValue, "\" (anciennement \"").concat(oldValue, "\")");
        },
    ...
    roomMembersPage: {
        ...
        roomArchived: "Il semblerait que cette salle ait \u00E9t\u00E9 archiv\u00E9e. Si vous avez des questions, contactez ".concat(CONST_1.default.EMAIL.CONCIERGE, "."),
        removeMembersPrompt: function (_a) {
            var memberName = _a.memberName;
            return ({
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_14 = {},
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = 'Jamais',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'Le mois dernier',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.THIS_MONTH] = 'Ce mois-ci',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_STATEMENT] = 'Dernière relevé',
                    _14),
            },
            status: 'Statut',
            keyword: 'Mot-clé',
            ...
            amount: {
                ...
                equalTo: function (_a) {
                    var _b = _a === void 0 ? {} : _a, amount = _b.amount;
                    return "\u00C9gal \u00E0 ".concat(amount !== null && amount !== void 0 ? amount : '');
                },
            },
            card: {
                expensify: 'Expensify',
            ...
            groupBy: (_15 = {},
                _15[CONST_1.default.SEARCH.GROUP_BY.FROM] = 'De',
                _15[CONST_1.default.SEARCH.GROUP_BY.CARD] = 'Carte',
                _15[CONST_1.default.SEARCH.GROUP_BY.WITHDRAWAL_ID] = 'ID de retrait',
                _15),
            feed: 'Flux',
            withdrawalType: (_16 = {},
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.EXPENSIFY_CARD] = 'Expensify Card',
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.REIMBURSEMENT] = 'Remboursement',
                _16),
            is: 'Est',
            action: (_17 = {},
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.SUBMIT] = 'Soumettre',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.APPROVE] = 'Approuver',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.PAY] = 'Payer',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.EXPORT] = 'Exporter',
                _17),
            reportField: function (_a) {
                var name = _a.name, value = _a.value;
                return "".concat(name, " est ").concat(value);
            },
        },
        has: 'A',
        groupBy: 'Groupe par',
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationPrompt: function (_a) {
                var workspaceName = _a.workspaceName;
                return "\u00CAtes-vous s\u00FBr de vouloir cr\u00E9er un autre rapport dans ".concat(workspaceName, " ? Vous pouvez acc\u00E9der \u00E0 vos rapports vides dans");
            },
        ...
        actions: {
            type: {
                changeField: function (_a) {
                    ...
                    return "a modifi\u00E9 ".concat(fieldName, " en \"").concat(newValue, "\" (auparavant \"").concat(oldValue, "\")");
                },
                changeFieldEmpty: function (_a) {
                    var newValue = _a.newValue, fieldName = _a.fieldName;
                    return "a d\u00E9fini ".concat(fieldName, " sur \"").concat(newValue, "\"");
                },
                changeReportPolicy: function (_a) {
                    var fromPolicyName = _a.fromPolicyName, toPolicyName = _a.toPolicyName;
                    if (!toPolicyName) {
                        return "Espace de travail modifi\u00E9".concat(fromPolicyName ? " (auparavant ".concat(fromPolicyName, ")") : '');
                    }
                    return "Espace de travail modifi\u00E9 en ".concat(toPolicyName).concat(fromPolicyName ? " (auparavant ".concat(fromPolicyName, ")") : '');
                },
                ...
                exportedToIntegration: {
                    automatic: function (_a) {
                        ...
                        return "export\u00E9 vers ".concat(translatedLabel);
                    },
    ...
    referralProgram: (_18 = {},
        ...
        _18.copyReferralLink = "Copier le lien d'invitation",
        _18),
    systemChatFooterMessage: (_19 = {},
        _19[CONST_1.default.INTRO_CHOICES.MANAGE_TEAM] = function (_a) {
            ...
            return "Discutez avec votre sp\u00E9cialiste de configuration en <a href=\"".concat(href, "\">").concat(adminReportName, "</a> pour obtenir de l'aide");
        },
        _19.default = "Message <concierge-link>".concat(CONST_1.default.CONCIERGE_CHAT_NAME, "</concierge-link> pour obtenir de l'aide avec la configuration"),
        _19),
    violations: {
        ...
        overTripLimit: function (_a) {
            var formattedLimit = _a.formattedLimit;
            return "Montant sup\u00E9rieur \u00E0 la limite de ".concat(formattedLimit, "/voyage");
        },
        ...
        rter: function (_a) {
            ...
            if (brokenBankConnection || rterType === CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? "Connexion bancaire interrompue. <a href=\"".concat(companyCardPageURL, "\">Reconnecter pour associer le re\u00E7u</a>")
        ...
        adminBrokenConnectionError: function (_a) {
            ...
            return "<muted-text-label>Re\u00E7u en attente en raison d'une connexion bancaire rompue. Veuillez r\u00E9soudre ce probl\u00E8me dans <a href=\"".concat(workspaceCompanyCardRoute, "\">Cartes d'entreprise</a>.</muted-text-label>");
        },
    ...
    exitSurvey: {
        ...
        reasons: (_21 = {},
            _21[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = "J'ai besoin d'une fonctionnalité qui n'est disponible que dans Expensify Classic.",
            _21[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Je ne comprends pas comment utiliser New Expensify.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Je comprends comment utiliser New Expensify, mais je préfère Expensify Classic.',
            _21),
        prompts: (_22 = {},
            _22[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Quelle fonctionnalité vous manque-t-il dans le nouveau Expensify ?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Que cherchez-vous à faire ?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Pourquoi préférez-vous Expensify Classic ?',
            _22),
        ...
        benefits: (_23 = {},
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Discussion directe sur les dépenses et les rapports',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Possibilité de tout faire sur mobile',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Voyage et dépenses à la vitesse du chat',
            _23),
    ...
    subscription: {
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "Veuillez terminer le processus d'authentification pour activer votre carte se terminant par ".concat(cardEnding, ".");
                },
            },
            insufficientFunds: {
                title: "Votre carte n'a pas pu être débitée",
        ...
        compareModal: {
            ...
            subtitle: "<muted-text>D\u00E9bloquez les fonctionnalit\u00E9s dont vous avez besoin avec le forfait qui vous convient. <a href=\"".concat(CONST_1.default.PRICING, "\">Consultez notre page de tarifs</a> ou la liste compl\u00E8te des fonctionnalit\u00E9s de chacun de nos forfaits.</muted-text>"),
        },
        details: {
        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                preventFutureActivity: function (_a) {
                    ...
                    return "Si vous souhaitez \u00E9viter toute activit\u00E9 et frais futurs, vous devez <a href=\"".concat(workspacesListRoute, "\">supprimer votre/vos espace(s) de travail</a>. Notez que lorsque vous supprimez votre(vos) espace(s) de travail, vous serez factur\u00E9 pour toute activit\u00E9 en cours qui a \u00E9t\u00E9 engag\u00E9e au cours du mois civil en cours.");
                },
            },
            requestSubmitted: {
                title: 'Demande soumise',
                subtitle: 'Merci de nous avoir fait part de votre souhait de résilier votre abonnement. Nous examinons actuellement votre demande et vous contacterons prochainement via votre chat avec <concierge-link>Concierge</concierge-link>.',
            },
    ...
    delegate: {
        ...
        notAllowedMessage: function (_a) {
            ...
            return "En tant que <a href=\"".concat(CONST_1.default.DELEGATE_ROLE_HELP_DOT_ARTICLE_LINK, "\">copilote</a> de ").concat(accountOwnerEmail, ", vous n'avez pas la permission d'entreprendre cette action. D\u00E9sol\u00E9 de ne pas pouvoir effectuer cette action.");
        },
    ...
    scheduledCall: {
        book: {
            ...
            slots: function (_a) {
                var date = _a.date;
                return "<muted-text>Heures disponibles pour <strong>".concat(date, "</strong></muted-text>");
            },
        },
        confirmation: {
    ...
    nextStep: {
        message: (_24 = {},
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_ADD_TRANSACTIONS] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attendant que <strong>".concat(actor, "</strong> ajoute des d\u00E9penses.");
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION] = function (_) { return "Aucune autre action requise !"; },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_SUBMITTER_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attente que <strong>".concat(actor, "</strong> ajoute un compte bancaire.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_AUTOMATIC_SUBMIT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "le ".concat(eta) : " ".concat(eta);
                }
                // eslint-disable-next-line default-case
                switch (actorType) {
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return "En attente que <strong>vos</strong> d\u00E9penses soient automatiquement soumises".concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attente que les d\u00E9penses de <strong>".concat(actor, "</strong> soient automatiquement soumises").concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return "En attente de l\u2019envoi automatique des d\u00E9penses d\u2019un administrateur".concat(formattedETA, ".");
                }
            },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_FIX_ISSUES] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attendant que <strong>".concat(actor, "</strong> corrige le(s) probl\u00E8me(s).");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attente de l\u2019approbation des d\u00E9penses par <strong>".concat(actor, "</strong>.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attente que <strong>".concat(actor, "</strong> paie les d\u00E9penses.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_POLICY_BANK_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "En attendant que <strong>".concat(actor, "</strong> termine la configuration d'un compte bancaire professionnel.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_PAYMENT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "avant ".concat(eta) : " ".concat(eta);
                }
                return "En attente de finalisation du paiement".concat(formattedETA, ".");
            },
            _24),
        eta: (_25 = {},
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SHORTLY] = 'bientôt',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.TODAY] = "plus tard aujourd'hui",
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_WEEK] = 'dimanche',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SEMI_MONTHLY] = 'les 1er et 16 de chaque mois',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_BUSINESS_DAY_OF_MONTH] = 'le dernier jour ouvrable du mois',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_DAY_OF_MONTH] = 'le dernier jour du mois',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_TRIP] = 'à la fin de votre voyage',
            _25),
    },
    domain: {
        ...
        verifyDomain: {
            ...
            beforeProceeding: function (_a) {
                ...
                return "Avant de poursuivre, v\u00E9rifiez que vous \u00EAtes propri\u00E9taire de <strong>".concat(domainName, "</strong> en mettant \u00E0 jour ses param\u00E8tres DNS.");
            },
            accessYourDNS: function (_a) {
                var domainName = _a.domainName;
                return "Acc\u00E9dez \u00E0 votre fournisseur DNS et ouvrez les param\u00E8tres DNS pour <strong>".concat(domainName, "</strong>.");
            },
            ...
            youMayNeedToConsult: "Il se peut que vous deviez consulter le service informatique de votre organisation pour terminer la v\u00E9rification. <a href=\"".concat(CONST_1.default.DOMAIN_VERIFICATION_HELP_URL, "\">En savoir plus</a>."),
        ...
        domainVerified: {
            ...
            description: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><centered-text>Le domaine <strong>".concat(domainName, "</strong> a \u00E9t\u00E9 v\u00E9rifi\u00E9 avec succ\u00E8s et vous pouvez maintenant configurer SAML et d'autres fonctionnalit\u00E9s de s\u00E9curit\u00E9.</centered-text></muted-text>");
            },
        },
        saml: 'SAML',
        samlFeatureList: {
