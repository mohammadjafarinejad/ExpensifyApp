...
var translations = {
    common: {
        ...
        view: 'Visualizza',
        review: function (reviewParams) { return "Rivisore".concat((reviewParams === null || reviewParams === void 0 ? void 0 : reviewParams.amount) ? " ".concat(reviewParams === null || reviewParams === void 0 ? void 0 : reviewParams.amount) : ''); },
        not: 'Non',
        signIn: 'Accedi',
        ...
        acceptTermsAndPrivacy: "Accetto il <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termini di servizio di Expensify</a> e <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Informativa sulla privacy</a>"),
        acceptTermsAndConditions: "Accetto il <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.ACH_TERMS_URL, "\">termini e condizioni</a>"),
        acceptTermsOfService: "Accetto il <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termini di servizio di Expensify</a>"),
        remove: 'Rimuovi',
        admin: 'Admin',
        owner: 'Proprietario',
        ...
        noResultsFoundMatching: function (searchString) { return "Nessun risultato trovato corrispondente a \"".concat(searchString, "\""); },
        ...
        leaveWorkspaceConfirmationApprover: function (_a) {
            ...
            return "Se lasci questo spazio di lavoro, verrai sostituito nel flusso di approvazione da ".concat(workspaceOwner, ", il proprietario dello spazio di lavoro.");
        },
        leaveWorkspaceConfirmationExporter: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Se lasci questo spazio di lavoro, verrai sostituito come esportatore preferito da ".concat(workspaceOwner, ", il proprietario dello spazio di lavoro.");
        },
        leaveWorkspaceConfirmationTechContact: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Se lasci questo spazio di lavoro, verrai sostituito come contatto tecnico da ".concat(workspaceOwner, ", il proprietario dello spazio di lavoro.");
        },
        leaveWorkspaceReimburser: 'Non puoi lasciare questo spazio di lavoro poiché sei il rimborsatore. Imposta un nuovo rimborsatore in Spazi di lavoro > Effettua o traccia i pagamenti, quindi riprova.',
    ...
    supportalNoAccess: {
        ...
        descriptionWithCommand: function (_a) {
            ...
            return "Non sei autorizzato a eseguire questa azione quando il supporto \u00E8 connesso (comando: ".concat(command !== null && command !== void 0 ? command : '', "). Se ritieni che Success debba essere in grado di eseguire questa azione, avvia una conversazione su Slack.");
        },
    },
    lockedAccount: {
    ...
    reportActionContextMenu: {
        ...
        deleteConfirmation: function (_a) {
            ...
            return "Sei sicuro di voler eliminare questo ".concat(type, "?");
        },
    ...
    reportActionsView: {
        beginningOfArchivedRoom: function (_a) {
            ...
            return "Ti sei perso la festa in <strong><a class=\"no-style-link\" href=\"".concat(reportDetailsLink, "\">").concat(reportName, "</a></strong>, non c'\u00E8 niente da vedere qui.");
        },
        beginningOfChatHistoryDomainRoom: function (_a) {
            var domainRoom = _a.domainRoom;
            return "Questa chat \u00E8 dedicata a tutti i membri di Expensify sul dominio <strong>".concat(domainRoom, "</strong>. Utilizzatela per chattare con i colleghi, condividere suggerimenti e porre domande.");
        },
        beginningOfChatHistoryAdminRoom: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Questa chat \u00E8 dedicata agli amministratori <strong>".concat(workspaceName, "</strong>. Utilizzatela per chattare sulla configurazione dello spazio di lavoro e altro ancora.");
        },
        beginningOfChatHistoryAnnounceRoom: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Questa chat \u00E8 dedicata a tutti i membri della <strong>".concat(workspaceName, "</strong>. Usatela per gli annunci pi\u00F9 importanti.");
        },
        beginningOfChatHistoryUserRoom: function (_a) {
            var reportName = _a.reportName, reportDetailsLink = _a.reportDetailsLink;
            return "Questa chat \u00E8 per tutto ci\u00F2 che riguarda <strong><a class=\"no-style-link\" href=\"".concat(reportDetailsLink, "\">").concat(reportName, "</a></strong>.");
        },
        beginningOfChatHistoryInvoiceRoom: function (_a) {
            var invoicePayer = _a.invoicePayer, invoiceReceiver = _a.invoiceReceiver;
            return "Questa chat \u00E8 per le fatture tra <strong>".concat(invoicePayer, "</strong> e <strong>").concat(invoiceReceiver, "</strong>. Utilizzare il pulsante + per inviare una fattura.");
        },
        ...
        beginningOfChatHistoryPolicyExpenseChat: function (_a) {
            ...
            return "\u00C8 qui che <strong>".concat(submitterDisplayName, "</strong> presenter\u00E0 le spese a <strong>").concat(workspaceName, "</strong>. Basta usare il pulsante +.");
        },
    ...
    spreadsheet: {
        ...
        dragAndDropMultiLevelTag: "<muted-link>Trascina e rilascia il tuo foglio di calcolo qui, oppure scegli un file qui sotto. <a href=\"".concat(CONST_1.default.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK, "\">Scopri di pi\u00F9</a> sui formati di file supportati.</muted-link>"),
        ...
        chooseSpreadsheetMultiLevelTag: "<muted-link>Seleziona un file di foglio di calcolo da importare. <a href=\"".concat(CONST_1.default.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK, "\">Scopri di pi\u00F9</a> sui formati di file supportati.</muted-link>"),
        ...
        importMemberConfirmation: function () { return ({
            ...
            other: function (count) {
                return "Conferma i dettagli di seguito per i ".concat(count, " nuovi membri del workspace che verranno aggiunti come parte di questo caricamento. I membri esistenti non riceveranno aggiornamenti di ruolo n\u00E9 messaggi di invito.");
            },
        }); },
    },
    receipt: {
        ...
        alternativeMethodsDownloadApp: function (_a) {
            ...
            return "<label-text><a href=\"".concat(downloadUrl, "\">Scarica l\u2019app</a> per scansionare dal telefono</label-text>");
        },
        alternativeMethodsForwardReceipts: function (_a) {
            var email = _a.email;
            return "<label-text>Inoltra le ricevute a <a href=\"mailto:".concat(email, "\">").concat(email, "</a></label-text>");
        },
        alternativeMethodsAddPhoneNumber: function (_a) {
            var phoneNumber = _a.phoneNumber, contactMethodsUrl = _a.contactMethodsUrl;
            return "<label-text><a href=\"".concat(contactMethodsUrl, "\">Aggiungi il tuo numero</a> per inviare ricevute via SMS a ").concat(phoneNumber, "</label-text>");
        },
        alternativeMethodsTextReceipts: function (_a) {
            var phoneNumber = _a.phoneNumber;
            return "<label-text>Invia ricevute via SMS a ".concat(phoneNumber, " (solo numeri USA)</label-text>");
        },
        takePhoto: 'Scatta una foto',
        cameraAccess: "L'accesso alla fotocamera è necessario per scattare foto delle ricevute.",
        deniedCameraAccess: "L'accesso alla fotocamera non \u00E8 ancora stato concesso, si prega di seguire <a href=\"".concat(CONST_1.default.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL, "\">queste istruzioni</a>."),
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "ha eliminato una spesa (".concat(amount, " per ").concat(merchant, ")");
        },
        ...
        unreportedTransaction: function (_a) {
            ...
            return "spostato questa spesa nel tuo <a href=\"".concat(reportUrl, "\">spazio personale</a>");
        },
        movedAction: function (_a) {
            ...
            if (shouldHideMovedReportUrl) {
                return "ha spostato questo rapporto nello spazio di lavoro <a href=\"".concat(newParentReportUrl, "\">").concat(toPolicyName, "</a>");
            }
            return "ha spostato questo <a href=\"".concat(movedReportUrl, "\">rapporto</a> nello spazio di lavoro <a href=\"").concat(newParentReportUrl, "\">").concat(toPolicyName, "</a>");
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Paga ".concat(formattedAmount, " come individuo") : "Paga con conto personale");
        },
        settleWallet: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Paga ".concat(formattedAmount, " con portafoglio") : "Paga con portafoglio");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Paga ".concat(formattedAmount, " come azienda") : "Paga con conto aziendale");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Segna ".concat(formattedAmount, " come pagato") : "Segna come pagato");
        },
        settleInvoicePersonal: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return (amount ? "Pagato ".concat(amount, " con conto personale ").concat(last4Digits) : "Pagato con conto personale");
        },
        settleInvoiceBusiness: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return (amount ? "Pagato ".concat(amount, " con conto aziendale ").concat(last4Digits) : "Pagato con conto aziendale");
        },
        payWithPolicy: function (_a) {
            var formattedAmount = _a.formattedAmount, policyName = _a.policyName;
            return (formattedAmount ? "Paga ".concat(formattedAmount, " tramite ").concat(policyName) : "Paga tramite ".concat(policyName));
        },
        businessBankAccount: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return amount ? "pagato ".concat(amount, " con conto bancario ").concat(last4Digits) : "pagato con conto bancario ".concat(last4Digits);
        },
        automaticallyPaidWithBusinessBankAccount: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return "pagato ".concat(amount ? "".concat(amount, " ") : '', "con il conto bancario terminante con ").concat(last4Digits, " tramite le <a href=\"").concat(CONST_1.default.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL, "\">regole dello spazio di lavoro</a>");
        },
        invoicePersonalBank: function (_a) {
            var lastFour = _a.lastFour;
            return "Conto personale \u2022 ".concat(lastFour);
        },
        invoiceBusinessBank: function (_a) {
            var lastFour = _a.lastFour;
            return "Conto aziendale \u2022 ".concat(lastFour);
        },
        ...
        submitted: function (_a) {
            var memo = _a.memo;
            return "inviato".concat(memo ? ", dicendo: ".concat(memo) : '');
        },
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "ha avviato il pagamento, ma \u00E8 in attesa che ".concat(submitterDisplayName, " aggiunga un conto bancario.");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', "segnato come pagato");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "pagato con portafoglio");
        },
        ...
        error: {
            ...
            receiptFailureMessage: '<rbr>Si è verificato un errore durante il caricamento della tua ricevuta. Per favore <a href="download">salva la ricevuta</a> e <a href="retry">riprova</a> più tardi.</rbr>',
        ...
        changeApprover: {
            ...
            description: function (_a) {
                ...
                return "Puoi anche cambiare l'approvatore in modo permanente per tutti i report nelle tue <a href=\"".concat(workflowSettingLink, "\">impostazioni del flusso di lavoro</a>.");
            },
            changedApproverMessage: function (_a) {
                var managerID = _a.managerID;
                return "ha cambiato l'approvatore in <mention-user accountID=\"".concat(managerID, "\"/>");
            },
            actions: {
    ...
    transactionMerge: {
        listPage: {
            ...
            noEligibleExpenseFoundSubtitle: "<muted-text><centered-text>Non hai spese che possono essere unite a questa. <a href=\"".concat(CONST_1.default.HELP_DOC_LINKS.MERGE_EXPENSES, "\">Scopri di pi\u00F9</a> sulle spese idonee.</centered-text></muted-text>"),
            selectTransactionToMerge: function (_a) {
                var reportName = _a.reportName;
                return "Seleziona una <a href=\"".concat(CONST_1.default.HELP_DOC_LINKS.MERGE_EXPENSES, "\">spesa idonea</a> da unire <strong>").concat(reportName, "</strong>.");
            },
        },
        receiptPage: {
        ...
        detailsPage: {
            ...
            pleaseSelectError: function (_a) {
                var field = _a.field;
                return "Seleziona un/a ".concat(field);
            },
    ...
    contacts: {
        ...
        helpText: function (_a) {
            var email = _a.email;
            return "Aggiungi pi\u00F9 modi per inviare le ricevute. Inoltrale a <copy-text text=\"".concat(email, "\"/> o inviarli al 47777 (solo numeri USA).");
        },
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            description: '<muted-text>Utilizzate gli strumenti qui sotto per risolvere i problemi di Expensify. Se riscontrate problemi, <concierge-link>inviate un bug</concierge-link>.</muted-text>',
        ...
        versionLetter: 'v',
        readTheTermsAndPrivacy: "<muted-text-micro>Leggete i <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termini di servizioe</a> e la <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacy</a>.</muted-text-micro>"),
        help: 'Aiuto',
        whatIsNew: 'Novità',
    ...
    mergeAccountsPage: {
        ...
        accountDetails: {
            accountToMergeInto: function (_a) {
                var login = _a.login;
                return "Inserire l'account che si desidera unire in <strong>".concat(login, "</strong>.");
            },
        ...
        accountValidate: {
            ...
            lossOfUnsubmittedData: function (_a) {
                var login = _a.login;
                return "La fusione dei conti \u00E8 irreversibile e comporta la perdita di tutte le spese non inviate per <strong>".concat(login, "</strong>.");
            },
            enterMagicCode: function (_a) {
                var login = _a.login;
                return "Per continuare, inserire il codice magico inviato a <strong>".concat(login, "</strong>.");
            },
            errors: {
        ...
        mergeSuccess: {
            ...
            description: function (_a) {
                ...
                return "<muted-text><centered-text>Tutti i dati di <strong>".concat(from, "</strong> sono stati uniti a <strong>").concat(to, "</strong>. In futuro, \u00E8 possibile utilizzare entrambi i login per questo account.</centered-text></muted-text>");
            },
        },
        mergePendingSAML: {
        ...
        mergeFailureSAMLDomainControlDescription: function (_a) {
            var _b;
            var email = _a.email;
            return "<muted-text><centered-text>Non \u00E8 possibile unire <strong>".concat(email, "</strong> perch\u00E9 \u00E8 controllato da <strong>").concat((_b = email.split('@').at(1)) !== null && _b !== void 0 ? _b : '', "</strong>. Si prega di <concierge-link>contattare Concierge</concierge-link> per assistenza.</centered-text></muted-text>");
        },
        mergeFailureSAMLAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Non \u00E8 possibile unire <strong>".concat(email, "</strong> ad altri account perch\u00E9 l'amministratore del dominio lo ha impostato come login principale. Si prega di unire altri account al suo posto.</centered-text></muted-text>");
        },
        mergeFailure2FA: {
            description: function (_a) {
                var email = _a.email;
                return "<muted-text><centered-text>Non \u00E8 possibile unire gli account perch\u00E9 <strong>".concat(email, "</strong> ha attivato l'autenticazione a due fattori (2FA). Disattivare la 2FA per <strong>").concat(email, "</strong> e riprovare.</centered-text></muted-text>");
            },
            learnMore: 'Scopri di più sulla fusione degli account.',
        },
        mergeFailureAccountLockedDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Non \u00E8 possibile unire <strong>".concat(email, "</strong> perch\u00E9 \u00E8 bloccato. Si prega di <concierge-link>contattare Concierge</concierge-link> per assistenza.</centered-text></muted-text>");
        },
        mergeFailureUncreatedAccountDescription: function (_a) {
            var email = _a.email, contactMethodLink = _a.contactMethodLink;
            return "<muted-text><centered-text>Non \u00E8 possibile unire gli account perch\u00E9 <strong>".concat(email, "</strong> non ha un account Expensify. Si prega di <a href=\"").concat(contactMethodLink, "\">aggiungerlo come metodo di contatto</a>.</centered-text></muted-text>");
        },
        mergeFailureSmartScannerAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Non \u00E8 possibile unire <strong>".concat(email, "</strong> ad altri conti. Si prega invece di unire altri account.</centered-text></muted-text>");
        },
        mergeFailureInvoicedAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>Non \u00E8 possibile unire i conti in <strong>".concat(email, "</strong> perch\u00E9 questo conto possiede una relazione di fatturazione.</centered-text></muted-text>");
        },
    ...
    billingCurrency: {
        ...
        note: "Nota: la modifica della valuta di pagamento pu\u00F2 influire sul costo di Expensify. Per maggiori dettagli, consultare la <a href=\"".concat(CONST_1.default.PRICING, "\">pagina dei prezzi</a>."),
    },
    addDebitCardPage: {
    ...
    cardPage: {
        ...
        missingPrivateDetails: function (_a) {
            ...
            return "Per favore <a href=\"".concat(missingDetailsLink, "\">aggiungi i tuoi dati personali</a>, poi riprova.");
        },
        ...
        cardFraudAlert: {
            ...
            clearedMessage: function (_a) {
                ...
                return "abbiamo eliminato l'attivit\u00E0 sospetta e riattivato la carta x".concat(cardLastFour, ". Tutto pronto per continuare a registrare le spese!");
            },
            deactivatedMessage: function (_a) {
                var cardLastFour = _a.cardLastFour;
                return "disattivato la carta che termina con ".concat(cardLastFour);
            },
            alertMessage: function (_a) {
                var cardLastFour = _a.cardLastFour, amount = _a.amount, merchant = _a.merchant, date = _a.date;
                return "attivit\u00E0 sospetta identificata sulla carta che termina con ".concat(cardLastFour, ". Riconosci questo addebito?\n\n").concat(amount, " per ").concat(merchant, " - ").concat(date);
            },
        },
    },
    workflowsPage: {
    ...
    paymentMethodList: {
        ...
        bankAccountLastFour: function (_a) {
            var lastFour = _a.lastFour;
            return "Conto bancario \u2022 ".concat(lastFour);
        },
    },
    preferencesPage: {
        appSection: {
    ...
    termsOfUse: {
        terms: "<muted-text-xs>Effettuando l'accesso, l'utente accetta i <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termini di servizio</a> e la <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacy</a>.</muted-text-xs>"),
        license: "<muted-text-xs>La trasmissione di denaro \u00E8 fornita da ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " (NMLS ID:2017010) in base alle sue <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.LICENSES_URL, "\">licenze</a>.</muted-text-xs>"),
    },
    validateCodeForm: {
        ...
        requestNewCode: function (_a) {
            ...
            return "Richiedi un nuovo codice in <a>".concat(timeRemaining, "</a>");
        },
        ...
        tasks: {
            ...
            addExpenseApprovalsTask: {
                ...
                description: function (_a) {
                    ...
                    return "*Aggiungi approvazioni spese* per controllare le spese del tuo team e mantenerle sotto controllo.\n" +
                        '\n' +
                        "Ecco come fare:\n" +
                        '\n' +
            ...
            addAccountingIntegrationTask: {
                ...
                description: function (_a) {
                    ...
                    return "Connetti".concat(integrationName === CONST_1.default.ONBOARDING_ACCOUNTING_MAPPING.other ? ' il tuo' : ' a', " ").concat(integrationName, " per una codifica automatica delle spese e sincronizzazione che semplifica la chiusura di fine mese.\n") +
                        ...
                        '1. Clicca su *Spazi di lavoro*.\n' +
                        '2. Seleziona il tuo spazio di lavoro.\n' +
                        '3. Clicca su *Contabilità*.\n' +
                        "4. Trova ".concat(integrationName, ".\n") +
            ...
            setupCategoriesAndTags: {
                title: function (_a) {
                    ...
                    return "Configura [categorie](".concat(workspaceCategoriesLink, ") e [tag](").concat(workspaceTagsLink, ")");
                },
                description: function (_a) {
            ...
            setupTagsTask: {
                title: function (_a) {
                    ...
                    return "Configura i [tag](".concat(workspaceTagsLink, ")");
                },
                description: function (_a) {
                    var workspaceMoreFeaturesLink = _a.workspaceMoreFeaturesLink;
            ...
            reviewWorkspaceSettingsTask: {
                ...
                description: function (_a) {
                    ...
                    return 'Ecco come rivedere e aggiornare le impostazioni dello spazio di lavoro:\n' +
                        ...
                        "[Vai al tuo spazio di lavoro.](".concat(workspaceSettingsLink, ")");
                },
            },
            createReportTask: {
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: function (_a) {
            var login = _a.login;
            return "<strong>Conferma che ".concat(login, " sia scritto correttamente e sia un indirizzo email reale e consegnabile.</strong> Gli alias email come \"expenses@domain.com\" devono avere accesso alla propria casella di posta elettronica per essere un login valido di Expensify.");
        },
        ensureYourEmailClient: "<strong>Assicurati che il tuo client di posta elettronica consenta le email da expensify.com.</strong> Potete trovare indicazioni su come completare questo passaggio <a href=\"".concat(CONST_1.default.SET_NOTIFICATION_LINK, "\">qui</a>, ma potreste aver bisogno dell'aiuto del vostro reparto IT per configurare le vostre impostazioni e-mail."),
        onceTheAbove: "Una volta completati i passaggi sopra descritti, contattare <a href=\"mailto:".concat(CONST_1.default.EMAIL.CONCIERGE, "\">").concat(CONST_1.default.EMAIL.CONCIERGE, "</a> per sbloccare l'accesso."),
    },
    ...
    focusModeUpdateModal: {
        ...
        prompt: function (_a) {
            ...
            return "Rimani al passo vedendo solo le chat non lette o quelle che richiedono la tua attenzione. Non preoccuparti, puoi cambiare questa impostazione in qualsiasi momento in <a href=\"".concat(priorityModePageUrl, "\">impostazioni</a>.");
        },
    },
    notFound: {
    ...
    bankAccount: {
        ...
        error: {
            ...
            deletePaymentBankAccount: 'Questo conto bancario non può essere eliminato perché viene utilizzato per i pagamenti con la carta Expensify. Se desideri comunque eliminare questo conto, contatta il Concierge.',
        },
    },
    ...
    additionalDetailsStep: {
        ...
        failedKYCMessage: function (_a) {
            ...
            return "Non siamo riusciti a verificare la tua identit\u00E0. Per favore riprova pi\u00F9 tardi o contatta <a href=\"mailto:".concat(conciergeEmail, "\">").concat(conciergeEmail, "</a> se hai domande.");
        },
    },
    termsStep: {
        ...
        haveReadAndAgree: "Ho letto e acconsento a ricevere le <a href=\"".concat(CONST_1.default.ELECTRONIC_DISCLOSURES_URL, "\">informazioni elettroniche</a>."),
        ...
        agreeToThe: function (_a) {
            ...
            return "Accetto l'accordo sulla <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacy</a> e il <a href=\"").concat(walletAgreementUrl, "\">Portafoglio</a>.");
        },
        ...
        shortTermsForm: {
            ...
            generalInfo: "Per informazioni generali sui conti prepagati, visitare <a href=\"".concat(CONST_1.default.CFPB_PREPAID_URL, "\">").concat(CONST_1.default.TERMS.CFPB_PREPAID, "</a>."),
            conditionsDetails: "Per i dettagli e le condizioni di tutte le tariffe e i servizi, visitare il sito <a href=\"".concat(CONST_1.default.FEES_URL, "\">").concat(CONST_1.default.FEES_URL, "</a> o chiamare il numero +1 833-400-0904."),
        ...
        longTermsForm: {
            ...
            electronicFundsStandardDetails: "Il trasferimento di fondi dal Portafoglio Expensify al vostro conto corrente bancario con l'opzione standard non comporta spese. Questo trasferimento viene solitamente completato entro 1-3 giorni lavorativi.",
            electronicFundsInstantDetails: function (_a) {
                var percentage = _a.percentage, amount = _a.amount;
                return "Il trasferimento di fondi dal portafoglio Expensify alla carta di debito collegata tramite l'opzione di trasferimento istantaneo è a pagamento. Questo trasferimento viene solitamente completato in pochi minuti." +
                    "La commissione \u00E8 pari al ".concat(percentage, "% dell'importo del trasferimento (con una commissione minima di ").concat(amount, ").");
            },
            fdicInsuranceBancorp: function (_a) {
                var amount = _a.amount;
                return "I vostri fondi hanno diritto all'assicurazione FDIC. I vostri fondi saranno conservati o trasferiti alla ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", un istituto assicurato dalla FDIC.") +
                    " Una volta l\u00EC, i vostri fondi sono assicurati fino a ".concat(amount, " dalla FDIC nel caso in cui ").concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, " fallisca, se sono soddisfatti i requisiti specifici di assicurazione dei depositi e se la vostra carta \u00E8 registrata.") +
                    " Per maggiori dettagli, vedere ".concat(CONST_1.default.TERMS.FDIC_PREPAID, ".");
            },
            contactExpensifyPayments: "Contattare ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " chiamando il numero +1 833-400-0904, inviando un'e-mail a ").concat(CONST_1.default.EMAIL.CONCIERGE, " o accedendo a ").concat(CONST_1.default.NEW_EXPENSIFY_URL, "."),
            generalInformation: "Per informazioni generali sui conti prepagati, visitare ".concat(CONST_1.default.TERMS.CFPB_PREPAID, ". Se avete un reclamo su un conto prepagato, chiamate il Consumer Financial Protection Bureau al numero 1-855-411-2372 o visitate ").concat(CONST_1.default.TERMS.CFPB_COMPLAINT, "."),
    ...
    signerInfoStep: {
        ...
        areYouDirector: function (_a) {
            var companyName = _a.companyName;
            return "Sei un direttore presso ".concat(companyName, "?");
        },
        ...
        enterOneEmail: function (_a) {
            var companyName = _a.companyName;
            return "Inserisci l'email del direttore presso ".concat(companyName);
        },
        ...
        enterTwoEmails: function (_a) {
            var companyName = _a.companyName;
            return "Inserisci le email di due direttori presso ".concat(companyName);
        },
        ...
        isConnecting: function (_a) {
            ...
            return "sta collegando un conto bancario aziendale in ".concat(currency, " terminante con ").concat(bankAccountLastFour, " a Expensify per pagare i dipendenti in ").concat(currency, ". Il prossimo passaggio richiede le informazioni di un firmatario, come un direttore.");
        },
        error: {
    ...
    docusignStep: {
        ...
        pleaseComplete: 'Completa il modulo di autorizzazione ACH tramite il link Docusign qui sotto e carica una copia firmata qui per consentirci di prelevare fondi direttamente dal tuo conto bancario.',
        pleaseCompleteTheBusinessAccount: 'Completa la richiesta di conto aziendale e l’accordo di addebito diretto.',
        pleaseCompleteTheDirect: 'Completa l’accordo di addebito diretto tramite il link Docusign qui sotto e carica una copia firmata qui per consentirci di prelevare fondi direttamente dal tuo conto bancario.',
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: "Accettate <a href=\"".concat(CONST_1.default.TRAVEL_TERMS_URL, "\">i termini e le condizioni</a> di Expensify Travel."),
        ...
        phoneError: function (_a) {
            ...
            return "<rbr><a href=\"".concat(phoneErrorMethodsRoute, "\">Aggiungete un'e-mail di lavoro come login principale</a> per prenotare i viaggi.</rbr>");
        },
        domainSelector: {
            title: 'Dominio',
        ...
        domainPermissionInfo: {
            ...
            restriction: function (_a) {
                ...
                return "Non hai l'autorizzazione per abilitare Expensify Travel per il dominio <strong>".concat(domain, "</strong>. Dovrai chiedere a qualcuno di quel dominio di abilitare invece Travel.");
            },
            accountantInvitation: "Se sei un commercialista, valuta la possibilit\u00E0 di aderire al <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.EXPENSIFY_APPROVED_PROGRAM_URL, "\">programma ExpensifyApproved! per commercialisti</a> per abilitare i viaggi per questo dominio."),
        },
        publicDomainError: {
        ...
        verifyCompany: {
            ...
            conciergeMessage: function (_a) {
                var domain = _a.domain;
                return "Abilitazione del viaggio fallita per il dominio: ".concat(domain, ". Si prega di rivedere e abilitare il viaggio per questo dominio.");
            },
        },
        updates: {
    ...
    workspace: {
        common: {
            ...
            shareNote: {
                ...
                content: function (_a) {
                    ...
                    return "Condividi questo codice QR o copia il link sottostante per consentire ai membri di richiedere facilmente l'accesso al tuo spazio di lavoro. Tutte le richieste di accesso allo spazio di lavoro verranno visualizzate nella stanza <a href=\"".concat(adminsRoomLink, "\">").concat(CONST_1.default.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS, "</a> per la tua revisione.");
                },
            },
            ...
            deepDiveExpensifyCard: "<muted-text-label>Le transazioni della carta Expensify verranno esportate automaticamente in un \u201CConto di responsabilit\u00E0 della carta Expensify\u201D creato con la <a href=\"".concat(CONST_1.default.DEEP_DIVE_EXPENSIFY_CARD, "\">nostra integrazione</a>.</muted-text-label>"),
        },
        receiptPartners: {
            ...
            uber: {
                subtitle: function (_a) {
                    ...
                    return organizationName ? "Connesso a ".concat(organizationName) : 'Automatizza le spese di viaggio e consegna pasti in tutta la tua organizzazione.';
                },
                ...
                status: (_e = {
                    ...
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.LINKED] = 'Collegato',
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.LINKED_PENDING_APPROVAL] = 'In attesa',
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.SUSPENDED] = 'Sospeso',
                    _e),
        ...
        perDiem: {
            subtitle: "<muted-text>Imposta le tariffe di diaria per controllare la spesa giornaliera dei dipendenti. <a href=\"".concat(CONST_1.default.DEEP_DIVE_PER_DIEM, "\">Scopri di pi\u00F9</a>.</muted-text>"),
            amount: 'Importo',
        ...
        qbd: {
            ...
            accounts: (_g = {},
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Carta di credito',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Fattura fornitore',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Voce di diario',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Controlla',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = 'Creeremo un assegno dettagliato per ogni report di Expensify e lo invieremo dal conto bancario sottostante.',
                ...
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = "Creeremo una fattura dettagliata del fornitore per ogni report di Expensify con la data dell'ultima spesa e la aggiungeremo al conto sottostante. Se questo periodo è chiuso, la registreremo al 1° del prossimo periodo aperto.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Scegli dove esportare le transazioni con carta di credito.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Scegli un fornitore da applicare a tutte le transazioni con carta di credito.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = 'Scegli da dove inviare gli assegni.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = "Le fatture dei fornitori non sono disponibili quando le località sono abilitate. Si prega di scegliere un'opzione di esportazione diversa.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = "Gli assegni non sono disponibili quando le località sono abilitate. Si prega di scegliere un'opzione di esportazione diversa.",
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = "Le registrazioni contabili non sono disponibili quando le tasse sono abilitate. Si prega di scegliere un'opzione di esportazione diversa.",
                _g),
            ...
            setupPage: {
                ...
                setupErrorBody: function (_a) {
                    ...
                    return "<muted-text><centered-text>La connessione a QuickBooks Desktop non funziona al momento. Riprovare pi\u00F9 tardi o <a href=\"".concat(conciergeLink, "\">contattare Concierge</a> se il problema persiste.</centered-text></muted-text>");
                },
            },
            ...
            accountingMethods: {
                ...
                values: (_h = {},
                    ...
                    _h[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contanti',
                    _h),
                alternateText: (_j = {},
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Le spese anticipate verranno esportate quando approvate definitivamente.',
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Le spese anticipate verranno esportate quando pagate',
                    _j),
            },
        },
        qbo: {
            ...
            accounts: (_l = {},
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = 'Carta di debito',
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Carta di credito',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Fattura fornitore',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Voce di diario',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Controlla',
                ...
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "Abbineremo automaticamente il nome del commerciante sulla transazione con carta di credito a qualsiasi fornitore corrispondente in QuickBooks. Se non esistono fornitori, creeremo un fornitore 'Credit Card Misc.' per l'associazione.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = "Creeremo una fattura dettagliata del fornitore per ogni report di Expensify con la data dell'ultima spesa e la aggiungeremo al conto sottostante. Se questo periodo è chiuso, la registreremo al 1° del prossimo periodo aperto.",
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Scegli dove esportare le transazioni con carta di debito.',
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Scegli dove esportare le transazioni con carta di credito.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Scegli un fornitore da applicare a tutte le transazioni con carta di credito.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = "Le fatture dei fornitori non sono disponibili quando le località sono abilitate. Si prega di scegliere un'opzione di esportazione diversa.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = "Gli assegni non sono disponibili quando le località sono abilitate. Si prega di scegliere un'opzione di esportazione diversa.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = "Le registrazioni contabili non sono disponibili quando le tasse sono abilitate. Si prega di scegliere un'opzione di esportazione diversa.",
                _l),
            exportDestinationAccountsMisconfigurationError: (_m = {},
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = "Scegli un account valido per l'esportazione delle fatture fornitore",
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = "Scegli un account valido per l'esportazione della registrazione contabile",
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = "Scegli un account valido per l'esportazione dell'assegno",
                _m),
            exportDestinationSetupAccountsInfo: (_o = {},
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = "Per utilizzare l'esportazione delle fatture dei fornitori, configura un conto contabile fornitori in QuickBooks Online.",
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = "Per utilizzare l'esportazione delle registrazioni contabili, configura un conto contabile in QuickBooks Online.",
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = "Per utilizzare l'esportazione degli assegni, configura un conto bancario in QuickBooks Online.",
                _o),
            noAccountsFound: 'Nessun account trovato',
            ...
            accountingMethods: {
                ...
                values: (_p = {},
                    ...
                    _p[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contanti',
                    _p),
                alternateText: (_q = {},
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Le spese anticipate verranno esportate quando approvate definitivamente.',
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Le spese anticipate verranno esportate quando pagate',
                    _q),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_r = {},
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Contatto predefinito Xero',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = 'Tag',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = 'Campi del rapporto',
                _r),
            ...
            invoiceStatus: {
                ...
                values: (_t = {},
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = 'Bozza',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = 'In attesa di approvazione',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = 'In attesa di pagamento',
                    _t),
            },
            noAccountsFound: 'Nessun account trovato',
            ...
            accountingMethods: {
                ...
                values: (_u = {},
                    ...
                    _u[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contanti',
                    _u),
                alternateText: (_v = {},
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Le spese anticipate verranno esportate quando approvate definitivamente.',
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Le spese anticipate verranno esportate quando pagate',
                    _v),
            },
        },
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_x = {},
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = 'Report di spesa',
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Fatture fornitore',
                    _x),
            },
            nonReimbursableExpenses: {
                description: 'Imposta come esportare gli acquisti con carta aziendale su Sage Intacct.',
                values: (_y = {},
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = 'Carte di credito',
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Fatture fornitore',
                    _y),
            },
            creditCardAccount: 'Account di carta di credito',
        ...
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: (_1 = {},
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = 'Singola voce dettagliata per ciascun report',
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = 'Voce singola per ogni spesa',
                    _1),
            },
            invoiceItem: {
            ...
            exportDestination: {
                values: (_4 = {},
                    ...
                    _4),
                expenseReportDestinationConfirmDescription: 'Se cambi l’impostazione di esportazione delle carte aziendali in note spese, i fornitori NetSuite e i conti di registrazione per le singole carte saranno disabilitati.\n\nNon preoccuparti, salveremo comunque le tue selezioni precedenti nel caso tu voglia tornare indietro in seguito.',
            },
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_5 = {},
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'Preferenza predefinita di NetSuite',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = 'Solo supervisore approvato',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = 'Solo contabilità approvata',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = 'Supervisore e contabilità approvati',
                        _5),
                },
                accountingMethods: {
                    label: 'Quando Esportare',
                    ...
                    values: (_6 = {},
                        ...
                        _6[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contanti',
                        _6),
                    alternateText: (_7 = {},
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Le spese anticipate verranno esportate quando approvate definitivamente.',
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Le spese anticipate verranno esportate quando pagate',
                        _7),
                },
                exportVendorBillsTo: {
                    ...
                    values: (_8 = {},
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'Preferenza predefinita di NetSuite',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = 'In attesa di approvazione',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = 'Approvato per la pubblicazione',
                        _8),
                },
                exportJournalsTo: {
                    ...
                    values: (_9 = {},
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'Preferenza predefinita di NetSuite',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = 'In attesa di approvazione',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = 'Approvato per la pubblicazione',
                        _9),
                },
                error: {
        ...
        intacct: {
            ...
            toggleImportTitle: function (_a) {
                ...
                return "Scegli come gestire Sage Intacct <strong>".concat(mappingTitle, "</strong> in Expensify.");
            },
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                learnMoreAboutOptions: "<muted-text>Per saperne di pi\u00F9 su queste <a href=\"".concat(CONST_1.default.COMPANY_CARDS_CONNECT_CREDIT_CARDS_HELP_URL, "\">opzioni</a>.</muted-text>"),
            ...
            statementCloseDate: (_11 = {},
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Ultimo giorno del mese',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Ultimo giorno lavorativo del mese',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Giorno del mese personalizzato',
                _11),
            ...
            chooseCardFor: function (_a) {
                ...
                return "Scegli una carta per <strong>".concat(assignee, "</strong>. Non riesci a trovare la carta che stai cercando? <concierge-link>Facci sapere.</concierge-link>");
            },
            noActiveCards: 'Nessuna carta attiva in questo feed',
            somethingMightBeBroken: '<muted-text><centered-text>Oppure potrebbe esserci qualcosa di rotto. In ogni caso, se avete domande, <concierge-link>contattate il Concierge</concierge-link>.</centered-text></muted-text>',
            ...
            brokenConnectionError: '<rbr>La connessione del feed della carta è interrotta. Per favore <a href="#">accedi al tuo conto bancario</a> così possiamo ristabilire la connessione.</rbr>',
        ...
        expensifyCard: {
            ...
            euUkDisclaimer: 'Le carte fornite ai residenti nello Spazio Economico Europeo sono emesse da Transact Payments Malta Limited, mentre le carte fornite ai residenti nel Regno Unito sono emesse da Transact Payments Limited in base alla licenza di Visa Europe Limited. Transact Payments Malta Limited è debitamente autorizzata e regolamentata dalla Malta Financial Services Authority come istituto finanziario ai sensi del Financial Institution Act del 1994. Numero di registrazione C 91879. Transact Payments Limited è autorizzata e regolamentata dalla Gibraltar Financial Service Commission.',
            ...
            settlementAccountInfo: function (_a) {
                ...
                return "Assicurarsi che questo conto corrisponda al <a href=\"".concat(reconciliationAccountSettingsLink, "\">conto Riconciliazione</a> (").concat(accountNumber, ") in modo che la Riconciliazione continua funzioni correttamente.");
            },
            settlementFrequency: 'Frequenza di liquidazione',
            ...
            cardPending: function (_a) {
                var name = _a.name;
                return "La carta \u00E8 attualmente in sospeso e verr\u00E0 emessa una volta che l'account di ".concat(name, " sar\u00E0 convalidato.");
            },
            virtual: 'Virtuale',
            physical: 'Fisico',
            ...
            issuedCardNoShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "\u00C8 stata emessa una Expensify Card per ".concat(assignee, "! La carta verr\u00E0 spedita una volta confermati i dettagli di spedizione.");
            },
            ...
            addedShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "".concat(assignee, " ha aggiunto i dettagli di spedizione. La Expensify Card arriver\u00E0 in 2-3 giorni lavorativi.");
            },
        ...
        categories: {
            ...
            emptyCategories: {
                ...
                subtitleWithAccounting: function (_a) {
                    ...
                    return "<muted-text><centered-text>Le categorie vengono attualmente importate da una connessione contabile. Passare alla <a href=\"".concat(accountingPageURL, "\">contabilit\u00E0</a> per apportare eventuali modifiche.</centered-text></muted-text>");
                },
            },
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                integrationExportTitle: function (_a) {
                    ...
                    return "Scegli l'account ".concat(integration, " in cui esportare le transazioni. Selezionare un'altra <a href=\"").concat(exportPageLink, "\">opzione di esportazione</a> per cambiare i conti disponibili.");
                },
        ...
        reports: {
            ...
            customReportNamesSubtitle: "<muted-text>Personalizza i titoli dei report utilizzando le nostre <a href=\"".concat(CONST_1.default.CUSTOM_REPORT_NAME_HELP_URL, "\">formule complete</a>.</muted-text>"),
            customNameTitle: 'Titolo predefinito del report',
            customNameDescription: "Scegli un nome personalizzato per i rapporti sulle spese utilizzando le nostre <a href=\"".concat(CONST_1.default.CUSTOM_REPORT_NAME_HELP_URL, "\">formule complete</a>."),
        ...
        tags: {
            ...
            dependentMultiLevelTagsSubtitle: function (_a) {
                ...
                return "<muted-text>Si stanno utilizzando <a href=\"".concat(CONST_1.default.IMPORT_TAGS_EXPENSIFY_URL_DEPENDENT_TAGS, "\">tag dipendenti</a>. \u00C8 possibile <a href=\"").concat(importSpreadsheetLink, "\">reimportare un foglio di calcolo</a> per aggiornare i tag.</muted-text>");
            },
            emptyTags: {
                title: 'Non hai creato alcun tag',
                //  We need to remove the subtitle and use the below one when we remove the canUseMultiLevelTags beta
                subtitle: 'Aggiungi un tag per tracciare progetti, sedi, reparti e altro.',
                subtitleHTML: "<muted-text><centered-text>Importare un foglio di calcolo per aggiungere tag per tracciare progetti, sedi, reparti e altro ancora. <a href=\"".concat(CONST_1.default.IMPORT_TAGS_EXPENSIFY_URL, "\">Ulteriori informazioni</a> sulla formattazione dei file di tag.</centered-text></muted-text>"),
                subtitleWithAccounting: function (_a) {
                    var accountingPageURL = _a.accountingPageURL;
                    return "<muted-text><centered-text>I tag vengono attualmente importati da una connessione contabile. Passare alla <a href=\"".concat(accountingPageURL, "\">contabilit\u00E0</a> per apportare eventuali modifiche.</centered-text></muted-text>");
                },
            },
        ...
        duplicateWorkspace: {
            ...
            confirmTitle: function (_a) {
                ...
                return "Stai per creare e condividere ".concat(newWorkspaceName !== null && newWorkspaceName !== void 0 ? newWorkspaceName : '', " con ").concat(totalMembers !== null && totalMembers !== void 0 ? totalMembers : 0, " membri dall'area di lavoro originale.");
            },
        ...
        people: {
            ...
            workspaceMembersCount: function (_a) {
                var count = _a.count;
                return "Numero totale di membri dello spazio di lavoro: ".concat(count);
            },
            ...
            removeMemberPromptApprover: function (_a) {
                ...
                return "Se rimuovi ".concat(approver, " da questo spazio di lavoro, verr\u00E0 sostituito/a nel flusso di approvazione con ").concat(workspaceOwner, ", il proprietario dello spazio di lavoro.");
            },
            removeMemberPromptPendingApproval: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " ha rapporti spese in sospeso da approvare. Chiedi loro di approvarli oppure assumi il controllo dei loro rapporti prima di rimuoverli dallo spazio di lavoro.");
            },
            removeMemberPromptReimburser: function (_a) {
                var memberName = _a.memberName;
                return "Non puoi rimuovere ".concat(memberName, " da questo spazio di lavoro. Imposta un nuovo responsabile dei rimborsi in Flussi di lavoro > Effettua o traccia i pagamenti, quindi riprova.");
            },
            removeMemberPromptExporter: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Se rimuovi ".concat(memberName, " da questo spazio di lavoro, lo/la sostituiremo come esportatore preferito con ").concat(workspaceOwner, ", il proprietario dello spazio di lavoro.");
            },
            removeMemberPromptTechContact: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Se rimuovi ".concat(memberName, " da questo spazio di lavoro, sostituiremo il referente tecnico con ").concat(workspaceOwner, ", il proprietario dello spazio di lavoro.");
            },
            cannotRemoveUserDueToReport: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " ha un report in elaborazione che richiede un intervento. Ti preghiamo di chiedere loro di completare l'azione richiesta prima di rimuoverli dallo spazio di lavoro.");
            },
        },
        card: {
            getStartedIssuing: 'Inizia emettendo la tua prima carta virtuale o fisica.',
        ...
        accounting: {
            ...
            errorODIntegration: function (_a) {
                ...
                return "C'\u00E8 un errore con una connessione che \u00E8 stata impostata in Expensify Classic. [Vai su Expensify Classic per risolvere questo problema.](".concat(oldDotPolicyConnectionsURL, ")");
            },
            ...
            importTypes: (_12 = {},
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = 'Importato',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Importato come tag',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Importato',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'Non importato',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'Non importato',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Importato come campi del report',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'Impostazione predefinita dipendente NetSuite',
                _12),
            ...
            enableContinuousReconciliation: function (_a) {
                ...
                return "<muted-text-label>Per abilitare la riconciliazione continua, abilita la <a href=\"".concat(accountingAdvancedSettingsLink, "\">sincronizzazione automatica</a> per ").concat(connectionName, ".</muted-text-label>");
            },
            chooseReconciliationAccount: {
                ...
                settlementAccountReconciliation: function (_a) {
                    ...
                    return "Assicurati che questo account corrisponda al tuo <a href=\"".concat(settlementAccountUrl, "\">Conto di regolamento della carta Expensify</a> (terminante con ").concat(lastFourPAN, ") affinch\u00E9 la Riconciliazione Continua funzioni correttamente.");
                },
            },
        },
        export: {
        ...
        distanceRates: {
            ...
            status: 'Stato',
            unit: 'Unit',
            taxFeatureNotEnabledMessage: '<muted-text>Le tasse devono essere abilitate nello spazio di lavoro per utilizzare questa funzione. Vai su <a href="#">Più funzionalità</a> per apportare quella modifica. </muted-text>',
        ...
        bankAccount: {
            ...
            disconnectYourBankAccount: function (_a) {
                var bankName = _a.bankName;
                return "Disconnettere il conto bancario <strong>".concat(bankName, "</strong>. Qualsiasi transazione in sospeso per questo conto verr\u00E0 comunque completata.");
            },
            ...
            yourWorkspace: "Il tuo spazio di lavoro \u00E8 impostato su una valuta non supportata. Visualizza <a href=\"".concat(CONST_1.default.CONNECT_A_BUSINESS_BANK_ACCOUNT_HELP_URL, "\">l'elenco delle valute supportate</a>."),
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptText: "<muted-text-micro>Leggere e accettare i <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">termini</a> e <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">l'informativa sulla privacy</a> per aggiungere la carta.</muted-text-micro>"),
            ...
            addPaymentCardLearnMore: "<muted-text>Scopri di pi\u00F9 sulla nostra <a href=\"".concat(CONST_1.default.PERSONAL_DATA_PROTECTION_INFO_URL, "\">sicurezza</a>.</muted-text>"),
        ...
        upgrade: (_13 = {
                reportFields: {
                    ...
                    onlyAvailableOnPlan: function (_a) {
                        ...
                        return "<muted-text>I campi del report sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                    },
                }
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.NETSUITE] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>La nostra integrazione con NetSuite \u00E8 disponibile solo con il piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.SAGE_INTACCT] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>La nostra integrazione con Sage Intacct \u00E8 disponibile solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.QBD] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>La nostra integrazione con QuickBooks Desktop \u00E8 disponibile solo con il piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Le approvazioni avanzate sono disponibili solo nel piano Control, che parte da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.categories = {
                title: 'Categorie',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Le categorie sono disponibili nel piano Collect, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.glCodes = {
                title: 'Codici GL',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I codici GL sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.glAndPayrollCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I codici GL e Payroll sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.taxCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I codici fiscali sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.companyCards = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Questo \u00E8 disponibile solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.rules = {
                title: 'Regole',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Le regole sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.perDiem = {
                title: 'Per diem',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I diari sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.travel = {
                title: 'Viaggio',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Il viaggio \u00E8 disponibile nel piano Collect, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.reports = {
                title: 'Report',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I report sono disponibili nel piano Collect, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.multiLevelTags = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I tag multilivello sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.distanceRates = {
                title: 'Tariffe a distanza',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Le tariffe a distanza sono disponibili con il piano Collect, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.auditor = {
                title: 'Revisore',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I revisori sono disponibili solo con il piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id] = {
                title: 'Livelli di approvazione multipli',
                description: 'I livelli di approvazione multipli sono uno strumento di flusso di lavoro per le aziende che richiedono a più di una persona di approvare un report prima che possa essere rimborsato.',
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>I livelli di approvazione multipli sono disponibili solo nel piano Control, a partire da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", "</muted-text>");
                },
            },
            _13.pricing = {
            ...
            _13.note = function (_a) {
                ...
                return "<muted-text>Aggiorna per accedere a questa funzione oppure <a href=\"".concat(subscriptionLink, "\">scopri di pi\u00F9</a> sui nostri piani e prezzi.</muted-text>");
            },
            _13.upgradeToUnlock = 'Sblocca questa funzione',
            _13.completed = {
                ...
                successMessage: function (_a) {
                    ...
                    return "<centered-text>Hai aggiornato con successo ".concat(policyName, " al piano Control! <a href=\"").concat(subscriptionLink, "\">Visualizza il tuo abbonamento</a> per maggiori dettagli.</centered-text>");
                },
            ...
            _13.commonFeatures = {
                ...
                benefits: {
                    startsAtFull: function (_a) {
                        ...
                        return "<muted-text>Il piano Control parte da <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per membro al mese." : "per membro attivo al mese.", " <a href=\"").concat(learnMoreMethodsRoute, "\">Scopri di pi\u00F9</a> informazioni sui nostri piani e prezzi.</muted-text>");
                    },
        ...
        payAndDowngrade: {
            ...
            description1: function (_a) {
                var formattedAmount = _a.formattedAmount;
                return "La fattura finale per questo abbonamento sar\u00E0 di <strong>".concat(formattedAmount, "</strong>");
            },
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: function (_a) {
                    ...
                    return "<muted-text>Imposta controlli di spesa e valori predefiniti per le singole spese. Puoi anche creare regole per <a href=\"".concat(categoriesPageLink, "\">categorie</a> e <a href=\"").concat(tagsPageLink, "\">tag</a>.</muted-text>");
                },
                ...
                cashExpenseDefaultDescription: 'Scegli come devono essere create le spese in contanti. Una spesa è considerata in contanti se non è una transazione su carta aziendale importata. Ciò include spese create manualmente, ricevute, diarie, chilometraggi e spese di tempo.',
                ...
                billableDefaultDescription: function (_a) {
                    ...
                    return "<muted-text>Scegli se le spese in contanti e con carta di credito devono essere fatturabili per impostazione predefinita. Le spese fatturabili possono essere abilitate o disabilitate nei <a href=\"".concat(tagsPageLink, "\">tag</a>.</muted-text>");
                },
                billable: 'Fatturabile',
                ...
                eReceipts: 'eReceipts',
                eReceiptsHint: "Le ricevute elettroniche vengono create automaticamente [per la maggior parte delle transazioni di credito in USD](".concat(CONST_1.default.DEEP_DIVE_ERECEIPTS, ")."),
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "Vai su [pi\u00F9 funzionalit\u00E0](".concat(moreFeaturesLink, ") e attiva i flussi di lavoro, quindi aggiungi ").concat(featureName, " per sbloccare questa funzionalit\u00E0.");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName, moreFeaturesLink = _a.moreFeaturesLink;
                    return "Vai su [pi\u00F9 funzionalit\u00E0](".concat(moreFeaturesLink, ") e attiva ").concat(featureName, " per sbloccare questa funzionalit\u00E0.");
                },
            },
            categoryRules: {
                ...
                enableWorkflows: function (_a) {
                    ...
                    return "Vai su [Pi\u00F9 funzionalit\u00E0](".concat(moreFeaturesLink, ") e attiva i flussi di lavoro, quindi aggiungi le approvazioni per sbloccare questa funzionalit\u00E0.");
                },
            },
            customRules: {
    ...
    workspaceActions: {
        ...
        updateDefaultReimbursable: function (_a) {
            var oldValue = _a.oldValue, newValue = _a.newValue;
            return "aggiornato \"Spesa in contanti predefinita\" a \"".concat(newValue, "\" (precedentemente \"").concat(oldValue, "\")");
        },
    ...
    roomMembersPage: {
        ...
        roomArchived: "Sembra che questa stanza sia stata archiviata. Se hai domande, contatta ".concat(CONST_1.default.EMAIL.CONCIERGE, "."),
        removeMembersPrompt: function (_a) {
            var memberName = _a.memberName;
            return ({
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_14 = {},
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = 'Mai',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'Ultimo mese',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.THIS_MONTH] = 'Questo mese',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_STATEMENT] = 'Ultima dichiarazione',
                    _14),
            },
            status: 'Stato',
            ...
            amount: {
                ...
                equalTo: function (_a) {
                    var _b = _a === void 0 ? {} : _a, amount = _b.amount;
                    return "Uguale a ".concat(amount !== null && amount !== void 0 ? amount : '');
                },
            },
            card: {
                expensify: 'Expensify',
            ...
            groupBy: (_15 = {},
                _15[CONST_1.default.SEARCH.GROUP_BY.FROM] = 'Da',
                _15[CONST_1.default.SEARCH.GROUP_BY.CARD] = 'Carta',
                _15[CONST_1.default.SEARCH.GROUP_BY.WITHDRAWAL_ID] = 'ID di prelievo',
                _15),
            feed: 'Feed',
            withdrawalType: (_16 = {},
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.EXPENSIFY_CARD] = 'Expensify Card',
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.REIMBURSEMENT] = 'Rimborso',
                _16),
            is: 'È',
            action: (_17 = {},
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.SUBMIT] = 'Inviare',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.APPROVE] = 'Approvare',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.PAY] = 'Pagare',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.EXPORT] = 'Esportare',
                _17),
            reportField: function (_a) {
                var name = _a.name, value = _a.value;
                return "".concat(name, " \u00E8 ").concat(value);
            },
        },
        has: 'Ha',
        groupBy: 'Gruppo per',
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationPrompt: function (_a) {
                var workspaceName = _a.workspaceName;
                return "Sei sicuro di voler creare un altro rapporto in ".concat(workspaceName, "? Puoi accedere ai tuoi rapporti vuoti in");
            },
        ...
        actions: {
            type: {
                changeField: function (_a) {
                    ...
                    return "ha modificato ".concat(fieldName, " in \"").concat(newValue, "\" (precedentemente \"").concat(oldValue, "\")");
                },
                changeFieldEmpty: function (_a) {
                    var newValue = _a.newValue, fieldName = _a.fieldName;
                    return "ha impostato ".concat(fieldName, " su \"").concat(newValue, "\"");
                },
                changeReportPolicy: function (_a) {
                    var fromPolicyName = _a.fromPolicyName, toPolicyName = _a.toPolicyName;
                    if (!toPolicyName) {
                        return "Spazio di lavoro modificato".concat(fromPolicyName ? " (precedentemente ".concat(fromPolicyName, ")") : '');
                    }
                    return "Spazio di lavoro modificato in ".concat(toPolicyName).concat(fromPolicyName ? " (precedentemente ".concat(fromPolicyName, ")") : '');
                },
                ...
                exportedToIntegration: {
                    automatic: function (_a) {
                        ...
                        return "esportato in ".concat(translatedLabel);
                    },
    ...
    referralProgram: (_18 = {},
        ...
        _18.copyReferralLink = 'Copia il link di invito',
        _18),
    systemChatFooterMessage: (_19 = {},
        _19[CONST_1.default.INTRO_CHOICES.MANAGE_TEAM] = function (_a) {
            ...
            return "Chatta con il tuo specialista di configurazione in <a href=\"".concat(href, "\">").concat(adminReportName, "</a> per assistenza");
        },
        _19.default = "Messaggio <concierge-link>".concat(CONST_1.default.CONCIERGE_CHAT_NAME, "</concierge-link> per assistenza con la configurazione"),
        _19),
    violations: {
        ...
        overTripLimit: function (_a) {
            var formattedLimit = _a.formattedLimit;
            return "Importo superiore al limite di ".concat(formattedLimit, "/viaggio");
        },
        ...
        rter: function (_a) {
            ...
            if (brokenBankConnection || rterType === CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? "Connessione bancaria interrotta. <a href=\"".concat(companyCardPageURL, "\">Riconnetti per abbinarla alla ricevuta</a>")
        ...
        adminBrokenConnectionError: function (_a) {
            ...
            return "<muted-text-label>Ricevuta in sospeso a causa di una connessione bancaria interrotta. Risolvi il problema in <a href=\"".concat(workspaceCompanyCardRoute, "\">Carte aziendali</a>.</muted-text-label>");
        },
    ...
    exitSurvey: {
        ...
        reasons: (_21 = {},
            _21[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Ho bisogno di una funzionalità disponibile solo in Expensify Classic.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Non capisco come usare New Expensify.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Capisco come utilizzare New Expensify, ma preferisco Expensify Classic.',
            _21),
        prompts: (_22 = {},
            _22[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Quale funzionalità ti serve che non è disponibile nel nuovo Expensify?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Cosa stai cercando di fare?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Perché preferisci Expensify Classic?',
            _22),
        ...
        benefits: (_23 = {},
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Chattare direttamente su spese e report',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Possibilità di fare tutto su mobile',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Viaggia e gestisci le spese alla velocità della chat',
            _23),
    ...
    subscription: {
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "Completa il processo di autenticazione per attivare la tua carta che termina con ".concat(cardEnding, ".");
                },
            },
            insufficientFunds: {
                title: 'La tua carta non può essere addebitata',
        ...
        compareModal: {
            ...
            subtitle: "<muted-text>Sblocca le funzionalit\u00E0 di cui hai bisogno con il piano pi\u00F9 adatto a te. <a href=\"".concat(CONST_1.default.PRICING, "\">Consulta la nostra pagina dei prezzi</a> o una panoramica completa delle funzionalit\u00E0 di ciascuno dei nostri piani.</muted-text>"),
        },
        details: {
        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                preventFutureActivity: function (_a) {
                    ...
                    return "Se desideri prevenire attivit\u00E0 e addebiti futuri, devi <a href=\"".concat(workspacesListRoute, "\">elimina il tuo/i tuoi spazio/i di lavoro</a>. Si noti che quando si eliminano i propri workspace, verr\u00E0 addebitata qualsiasi attivit\u00E0 in sospeso che \u00E8 stata sostenuta durante il mese di calendario corrente.");
                },
            },
            requestSubmitted: {
                title: 'Richiesta inviata',
                subtitle: "Grazie per averci comunicato il tuo interesse a cancellare l'abbonamento. Stiamo esaminando la tua richiesta e ti contatteremo presto tramite la chat con il <concierge-link>Concierge</concierge-link>.",
            },
    ...
    delegate: {
        ...
        notAllowedMessage: function (_a) {
            ...
            return "Come <a href=\"".concat(CONST_1.default.DELEGATE_ROLE_HELP_DOT_ARTICLE_LINK, "\">copilota</a> di ").concat(accountOwnerEmail, ", non hai il permesso di eseguire questa azione. Mi dispiace!");
        },
    ...
    scheduledCall: {
        book: {
            ...
            slots: function (_a) {
                var date = _a.date;
                return "<muted-text>Orari disponibili per <strong>".concat(date, "</strong></muted-text>");
            },
        },
        confirmation: {
    ...
    nextStep: {
        message: (_24 = {},
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_ADD_TRANSACTIONS] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che <strong>".concat(actor, "</strong> aggiunga le spese.");
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION] = function (_) { return "Nessuna ulteriore azione richiesta!"; },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_SUBMITTER_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che <strong>".concat(actor, "</strong> aggiunga un conto bancario.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_AUTOMATIC_SUBMIT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "il ".concat(eta) : " ".concat(eta);
                }
                // eslint-disable-next-line default-case
                switch (actorType) {
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return "In attesa che <strong>le tue</strong> spese vengano inviate automaticamente".concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che le spese di <strong>".concat(actor, "</strong> vengano inviate automaticamente").concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return "In attesa che le spese di un amministratore vengano inviate automaticamente".concat(formattedETA, ".");
                }
            },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_FIX_ISSUES] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che <strong>".concat(actor, "</strong> risolva il problema o i problemi.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che <strong>".concat(actor, "</strong> approvi le spese.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che <strong>".concat(actor, "</strong> paghi le spese.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_POLICY_BANK_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "In attesa che <strong>".concat(actor, "</strong> completi la configurazione di un conto bancario aziendale.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_PAYMENT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "entro ".concat(eta) : " ".concat(eta);
                }
                return "In attesa che il pagamento sia completato".concat(formattedETA, ".");
            },
            _24),
        eta: (_25 = {},
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SHORTLY] = 'a breve',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.TODAY] = 'più tardi oggi',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_WEEK] = 'di domenica',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SEMI_MONTHLY] = 'il 1º e il 16 di ogni mese',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_BUSINESS_DAY_OF_MONTH] = "nell'ultimo giorno lavorativo del mese",
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_DAY_OF_MONTH] = "l'ultimo giorno del mese",
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_TRIP] = 'alla fine del tuo viaggio',
            _25),
    },
    domain: {
        ...
        verifyDomain: {
            ...
            beforeProceeding: function (_a) {
                ...
                return "Prima di procedere, verifica di essere il proprietario di <strong>".concat(domainName, "</strong> aggiornando le impostazioni DNS.");
            },
            accessYourDNS: function (_a) {
                var domainName = _a.domainName;
                return "Accedi al tuo provider DNS e apri le impostazioni DNS per <strong>".concat(domainName, "</strong>.");
            },
            addTXTRecord: 'Aggiungi il seguente record TXT:',
            saveChanges: 'Salva le modifiche e torna qui per verificare il tuo dominio.',
            youMayNeedToConsult: "Potresti dover contattare il reparto IT della tua organizzazione per completare la verifica. <a href=\"".concat(CONST_1.default.DOMAIN_VERIFICATION_HELP_URL, "\">Scopri di pi\u00F9</a>."),
        ...
        domainVerified: {
            ...
            description: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><centered-text>Il dominio <strong>".concat(domainName, "</strong> \u00E8 stato verificato con successo e ora puoi configurare SAML e altre funzionalit\u00E0 di sicurezza.</centered-text></muted-text>");
            },
        },
        saml: 'SAML',
        samlFeatureList: {
            ...
            subtitle: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><a href=\"".concat(CONST_1.default.SAML_HELP_URL, "\">SAML SSO</a> \u00E8 una funzionalit\u00E0 di sicurezza che ti offre un maggiore controllo su come i membri con indirizzi email <strong>").concat(domainName, "</strong> accedono a Expensify. Per abilitarla, dovrai verificare di essere un amministratore aziendale autorizzato.</muted-text>");
            },
