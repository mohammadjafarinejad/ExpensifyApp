...
var translations = {
    common: {
        ...
        acceptTermsAndPrivacy: "Ik accepteer de <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Expensify Gebruiksvoorwaarden</a> en <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacybeleid</a>"),
        acceptTermsAndConditions: "Ik accepteer de <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.ACH_TERMS_URL, "\">algemene voorwaarden</a>"),
        acceptTermsOfService: "Ik accepteer de <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Expensify Gebruiksvoorwaarden</a>"),
        remove: 'Verwijderen',
        admin: 'Admin',
        owner: 'Eigenaar',
        ...
        noResultsFoundMatching: function (searchString) { return "Geen resultaten gevonden die overeenkomen met \"".concat(searchString, "\""); },
        ...
        error: {
            ...
            phoneNumber: "Voer een volledig telefoonnummer in\n(bijv. ".concat(CONST_1.default.FORMATTED_EXAMPLE_PHONE_NUMBER, ")"),
        ...
        leaveWorkspaceConfirmationApprover: function (_a) {
            ...
            return "Als je deze werkruimte verlaat, word je in de goedkeuringsworkflow vervangen door ".concat(workspaceOwner, ", de eigenaar van de werkruimte.");
        },
        leaveWorkspaceConfirmationExporter: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Als je deze werkruimte verlaat, word je als voorkeursexporteur vervangen door ".concat(workspaceOwner, ", de eigenaar van de werkruimte.");
        },
        leaveWorkspaceConfirmationTechContact: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Als je deze werkruimte verlaat, word je als technisch contactpersoon vervangen door ".concat(workspaceOwner, ", de eigenaar van de werkruimte.");
        },
        leaveWorkspaceReimburser: 'Je kunt deze werkruimte niet verlaten als de uitbetaler. Stel een nieuwe uitbetaler in via Workspaces > Make or track payments en probeer het daarna opnieuw.',
    ...
    supportalNoAccess: {
        ...
        descriptionWithCommand: function (_a) {
            ...
            return "U bent niet gemachtigd om deze actie uit te voeren wanneer ondersteuning is ingelogd (opdracht: ".concat(command !== null && command !== void 0 ? command : '', "). Als u denkt dat Success deze actie zou moeten kunnen uitvoeren, start dan een gesprek in Slack.");
        },
    },
    lockedAccount: {
    ...
    reportActionContextMenu: {
        ...
        deleteConfirmation: function (_a) {
            ...
            return "Weet je zeker dat je deze ".concat(type, " wilt verwijderen?");
        },
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoom: function (_a) {
            ...
            return "Deze chat is voor facturen tussen <strong>".concat(invoicePayer, "</strong> en <strong>").concat(invoiceReceiver, "</strong>. Gebruik de + knop om een factuur te sturen.");
        },
        ...
        beginningOfChatHistoryPolicyExpenseChat: function (_a) {
            ...
            return "Dit is waar <strong>".concat(submitterDisplayName, "</strong> kosten zal indienen bij <strong>").concat(workspaceName, "</strong>. Gebruik gewoon de + knop.");
        },
        ...
        usePlusButton: function (_a) {
            ...
            return " Gebruik de + knop om een uitgave te ".concat(additionalText, ".");
        },
    ...
    receipt: {
        ...
        alternativeMethodsDownloadApp: function (_a) {
            ...
            return "<label-text><a href=\"".concat(downloadUrl, "\">Download de app</a> om met je telefoon te scannen</label-text>");
        },
        alternativeMethodsForwardReceipts: function (_a) {
            var email = _a.email;
            return "<label-text>Stuur bonnetjes door naar <a href=\"mailto:".concat(email, "\">").concat(email, "</a></label-text>");
        },
        alternativeMethodsAddPhoneNumber: function (_a) {
            var phoneNumber = _a.phoneNumber, contactMethodsUrl = _a.contactMethodsUrl;
            return "<label-text><a href=\"".concat(contactMethodsUrl, "\">Voeg je nummer toe</a> om bonnetjes te sms\u2019en naar ").concat(phoneNumber, "</label-text>");
        },
        alternativeMethodsTextReceipts: function (_a) {
            var phoneNumber = _a.phoneNumber;
            return "<label-text>Sms bonnetjes naar ".concat(phoneNumber, " (alleen VS-nummers)</label-text>");
        },
        takePhoto: 'Maak een foto',
        cameraAccess: "Cameratoegang is vereist om foto's van bonnetjes te maken.",
        deniedCameraAccess: "Camera-toegang is nog steeds niet verleend, volg alstublieft <a href=\"".concat(CONST_1.default.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL, "\">deze instructies</a>."),
    ...
    contacts: {
        ...
        helpText: function (_a) {
            var email = _a.email;
            return "Voeg meer manieren toe om bonnen te verzenden. Stuur ze naar <copy-text text=\"".concat(email, "\"/> of stuur ze naar 47777 (alleen Amerikaanse nummers).");
        },
    ...
    mergeAccountsPage: {
        ...
        accountDetails: {
            accountToMergeInto: function (_a) {
                var login = _a.login;
                return "Voer de account in die je wilt samenvoegen in <strong>".concat(login, "</strong>.");
            },
        ...
        accountValidate: {
            ...
            lossOfUnsubmittedData: function (_a) {
                var login = _a.login;
                return "Het samenvoegen van je accounts is onomkeerbaar en zal resulteren in het verlies van alle niet-ingediende uitgaven voor <strong>".concat(login, "</strong>.");
            },
            enterMagicCode: function (_a) {
                var login = _a.login;
                return "Voer de magische code in die naar <strong>".concat(login, "</strong> is verzonden om verder te gaan.");
            },
            errors: {
    ...
    cardPage: {
        ...
        missingPrivateDetails: function (_a) {
            ...
            return "<a href=\"".concat(missingDetailsLink, "\">Voeg je persoonlijke gegevens toe</a> en probeer het daarna opnieuw.");
        },
        ...
        cardFraudAlert: {
            ...
            clearedMessage: function (_a) {
                ...
                return "verdachte activiteit verwijderd en kaart x".concat(cardLastFour, " opnieuw geactiveerd. Alles klaar om door te gaan met declareren!");
            },
            deactivatedMessage: function (_a) {
                var cardLastFour = _a.cardLastFour;
                return "deactiveerde de kaart eindigend op ".concat(cardLastFour);
            },
            alertMessage: function (_a) {
                var cardLastFour = _a.cardLastFour, amount = _a.amount, merchant = _a.merchant, date = _a.date;
                return "verdachte activiteit ge\u00EFdentificeerd op kaart eindigend op ".concat(cardLastFour, ". Herken je deze transactie?\n\n").concat(amount, " voor ").concat(merchant, " - ").concat(date);
            },
        },
    },
    workflowsPage: {
    ...
    validateCodeForm: {
        ...
        requestNewCode: function (_a) {
            ...
            return "Vraag een nieuwe code aan over <a>".concat(timeRemaining, "</a>");
        },
        ...
        tasks: {
            ...
            addExpenseApprovalsTask: {
                ...
                description: function (_a) {
                    ...
                    return "*Voeg uitgaven goedkeuringen toe* om de uitgaven van je team te controleren en onder controle te houden.\n" +
                        '\n' +
                        "Zo doe je dat:\n" +
                        '\n' +
                        ...
                        '\n' +
                        "[Ga naar meer functies](".concat(workspaceMoreFeaturesLink, ").");
                },
            },
            ...
            splitExpenseTask: {
                ...
                description: '*Uitgaven splitsen* met één of meer personen.' +
                    '\n' +
                    "1. Klik op de +-knop.\n" +
                    '2. Kies *Start chat*.\n' +
            ...
            reviewWorkspaceSettingsTask: {
                ...
                description: function (_a) {
                    ...
                    return 'Zo bekijkt en werkt u uw werkruimte-instellingen bij:\n' +
                        ...
                        "[Ga naar uw werkruimte.](".concat(workspaceSettingsLink, ")");
                },
            },
            createReportTask: {
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: function (_a) {
            var login = _a.login;
            return "<strong>Bevestig dat ".concat(login, " correct gespeld is en een echt, bezorgbaar e-mailadres is.</strong> E-mailaliassen zoals \"expenses@domain.com\" moeten toegang hebben tot hun eigen e-mailinbox om een geldige Expensify-login te zijn.");
        },
        ensureYourEmailClient: "<strong>Zorg ervoor dat uw e-mailclient e-mails van expensify.com toestaat.</strong> Je kunt hier <a href=\"".concat(CONST_1.default.SET_NOTIFICATION_LINK, "\"></a> vinden hoe je deze stap uitvoert, maar het kan zijn dat je IT-afdeling je moet helpen bij het configureren van je e-mailinstellingen."),
        onceTheAbove: "Als de bovenstaande stappen zijn voltooid, neem dan contact op met <a href=\"mailto:".concat(CONST_1.default.EMAIL.CONCIERGE, "\">").concat(CONST_1.default.EMAIL.CONCIERGE, "</a> om uw aanmelding te deblokkeren."),
    },
    ...
    focusModeUpdateModal: {
        ...
        prompt: function (_a) {
            ...
            return "Blijf op de hoogte door alleen ongelezen chats of chats die uw aandacht nodig hebben te bekijken. Maak je geen zorgen, je kunt dit op elk moment wijzigen in <a href=\"".concat(priorityModePageUrl, "\">instellingen</a>.");
        },
    },
    notFound: {
    ...
    additionalDetailsStep: {
        ...
        failedKYCMessage: function (_a) {
            ...
            return "We konden uw identiteit niet verifi\u00EBren. Probeer het later opnieuw of neem contact op met <a href=\"mailto:".concat(conciergeEmail, "\">").concat(conciergeEmail, "</a> als je vragen hebt.");
        },
    },
    termsStep: {
        ...
        haveReadAndAgree: "Ik heb de <a href=\"".concat(CONST_1.default.ELECTRONIC_DISCLOSURES_URL, "\">elektronische openbaarmakingen</a> gelezen en ga ermee akkoord deze te ontvangen."),
        ...
        agreeToThe: function (_a) {
            ...
            return "Ik ga akkoord met de <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacy</a> en <a href=\"").concat(walletAgreementUrl, "\">Portemonnee overeenkomst</a>.");
        },
        ...
        shortTermsForm: {
            ...
            generalInfo: "Ga voor algemene informatie over prepaidrekeningen naar <a href=\"".concat(CONST_1.default.CFPB_PREPAID_URL, "\">").concat(CONST_1.default.TERMS.CFPB_PREPAID, "</a>."),
            conditionsDetails: "Ga voor meer informatie en voorwaarden voor alle kosten en services naar <a href=\"".concat(CONST_1.default.FEES_URL, "\">").concat(CONST_1.default.FEES_URL, "</a> of bel +1 833-400-0904."),
        ...
        longTermsForm: {
            ...
            electronicFundsStandardDetails: 'Er zijn geen kosten verbonden aan het overmaken van geld van je Expensify Wallet naar je bankrekening via de standaard optie. Deze overschrijving is meestal binnen 1-3 werkdagen voltooid.',
            electronicFundsInstantDetails: function (_a) {
                var percentage = _a.percentage, amount = _a.amount;
                return 'Er zijn kosten verbonden aan het overmaken van geld van je Expensify Wallet naar je gekoppelde debetkaart met de optie voor directe overboeking.' +
                    "Deze overdracht is meestal binnen enkele minuten voltooid. De kosten zijn ".concat(percentage, "% an het transferbedrag (met een minimum van ").concat(amount, ").");
            },
            fdicInsuranceBancorp: function (_a) {
                var amount = _a.amount;
                return "Uw tegoeden komen in aanmerking voor FDIC-verzekering. Uw tegoeden worden bewaard bij of overgedragen aan ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", een FDIC-gegarandeerde instelling.") +
                    " Daar is uw geld tot ".concat(amount, " verzekerd door de FDIC in het geval ").concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, " failliet gaat, als aan de specifieke vereisten voor depositoverzekering wordt voldaan en uw kaart is geregistreerd.") +
                    " Zie ".concat(CONST_1.default.TERMS.FDIC_PREPAID, " voor meer informatie.");
            },
            contactExpensifyPayments: "Neem contact op met ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " door te bellen naar +1 833-400-0904, per e-mail naar ").concat(CONST_1.default.EMAIL.CONCIERGE, " of meld je aan op ").concat(CONST_1.default.NEW_EXPENSIFY_URL, "."),
            generalInformation: "Ga voor algemene informatie over prepaidrekeningen naar ".concat(CONST_1.default.TERMS.CFPB_PREPAID, ". Als u een klacht hebt over een prepaidrekening, bel dan het Consumer Financial Protection Bureau op 1-855-411-2372 of ga naar ").concat(CONST_1.default.TERMS.CFPB_COMPLAINT, "."),
    ...
    signerInfoStep: {
        ...
        areYouDirector: function (_a) {
            var companyName = _a.companyName;
            return "Bent u een directeur bij ".concat(companyName, "?");
        },
        ...
        enterOneEmail: function (_a) {
            var companyName = _a.companyName;
            return "Voer het e-mailadres in van de directeur bij ".concat(companyName);
        },
        ...
        enterTwoEmails: function (_a) {
            var companyName = _a.companyName;
            return "Voer de e-mailadressen in van twee directeuren bij ".concat(companyName);
        },
        ...
        isConnecting: function (_a) {
            ...
            return "verbindt een zakelijke bankrekening in ".concat(currency, " eindigend op ").concat(bankAccountLastFour, " met Expensify om werknemers in ").concat(currency, " te betalen. De volgende stap vereist ondertekenaarinformatie van een directeur.");
        },
        error: {
    ...
    travel: {
        ...
        verifyCompany: {
            ...
            conciergeMessage: function (_a) {
                var domain = _a.domain;
                return "Reismogelijkheid mislukt voor domein: ".concat(domain, ". Controleer en schakel reizen in voor dit domein.");
            },
        },
        updates: {
    ...
    workspace: {
        ...
        receiptPartners: {
            ...
            uber: {
                subtitle: function (_a) {
                    ...
                    return organizationName ? "Verbonden met ".concat(organizationName) : 'Automatiseer reis- en maaltijdbezorgingskosten binnen uw organisatie.';
                },
        ...
        perDiem: {
            subtitle: "<muted-text>Stel dagvergoedingen in om de dagelijkse uitgaven van werknemers te beheersen. <a href=\"".concat(CONST_1.default.DEEP_DIVE_PER_DIEM, "\">Meer informatie</a>.</muted-text>"),
            amount: 'Bedrag',
        ...
        qbd: {
            ...
            accountingMethods: {
                ...
                values: (_h = {},
                    ...
                    _h[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contant',
                    _h),
                alternateText: (_j = {},
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze definitief zijn goedgekeurd.',
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze zijn betaald.',
                    _j),
            },
        },
        qbo: {
            ...
            accounts: (_l = {},
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = 'Debetkaart',
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Creditcard',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Leveranciersfactuur',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Journaalboeking',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Controleren',
                ...
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "We zullen automatisch de naam van de handelaar op de creditcardtransactie koppelen aan eventuele overeenkomstige leveranciers in QuickBooks. Als er geen leveranciers bestaan, maken we een 'Credit Card Misc.' leverancier voor associatie aan.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'We maken een gespecificeerde leveranciersfactuur voor elk Expensify-rapport met de datum van de laatste uitgave en voegen deze toe aan het onderstaande account. Als deze periode is afgesloten, boeken we naar de 1e van de volgende open periode.',
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Kies waar u debetkaarttransacties wilt exporteren.',
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Kies waar u creditcardtransacties wilt exporteren.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Kies een leverancier om toe te passen op alle creditcardtransacties.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Leveranciersfacturen zijn niet beschikbaar wanneer locaties zijn ingeschakeld. Kies alstublieft een andere exportoptie.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Cheques zijn niet beschikbaar wanneer locaties zijn ingeschakeld. Kies een andere exportoptie.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'Journaalposten zijn niet beschikbaar wanneer belastingen zijn ingeschakeld. Kies een andere exportoptie.',
                _l),
            exportDestinationAccountsMisconfigurationError: (_m = {},
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Kies een geldig account voor de export van leveranciersfacturen',
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Kies een geldig account voor journaalpostexport',
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Kies een geldig account voor het exporteren van cheques',
                _m),
            exportDestinationSetupAccountsInfo: (_o = {},
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Om de export van leveranciersfacturen te gebruiken, stel een crediteurenrekening in QuickBooks Online in.',
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Om journal entry export te gebruiken, stel een journaalrekening in QuickBooks Online in.',
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Om cheque-export te gebruiken, stel een bankrekening in QuickBooks Online in.',
                _o),
            noAccountsFound: 'Geen accounts gevonden',
            ...
            accountingMethods: {
                ...
                values: (_p = {},
                    ...
                    _p[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contant',
                    _p),
                alternateText: (_q = {},
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze definitief zijn goedgekeurd.',
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze zijn betaald.',
                    _q),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_r = {},
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Xero contact standaardinstelling',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = 'Tags',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = 'Rapportvelden',
                _r),
            ...
            invoiceStatus: {
                ...
                values: (_t = {},
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = 'Conceptversie',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = 'In afwachting van goedkeuring',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = 'In afwachting van betaling',
                    _t),
            },
            noAccountsFound: 'Geen accounts gevonden',
            ...
            accountingMethods: {
                ...
                values: (_u = {},
                    ...
                    _u[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contant',
                    _u),
                alternateText: (_v = {},
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze definitief zijn goedgekeurd.',
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze zijn betaald.',
                    _v),
            },
        },
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_x = {},
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = 'Onkostendeclaraties',
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Leveranciersfacturen',
                    _x),
            },
            nonReimbursableExpenses: {
                description: 'Stel in hoe aankopen met bedrijfskaarten worden geëxporteerd naar Sage Intacct.',
                values: (_y = {},
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = 'Kredietkaarten',
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Leveranciersfacturen',
                    _y),
            },
            creditCardAccount: 'Creditcardrekening',
            ...
            accountingMethods: {
                ...
                values: (_z = {},
                    ...
                    _z[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contant',
                    _z),
                alternateText: (_0 = {},
                    _0[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze definitief zijn goedgekeurd.',
                    _0[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze zijn betaald.',
                    _0),
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: (_1 = {},
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = 'Enkele, gespecificeerde invoer voor elk rapport',
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = 'Enkele invoer voor elke uitgave',
                    _1),
            },
            invoiceItem: {
                label: 'Factuuritem',
            ...
            exportDestination: {
                values: (_4 = {},
                    ...
                    _4),
                expenseReportDestinationConfirmDescription: 'Als je de exportinstelling voor bedrijfskaarten wijzigt naar onkostenrapporten, worden NetSuite-leveranciers en boekingsaccounts voor individuele kaarten uitgeschakeld.\n\nGeen zorgen, we bewaren je vorige selecties nog steeds voor het geval je later terug wilt schakelen.',
            },
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_5 = {},
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'NetSuite standaardvoorkeur',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = 'Alleen door supervisor goedgekeurd',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = 'Alleen boekhouding goedgekeurd',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = 'Supervisor en boekhouding goedgekeurd',
                        _5),
                },
                accountingMethods: {
                    label: 'Wanneer exporteren',
                    ...
                    values: (_6 = {},
                        ...
                        _6[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contant',
                        _6),
                    alternateText: (_7 = {},
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze definitief zijn goedgekeurd.',
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze zijn betaald.',
                        _7),
                },
                exportVendorBillsTo: {
                    ...
                    values: (_8 = {},
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'NetSuite standaardvoorkeur',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = 'In afwachting van goedkeuring',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = 'Goedgekeurd voor plaatsing',
                        _8),
                },
                exportJournalsTo: {
                    ...
                    values: (_9 = {},
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'NetSuite standaardvoorkeur',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = 'In afwachting van goedkeuring',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = 'Goedgekeurd voor plaatsing',
                        _9),
                },
                error: {
        ...
        intacct: {
            ...
            toggleImportTitle: function (_a) {
                ...
                return "Kies hoe Sage Intacct <strong>".concat(mappingTitle, "</strong> in Expensify te beheren.");
            },
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                learnMoreAboutOptions: "<muted-text>Meer informatie over deze <a href=\"".concat(CONST_1.default.COMPANY_CARDS_CONNECT_CREDIT_CARDS_HELP_URL, "\">opties</a>.</muted-text>"),
            ...
            statementCloseDate: (_11 = {},
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Laatste dag van de maand',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Laatste werkdag van de maand',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Aangepaste dag van de maand',
                _11),
            ...
            chooseCardFor: function (_a) {
                ...
                return "Kies een kaart voor <strong>".concat(assignee, "</strong>. Kun je de kaart die je zoekt niet vinden? <concierge-link>Laat het ons weten.</concierge-link>");
            },
        ...
        expensifyCard: {
            ...
            cardPending: function (_a) {
                var name = _a.name;
                return "De kaart is momenteel in behandeling en wordt uitgegeven zodra het account van ".concat(name, " is gevalideerd.");
            },
            virtual: 'Virtueel',
            physical: 'Fysiek',
            ...
            issuedCardNoShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "heeft ".concat(assignee, " een Expensify Card uitgegeven! De kaart wordt verzonden zodra de verzendgegevens zijn bevestigd.");
            },
            ...
            addedShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "".concat(assignee, " heeft verzendgegevens toegevoegd. Expensify Card wordt binnen 2-3 werkdagen bezorgd.");
            },
        ...
        people: {
            ...
            removeMemberPromptApprover: function (_a) {
                ...
                return "Als je ".concat(approver, " uit deze werkruimte verwijdert, vervangen we deze persoon in de goedkeuringsworkflow door ").concat(workspaceOwner, ", de eigenaar van de werkruimte.");
            },
            removeMemberPromptPendingApproval: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " heeft openstaande onkostendeclaraties die moeten worden goedgekeurd. Vraag hen deze goed te keuren, of neem hun declaraties over voordat je hen uit de werkruimte verwijdert.");
            },
            removeMemberPromptReimburser: function (_a) {
                var memberName = _a.memberName;
                return "Je kunt ".concat(memberName, " niet uit deze werkruimte verwijderen. Stel een nieuwe uitbetaler in via Werkstromen > Betalingen uitvoeren of bijhouden en probeer het daarna opnieuw.");
            },
            removeMemberPromptExporter: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Als je ".concat(memberName, " uit deze werkruimte verwijdert, vervangen we hem/haar als voorkeursexporteur door ").concat(workspaceOwner, ", de eigenaar van de werkruimte.");
            },
            removeMemberPromptTechContact: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Als je ".concat(memberName, " uit deze werkruimte verwijdert, vervangen we hen als technisch contactpersoon door ").concat(workspaceOwner, ", de eigenaar van de werkruimte.");
            },
            cannotRemoveUserDueToReport: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " heeft een openstaand rapport in behandeling waarvoor actie nodig is. Vraag hen om de vereiste actie te voltooien voordat je hen uit de werkruimte verwijdert.");
            },
        },
        card: {
            getStartedIssuing: 'Begin met het aanvragen van je eerste virtuele of fysieke kaart.',
        ...
        accounting: {
            ...
            errorODIntegration: function (_a) {
                ...
                return "Er is een fout opgetreden met een verbinding die is ingesteld in Expensify Classic. [Ga naar Expensify Classic om dit probleem op te lossen.](".concat(oldDotPolicyConnectionsURL, ")");
            },
            ...
            importTypes: (_12 = {},
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = 'Geïmporteerd',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Geïmporteerd als tags',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Geïmporteerd',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'Niet geïmporteerd',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'Niet geïmporteerd',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Geïmporteerd als rapportvelden',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'NetSuite medewerker standaardwaarde',
                _12),
            ...
            chooseReconciliationAccount: {
                ...
                settlementAccountReconciliation: function (_a) {
                    ...
                    return "Zorg ervoor dat dit account overeenkomt met uw <a href=\"".concat(settlementAccountUrl, "\">Expensify Card afwikkelingsrekening</a> (eindigend op ").concat(lastFourPAN, ") zodat Continue Reconciliation goed werkt.");
                },
            },
        },
        export: {
        ...
        distanceRates: {
            ...
            status: 'Status',
            unit: 'Eenheid',
            taxFeatureNotEnabledMessage: '<muted-text>Belastingen moeten zijn ingeschakeld in de werkruimte om deze functie te gebruiken. Ga naar <a href="#">Meer functies</a> om die wijziging door te voeren.</muted-text>',
        ...
        bankAccount: {
            ...
            disconnectYourBankAccount: function (_a) {
                var bankName = _a.bankName;
                return "Koppel uw <strong>".concat(bankName, "</strong> bankrekening los. Eventuele openstaande transacties voor deze rekening zullen nog steeds worden voltooid.");
            },
        ...
        upgrade: (_13 = {
                reportFields: {
                    ...
                    onlyAvailableOnPlan: function (_a) {
                        ...
                        return "<muted-text>Rapportvelden zijn alleen beschikbaar op het Control-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                    },
                }
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.NETSUITE] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Onze NetSuite-integratie is alleen beschikbaar op het Control-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.SAGE_INTACCT] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Onze Sage Intacct-integratie is alleen beschikbaar op het Control-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.QBD] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Onze QuickBooks Desktop-integratie is alleen beschikbaar op het Control-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Geavanceerde goedkeuringen zijn alleen beschikbaar op het Control-plan, dat begint bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.categories = {
                title: 'Categorieën',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Categorie\u00EBn zijn beschikbaar op het Collect-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.glCodes = {
                title: 'GL-codes',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>GL-codes zijn alleen beschikbaar in het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.glAndPayrollCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>GL- en Payroll-codes zijn alleen beschikbaar op het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.taxCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Belastingcodes zijn alleen beschikbaar in het Control-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.companyCards = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Dit is alleen beschikbaar op het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.rules = {
                title: 'Regels',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Regels zijn alleen beschikbaar in het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.perDiem = {
                title: 'Per diem',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Dagvergoedingen zijn alleen beschikbaar in het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.travel = {
                title: 'Reis',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Reizen is beschikbaar op het Collect-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.reports = {
                title: 'Rapporten',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Rapporten zijn beschikbaar op het Collect-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.multiLevelTags = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Multi-level tags zijn alleen beschikbaar op het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.distanceRates = {
                title: 'Afstandstarieven',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Afstandstarieven zijn beschikbaar op het Collect-abonnement, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.auditor = {
                title: 'Auditor',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Auditors zijn alleen beschikbaar in het Control-plan, beginnend bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Meerdere goedkeuringsniveaus zijn alleen beschikbaar op het Control-plan, vanaf <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", "</muted-text>");
                },
            },
            _13.pricing = {
            ...
            _13.note = function (_a) {
                ...
                return "<muted-text>Upgrade om toegang te krijgen tot deze functie, of <a href=\"".concat(subscriptionLink, "\">lees meer</a> over onze abonnementen en prijzen.</muted-text>");
            },
            _13.upgradeToUnlock = 'Ontgrendel deze functie',
            _13.completed = {
            ...
            _13.commonFeatures = {
                ...
                benefits: {
                    startsAtFull: function (_a) {
                        ...
                        return "<muted-text>Het Control-abonnement begint bij <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "per lid per maand." : "per actief lid per maand.", " <a href=\"").concat(learnMoreMethodsRoute, "\">Meer informatie</a> over onze plannen en prijzen.</muted-text>");
                    },
        ...
        rules: {
            individualExpenseRules: {
                ...
                eReceipts: 'eReceipts',
                eReceiptsHint: "eRecepten worden automatisch aangemaakt [voor de meeste USD-krediettransacties](".concat(CONST_1.default.DEEP_DIVE_ERECEIPTS, ")."),
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_14 = {},
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = 'Nooit',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'Laatste maand',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.THIS_MONTH] = 'Deze maand',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_STATEMENT] = 'Laatste verklaring',
                    _14),
            },
            status: 'Status',
            keyword: 'Trefwoord',
            ...
            amount: {
                ...
                equalTo: function (_a) {
                    var _b = _a === void 0 ? {} : _a, amount = _b.amount;
                    return "Gelijk aan ".concat(amount !== null && amount !== void 0 ? amount : '');
                },
            },
            card: {
                expensify: 'Expensify',
            ...
            groupBy: (_15 = {},
                _15[CONST_1.default.SEARCH.GROUP_BY.FROM] = 'Van',
                _15[CONST_1.default.SEARCH.GROUP_BY.CARD] = 'Kaart',
                _15[CONST_1.default.SEARCH.GROUP_BY.WITHDRAWAL_ID] = 'Opname-ID',
                _15),
            feed: 'Feed',
            withdrawalType: (_16 = {},
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.EXPENSIFY_CARD] = 'Expensify Card',
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.REIMBURSEMENT] = 'Terugbetaling',
                _16),
            is: 'Is',
            action: (_17 = {},
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.SUBMIT] = 'Indienen',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.APPROVE] = 'Goedkeuren',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.PAY] = 'Betalen',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.EXPORT] = 'Exporteren',
                _17),
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationPrompt: function (_a) {
                var workspaceName = _a.workspaceName;
                return "Weet je zeker dat je nog een rapport wilt maken in ".concat(workspaceName, "? Je kunt je lege rapporten vinden onder");
            },
        ...
        actions: {
            type: {
                changeField: function (_a) {
                    ...
                    return "heeft ".concat(fieldName, " gewijzigd naar \"").concat(newValue, "\" (voorheen \"").concat(oldValue, "\")");
                },
                changeFieldEmpty: function (_a) {
                    var newValue = _a.newValue, fieldName = _a.fieldName;
                    return "heeft ".concat(fieldName, " ingesteld op \"").concat(newValue, "\"");
                },
    ...
    referralProgram: (_18 = {},
        ...
        _18.copyReferralLink = 'Kopieer uitnodigingslink',
        _18),
    systemChatFooterMessage: (_19 = {},
        _19[CONST_1.default.INTRO_CHOICES.MANAGE_TEAM] = function (_a) {
            ...
            return "Chat met uw setup specialist in <a href=\"".concat(href, "\">").concat(adminReportName, "</a> voor hulp");
        },
        _19.default = "Bericht <concierge-link>".concat(CONST_1.default.CONCIERGE_CHAT_NAME, "</concierge-link> voor hulp bij de installatie"),
        _19),
    violations: {
        ...
        rter: function (_a) {
            ...
            if (brokenBankConnection || rterType === CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? "Bankverbinding verbroken. <a href=\"".concat(companyCardPageURL, "\">Opnieuw verbinden om bon te koppelen</a>")
        ...
        adminBrokenConnectionError: function (_a) {
            ...
            return "<muted-text-label>Bon in afwachting vanwege een verbroken bankverbinding. Los dit op in <a href=\"".concat(workspaceCompanyCardRoute, "\">Bedrijfspassen</a>.</muted-text-label>");
        },
    ...
    exitSurvey: {
        ...
        reasons: (_21 = {},
            _21[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Ik heb een functie nodig die alleen beschikbaar is in Expensify Classic.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Ik begrijp niet hoe ik New Expensify moet gebruiken.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Ik begrijp hoe ik New Expensify moet gebruiken, maar ik geef de voorkeur aan Expensify Classic.',
            _21),
        prompts: (_22 = {},
            _22[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Welke functie heeft u nodig die niet beschikbaar is in New Expensify?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Wat probeer je te doen?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Waarom geef je de voorkeur aan Expensify Classic?',
            _22),
        ...
        benefits: (_23 = {},
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Direct chatten over onkosten en rapporten',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Mogelijkheid om alles op mobiel te doen',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Reizen en uitgaven met de snelheid van chatten',
            _23),
    ...
    scheduledCall: {
        book: {
            ...
            slots: function (_a) {
                var date = _a.date;
                return "<muted-text>Beschikbare tijden voor <strong>".concat(date, "</strong></muted-text>");
            },
        },
        confirmation: {
        ...
        message: (_24 = {},
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_ADD_TRANSACTIONS] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten op <strong>".concat(actor, "</strong> om uitgaven toe te voegen.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return "Wachten tot een beheerder uitgaven toevoegt.";
                }
            },
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION] = function (_) { return "Geen verdere actie vereist!"; },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_SUBMITTER_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten tot <strong>".concat(actor, "</strong> een bankrekening toevoegt.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_AUTOMATIC_SUBMIT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "op ".concat(eta) : " ".concat(eta);
                }
                // eslint-disable-next-line default-case
                switch (actorType) {
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return "Wachten tot <strong>je</strong> uitgaven automatisch worden ingediend".concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten tot de uitgaven van <strong>".concat(actor, "'s</strong> automatisch worden ingediend").concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return "Wachten tot de uitgaven van een beheerder automatisch worden ingediend".concat(formattedETA, ".");
                }
            },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_FIX_ISSUES] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten tot <strong>".concat(actor, "</strong> het probleem of de problemen oplost.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten tot <strong>".concat(actor, "</strong> onkosten goedkeurt.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten tot <strong>".concat(actor, "</strong> de onkosten betaalt.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_POLICY_BANK_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Wachten tot <strong>".concat(actor, "</strong> klaar is met het instellen van een zakelijke bankrekening.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_PAYMENT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "v\u00F3\u00F3r ".concat(eta) : " ".concat(eta);
                }
                return "Wachten tot de betaling is voltooid".concat(formattedETA, ".");
            },
            _24),
        eta: (_25 = {},
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SHORTLY] = 'binnenkort',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.TODAY] = 'later vandaag',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_WEEK] = 'op zondag',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SEMI_MONTHLY] = 'op de 1e en 16e van elke maand',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_BUSINESS_DAY_OF_MONTH] = 'op de laatste werkdag van de maand',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_DAY_OF_MONTH] = 'op de laatste dag van de maand',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_TRIP] = 'aan het einde van je reis',
            _25),
    },
    domain: {
        ...
        verifyDomain: {
            ...
            beforeProceeding: function (_a) {
                ...
                return "Controleer voordat je verdergaat of je eigenaar bent van <strong>".concat(domainName, "</strong> door de DNS-instellingen bij te werken.");
            },
            accessYourDNS: function (_a) {
                var domainName = _a.domainName;
                return "Ga naar je DNS-provider en open de DNS-instellingen voor <strong>".concat(domainName, "</strong>.");
            },
            addTXTRecord: 'Voeg het volgende TXT-record toe:',
            saveChanges: 'Sla wijzigingen op en kom hier terug om je domein te verifiëren.',
            youMayNeedToConsult: "Misschien moet je contact opnemen met de IT-afdeling van je organisatie om de verificatie te voltooien. <a href=\"".concat(CONST_1.default.DOMAIN_VERIFICATION_HELP_URL, "\">Meer informatie</a>."),
        ...
        domainVerified: {
            ...
            description: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><centered-text>Het domein <strong>".concat(domainName, "</strong> is succesvol geverifieerd en je kunt nu SAML en andere beveiligingsfuncties instellen.</centered-text></muted-text>");
            },
        },
        saml: 'SAML',
        samlFeatureList: {
            ...
            subtitle: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><a href=\"".concat(CONST_1.default.SAML_HELP_URL, "\">SAML SSO</a> is een beveiligingsfunctie die je meer controle geeft over hoe leden met e-mailadressen van <strong>").concat(domainName, "</strong> inloggen bij Expensify. Om dit in te schakelen, moet je bevestigen dat je een geautoriseerde bedrijfsbeheerder bent.</muted-text>");
            },
