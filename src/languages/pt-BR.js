...
var translations = {
    common: {
        ...
        view: 'Visualizar',
        review: function (reviewParams) { return "Revis\u00E3o".concat((reviewParams === null || reviewParams === void 0 ? void 0 : reviewParams.amount) ? " ".concat(reviewParams === null || reviewParams === void 0 ? void 0 : reviewParams.amount) : ''); },
        not: 'Não',
        signIn: 'Entrar',
        ...
        acceptTermsAndPrivacy: "Eu aceito o <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termos de Servi\u00E7o da Expensify</a> e <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Pol\u00EDtica de Privacidade</a>"),
        acceptTermsAndConditions: "Eu aceito o <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.ACH_TERMS_URL, "\">termos e condi\u00E7\u00F5es</a>"),
        acceptTermsOfService: "Eu aceito o <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termos de Servi\u00E7o da Expensify</a>"),
        remove: 'Remover',
        admin: 'Administração',
        owner: 'Proprietário',
        ...
        noResultsFoundMatching: function (searchString) { return "Nenhum resultado encontrado correspondente a \"".concat(searchString, "\""); },
        ...
        leaveWorkspaceConfirmationApprover: function (_a) {
            ...
            return "Se voc\u00EA sair deste espa\u00E7o de trabalho, voc\u00EA ser\u00E1 substitu\u00EDdo(a) no fluxo de aprova\u00E7\u00E3o pelo ".concat(workspaceOwner, ", o propriet\u00E1rio do espa\u00E7o de trabalho.");
        },
        leaveWorkspaceConfirmationExporter: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Se voc\u00EA sair deste espa\u00E7o de trabalho, ser\u00E1 substitu\u00EDdo como exportador preferencial por ".concat(workspaceOwner, ", o propriet\u00E1rio do espa\u00E7o de trabalho.");
        },
        leaveWorkspaceConfirmationTechContact: function (_a) {
            var workspaceOwner = _a.workspaceOwner;
            return "Se voc\u00EA sair deste espa\u00E7o de trabalho, ser\u00E1 substitu\u00EDdo como contato t\u00E9cnico por ".concat(workspaceOwner, ", o propriet\u00E1rio do espa\u00E7o de trabalho.");
        },
        leaveWorkspaceReimburser: 'Você não pode sair deste espaço de trabalho como responsável pelo reembolso. Defina um novo responsável pelo reembolso em Espaços de trabalho > Fazer ou acompanhar pagamentos e tente novamente.',
    ...
    supportalNoAccess: {
        ...
        descriptionWithCommand: function (_a) {
            ...
            return "Voc\u00EA n\u00E3o est\u00E1 autorizado a realizar esta a\u00E7\u00E3o quando o suporte est\u00E1 conectado (comando: ".concat(command !== null && command !== void 0 ? command : '', "). Se voc\u00EA acha que o Success deveria poder realizar esta a\u00E7\u00E3o, por favor, inicie uma conversa no Slack.");
        },
    },
    lockedAccount: {
    ...
    reportActionContextMenu: {
        ...
        deleteConfirmation: function (_a) {
            ...
            return "Tem certeza de que deseja excluir este ".concat(type, "?");
        },
    ...
    reportActionsView: {
        beginningOfArchivedRoom: function (_a) {
            ...
            return "Voc\u00EA perdeu a festa no <strong><a class=\"no-style-link\" href=\"".concat(reportDetailsLink, "\">").concat(reportName, "</a></strong>, n\u00E3o h\u00E1 nada para ver aqui.");
        },
        beginningOfChatHistoryDomainRoom: function (_a) {
            var domainRoom = _a.domainRoom;
            return "Este bate-papo \u00E9 com todos os membros da Expensify no dom\u00EDnio <strong>".concat(domainRoom, "</strong>. Use-o para conversar com colegas, compartilhar dicas e fazer perguntas.");
        },
        beginningOfChatHistoryAdminRoom: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Este bate-papo \u00E9 com o administrador do <strong>".concat(workspaceName, "</strong>. Use-o para conversar sobre a configura\u00E7\u00E3o do espa\u00E7o de trabalho e muito mais.");
        },
        beginningOfChatHistoryAnnounceRoom: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Este bate-papo \u00E9 com todos na <strong>".concat(workspaceName, "</strong>. Use-o para os an\u00FAncios mais importantes.");
        },
        beginningOfChatHistoryUserRoom: function (_a) {
            var reportName = _a.reportName, reportDetailsLink = _a.reportDetailsLink;
            return "Esta sala de bate-papo \u00E9 para qualquer coisa relacionada ao <strong><a class=\"no-style-link\" href=\"".concat(reportDetailsLink, "\">").concat(reportName, "</a></strong>.");
        },
        beginningOfChatHistoryInvoiceRoom: function (_a) {
            var invoicePayer = _a.invoicePayer, invoiceReceiver = _a.invoiceReceiver;
            return "Este bate-papo \u00E9 para faturas entre <strong>".concat(invoicePayer, "</strong> e a <strong>").concat(invoiceReceiver, "</strong>. Use o bot\u00E3o + para enviar uma fatura.");
        },
        ...
        beginningOfChatHistoryPolicyExpenseChat: function (_a) {
            ...
            return "\u00C9 aqui que <strong>".concat(submitterDisplayName, "</strong> enviar\u00E1 as despesas para a <strong>").concat(workspaceName, "</strong>. Basta usar o bot\u00E3o +.");
        },
    ...
    spreadsheet: {
        ...
        dragAndDropMultiLevelTag: "<muted-link>Arraste e solte sua planilha aqui ou escolha um arquivo abaixo. <a href=\"".concat(CONST_1.default.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK, "\">Saiba mais</a> sobre os formatos de arquivo suportados.</muted-link>"),
        ...
        chooseSpreadsheetMultiLevelTag: "<muted-link>Selecione um arquivo de planilha para importar. <a href=\"".concat(CONST_1.default.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK, "\">Saiba mais</a> sobre os formatos de arquivo suportados.</muted-link>"),
        ...
        importMemberConfirmation: function () { return ({
            ...
            other: function (count) {
                return "Confirme os detalhes abaixo para os ".concat(count, " novos membros do workspace que ser\u00E3o adicionados como parte deste envio. Os membros existentes n\u00E3o receber\u00E3o atualiza\u00E7\u00F5es de fun\u00E7\u00E3o nem mensagens de convite.");
            },
        }); },
    },
    receipt: {
        ...
        alternativeMethodsDownloadApp: function (_a) {
            ...
            return "<label-text><a href=\"".concat(downloadUrl, "\">Baixe o app</a> para escanear pelo celular</label-text>");
        },
        alternativeMethodsForwardReceipts: function (_a) {
            var email = _a.email;
            return "<label-text>Encaminhe recibos para <a href=\"mailto:".concat(email, "\">").concat(email, "</a></label-text>");
        },
        alternativeMethodsAddPhoneNumber: function (_a) {
            var phoneNumber = _a.phoneNumber, contactMethodsUrl = _a.contactMethodsUrl;
            return "<label-text><a href=\"".concat(contactMethodsUrl, "\">Adicione seu n\u00FAmero</a> para enviar recibos por SMS para ").concat(phoneNumber, "</label-text>");
        },
        alternativeMethodsTextReceipts: function (_a) {
            var phoneNumber = _a.phoneNumber;
            return "<label-text>Envie recibos por SMS para ".concat(phoneNumber, " (apenas n\u00FAmeros dos EUA)</label-text>");
        },
        takePhoto: 'Tire uma foto',
        cameraAccess: 'O acesso à câmera é necessário para tirar fotos dos recibos.',
        deniedCameraAccess: "O acesso \u00E0 c\u00E2mera ainda n\u00E3o foi concedido, por favor siga <a href=\"".concat(CONST_1.default.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL, "\">essas instru\u00E7\u00F5es</a>."),
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "excluiu uma despesa (".concat(amount, " para ").concat(merchant, ")");
        },
        ...
        unreportedTransaction: function (_a) {
            ...
            return "movei esta despesa para o seu <a href=\"".concat(reportUrl, "\">espa\u00E7o pessoal</a>");
        },
        movedAction: function (_a) {
            ...
            if (shouldHideMovedReportUrl) {
                return "moveu este relat\u00F3rio para o workspace <a href=\"".concat(newParentReportUrl, "\">").concat(toPolicyName, "</a>");
            }
            return "moveu este <a href=\"".concat(movedReportUrl, "\">relat\u00F3rio</a> para o workspace <a href=\"").concat(newParentReportUrl, "\">").concat(toPolicyName, "</a>");
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pagar ".concat(formattedAmount, " como indiv\u00EDduo") : "Pagar com conta pessoal");
        },
        settleWallet: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pagar ".concat(formattedAmount, " com carteira") : "Pagar com carteira");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pagar ".concat(formattedAmount, " como empresa") : "Pagar com conta empresarial");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Marcar ".concat(formattedAmount, " como pago") : "Marcar como pago");
        },
        settleInvoicePersonal: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return (amount ? "Pago ".concat(amount, " com conta pessoal ").concat(last4Digits) : "Pago com conta pessoal");
        },
        settleInvoiceBusiness: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return (amount ? "Pago ".concat(amount, " com conta empresarial ").concat(last4Digits) : "Pago com conta empresarial");
        },
        payWithPolicy: function (_a) {
            var formattedAmount = _a.formattedAmount, policyName = _a.policyName;
            return (formattedAmount ? "Pagar ".concat(formattedAmount, " via ").concat(policyName) : "Pagar via ".concat(policyName));
        },
        businessBankAccount: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return (amount ? "pago ".concat(amount, " com conta banc\u00E1ria ").concat(last4Digits) : "pago com conta banc\u00E1ria ".concat(last4Digits));
        },
        automaticallyPaidWithBusinessBankAccount: function (_a) {
            var amount = _a.amount, last4Digits = _a.last4Digits;
            return "pago ".concat(amount ? "".concat(amount, " ") : '', "com a conta banc\u00E1ria terminada em ").concat(last4Digits, " via <a href=\"").concat(CONST_1.default.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL, "\">regras do espa\u00E7o de trabalho</a>");
        },
        invoicePersonalBank: function (_a) {
            var lastFour = _a.lastFour;
            return "Conta pessoal \u2022 ".concat(lastFour);
        },
        invoiceBusinessBank: function (_a) {
            var lastFour = _a.lastFour;
            return "Conta empresarial \u2022 ".concat(lastFour);
        },
        ...
        submitted: function (_a) {
            var memo = _a.memo;
            return "enviado".concat(memo ? ", dizendo ".concat(memo) : '');
        },
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "iniciou o pagamento, mas est\u00E1 aguardando ".concat(submitterDisplayName, " adicionar uma conta banc\u00E1ria.");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', "marcado como pago");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "pago com carteira");
        },
        ...
        changeApprover: {
            ...
            description: function (_a) {
                ...
                return "Voc\u00EA tamb\u00E9m pode alterar o aprovador permanentemente para todos os relat\u00F3rios em suas <a href=\"".concat(workflowSettingLink, "\">configura\u00E7\u00F5es de fluxo de trabalho</a>.");
            },
            changedApproverMessage: function (_a) {
                var managerID = _a.managerID;
                return "alterou o aprovador para <mention-user accountID=\"".concat(managerID, "\"/>");
            },
            actions: {
    ...
    transactionMerge: {
        listPage: {
            ...
            noEligibleExpenseFoundSubtitle: "<muted-text><centered-text>Voc\u00EA n\u00E3o tem despesas que possam ser mescladas com esta. <a href=\"".concat(CONST_1.default.HELP_DOC_LINKS.MERGE_EXPENSES, "\">Saiba mais</a> sobre despesas eleg\u00EDveis.</centered-text></muted-text>"),
            selectTransactionToMerge: function (_a) {
                var reportName = _a.reportName;
                return "Selecione uma <a href=\"".concat(CONST_1.default.HELP_DOC_LINKS.MERGE_EXPENSES, "\">despesa eleg\u00EDvel</a> para mesclar <strong>").concat(reportName, "</strong>.");
            },
        },
        receiptPage: {
        ...
        detailsPage: {
            ...
            pleaseSelectError: function (_a) {
                var field = _a.field;
                return "Por favor selecione um(a) ".concat(field);
            },
    ...
    contacts: {
        ...
        helpText: function (_a) {
            var email = _a.email;
            return "Adicione mais maneiras de enviar recibos. Encaminhe-os para <copy-text text=\"".concat(email, "\"/> ou envie uma mensagem para 47777 (apenas n\u00FAmeros dos EUA).");
        },
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            description: '<muted-text>Use as ferramentas abaixo para ajudar a solucionar problemas na experiência da Expensify. Se você encontrar algum problema, <concierge-link>envie um bug</concierge-link>.</muted-text>',
        ...
        versionLetter: 'v',
        readTheTermsAndPrivacy: "<muted-text-micro>Leia os <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termos de Servi\u00E7o</a> e <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacidade</a>.</muted-text-micro>"),
        help: 'Ajuda',
    ...
    mergeAccountsPage: {
        ...
        accountDetails: {
            accountToMergeInto: function (_a) {
                var login = _a.login;
                return "Digite a conta que voc\u00EA deseja mesclar em <strong>".concat(login, "</strong>.");
            },
        ...
        accountValidate: {
            ...
            lossOfUnsubmittedData: function (_a) {
                var login = _a.login;
                return "A fus\u00E3o de suas contas \u00E9 irrevers\u00EDvel e resultar\u00E1 na perda de quaisquer despesas n\u00E3o enviadas para <strong>".concat(login, "</strong>.");
            },
            enterMagicCode: function (_a) {
                var login = _a.login;
                return "Para continuar, digite o c\u00F3digo m\u00E1gico enviado para <strong>".concat(login, "</strong>.");
            },
            errors: {
        ...
        mergeSuccess: {
            ...
            description: function (_a) {
                ...
                return "<muted-text><centered-text>Voc\u00EA mesclou com \u00EAxito todos os dados de <strong>".concat(from, "</strong> em <strong>").concat(to, "</strong>. A partir de agora, voc\u00EA pode usar qualquer login para essa conta.</centered-text></muted-text>");
            },
        },
        mergePendingSAML: {
            ...
            reachOutForHelp: '<muted-text><centered-text>Sinta-se à vontade para entrar em <concierge-link>contato com o Concierge</concierge-link> se tiver alguma dúvida!</centered-text></muted-text>',
            goToExpensifyClassic: 'Ir para Expensify Classic',
        },
        mergeFailureSAMLDomainControlDescription: function (_a) {
            var _b;
            var email = _a.email;
            return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar o <strong>".concat(email, "</strong> porque ele \u00E9 controlado pelo <strong>").concat((_b = email.split('@').at(1)) !== null && _b !== void 0 ? _b : '', "</strong>. Entre em <concierge-link>contato com o Concierge</concierge-link> para obter ajuda.</centered-text></muted-text>");
        },
        mergeFailureSAMLAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar <strong>".concat(email, "</strong> com outras contas porque o administrador do dom\u00EDnio o definiu como seu login principal. Em vez disso, mescle outras contas a ele.</centered-text></muted-text>");
        },
        mergeFailure2FA: {
            description: function (_a) {
                var email = _a.email;
                return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar contas porque o site <strong>".concat(email, "</strong> tem a autentica\u00E7\u00E3o de dois fatores (2FA) ativada. Desative a 2FA para <strong>").concat(email, "</strong> e tente novamente.</centered-text></muted-text>");
            },
            learnMore: 'Saiba mais sobre como mesclar contas.',
        },
        mergeFailureAccountLockedDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar o site <strong>".concat(email, "</strong> porque ele est\u00E1 bloqueado. Entre em <concierge-link>contato com o Concierge</concierge-link> para obter ajuda.</centered-text></muted-text>");
        },
        mergeFailureUncreatedAccountDescription: function (_a) {
            var email = _a.email, contactMethodLink = _a.contactMethodLink;
            return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar contas porque <strong>".concat(email, "</strong> n\u00E3o tem uma conta Expensify. Em vez disso, <a href=\"").concat(contactMethodLink, "\">adicione-o como um m\u00E9todo de contato</a>.</centered-text></muted-text>");
        },
        mergeFailureSmartScannerAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar <strong>".concat(email, "</strong> em outras contas. Em vez disso, mescle outras contas a ela.</centered-text></muted-text>");
        },
        mergeFailureInvoicedAccountDescription: function (_a) {
            var email = _a.email;
            return "<muted-text><centered-text>N\u00E3o \u00E9 poss\u00EDvel mesclar contas em <strong>".concat(email, "</strong> porque essa conta possui uma rela\u00E7\u00E3o de faturamento.</centered-text></muted-text>");
        },
    ...
    billingCurrency: {
        ...
        note: "Observa\u00E7\u00E3o: a altera\u00E7\u00E3o da moeda de pagamento pode afetar o valor que voc\u00EA pagar\u00E1 pela Expensify. Consulte nossa <a href=\"".concat(CONST_1.default.PRICING, "\">p\u00E1gina de pre\u00E7os</a> para obter detalhes completos."),
    },
    addDebitCardPage: {
    ...
    cardPage: {
        ...
        missingPrivateDetails: function (_a) {
            ...
            return "Por favor, <a href=\"".concat(missingDetailsLink, "\">adicione seus dados pessoais</a> e tente novamente.");
        },
        ...
        cardFraudAlert: {
            ...
            clearedMessage: function (_a) {
                ...
                return "limpou a atividade suspeita e reativou o cart\u00E3o x".concat(cardLastFour, ". Tudo pronto para continuar gastando!");
            },
            deactivatedMessage: function (_a) {
                var cardLastFour = _a.cardLastFour;
                return "desativou o cart\u00E3o com final ".concat(cardLastFour);
            },
            alertMessage: function (_a) {
                var cardLastFour = _a.cardLastFour, amount = _a.amount, merchant = _a.merchant, date = _a.date;
                return "atividade suspeita identificada no cart\u00E3o com final ".concat(cardLastFour, ". Voc\u00EA reconhece esta cobran\u00E7a?\n\n").concat(amount, " para ").concat(merchant, " - ").concat(date);
            },
        },
    },
    workflowsPage: {
    ...
    paymentMethodList: {
        ...
        bankAccountLastFour: function (_a) {
            var lastFour = _a.lastFour;
            return "Conta banc\u00E1ria \u2022 ".concat(lastFour);
        },
    },
    preferencesPage: {
        appSection: {
    ...
    termsOfUse: {
        terms: "<muted-text-xs>Ao fazer o login, voc\u00EA concorda com os <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">Termos de Servi\u00E7o</a> e <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacidade</a>.</muted-text-xs>"),
        license: "<muted-text-xs>A transmiss\u00E3o de dinheiro \u00E9 fornecida pela ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " (NMLS ID:2017010) de acordo com suas <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.LICENSES_URL, "\">licen\u00E7as</a>.</muted-text-xs>"),
    },
    validateCodeForm: {
        ...
        requestNewCode: function (_a) {
            ...
            return "Solicitar um novo c\u00F3digo em <a>".concat(timeRemaining, "</a>");
        },
        ...
        tasks: {
            ...
            addExpenseApprovalsTask: {
                ...
                description: function (_a) {
                    ...
                    return "*Adicione aprova\u00E7\u00F5es de despesas* para revisar os gastos da sua equipe e mant\u00EA-los sob controle.\n" +
                        '\n' +
                        "Veja como fazer:\n" +
                        '\n' +
                        ...
                        '\n' +
                        "[Ir para mais recursos](".concat(workspaceMoreFeaturesLink, ").");
                },
            },
            ...
            addAccountingIntegrationTask: {
                ...
                description: function (_a) {
                    ...
                    return "Conecte-se".concat(integrationName === CONST_1.default.ONBOARDING_ACCOUNTING_MAPPING.other ? ' ao seu' : ' ao', " ").concat(integrationName, " para categoriza\u00E7\u00E3o autom\u00E1tica de despesas e sincroniza\u00E7\u00E3o que torna o fechamento do m\u00EAs muito f\u00E1cil.\n") +
                        ...
                        "4. Encontre ".concat(integrationName, ".\n") +
            ...
            setupCategoriesAndTags: {
                title: function (_a) {
                    ...
                    return "Configure [categorias](".concat(workspaceCategoriesLink, ") e [tags](").concat(workspaceTagsLink, ")");
                },
                description: function (_a) {
            ...
            setupTagsTask: {
                title: function (_a) {
                    ...
                    return "Configure [tags](".concat(workspaceTagsLink, ")");
                },
                description: function (_a) {
                    var workspaceMoreFeaturesLink = _a.workspaceMoreFeaturesLink;
            ...
            reviewWorkspaceSettingsTask: {
                ...
                description: function (_a) {
                    ...
                    return 'Veja como revisar e atualizar as configurações do seu espaço de trabalho:\n' +
                        ...
                        "[V\u00E1 para o seu espa\u00E7o de trabalho.](".concat(workspaceSettingsLink, ")");
                },
            },
            createReportTask: {
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: function (_a) {
            var login = _a.login;
            return "<strong>Confirme que ".concat(login, " est\u00E1 escrito corretamente e \u00E9 um endere\u00E7o de e-mail real e v\u00E1lido para entrega.</strong> Os aliases de e-mail, como \"expenses@domain.com\", devem ter acesso \u00E0 sua pr\u00F3pria caixa de entrada de e-mail para que seja um login v\u00E1lido do Expensify.");
        },
        ensureYourEmailClient: "<strong>Certifique-se de que seu cliente de e-mail permita e-mails de expensify.com.</strong> Voc\u00EA pode encontrar instru\u00E7\u00F5es sobre como concluir essa etapa <a href=\"".concat(CONST_1.default.SET_NOTIFICATION_LINK, "\">aqui</a>, mas talvez seja necess\u00E1rio que seu departamento de TI o ajude a definir suas configura\u00E7\u00F5es de e-mail."),
        onceTheAbove: "Depois que as etapas acima forem conclu\u00EDdas, entre em contato com <a href=\"mailto:".concat(CONST_1.default.EMAIL.CONCIERGE, "\">").concat(CONST_1.default.EMAIL.CONCIERGE, "</a> para desbloquear seu login."),
    },
    ...
    focusModeUpdateModal: {
        ...
        prompt: function (_a) {
            ...
            return "Mantenha-se atualizado vendo apenas os chats n\u00E3o lidos ou que precisam da sua aten\u00E7\u00E3o. N\u00E3o se preocupe, voc\u00EA pode mudar isso a qualquer momento em <a href=\"".concat(priorityModePageUrl, "\">configura\u00E7\u00F5es</a>.");
        },
    },
    notFound: {
    ...
    bankAccount: {
        ...
        error: {
            ...
            deletePaymentBankAccount: 'Este banco conta não pode ser excluída porque é usada para pagamentos do Cartão Expensify. Se ainda assim deseja excluir essa conta, entre em contato com o Concierge.',
        },
    },
    ...
    additionalDetailsStep: {
        ...
        failedKYCMessage: function (_a) {
            ...
            return "N\u00E3o conseguimos verificar sua identidade. Por favor, tente novamente mais tarde ou entre em contato com <a href=\"mailto:".concat(conciergeEmail, "\">").concat(conciergeEmail, "</a> se voc\u00EA tiver alguma d\u00FAvida.");
        },
    },
    termsStep: {
        ...
        haveReadAndAgree: "Eu li e concordo em receber <a href=\"".concat(CONST_1.default.ELECTRONIC_DISCLOSURES_URL, "\">divulga\u00E7\u00F5es eletr\u00F4nicas</a>."),
        ...
        agreeToThe: function (_a) {
            ...
            return "Concordo com o Acordo de <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">Privacidade</a> e <a href=\"").concat(walletAgreementUrl, "\">Carteira</a>.");
        },
        ...
        shortTermsForm: {
            ...
            generalInfo: "Para obter informa\u00E7\u00F5es gerais sobre contas pr\u00E9-pagas, visite <a href=\"".concat(CONST_1.default.CFPB_PREPAID_URL, "\">").concat(CONST_1.default.TERMS.CFPB_PREPAID, "</a>."),
            conditionsDetails: "Para obter detalhes e condi\u00E7\u00F5es de todas as taxas e servi\u00E7os, acesse <a href=\"".concat(CONST_1.default.FEES_URL, "\">").concat(CONST_1.default.FEES_URL, "</a> ou ligue para +1 833-400-0904."),
        ...
        longTermsForm: {
            ...
            electronicFundsStandardDetails: 'Não há nenhuma taxa para transferir fundos de sua Carteira Expensify para sua conta bancária usando a opção padrão. Essa transferência geralmente é concluída dentro de 1 a 3 dias úteis.',
            electronicFundsInstantDetails: function (_a) {
                var percentage = _a.percentage, amount = _a.amount;
                return 'Há uma taxa para transferir fundos de sua Carteira Expensify para seu cartão de débito vinculado usando a opção de transferência instantânea.' +
                    " Essa transfer\u00EAncia geralmente \u00E9 conclu\u00EDda em alguns minutos. A taxa \u00E9 de ".concat(percentage, "% do valor da transfer\u00EAncia (com uma taxa m\u00EDnima de ").concat(amount, ").");
            },
            fdicInsuranceBancorp: function (_a) {
                var amount = _a.amount;
                return "Seus fundos s\u00E3o eleg\u00EDveis para o seguro FDIC. Seus fundos ser\u00E3o mantidos ou transferidos para o ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", uma institui\u00E7\u00E3o segurada pelo FDIC.") +
                    " Uma vez l\u00E1, seus fundos s\u00E3o segurados em at\u00E9 ".concat(amount, " pelo FDIC no caso de fal\u00EAncia do ").concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", se os requisitos espec\u00EDficos de seguro de dep\u00F3sito forem atendidos e seu cart\u00E3o estiver registrado. ") +
                    " Consulte ".concat(CONST_1.default.TERMS.FDIC_PREPAID, " para obter detalhes.");
            },
            contactExpensifyPayments: "Entre em contato com a ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " pelo telefone +1 833-400-0904, por e-mail em ").concat(CONST_1.default.EMAIL.CONCIERGE, " ou fa\u00E7a login em ").concat(CONST_1.default.NEW_EXPENSIFY_URL, "."),
            generalInformation: "Para obter informa\u00E7\u00F5es gerais sobre contas pr\u00E9-pagas, acesse ".concat(CONST_1.default.TERMS.CFPB_PREPAID, ". Se voc\u00EA tiver uma reclama\u00E7\u00E3o sobre uma conta pr\u00E9-paga, ligue para o Consumer Financial Protection Bureau (Departamento de Prote\u00E7\u00E3o Financeira do Consumidor) no n\u00FAmero 1-855-411-2372 ou acesse ").concat(CONST_1.default.TERMS.CFPB_COMPLAINT, "."),
    ...
    beneficialOwnerInfoStep: {
        ...
        areThereMoreIndividualsWhoOwn25percent: function (_a) {
            var companyName = _a.companyName;
            return "Existem mais pessoas que possuem 25% ou mais da ".concat(companyName, "?");
        },
    ...
    signerInfoStep: {
        ...
        areYouDirector: function (_a) {
            var companyName = _a.companyName;
            return "Voc\u00EA \u00E9 um diretor na ".concat(companyName, "?");
        },
        ...
        enterOneEmail: function (_a) {
            var companyName = _a.companyName;
            return "Digite o e-mail do diretor da ".concat(companyName);
        },
        ...
        enterTwoEmails: function (_a) {
            var companyName = _a.companyName;
            return "Digite os e-mails de dois diretores da ".concat(companyName);
        },
        ...
        isConnecting: function (_a) {
            ...
            return "est\u00E1 conectando uma conta banc\u00E1ria empresarial em ".concat(currency, " com final ").concat(bankAccountLastFour, " ao Expensify para pagar funcion\u00E1rios em ").concat(currency, ". A pr\u00F3xima etapa exige as informa\u00E7\u00F5es de um signat\u00E1rio, como um diretor.");
        },
        error: {
    ...
    docusignStep: {
        ...
        pleaseComplete: 'Por favor, preencha o formulário de autorização ACH pelo link do Docusign abaixo e envie uma cópia assinada aqui para que possamos debitar diretamente da sua conta bancária.',
        pleaseCompleteTheBusinessAccount: 'Por favor, preencha a Solicitação de Conta Empresarial e o Acordo de Débito Direto.',
        pleaseCompleteTheDirect: 'Por favor, preencha o Acordo de Débito Direto usando o link do Docusign abaixo e envie uma cópia assinada aqui para que possamos debitar diretamente da sua conta bancária.',
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            subtitle: "Por favor, concorde com os <a href=\"".concat(CONST_1.default.TRAVEL_TERMS_URL, "\">termos e condi\u00E7\u00F5es</a> da Expensify Travel."),
        ...
        phoneError: function (_a) {
            ...
            return "<rbr><a href=\"".concat(phoneErrorMethodsRoute, "\">Adicione um e-mail de trabalho como seu login principal</a> para reservar viagens.</rbr>");
        },
        domainSelector: {
            title: 'Domínio',
        ...
        domainPermissionInfo: {
            ...
            restriction: function (_a) {
                ...
                return "Voc\u00EA n\u00E3o tem permiss\u00E3o para ativar o Expensify Travel para o dom\u00EDnio <strong>".concat(domain, "</strong>. Voc\u00EA precisar\u00E1 pedir a algu\u00E9m desse dom\u00EDnio para ativar o Travel.");
            },
            accountantInvitation: "Se voc\u00EA \u00E9 contador, considere participar do <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.EXPENSIFY_APPROVED_PROGRAM_URL, "\">programa ExpensifyApproved! para contadores</a> para habilitar viagens para esse dom\u00EDnio."),
        },
        publicDomainError: {
        ...
        verifyCompany: {
            ...
            conciergeMessage: function (_a) {
                var domain = _a.domain;
                return "A habilita\u00E7\u00E3o de viagem falhou para o dom\u00EDnio: ".concat(domain, ". Por favor, revise e habilite a viagem para este dom\u00EDnio.");
            },
        },
        updates: {
    ...
    workspace: {
        common: {
            ...
            shareNote: {
                ...
                content: function (_a) {
                    ...
                    return "Compartilhe este c\u00F3digo QR ou copie o link abaixo para facilitar aos membros a solicita\u00E7\u00E3o de acesso ao seu espa\u00E7o de trabalho. Todas as solicita\u00E7\u00F5es para ingressar no espa\u00E7o de trabalho aparecer\u00E3o na sala <a href=\"".concat(adminsRoomLink, "\">").concat(CONST_1.default.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS, "</a> para sua an\u00E1lise.");
                },
            },
            ...
            deepDiveExpensifyCard: "<muted-text-label>As transa\u00E7\u00F5es do cart\u00E3o Expensify ser\u00E3o exportadas automaticamente para uma \u201CConta de responsabilidade do cart\u00E3o Expensify\u201D criada com <a href=\"".concat(CONST_1.default.DEEP_DIVE_EXPENSIFY_CARD, "\">nossa integra\u00E7\u00E3o</a>.</muted-text-label>"),
        },
        receiptPartners: {
            ...
            uber: {
                subtitle: function (_a) {
                    ...
                    return organizationName ? "Conectado a ".concat(organizationName) : 'Automatize as despesas de viagens e entregas de refeições em toda a sua organização.';
                },
                ...
                status: (_e = {
                    ...
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.LINKED] = 'Vinculado',
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.LINKED_PENDING_APPROVAL] = 'Pendente',
                    _e[CONST_1.default.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS.SUSPENDED] = 'Suspenso',
                    _e),
        ...
        perDiem: {
            subtitle: "<muted-text>Defina taxas de di\u00E1rias para controlar os gastos di\u00E1rios dos funcion\u00E1rios. <a href=\"".concat(CONST_1.default.DEEP_DIVE_PER_DIEM, "\">Saiba mais</a>.</muted-text>"),
            amount: 'Quantia',
        ...
        qbd: {
            ...
            accounts: (_g = {},
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Cartão de crédito',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Fatura do fornecedor',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Lançamento contábil',
                _g[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Verificar',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = 'Vamos criar um cheque detalhado para cada relatório do Expensify e enviá-lo a partir da conta bancária abaixo.',
                ...
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'Criaremos uma fatura detalhada do fornecedor para cada relatório do Expensify com a data da última despesa e a adicionaremos à conta abaixo. Se este período estiver fechado, lançaremos no dia 1º do próximo período aberto.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Escolha onde exportar as transações do cartão de crédito.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Escolha um fornecedor para aplicar a todas as transações de cartão de crédito.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = 'Escolha de onde enviar os cheques.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'As contas de fornecedores não estão disponíveis quando os locais estão ativados. Por favor, escolha uma opção de exportação diferente.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Cheques estão indisponíveis quando locais estão habilitados. Por favor, escolha uma opção de exportação diferente.',
                _g["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'As entradas de diário não estão disponíveis quando os impostos estão ativados. Por favor, escolha uma opção de exportação diferente.',
                _g),
            ...
            setupPage: {
                ...
                setupErrorBody: function (_a) {
                    ...
                    return "<muted-text><centered-text>A conex\u00E3o com o QuickBooks Desktop n\u00E3o est\u00E1 funcionando no momento. Tente novamente mais tarde ou <a href=\"".concat(conciergeLink, "\">entre em contato com o Concierge</a> se o problema persistir.</centered-text></muted-text>");
                },
            },
            ...
            accountingMethods: {
                ...
                values: (_h = {},
                    _h[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Acumulação',
                    _h[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Dinheiro',
                    _h),
                alternateText: (_j = {},
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Despesas do próprio bolso serão exportadas quando aprovadas em definitivo',
                    _j[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Despesas do próprio bolso serão exportadas quando pagas',
                    _j),
            },
        },
        qbo: {
            ...
            accounts: (_l = {},
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = 'Cartão de débito',
                _l[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Cartão de crédito',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Fatura do fornecedor',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Lançamento contábil',
                _l[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Verificar',
                ...
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "Vamos corresponder automaticamente o nome do comerciante na transação do cartão de crédito a qualquer fornecedor correspondente no QuickBooks. Se não existirem fornecedores, criaremos um fornecedor 'Cartão de Crédito Diversos' para associação.",
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'Criaremos uma fatura detalhada do fornecedor para cada relatório do Expensify com a data da última despesa e a adicionaremos à conta abaixo. Se este período estiver fechado, lançaremos no dia 1º do próximo período aberto.',
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Escolha onde exportar as transações do cartão de débito.',
                _l["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Escolha onde exportar as transações do cartão de crédito.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Escolha um fornecedor para aplicar a todas as transações de cartão de crédito.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'As contas de fornecedores não estão disponíveis quando os locais estão ativados. Por favor, escolha uma opção de exportação diferente.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Cheques estão indisponíveis quando locais estão habilitados. Por favor, escolha uma opção de exportação diferente.',
                _l["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'As entradas de diário não estão disponíveis quando os impostos estão ativados. Por favor, escolha uma opção de exportação diferente.',
                _l),
            exportDestinationAccountsMisconfigurationError: (_m = {},
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Escolha uma conta válida para exportação de fatura do fornecedor',
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Escolha uma conta válida para exportação de lançamento contábil',
                _m[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Escolha uma conta válida para exportação de cheques',
                _m),
            exportDestinationSetupAccountsInfo: (_o = {},
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Para usar a exportação de fatura de fornecedor, configure uma conta a pagar no QuickBooks Online.',
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Para usar a exportação de lançamentos contábeis, configure uma conta de diário no QuickBooks Online',
                _o[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Para usar a exportação de cheques, configure uma conta bancária no QuickBooks Online',
                _o),
            noAccountsFound: 'Nenhuma conta encontrada',
            ...
            accountingMethods: {
                ...
                description: 'Escolha quando exportar as despesas:',
                values: (_p = {},
                    _p[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Acumulação',
                    _p[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Dinheiro',
                    _p),
                alternateText: (_q = {},
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Despesas do próprio bolso serão exportadas quando aprovadas em definitivo',
                    _q[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Despesas do próprio bolso serão exportadas quando pagas',
                    _q),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_r = {},
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Contato padrão do Xero',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = 'Tags',
                _r[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = 'Campos do relatório',
                _r),
            ...
            invoiceStatus: {
                ...
                values: (_t = {},
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = 'Rascunho',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = 'Aguardando aprovação',
                    _t[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = 'Aguardando pagamento',
                    _t),
            },
            noAccountsFound: 'Nenhuma conta encontrada',
            ...
            accountingMethods: {
                ...
                description: 'Escolha quando exportar as despesas:',
                values: (_u = {},
                    _u[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Acumulação',
                    _u[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Dinheiro',
                    _u),
                alternateText: (_v = {},
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Despesas do próprio bolso serão exportadas quando aprovadas em definitivo',
                    _v[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Despesas do próprio bolso serão exportadas quando pagas',
                    _v),
            },
        },
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_x = {},
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = 'Relatórios de despesas',
                    _x[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Faturas de fornecedores',
                    _x),
            },
            nonReimbursableExpenses: {
                description: 'Defina como as compras com cartão corporativo são exportadas para o Sage Intacct.',
                values: (_y = {},
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = 'Cartões de crédito',
                    _y[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Faturas de fornecedores',
                    _y),
            },
            creditCardAccount: 'Conta de cartão de crédito',
        ...
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: (_1 = {},
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = 'Entrada única e detalhada para cada relatório',
                    _1[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = 'Entrada única para cada despesa',
                    _1),
            },
            invoiceItem: {
            ...
            exportDestination: {
                values: (_4 = {},
                    ...
                    _4),
                expenseReportDestinationConfirmDescription: 'Se você mudar a configuração de exportação de cartões corporativos para relatórios de despesas, os fornecedores do NetSuite e as contas de lançamento para cartões individuais serão desabilitados.\n\nNão se preocupe, ainda vamos salvar suas seleções anteriores caso você queira voltar às configurações anteriores mais tarde.',
            },
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_5 = {},
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'Preferência padrão do NetSuite',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = 'Apenas aprovado pelo supervisor',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = 'Apenas contabilidade aprovada',
                        _5[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = 'Supervisor e contabilidade aprovados',
                        _5),
                },
                accountingMethods: {
                    label: 'Quando Exportar',
                    description: 'Escolha quando exportar as despesas:',
                    values: (_6 = {},
                        _6[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Acumulação',
                        _6[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Dinheiro',
                        _6),
                    alternateText: (_7 = {},
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Despesas do próprio bolso serão exportadas quando aprovadas em definitivo',
                        _7[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Despesas do próprio bolso serão exportadas quando pagas',
                        _7),
                },
                exportVendorBillsTo: {
                    ...
                    values: (_8 = {},
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'Preferência padrão do NetSuite',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = 'Aguardando aprovação',
                        _8[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = 'Aprovado para postagem',
                        _8),
                },
                exportJournalsTo: {
                    ...
                    values: (_9 = {},
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'Preferência padrão do NetSuite',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = 'Aguardando aprovação',
                        _9[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = 'Aprovado para postagem',
                        _9),
                },
                error: {
        ...
        intacct: {
            ...
            toggleImportTitle: function (_a) {
                ...
                return "Escolha como lidar com o Sage Intacct <strong>".concat(mappingTitle, "</strong> in Expensify.");
            },
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                learnMoreAboutOptions: "<muted-text>Saiba mais sobre essas <a href=\"".concat(CONST_1.default.COMPANY_CARDS_CONNECT_CREDIT_CARDS_HELP_URL, "\">op\u00E7\u00F5es</a>.</muted-text>"),
            ...
            statementCloseDate: (_11 = {},
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Último dia do mês',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Último dia útil do mês',
                _11[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Dia personalizado do mês',
                _11),
            ...
            chooseCardFor: function (_a) {
                ...
                return "Escolha um cart\u00E3o para <strong>".concat(assignee, "</strong>. N\u00E3o consegue encontrar o cart\u00E3o que procura? <concierge-link>Avise-nos.</concierge-link>");
            },
            noActiveCards: 'Nenhum cartão ativo neste feed',
            somethingMightBeBroken: '<muted-text><centered-text>Ou algo pode estar quebrado. De qualquer forma, se você tiver alguma dúvida, entre em <concierge-link>contato com a Concierge</concierge-link>.</centered-text></muted-text>',
            ...
            brokenConnectionError: '<rbr>A conexão do feed do cartão está quebrada. Por favor, <a href="#">faça login no seu banco</a> para que possamos estabelecer a conexão novamente.</rbr>',
        ...
        expensifyCard: {
            ...
            euUkDisclaimer: 'Os cartões fornecidos a residentes do EEE são emitidos pela Transact Payments Malta Limited, enquanto os cartões fornecidos a residentes do Reino Unido são emitidos pela Transact Payments Limited, de acordo com a licença da Visa Europe Limited. A Transact Payments Malta Limited é devidamente autorizada e regulamentada pela Autoridade de Serviços Financeiros de Malta como uma instituição financeira, de acordo com a Lei de Instituições Financeiras de 1994. Número de registro C 91879. A Transact Payments Limited é autorizada e regulamentada pela Comissão de Serviços Financeiros de Gibraltar.',
            findCard: 'Encontrar cartão',
            newCard: 'Novo cartão',
            name: 'Nome',
            lastFour: 'Últimos 4',
            ...
            settlementAccountInfo: function (_a) {
                ...
                return "Certifique-se de que essa conta corresponda \u00E0 sua <a href=\"".concat(reconciliationAccountSettingsLink, "\">conta de Reconcilia\u00E7\u00E3o</a> (").concat(accountNumber, ") para que a Reconcilia\u00E7\u00E3o Cont\u00EDnua funcione corretamente.");
            },
            settlementFrequency: 'Frequência de liquidação',
            ...
            cardPending: function (_a) {
                var name = _a.name;
                return "O cart\u00E3o est\u00E1 pendente e ser\u00E1 emitido assim que a conta de ".concat(name, " for validada.");
            },
            virtual: 'Virtual',
            physical: 'Físico',
            ...
            issuedCardNoShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "Foi emitido para ".concat(assignee, " um Expensify Card! O cart\u00E3o ser\u00E1 enviado assim que os detalhes de envio forem confirmados.");
            },
            ...
            addedShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "".concat(assignee, " adicionou informa\u00E7\u00F5es de envio. O Expensify Card chegar\u00E1 em 2-3 dias \u00FAteis.");
            },
        ...
        categories: {
            ...
            emptyCategories: {
                ...
                subtitleWithAccounting: function (_a) {
                    ...
                    return "<muted-text><centered-text>No momento, suas categorias est\u00E3o sendo importadas de uma conex\u00E3o de contabilidade. V\u00E1 para a <a href=\"".concat(accountingPageURL, "\">contabilidade</a> para fazer altera\u00E7\u00F5es.</centered-text></muted-text>");
                },
            },
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                integrationExportTitle: function (_a) {
                    ...
                    return "Escolha a conta ".concat(integration, " para onde as transa\u00E7\u00F5es devem ser exportadas. Selecione uma <a href=\"").concat(exportPageLink, "\">op\u00E7\u00E3o de exporta\u00E7\u00E3o</a> diferente para alterar as contas dispon\u00EDveis.");
                },
        ...
        reports: {
            ...
            customReportNamesSubtitle: "<muted-text>Personalize os t\u00EDtulos dos relat\u00F3rios utilizando nossas <a href=\"".concat(CONST_1.default.CUSTOM_REPORT_NAME_HELP_URL, "\">f\u00F3rmulas abrangentes</a>.</muted-text>"),
            customNameTitle: 'Título padrão do relatório',
            customNameDescription: "Escolha um nome personalizado para relat\u00F3rios de despesas usando nossas <a href=\"".concat(CONST_1.default.CUSTOM_REPORT_NAME_HELP_URL, "\">f\u00F3rmulas abrangentes</a>."),
        ...
        tags: {
            ...
            dependentMultiLevelTagsSubtitle: function (_a) {
                ...
                return "<muted-text>Voc\u00EA est\u00E1 usando <a href=\"".concat(CONST_1.default.IMPORT_TAGS_EXPENSIFY_URL_DEPENDENT_TAGS, "\">tags dependentes</a>. Voc\u00EA pode <a href=\"").concat(importSpreadsheetLink, "\">reimportar uma planilha</a> para atualizar suas tags.</muted-text>");
            },
            emptyTags: {
                ...
                subtitleHTML: "<muted-text><centered-text>Importe uma planilha para adicionar tags para rastrear projetos, locais, departamentos e muito mais. <a href=\"".concat(CONST_1.default.IMPORT_TAGS_EXPENSIFY_URL, "\">Saiba mais</a> sobre a formata\u00E7\u00E3o de arquivos de tags.</centered-text></muted-text>"),
                subtitleWithAccounting: function (_a) {
                    var accountingPageURL = _a.accountingPageURL;
                    return "<muted-text><centered-text>No momento, suas tags est\u00E3o sendo importadas de uma conex\u00E3o de contabilidade. V\u00E1 para a <a href=\"".concat(accountingPageURL, "\">contabilidade</a> para fazer altera\u00E7\u00F5es.</centered-text></muted-text>");
                },
            },
        ...
        duplicateWorkspace: {
            ...
            confirmTitle: function (_a) {
                ...
                return "Voc\u00EA est\u00E1 prestes a criar e compartilhar ".concat(newWorkspaceName !== null && newWorkspaceName !== void 0 ? newWorkspaceName : '', " com ").concat(totalMembers !== null && totalMembers !== void 0 ? totalMembers : 0, " membros do espa\u00E7o de trabalho original.");
            },
        ...
        people: {
            ...
            workspaceMembersCount: function (_a) {
                var count = _a.count;
                return "Total de membros do espa\u00E7o de trabalho: ".concat(count);
            },
            ...
            removeMemberPromptApprover: function (_a) {
                ...
                return "Se voc\u00EA remover ".concat(approver, " deste espa\u00E7o de trabalho, vamos substitu\u00ED-lo(a) no fluxo de aprova\u00E7\u00E3o por ").concat(workspaceOwner, ", o(a) propriet\u00E1rio(a) do espa\u00E7o de trabalho.");
            },
            removeMemberPromptPendingApproval: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " tem relat\u00F3rios de despesas pendentes para aprovar. Solicite que os aprove ou assuma o controle dos relat\u00F3rios antes de remov\u00EA-lo(a) do espa\u00E7o de trabalho.");
            },
            removeMemberPromptReimburser: function (_a) {
                var memberName = _a.memberName;
                return "Voc\u00EA n\u00E3o pode remover ".concat(memberName, " deste espa\u00E7o de trabalho. Defina um novo reembolsador em Fluxos de trabalho > Fazer ou acompanhar pagamentos e tente novamente.");
            },
            removeMemberPromptExporter: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Se voc\u00EA remover ".concat(memberName, " deste espa\u00E7o de trabalho, vamos substitu\u00ED-lo(a) como exportador preferido por ").concat(workspaceOwner, ", o(a) propriet\u00E1rio(a) do espa\u00E7o de trabalho.");
            },
            removeMemberPromptTechContact: function (_a) {
                var memberName = _a.memberName, workspaceOwner = _a.workspaceOwner;
                return "Se voc\u00EA remover ".concat(memberName, " deste espa\u00E7o de trabalho, vamos substitu\u00ED-lo(a) como contato t\u00E9cnico por ").concat(workspaceOwner, ", o(a) propriet\u00E1rio(a) do espa\u00E7o de trabalho.");
            },
            cannotRemoveUserDueToReport: function (_a) {
                var memberName = _a.memberName;
                return "".concat(memberName, " tem um relat\u00F3rio em processamento que requer a\u00E7\u00E3o. Pe\u00E7a que a a\u00E7\u00E3o necess\u00E1ria seja conclu\u00EDda antes de remover essa pessoa do espa\u00E7o de trabalho.");
            },
        },
        card: {
            getStartedIssuing: 'Comece emitindo seu primeiro cartão virtual ou físico.',
            ...
            issueNewCard: {
                ...
                name: 'Nome',
                disabledApprovalForSmartLimitError: 'Por favor, ative as aprovações em <strong>Fluxos de Trabalho > Adicionar aprovações</strong> antes de configurar os limites inteligentes',
            },
            deactivateCardModal: {
        ...
        accounting: {
            ...
            errorODIntegration: function (_a) {
                ...
                return "H\u00E1 um erro com uma conex\u00E3o que foi configurada no Expensify Classic. [V\u00E1 para o Expensify Classic para resolver este problema.](".concat(oldDotPolicyConnectionsURL, ")");
            },
            ...
            importTypes: (_12 = {},
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = 'Importado',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Importado como tags',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Importado',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'Não importado',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'Não importado',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Importado como campos de relatório',
                _12[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'NetSuite employee default',
                _12),
            ...
            enableContinuousReconciliation: function (_a) {
                ...
                return "<muted-text-label>Para ativar a reconcilia\u00E7\u00E3o cont\u00EDnua, habilite a <a href=\"".concat(accountingAdvancedSettingsLink, "\">sincroniza\u00E7\u00E3o autom\u00E1tica</a> para o ").concat(connectionName, ".</muted-text-label>");
            },
            chooseReconciliationAccount: {
                ...
                settlementAccountReconciliation: function (_a) {
                    ...
                    return "Certifique-se de que esta conta corresponde \u00E0 sua <a href=\"".concat(settlementAccountUrl, "\">Conta de liquida\u00E7\u00E3o do Cart\u00E3o Expensify</a> (terminando em ").concat(lastFourPAN, ") para que a Reconcilia\u00E7\u00E3o Cont\u00EDnua funcione corretamente.");
                },
            },
        },
        export: {
        ...
        distanceRates: {
            ...
            status: 'Status',
            unit: 'Unidade',
            taxFeatureNotEnabledMessage: '<muted-text>Os impostos devem estar ativados no espaço de trabalho para usar este recurso. Vá para <a href="#">Mais funcionalidades</a> para fazer essa alteração.</muted-text>',
        ...
        bankAccount: {
            ...
            disconnectYourBankAccount: function (_a) {
                var bankName = _a.bankName;
                return "Desconecte sua conta banc\u00E1ria de <strong>".concat(bankName, "</strong>. Quaisquer transa\u00E7\u00F5es pendentes para esta conta ainda ser\u00E3o conclu\u00EDdas.");
            },
            ...
            yourWorkspace: "Seu espa\u00E7o de trabalho est\u00E1 configurado para uma moeda n\u00E3o suportada. Veja a <a href=\"".concat(CONST_1.default.CONNECT_A_BUSINESS_BANK_ACCOUNT_HELP_URL, "\">lista de moedas suportadas</a>."),
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptText: "<muted-text-micro>Leia e aceite os <a href=\"".concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.TERMS_URL, "\">termos</a> e a <a href=\"").concat(CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL, "\">pol\u00EDtica de privacidade</a> para adicionar seu cart\u00E3o.</muted-text-micro>"),
            ...
            addPaymentCardLearnMore: "<muted-text>Saiba mais sobre nossa <a href=\"".concat(CONST_1.default.PERSONAL_DATA_PROTECTION_INFO_URL, "\">seguran\u00E7a</a>.</muted-text>"),
        ...
        upgrade: (_13 = {
                reportFields: {
                    ...
                    onlyAvailableOnPlan: function (_a) {
                        ...
                        return "<muted-text>Os campos de relat\u00F3rio est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                    },
                }
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.NETSUITE] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Nossa integra\u00E7\u00E3o com o NetSuite est\u00E1 dispon\u00EDvel apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.SAGE_INTACCT] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Nossa integra\u00E7\u00E3o com o Sage Intacct est\u00E1 dispon\u00EDvel apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13[CONST_1.default.POLICY.CONNECTIONS.NAME.QBD] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Nossa integra\u00E7\u00E3o com o QuickBooks Desktop est\u00E1 dispon\u00EDvel apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id] = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>As aprova\u00E7\u00F5es avan\u00E7adas est\u00E3o dispon\u00EDveis apenas no plano Control, que come\u00E7a em <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.categories = {
                title: 'Categorias',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>As categorias est\u00E3o dispon\u00EDveis no plano Collect, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.glCodes = {
                title: 'códigos GL',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Os c\u00F3digos GL est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.glAndPayrollCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Os c\u00F3digos GL e de folha de pagamento est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.taxCodes = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Os c\u00F3digos fiscais est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.companyCards = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Isso est\u00E1 dispon\u00EDvel apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.rules = {
                title: 'Regras',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>As regras est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.perDiem = {
                title: 'Per diem',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Per diem est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.travel = {
                title: 'Viagem',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Viagens est\u00E3o dispon\u00EDveis no plano Collect, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.reports = {
                title: 'Relatórios',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Os relat\u00F3rios est\u00E3o dispon\u00EDveis no plano Collect, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.multiLevelTags = {
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>As tags de m\u00FAltiplos n\u00EDveis est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.distanceRates = {
                title: 'Taxas de distância',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>As tarifas de dist\u00E2ncia est\u00E3o dispon\u00EDveis no plano Collect, come\u00E7ando em <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.auditor = {
                title: 'Auditor',
                ...
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>Os auditores est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13[CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id] = {
                title: 'Vários níveis de aprovação',
                description: 'Vários níveis de aprovação são uma ferramenta de fluxo de trabalho para empresas que exigem que mais de uma pessoa aprove um relatório antes que ele possa ser reembolsado.',
                onlyAvailableOnPlan: function (_a) {
                    var formattedPrice = _a.formattedPrice, hasTeam2025Pricing = _a.hasTeam2025Pricing;
                    return "<muted-text>V\u00E1rios n\u00EDveis de aprova\u00E7\u00E3o est\u00E3o dispon\u00EDveis apenas no plano Control, a partir de <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", "</muted-text>");
                },
            },
            _13.pricing = {
            ...
            _13.note = function (_a) {
                ...
                return "<muted-text>Atualize para acessar esse recurso ou <a href=\"".concat(subscriptionLink, "\">saiba mais</a> sobre nossos planos e pre\u00E7os.</muted-text>");
            },
            _13.upgradeToUnlock = 'Desbloquear este recurso',
            _13.completed = {
                ...
                successMessage: function (_a) {
                    ...
                    return "<centered-text>Voc\u00EA atualizou com sucesso o ".concat(policyName, " para o plano Controle! <a href=\"").concat(subscriptionLink, "\">Veja sua assinatura</a> para mais detalhes.</centered-text>");
                },
            ...
            _13.commonFeatures = {
                ...
                benefits: {
                    startsAtFull: function (_a) {
                        ...
                        return "<muted-text>O plano Control come\u00E7a em <strong>".concat(formattedPrice, "</strong> ").concat(hasTeam2025Pricing ? "por membro por m\u00EAs." : "por membro ativo por m\u00EAs.", " <a href=\"").concat(learnMoreMethodsRoute, "\">Saiba mais</a> sobre nossos planos e pre\u00E7os.</muted-text>");
                    },
        ...
        payAndDowngrade: {
            ...
            description1: function (_a) {
                var formattedAmount = _a.formattedAmount;
                return "Sua fatura final para essa assinatura ser\u00E1 de <strong>".concat(formattedAmount, "</strong>");
            },
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: function (_a) {
                    ...
                    return "<muted-text>Defina controles de gastos e padr\u00F5es para despesas individuais. Voc\u00EA tamb\u00E9m pode criar regras para <a href=\"".concat(categoriesPageLink, "\">categorias</a> e <a href=\"").concat(tagsPageLink, "\">tags</a>.</muted-text>");
                },
                ...
                cashExpenseDefaultDescription: 'Escolha como as despesas em dinheiro devem ser criadas. Uma despesa é considerada em dinheiro se não for uma transação de cartão corporativo importada. Isso inclui despesas criadas manualmente, recibos, diárias, distância e despesas de tempo.',
                ...
                billableDefaultDescription: function (_a) {
                    ...
                    return "<muted-text>Escolha se as despesas em dinheiro e cart\u00E3o de cr\u00E9dito devem ser fatur\u00E1veis por padr\u00E3o. As despesas fatur\u00E1veis s\u00E3o ativadas ou desativadas nas <a href=\"".concat(tagsPageLink, "\">tags</a>.</muted-text>");
                },
                billable: 'Faturável',
                ...
                eReceipts: 'eReceipts',
                eReceiptsHint: "Os recibos eletr\u00F4nicos s\u00E3o criados automaticamente [para a maioria das transa\u00E7\u00F5es de cr\u00E9dito em d\u00F3lares](".concat(CONST_1.default.DEEP_DIVE_ERECEIPTS, ")."),
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "Acesse [mais recursos](".concat(moreFeaturesLink, ") e habilite fluxos de trabalho, depois adicione ").concat(featureName, " para desbloquear esse recurso.");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName, moreFeaturesLink = _a.moreFeaturesLink;
                    return "Acesse [mais recursos](".concat(moreFeaturesLink, ") e habilite ").concat(featureName, " para desbloquear este recurso.");
                },
            },
            categoryRules: {
                ...
                enableWorkflows: function (_a) {
                    ...
                    return "V\u00E1 para [Mais recursos](".concat(moreFeaturesLink, ") e habilite os fluxos de trabalho, depois adicione aprova\u00E7\u00F5es para desbloquear esse recurso.");
                },
            },
            customRules: {
    ...
    workspaceActions: {
        ...
        updateDefaultReimbursable: function (_a) {
            var oldValue = _a.oldValue, newValue = _a.newValue;
            return "atualizou \"Despesa em dinheiro padr\u00E3o\" para \"".concat(newValue, "\" (anteriormente \"").concat(oldValue, "\")");
        },
    ...
    roomMembersPage: {
        ...
        roomArchived: "Parece que esta sala foi arquivada. Em caso de d\u00FAvidas, entre em contato com ".concat(CONST_1.default.EMAIL.CONCIERGE, "."),
        removeMembersPrompt: function (_a) {
            var memberName = _a.memberName;
            return ({
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_14 = {},
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = 'Nunca',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'Último mês',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.THIS_MONTH] = 'Este mês',
                    _14[CONST_1.default.SEARCH.DATE_PRESETS.LAST_STATEMENT] = 'Última declaração',
                    _14),
            },
            status: 'Status',
            ...
            groupBy: (_15 = {},
                ...
                _15[CONST_1.default.SEARCH.GROUP_BY.CARD] = 'Cartão',
                _15[CONST_1.default.SEARCH.GROUP_BY.WITHDRAWAL_ID] = 'ID de retirada',
                _15),
            feed: 'Feed',
            withdrawalType: (_16 = {},
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.EXPENSIFY_CARD] = 'Expensify Card',
                _16[CONST_1.default.SEARCH.WITHDRAWAL_TYPE.REIMBURSEMENT] = 'Reembolso',
                _16),
            is: 'É',
            action: (_17 = {},
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.SUBMIT] = 'Enviar',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.APPROVE] = 'Aprovar',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.PAY] = 'Pagar',
                _17[CONST_1.default.SEARCH.ACTION_FILTERS.EXPORT] = 'Exportar',
                _17),
            reportField: function (_a) {
                var name = _a.name, value = _a.value;
                return "".concat(name, " \u00E9 ").concat(value);
            },
        },
        has: 'Tem',
        groupBy: 'Agrupar por',
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationPrompt: function (_a) {
                var workspaceName = _a.workspaceName;
                return "Tem certeza de que deseja criar outro relat\u00F3rio em ".concat(workspaceName, "? Voc\u00EA pode acessar seus relat\u00F3rios vazios em");
            },
        ...
        actions: {
            type: {
                changeField: function (_a) {
                    ...
                    return "alterou ".concat(fieldName, " para \"").concat(newValue, "\" (anteriormente \"").concat(oldValue, "\")");
                },
                changeFieldEmpty: function (_a) {
                    var newValue = _a.newValue, fieldName = _a.fieldName;
                    return "definiu ".concat(fieldName, " como \"").concat(newValue, "\"");
                },
                changeReportPolicy: function (_a) {
                    var fromPolicyName = _a.fromPolicyName, toPolicyName = _a.toPolicyName;
                    if (!toPolicyName) {
                        return "Espa\u00E7o de trabalho alterado".concat(fromPolicyName ? " (anteriormente ".concat(fromPolicyName, ")") : '');
                    }
                    return "Espa\u00E7o de trabalho alterado para ".concat(toPolicyName).concat(fromPolicyName ? " (anteriormente ".concat(fromPolicyName, ")") : '');
                },
                ...
                exportedToIntegration: {
                    automatic: function (_a) {
                        ...
                        return "exportado para ".concat(translatedLabel);
                    },
    ...
    referralProgram: (_18 = {},
        ...
        _18.copyReferralLink = 'Copiar link de convite',
        _18),
    systemChatFooterMessage: (_19 = {},
        _19[CONST_1.default.INTRO_CHOICES.MANAGE_TEAM] = function (_a) {
            ...
            return "Converse com seu especialista em configura\u00E7\u00E3o em <a href=\"".concat(href, "\">").concat(adminReportName, "</a> para ajuda");
        },
        _19.default = "Mensagem <concierge-link>".concat(CONST_1.default.CONCIERGE_CHAT_NAME, "</concierge-link> para ajuda com a configura\u00E7\u00E3o"),
        _19),
    violations: {
        ...
        overTripLimit: function (_a) {
            var formattedLimit = _a.formattedLimit;
            return "Valor acima do limite de ".concat(formattedLimit, "/viagem");
        },
        ...
        rter: function (_a) {
            ...
            if (brokenBankConnection || rterType === CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? "Conex\u00E3o banc\u00E1ria interrompida. <a href=\"".concat(companyCardPageURL, "\">Reconectar para associar o recibo</a>")
        ...
        adminBrokenConnectionError: function (_a) {
            ...
            return "<muted-text-label>Recibo pendente devido a uma conex\u00E3o banc\u00E1ria interrompida. Resolva em <a href=\"".concat(workspaceCompanyCardRoute, "\">Cart\u00F5es da empresa</a>.</muted-text-label>");
        },
    ...
    exitSurvey: {
        ...
        reasons: (_21 = {},
            _21[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Preciso de um recurso que está disponível apenas no Expensify Classic.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Não entendo como usar o New Expensify.',
            _21[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Eu entendo como usar o New Expensify, mas eu prefiro o Expensify Classic.',
            _21),
        prompts: (_22 = {},
            _22[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Que recurso você precisa que não está disponível no Novo Expensify?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'O que você está tentando fazer?',
            _22[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Por que você prefere o Expensify Classic?',
            _22),
        ...
        benefits: (_23 = {},
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Conversando diretamente em despesas e relatórios',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Capacidade de fazer tudo no celular',
            _23[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Viagem e despesas na velocidade do chat',
            _23),
    ...
    subscription: {
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "Conclua o processo de autentica\u00E7\u00E3o para ativar seu cart\u00E3o que termina em ".concat(cardEnding, ".");
                },
            },
            insufficientFunds: {
                title: 'Não foi possível cobrar no seu cartão',
        ...
        compareModal: {
            ...
            subtitle: "<muted-text>Desbloqueie os recursos de que voc\u00EA precisa com o plano ideal para voc\u00EA. <a href=\"".concat(CONST_1.default.PRICING, "\">Consulte nossa p\u00E1gina de pre\u00E7os</a> ou uma descri\u00E7\u00E3o completa dos recursos de cada um dos nossos planos.</muted-text>"),
        },
        details: {
        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                preventFutureActivity: function (_a) {
                    ...
                    return "Se voc\u00EA deseja evitar atividades e cobran\u00E7as futuras, voc\u00EA deve <a href=\"".concat(workspacesListRoute, "\">excluir seu(s) espa\u00E7o(s) de trabalho</a>. Observe que, ao excluir seu(s) workspace(s), voc\u00EA ser\u00E1 cobrado por qualquer atividade pendente que tenha ocorrido durante o m\u00EAs corrente.");
                },
            },
            requestSubmitted: {
                title: 'Solicitação enviada',
                subtitle: 'Obrigado por nos informar que você está interessado em cancelar sua assinatura. Estamos analisando sua solicitação e entraremos em contato em breve pelo chat com o <concierge-link>Concierge</concierge-link>.',
            },
    ...
    delegate: {
        ...
        notAllowedMessage: function (_a) {
            ...
            return "Como <a href=\"".concat(CONST_1.default.DELEGATE_ROLE_HELP_DOT_ARTICLE_LINK, "\">copiloto</a> do ").concat(accountOwnerEmail, ", voc\u00EA n\u00E3o tem permiss\u00E3o para realizar essa a\u00E7\u00E3o. Desculpe-me!");
        },
    ...
    scheduledCall: {
        book: {
            ...
            slots: function (_a) {
                var date = _a.date;
                return "<muted-text>Hor\u00E1rios dispon\u00EDveis para <strong>".concat(date, "</strong></muted-text>");
            },
        },
        confirmation: {
    ...
    nextStep: {
        message: (_24 = {},
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_ADD_TRANSACTIONS] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando <strong>".concat(actor, "</strong> adicionar despesas.");
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION] = function (_) { return "Nenhuma a\u00E7\u00E3o adicional necess\u00E1ria!"; },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_SUBMITTER_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando <strong>".concat(actor, "</strong> adicionar uma conta banc\u00E1ria.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_AUTOMATIC_SUBMIT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "em ".concat(eta) : " ".concat(eta);
                }
                // eslint-disable-next-line default-case
                switch (actorType) {
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return "Aguardando o envio autom\u00E1tico das <strong>suas</strong> despesas".concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando o envio autom\u00E1tico das despesas de <strong>".concat(actor, "</strong>").concat(formattedETA, ".");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return "Aguardando as despesas de um administrador serem enviadas automaticamente".concat(formattedETA, ".");
                }
            },
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_FIX_ISSUES] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando <strong>".concat(actor, "</strong> corrigir o(s) problema(s).");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando <strong>".concat(actor, "</strong> aprovar as despesas.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando <strong>".concat(actor, "</strong> efetuar o pagamento das despesas.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_POLICY_BANK_ACCOUNT] = function (_a) {
                ...
                switch (actorType) {
                    ...
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return "Aguardando <strong>".concat(actor, "</strong> concluir a configura\u00E7\u00E3o de uma conta banc\u00E1ria empresarial.");
                    case CONST_1.default.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            _24[CONST_1.default.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_PAYMENT] = function (_a) {
                ...
                var formattedETA = '';
                if (eta) {
                    formattedETA = etaType === CONST_1.default.NEXT_STEP.ETA_TYPE.DATE_TIME ? "at\u00E9 ".concat(eta) : " ".concat(eta);
                }
                return "Aguardando a conclus\u00E3o do pagamento".concat(formattedETA, ".");
            },
            _24),
        eta: (_25 = {},
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SHORTLY] = 'em breve',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.TODAY] = 'mais tarde hoje',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_WEEK] = 'no domingo',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.SEMI_MONTHLY] = 'nos dias 1º e 16 de cada mês',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_BUSINESS_DAY_OF_MONTH] = 'no último dia útil do mês',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.LAST_DAY_OF_MONTH] = 'no último dia do mês',
            _25[CONST_1.default.NEXT_STEP.ETA_KEY.END_OF_TRIP] = 'no final da sua viagem',
            _25),
    },
    domain: {
        ...
        verifyDomain: {
            ...
            beforeProceeding: function (_a) {
                ...
                return "Antes de prosseguir, verifique se voc\u00EA \u00E9 o propriet\u00E1rio de <strong>".concat(domainName, "</strong> atualizando as configura\u00E7\u00F5es de DNS.");
            },
            accessYourDNS: function (_a) {
                var domainName = _a.domainName;
                return "Acesse seu provedor de DNS e abra as configura\u00E7\u00F5es de DNS para <strong>".concat(domainName, "</strong>.");
            },
            addTXTRecord: 'Adicione o seguinte registro TXT:',
            saveChanges: 'Salve as alterações e volte aqui para verificar seu domínio.',
            youMayNeedToConsult: "Talvez seja necess\u00E1rio consultar o departamento de TI da sua organiza\u00E7\u00E3o para concluir a verifica\u00E7\u00E3o. <a href=\"".concat(CONST_1.default.DOMAIN_VERIFICATION_HELP_URL, "\">Saiba mais</a>."),
        ...
        domainVerified: {
            ...
            description: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><centered-text>O dom\u00EDnio <strong>".concat(domainName, "</strong> foi verificado com sucesso e agora voc\u00EA pode configurar SAML e outros recursos de seguran\u00E7a.</centered-text></muted-text>");
            },
        },
        saml: 'SAML',
        samlFeatureList: {
            ...
            subtitle: function (_a) {
                var domainName = _a.domainName;
                return "<muted-text><a href=\"".concat(CONST_1.default.SAML_HELP_URL, "\">SAML SSO</a> \u00E9 um recurso de seguran\u00E7a que oferece mais controle sobre como os membros com e-mails do dom\u00EDnio <strong>").concat(domainName, "</strong> fazem login no Expensify. Para ativ\u00E1-lo, voc\u00EA precisar\u00E1 confirmar sua identidade como um administrador autorizado da empresa.</muted-text>");
            },
