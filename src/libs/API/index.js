...
exports.waitForWrites = waitForWrites;
...
var FraudMonitoring_1 = require("@libs/Middleware/FraudMonitoring");
...
(0, Request_1.addMiddleware)(Middleware_1.Logging);
...
(0, Request_1.addMiddleware)(Middleware_1.RecheckConnection);
...
(0, Request_1.addMiddleware)(Middleware_1.Reauthentication);
...
(0, Request_1.addMiddleware)(Middleware_1.handleDeletedAccount);
// Handle supportal permission denial centrally
(0, Request_1.addMiddleware)(Middleware_1.SupportalPermission);
...
(0, Request_1.addMiddleware)(Middleware_1.HandleUnusedOptimisticID);
(0, Request_1.addMiddleware)(Middleware_1.Pagination);
...
(0, Request_1.addMiddleware)(Middleware_1.SaveResponseInOnyx);
// FraudMonitoring - Tags the request with the appropriate Fraud Protection event.
(0, Request_1.addMiddleware)(FraudMonitoring_1.default);
