...
react_native_onyx_1.default.connectWithoutView({
    ...
    callback: function (value) {
        ...
        Sentry.setUser({
            id: value === null || value === void 0 ? void 0 : value.accountID,
...
function reauthenticate(command) {
    ...
    return (0, NetworkStore_1.hasReadRequiredDataFromStorage)().then(function () {
        ...
        return Authenticate({
            ...
            if ((0, Delegate_1.isConnectedAsDelegate)({ delegatedAccess: account === null || account === void 0 ? void 0 : account.delegatedAccess })) {
