...
function getCategoryOptionTree(options, isOneLine, selectedOptions) {
    ...
    Object.values(options).forEach(function (option) {
        if (isOneLine) {
            ...
            var decodedCategoryName = (0, CategoryUtils_1.getDecodedCategoryName)(option.name);
        ...
        option.name.split(CONST_1.default.PARENT_CHILD_SEPARATOR).forEach(function (optionName, index, array) {
            ...
            var decodedCategoryName = (0, CategoryUtils_1.getDecodedCategoryName)(optionName);
            optionCollection.set(searchText, {
                text: "".concat(indents).concat(decodedCategoryName),
...
function getCategoryListSections(_a) {
    var categories = _a.categories, localeCompare = _a.localeCompare, searchValue = _a.searchValue, _b = _a.selectedOptions, selectedOptions = _b === void 0 ? [] : _b, _c = _a.recentlyUsedCategories, recentlyUsedCategories = _c === void 0 ? [] : _c, _d = _a.maxRecentReportsToShow, maxRecentReportsToShow = _d === void 0 ? CONST_1.default.IOU.MAX_RECENT_REPORTS_TO_SHOW : _d, translate = _a.translate;
    var sortedCategories = sortCategories(categories, localeCompare);
    var enabledCategories = Object.values(sortedCategories).filter(function (category) { return category.enabled; });
    var enabledCategoriesNames = new Set(enabledCategories.map(function (category) { return category.name; }));
    ...
    var filteredCategories = enabledCategories.filter(function (category) { return !selectedOptionNames.has(category.name); });
    ...
    var filteredRecentlyUsedCategories = recentlyUsedCategories
        .filter(function (categoryName) { var _a, _b; return !selectedOptionNames.has(categoryName) && ((_a = categories[categoryName]) === null || _a === void 0 ? void 0 : _a.enabled) && ((_b = categories[categoryName]) === null || _b === void 0 ? void 0 : _b.pendingAction) !== CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE; })
...
function sortCategories(categories, localeCompare) {
    ...
    var sortedCategories = Object.values(categories).sort(function (a, b) { return localeCompare(a.name, b.name); });
    ...
    var flatHierarchy = function (initialHierarchy) {
        return Object.values(initialHierarchy).reduce(function (acc, category) {
            ...
            if (!(0, EmptyObject_1.isEmptyObject)(subcategories)) {
                ...
                acc.push.apply(acc, nestedCategories.sort(function (a, b) { return localeCompare(a.name, b.name); }));
            }
            return acc;
        }, []);
    };
