...
exports.isCategoryDescriptionRequired = isCategoryDescriptionRequired;
exports.getDecodedCategoryName = getDecodedCategoryName;
...
function isCategoryDescriptionRequired(policyCategories, category, areRulesEnabled) {
    var _a;
    if (!policyCategories || !category || !areRulesEnabled) {
        return false;
    }
    return !!((_a = policyCategories[category]) === null || _a === void 0 ? void 0 : _a.areCommentsRequired);
}
function getDecodedCategoryName(categoryName) {
    return expensify_common_1.Str.htmlDecode(categoryName);
}
