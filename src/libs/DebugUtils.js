...
function onyxDataToString(data) {
    ...
    return (0, SafeString_1.default)(data);
}
/**
...
function compareStringWithOnyxData(text, data) {
    ...
    return text === (0, SafeString_1.default)(data);
}
/**
    ...
    switch (key) {
        ...
        case 'pendingFields':
            return validateObject(value, {
                ...
                nextStep: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                ...
                hasReportBeenRetracted: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                hasReportBeenReopened: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                isExportedToIntegration: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                hasExportError: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                ...
                expensify_text_title: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                created: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                transactionCount: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
            });
    ...
    switch (key) {
        ...
        case 'pendingFields':
            return validateObject(value, {
                ...
                convertedAmount: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                ...
                isDemoTransaction: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                splitExpensesTotal: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
                taxValue: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION,
            }, 'string');
        case 'receipt':
            return validateObject(value, {
                type: 'string',
...
function getReasonForShowingRowInLHN(_a) {
    var report = _a.report, chatReport = _a.chatReport, doesReportHaveViolations = _a.doesReportHaveViolations, _b = _a.hasRBR, hasRBR = _b === void 0 ? false : _b, isReportArchived = _a.isReportArchived, _c = _a.isInFocusMode, isInFocusMode = _c === void 0 ? false : _c, _d = _a.betas, betas = _d === void 0 ? undefined : _d, draftComment = _a.draftComment;
    if (!report) {
        return null;
    }
