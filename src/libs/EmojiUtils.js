...
var processFrequentlyUsedEmojis = function (emojiList) {
    var _a;
    if (!emojiList) {
        return [];
    }
    var processedFrequentlyUsedEmojis = (_a = emojiList === null || emojiList === void 0 ? void 0 : emojiList.map(function (item) {
        var emoji = item;
        if (!item.code) {
    ...
    processedFrequentlyUsedEmojis.forEach(function (emoji) {
    ...
    return Array.from(frequentlyUsedEmojiCodesToObjects.values()).sort(function (a, b) {
        if (a.count !== b.count) {
...
function containsCustomEmoji(text) {
    ...
    var privateUseAreaRegex = CONST_1.default.REGEX.PRIVATE_USER_AREA;
...
function containsOnlyCustomEmoji(text) {
    ...
    var privateUseAreaRegex = CONST_1.default.REGEX.ONLY_PRIVATE_USER_AREA;
    return privateUseAreaRegex.test(text);
}
