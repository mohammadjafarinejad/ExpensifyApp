...
var createPluralRules = function (locale) { return new Intl.PluralRules(locale); };
var memoizedCreatePluralRules = (0, memoize_1.default)(createPluralRules);
/**
...
function getTranslatedPhrase(language, phraseKey) {
    ...
    if (translatedPhrase) {
        if (typeof translatedPhrase === 'function') {
            ...
            var pluralRule = memoizedCreatePluralRules(language).select(phraseObject.count);
...
function getDevicePreferredLocale() {
    var _a, _b;
    return (_b = (_a = RNLocalize.findBestLanguageTag(Object.values(CONST_1.default.LOCALES))) === null || _a === void 0 ? void 0 : _a.languageTag) !== null && _b !== void 0 ? _b : CONST_1.default.LOCALES.DEFAULT;
}
