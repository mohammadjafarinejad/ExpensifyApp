...
var appGroupName = react_native_hybrid_app_1.default.isHybridApp() ? 'group.com.expensify' : 'group.com.expensify.new';
react_native_app_logs_1.default.configure({ appGroupName: appGroupName, interval: -1 });
