...
var requestsToIgnoreLastUpdateID = new Set([
...
var SaveResponseInOnyx = function (requestResponse, request) {
    return requestResponse.then(function (response) {
        ...
        if (requestsToIgnoreLastUpdateID.has(request.command) || !OnyxUpdates.doesClientNeedToBeUpdated({ previousUpdateID: Number((_d = response === null || response === void 0 ? void 0 : response.previousUpdateID) !== null && _d !== void 0 ? _d : CONST_1.default.DEFAULT_NUMBER_ID) })) {
