 ...
 * at the top
 */
var IOU_ACTIONS_TO_FILTER_OUT = new Set([CONST_1.default.IOU.REPORT_ACTION_TYPE.CREATE, CONST_1.default.IOU.REPORT_ACTION_TYPE.TRACK]);
/**
 ...
 */
function getAllNonDeletedTransactions(transactions, reportActions, isOffline) {
    ...
    return Object.values(transactions !== null && transactions !== void 0 ? transactions : {}).filter(function (transaction) {
        ...
        var action = (0, ReportActionsUtils_1.getIOUActionForTransactionID)(reportActions, transaction.transactionID);
        if ((action === null || action === void 0 ? void 0 : action.pendingAction) === CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE && isOffline) {
            return true;
        }
...
function shouldWaitForTransactions(report, transactions, reportMetadata) {
    ...
    var isStillLoadingData = (transactions === null || transactions === void 0 ? void 0 : transactions.length) === 0 && ((!!(reportMetadata === null || reportMetadata === void 0 ? void 0 : reportMetadata.isLoadingInitialReportActions) && !reportMetadata.hasOnceLoadedReportActions) || (report === null || report === void 0 ? void 0 : report.total) !== 0);
...
var getTotalAmountForIOUReportPreviewButton = function (report, policy, reportPreviewAction) {
    ...
    if (reportPreviewAction === CONST_1.default.REPORT.REPORT_PREVIEW_ACTIONS.PAY) {
        ...
        if ((0, ReportUtils_1.hasHeldExpenses)(report === null || report === void 0 ? void 0 : report.reportID) && canAllowSettlement && hasValidNonHeldAmount && !hasOnlyHeldExpenses) {
