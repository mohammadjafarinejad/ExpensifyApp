...
exports.handleNegativeAmountFlipping = handleNegativeAmountFlipping;
 ...
 */
function handleNegativeAmountFlipping(amount, allowFlippingAmount, toggleNegative) {
    if (allowFlippingAmount && amount.startsWith('-')) {
        toggleNegative === null || toggleNegative === void 0 ? void 0 : toggleNegative();
