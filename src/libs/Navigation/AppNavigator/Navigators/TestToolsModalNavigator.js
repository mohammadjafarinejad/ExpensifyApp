...
function TestToolsModalNavigator() {
    ...
    (0, useKeyboardShortcut_1.default)(CONST_1.default.KEYBOARD_SHORTCUTS.ESCAPE, function () { return (0, TestTool_1.default)(); }, { shouldBubble: false });
    return (<NoDropZone_1.default>
            <Overlay_1.default />
            <PressableWithoutFeedback_1.default ref={outerViewRef} onPress={handleOuterClick} style={[styles.flex1, styles.alignItemsCenter, styles.getTestToolsNavigatorOuterView(shouldUseNarrowLayout)]} accessible={false}>
