...
function addCustomHistoryRouterExtension(originalRouter) {
    return function (options) {
        ...
        var getRehydratedState = function (partialState, configOptions) {
            ...
            if (((_a = state.history) === null || _a === void 0 ? void 0 : _a.at(-1)) === CONST_1.default.NAVIGATION.CUSTOM_HISTORY_ENTRY_SIDE_PANEL) {
                stateWithInitialHistory.history = __spreadArray(__spreadArray([], stateWithInitialHistory.history, true), [CONST_1.default.NAVIGATION.CUSTOM_HISTORY_ENTRY_SIDE_PANEL], false);
                return stateWithInitialHistory;
            }
            return stateWithInitialHistory;
        };
