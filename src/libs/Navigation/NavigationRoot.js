...
var telemetry_1 = require("@src/setup/telemetry");
...
function NavigationRoot(_a) {
    ...
    var _c = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_INTRO_SELECTED, {
        selector: Onboarding_1.wasInvitedToNewDotSelector,
        canBeMissing: true,
    ...
    var onboardingValues = (0, OnyxListItemProvider_1.useOnboardingValues)();
    ...
    var initialState = (0, react_1.useMemo)(function () {
        ...
        if ((0, shouldOpenLastVisitedPath_1.default)(lastVisitedPath) && authenticated) {
            ...
            var isSpecificDeepLink = path && !isRootPath;
            if (!isSpecificDeepLink) {
                Log_1.default.info('Restoring last visited path on app startup', false, { lastVisitedPath: lastVisitedPath, initialUrl: initialUrl, path: path });
                return (0, getAdaptedStateFromPath_1.default)(lastVisitedPath, linkingConfig_1.linkingConfig.config);
            }
        }
    ...
    var onReadyWithSentry = (0, react_1.useCallback)(function () {
        onReady();
        telemetry_1.navigationIntegration.registerNavigationContainer(Navigation_1.navigationRef);
    }, [onReady]);
    return (<native_1.NavigationContainer initialState={initialState} onStateChange={handleStateChange} onReady={onReadyWithSentry} theme={navigationTheme} ref={Navigation_1.navigationRef} linking={linkingConfig_1.linkingConfig} documentTitle={{
            enabled: false,
        }}>
