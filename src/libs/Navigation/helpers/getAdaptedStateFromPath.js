...
function getMatchingFullScreenRoute(route) {
    ...
    if (RELATIONS_1.RHP_TO_WORKSPACES_LIST[route.name]) {
        return {
            ...
            path: (0, normalizePath_1.default)(ROUTES_1.default.WORKSPACES_LIST.route),
        };
    }
    ...
    if (RELATIONS_1.RHP_TO_DOMAIN[route.name]) {
        var paramsFromRoute = (0, getParamsFromRoute_1.default)(RELATIONS_1.RHP_TO_DOMAIN[route.name]);
        return (0, getInitialSplitNavigatorState_1.default)({
            name: SCREENS_1.default.DOMAIN.INITIAL,
            params: paramsFromRoute.length > 0 ? (0, pick_1.default)(route.params, paramsFromRoute) : undefined,
        }, {
            name: RELATIONS_1.RHP_TO_DOMAIN[route.name],
            params: paramsFromRoute.length > 0 ? (0, pick_1.default)(route.params, paramsFromRoute) : undefined,
        });
    }
    return undefined;
