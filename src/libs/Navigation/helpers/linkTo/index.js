...
function areNamesAndParamsEqual(currentState, stateFromPath) {
    var currentFocusedRoute = (0, native_1.findFocusedRoute)(currentState);
    var targetFocusedRoute = (0, native_1.findFocusedRoute)(stateFromPath);
    var areNamesEqual = (currentFocusedRoute === null || currentFocusedRoute === void 0 ? void 0 : currentFocusedRoute.name) === (targetFocusedRoute === null || targetFocusedRoute === void 0 ? void 0 : targetFocusedRoute.name);
    var areParamsEqual = (0, ObjectUtils_1.shallowCompare)(currentFocusedRoute === null || currentFocusedRoute === void 0 ? void 0 : currentFocusedRoute.params, targetFocusedRoute === null || targetFocusedRoute === void 0 ? void 0 : targetFocusedRoute.params);
    return areNamesEqual && areParamsEqual;
}
function arePathAndBackToEqual(stateFromPath) {
    var _a;
    var focusedRouteFromPath = (0, native_1.findFocusedRoute)(stateFromPath);
    var params = (_a = focusedRouteFromPath === null || focusedRouteFromPath === void 0 ? void 0 : focusedRouteFromPath.params) !== null && _a !== void 0 ? _a : {};
    if (!(focusedRouteFromPath === null || focusedRouteFromPath === void 0 ? void 0 : focusedRouteFromPath.path) || !('backTo' in params) || !params.backTo || typeof params.backTo !== 'string') {
        return false;
    }
    var cleanedPath = focusedRouteFromPath.path.replace(/\?.*/, '');
    var cleanedBackTo = params.backTo.replace(/\?.*/, '');
...
function isNavigatingToAttachmentScreen(focusedRouteName) {
    return focusedRouteName === SCREENS_1.default.REPORT_ATTACHMENTS;
}
...
function linkTo(navigation, path, options) {
    ...
    var normalizedPath = (0, normalizePath_1.default)(path);
    ...
    var stateFromPath = (0, getStateFromPath_1.default)(normalizedPathAfterRedirection);
    ...
    if (shouldCheckFullScreenRouteMatching(action)) {
        var newFocusedRoute = (0, native_1.findFocusedRoute)(stateFromPath);
        if (newFocusedRoute) {
            var matchingFullScreenRoute_1 = (0, getAdaptedStateFromPath_1.getMatchingFullScreenRoute)(newFocusedRoute);
            var lastFullScreenRoute = currentState.routes.findLast(function (route) { return (0, getAdaptedStateFromPath_1.isFullScreenName)(route.name); });
            if (matchingFullScreenRoute_1 && lastFullScreenRoute && matchingFullScreenRoute_1.name !== lastFullScreenRoute.name) {
                var isMatchingRoutePreloaded = currentState.preloadedRoutes.some(function (preloadedRoute) { return preloadedRoute.name === matchingFullScreenRoute_1.name; });
                if (isMatchingRoutePreloaded) {
                    navigation.dispatch(native_1.StackActions.push(matchingFullScreenRoute_1.name));
                }
                else {
                    var lastRouteInMatchingFullScreen = (_c = (_b = matchingFullScreenRoute_1.state) === null || _b === void 0 ? void 0 : _b.routes) === null || _c === void 0 ? void 0 : _c.at(-1);
                    var additionalAction = native_1.StackActions.push(matchingFullScreenRoute_1.name, {
    ...
    var minimalAction = (0, getMinimalAction_1.default)(action, navigation.getRootState()).action;
