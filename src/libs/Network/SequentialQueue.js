...
exports.getShouldFailAllRequests = getShouldFailAllRequests;
...
function process() {
    ...
    currentRequestPromise = (0, Request_1.processWithMiddleware)(requestToProcess, true)
        ...
        if (error.message === CONST_1.default.ERROR.THROTTLED && requestToProcess.command === types_1.WRITE_COMMANDS.RESEND_VALIDATE_CODE) {
            react_native_onyx_1.default.update((_b = requestToProcess.failureData) !== null && _b !== void 0 ? _b : []);
            (0, PersistedRequests_1.endRequestAndRemoveFromQueue)(requestToProcess);
            sequentialQueueRequestThrottle.clear();
            return process();
        }
        ...
        return sequentialQueueRequestThrottle
            ...
            (0, PersistedRequests_1.endRequestAndRemoveFromQueue)(requestToProcess);
            sequentialQueueRequestThrottle.clear();
            if (requestToProcess.command === types_1.WRITE_COMMANDS.OPEN_APP) {
                (0, isOpenAppFailureModalOpen_1.setIsOpenAppFailureModalOpen)(true);
            }
            return process();
        });
    });
...
function getShouldFailAllRequests() {
...
(0, PersistedRequests_1.onInitialization)(flush);
