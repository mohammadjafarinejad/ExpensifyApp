...
react_native_onyx_1.default.connectWithoutView({
    ...
    callback: function (val) {
        var _a;
        stashedSupportLogin = (_a = val === null || val === void 0 ? void 0 : val.login) !== null && _a !== void 0 ? _a : '';
    },
});
/**
...
function enhanceParameters(command, parameters) {
    ...
    if (isAuthTokenRequired(command) && !parameters.authToken) {
        finalParameters.authToken = (_a = (0, NetworkStore_1.getAuthToken)()) !== null && _a !== void 0 ? _a : null;
    }
    ...
    finalParameters.email = (_b = parameters.email) !== null && _b !== void 0 ? _b : (0, NetworkStore_1.getCurrentUserEmail)();
