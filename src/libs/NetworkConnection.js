...
var isNetworkStatusInitialized = false;
...
react_native_onyx_1.default.connectWithoutView({
    ...
    callback: function (network) {
        ...
        networkTimeSkew = (_a = network === null || network === void 0 ? void 0 : network.timeSkew) !== null && _a !== void 0 ? _a : 0;
        if (!(network === null || network === void 0 ? void 0 : network.lastOfflineAt)) {
            (0, Network_1.setNetworkLastOffline)(new Date().toISOString());
        }
        var newIsOffline = (_b = network === null || network === void 0 ? void 0 : network.isOffline) !== null && _b !== void 0 ? _b : network === null || network === void 0 ? void 0 : network.shouldForceOffline;
...
function getDBTimeWithSkew(timestamp) {
    ...
    if (networkTimeSkew > 0) {
        ...
        return DateUtils_1.default.getDBTime(datetime.valueOf() + networkTimeSkew);
    }
    return DateUtils_1.default.getDBTime(timestamp);
}
...
function subscribeToNetInfo(accountID) {
    ...
    if (!CONFIG_1.default.IS_USING_LOCAL_WEB) {
        ...
        netinfo_1.default.configure({
            ...
            reachabilityUrl: "".concat(CONFIG_1.default.EXPENSIFY.DEFAULT_API_ROOT, "api/Ping?accountID=").concat(accountID !== null && accountID !== void 0 ? accountID : 'unknown'),
