...
function showModifiedExpenseNotification(_a) {
    ...
    BrowserNotifications_1.default.pushModifiedExpenseNotification({ report: report, reportAction: reportAction, movedFromReport: movedFromReport, movedToReport: movedToReport, onClick: onClick });
}
