...
function getDestinationListSections(_a) {
    var destinations = _a.destinations, searchValue = _a.searchValue, _b = _a.selectedOptions, selectedOptions = _b === void 0 ? [] : _b, _c = _a.recentlyUsedDestinations, recentlyUsedDestinations = _c === void 0 ? [] : _c, _d = _a.maxRecentReportsToShow, maxRecentReportsToShow = _d === void 0 ? CONST_1.default.IOU.MAX_RECENT_REPORTS_TO_SHOW : _d, translate = _a.translate;
    ...
    var selectedOptionRateIDs = new Set(selectedOptions.map(function (selectedOption) { return selectedOption.rateID; }));
    if (sortedDestinations.length < CONST_1.default.STANDARD_LIST_ITEM_LIMIT) {
        var filteredNonSelectedDestinations = sortedDestinations.filter(function (_a) {
            ...
            return !selectedOptionRateIDs.has(rateID);
        });
    ...
    var filteredRecentlyUsedDestinations = sortedDestinations.filter(function (_a) {
        var rateID = _a.rateID;
        return recentlyUsedDestinations.includes(rateID) && !selectedOptionRateIDs.has(rateID);
    });
