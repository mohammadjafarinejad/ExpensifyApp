...
exports.getUberConnectionErrorDirectlyFromPolicy = getUberConnectionErrorDirectlyFromPolicy;
...
exports.hasOnlyPersonalPolicies = hasOnlyPersonalPolicies;
...
exports.getDefaultChatEnabledPolicy = getDefaultChatEnabledPolicy;
...
exports.getCustomUnitsForDuplication = getCustomUnitsForDuplication;
...
exports.hasDynamicExternalWorkflow = hasDynamicExternalWorkflow;
exports.getPolicyEmployeeAccountIDs = getPolicyEmployeeAccountIDs;
exports.isMemberPolicyAdmin = isMemberPolicyAdmin;
exports.getActivePoliciesWithExpenseChatAndPerDiemEnabled = getActivePoliciesWithExpenseChatAndPerDiemEnabled;
...
function getActivePoliciesWithExpenseChatAndPerDiemEnabled(policies, currentUserLogin) {
    return getActivePoliciesWithExpenseChat(policies, currentUserLogin).filter(function (policy) { return policy === null || policy === void 0 ? void 0 : policy.arePerDiemRatesEnabled; });
}
/**
...
function getCustomUnitsForDuplication(policy, isCustomUnitsOptionSelected, isPerDiemOptionSelected) {
    var _a, _b;
    var customUnits = policy === null || policy === void 0 ? void 0 : policy.customUnits;
    ...
    if (isCustomUnitsOptionSelected) {
        var distanceCustomUnit = Object.values(customUnits).find(function (customUnit) { return customUnit.name === CONST_1.default.CUSTOM_UNITS.NAME_DISTANCE; });
        if (!distanceCustomUnit) {
            return undefined;
        }
        return _a = {}, _a[distanceCustomUnit.customUnitID] = distanceCustomUnit, _a;
    }
    var perDiemUnit = Object.values(customUnits).find(function (customUnit) { return customUnit.name === CONST_1.default.CUSTOM_UNITS.NAME_PER_DIEM_INTERNATIONAL; });
    if (!perDiemUnit) {
        return undefined;
    }
    return _b = {}, _b[perDiemUnit.customUnitID] = perDiemUnit, _b;
}
/**
 * Retrieves custom unit rate object from the given customUnitRateID
 */
...
function isPolicyMember(policy, userLogin) {
    var _a;
    return !!policy && !!userLogin && (!!((_a = policy.employeeList) === null || _a === void 0 ? void 0 : _a[userLogin]) || policy.owner === userLogin);
}
function isPolicyMemberWithoutPendingDelete(currentUserLogin, policy) {
    var _a;
    if (!currentUserLogin || !(policy === null || policy === void 0 ? void 0 : policy.id)) {
        return false;
    }
    var policyEmployee = (_a = policy === null || policy === void 0 ? void 0 : policy.employeeList) === null || _a === void 0 ? void 0 : _a[currentUserLogin];
...
function isPolicyPayer(policy, currentUserLogin) {
    ...
    var isReimburser = policy.reimburser === currentUserLogin;
...
function getUberConnectionErrorDirectlyFromPolicy(policy) {
    var _a;
    var receiptUber = (_a = policy === null || policy === void 0 ? void 0 : policy.receiptPartners) === null || _a === void 0 ? void 0 : _a.uber;
    return !!(receiptUber === null || receiptUber === void 0 ? void 0 : receiptUber.error);
}
...
function getTagListByOrderWeight(policyTagList, orderWeight) {
    ...
    return (_a = Object.values(policyTagList).find(function (tag) { return tag.orderWeight === orderWeight; })) !== null && _a !== void 0 ? _a : tagListEmpty;
}
...
function getCommaSeparatedTagNameWithSanitizedColons(tag) {
    return (0, TransactionUtils_1.getTagArrayFromName)(tag)
        .filter(function (tagItem) { return tagItem !== ''; })
 ...
 */
function hasDynamicExternalWorkflow(policy) {
    return (policy === null || policy === void 0 ? void 0 : policy.approvalMode) === CONST_1.default.POLICY.APPROVAL_MODE.DYNAMICEXTERNAL;
}
/**
...
function isPolicyFeatureEnabled(policy, featureName) {
    ...
    if (featureName === CONST_1.default.POLICY.MORE_FEATURES.ARE_RECEIPT_PARTNERS_ENABLED) {
        return (_c = (_b = policy === null || policy === void 0 ? void 0 : policy.receiptPartners) === null || _b === void 0 ? void 0 : _b.enabled) !== null && _c !== void 0 ? _c : false;
    }
...
function getDefaultApprover(policy) {
    ...
    return (policy === null || policy === void 0 ? void 0 : policy.approver) || (policy === null || policy === void 0 ? void 0 : policy.owner) || '';
}
...
function getNetSuiteApprovalAccountOptions(policy, selectedBankAccountId, translate) {
    var _a, _b;
    var payableAccounts = (_b = (_a = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _a === void 0 ? void 0 : _a.netsuite) === null || _b === void 0 ? void 0 : _b.options.data.payableList;
...
function getNetSuiteImportCustomFieldLabel(policy, importField, translate, localeCompare) {
    ...
    var importedTypes = Array.from(mappingSet)
        .sort(function (a, b) { return localeCompare(b, a); })
 ...
 */
var sortWorkspacesBySelected = function (workspace1, workspace2, selectedWorkspaceIDs, localeCompare) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    if (workspace1.policyID && (selectedWorkspaceIDs === null || selectedWorkspaceIDs === void 0 ? void 0 : selectedWorkspaceIDs.includes(workspace1 === null || workspace1 === void 0 ? void 0 : workspace1.policyID)) && workspace2.policyID && (selectedWorkspaceIDs === null || selectedWorkspaceIDs === void 0 ? void 0 : selectedWorkspaceIDs.includes(workspace2.policyID))) {
        return localeCompare((_b = (_a = workspace1.name) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '', (_d = (_c = workspace2.name) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : '');
    }
    if (workspace1.policyID && (selectedWorkspaceIDs === null || selectedWorkspaceIDs === void 0 ? void 0 : selectedWorkspaceIDs.includes(workspace1 === null || workspace1 === void 0 ? void 0 : workspace1.policyID))) {
        return -1;
    }
    if (workspace2.policyID && (selectedWorkspaceIDs === null || selectedWorkspaceIDs === void 0 ? void 0 : selectedWorkspaceIDs.includes(workspace2.policyID))) {
        return 1;
    }
    return localeCompare((_f = (_e = workspace1.name) === null || _e === void 0 ? void 0 : _e.toLowerCase()) !== null && _f !== void 0 ? _f : '', (_h = (_g = workspace2.name) === null || _g === void 0 ? void 0 : _g.toLowerCase()) !== null && _h !== void 0 ? _h : '');
};
...
function getValidConnectedIntegration(policy, accountingIntegrations) {
    return (accountingIntegrations !== null && accountingIntegrations !== void 0 ? accountingIntegrations : Object.values(CONST_1.default.POLICY.CONNECTIONS.NAME)).find(function (integration) { var _a; return !!((_a = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _a === void 0 ? void 0 : _a[integration]) && !(0, connections_1.isConnectionUnverified)(policy, integration); });
}
...
function hasUnsupportedIntegration(policy) {
    return Object.values(CONST_1.default.POLICY.CONNECTIONS.UNSUPPORTED_NAMES).some(function (integration) { var _a; return !!((_a = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _a === void 0 ? void 0 : _a[integration]); });
}
function hasSupportedOnlyOnOldDotIntegration(policy) {
    return Object.values(CONST_1.default.POLICY.CONNECTIONS.SUPPORTED_ONLY_ON_OLDDOT).some(function (integration) { var _a; return !!((_a = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _a === void 0 ? void 0 : _a[integration]); });
}
...
function hasOnlyPersonalPolicies(policies) {
    return !Object.values(policies !== null && policies !== void 0 ? policies : {}).some(function (policy) { return policy && policy.type !== CONST_1.default.POLICY.TYPE.PERSONAL && policy.pendingAction !== CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE; });
}
...
function getUserFriendlyWorkspaceType(workspaceType, translate) {
...
function isPolicyAccessible(policy, currentUserLogin) {
    return (!(0, EmptyObject_1.isEmptyObject)(policy) &&
        (Object.keys(policy).length !== 1 || (0, EmptyObject_1.isEmptyObject)(policy.errors)) &&
...
function areAllGroupPoliciesExpenseChatDisabled(policies) {
    var groupPolicies = Object.values(policies !== null && policies !== void 0 ? policies : {}).filter(isPaidGroupPolicy);
 ...
 */
function getDefaultChatEnabledPolicy(groupPoliciesWithChatEnabled, activePolicy) {
...
function canModifyPlan(ownerPolicies, policy) {
    var _a;
    if (!(policy === null || policy === void 0 ? void 0 : policy.id)) {
        return ((_a = ownerPolicies === null || ownerPolicies === void 0 ? void 0 : ownerPolicies.length) !== null && _a !== void 0 ? _a : 0) > 1;
    }
...
function isCurrentUserMemberOfAnyPolicy() {
    return Object.values(allPolicies !== null && allPolicies !== void 0 ? allPolicies : {}).some(function (policy) { return (policy === null || policy === void 0 ? void 0 : policy.isPolicyExpenseChatEnabled) && (policy === null || policy === void 0 ? void 0 : policy.id) && policy.id !== CONST_1.default.POLICY.ID_FAKE; });
}
/**
...
function isMemberPolicyAdmin(policy, memberEmail) {
    ...
    var admins = getAdminEmployees(policy);
    return admins.some(function (admin) { return admin.email === memberEmail; });
}
