...
var preventTextInputFocusOnFirstResponderOnce_1 = require("./preventTextInputFocusOnFirstResponderOnce");
...
function focus(shouldFocusForNonBlurInputOnTapOutside) {
    ...
    if (!navigationState || (!(0, isReportOpenInRHP_1.default)(navigationState) && (focusedRoute === null || focusedRoute === void 0 ? void 0 : focusedRoute.name) !== SCREENS_1.default.REPORT && (focusedRoute === null || focusedRoute === void 0 ? void 0 : focusedRoute.name) !== SCREENS_1.default.SEARCH.MONEY_REQUEST_REPORT)) {
        return;
    }
...
function preventComposerFocusOnFirstResponderOnce() {
    (0, preventTextInputFocusOnFirstResponderOnce_1.default)(composerRef);
}
/**
...
function preventEditComposerFocusOnFirstResponderOnce() {
    (0, preventTextInputFocusOnFirstResponderOnce_1.default)(editComposerRef);
}
exports.default = {
    ...
    preventComposerFocusOnFirstResponderOnce: preventComposerFocusOnFirstResponderOnce,
    preventEditComposerFocusOnFirstResponderOnce: preventEditComposerFocusOnFirstResponderOnce,
};
