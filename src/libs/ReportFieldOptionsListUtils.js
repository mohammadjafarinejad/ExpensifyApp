...
function getReportFieldOptionsSection(_a) {
    var options = _a.options, recentlyUsedOptions = _a.recentlyUsedOptions, selectedOptions = _a.selectedOptions, searchValue = _a.searchValue, translate = _a.translate;
