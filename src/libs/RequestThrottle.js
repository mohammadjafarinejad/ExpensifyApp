...
var RequestThrottle = /** @class */ (function () {
    ...
    RequestThrottle.prototype.clear = function () {
        ...
        this.requestRetryCount = 0;
        if (this.timeoutID) {
            Log_1.default.info("[RequestThrottle - ".concat(this.name, "] clearing timeoutID: ").concat((0, SafeString_1.default)(this.timeoutID)));
    ...
    RequestThrottle.prototype.sleep = function (error, command) {
        ...
        return new Promise(function (resolve, reject) {
            var maxRequestRetries = command === types_1.WRITE_COMMANDS.OPEN_APP ? CONST_1.default.NETWORK.MAX_OPEN_APP_REQUEST_RETRIES : CONST_1.default.NETWORK.MAX_REQUEST_RETRIES;
            if (_this.requestRetryCount <= maxRequestRetries) {
