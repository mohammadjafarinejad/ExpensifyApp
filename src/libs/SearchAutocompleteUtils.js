...
var userFriendlyExpenseTypeList = Object.values(CONST_1.default.SEARCH.TRANSACTION_TYPE).map(function (value) { return (0, SearchQueryUtils_1.getUserFriendlyValue)(value); });
var userFriendlyGroupByList = Object.values(CONST_1.default.SEARCH.GROUP_BY).map(function (value) { return (0, SearchQueryUtils_1.getUserFriendlyValue)(value); });
var userFriendlyStatusList = Object.values(__assign(__assign(__assign(__assign({}, CONST_1.default.SEARCH.STATUS.EXPENSE), CONST_1.default.SEARCH.STATUS.INVOICE), CONST_1.default.SEARCH.STATUS.TRIP), CONST_1.default.SEARCH.STATUS.TASK)).map(function (value) { return (0, SearchQueryUtils_1.getUserFriendlyValue)(value); });
/**
 * @private
 */
function filterOutRangesWithCorrectValue(range, substitutionMap, userLogins, currencyList, categoryList, tagList) {
    ...
    var expenseTypeList = userFriendlyExpenseTypeList;
    var withdrawalTypeList = Object.values(CONST_1.default.SEARCH.WITHDRAWAL_TYPE);
    var statusList = userFriendlyStatusList;
    var groupByList = userFriendlyGroupByList;
    ...
    var datePresetList = Object.values(CONST_1.default.SEARCH.DATE_PRESETS);
    var hasList = Object.values(CONST_1.default.SEARCH.HAS_VALUES);
    var isList = Object.values(CONST_1.default.SEARCH.IS_VALUES);
    if (range.key.startsWith(CONST_1.default.SEARCH.REPORT_FIELD.GLOBAL_PREFIX)) {
    ...
    switch (range.key) {
        ...
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.MERCHANT:
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.DESCRIPTION:
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.TITLE:
            return range.value.length > 0;
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.WITHDRAWAL_ID:
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.REPORT_ID:
            return !['', 'null', 'undefined', '0', '-1'].includes(range.value);
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.TOTAL:
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.PURCHASE_AMOUNT:
        case CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.AMOUNT:
...
function parseForLiveMarkdown(input, currentUserName, map, userLogins, currencyList, categoryList, tagList) {
    ...
    return ranges
        ...
        .map(function (range) {
        var isCurrentUserMention = userLogins.get().includes(range.value) || range.value === currentUserName || range.value === CONST_1.default.SEARCH.ME;
