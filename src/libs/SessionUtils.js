...
exports.checkIfShouldUseNewPartnerName = checkIfShouldUseNewPartnerName;
var react_native_onyx_1 = require("react-native-onyx");
var CONFIG_1 = require("@src/CONFIG");
var ONYXKEYS_1 = require("@src/ONYXKEYS");
var NEW_PARTNER_USER_ID_PREFIX = 'expensify.cash-';
/**
...
function checkIfShouldUseNewPartnerName(partnerUserID) {
    ...
    if (partnerUserID === null || partnerUserID === void 0 ? void 0 : partnerUserID.startsWith(NEW_PARTNER_USER_ID_PREFIX)) {
        return true;
    }
    return false;
}
