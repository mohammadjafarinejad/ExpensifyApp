...
var getReviewNavigationRoute = function (backTo, threadReportID, transaction, duplicates, policyCategories) {
    // Clear the draft before selecting a different expense to prevent merging fields from the previous expense
    // (e.g., category, tag, tax) that may be not enabled/available in the new expense's policy.
    (0, Transaction_1.abandonReviewDuplicateTransactions)();
    var comparisonResult = (0, TransactionUtils_1.compareDuplicateTransactionFields)(transaction, duplicates, transaction === null || transaction === void 0 ? void 0 : transaction.reportID, transaction === null || transaction === void 0 ? void 0 : transaction.transactionID, policyCategories);
    ...
    if (comparisonResult.change.merchant) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_MERCHANT_PAGE.getRoute(threadReportID, backTo);
    }
    if (comparisonResult.change.category) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_CATEGORY_PAGE.getRoute(threadReportID, backTo);
    }
    if (comparisonResult.change.tag) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_TAG_PAGE.getRoute(threadReportID, backTo);
    }
    if (comparisonResult.change.description) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_DESCRIPTION_PAGE.getRoute(threadReportID, backTo);
    }
    if (comparisonResult.change.taxCode) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_TAX_CODE_PAGE.getRoute(threadReportID, backTo);
    }
    if (comparisonResult.change.billable) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_BILLABLE_PAGE.getRoute(threadReportID, backTo);
    }
    if (comparisonResult.change.reimbursable) {
        return ROUTES_1.default.TRANSACTION_DUPLICATE_REVIEW_REIMBURSABLE_PAGE.getRoute(threadReportID, backTo);
    }
    return ROUTES_1.default.TRANSACTION_DUPLICATE_CONFIRMATION_PAGE.getRoute(threadReportID, backTo);
};
...
function getMultiLevelTagViolationsCount(violations) {
    return violations === null || violations === void 0 ? void 0 : violations.reduce(function (acc, violation) {
        var _a, _b, _c;
        if (violation.type === CONST_1.default.VIOLATION_TYPES.VIOLATION && violation.name === CONST_1.default.VIOLATIONS.SOME_TAG_LEVELS_REQUIRED) {
            var violationCount = (_c = (_b = (_a = violation === null || violation === void 0 ? void 0 : violation.data) === null || _a === void 0 ? void 0 : _a.errorIndexes) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0;
            return acc + violationCount;
        }
        return acc;
    }, 0);
}
function getViolationTranslatePath(violations, hasFieldErrors, violationMessage, isTransactionOnHold, shouldShowOnlyViolations) {
    var _a, _b;
    ...
    var violationsCount = (_a = filteredViolations.length) !== null && _a !== void 0 ? _a : 0;
    var tagViolationsCount = (_b = getMultiLevelTagViolationsCount(filteredViolations)) !== null && _b !== void 0 ? _b : 0;
    var hasViolationsAndHold = violationsCount > 0 && isTransactionOnHold;
    var isTooLong = violationsCount > 1 || tagViolationsCount > 1 || violationMessage.length > CONST_1.default.REPORT_VIOLATIONS.RBR_MESSAGE_MAX_CHARACTERS_FOR_PREVIEW;
...
function getUniqueActionErrorsForTransaction(reportActions, transaction) {
    var reportErrors = Object.values(reportActions).map(function (reportAction) {
        ...
        if ((0, ReportActionsUtils_1.isMoneyRequestAction)(reportAction) && ((_c = (0, ReportActionsUtils_1.getOriginalMessage)(reportAction)) === null || _c === void 0 ? void 0 : _c.IOUTransactionID)) {
            if (((_d = (0, ReportActionsUtils_1.getOriginalMessage)(reportAction)) === null || _d === void 0 ? void 0 : _d.IOUTransactionID) === (transaction === null || transaction === void 0 ? void 0 : transaction.transactionID)) {
...
function getTransactionPreviewTextAndTranslationPaths(_a) {
    ...
    var isPaidGroupPolicy = (0, ReportUtils_1.isPaidGroupPolicy)(iouReport);
    var hasViolationsOfTypeNotice = (0, TransactionUtils_1.hasNoticeTypeViolation)(transaction, violations, true) && isPaidGroupPolicy;
    var hasActionWithErrors = (0, ReportUtils_1.hasActionWithErrorsForTransaction)(iouReport === null || iouReport === void 0 ? void 0 : iouReport.reportID, transaction);
    ...
    var path = getViolationTranslatePath(violations, hasFieldErrors, violationMessage !== null && violationMessage !== void 0 ? violationMessage : '', isTransactionOnHold, !isPaidGroupPolicy);
    if (path.translationPath === 'violations.reviewRequired' || (RBRMessage === undefined && violationMessage)) {
        RBRMessage = path;
    }
    if ((RBRMessage === undefined || RBRMessage.text === '') && (0, TransactionUtils_1.isDistanceRequest)(transaction) && violationMessage) {
        var hasModifiedAmountViolation = violations === null || violations === void 0 ? void 0 : violations.some(function (violation) { return violation.name === CONST_1.default.VIOLATIONS.MODIFIED_AMOUNT && (violation.type === CONST_1.default.VIOLATION_TYPES.VIOLATION || violation.type === CONST_1.default.VIOLATION_TYPES.NOTICE); });
    ...
    if (RBRMessage === undefined && hasActionWithErrors && !!reportActions) {
        var actionsWithErrors = getUniqueActionErrorsForTransaction(reportActions, transaction);
...
function createTransactionPreviewConditionals(_a) {
    ...
    var isSettlementOrApprovalPartial = !!((_b = iouReport === null || iouReport === void 0 ? void 0 : iouReport.pendingFields) === null || _b === void 0 ? void 0 : _b.partial);
    var hasViolationsOfTypeNotice = (0, TransactionUtils_1.hasNoticeTypeViolation)(transaction, violations) && iouReport && (0, ReportUtils_1.isPaidGroupPolicy)(iouReport);
    var hasFieldErrors = (0, TransactionUtils_1.hasMissingSmartscanFields)(transaction);
    var isFetchingWaypoints = (0, TransactionUtils_1.isFetchingWaypointsFromServer)(transaction);
    var isTransactionOnHold = (0, TransactionUtils_1.isOnHold)(transaction);
    ...
    var hasAnyViolations = (0, TransactionUtils_1.isUnreportedAndHasInvalidDistanceRateTransaction)(transaction) ||
        // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
        hasViolationsOfTypeNotice ||
        (0, TransactionUtils_1.hasWarningTypeViolation)(transaction, violations) ||
        (0, TransactionUtils_1.hasViolation)(transaction, violations, true) ||
        ((0, TransactionUtils_1.isDistanceRequest)(transaction) &&
            (violations === null || violations === void 0 ? void 0 : violations.some(function (violation) { return violation.name === CONST_1.default.VIOLATIONS.MODIFIED_AMOUNT && (violation.type === CONST_1.default.VIOLATION_TYPES.VIOLATION || violation.type === CONST_1.default.VIOLATION_TYPES.NOTICE); })));
    var hasErrorOrOnHold = hasFieldErrors || (!isFullySettled && !isFullyApproved && isTransactionOnHold);
    var hasReportViolationsOrActionErrors = ((0, ReportUtils_1.isReportOwner)(iouReport) && (0, ReportUtils_1.hasReportViolations)(iouReport === null || iouReport === void 0 ? void 0 : iouReport.reportID)) || (0, ReportUtils_1.hasActionWithErrorsForTransaction)(iouReport === null || iouReport === void 0 ? void 0 : iouReport.reportID, transaction);
    var shouldShowRBR = hasAnyViolations || hasErrorOrOnHold || hasReportViolationsOrActionErrors || (0, ReportUtils_1.hasReceiptError)(transaction);
