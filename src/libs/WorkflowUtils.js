...
exports.getEligibleExistingBusinessBankAccounts = getEligibleExistingBusinessBankAccounts;
...
function convertPolicyEmployeesToApprovalWorkflows(_a) {
    var _b, _c, _d;
    var policy = _a.policy, personalDetails = _a.personalDetails, firstApprover = _a.firstApprover, localeCompare = _a.localeCompare;
    var employees = (_b = policy === null || policy === void 0 ? void 0 : policy.employeeList) !== null && _b !== void 0 ? _b : {};
    ...
    var sortedApprovalWorkflows = Object.values(approvalWorkflows).sort(function (a, b) {
        ...
        return localeCompare((_b = (_a = a.approvers.at(0)) === null || _a === void 0 ? void 0 : _a.displayName) !== null && _b !== void 0 ? _b : '', (_d = (_c = b.approvers.at(0)) === null || _c === void 0 ? void 0 : _c.displayName) !== null && _d !== void 0 ? _d : '');
    });
    ...
    var availableMembers = (policy === null || policy === void 0 ? void 0 : policy.approvalMode) === CONST_1.default.POLICY.APPROVAL_MODE.BASIC ? sortedApprovalWorkflows === null || sortedApprovalWorkflows === void 0 ? void 0 : sortedApprovalWorkflows.flatMap(function (workflow) { return workflow.members; }) : ((_d = (_c = sortedApprovalWorkflows.at(0)) === null || _c === void 0 ? void 0 : _c.members) !== null && _d !== void 0 ? _d : []);
    return { approvalWorkflows: sortedApprovalWorkflows, usedApproverEmails: __spreadArray([], usedApproverEmails, true), availableMembers: availableMembers };
}
/**
...
function convertApprovalWorkflowToPolicyEmployees(_a) {
    var approvalWorkflow = _a.approvalWorkflow, previousEmployeeList = _a.previousEmployeeList, membersToRemove = _a.membersToRemove, approversToRemove = _a.approversToRemove, type = _a.type, defaultApprover = _a.defaultApprover;
    ...
    membersToRemove === null || membersToRemove === void 0 ? void 0 : membersToRemove.forEach(function (_a) {
        var email = _a.email;
        updatedEmployeeList[email] = __assign(__assign({}, (updatedEmployeeList[email] ? updatedEmployeeList[email] : { email: email })), { submitsTo: defaultApprover, pendingAction: pendingAction });
    });
 ...
 */
function getEligibleExistingBusinessBankAccounts(bankAccountList, policyCurrency) {
    if (!bankAccountList || policyCurrency === undefined) {
        return [];
    }
    return Object.values(bankAccountList).filter(function (account) {
        var _a, _b;
        return account.bankCurrency === policyCurrency && ((_a = account.accountData) === null || _a === void 0 ? void 0 : _a.state) === CONST_1.default.BANK_ACCOUNT.STATE.OPEN && ((_b = account.accountData) === null || _b === void 0 ? void 0 : _b.type) === CONST_1.default.BANK_ACCOUNT.TYPE.BUSINESS;
    });
}
