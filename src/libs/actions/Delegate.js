...
function connect(_a) {
    var _b, _c, _d;
    var email = _a.email, delegatedAccess = _a.delegatedAccess, credentials = _a.credentials, session = _a.session, activePolicyID = _a.activePolicyID, _e = _a.isFromOldDot, isFromOldDot = _e === void 0 ? false : _e;
    if (!(delegatedAccess === null || delegatedAccess === void 0 ? void 0 : delegatedAccess.delegators) && !isFromOldDot) {
        return;
    }
    react_native_onyx_1.default.set(ONYXKEYS_1.default.STASHED_CREDENTIALS, credentials !== null && credentials !== void 0 ? credentials : {});
    react_native_onyx_1.default.set(ONYXKEYS_1.default.STASHED_SESSION, session !== null && session !== void 0 ? session : {});
    ...
    var failureData = [
        {
            ...
            value: {
                delegatedAccess: {
                    errorFields: {
                        connect: (_d = {},
                            _d[email] = ErrorUtils.getMicroSecondOnyxErrorWithTranslationKey('delegate.genericError'),
                            _d),
                    },
                },
            },
...
function disconnect(_a) {
    var stashedCredentials = _a.stashedCredentials, stashedSession = _a.stashedSession;
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: ONYXKEYS_1.default.ACCOUNT,
    ...
    API.makeRequestWithSideEffects(types_1.SIDE_EFFECT_REQUEST_COMMANDS.DISCONNECT_AS_DELEGATE, {}, { optimisticData: optimisticData, successData: successData, failureData: failureData })
        ...
        if (!(response === null || response === void 0 ? void 0 : response.authToken) || !(response === null || response === void 0 ? void 0 : response.encryptedAuthToken)) {
            ...
            restoreDelegateSession(stashedSession !== null && stashedSession !== void 0 ? stashedSession : {});
            return;
        }
...
function clearDelegatorErrors(_a) {
    var delegatedAccess = _a.delegatedAccess;
...
function addDelegate(_a) {
    var _b, _c;
    var _d;
    var email = _a.email, role = _a.role, validateCode = _a.validateCode, delegatedAccess = _a.delegatedAccess;
    if (!(delegatedAccess === null || delegatedAccess === void 0 ? void 0 : delegatedAccess.delegates)) {
        return;
    }
    var existingDelegate = (_d = delegatedAccess === null || delegatedAccess === void 0 ? void 0 : delegatedAccess.delegates) === null || _d === void 0 ? void 0 : _d.find(function (delegate) { return delegate.email === email; });
...
function removeDelegate(_a) {
    var _b, _c;
    var _d, _e, _f;
    var email = _a.email, delegatedAccess = _a.delegatedAccess;
    if (!email || !(delegatedAccess === null || delegatedAccess === void 0 ? void 0 : delegatedAccess.delegates)) {
        return;
    }
    var optimisticData = [
        {
            ...
            value: {
                delegatedAccess: {
                    ...
                    delegates: (_d = delegatedAccess.delegates) === null || _d === void 0 ? void 0 : _d.map(function (delegate) {
                        return delegate.email === email
    ...
    var successData = [
        {
            ...
            value: {
                delegatedAccess: {
                    delegates: (_e = delegatedAccess.delegates) === null || _e === void 0 ? void 0 : _e.filter(function (delegate) { return delegate.email !== email; }),
                },
            },
        },
    ];
    var failureData = [
        {
            ...
            value: {
                delegatedAccess: {
                    ...
                    delegates: (_f = delegatedAccess.delegates) === null || _f === void 0 ? void 0 : _f.map(function (delegate) {
                        return delegate.email === email
...
function clearDelegateErrorsByField(_a) {
    var _b, _c;
    var email = _a.email, fieldName = _a.fieldName, delegatedAccess = _a.delegatedAccess;
    if (!(delegatedAccess === null || delegatedAccess === void 0 ? void 0 : delegatedAccess.delegates)) {
        return;
    }
    ...
    var failureData = [
        {
            ...
            value: {
                ...
                delegatedAccess: {
                    delegates: delegatedAccess.delegates.map(function (delegate) {
                        return delegate.email === email
                            ? __assign(__assign({}, delegate), { isLoading: false, pendingAction: null, pendingFields: { role: null } }) : delegate;
                    }),
                },
            },
        },
...
function clearDelegateRolePendingAction(_a) {
    var email = _a.email, delegatedAccess = _a.delegatedAccess;
    if (!(delegatedAccess === null || delegatedAccess === void 0 ? void 0 : delegatedAccess.delegates)) {
        return;
    }
