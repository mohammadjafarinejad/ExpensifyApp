...
function getReportFromHoldRequestsOnyxData(
    ...
    const {copiedActions: copiedSubmissionApprovalActions, copiedActionsSuccess: copiedSubmissionApprovalActionsSuccess, copiedActionsFailure: copiedSubmissionApprovalActionsFailure} = copySubmissionApprovalActionsForReport(iouReport?.reportID, optimisticExpenseReport.reportID);
