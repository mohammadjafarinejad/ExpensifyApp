        ...
        OnyxUtils_1.default.get(key).then(function (storedDerivedValue) {
            ...
            if (derivedValue) {
                ...
                OnyxUtils_1.default.tupleGet(dependencies).then(function (values) {
                    ...
                    (0, utils_1.setDerivedValue)(key, derivedValue !== null && derivedValue !== void 0 ? derivedValue : null);
                });
            }
            ...
            var recomputeDerivedValue = function (sourceKey, sourceValue, triggeredByIndex) {
                ...
                context.sourceValues = sourceKey && sourceValue !== undefined ? (_a = {}, _a[sourceKey] = sourceValue, _a) : undefined;
                // @ts-expect-error TypeScript can't confirm the shape of dependencyValues matches the compute function's parameters
