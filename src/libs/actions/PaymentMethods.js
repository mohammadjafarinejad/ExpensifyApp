 ...
 */
function continueSetup(kycWallRef, fallbackRoute) {
    var _a;
 ...
 *
 */
function hasPaymentMethodError(bankList, fundList, cardList) {
    var combinedPaymentMethods = __assign(__assign(__assign({}, bankList), fundList), cardList);
