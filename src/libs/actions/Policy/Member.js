...
function isApprover(policy, employeeLogin) {
    var _a;
    if ((policy === null || policy === void 0 ? void 0 : policy.approver) === employeeLogin) {
        return true;
    }
    return Object.values((_a = policy === null || policy === void 0 ? void 0 : policy.employeeList) !== null && _a !== void 0 ? _a : {}).some(function (employee) { return (employee === null || employee === void 0 ? void 0 : employee.submitsTo) === employeeLogin || (employee === null || employee === void 0 ? void 0 : employee.forwardsTo) === employeeLogin || (employee === null || employee === void 0 ? void 0 : employee.overLimitForwardsTo) === employeeLogin; });
}
/**
 ...
 */
function removeMembers(policyID, selectedMemberEmails, policyMemberEmailsToAccountIDs) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    if (selectedMemberEmails.length === 0) {
        return;
    }
    var accountIDs = selectedMemberEmails.map(function (email) { return policyMemberEmailsToAccountIDs[email]; }).filter(function (id) { return id !== undefined; });
    var policyKey = "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID);
    // This will be fixed as part of https://github.com/Expensify/Expensify/issues/507850
    // eslint-disable-next-line @typescript-eslint/no-deprecated
    var policy = getPolicy(policyID);
    ...
    var adminRoomMembers = removeOptimisticRoomMembers(CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS, policy === null || policy === void 0 ? void 0 : policy.id, (_b = policy === null || policy === void 0 ? void 0 : policy.name) !== null && _b !== void 0 ? _b : '', selectedMemberEmails
        .filter(function (login) {
        var _a, _b;
        var role = login ? (_b = (_a = policy === null || policy === void 0 ? void 0 : policy.employeeList) === null || _a === void 0 ? void 0 : _a[login]) === null || _b === void 0 ? void 0 : _b.role : '';
        return role === CONST_1.default.POLICY.ROLE.ADMIN || role === CONST_1.default.POLICY.ROLE.AUDITOR;
    })
        .map(function (login) { return policyMemberEmailsToAccountIDs[login]; }));
    var preferredExporterOnyxData = resetAccountingPreferredExporter(policyID, selectedMemberEmails);
    var optimisticMembersState = {};
    var successMembersState = {};
    var failureMembersState = {};
    selectedMemberEmails.forEach(function (email) {
    ...
    Object.keys((_c = policy === null || policy === void 0 ? void 0 : policy.employeeList) !== null && _c !== void 0 ? _c : {}).forEach(function (employeeEmail) {
        ...
        if ((employee === null || employee === void 0 ? void 0 : employee.submitsTo) && selectedMemberEmails.includes(employee === null || employee === void 0 ? void 0 : employee.submitsTo)) {
        ...
        if ((employee === null || employee === void 0 ? void 0 : employee.forwardsTo) && selectedMemberEmails.includes(employee === null || employee === void 0 ? void 0 : employee.forwardsTo)) {
        ...
        if ((employee === null || employee === void 0 ? void 0 : employee.overLimitForwardsTo) && selectedMemberEmails.includes(employee === null || employee === void 0 ? void 0 : employee.overLimitForwardsTo)) {
    ...
    var optimisticApprovalRules = approvalRules.filter(function (rule) { var _a; return !selectedMemberEmails.includes((_a = rule === null || rule === void 0 ? void 0 : rule.approver) !== null && _a !== void 0 ? _a : ''); });
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: policyKey,
            value: {
                ...
                approver: selectedMemberEmails.includes((_f = policy === null || policy === void 0 ? void 0 : policy.approver) !== null && _f !== void 0 ? _f : '') ? policy === null || policy === void 0 ? void 0 : policy.owner : policy === null || policy === void 0 ? void 0 : policy.approver,
    ...
    if (!(0, EmptyObject_1.isEmptyObject)((_h = policy === null || policy === void 0 ? void 0 : policy.primaryLoginsInvited) !== null && _h !== void 0 ? _h : {})) {
        ...
        var remainingLogins = employeeListEmails.filter(function (email) { return !selectedMemberEmails.includes(email); });
...
function buildUpdateWorkspaceMembersRoleOnyxData(policyID, selectedMemberEmails, selectedMemberAccountIDs, newRole) {
    var _a;
    ...
    var memberRoles = selectedMemberEmails.map(function (login) {
        return {
            email: login,
            role: newRole,
        };
    ...
    if (adminRoom) {
        ...
        if (newRole === CONST_1.default.POLICY.ROLE.ADMIN || newRole === CONST_1.default.POLICY.ROLE.AUDITOR) {
            selectedMemberAccountIDs.forEach(function (accountID) {
                var _a;
...
function updateWorkspaceMembersRole(policyID, selectedMemberEmails, selectedMemberAccountIDs, newRole) {
    var _a = buildUpdateWorkspaceMembersRoleOnyxData(policyID, selectedMemberEmails, selectedMemberAccountIDs, newRole), optimisticData = _a.optimisticData, successData = _a.successData, failureData = _a.failureData, memberRoles = _a.memberRoles;
    var params = {
        policyID: policyID,
...
function importPolicyMembers(policyID, members) {
    ...
    var _a = members.reduce(function (acc, curr) {
        ...
        if (employee) {
            if (curr.role !== employee.role || ((_b = curr.submitsTo) !== null && _b !== void 0 ? _b : '') !== ((_c = employee.submitsTo) !== null && _c !== void 0 ? _c : '') || ((_d = curr.forwardsTo) !== null && _d !== void 0 ? _d : '') !== ((_e = employee.forwardsTo) !== null && _e !== void 0 ? _e : '')) {
                acc.updated++;
            }
        }
        else {
 ...
 */
function clearDeleteMemberError(policyID, login) {
    var _a;
    react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID), {
        employeeList: (_a = {},
            _a[login] = {
 ...
 */
function clearAddMemberError(policyID, login, accountID) {
    var _a, _b;
    react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID), {
        employeeList: (_a = {},
            _a[login] = null,
