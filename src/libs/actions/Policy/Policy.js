...
exports.clearUberEmployeeError = clearUberEmployeeError;
...
exports.setWorkspaceAutoHarvesting = setWorkspaceAutoHarvesting;
...
exports.changePolicyUberBillingAccount = changePolicyUberBillingAccount;
...
exports.setWorkspaceConfirmationCurrency = setWorkspaceConfirmationCurrency;
...
var deprecatedActivePolicyID;
react_native_onyx_1.default.connect({
    key: ONYXKEYS_1.default.NVP_ACTIVE_POLICY_ID,
    callback: function (value) { return (deprecatedActivePolicyID = value); },
});
var deprecatedIntroSelected;
react_native_onyx_1.default.connect({
    key: ONYXKEYS_1.default.NVP_INTRO_SELECTED,
    callback: function (value) { return (deprecatedIntroSelected = value); },
});
/**
 ...
 */
function getInvoicePrimaryWorkspace(activePolicy, activeAdminWorkspaces) {
    if (PolicyUtils.canSendInvoiceFromWorkspace(activePolicy === null || activePolicy === void 0 ? void 0 : activePolicy.id)) {
        return activePolicy;
    }
...
function deleteWorkspace(params) {
    ...
    var policyID = params.policyID, activePolicyID = params.activePolicyID, policyName = params.policyName, lastAccessedWorkspacePolicyID = params.lastAccessedWorkspacePolicyID, policyCardFeeds = params.policyCardFeeds, reportsToArchive = params.reportsToArchive, transactionViolations = params.transactionViolations, reimbursementAccountError = params.reimbursementAccountError, lastUsedPaymentMethods = params.lastUsedPaymentMethods;
    // This will be fixed as part of https://github.com/Expensify/Expensify/issues/507850
    // eslint-disable-next-line @typescript-eslint/no-deprecated
    var policy = getPolicy(policyID);
    var filteredPolicies = Object.values(allPolicies).filter(function (p) { return (p === null || p === void 0 ? void 0 : p.id) !== policyID; });
    var workspaceAccountID = policy === null || policy === void 0 ? void 0 : policy.workspaceAccountID;
    ...
    var failureData = [
        {
            ...
            key: ONYXKEYS_1.default.REIMBURSEMENT_ACCOUNT,
            value: {
                errors: reimbursementAccountError !== null && reimbursementAccountError !== void 0 ? reimbursementAccountError : null,
            },
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
    ...
    if (policyID === activePolicyID) {
        var personalPolicyID = (_a = PolicyUtils.getPersonalPolicy()) === null || _a === void 0 ? void 0 : _a.id;
        // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: ONYXKEYS_1.default.NVP_ACTIVE_POLICY_ID,
    ...
    reportsToArchive.forEach(function (report) {
        ...
        for (var _i = 0, _g = Object.keys(transactionViolations !== null && transactionViolations !== void 0 ? transactionViolations : {}); _i < _g.length; _i++) {
            var transactionViolationKey = _g[_i];
            var transactionViolation = transactionViolations === null || transactionViolations === void 0 ? void 0 : transactionViolations[transactionViolationKey];
            var transactionID = transactionViolationKey.slice(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS.length);
            // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
            optimisticData.push({
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                key: "".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(transactionID),
                // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
                value: transactionViolation === null || transactionViolation === void 0 ? void 0 : transactionViolation.filter(function (violation) { return violation.type !== CONST_1.default.VIOLATION_TYPES.VIOLATION; }),
            });
            // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
            failureData.push({
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
    ...
    (_b = Object.keys(lastUsedPaymentMethods !== null && lastUsedPaymentMethods !== void 0 ? lastUsedPaymentMethods : {})) === null || _b === void 0 ? void 0 : _b.forEach(function (paymentMethodKey) {
        var _a, _b;
        var _c, _d, _e, _f, _g, _h, _j;
        var lastUsedPaymentMethod = lastUsedPaymentMethods === null || lastUsedPaymentMethods === void 0 ? void 0 : lastUsedPaymentMethods[paymentMethodKey];
        if (typeof lastUsedPaymentMethod === 'string' || !lastUsedPaymentMethod) {
            return;
        }
        if (((_c = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.iou) === null || _c === void 0 ? void 0 : _c.name) === policyID) {
            optimisticData.push({
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                ...
                value: (_a = {},
                    _a[paymentMethodKey] = {
                        iou: {
                            name: policyID !== ((_d = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed) === null || _d === void 0 ? void 0 : _d.name) ? (_e = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed) === null || _e === void 0 ? void 0 : _e.name : '',
                        },
                        lastUsed: {
                            name: policyID !== ((_f = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed) === null || _f === void 0 ? void 0 : _f.name) ? (_g = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed) === null || _g === void 0 ? void 0 : _g.name : '',
                        },
                    },
                    _a),
            });
            failureData.push({
                ...
                value: (_b = {},
                    _b[paymentMethodKey] = {
                        iou: {
                            name: (_h = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.iou) === null || _h === void 0 ? void 0 : _h.name,
                        },
                        lastUsed: {
                            name: (_j = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.iou) === null || _j === void 0 ? void 0 : _j.name,
                        },
                    },
                    _b),
            });
    ...
    var apiParams = { policyID: policyID };
    API.write(types_1.WRITE_COMMANDS.DELETE_WORKSPACE, apiParams, { optimisticData: optimisticData, finallyData: finallyData, failureData: failureData });
 ...
 */
function setWorkspaceAutoHarvesting(policy, enabled) {
    var _a, _b;
    ...
    var failureData = [
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
            value: {
                autoReporting: (_a = policy === null || policy === void 0 ? void 0 : policy.autoReporting) !== null && _a !== void 0 ? _a : null,
    ...
    var params = { policyID: policyID, enabled: enabled };
    API.write(types_1.WRITE_COMMANDS.SET_WORKSPACE_AUTO_HARVESTING, params, { optimisticData: optimisticData, failureData: failureData, successData: successData });
}
    ...
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
            value: __assign(__assign({}, value), { pendingFields: { approvalMode: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.UPDATE } }),
        },
    ];
    var failureData = [
        {
...
function setWorkspaceReimbursement(_a) {
    var _b;
    var _c, _d, _e, _f;
    var policyID = _a.policyID, reimbursementChoice = _a.reimbursementChoice, bankAccountID = _a.bankAccountID, reimburserEmail = _a.reimburserEmail, lastPaymentMethod = _a.lastPaymentMethod, shouldUpdateLastPaymentMethod = _a.shouldUpdateLastPaymentMethod;
    // This will be fixed as part of https://github.com/Expensify/Expensify/issues/507850
    // eslint-disable-next-line @typescript-eslint/no-deprecated
    var policy = getPolicy(policyID);
    var lastUsedPaymentMethod = typeof lastPaymentMethod === 'string' ? lastPaymentMethod : (_c = lastPaymentMethod === null || lastPaymentMethod === void 0 ? void 0 : lastPaymentMethod.expense) === null || _c === void 0 ? void 0 : _c.name;
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
            value: {
                ...
                reimburser: reimburserEmail,
                achAccount: { reimburser: reimburserEmail, bankAccountID: bankAccountID },
    ...
    var failureData = [
        {
            ...
            value: {
                isLoadingWorkspaceReimbursement: false,
                reimbursementChoice: (_d = policy === null || policy === void 0 ? void 0 : policy.reimbursementChoice) !== null && _d !== void 0 ? _d : null,
                achAccount: { reimburser: (_f = (_e = policy === null || policy === void 0 ? void 0 : policy.achAccount) === null || _e === void 0 ? void 0 : _e.reimburser) !== null && _f !== void 0 ? _f : null, bankAccountID: null },
                errorFields: { reimbursementChoice: ErrorUtils.getMicroSecondOnyxErrorWithTranslationKey('common.genericErrorMessage') },
                pendingFields: { reimbursementChoice: null },
            },
        },
    ];
    var params = { policyID: policyID, reimbursementChoice: reimbursementChoice, bankAccountID: bankAccountID };
 ...
 */
function createPolicyExpenseChats(policyID, invitedEmailsToAccountIDs, hasOutstandingChildRequest, notificationPreference) {
    ...
    Object.keys(invitedEmailsToAccountIDs).forEach(function (email) {
        ...
        workspaceMembersChats.onyxSuccessData.push({
            ...
            value: {
                ...
                participants: (_b = {},
                    _b[accountID] = (allPersonalDetails === null || allPersonalDetails === void 0 ? void 0 : allPersonalDetails[accountID]) ? {} : null,
                    _b),
            },
        }, {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
...
function setDuplicateWorkspaceData(data) {
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.DUPLICATE_WORKSPACE, __assign({}, data));
}
 ...
 */
function createDraftInitialWorkspace(introSelected, policyOwnerEmail, policyName, policyID, makeMeAdmin, currency, file) {
    var _a;
    var _b;
...
function buildPolicyData(options) {
    ...
    var _l = options.policyOwnerEmail, policyOwnerEmail = _l === void 0 ? '' : _l, _m = options.makeMeAdmin, makeMeAdmin = _m === void 0 ? false : _m, _o = options.policyName, policyName = _o === void 0 ? '' : _o, _p = options.policyID, policyID = _p === void 0 ? generatePolicyID() : _p, expenseReportId = options.expenseReportId, engagementChoice = options.engagementChoice, _q = options.currency, currency = _q === void 0 ? '' : _q, file = options.file, _r = options.shouldAddOnboardingTasks, shouldAddOnboardingTasks = _r === void 0 ? true : _r, companySize = options.companySize, userReportedIntegration = options.userReportedIntegration, featuresMap = options.featuresMap, lastUsedPaymentMethod = options.lastUsedPaymentMethod, adminParticipant = options.adminParticipant, _s = options.hasOutstandingChildRequest, hasOutstandingChildRequest = _s === void 0 ? true : _s;
    var workspaceName = policyName || generateDefaultWorkspaceName(policyOwnerEmail);
    var _t = buildOptimisticDistanceRateCustomUnits(currency), customUnits = _t.customUnits, customUnitID = _t.customUnitID, customUnitRateID = _t.customUnitRateID, outputCurrency = _t.outputCurrency;
    var _u = ReportUtils.buildOptimisticWorkspaceChats(policyID, workspaceName, expenseReportId), adminsChatReportID = _u.adminsChatReportID, adminsChatData = _u.adminsChatData, adminsReportActionData = _u.adminsReportActionData, adminsCreatedReportActionID = _u.adminsCreatedReportActionID, expenseChatReportID = _u.expenseChatReportID, expenseChatData = _u.expenseChatData, expenseReportActionData = _u.expenseReportActionData, expenseCreatedReportActionID = _u.expenseCreatedReportActionID, pendingChatMembers = _u.pendingChatMembers;
    ...
    var shouldSetCreatedPolicyAsActive = !deprecatedActivePolicyID || ((_h = allPolicies === null || allPolicies === void 0 ? void 0 : allPolicies["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(deprecatedActivePolicyID)]) === null || _h === void 0 ? void 0 : _h.type) === CONST_1.default.POLICY.TYPE.PERSONAL;
    // Determine workspace type based on selected features or user reported integration
    var isCorporateFeature = (_j = featuresMap === null || featuresMap === void 0 ? void 0 : featuresMap.some(function (feature) { return !feature.enabledByDefault && feature.enabled && feature.requiresUpdate; })) !== null && _j !== void 0 ? _j : false;
    var isCorporateIntegration = userReportedIntegration && CONST_1.default.POLICY.CONNECTIONS.CORPORATE.includes(userReportedIntegration);
    var workspaceType = isCorporateFeature || isCorporateIntegration ? CONST_1.default.POLICY.TYPE.CORPORATE : CONST_1.default.POLICY.TYPE.TEAM;
    var areDistanceRatesEnabled = !!(featuresMap === null || featuresMap === void 0 ? void 0 : featuresMap.find(function (feature) { return feature.id === CONST_1.default.POLICY.MORE_FEATURES.ARE_DISTANCE_RATES_ENABLED && feature.enabled; }));
    // WARNING: The data below should be kept in sync with the API so we create the policy with the correct configuration.
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
            value: __assign(__assign({ id: policyID, type: workspaceType, name: workspaceName, role: CONST_1.default.POLICY.ROLE.ADMIN, owner: sessionEmail, ownerAccountID: sessionAccountID, isPolicyExpenseChatEnabled: true, outputCurrency: outputCurrency, pendingAction: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD, autoReporting: true, approver: sessionEmail, autoReportingFrequency: shouldEnableWorkflowsByDefault ? CONST_1.default.POLICY.AUTO_REPORTING_FREQUENCIES.IMMEDIATE : CONST_1.default.POLICY.AUTO_REPORTING_FREQUENCIES.INSTANT, approvalMode: shouldEnableWorkflowsByDefault && engagementChoice !== CONST_1.default.ONBOARDING_CHOICES.TRACK_WORKSPACE ? CONST_1.default.POLICY.APPROVAL_MODE.BASIC : CONST_1.default.POLICY.APPROVAL_MODE.OPTIONAL, harvesting: {
                    enabled: !shouldEnableWorkflowsByDefault,
                }, customUnits: customUnits, areCategoriesEnabled: true, areCompanyCardsEnabled: true, areTagsEnabled: false, areDistanceRatesEnabled: areDistanceRatesEnabled, areWorkflowsEnabled: shouldEnableWorkflowsByDefault, areReportFieldsEnabled: false, areConnectionsEnabled: false, areExpensifyCardsEnabled: false, employeeList: __assign((_a = {}, _a[sessionEmail] = {
                    submitsTo: sessionEmail,
                    email: sessionEmail,
                    role: CONST_1.default.POLICY.ROLE.ADMIN,
                    errors: {},
                }, _a), ((adminParticipant === null || adminParticipant === void 0 ? void 0 : adminParticipant.login)
                    ? (_b = {},
                        _b[adminParticipant.login] = {
                            submitsTo: sessionEmail,
                            email: adminParticipant.login,
                            role: CONST_1.default.POLICY.ROLE.ADMIN,
                            errors: {},
                        },
                        _b) : {})), chatReportIDAdmins: makeMeAdmin ? Number(adminsChatReportID) : undefined, pendingFields: {
                    autoReporting: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    approvalMode: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    reimbursementChoice: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                ...
                }, defaultBillable: false, defaultReimbursable: true, disabledFields: { defaultBillable: true, reimbursable: false }, avatarURL: file === null || file === void 0 ? void 0 : file.uri, originalFileName: file === null || file === void 0 ? void 0 : file.name }, optimisticMccGroupData.optimisticData), { requiresCategory: true, fieldList: (_c = {},
    ...
    var successData = [
        {
            ...
            value: __assign(__assign({ pendingAction: null, pendingFields: {
                    ...
                    customRules: null,
                } }, optimisticMccGroupData.successData), { fieldList: (_d = {},
                    _d[CONST_1.default.POLICY.FIELDS.FIELD_LIST_TITLE] = {
                        pendingFields: {
                            defaultValue: null,
                            deletable: null,
                        },
        ...
        },
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(adminsChatReportID),
            value: (_e = {},
                _e[adminsCreatedReportActionID] = {
                    pendingAction: null,
                },
                _e),
        },
        ...
        },
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(expenseChatReportID),
            value: (_f = {},
                _f[expenseCreatedReportActionID] = {
                    pendingAction: null,
                },
                _f),
        },
    ...
    if (getAdminPolicies().length === 0 && lastUsedPaymentMethod) {
        Object.values(allReports !== null && allReports !== void 0 ? allReports : {})
            .filter(function (iouReport) { return (iouReport === null || iouReport === void 0 ? void 0 : iouReport.type) === CONST_1.default.REPORT.TYPE.IOU; })
            .forEach(function (iouReport) {
            var _a;
            var _b;
            // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
            if (((_b = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.iou) === null || _b === void 0 ? void 0 : _b.name) || !(iouReport === null || iouReport === void 0 ? void 0 : iouReport.policyID)) {
                return;
            }
            successData.push({
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                key: ONYXKEYS_1.default.NVP_LAST_PAYMENT_METHOD,
                value: (_a = {},
                    _a[iouReport === null || iouReport === void 0 ? void 0 : iouReport.policyID] = {
                        iou: {
                            name: policyID,
                        },
                        lastUsed: {
    ...
    var features = featuresMap === null || featuresMap === void 0 ? void 0 : featuresMap.reduce(function (acc, feature) {
    ...
    var params = {
        ...
        userReportedIntegration: userReportedIntegration !== null && userReportedIntegration !== void 0 ? userReportedIntegration : undefined,
        features: features ? JSON.stringify(features) : undefined,
        areDistanceRatesEnabled: areDistanceRatesEnabled,
    };
    if (deprecatedIntroSelected !== undefined &&
        (deprecatedIntroSelected.choice === CONST_1.default.ONBOARDING_CHOICES.TEST_DRIVE_RECEIVER || !(deprecatedIntroSelected === null || deprecatedIntroSelected === void 0 ? void 0 : deprecatedIntroSelected.createWorkspace)) &&
        engagementChoice &&
        shouldAddOnboardingTasks) {
        var onboardingMessages = (0, OnboardingFlow_1.getOnboardingMessages)().onboardingMessages;
        var onboardingData = ReportUtils.prepareOnboardingOnyxData(deprecatedIntroSelected, engagementChoice, onboardingMessages[engagementChoice], adminsChatReportID, policyID);
        if (!onboardingData) {
    ...
    if ((deprecatedIntroSelected === null || deprecatedIntroSelected === void 0 ? void 0 : deprecatedIntroSelected.choice) === CONST_1.default.ONBOARDING_CHOICES.TEST_DRIVE_RECEIVER && deprecatedIntroSelected.createWorkspace) {
        var createWorkspaceTaskReport = { reportID: deprecatedIntroSelected.createWorkspace };
        var _v = (0, Task_1.buildTaskData)(createWorkspaceTaskReport, deprecatedIntroSelected.createWorkspace), optimisticCreateWorkspaceTaskData = _v.optimisticData, successCreateWorkspaceTaskData = _v.successData, failureCreateWorkspaceTaskData = _v.failureData;
    ...
    if (adminParticipant === null || adminParticipant === void 0 ? void 0 : adminParticipant.login) {
        var employeeWorkspaceChat = createPolicyExpenseChats(policyID, (_g = {}, _g[adminParticipant.login] = (_k = adminParticipant.accountID) !== null && _k !== void 0 ? _k : CONST_1.default.DEFAULT_NUMBER_ID, _g), hasOutstandingChildRequest);
        ...
        failureData.push.apply(failureData, employeeWorkspaceChat.onyxFailureData);
    }
    return { successData: successData, optimisticData: optimisticData, failureData: failureData, params: params };
}
function createWorkspace(options) {
    ...
    var optionsWithDefaults = __assign({ engagementChoice: CONST_1.default.ONBOARDING_CHOICES.MANAGE_TEAM }, options);
    var _a = buildPolicyData(optionsWithDefaults), optimisticData = _a.optimisticData, failureData = _a.failureData, successData = _a.successData, params = _a.params;
 ...
 * @param [policyID] custom policy id we will use for created workspace
 */
function createDraftWorkspace(introSelected, policyOwnerEmail, makeMeAdmin, policyName, policyID, currency, file) {
    var _a, _b;
    if (policyOwnerEmail === void 0) { policyOwnerEmail = ''; }
    if (makeMeAdmin === void 0) { makeMeAdmin = false; }
    if (policyName === void 0) { policyName = ''; }
    ...
    if (currency === void 0) { currency = ''; }
    var workspaceName = policyName || generateDefaultWorkspaceName(policyOwnerEmail);
    var _c = buildOptimisticDistanceRateCustomUnits(currency), customUnits = _c.customUnits, customUnitID = _c.customUnitID, customUnitRateID = _c.customUnitRateID, outputCurrency = _c.outputCurrency;
    var _d = ReportUtils.buildOptimisticWorkspaceChats(policyID, workspaceName), expenseChatData = _d.expenseChatData, adminsChatReportID = _d.adminsChatReportID, adminsCreatedReportActionID = _d.adminsCreatedReportActionID, expenseChatReportID = _d.expenseChatReportID, expenseCreatedReportActionID = _d.expenseCreatedReportActionID;
    var shouldEnableWorkflowsByDefault = !(introSelected === null || introSelected === void 0 ? void 0 : introSelected.choice) || introSelected.choice === CONST_1.default.ONBOARDING_CHOICES.MANAGE_TEAM || introSelected.choice === CONST_1.default.ONBOARDING_CHOICES.LOOKING_AROUND;
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
...
function buildDuplicatePolicyData(policy, options) {
    var _a, _b, _c;
    var _d;
    var _e = options.policyName, policyName = _e === void 0 ? '' : _e, _f = options.policyID, policyID = _f === void 0 ? generatePolicyID() : _f, file = options.file, welcomeNote = options.welcomeNote, parts = options.parts, _g = options.targetPolicyID, targetPolicyID = _g === void 0 ? generatePolicyID() : _g, policyCategories = options.policyCategories;
    var _h = ReportUtils.buildOptimisticWorkspaceChats(targetPolicyID, policyName), adminsChatReportID = _h.adminsChatReportID, adminsChatData = _h.adminsChatData, adminsReportActionData = _h.adminsReportActionData, adminsCreatedReportActionID = _h.adminsCreatedReportActionID, expenseChatReportID = _h.expenseChatReportID, expenseChatData = _h.expenseChatData, expenseReportActionData = _h.expenseReportActionData, expenseCreatedReportActionID = _h.expenseCreatedReportActionID, pendingChatMembers = _h.pendingChatMembers;
    var isMemberOptionSelected = parts === null || parts === void 0 ? void 0 : parts.people;
    var isReportsOptionSelected = parts === null || parts === void 0 ? void 0 : parts.reports;
    var isConnectionsOptionSelected = parts === null || parts === void 0 ? void 0 : parts.connections;
    var isCategoriesOptionSelected = parts === null || parts === void 0 ? void 0 : parts.categories;
    var isTaxesOptionSelected = parts === null || parts === void 0 ? void 0 : parts.taxes;
    var isTagsOptionSelected = parts === null || parts === void 0 ? void 0 : parts.tags;
    var isInvoicesOptionSelected = parts === null || parts === void 0 ? void 0 : parts.invoices;
    var isCustomUnitsOptionSelected = parts === null || parts === void 0 ? void 0 : parts.customUnits;
    var isRulesOptionSelected = parts === null || parts === void 0 ? void 0 : parts.expenses;
    var isWorkflowsOptionSelected = parts === null || parts === void 0 ? void 0 : parts.exportLayouts;
    var isPerDiemOptionSelected = parts === null || parts === void 0 ? void 0 : parts.perDiem;
    var policyMemberAccountIDs = isMemberOptionSelected ? Object.values((0, PolicyUtils_1.getMemberAccountIDsForWorkspace)(policy === null || policy === void 0 ? void 0 : policy.employeeList, false, false)) : [];
    var _j = buildOptimisticDistanceRateCustomUnits(policy === null || policy === void 0 ? void 0 : policy.outputCurrency), customUnitID = _j.customUnitID, customUnitRateID = _j.customUnitRateID;
    var optimisticAnnounceChat = ReportUtils.buildOptimisticAnnounceChat(targetPolicyID, __spreadArray([], policyMemberAccountIDs, true));
    var announceRoomChat = optimisticAnnounceChat.announceChatData;
    var defaultOptimisticCategoriesData = (0, Category_1.buildOptimisticPolicyCategories)(targetPolicyID, Object.values(CONST_1.default.POLICY.DEFAULT_CATEGORIES));
    var optimisticCategoriesData = policyCategories && isCategoriesOptionSelected ? (0, Category_1.buildOptimisticPolicyWithExistingCategories)(targetPolicyID, policyCategories) : defaultOptimisticCategoriesData;
    // WARNING: The data below should be kept in sync with the API so we create the policy with the correct configuration.
    // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
    ...
    var optimisticData = __spreadArray([
        {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(targetPolicyID),
            value: __assign(__assign({}, policy), { areCategoriesEnabled: true, areTagsEnabled: isTagsOptionSelected, areDistanceRatesEnabled: isCustomUnitsOptionSelected, areInvoicesEnabled: isInvoicesOptionSelected, areRulesEnabled: isRulesOptionSelected, areWorkflowsEnabled: isWorkflowsOptionSelected, areReportFieldsEnabled: isReportsOptionSelected, areConnectionsEnabled: isConnectionsOptionSelected, arePerDiemRatesEnabled: isPerDiemOptionSelected, workspaceAccountID: undefined, tax: isTaxesOptionSelected ? policy === null || policy === void 0 ? void 0 : policy.tax : undefined, employeeList: isMemberOptionSelected ? policy.employeeList : (_a = {}, _a[policy.owner] = (_d = policy === null || policy === void 0 ? void 0 : policy.employeeList) === null || _d === void 0 ? void 0 : _d[policy.owner], _a), id: targetPolicyID, name: policyName, fieldList: isReportsOptionSelected ? policy === null || policy === void 0 ? void 0 : policy.fieldList : undefined, connections: isConnectionsOptionSelected ? policy === null || policy === void 0 ? void 0 : policy.connections : undefined, customUnits: (0, PolicyUtils_1.getCustomUnitsForDuplication)(policy, isCustomUnitsOptionSelected, isPerDiemOptionSelected), taxRates: isTaxesOptionSelected ? policy === null || policy === void 0 ? void 0 : policy.taxRates : undefined, pendingAction: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD, pendingFields: {
                    autoReporting: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    approvalMode: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    reimbursementChoice: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    name: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    ...
                    type: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                    areReportFieldsEnabled: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
                }, avatarURL: file === null || file === void 0 ? void 0 : file.uri, originalFileName: file === null || file === void 0 ? void 0 : file.name }),
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_METADATA).concat(expenseChatReportID),
        ...
        {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY_DRAFTS).concat(targetPolicyID),
            value: null,
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
    ...
    ], announceRoomChat.onyxOptimisticData, true);
    // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    var successData = __spreadArray([
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(targetPolicyID),
            value: {
        ...
        },
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(adminsChatReportID),
            value: (_b = {},
                _b[adminsCreatedReportActionID] = {
                    pendingAction: null,
                },
                _b),
        },
    ...
    ], announceRoomChat.onyxSuccessData, true);
    // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    ...
    ], announceRoomChat.onyxFailureData, true);
    if (optimisticCategoriesData === null || optimisticCategoriesData === void 0 ? void 0 : optimisticCategoriesData.optimisticData) {
        optimisticData.push.apply(optimisticData, optimisticCategoriesData.optimisticData);
    }
    if (optimisticCategoriesData === null || optimisticCategoriesData === void 0 ? void 0 : optimisticCategoriesData.failureData) {
        failureData.push.apply(failureData, optimisticCategoriesData.failureData);
    }
    if (optimisticCategoriesData === null || optimisticCategoriesData === void 0 ? void 0 : optimisticCategoriesData.successData) {
        successData.push.apply(successData, optimisticCategoriesData.successData);
    }
    // We need to clone the file to prevent non-indexable errors.
    var clonedFile = file ? (0, FileUtils_1.createFile)(file) : undefined;
...
function duplicateWorkspace(policy, options) {
    var _a = buildDuplicatePolicyData(policy, options), optimisticData = _a.optimisticData, failureData = _a.failureData, successData = _a.successData, params = _a.params;
    API.write(types_1.WRITE_COMMANDS.DUPLICATE_POLICY, params, { optimisticData: optimisticData, successData: successData, failureData: failureData });
    return params;
}
...
function openPolicyReceiptPartnersPage(policyID) {
    if (!policyID) {
        Log_1.default.warn('openPolicyReceiptPartnersPage invalid params', { policyID: policyID });
        return;
    }
    var params = { policyID: policyID };
...
function removePolicyReceiptPartnersConnection(policyID, partnerName, receiptPartnerData) {
    ...
    var optimisticData = [
        {
            ...
            value: {
                receiptPartners: (_a = {},
                    _a[partnerName] = { pendingAction: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE, enabled: false },
                    _a),
            },
        },
    ];
    ...
    var failureData = [
        {
            ...
            value: {
                receiptPartners: (_c = {},
                    _c[partnerName] = __assign(__assign({}, receiptPartnerData), { errorFields: { name: ErrorUtils.getMicroSecondOnyxErrorWithTranslationKey('common.genericErrorMessage') }, pendingAction: null }),
                    _c),
            },
        },
    ];
    ...
    API.write(types_1.WRITE_COMMANDS.DISCONNECT_WORKSPACE_RECEIPT_PARTNER, parameters, { optimisticData: optimisticData, failureData: failureData, successData: successData });
}
function togglePolicyUberAutoInvite(policyID, enabled) {
    if (!policyID) {
        Log_1.default.warn('togglePolicyUberAutoInvite invalid params', { policyID: policyID });
        return;
    }
    var optimisticData = [
        {
    ...
    var params = { policyID: policyID, enabled: enabled };
    API.write(types_1.WRITE_COMMANDS.TOGGLE_WORKSPACE_UBER_AUTO_INVITE, params, { optimisticData: optimisticData, successData: successData, failureData: failureData });
}
function changePolicyUberBillingAccount(policyID, email, oldEmail) {
    if (!policyID) {
        Log_1.default.warn('changePolicyUberBillingAccount invalid params', { policyID: policyID });
        return;
    }
    var optimisticData = [
        {
            ...
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            value: {
                receiptPartners: { uber: { centralBillingAccountEmail: email, pendingFields: { centralBillingAccountEmail: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.UPDATE } } },
            },
        },
    ];
    var successData = [
    ...
    var params = { policyID: policyID, email: email };
    API.write(types_1.WRITE_COMMANDS.SET_WORKSPACE_UBER_CENTRAL_BILL, params, { optimisticData: optimisticData, successData: successData, failureData: failureData });
}
function togglePolicyUberAutoRemove(policyID, enabled) {
    if (!policyID) {
        Log_1.default.warn('togglePolicyUberAutoRemove invalid params', { policyID: policyID });
        return;
    }
    var optimisticData = [
        {
    ...
    var params = { policyID: policyID, enabled: enabled };
    API.write(types_1.WRITE_COMMANDS.TOGGLE_WORKSPACE_UBER_AUTO_REMOVE, params, { optimisticData: optimisticData, successData: successData, failureData: failureData });
}
/**
...
function inviteWorkspaceEmployeesToUber(policyID, emails) {
    if (!policyID || emails.length === 0) {
        Log_1.default.warn('inviteWorkspaceEmployeesToUber invalid params', { policyID: policyID, emails: emails });
        return;
    }
    var params = {
        policyID: policyID,
    ...
    var invitedEmployees = emails.reduce(function (acc, email) {
        acc[email] = {
    ...
    var successEmployees = emails.reduce(function (acc, email) {
        acc[email] = {
            pendingAction: null,
        };
        return acc;
    ...
    var resetEmployeesOnFailure = emails.reduce(function (acc, email) {
        acc[email] = {
    ...
    API.write(types_1.WRITE_COMMANDS.INVITE_WORKSPACE_EMPLOYEES_TO_UBER, params, { optimisticData: optimisticData, successData: successData, failureData: failureData });
}
/**
 * Clears an error for a specific Uber employee
 */
function clearUberEmployeeError(policyID, email) {
    var _a;
    react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID), {
        receiptPartners: {
            uber: {
                employees: (_a = {},
                    _a[email] = { errors: null, pendingAction: null },
                    _a),
            },
        },
    });
        ...
        optimisticData: [
            // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
            {
                ...
                value: {
                    ...
                    pendingFields: {
                        receiptPartners: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.UPDATE,
                    },
                },
            },
        ],
...
function enablePolicyWorkflows(policyID, enabled) {
    ...
    API.write(types_1.WRITE_COMMANDS.ENABLE_POLICY_WORKFLOWS, parameters, onyxData);
    if (enabled && (0, getIsNarrowLayout_1.default)()) {
        (0, PolicyUtils_1.goBackWhenEnableFeature)(policyID);
    }
}
...
function enablePolicyRules(policyID, enabled, shouldGoBack) {
    ...
    if (enabled && (0, PolicyUtils_1.isControlPolicy)(policy) && (policy === null || policy === void 0 ? void 0 : policy.outputCurrency) === CONST_1.default.CURRENCY.USD) {
        var eReceiptsOnyxData = getWorkspaceEReceiptsEnabledOnyxData(policyID, enabled);
        (_a = onyxData.optimisticData) === null || _a === void 0 ? void 0 : _a.push.apply(_a, ((_b = eReceiptsOnyxData.optimisticData) !== null && _b !== void 0 ? _b : []));
        (_c = onyxData.successData) === null || _c === void 0 ? void 0 : _c.push.apply(_c, ((_d = eReceiptsOnyxData.successData) !== null && _d !== void 0 ? _d : []));
        (_e = onyxData.failureData) === null || _e === void 0 ? void 0 : _e.push.apply(_e, ((_f = eReceiptsOnyxData.failureData) !== null && _f !== void 0 ? _f : []));
    }
    var parameters = { policyID: policyID, enabled: enabled };
    ...
    API.write(types_1.WRITE_COMMANDS.SET_POLICY_RULES_ENABLED, parameters, onyxData);
    if (enabled && (0, getIsNarrowLayout_1.default)() && shouldGoBack) {
        (0, PolicyUtils_1.goBackWhenEnableFeature)(policyID);
    }
}
    ...
    var optimisticData = [
        {
            ...
            value: {
                ...
                glCodes: true,
                eReceipts: (policy === null || policy === void 0 ? void 0 : policy.outputCurrency) === CONST_1.default.CURRENCY.USD ? true : policy === null || policy === void 0 ? void 0 : policy.eReceipts,
                harvesting: {
                    enabled: false,
                },
    ...
    var failureData = [
        {
            ...
            value: {
                ...
                eReceipts: policy === null || policy === void 0 ? void 0 : policy.eReceipts,
            },
        },
    ];
        ...
        optimisticData: [
            {
                ...
                value: {
                    ...
                    pendingFields: {
                        customRules: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.UPDATE,
                    },
                },
            },
        ],
...
function getCashExpenseReimbursableMode(policyID) {
    ...
    if (policy.defaultReimbursable && !((_a = policy.disabledFields) === null || _a === void 0 ? void 0 : _a.reimbursable)) {
        return CONST_1.default.POLICY.CASH_EXPENSE_REIMBURSEMENT_CHOICES.REIMBURSABLE_DEFAULT;
    }
    if (!((_b = policy.disabledFields) === null || _b === void 0 ? void 0 : _b.reimbursable) && !policy.defaultReimbursable) {
        return CONST_1.default.POLICY.CASH_EXPENSE_REIMBURSEMENT_CHOICES.NON_REIMBURSABLE_DEFAULT;
    }
    if (policy.defaultReimbursable && ((_c = policy.disabledFields) === null || _c === void 0 ? void 0 : _c.reimbursable)) {
...
function setPolicyReimbursableMode(policyID, reimbursableMode) {
    var _a;
    var policy = allPolicies === null || allPolicies === void 0 ? void 0 : allPolicies["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID)];
    var originalDefaultReimbursable = policy === null || policy === void 0 ? void 0 : policy.defaultReimbursable;
    var originalDefaultReimbursableDisabled = (_a = policy === null || policy === void 0 ? void 0 : policy.disabledFields) === null || _a === void 0 ? void 0 : _a.reimbursable;
    var defaultReimbursable = reimbursableMode === CONST_1.default.POLICY.CASH_EXPENSE_REIMBURSEMENT_CHOICES.REIMBURSABLE_DEFAULT || reimbursableMode === CONST_1.default.POLICY.CASH_EXPENSE_REIMBURSEMENT_CHOICES.ALWAYS_REIMBURSABLE;
    var reimbursableDisabled = reimbursableMode === CONST_1.default.POLICY.CASH_EXPENSE_REIMBURSEMENT_CHOICES.ALWAYS_REIMBURSABLE ||
        ...
        optimisticData: [
            {
                ...
                key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
                value: {
                    defaultReimbursable: defaultReimbursable,
                    disabledFields: {
...
function setWorkspaceEReceiptsEnabled(policyID, enabled) {
    var onyxData = getWorkspaceEReceiptsEnabledOnyxData(policyID, enabled);
    var parameters = {
        policyID: policyID,
        enabled: enabled,
    };
...
function setPolicyDefaultReportTitle(policyID, customName) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-deprecated
    var policy = getPolicy(policyID);
    if (customName === ((_f = (_e = policy === null || policy === void 0 ? void 0 : policy.fieldList) === null || _e === void 0 ? void 0 : _e[CONST_1.default.POLICY.FIELDS.FIELD_LIST_TITLE]) === null || _f === void 0 ? void 0 : _f.defaultValue)) {
        return;
    }
    var previousReportTitleField = (_h = (_g = policy === null || policy === void 0 ? void 0 : policy.fieldList) === null || _g === void 0 ? void 0 : _g[CONST_1.default.POLICY.FIELDS.FIELD_LIST_TITLE]) !== null && _h !== void 0 ? _h : {};
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
...
function setPolicyAutoReimbursementLimit(policyID, limit) {
    ...
    var fallbackLimit = limit === '' ? '0' : limit;
    var parsedLimit = CurrencyUtils.convertToBackendAmount(parseFloat(fallbackLimit));
    if (parsedLimit === ((_b = (_a = policy === null || policy === void 0 ? void 0 : policy.autoReimbursement) === null || _a === void 0 ? void 0 : _a.limit) !== null && _b !== void 0 ? _b : CONST_1.default.POLICY.AUTO_REIMBURSEMENT_LIMIT_DEFAULT_CENTS)) {
        return;
    }
    var optimisticData = [
        {
...
function enablePolicyAutoReimbursementLimit(policyID, enabled) {
    ...
    var autoReimbursementValues = { limit: enabled ? CONST_1.default.POLICY.AUTO_REIMBURSEMENT_LIMIT_SUGGESTED_CENTS : CONST_1.default.POLICY.AUTO_REIMBURSEMENT_LIMIT_DEFAULT_CENTS };
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID),
...
function calculateBillNewDot() {
    ...
    API.makeRequestWithSideEffects(types_1.SIDE_EFFECT_REQUEST_COMMANDS.CALCULATE_BILL_NEW_DOT, null, {
        optimisticData: optimisticData,
        successData: successData,
        failureData: failureData,
    });
...
function clearPolicyTitleFieldError(policyID) {
    ...
    react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID), {
        errorFields: {
            fieldList: (_a = {},
                _a[CONST_1.default.POLICY.FIELDS.FIELD_LIST_TITLE] = null,
                _a),
        },
    });
}
 ...
 */
function setWorkspaceConfirmationCurrency(currency) {
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.FORMS.WORKSPACE_CONFIRMATION_FORM_DRAFT, { currency: currency });
}
