...
function resetUSDBankAccount(bankAccountID, session, policyID, achAccount, lastUsedPaymentMethod) {
    ...
    var isLastUsedPaymentMethodBBA = ((_c = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.expense) === null || _c === void 0 ? void 0 : _c.name) === CONST_1.default.IOU.PAYMENT_TYPE.VBBA;
    var isPreviousLastUsedPaymentMethodBBA = ((_d = lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed) === null || _d === void 0 ? void 0 : _d.name) === CONST_1.default.IOU.PAYMENT_TYPE.VBBA;
    var onyxData = {
        optimisticData: [
            {
    ...
    if (isLastUsedPaymentMethodBBA && policyID) {
        (_e = onyxData.successData) === null || _e === void 0 ? void 0 : _e.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: ONYXKEYS_1.default.NVP_LAST_PAYMENT_METHOD,
            value: (_b = {},
                _b[policyID] = {
                    expense: {
                        name: isPreviousLastUsedPaymentMethodBBA ? '' : lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed.name,
                    },
                    lastUsed: {
                        name: isPreviousLastUsedPaymentMethodBBA ? '' : lastUsedPaymentMethod === null || lastUsedPaymentMethod === void 0 ? void 0 : lastUsedPaymentMethod.lastUsed.name,
                    },
