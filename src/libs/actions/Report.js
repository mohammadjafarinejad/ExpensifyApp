...
exports.addAttachmentWithComment = addAttachmentWithComment;
...
exports.handlePreexistingReport = handlePreexistingReport;
...
exports.updatePolicyRoomAvatar = updatePolicyRoomAvatar;
...
exports.optimisticReportLastData = optimisticReportLastData;
exports.setOptimisticTransactionThread = setOptimisticTransactionThread;
 ...
 */
function addActions(reportID, notifyReportID, timezoneParam, text, file) {
    var _a, _b;
    var _c;
    if (text === void 0) { text = ''; }
    ...
    var currentTime = NetworkConnection_1.default.getDBTimeWithSkew();
    ...
    var optimisticParentReportData = (0, ReportUtils_1.getOptimisticDataForParentReportAction)(report, currentTime, CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD);
    ...
    if (DateUtils_1.default.canUpdateTimezone() && currentUserAccountID) {
        var timezone = DateUtils_1.default.getCurrentTimezone(timezoneParam);
    ...
    notifyNewAction(notifyReportID, lastAction === null || lastAction === void 0 ? void 0 : lastAction.actorAccountID, lastAction);
}
/** Add an attachment with an optional comment to a report */
function addAttachmentWithComment(reportID, notifyReportID, attachments, text, timezone, shouldPlaySound) {
    if (text === void 0) { text = ''; }
    if (timezone === void 0) { timezone = CONST_1.default.DEFAULT_TIME_ZONE; }
    if (shouldPlaySound === void 0) { shouldPlaySound = false; }
    if (!reportID) {
        return;
    }
    ...
    addActions(reportID, notifyReportID, timezone, text, attachments === null || attachments === void 0 ? void 0 : attachments.at(0));
    // Remaining: attachment-only actions (no text duplication)
    for (var i = 1; i < (attachments === null || attachments === void 0 ? void 0 : attachments.length); i += 1) {
        addActions(reportID, notifyReportID, timezone, '', attachments === null || attachments === void 0 ? void 0 : attachments.at(i));
    }
    // Play sound once
    handlePlaySound();
}
/** Add a single comment to a report */
function addComment(reportID, notifyReportID, text, timezoneParam, shouldPlaySound) {
    if (shouldPlaySound) {
        (0, Sound_1.default)(Sound_1.SOUNDS.DONE);
    }
 ...
 */
function buildUpdateReportAvatarOnyxData(reportID, file) {
    var _a, _b;
...
function updateGroupChatAvatar(reportID, file) {
    var _a = buildUpdateReportAvatarOnyxData(reportID, file), optimisticData = _a.optimisticData, successData = _a.successData, failureData = _a.failureData;
 ...
 */
function updatePolicyRoomAvatar(reportID, file) {
    var _a, _b, _c;
    var _d, _e;
    var avatarURL = (_d = file === null || file === void 0 ? void 0 : file.uri) !== null && _d !== void 0 ? _d : '';
    var _f = buildUpdateReportAvatarOnyxData(reportID, file), optimisticData = _f.optimisticData, successData = _f.successData, failureData = _f.failureData;
    var optimisticAction = (0, ReportUtils_1.buildOptimisticRoomAvatarUpdatedReportAction)(avatarURL);
    optimisticData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
        value: (_a = {}, _a[optimisticAction.reportActionID] = optimisticAction, _a),
    });
    ...
    optimisticData.push({
        ...
        value: {
            ...
            lastMessageText: (_e = optimisticAction.message.at(0)) === null || _e === void 0 ? void 0 : _e.text,
        },
    });
    ...
    successData.push({
        ...
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
        value: (_b = {},
            _b[optimisticAction.reportActionID] = { pendingAction: null },
            _b),
    });
    failureData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
        value: (_c = {},
            _c[optimisticAction.reportActionID] = {
                pendingAction: null,
            },
            _c),
    });
    var parameters = { reportID: reportID, file: file, reportActionID: optimisticAction.reportActionID };
    API.write(types_1.WRITE_COMMANDS.UPDATE_ROOM_AVATAR, parameters, { optimisticData: optimisticData, failureData: failureData, successData: successData });
}
/**
 ...
 */
function openReport(reportID, reportActionID, participantLoginList, newReportObject, parentReportActionID, isFromDeepLink, participantAccountIDList, avatar, transactionID, isNewThread) {
    var _a, _b, _c, _d, _e;
    ...
    if (isNewThread === void 0) { isNewThread = false; }
    if (!reportID) {
        return;
    }
    var optimisticReport = reportActionsExist(reportID)
        ? {}
        : {
            reportName: (_g = (_f = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)]) === null || _f === void 0 ? void 0 : _f.reportName) !== null && _g !== void 0 ? _g : CONST_1.default.REPORT.DEFAULT_REPORT_NAME,
        };
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
    ...
    if (isNewThread) {
        failureData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID),
            value: { errorFields: { createChatThread: (0, ErrorUtils_1.getMicroSecondOnyxErrorWithTranslationKey)('report.genericCreateReportFailureMessage') } },
        });
    }
    var finallyData = [];
    var parameters = {
        ...
        if (transaction) {
            ...
            if (selfDMReportID) {
                ...
                var optimisticParentAction = (0, ReportUtils_1.buildOptimisticIOUReportAction)({
                    ...
                    comment: (_j = (_h = transaction.comment) === null || _h === void 0 ? void 0 : _h.comment) !== null && _j !== void 0 ? _j : '',
                ...
                Log_1.default.info('[Report] Legacy transaction fallback: creating money request preview in self DM', false, {
                    selfDMReportID: selfDMReportID,
                    transactionID: transactionID,
                    reportID: reportID,
                });
                optimisticData.push({
                    ...
                    value: (_a = {},
                        _a[generatedReportActionID] = __assign(__assign({}, optimisticParentAction), { reportActionID: generatedReportActionID, childReportID: reportID }),
                        _a),
                });
    ...
    var isInviteOnboardingComplete = (_k = introSelected === null || introSelected === void 0 ? void 0 : introSelected.isInviteOnboardingComplete) !== null && _k !== void 0 ? _k : false;
    var isOnboardingCompleted = (_l = onboarding === null || onboarding === void 0 ? void 0 : onboarding.hasCompletedGuidedSetupFlow) !== null && _l !== void 0 ? _l : false;
    ...
    if (isGroupChat) {
        ...
        parameters.optimisticAccountIDList = Object.keys((_m = newReportObject === null || newReportObject === void 0 ? void 0 : newReportObject.participants) !== null && _m !== void 0 ? _m : {}).join(',');
        parameters.reportName = (_o = newReportObject === null || newReportObject === void 0 ? void 0 : newReportObject.reportName) !== null && _o !== void 0 ? _o : '';
    ...
    if (isCreatingNewReport) {
        ...
        if (newReportObject.ownerAccountID && newReportObject.ownerAccountID !== CONST_1.default.REPORT.OWNER_ACCOUNT_ID_FAKE) {
            emailCreatingAction = (_q = (_p = allPersonalDetails === null || allPersonalDetails === void 0 ? void 0 : allPersonalDetails[newReportObject.ownerAccountID]) === null || _p === void 0 ? void 0 : _p.login) !== null && _q !== void 0 ? _q : '';
        }
        var optimisticCreatedAction = (0, ReportUtils_1.buildOptimisticCreatedReportAction)(emailCreatingAction);
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
            value: (_b = {}, _b[optimisticCreatedAction.reportActionID] = optimisticCreatedAction, _b),
        }, {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_METADATA).concat(reportID),
            value: {
        ...
        if (newReportObject.parentReportID && parentReportActionID) {
            optimisticData.push({
                ...
                value: (_d = {}, _d[parentReportActionID] = { childReportID: reportID, childType: CONST_1.default.REPORT.TYPE.CHAT }, _d),
            });
            failureData.push({
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(newReportObject.parentReportID),
                value: (_e = {}, _e[parentReportActionID] = { childType: '' }, _e),
            });
        }
    }
    parameters.clientLastReadTime = (_s = (_r = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)]) === null || _r === void 0 ? void 0 : _r.lastReadTime) !== null && _s !== void 0 ? _s : '';
...
function createTransactionThreadReport(iouReport, iouReportAction) {
    if (!iouReportAction) {
        Log_1.default.warn('Cannot build transaction thread report without iouReportAction parameter');
        return;
    }
    var reportToUse = iouReport;
    ...
    if (!iouReport && ReportActionsUtils.isTrackExpenseAction(iouReportAction)) {
        var selfDMReportID = (0, ReportUtils_1.findSelfDMReportID)();
        reportToUse = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(selfDMReportID)];
    }
    if (!reportToUse) {
        Log_1.default.warn('Cannot build transaction thread report without a valid report');
        return;
    }
    var optimisticTransactionThreadReportID = (0, ReportUtils_1.generateReportID)();
    var optimisticTransactionThread = (0, ReportUtils_1.buildTransactionThread)(iouReportAction, reportToUse, undefined, optimisticTransactionThreadReportID);
    openReport(optimisticTransactionThreadReportID, undefined, currentUserEmail ? [currentUserEmail] : [], optimisticTransactionThread, iouReportAction === null || iouReportAction === void 0 ? void 0 : iouReportAction.reportActionID);
...
function navigateToAndOpenReport(userLogins, shouldDismissModal, reportName, avatarUri, avatarFile, optimisticReportID, isGroupChat) {
    ...
    if (shouldDismissModal) {
        Navigation_1.default.onModalDismissedOnce(function () {
            Navigation_1.default.onModalDismissedOnce(function () {
    ...
    else if (report === null || report === void 0 ? void 0 : report.reportID) {
        Navigation_1.default.navigate(ROUTES_1.default.REPORT_WITH_ID.getRoute(report.reportID));
    }
...
function readNewestAction(reportID, shouldResetUnreadMarker) {
    ...
    var lastReadTime = NetworkConnection_1.default.getDBTimeWithSkew();
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID),
...
function markAllMessagesAsRead(archivedReportsIdSet) {
    if ((0, Session_1.isAnonymousUser)()) {
        return;
    }
    var newLastReadTime = NetworkConnection_1.default.getDBTimeWithSkew();
    ...
    Object.values(allReports !== null && allReports !== void 0 ? allReports : {}).forEach(function (report) {
        ...
        var isArchivedReport = archivedReportsIdSet.has("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_NAME_VALUE_PAIRS).concat(report.reportID));
        if (!(0, ReportUtils_1.isUnread)(report, oneTransactionThreadReport, isArchivedReport)) {
            return;
        }
...
function saveReportDraftComment(reportID, comment, callback) {
    ...
    react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_DRAFT_COMMENT).concat(reportID), comment || null).then(callback);
}
...
function handlePreexistingReport(report) {
    var _a;
    ...
    if ((0, ReportUtils_1.isMoneyRequestReport)(report) && parentReportActionID) {
    ...
    react_native_1.InteractionManager.runAfterInteractions(function () {
        ...
        if (Navigation_1.default.getActiveRoute().includes("/r/".concat(reportID))) {
            ...
            callback = function () {
                currCallback_1();
                Navigation_1.default.setParams({ reportID: preexistingReportID.toString() });
            };
...
function deleteReportComment(reportID, reportAction, ancestors, isReportArchived, isOriginalReportArchived) {
    var _a, _b, _c;
    var _d, _e, _f;
    ...
    var optimisticLastReportData = optimisticReportLastData(originalReportID, optimisticReportActions, canUserPerformWriteAction, isOriginalReportArchived);
    var optimisticReport = __assign({}, optimisticLastReportData);
    ...
    if (childVisibleActionCount === 0) {
        optimisticData.push.apply(optimisticData, (0, ReportUtils_1.getOptimisticDataForAncestors)(ancestors, (_f = optimisticReport === null || optimisticReport === void 0 ? void 0 : optimisticReport.lastVisibleActionCreated) !== null && _f !== void 0 ? _f : '', CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE));
    }
    var parameters = {
...
function handleUserDeletedLinksInHtml(newCommentText, originalCommentMarkdown, videoAttributeCache) {
    ...
    var userEmailDomain = (0, LoginUtils_1.isEmailPublicDomain)(currentUserEmail !== null && currentUserEmail !== void 0 ? currentUserEmail : '') ? '' : expensify_common_1.Str.extractEmailDomain(currentUserEmail !== null && currentUserEmail !== void 0 ? currentUserEmail : '');
    var allPersonalDetailLogins = Object.values(allPersonalDetails !== null && allPersonalDetails !== void 0 ? allPersonalDetails : {}).map(function (personalDetail) { var _a; return (_a = personalDetail === null || personalDetail === void 0 ? void 0 : personalDetail.login) !== null && _a !== void 0 ? _a : ''; });
    var htmlForNewComment = (0, ParsingUtils_1.getParsedMessageWithShortMentions)({
        text: newCommentText,
    ...
    var removedLinks = Parser_1.default.getRemovedMarkdownLinks(originalCommentMarkdown, newCommentText);
    return removeLinksFromHtml(htmlForNewComment, removedLinks);
}
/** Saves a new message for a comment. Marks the comment as edited, which will be reflected in the UI. */
function editReportComment(originalReport, originalReportAction, ancestors, textForNewComment, isOriginalReportArchived, isOriginalParentReportArchived, videoAttributeCache) {
    var _a, _b, _c;
    var originalReportID = originalReport === null || originalReport === void 0 ? void 0 : originalReport.reportID;
    if (!originalReportID || !originalReportAction) {
        return;
    }
    var canUserPerformWriteAction = (0, ReportUtils_1.canUserPerformWriteAction)(originalReport, isOriginalReportArchived);
...
function updateReportField(report, reportField, previousReportField, policy, isASAPSubmitBetaEnabled, accountID, email, hasViolationsParam, recentlyUsedReportFields, shouldFixViolations) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r;
    var _s, _t;
    if (shouldFixViolations === void 0) { shouldFixViolations = false; }
    ...
    var recentlyUsedValues = (_s = recentlyUsedReportFields === null || recentlyUsedReportFields === void 0 ? void 0 : recentlyUsedReportFields[fieldKey]) !== null && _s !== void 0 ? _s : [];
    ...
    var optimisticData = [
        {
            ...
            value: {
                ...
                pendingFields: (_b = {},
                    ...
                    _b.nextStep = CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.UPDATE,
                    _b),
            },
        },
        {
    ...
    var failureData = [
        {
            ...
            value: {
                fieldList: (_g = {},
                    ...
                    _g),
                nextStep: (_t = report.nextStep) !== null && _t !== void 0 ? _t : null,
                pendingFields: (_h = {},
                    _h[fieldKey] = null,
                    _h.nextStep = null,
                    _h),
...
function buildNewReportOptimisticData(policy, reportID, reportActionID, creatorPersonalDetails, reportPreviewReportActionID, hasViolationsParam, isASAPSubmitBetaEnabled) {
    var _a, _b, _c, _d, _e, _f;
    var accountID = creatorPersonalDetails.accountID, login = creatorPersonalDetails.login, email = creatorPersonalDetails.email;
    ...
    var optimisticNextStep = (0, NextStepUtils_1.buildOptimisticNextStep)({
        ...
        policy: policy,
        currentUserAccountIDParam: accountID,
        currentUserEmailParam: email !== null && email !== void 0 ? email : '',
        hasViolations: hasViolationsParam,
        isASAPSubmitBetaEnabled: isASAPSubmitBetaEnabled,
    });
    ...
    var outstandingChildRequest = (0, ReportUtils_1.getOutstandingChildRequest)(optimisticReportData);
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.SET,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID),
        ...
        },
        {
            ...
            value: __assign({ lastVisibleActionCreated: optimisticReportPreview.created, iouReportID: reportID }, outstandingChildRequest),
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
    ...
    optimisticData.push.apply(optimisticData, (0, ReportTitleUtils_1.updateTitleFieldToMatchPolicy)(reportID, policy));
    var currentSearchQueryJSON = (0, SearchQueryUtils_1.getCurrentSearchQueryJSON)();
    if ((currentSearchQueryJSON === null || currentSearchQueryJSON === void 0 ? void 0 : currentSearchQueryJSON.type) === CONST_1.default.SEARCH.DATA_TYPES.EXPENSE_REPORT) {
        // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.SNAPSHOT).concat(currentSearchQueryJSON.hash),
            value: {
                data: (_c = {}, _c["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)] = optimisticReportData, _c),
            },
        });
    }
    var failureData = [
        ...
        },
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
            // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
            value: (_d = {}, _d[reportActionID] = { errorFields: { createReport: (0, ErrorUtils_1.getMicroSecondOnyxErrorWithTranslationKey)('report.genericCreateReportFailureMessage') } }, _d),
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(parentReport === null || parentReport === void 0 ? void 0 : parentReport.reportID),
            value: { lastVisibleActionCreated: parentReport === null || parentReport === void 0 ? void 0 : parentReport.lastVisibleActionCreated, hasOutstandingChildRequest: parentReport === null || parentReport === void 0 ? void 0 : parentReport.hasOutstandingChildRequest },
        },
    ];
    var successData = [
        {
        ...
        },
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(parentReport === null || parentReport === void 0 ? void 0 : parentReport.reportID),
            value: (_f = {},
                _f[reportPreviewReportActionID] = {
                    pendingAction: null,
                    // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
                    errorFields: null,
                },
    ...
    return {
        ...
        successData: successData,
        failureData: failureData,
        optimisticReportData: optimisticReportData,
    };
}
function createNewReport(creatorPersonalDetails, hasViolationsParam, isASAPSubmitBetaEnabled, policyID, shouldNotifyNewAction) {
    ...
    var _a = buildNewReportOptimisticData(policy, optimisticReportID, reportActionID, creatorPersonalDetails, reportPreviewReportActionID, hasViolationsParam, isASAPSubmitBetaEnabled), optimisticReportName = _a.optimisticReportName, parentReportID = _a.parentReportID, reportPreviewAction = _a.reportPreviewAction, optimisticData = _a.optimisticData, successData = _a.successData, failureData = _a.failureData, optimisticReportData = _a.optimisticReportData;
    API.write(types_1.WRITE_COMMANDS.CREATE_APP_REPORT, { reportName: optimisticReportName, type: CONST_1.default.REPORT.TYPE.EXPENSE, policyID: policyID, reportID: optimisticReportID, reportActionID: reportActionID, reportPreviewReportActionID: reportPreviewReportActionID }, { optimisticData: optimisticData, successData: successData, failureData: failureData });
...
function shouldShowReportActionNotification(reportID, action, isRemote) {
    ...
    var topmostReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(topmostReportID)];
    var topmostReportActions = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["".concat(topmostReport === null || topmostReport === void 0 ? void 0 : topmostReport.reportID)];
    var chatTopmostReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(topmostReport === null || topmostReport === void 0 ? void 0 : topmostReport.chatReportID)];
    if (reportID === ReportActionsUtils.getOneTransactionThreadReportID(topmostReport, chatTopmostReport, topmostReportActions) && Visibility_1.default.isVisible() && Visibility_1.default.hasFocus()) {
        Log_1.default.info("".concat(tag, " No notification because the report is a transaction thread associated with the current one-transaction report"));
        return false;
    }
    var report = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)];
...
function showReportActionNotification(reportID, reportAction) {
    ...
    if (reportAction.actionName === CONST_1.default.REPORT.ACTIONS.TYPE.MODIFIED_EXPENSE) {
        var movedFromReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, ModifiedExpenseMessage_1.getMovedReportID)(reportAction, CONST_1.default.REPORT.MOVE_TYPE.FROM))];
        var movedToReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, ModifiedExpenseMessage_1.getMovedReportID)(reportAction, CONST_1.default.REPORT.MOVE_TYPE.TO))];
        LocalNotification_1.default.showModifiedExpenseNotification({ report: report, reportAction: reportAction, onClick: onClick, movedFromReport: movedFromReport, movedToReport: movedToReport });
    }
    else {
...
function leaveGroupChat(reportID, shouldClearQuickAction) {
    var _a;
    var report = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)];
    if (!report) {
...
function inviteToRoom(reportID, inviteeEmailsToAccountIDs, formatPhoneNumber) {
    var _a = buildInviteToRoomOnyxData(reportID, inviteeEmailsToAccountIDs, formatPhoneNumber), optimisticData = _a.optimisticData, successData = _a.successData, failureData = _a.failureData, isGroupChat = _a.isGroupChat, inviteeEmails = _a.inviteeEmails, newAccountIDs = _a.newAccountIDs;
    if (isGroupChat) {
        var parameters_1 = {
            reportID: reportID,
...
function optimisticReportLastData(reportID, optimisticReportActions, canUserPerformWriteAction, isReportArchived) {
    var _a, _b;
    if (optimisticReportActions === void 0) { optimisticReportActions = {}; }
    var lastMessageText = (_a = (0, ReportUtils_1.getLastVisibleMessage)(reportID, isReportArchived, optimisticReportActions).lastMessageText) !== null && _a !== void 0 ? _a : '';
    var lastVisibleAction = ReportActionsUtils.getLastVisibleAction(reportID, canUserPerformWriteAction, optimisticReportActions);
    return {
        lastMessageText: lastMessageText,
        lastVisibleActionCreated: (_b = lastVisibleAction === null || lastVisibleAction === void 0 ? void 0 : lastVisibleAction.created) !== null && _b !== void 0 ? _b : '',
        lastActorAccountID: lastMessageText ? lastVisibleAction === null || lastVisibleAction === void 0 ? void 0 : lastVisibleAction.actorAccountID : CONST_1.default.DEFAULT_NUMBER_ID,
    };
}
/** Flag a comment as offensive */
function flagComment(reportAction, severity, originalReport, isOriginalReportArchived) {
    var _a, _b, _c, _d;
    var originalReportID = originalReport === null || originalReport === void 0 ? void 0 : originalReport.reportID;
    ...
    var reportActionID = reportAction.reportActionID;
    var shouldHideMessage = [CONST_1.default.MODERATION.FLAG_SEVERITY_HARASSMENT, CONST_1.default.MODERATION.FLAG_SEVERITY_ASSAULT, CONST_1.default.MODERATION.FLAG_SEVERITY_INTIMIDATION, CONST_1.default.MODERATION.FLAG_SEVERITY_BULLYING].includes(severity);
    var updatedMessage = __assign(__assign(__assign({}, message), { moderationDecision: updatedDecision }), (shouldHideMessage ? { translationKey: '', type: 'COMMENT', html: '', text: '', isEdited: true } : {}));
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(originalReportID),
    ...
    var canUserPerformWriteAction = (0, ReportUtils_1.canUserPerformWriteAction)(report, isOriginalReportArchived);
    var optimisticLastReportData = optimisticReportLastData(originalReportID !== null && originalReportID !== void 0 ? originalReportID : String(CONST_1.default.DEFAULT_NUMBER_ID), (_b = {},
        _b[reportActionID] = __assign(__assign({}, reportAction), { message: [updatedMessage], pendingAction: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.UPDATE }),
        _b), canUserPerformWriteAction, isOriginalReportArchived);
    var optimisticReport = __assign({}, optimisticLastReportData);
    ...
    var failureData = [
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(originalReportID),
            value: (_c = {},
                _c[reportActionID] = __assign(__assign({}, reportAction), { pendingAction: null }),
                _c),
        },
    ];
    if (shouldHideMessage) {
...
function completeOnboarding(_a) {
    var engagementChoice = _a.engagementChoice, onboardingMessage = _a.onboardingMessage, _b = _a.firstName, firstName = _b === void 0 ? '' : _b, _c = _a.lastName, lastName = _c === void 0 ? '' : _c, adminsChatReportID = _a.adminsChatReportID, onboardingPolicyID = _a.onboardingPolicyID, paymentSelected = _a.paymentSelected, companySize = _a.companySize, userReportedIntegration = _a.userReportedIntegration, wasInvited = _a.wasInvited, _d = _a.selectedInterestedFeatures, selectedInterestedFeatures = _d === void 0 ? [] : _d, shouldSkipTestDriveModal = _a.shouldSkipTestDriveModal, isInvitedAccountant = _a.isInvitedAccountant;
    var onboardingData = (0, ReportUtils_1.prepareOnboardingOnyxData)(introSelected, engagementChoice, onboardingMessage, adminsChatReportID, onboardingPolicyID, userReportedIntegration, wasInvited, companySize, selectedInterestedFeatures, isInvitedAccountant);
    if (!onboardingData) {
        return;
    }
    ...
    if (!shouldSkipTestDriveModal && (onboarding === null || onboarding === void 0 ? void 0 : onboarding.testDriveModalDismissed) !== true) {
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: ONYXKEYS_1.default.NVP_ONBOARDING,
...
function searchForReports(searchInput, policyID) {
    ...
    var searchForRoomToMentionParams = { query: searchInput.toLowerCase(), policyID: policyID };
    var searchForReportsParams = { searchInput: searchInput.toLowerCase(), canCancel: true };
...
function resolveActionableMentionWhisper(reportID, reportAction, resolution, isReportArchived) {
    var _a, _b, _c;
    ...
    var optimisticReportActions = (_a = {},
        ...
        _a);
    var report = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)];
    var reportUpdateDataWithPreviousLastMessage = (0, ReportUtils_1.getReportLastMessage)(reportID, isReportArchived, optimisticReportActions);
...
function resolveActionableMentionConfirmWhisper(reportID, reportAction, resolution, isReportArchived) {
    resolveActionableMentionWhisper(reportID, reportAction, resolution, isReportArchived);
}
function resolveActionableReportMentionWhisper(reportId, reportAction, resolution, isReportArchived) {
    var _a, _b, _c;
    if (!reportAction || !reportId) {
        return;
    }
...
function downloadReportPDF(fileName, reportName) {
    ...
    (0, fileDownload_1.default)((0, addEncryptedAuthTokenToURL_1.default)(pdfURL, true), downloadFileName, '', Browser.isMobileSafari()).then(function () { return (0, Download_1.setDownload)(fileName, false); });
}
...
function deleteAppReport(reportID) {
    ...
    Object.values(reportActionsForReport !== null && reportActionsForReport !== void 0 ? reportActionsForReport : {}).forEach(function (reportAction) {
        ...
        var transactionID = (_l = ReportActionsUtils.getOriginalMessage(reportAction)) === null || _l === void 0 ? void 0 : _l.IOUTransactionID;
        ...
        if (transactionID) {
            ...
            failureData.push({
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                key: "".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat(transactionID),
                value: { reportID: transaction === null || transaction === void 0 ? void 0 : transaction.reportID, comment: { hold: (_m = transaction === null || transaction === void 0 ? void 0 : transaction.comment) === null || _m === void 0 ? void 0 : _m.hold } },
            }, 
            // @ts-expect-error - will be solved in https://github.com/Expensify/App/issues/73830
            {
                onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            ...
            if ((0, TransactionUtils_1.isOnHold)(transaction)) {
                ...
                optimisticData.push({
                    ...
                    value: (_a = {}, _a[unHoldAction.reportActionID] = unHoldAction, _a),
                });
                successData.push({
                    onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                    key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(childReportID),
                    value: (_b = {}, _b[unHoldAction.reportActionID] = { pendingAction: null }, _b),
                });
                failureData.push({
                    onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
                    key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(childReportID),
                    value: (_c = {}, _c[unHoldAction.reportActionID] = null, _c),
                });
                transactionIDToReportActionAndThreadData[transactionID] = __assign(__assign({}, transactionIDToReportActionAndThreadData[transactionID]), { unholdReportActionID: unHoldAction.reportActionID });
            }
        }
        ...
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(selfDMReportID),
            value: (_d = {}, _d[newReportActionID] = updatedReportAction, _d),
        });
        successData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(selfDMReportID),
            value: (_e = {}, _e[newReportActionID] = { pendingAction: null }, _e),
        });
        failureData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(selfDMReportID),
            value: (_f = {}, _f[newReportActionID] = null, _f),
        });
        ...
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(childReportID),
            value: (_h = {}, _h[unreportedAction.reportActionID] = unreportedAction, _h),
        });
        successData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(childReportID),
            value: (_j = {}, _j[unreportedAction.reportActionID] = { pendingAction: null }, _j),
        });
        failureData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(childReportID),
            value: (_k = {}, _k[unreportedAction.reportActionID] = null, _k),
        });
        if (transactionID) {
            transactionIDToReportActionAndThreadData[transactionID] = __assign(__assign({}, transactionIDToReportActionAndThreadData[transactionID]), { moneyRequestPreviewReportActionID: newReportActionID, movedReportActionID: unreportedAction === null || unreportedAction === void 0 ? void 0 : unreportedAction.reportActionID });
        }
    });
    ...
    var chatReport = (0, ReportUtils_1.getReportOrDraftReport)(report === null || report === void 0 ? void 0 : report.parentReportID);
    if (chatReport) {
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report === null || report === void 0 ? void 0 : report.parentReportID),
            value: { hasOutstandingChildRequest: (0, ReportUtils_1.hasOutstandingChildRequest)(chatReport, report === null || report === void 0 ? void 0 : report.reportID) },
        });
    }
    failureData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
 ...
 */
function moveIOUReportToPolicy(reportID, policy, isFromSettlementButton) {
    var _a, _b;
    ...
    if (!isReimbursed && ReportActionsUtils.hasRequestFromCurrentAccount(reportID, (_a = iouReport.managerID) !== null && _a !== void 0 ? _a : CONST_1.default.DEFAULT_NUMBER_ID) && !isFromSettlementButton) {
        return;
    }
    var policyID = policy.id;
    var iouReportID = iouReport.reportID;
    var employeeAccountID = iouReport.ownerAccountID;
    var expenseChatReportId = (_b = (0, ReportUtils_1.getPolicyExpenseChat)(employeeAccountID, policyID)) === null || _b === void 0 ? void 0 : _b.reportID;
    var useTemporaryOptimisticExpenseChatReportID = !expenseChatReportId;
    var optimisticExpenseChatReportID = expenseChatReportId !== null && expenseChatReportId !== void 0 ? expenseChatReportId : (0, ReportUtils_1.generateReportID)();
    var _c = convertIOUReportToExpenseReport(iouReport, policy, policyID, optimisticExpenseChatReportID), optimisticData = _c.optimisticData, successData = _c.successData, failureData = _c.failureData, movedExpenseReportAction = _c.movedExpenseReportAction, movedReportAction = _c.movedReportAction;
    var parameters = {
    ...
    return { policyExpenseChatReportID: optimisticExpenseChatReportID, useTemporaryOptimisticExpenseChatReportID: useTemporaryOptimisticExpenseChatReportID };
}
/**
 * Moves an IOU report to a policy by converting it to an expense report
 * @param reportID - The ID of the IOU report to move
 */
function moveIOUReportToPolicyAndInviteSubmitter(reportID, policy, formatPhoneNumber) {
    var _a, _b, _c, _d;
    var _e;
    var iouReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)];
    if (!policy || !iouReport) {
    ...
    if (!isReimbursed && ReportActionsUtils.hasRequestFromCurrentAccount(reportID, (_e = iouReport.managerID) !== null && _e !== void 0 ? _e : CONST_1.default.DEFAULT_NUMBER_ID)) {
        return;
    }
    var optimisticData = [];
    var successData = [];
    ...
    var _f = PersonalDetailsUtils.getNewAccountIDsAndLogins([submitterLogin], [submitterAccountID]), newAccountIDs = _f.newAccountIDs, newLogins = _f.newLogins;
    var newPersonalDetailsOnyxData = PersonalDetailsUtils.getPersonalDetailsOnyxDataForOptimisticUsers(newLogins, newAccountIDs, formatPhoneNumber);
    ...
    var optimisticMembersState = (_b = {},
        _b[submitterLogin] = {
            ...
            pendingAction: CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD,
            submitsTo: (0, PolicyUtils_1.getDefaultApprover)(policy),
        },
        _b);
    ...
    var _g = convertIOUReportToExpenseReport(iouReport, policy, policyID, optimisticPolicyExpenseChatReportID), convertedOptimisticData = _g.optimisticData, convertedSuccessData = _g.successData, convertedFailureData = _g.failureData, movedExpenseReportAction = _g.movedExpenseReportAction, movedReportAction = _g.movedReportAction;
    optimisticData.push.apply(optimisticData, convertedOptimisticData);
    successData.push.apply(successData, convertedSuccessData);
    failureData.push.apply(failureData, convertedFailureData);
    var parameters = {
...
function convertIOUReportToExpenseReport(iouReport, policy, policyID, optimisticPolicyExpenseChatReportID) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    var _k, _l, _m;
    var optimisticData = [];
    var successData = [];
    var failureData = [];
    var expenseReport = __assign(__assign({}, iouReport), { chatReportID: optimisticPolicyExpenseChatReportID, policyID: policyID, policyName: policy.name, parentReportID: optimisticPolicyExpenseChatReportID, type: CONST_1.default.REPORT.TYPE.EXPENSE, total: -((_k = iouReport === null || iouReport === void 0 ? void 0 : iouReport.total) !== null && _k !== void 0 ? _k : 0) });
    var nextApproverAccountID = (0, ReportUtils_1.getNextApproverAccountID)(iouReport, true);
    if (iouReport.managerID !== nextApproverAccountID) {
        expenseReport.stateNum = CONST_1.default.REPORT.STATE_NUM.OPEN;
        expenseReport.statusNum = CONST_1.default.REPORT.STATUS_NUM.OPEN;
        expenseReport.managerID = nextApproverAccountID;
    }
    var titleReportField = (0, ReportUtils_1.getTitleReportField)((_l = (0, ReportUtils_1.getReportFieldsByPolicyID)(policyID)) !== null && _l !== void 0 ? _l : {});
    ...
    var reportID = iouReport.reportID;
    optimisticData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID),
        value: expenseReport,
    ...
    var reportPreview = !!oldChatReportID && !!reportPreviewActionID ? (_m = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions[oldChatReportID]) === null || _m === void 0 ? void 0 : _m[reportPreviewActionID] : undefined;
    if (reportPreview === null || reportPreview === void 0 ? void 0 : reportPreview.reportActionID) {
        ...
        optimisticData.push({
            ...
            value: (_c = {}, _c[reportPreview.reportActionID] = __assign(__assign({}, reportPreview), { childReportName: expenseReport.reportName, created: DateUtils_1.default.getDBTime() }), _c),
        });
        failureData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(optimisticPolicyExpenseChatReportID),
    ...
    var movedExpenseReportAction = (0, ReportUtils_1.buildOptimisticMovedReportAction)(iouReport.policyID, policyID, optimisticPolicyExpenseChatReportID, reportID, policy.name, true);
    optimisticData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
        value: (_e = {}, _e[movedExpenseReportAction.reportActionID] = movedExpenseReportAction, _e),
    });
    successData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
        value: (_f = {},
            _f[movedExpenseReportAction.reportActionID] = __assign(__assign({}, movedExpenseReportAction), { pendingAction: null }),
            _f),
    });
    failureData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
        value: (_g = {}, _g[movedExpenseReportAction.reportActionID] = null, _g),
    });
    ...
    var movedReportAction = (0, ReportUtils_1.buildOptimisticMovedReportAction)(iouReport.policyID, policyID, optimisticPolicyExpenseChatReportID, reportID, policy.name);
    optimisticData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(oldChatReportID),
        value: (_h = {}, _h[movedReportAction.reportActionID] = movedReportAction, _h),
    });
    failureData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(oldChatReportID),
        value: (_j = {}, _j[movedReportAction.reportActionID] = null, _j),
    });
    return { optimisticData: optimisticData, successData: successData, failureData: failureData, movedExpenseReportAction: movedExpenseReportAction, movedReportAction: movedReportAction };
}
/**
...
function navigateToTrainingModal(isChangePolicyTrainingModalDismissed, reportID) {
...
function buildOptimisticChangePolicyData(report, policy, accountID, email, hasViolationsParam, isASAPSubmitBetaEnabled, isReportLastVisibleArchived, reportNextStep, optimisticPolicyExpenseChatReport) {
    ...
    var newStatusNum = report === null || report === void 0 ? void 0 : report.statusNum;
    var isOpenOrSubmitted = (0, ReportUtils_1.isOpenExpenseReport)(report) || (0, ReportUtils_1.isProcessingReport)(report);
    var managerLogin = PersonalDetailsUtils.getLoginByAccountID((_m = report.managerID) !== null && _m !== void 0 ? _m : CONST_1.default.DEFAULT_NUMBER_ID);
    ...
    if (newStatusNum) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-deprecated
        var optimisticNextStepDeprecated = (0, NextStepUtils_1.buildNextStepNew)({
            report: __assign(__assign({}, report), { policyID: policy.id }),
        ...
        failureData.push({
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID),
            value: {
                nextStep: (_o = report.nextStep) !== null && _o !== void 0 ? _o : null,
                pendingFields: {
                    nextStep: null,
                },
            },
    ...
    var shouldSetOutstandingChildRequest = false;
    if (newStatusNum === CONST_1.default.REPORT.STATUS_NUM.OPEN || isOpenOrSubmitted) {
        if (newStatusNum === CONST_1.default.REPORT.STATUS_NUM.OPEN) {
            shouldSetOutstandingChildRequest = (0, ReportUtils_1.isCurrentUserSubmitter)(report);
        }
        else if ((0, ReportUtils_1.isProcessingReport)(report)) {
    ...
    if (report.parentReportID && report.parentReportActionID) {
        ...
        var oldReportPreviewAction = (_p = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions[oldWorkspaceChatReportID]) === null || _p === void 0 ? void 0 : _p[oldReportPreviewActionID];
        ...
        var lastMessageText = (_q = (0, ReportUtils_1.getLastVisibleMessage)(oldWorkspaceChatReportID, isReportLastVisibleArchived, (_c = {},
            _c[oldReportPreviewActionID] = updatedReportPreviewAction,
            _c))) === null || _q === void 0 ? void 0 : _q.lastMessageText;
        var lastVisibleActionCreated = (_r = (0, ReportUtils_1.getReportLastMessage)(oldWorkspaceChatReportID, isReportLastVisibleArchived, (_d = {},
            _d[oldReportPreviewActionID] = updatedReportPreviewAction,
            _d))) === null || _r === void 0 ? void 0 : _r.lastVisibleActionCreated;
        optimisticData.push({
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
    ...
    var policyExpenseChat = optimisticPolicyExpenseChatReport !== null && optimisticPolicyExpenseChatReport !== void 0 ? optimisticPolicyExpenseChatReport : (0, ReportUtils_1.getPolicyExpenseChat)(report.ownerAccountID, policy.id);
    ...
    optimisticData.push({
        ...
        value: __assign({ lastVisibleActionCreated: optimisticReportPreviewAction === null || optimisticReportPreviewAction === void 0 ? void 0 : optimisticReportPreviewAction.created }, (shouldSetOutstandingChildRequest ? { hasOutstandingChildRequest: true } : {})),
    });
    failureData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(newPolicyExpenseChatReportID),
        value: { lastVisibleActionCreated: policyExpenseChat === null || policyExpenseChat === void 0 ? void 0 : policyExpenseChat.lastVisibleActionCreated, hasOutstandingChildRequest: policyExpenseChat === null || policyExpenseChat === void 0 ? void 0 : policyExpenseChat.hasOutstandingChildRequest },
    });
    // 4. Optimistically create a CHANGE_POLICY reportAction on the report using the reportActionID
    var optimisticMovedReportAction = (0, ReportUtils_1.buildOptimisticChangePolicyReportAction)(report.policyID, policy.id);
    optimisticData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID),
    ...
    if (policy && currentSearchQueryJSON) {
        ...
        optimisticData.push({
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.SNAPSHOT).concat(currentSearchQueryJSON.hash),
            value: {
                data: (_l = {}, _l["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policy.id)] = policy, _l),
            },
        });
    }
 ...
 */
function changeReportPolicy(report, policy, accountID, email, hasViolationsParam, isChangePolicyTrainingModalDismissed, isASAPSubmitBetaEnabled, reportNextStep, isReportLastVisibleArchived) {
    if (isReportLastVisibleArchived === void 0) { isReportLastVisibleArchived = false; }
    if (!report || !policy || report.policyID === policy.id || !(0, ReportUtils_1.isExpenseReport)(report)) {
        return;
    }
    var _a = buildOptimisticChangePolicyData(report, policy, accountID, email, hasViolationsParam, isASAPSubmitBetaEnabled, isReportLastVisibleArchived, reportNextStep), optimisticData = _a.optimisticData, successData = _a.successData, failureData = _a.failureData, optimisticReportPreviewAction = _a.optimisticReportPreviewAction, optimisticMovedReportAction = _a.optimisticMovedReportAction;
    var params = {
 ...
 */
function changeReportPolicyAndInviteSubmitter(report, policy, accountID, email, hasViolationsParam, isChangePolicyTrainingModalDismissed, isASAPSubmitBetaEnabled, employeeList, formatPhoneNumber, isReportLastVisibleArchived) {
    var _a;
    if (!report.reportID || !(policy === null || policy === void 0 ? void 0 : policy.id) || report.policyID === policy.id || !(0, ReportUtils_1.isExpenseReport)(report) || !report.ownerAccountID) {
        return;
    }
    ...
    var _b = (0, Member_1.buildAddMembersToWorkspaceOnyxData)((_a = {}, _a[submitterEmail] = report.ownerAccountID, _a), policy.id, policyMemberAccountIDs, CONST_1.default.POLICY.ROLE.USER, formatPhoneNumber, CONST_1.default.REPORT.NOTIFICATION_PREFERENCE.ALWAYS), optimisticData = _b.optimisticData, successData = _b.successData, failureData = _b.failureData, membersChats = _b.membersChats;
    ...
    var _c = buildOptimisticChangePolicyData(report, policy, accountID, email, hasViolationsParam, isASAPSubmitBetaEnabled, isReportLastVisibleArchived, undefined, membersChats.reportCreationData[submitterEmail]), optimisticChangePolicyData = _c.optimisticData, successChangePolicyData = _c.successData, failureChangePolicyData = _c.failureData, optimisticReportPreviewAction = _c.optimisticReportPreviewAction, optimisticMovedReportAction = _c.optimisticMovedReportAction;
 ...
 */
function resolveConciergeCategoryOptions(reportID, notifyReportID, reportActionID, selectedCategory, timezoneParam) {
    var _a;
    if (!reportID || !reportActionID) {
        return;
    }
    addComment(reportID, notifyReportID !== null && notifyReportID !== void 0 ? notifyReportID : reportID, selectedCategory, timezoneParam);
    react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID), (_a = {},
        _a[reportActionID] = {
            originalMessage: {
 ...
 */
function setOptimisticTransactionThread(reportID, parentReportID, parentReportActionID, policyID) {
    if (!reportID) {
        return;
    }
