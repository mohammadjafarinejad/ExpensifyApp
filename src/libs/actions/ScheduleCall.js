...
exports.sendScheduleCallNudge = sendScheduleCallNudge;
...
function sendScheduleCallNudge(accountID, reportID) {
    var params = {
        accountID: accountID,
        reportID: reportID,
    };
    API.write(types_1.WRITE_COMMANDS.SEND_SCHEDULE_CALL_NUDGE, params);
}
