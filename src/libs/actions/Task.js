 ...
 */
function createTaskAndNavigate(params) {
    var _a, _b, _c, _d, _e, _f, _g;
    var _h, _j;
    var parentReportID = params.parentReportID, title = params.title, description = params.description, assigneeEmail = params.assigneeEmail, currentUserAccountID = params.currentUserAccountID, currentUserEmail = params.currentUserEmail, _k = params.assigneeAccountID, assigneeAccountID = _k === void 0 ? 0 : _k, assigneeChatReport = params.assigneeChatReport, _l = params.policyID, policyID = _l === void 0 ? CONST_1.default.POLICY.OWNER_EMAIL_FAKE : _l, _m = params.isCreatedUsingMarkdown, isCreatedUsingMarkdown = _m === void 0 ? false : _m, _o = params.quickAction, quickAction = _o === void 0 ? {} : _o, _p = params.ancestors, ancestors = _p === void 0 ? [] : _p;
    if (!parentReportID) {
        return;
    }
    ...
    optimisticData.push.apply(optimisticData, ReportUtils.getOptimisticDataForAncestors(ancestors, currentTime, CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD));
    // FOR PARENT REPORT (SHARE DESTINATION)
    successData.push({
        onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
        key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(parentReportID),
...
function buildTaskData(taskReport, taskReportID) {
    ...
    var failureData = [
        {
            ...
            value: {
                ...
                lastReadTime: (_f = taskReport === null || taskReport === void 0 ? void 0 : taskReport.lastReadTime) !== null && _f !== void 0 ? _f : null,
            },
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
    ...
    var parentReportAction = getParentReportAction(taskReport);
    if (parentReportAction) {
        optimisticData.push({
            ...
            value: (_d = {},
                _d[parentReportAction.reportActionID] = {
        ...
        failureData.push({
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(parentReport === null || parentReport === void 0 ? void 0 : parentReport.reportID),
            value: (_e = {},
                _e[parentReportAction.reportActionID] = {
 ...
 */
function reopenTask(taskReport, currentUserAccountID, reportIDFromAction) {
    var _a, _b, _c;
    var _d;
...
function editTaskAssignee(report, sessionAccountID, assigneeEmail, currentUserAccountID, assigneeAccountID, assigneeChatReport) {
...
function setNewOptimisticAssignee(currentUserAccountID, assigneePersonalDetails) {
    var _a;
    var _b;
    ...
    var optimisticPersonalDetailsListAction = {
        ...
        avatar: assigneePersonalDetails === null || assigneePersonalDetails === void 0 ? void 0 : assigneePersonalDetails.avatar,
        displayName: (_b = assigneePersonalDetails === null || assigneePersonalDetails === void 0 ? void 0 : assigneePersonalDetails.displayName) !== null && _b !== void 0 ? _b : assigneePersonalDetails === null || assigneePersonalDetails === void 0 ? void 0 : assigneePersonalDetails.login,
        login: assigneePersonalDetails === null || assigneePersonalDetails === void 0 ? void 0 : assigneePersonalDetails.login,
    };
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, (_a = {}, _a[assigneePersonalDetails.accountID] = optimisticPersonalDetailsListAction, _a));
 ...
 */
function setAssigneeValue(currentUserAccountID, assigneePersonalDetails, shareToReportID, chatReport, isCurrentUser, skipShareDestination) {
    var _a;
    ...
    // This is only needed for creation of a new task and so it should only be stored locally
    react_native_onyx_1.default.merge(ONYXKEYS_1.default.TASK, { assignee: (_a = assigneePersonalDetails === null || assigneePersonalDetails === void 0 ? void 0 : assigneePersonalDetails.login) !== null && _a !== void 0 ? _a : '', assigneeAccountID: assigneePersonalDetails.accountID });
 ...
 */
function clearOutTaskInfoAndNavigate(currentUserAccountID, assigneePersonalDetails, reportID, chatReport, skipConfirmation) {
    var _a;
    if (skipConfirmation === void 0) { skipConfirmation = false; }
    ...
    var assigneeAccountID = (_a = assigneePersonalDetails === null || assigneePersonalDetails === void 0 ? void 0 : assigneePersonalDetails.accountID) !== null && _a !== void 0 ? _a : CONST_1.default.DEFAULT_NUMBER_ID;
 ...
 */
function startOutCreateTaskQuickAction(currentUserAccountID, reportID, targetAccountPersonalDetails) {
...
function getShareDestination(reportID, reports, personalDetails, localeCompare) {
    var _a, _b, _c, _d, _e, _f;
    var report = reports === null || reports === void 0 ? void 0 : reports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID)];
    ...
    var displayNamesWithTooltips = ReportUtils.getDisplayNamesWithTooltips(OptionsListUtils.getPersonalDetailsForAccountIDs(participants, personalDetails), isMultipleParticipant, localeCompare);
    var subtitle = '';
    if (isOneOnOneChat) {
 ...
 */
function deleteTask(report, isReportArchived, currentUserAccountID) {
    var _a, _b, _c, _d, _e, _f;
    var _g, _h, _j, _k, _l;
    if (!report) {
        return;
    ...
    var parentReport = getParentReport(report);
    var canUserPerformWriteAction = ReportUtils.canUserPerformWriteAction(report, isReportArchived);
    ...
    var hasOutstandingChildTask = getOutstandingChildTask(report);
    var optimisticLastReportData = (0, Report_1.optimisticReportLastData)((_g = parentReport === null || parentReport === void 0 ? void 0 : parentReport.reportID) !== null && _g !== void 0 ? _g : String(CONST_1.default.DEFAULT_NUMBER_ID), optimisticReportActions, canUserPerformWriteAction);
    var optimisticData = [
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID),
        ...
        },
        {
            ...
            value: __assign(__assign({}, optimisticLastReportData), { hasOutstandingChildTask: hasOutstandingChildTask }),
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(report.reportID),
    ...
    var childVisibleActionCount = (_h = parentReportAction === null || parentReportAction === void 0 ? void 0 : parentReportAction.childVisibleActionCount) !== null && _h !== void 0 ? _h : 0;
    if (childVisibleActionCount === 0) {
        var optimisticParentReportData = ReportUtils.getOptimisticDataForParentReportAction(parentReport, (_j = parentReport === null || parentReport === void 0 ? void 0 : parentReport.lastVisibleActionCreated) !== null && _j !== void 0 ? _j : '', CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE);
    ...
    var failureData = [
        {
            ...
            key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID),
            value: {
                stateNum: (_k = report.stateNum) !== null && _k !== void 0 ? _k : '',
                statusNum: (_l = report.statusNum) !== null && _l !== void 0 ? _l : '',
            },
        },
        {
            onyxMethod: react_native_onyx_1.default.METHOD.MERGE,
...
function canActionTask(taskReport, sessionAccountID, parentReport, isParentReportArchived) {
    ...
    if (!parentReport && !(taskReport === null || taskReport === void 0 ? void 0 : taskReport.parentReportID)) {
        return false;
    }
...
function getFinishOnboardingTaskOnyxData(taskReport, taskParentReport, isParentReportArchived, currentUserAccountID) {
...
function completeTestDriveTask(viewTourTaskReport, viewTourTaskParentReport, isViewTourTaskParentReportArchived, currentUserAccountID, shouldUpdateSelfTourViewedOnlyLocally) {
