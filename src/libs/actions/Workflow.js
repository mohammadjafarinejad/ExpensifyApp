...
function createApprovalWorkflow(approvalWorkflow, policy) {
    var _a;
    if (!policy) {
        return;
    }
    ...
    var parameters = { policyID: policy.id, employees: JSON.stringify(Object.values(updatedEmployees)) };
...
function updateApprovalWorkflow(approvalWorkflow, membersToRemove, approversToRemove, policy) {
    var _a, _b, _c;
    if (!policy) {
        return;
    }
    var previousDefaultApprover = (0, PolicyUtils_1.getDefaultApprover)(policy);
    var newDefaultApprover = approvalWorkflow.isDefault ? (_a = approvalWorkflow.approvers.at(0)) === null || _a === void 0 ? void 0 : _a.email : undefined;
    var previousEmployeeList = Object.fromEntries(Object.entries((_b = policy.employeeList) !== null && _b !== void 0 ? _b : {}).map(function (_a) {
        var key = _a[0], value = _a[1];
        return [key, __assign(__assign({}, value), { pendingAction: null })];
    }));
    var updatedEmployees = (0, WorkflowUtils_1.convertApprovalWorkflowToPolicyEmployees)({
        ...
        defaultApprover: (_c = newDefaultApprover !== null && newDefaultApprover !== void 0 ? newDefaultApprover : previousDefaultApprover) !== null && _c !== void 0 ? _c : '',
    });
    // If there are no changes to the employees list, we can exit early
...
function removeApprovalWorkflow(approvalWorkflow, policy) {
    var _a;
    if (!policy) {
        return;
    }
 ...
 */
function setApprovalWorkflowApprover(_a) {
    var _b;
    var approver = _a.approver, approverIndex = _a.approverIndex, currentApprovalWorkflow = _a.currentApprovalWorkflow, policy = _a.policy, personalDetailsByEmail = _a.personalDetailsByEmail;
    if (!currentApprovalWorkflow || !(policy === null || policy === void 0 ? void 0 : policy.employeeList) || !personalDetailsByEmail) {
        return;
    }
    ...
    if ((_b = policy.employeeList[approver.email]) === null || _b === void 0 ? void 0 : _b.forwardsTo) {
...
function clearApprovalWorkflowApprover(_a) {
    var approverIndex = _a.approverIndex, currentApprovalWorkflow = _a.currentApprovalWorkflow;
