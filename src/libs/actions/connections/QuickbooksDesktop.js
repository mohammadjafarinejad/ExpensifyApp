...
exports.updateQuickbooksDesktopAccountingMethod = updateQuickbooksDesktopAccountingMethod;
...
function updateQuickbooksDesktopAccountingMethod(policyID, settingValue, oldSettingValue) {
    var onyxData = buildOnyxDataForQuickbooksExportConfiguration(policyID, CONST_1.default.QUICKBOOKS_DESKTOP_CONFIG.ACCOUNTING_METHOD, settingValue, oldSettingValue);
    var parameters = {
        policyID: policyID,
        accountingMethod: settingValue,
    };
    API.write(types_1.WRITE_COMMANDS.UPDATE_QUICKBOOKS_DESKTOP_ACCOUNTING_METHOD, parameters, onyxData);
}
