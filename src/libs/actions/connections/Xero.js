...
function updateXeroAccountingMethod(policyID, accountingMethod, oldAccountingMethod) {
    ...
    var _a = prepareXeroExportOptimisticData(policyID, CONST_1.default.XERO_CONFIG.ACCOUNTING_METHOD, accountingMethod, oldAccountingMethod), optimisticData = _a.optimisticData, failureData = _a.failureData, successData = _a.successData;
    API.write(types_1.WRITE_COMMANDS.UPDATE_XERO_ACCOUNTING_METHOD, parameters, { optimisticData: optimisticData, failureData: failureData, successData: successData });
}
