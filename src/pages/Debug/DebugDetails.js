...
function DebugDetails(_a) {
    ...
    var booleanFields = (0, react_1.useMemo)(function () {
        return Object.entries(data !== null && data !== void 0 ? data : {})
            ...
            .sort(function (a, b) { return localeCompare(a[0], b[0]); });
    }, [data, localeCompare]);
    ...
    var textFields = (0, react_1.useMemo)(function () {
        return Object.entries(data !== null && data !== void 0 ? data : {})
            ...
            .sort(function (a, b) { var _a, _b; return localeCompare((_a = a.at(0)) !== null && _a !== void 0 ? _a : '', (_b = b.at(0)) !== null && _b !== void 0 ? _b : ''); });
