...
function DebugReportActions(_a) {
    ...
    var _b = (0, useLocalize_1.default)(), translate = _b.translate, datetimeToCalendarTime = _b.datetimeToCalendarTime, localeCompare = _b.localeCompare;
    ...
    var ifUserCanPerformWriteAction = (0, ReportUtils_1.canUserPerformWriteAction)(report, isReportArchived);
    ...
    var getSortedAllReportActionsSelector = (0, react_1.useCallback)(function (allReportActions) {
        return (0, ReportActionsUtils_1.getSortedReportActionsForDisplay)(allReportActions, ifUserCanPerformWriteAction, true);
    ...
    var getReportActionDebugText = (0, react_1.useCallback)(function (reportAction) {
        ...
        if ((0, ReportActionsUtils_1.isCreatedAction)(reportAction)) {
            return (0, ReportUtils_1.formatReportLastMessageText)((_a = SidebarUtils_1.default.getWelcomeMessage(report, policy, participantPersonalDetailList, localeCompare, isReportArchived).messageText) !== null && _a !== void 0 ? _a : translate('report.noActivityYet'));
        }
