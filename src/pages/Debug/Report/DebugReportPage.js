...
function DebugReportPage(_a) {
    ...
    var reportAttributesSelector = (0, react_1.useCallback)(function (attributes) { var _a; return (_a = attributes === null || attributes === void 0 ? void 0 : attributes.reports) === null || _a === void 0 ? void 0 : _a[reportID]; }, [reportID]);
    var reportAttributes = (0, useOnyx_1.default)(ONYXKEYS_1.default.DERIVED.REPORT_ATTRIBUTES, {
        selector: reportAttributesSelector,
        canBeMissing: true,
    }, [reportAttributesSelector])[0];
    ...
    var metadata = (0, react_1.useMemo)(function () {
        ...
        var _e = (_c = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow(report, chatReport, reportActions, transactions, transactionViolations, hasViolations, (_b = reportAttributes === null || reportAttributes === void 0 ? void 0 : reportAttributes.reportErrors) !== null && _b !== void 0 ? _b : {}, isReportArchived)) !== null && _c !== void 0 ? _c : {}, reasonRBR = _e.reason, reportActionRBR = _e.reportAction;
        var hasRBR = !!reasonRBR;
        var hasGBR = !hasRBR && !!reasonGBR;
        var reasonLHN = DebugUtils_1.default.getReasonForShowingRowInLHN({
            report: report,
    ...
    }, [report, transactionViolations, reportID, isReportArchived, chatReport, reportActions, transactions, reportAttributes === null || reportAttributes === void 0 ? void 0 : reportAttributes.reportErrors, betas, priorityMode, draftComment, translate]);
