...
function DebugReportActionCreatePage(_a) {
    ...
    var _c = (0, react_1.useState)(function () { return getInitialReportAction(reportID, session, personalDetailsList); }), draftReportAction = _c[0], setDraftReportAction = _c[1];
