...
function DebugTransactionPage(_a) {
    ...
    var report = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(transaction === null || transaction === void 0 ? void 0 : transaction.reportID), {
        canBeMissing: true,
    })[0];
    var policyTags = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.POLICY_TAGS).concat(report === null || report === void 0 ? void 0 : report.policyID), {
        canBeMissing: true,
    })[0];
    var policyTagLists = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.getTagLists)(policyTags); }, [policyTags]);
    var styles = (0, useThemeStyles_1.default)();
    var DebugDetailsTab = (0, react_1.useCallback)(function () { return (<DebugDetails_1.default formType={CONST_1.default.DEBUG.FORMS.TRANSACTION} data={transaction} policyID={report === null || report === void 0 ? void 0 : report.policyID} policyHasEnabledTags={(0, TagsOptionsListUtils_1.hasEnabledTags)(policyTagLists)} onSave={function (data) {
