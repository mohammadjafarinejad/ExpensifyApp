...
function EditReportFieldDropdownPage(_a) {
    ...
    }, [fieldOptions, localeCompare, debouncedSearchValue, fieldValue, recentlyUsedOptions, translate]), sections = _d[0], headerMessage = _d[1];
    ...
    return (<SelectionListWithSections_1.default textInputValue={searchValue} textInputLabel={translate('common.search')} sections={sections !== null && sections !== void 0 ? sections : []} onSelectRow={function (option) {
        var _a;
