...
function PlaidStep(_a) {
    ...
    var handleNextPress = (0, react_1.useCallback)(function () {
        var _a;
        var _b, _c, _d;
        var selectedPlaidBankAccount = ((_b = plaidData === null || plaidData === void 0 ? void 0 : plaidData.bankAccounts) !== null && _b !== void 0 ? _b : []).find(function (account) { return account.plaidAccountID === (personalBankAccountDraft === null || personalBankAccountDraft === void 0 ? void 0 : personalBankAccountDraft[BANK_INFO_STEP_KEYS.PLAID_ACCOUNT_ID]); });
