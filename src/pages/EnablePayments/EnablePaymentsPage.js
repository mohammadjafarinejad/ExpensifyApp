...
function EnablePaymentsPage() {
    ...
    var userWallet = (0, useOnyx_1.default)(ONYXKEYS_1.default.USER_WALLET, {
        canBeMissing: true,
        // We want to refresh the wallet each time the user attempts to activate the wallet so we won't use the
        // stored values here.
        initWithStoredValues: false,
    })[0];
    var _a = userWallet !== null && userWallet !== void 0 ? userWallet : {}, isPendingOnfidoResult = _a.isPendingOnfidoResult, hasFailedOnfido = _a.hasFailedOnfido;
    ...
    return (<ScreenWrapper_1.default shouldShowOfflineIndicator={(userWallet === null || userWallet === void 0 ? void 0 : userWallet.currentStep) !== CONST_1.default.WALLET.STEP.ONFIDO} includeSafeAreaPaddingBottom testID={EnablePaymentsPage.displayName} forwardedFSClass={CONST_1.default.FULLSTORY.CLASS.MASK}>
            {function () {
