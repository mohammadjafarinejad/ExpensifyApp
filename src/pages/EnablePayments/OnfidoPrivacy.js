...
function OnfidoPrivacy(_a) {
    ...
    var onfidoError = (_b = (0, ErrorUtils_1.getLatestErrorMessage)(walletOnfidoData)) !== null && _b !== void 0 ? _b : '';
    ...
    return (<react_native_1.View style={[styles.flex1, styles.justifyContentBetween]}>
            {!hasAcceptedPrivacyPolicy ? (<>
                    ...
                    <FixedFooter_1.default>
                        <FormAlertWithSubmitButton_1.default isAlertVisible={!!onfidoError} onSubmit={BankAccounts_1.openOnfidoFlow} onFixTheErrorsLinkPressed={function () {
                var _a;
