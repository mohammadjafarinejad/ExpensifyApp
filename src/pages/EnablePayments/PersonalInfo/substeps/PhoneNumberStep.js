...
function PhoneNumberStep(_a) {
    ...
    var walletAdditionalDetails = (0, useOnyx_1.default)(ONYXKEYS_1.default.WALLET_ADDITIONAL_DETAILS, { canBeMissing: true })[0];
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        if (values.phoneNumber) {
            var phoneNumberWithCountryCode = (0, LoginUtils_1.appendCountryCode)(values.phoneNumber, countryCode);
            var e164FormattedPhoneNumber = (0, LoginUtils_1.formatE164PhoneNumber)(values.phoneNumber, countryCode);
    ...
    return (<SingleFieldStep_1.default isEditing={isEditing} onNext={onNext} onMove={onMove} formID={ONYXKEYS_1.default.FORMS.WALLET_ADDITIONAL_DETAILS} formTitle={translate('personalInfoStep.whatsYourPhoneNumber')} formDisclaimer={translate('personalInfoStep.weNeedThisToVerify')} validate={validate} onSubmit={function (values) {
            var _a;
            handleSubmit(__assign(__assign({}, values), { phoneNumber: (_a = (0, LoginUtils_1.formatE164PhoneNumber)(values.phoneNumber, countryCode)) !== null && _a !== void 0 ? _a : '' }));
