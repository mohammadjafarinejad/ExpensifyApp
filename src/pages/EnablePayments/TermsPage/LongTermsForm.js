...
function LongTermsForm() {
    ...
    var termsData = [
        {
            ...
            rightText: (0, CurrencyUtils_1.convertToDisplayString)(0, 'USD'),
        ...
        },
        {
            ...
            subRightText: translate('termsStep.longTermsForm.electronicFundsInstantFeeMin', { amount: (0, CurrencyUtils_1.convertToDisplayString)(25, 'USD') }),
            details: translate('termsStep.longTermsForm.electronicFundsInstantDetails', { percentage: numberFormat(1.5), amount: (0, CurrencyUtils_1.convertToDisplayString)(25, 'USD') }),
        },
    ];
    ...
    return (<>
            ...
            <Text_1.default style={[styles.mb4, styles.mt6, styles.textMicroSupporting]}>
                {translate('termsStep.longTermsForm.fdicInsuranceBancorp', { amount: (0, CurrencyUtils_1.convertToDisplayString)(25000000, 'USD') })}
            </Text_1.default>
            <Text_1.default style={[styles.mb4, styles.textMicroSupporting]}>{translate('termsStep.noOverdraftOrCredit')}</Text_1.default>
            <Text_1.default style={[styles.mb4, styles.textMicroSupporting]}>{translate('termsStep.longTermsForm.contactExpensifyPayments')}</Text_1.default>
            <Text_1.default style={[styles.mb6, styles.textMicroSupporting]}>{translate('termsStep.longTermsForm.generalInformation')}</Text_1.default>
