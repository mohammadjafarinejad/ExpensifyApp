...
function GroupChatNameEditPage(_a) {
    ...
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.NEW_GROUP_CHAT_DRAFT, { canBeMissing: true })[0], groupChatDraft = _b === void 0 ? (0, ReportUtils_1.getGroupChatDraft)() : _b;
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        var nameLength = StringUtils_1.default.getUTF8ByteLength(name.trim());
