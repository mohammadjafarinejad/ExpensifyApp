...
function KeyboardShortcutsPage(_a) {
    var route = _a.route;
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={KeyboardShortcutsPage.displayName}>
            <HeaderWithBackButton_1.default title={translate('keyboardShortcutsPage.title')} onBackButtonPress={function () { return Navigation_1.default.goBack(backTo); }}/>
