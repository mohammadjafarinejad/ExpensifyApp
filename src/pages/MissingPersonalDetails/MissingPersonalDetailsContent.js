...
function MissingPersonalDetailsContent(_a) {
    var privatePersonalDetails = _a.privatePersonalDetails, draftValues = _a.draftValues, headerTitle = _a.headerTitle, onComplete = _a.onComplete;
    ...
    var handleFinishStep = (0, react_1.useCallback)(function () {
        ...
        if (!onComplete) {
            Navigation_1.default.navigate(ROUTES_1.default.MISSING_PERSONAL_DETAILS_CONFIRM_MAGIC_CODE);
            return;
        }
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} shouldEnableMaxHeight testID={MissingPersonalDetailsContent.displayName}>
            <HeaderWithBackButton_1.default title={headerTitle !== null && headerTitle !== void 0 ? headerTitle : translate('workspace.expensifyCard.addShippingDetails')} onBackButtonPress={handleBackButtonPress}/>
