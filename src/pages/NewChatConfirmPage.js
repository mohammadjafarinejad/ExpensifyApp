...
function NewChatConfirmPage() {
    ...
    var _c = (0, useOnyx_1.default)(ONYXKEYS_1.default.NEW_GROUP_CHAT_DRAFT, { canBeMissing: true }), newGroupDraft = _c[0], newGroupDraftMetaData = _c[1];
    ...
    var sections = (0, react_1.useMemo)(function () {
        return selectedOptions
            ...
            .sort(function (a, b) { var _a, _b, _c, _d; return localeCompare((_b = (_a = a.text) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '', (_d = (_c = b.text) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : ''); });
    ...
    source={stashedLocalAvatarImage !== null && stashedLocalAvatarImage !== void 0 ? stashedLocalAvatarImage : (0, ReportUtils_1.getDefaultGroupAvatar)(optimisticReportID.current)} onImageSelected={function (image) {
            ...
            setAvatarFile(undefined);
            (0, Report_1.setGroupDraft)({ avatarUri: null, avatarFileName: null, avatarFileType: null });
        }} size={CONST_1.default.AVATAR_SIZE.X_LARGE} avatarStyle={styles.avatarXLarge} editIcon={Expensicons.Camera} editIconStyle={styles.smallEditIconAccount} style={styles.w100}/>
            </react_native_1.View>
            ...
            <react_native_1.View style={[styles.flex1, styles.mt3]}>
                <SelectionListWithSections_1.default canSelectMultiple sections={[{ title: translate('common.members'), data: sections }]} ListItem={InviteMemberListItem_1.default} onSelectRow={unselectOption} showConfirmButton={!!selectedOptions.length} confirmButtonText={translate('newChatPage.startGroup')} onConfirm={createGroup} shouldHideListOnInitialRender={false}/>
            </react_native_1.View>
