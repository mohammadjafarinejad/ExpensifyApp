...
function BaseOnboardingEmployees(_a) {
    ...
    return (<ScreenWrapper_1.default testID="BaseOnboardingEmployees" style={[styles.defaultModalContainer, shouldUseNativeStyles && styles.pt8]}>
            <HeaderWithBackButton_1.default shouldShowBackButton progressBarPercentage={onboardingPurposeSelected === CONST_1.default.ONBOARDING_CHOICES.MANAGE_TEAM ? 80 : 90} onBackButtonPress={function () {
            ...
            <SelectionList_1.default data={companySizeOptions} onSelectRow={function (item) {
            setSelectedCompanySize(item.keyForList);
            setError('');
        }} initiallyFocusedItemKey={(_b = companySizeOptions.find(function (item) { return item.keyForList === selectedCompanySize; })) === null || _b === void 0 ? void 0 : _b.keyForList} shouldUpdateFocusedIndex ListItem={RadioListItem_1.default} footerContent={footerContent} style={{ listItemWrapperStyle: onboardingIsMediumOrLargerScreenWidth ? [styles.pl8, styles.pr8] : [] }}/>
