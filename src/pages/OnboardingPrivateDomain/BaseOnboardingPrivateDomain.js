...
function BaseOnboardingPrivateDomain(_a) {
    ...
    return (<ScreenWrapper_1.default shouldEnableMaxHeight includeSafeAreaPaddingBottom testID="BaseOnboardingPrivateDomain" style={[styles.defaultModalContainer, shouldUseNativeStyles && styles.pt8]}>
            <HeaderWithBackButton_1.default shouldShowBackButton progressBarPercentage={40} onBackButtonPress={function () {
            var _a, _b;
            var routeToNavigate = (_b = (_a = route.params) === null || _a === void 0 ? void 0 : _a.backTo) !== null && _b !== void 0 ? _b : ROUTES_1.default.ONBOARDING_PERSONAL_DETAILS.getRoute();
            Navigation_1.default.goBack(routeToNavigate);
        }}/>
