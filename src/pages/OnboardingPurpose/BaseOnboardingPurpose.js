...
function BaseOnboardingPurpose(_a) {
    ...
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.ONBOARDING_ERROR_MESSAGE_TRANSLATION_KEY, { canBeMissing: true }), onboardingErrorMessage = _b[0], onboardingErrorMessageResult = _b[1];
        ...
        return {
            ...
            onPress: function () {
                ...
                if (isPrivateDomainAndHasAccessiblePolicies && (personalDetailsForm === null || personalDetailsForm === void 0 ? void 0 : personalDetailsForm.firstName)) {
                    if (choice === CONST_1.default.ONBOARDING_CHOICES.PERSONAL_SPEND) {
                ...
                Navigation_1.default.navigate(ROUTES_1.default.ONBOARDING_PERSONAL_DETAILS.getRoute((_c = route.params) === null || _c === void 0 ? void 0 : _c.backTo));
            },
        };
    });
    var isFocused = (0, native_1.useIsFocused)();
    var handleOuterClick = (0, react_1.useCallback)(function () {
        (0, Welcome_1.setOnboardingErrorMessage)('onboarding.errorSelection');
    }, []);
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom testID="BaseOnboardingPurpose" style={[styles.defaultModalContainer, shouldUseNativeStyles && styles.pt8]} shouldEnableMaxHeight={shouldEnableMaxHeight}>
            ...
            <react_native_1.View style={[styles.w100, styles.mb5, styles.mh0, paddingHorizontal]}>
                <FormHelpMessage_1.default message={onboardingErrorMessage ? translate(onboardingErrorMessage) : undefined}/>
            </react_native_1.View>
