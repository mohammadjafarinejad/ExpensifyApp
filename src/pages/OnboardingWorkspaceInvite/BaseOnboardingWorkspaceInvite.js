...
function BaseOnboardingWorkspaceInvite(_a) {
    ...
    var _f = (0, react_1.useState)([]), personalDetails = _f[0], setPersonalDetails = _f[1];
    var _g = (0, react_1.useState)([]), usersToInvite = _g[0], setUsersToInvite = _g[1];
    var _h = (0, react_1.useState)(false), didScreenTransitionEnd = _h[0], setDidScreenTransitionEnd = _h[1];
    ...
    }), options = _j.options, areOptionsInitialized = _j.areOptionsInitialized;
    ...
    var defaultOptions = (0, react_1.useMemo)(function () {
        ...
        var inviteOptions = (0, OptionsListUtils_1.getMemberInviteOptions)(options.personalDetails, nvpDismissedProductTraining, betas !== null && betas !== void 0 ? betas : [], excludedUsers, true);
    ...
    var completeOnboarding = (0, react_1.useCallback)(function (isInvitedAccountant) {
        var _a;
        (0, Report_2.completeOnboarding)({
            ...
            isInvitedAccountant: isInvitedAccountant,
        });
    ...
    var inviteUser = (0, react_1.useCallback)(function () {
        ...
        (0, Member_1.addMembersToWorkspace)(invitedEmailsToAccountIDs, "".concat(welcomeNoteSubject, "\n\n").concat(welcomeNote), onboardingPolicyID, policyMemberAccountIDs, CONST_1.default.POLICY.ROLE.USER, formatPhoneNumber);
        completeOnboarding(true);
    }, [completeOnboarding, onboardingPolicyID, policy === null || policy === void 0 ? void 0 : policy.employeeList, selectedOptions, welcomeNote, welcomeNoteSubject, formatPhoneNumber]);
    (0, react_1.useEffect)(function () {
    ...
    var headerMessage = (0, react_1.useMemo)(function () {
        ...
        if (usersToInvite.length === 0 &&
            excludedUsers[(0, PhoneNumber_1.parsePhoneNumber)((0, LoginUtils_1.appendCountryCode)(searchValue, countryCode)).possible ? (0, PhoneNumber_1.addSMSDomainIfPhoneNumber)((0, LoginUtils_1.appendCountryCode)(searchValue, countryCode)) : searchValue]) {
        ...
        return (0, OptionsListUtils_1.getHeaderMessage)(personalDetails.length !== 0, usersToInvite.length > 0, searchValue, countryCode, false);
    }, [excludedUsers, translate, debouncedSearchTerm, policy === null || policy === void 0 ? void 0 : policy.name, usersToInvite, personalDetails.length, countryCode]);
    var footerContent = (0, react_1.useMemo)(function () { return (<react_native_1.View style={[onboardingIsMediumOrLargerScreenWidth ? styles.mh3 : undefined]}>
                <react_native_1.View style={styles.mb2}>
                    <Button_1.default large text={translate('common.skip')} onPress={function () { return completeOnboarding(false); }}/>
                </react_native_1.View>
                <react_native_1.View>
