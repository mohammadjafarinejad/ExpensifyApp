...
function BaseOnboardingWorkspaces(_a) {
    ...
    var skipJoiningWorkspaces = function () {
        var _a, _b, _c;
        if (isVsb) {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom shouldEnableMaxHeight testID="BaseOnboardingWorkspaces" style={[styles.defaultModalContainer, shouldUseNativeStyles && styles.pt8]} shouldShowOfflineIndicator={isSmallScreenWidth}>
            ...
            <SelectionList_1.default data={policyIDItems} onSelectRow={function () { }} ListItem={UserListItem_1.default} style={{ listItemWrapperStyle: onboardingIsMediumOrLargerScreenWidth ? [styles.pl8, styles.pr8, styles.cursorDefault] : [] }} showLoadingPlaceholder={joinablePoliciesLoading} shouldStopPropagation showScrollIndicator customListHeader={<react_native_1.View style={[wrapperPadding, onboardingIsMediumOrLargerScreenWidth && styles.mt5, styles.mb5]}>
                    ...
                    </react_native_1.View>} footerContent={<Button_1.default success={false} large text={translate('common.skip')} testID="onboardingWorkSpaceSkipButton" onPress={skipJoiningWorkspaces} style={[styles.mt5]}/>}/>
