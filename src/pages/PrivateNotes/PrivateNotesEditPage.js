...
function PrivateNotesEditPageInternal(_a) {
    var _b, _c, _d, _e, _f;
    var route = _a.route, report = _a.report, accountID = _a.accountID, privateNoteDraft = _a.privateNoteDraft;
    ...
    return (<ScreenWrapper_1.default shouldEnableMaxHeight includeSafeAreaPaddingBottom testID={PrivateNotesEditPageInternal.displayName}>
...
function PrivateNotesEditPage(_a) {
    var report = _a.report, rest = __rest(_a, ["report"]);
    var _b = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.PRIVATE_NOTES_DRAFT).concat(report.reportID), { canBeMissing: true }), privateNoteDraft = _b[0], privateNoteDraftMetadata = _b[1];
    if ((0, isLoadingOnyxValue_1.default)(privateNoteDraftMetadata)) {
        return null;
    }
    ...
    return (<PrivateNotesEditPageInternal report={report} privateNoteDraft={privateNoteDraft !== null && privateNoteDraft !== void 0 ? privateNoteDraft : ''} 
