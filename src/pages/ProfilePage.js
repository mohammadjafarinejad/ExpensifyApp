...
var reportsSelector = function (reports) { return (0, mapOnyxCollectionItems_1.default)(reports, chatReportSelector); };
function ProfilePage(_a) {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s;
    var route = _a.route;
    var reports = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.REPORT, { selector: reportsSelector, canBeMissing: true })[0];
    ...
    var _t = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_DEBUG_MODE_ENABLED, { canBeMissing: true })[0], isDebugModeEnabled = _t === void 0 ? false : _t;
    ...
    var _u = (0, useLocalize_1.default)(), translate = _u.translate, formatPhoneNumber = _u.formatPhoneNumber;
            ...
            <FullPageNotFoundView_1.default shouldShow={shouldShowBlockingView}>
                ...
                <react_native_1.View style={[styles.containerWithSpaceBetween, styles.pointerEventsBoxNone]}>
                    <ScrollView_1.default>
                        ...
                        {!(0, EmptyObject_1.isEmptyObject)(report) && !!report.reportID && !isCurrentUser && (<MenuItem_1.default title={"".concat(translate('privateNotes.title'))} titleStyle={styles.flex1} icon={Expensicons.Pencil} onPress={function () { var _a; return (0, ReportUtils_1.navigateToPrivateNotes)(report, (_a = session === null || session === void 0 ? void 0 : session.accountID) !== null && _a !== void 0 ? _a : CONST_1.default.DEFAULT_NUMBER_ID, navigateBackTo); }} wrapperStyle={styles.breakAll} shouldShowRightIcon brickRoadIndicator={(0, Report_1.hasErrorInPrivateNotes)(report) ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined}/>)}
