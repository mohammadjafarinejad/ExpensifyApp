...
function Address(_a) {
    ...
    var defaultValues = {
        ...
        country: ((_c = reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[inputKeys.country]) !== null && _c !== void 0 ? _c : ''),
    };
    ...
    var _d = (0, react_1.useState)(defaultValues.country === CONST_1.default.COUNTRY.US || defaultValues.country === CONST_1.default.COUNTRY.CA || defaultValues.country === ''), shouldDisplayStateSelector = _d[0], setShouldDisplayStateSelector = _d[1];
