...
function Documents(_a) {
    ...
    var beneficialOwnerCountry = (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[beneficialOwnerCountryInputID]);
    ...
    var defaultValues = (_b = {},
        _b[proofOfOwnershipInputID] = Array.isArray(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[proofOfOwnershipInputID]) ? ((_f = reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[proofOfOwnershipInputID]) !== null && _f !== void 0 ? _f : []) : [],
        _b[copyOfIDInputID] = Array.isArray(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[copyOfIDInputID]) ? ((_g = reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[copyOfIDInputID]) !== null && _g !== void 0 ? _g : []) : [],
        _b[addressProofInputID] = Array.isArray(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[addressProofInputID]) ? ((_h = reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[addressProofInputID]) !== null && _h !== void 0 ? _h : []) : [],
        _b[codiceFiscaleInputID] = Array.isArray(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[codiceFiscaleInputID]) ? ((_j = reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[codiceFiscaleInputID]) !== null && _j !== void 0 ? _j : []) : [],
        _b);
    var _k = (0, react_1.useState)(defaultValues[proofOfOwnershipInputID]), uploadedProofOfOwnership = _k[0], setUploadedProofOfOwnership = _k[1];
    var _l = (0, react_1.useState)(defaultValues[copyOfIDInputID]), uploadedCopyOfID = _l[0], setUploadedCopyOfID = _l[1];
    var _m = (0, react_1.useState)(defaultValues[addressProofInputID]), uploadedAddressProof = _m[0], setUploadedAddressProof = _m[1];
    var _o = (0, react_1.useState)(defaultValues[codiceFiscaleInputID]), uploadedCodiceFiscale = _o[0], setUploadedCodiceFiscale = _o[1];
