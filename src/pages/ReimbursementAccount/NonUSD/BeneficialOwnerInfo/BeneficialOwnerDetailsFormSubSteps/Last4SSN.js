...
function Last4SSN(_a) {
    ...
    var defaultLast4SSN = (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[last4SSNInputID]);
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        if (values[last4SSNInputID] && !(0, ValidationUtils_1.isValidSSNLastFour)((0, SafeString_1.default)(values[last4SSNInputID]))) {
