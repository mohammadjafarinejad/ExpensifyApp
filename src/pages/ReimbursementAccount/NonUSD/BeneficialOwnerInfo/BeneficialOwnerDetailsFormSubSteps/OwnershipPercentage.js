...
function OwnershipPercentage(_a) {
    ...
    var defaultOwnershipPercentage = (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[ownershipPercentageInputID]);
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        if (values[ownershipPercentageInputID] && !(0, ValidationUtils_1.isValidOwnershipPercentage)((0, SafeString_1.default)(values[ownershipPercentageInputID]), totalOwnedPercentage, ownerBeingModifiedID)) {
