...
var INPUT_KEYS = {
    ...
    BUSINESS_TYPE_ID: ReimbursementAccountForm_1.default.ADDITIONAL_DATA.CORPAY.BUSINESS_TYPE_ID,
};
function BusinessInfo(_a) {
    ...
    var submit = (0, react_1.useCallback)(function () {
        (0, BankAccounts_1.saveCorpayOnboardingCompanyDetails)(__assign(__assign({}, businessInfoStepValues), { 
            ...
            businessConfirmationEmail: !isProduction && isBetaEnabled(CONST_1.default.BETAS.GLOBAL_REIMBURSEMENTS_ON_ND)
                ...
                : businessInfoStepValues.businessConfirmationEmail, fundSourceCountries: country, fundDestinationCountries: country, currencyNeeded: currency, purposeOfTransactionId: CONST_1.default.NON_USD_BANK_ACCOUNT.PURPOSE_OF_TRANSACTION_ID, businessTypeId: isBusinessTypeRequired ? businessInfoStepValues.businessTypeId : undefined }), bankAccountID);
