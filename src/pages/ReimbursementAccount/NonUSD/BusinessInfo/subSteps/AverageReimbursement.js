...
var TRADE_VOLUME = ReimbursementAccountForm_1.default.ADDITIONAL_DATA.CORPAY.TRADE_VOLUME;
var STEP_FIELDS = [TRADE_VOLUME];
function AverageReimbursement(_a) {
    var _b, _c;
        ...
        return [
            {
                ...
                defaultValue: (_c = (_b = (_a = reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.achData) === null || _a === void 0 ? void 0 : _a.corpay) === null || _b === void 0 ? void 0 : _b[TRADE_VOLUME]) !== null && _c !== void 0 ? _c : '',
