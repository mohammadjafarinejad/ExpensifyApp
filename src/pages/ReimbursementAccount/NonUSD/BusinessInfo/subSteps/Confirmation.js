...
function Confirmation(_a) {
    ...
    var isBusinessTypeRequired = values[COMPANY_COUNTRY_CODE] !== CONST_2.default.COUNTRY.CA;
    ...
    var businessType = (0, react_1.useMemo)(function () { var _a; return displayStringValue((_a = corpayOnboardingFields === null || corpayOnboardingFields === void 0 ? void 0 : corpayOnboardingFields.picklists.BusinessType) !== null && _a !== void 0 ? _a : [], values[BUSINESS_TYPE_ID]); }, [corpayOnboardingFields === null || corpayOnboardingFields === void 0 ? void 0 : corpayOnboardingFields.picklists.BusinessType, values]);
    var summaryItems = (0, react_1.useMemo)(function () { return __spreadArray(__spreadArray([
        {
    ...
    ], false); }, [businessCategory, businessType, incorporationType, isBusinessTypeRequired, onMove, paymentVolume, tradeVolumeRange, translate, values]);
