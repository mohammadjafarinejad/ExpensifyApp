...
function EnterEmail(_a) {
    var _b, _c, _d, _e, _f;
    var onSubmit = _a.onSubmit, isUserDirector = _a.isUserDirector, isLoading = _a.isLoading;
    ...
    var shouldGatherOnlySecondSignerEmail = currency === CONST_1.default.CURRENCY.AUD && isUserDirector;
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        if (!shouldGatherOnlySecondSignerEmail && values[SIGNER_EMAIL] && !expensify_common_1.Str.isValidEmail(values[SIGNER_EMAIL])) {
            errors[SIGNER_EMAIL] = translate('bankAccount.error.email');
        }
        if (shouldGatherOnlySecondSignerEmail && values[SECOND_SIGNER_EMAIL] && !expensify_common_1.Str.isValidEmail(String(values[SECOND_SIGNER_EMAIL]))) {
    ...
    return (<FormProvider_1.default formID={ONYXKEYS_1.default.FORMS.REIMBURSEMENT_ACCOUNT_FORM} submitButtonText={translate('common.next')} onSubmit={onSubmit} isLoading={isLoading} validate={validate} style={[styles.mh5, styles.flexGrow1]} shouldHideFixErrorsAlert={!shouldGatherBothEmails}>
            ...
            <InputWrapper_1.default InputComponent={TextInput_1.default} label={shouldGatherBothEmails ? "".concat(translate('common.email'), " 1") : translate('common.email')} aria-label={shouldGatherBothEmails ? "".concat(translate('common.email'), " 1") : translate('common.email')} role={CONST_1.default.ROLE.PRESENTATION} inputID={shouldGatherOnlySecondSignerEmail ? SECOND_SIGNER_EMAIL : SIGNER_EMAIL} inputMode={CONST_1.default.INPUT_MODE.EMAIL} containerStyles={[styles.mt6]} ref={!shouldGatherBothEmails ? inputCallbackRef : undefined}/>
