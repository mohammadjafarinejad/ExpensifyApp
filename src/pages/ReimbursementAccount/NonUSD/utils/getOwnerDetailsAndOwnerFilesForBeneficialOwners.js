...
function getOwnerDetailsAndOwnerFilesForBeneficialOwners(ownerKeys, reimbursementAccountDraft) {
    ...
    ownerKeys.forEach(function (ownerKey) {
        ...
        ownerDetailsFields.forEach(function (fieldName) {
            ...
            if (fieldName === SSN_LAST_4 && (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[ownerDetailsNationalityKey]) !== CONST_1.default.COUNTRY.US) {
                return;
            }
            if (fieldName === OWNERSHIP_PERCENTAGE) {
                ownerDetails[ownerDetailsKey] = (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[ownerDetailsKey]);
                return;
            }
            if (fieldName === FIRST_NAME || fieldName === LAST_NAME) {
                ownerDetails[ownerDetailsFullNameKey] = ownerDetails[ownerDetailsFullNameKey]
                    ? "".concat((0, SafeString_1.default)(ownerDetails[ownerDetailsFullNameKey]), " ").concat((0, SafeString_1.default)(reimbursementAccountDraft[ownerDetailsKey]))
            ...
            if (fieldName === STREET || fieldName === CITY || fieldName === STATE || fieldName === ZIP_CODE) {
                ownerDetails[ownerDetailsResidentialAddressKey] = ownerDetails[ownerDetailsResidentialAddressKey]
                    ? "".concat((0, SafeString_1.default)(ownerDetails[ownerDetailsResidentialAddressKey]), ", ").concat((0, SafeString_1.default)(reimbursementAccountDraft[ownerDetailsKey]))
                    : reimbursementAccountDraft[ownerDetailsKey];
                return;
            }
