    ...
    signerDetailsFields.forEach(function (fieldName) {
        ...
        if (fieldName === STREET || fieldName === CITY || fieldName === STATE || fieldName === ZIP_CODE) {
            signerDetails[ADDRESS] = signerDetails[ADDRESS]
                ? "".concat((0, SafeString_1.default)(signerDetails[ADDRESS]), ", ").concat((0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[fieldName]))
                : reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[fieldName];
            return;
        }
        ...
        beneficialOwnerFields.forEach(function (fieldName) {
            ...
            if (fieldName === FIRST_NAME || fieldName === LAST_NAME) {
                signerDetails[FULL_NAME] = signerDetails[FULL_NAME]
                    ? "".concat((0, SafeString_1.default)(signerDetails[FULL_NAME]), " ").concat((0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[beneficialFieldKey]))
                    : (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[beneficialFieldKey]);
                return;
            }
            if (fieldName === DOB) {
                signerDetails[DATE_OF_BIRTH] = (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[beneficialFieldKey]);
                return;
            }
            if (fieldName === BENEFICIAL_STREET || fieldName === BENEFICIAL_CITY || fieldName === BENEFICIAL_STATE || fieldName === BENEFICIAL_ZIP_CODE) {
                signerDetails[ADDRESS] = signerDetails[ADDRESS]
                    ? "".concat((0, SafeString_1.default)(signerDetails[ADDRESS]), ", ").concat((0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[beneficialFieldKey]))
                    : (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[beneficialFieldKey]);
            }
        });
    }
