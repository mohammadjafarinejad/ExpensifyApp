...
function Plaid(_a) {
    ...
    var handleNextPress = (0, react_1.useCallback)(function () {
        var _a;
        var _b, _c, _d;
        var selectedPlaidBankAccount = ((_b = plaidData === null || plaidData === void 0 ? void 0 : plaidData.bankAccounts) !== null && _b !== void 0 ? _b : []).find(function (account) { return account.plaidAccountID === (reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[BANK_INFO_STEP_KEYS.PLAID_ACCOUNT_ID]); });
