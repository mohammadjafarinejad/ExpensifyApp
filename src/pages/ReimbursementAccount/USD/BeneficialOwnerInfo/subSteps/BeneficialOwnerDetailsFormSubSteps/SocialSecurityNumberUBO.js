...
function SocialSecurityNumberUBO(_a) {
    ...
    var defaultSsnLast4 = (0, SafeString_1.default)(reimbursementAccountDraft === null || reimbursementAccountDraft === void 0 ? void 0 : reimbursementAccountDraft[ssnLast4InputID]);
    var stepFields = [ssnLast4InputID];
    var validate = function (values) {
        var errors = (0, ValidationUtils_1.getFieldRequiredErrors)(values, stepFields);
        if (values[ssnLast4InputID] && !(0, ValidationUtils_1.isValidSSNLastFour)((0, SafeString_1.default)(values[ssnLast4InputID]))) {
