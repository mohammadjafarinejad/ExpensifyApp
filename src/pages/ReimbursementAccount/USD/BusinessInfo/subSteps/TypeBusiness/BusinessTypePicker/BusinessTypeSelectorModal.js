...
function BusinessTypeSelectorModal(_a) {
    ...
    return (<Modal_1.default type={CONST_1.default.MODAL.MODAL_TYPE.RIGHT_DOCKED} isVisible={isVisible} onClose={onClose} onBackdropPress={function () {
            onClose();
            ...
            <ScreenWrapper_1.default style={[styles.pb0]} includePaddingTop={false} includeSafeAreaPaddingBottom={false} testID={BusinessTypeSelectorModal.displayName}>
                ...
                <SelectionList_1.default data={incorporationTypes} initiallyFocusedItemKey={currentBusinessType} onSelectRow={onBusinessTypeSelected} shouldSingleExecuteRowSelect shouldStopPropagation ListItem={RadioListItem_1.default}/>
