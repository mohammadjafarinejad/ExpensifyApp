...
function TermsAndConditionsLabel() {
    var translate = (0, useLocalize_1.default)().translate;
    return <RenderHTML_1.default html={translate('common.acceptTermsAndConditions')}/>;
}
function ConfirmAgreements(_a) {
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        if (!(0, ValidationUtils_1.isRequiredFulfilled)(values.acceptTermsAndConditions)) {
            errors.acceptTermsAndConditions = translate('common.error.acceptTerms');
        }
        if (!(0, ValidationUtils_1.isRequiredFulfilled)(values.certifyTrueInformation)) {
            errors.certifyTrueInformation = translate('completeVerificationStep.certifyTrueAndAccurateError');
        }
        if (!(0, ValidationUtils_1.isRequiredFulfilled)(values.isAuthorizedToUseBankAccount)) {
