...
function ConnectBankAccount(_a) {
    ...
    var policy = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat((_b = reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.achData) === null || _b === void 0 ? void 0 : _b.policyID), { canBeMissing: true })[0];
    ...
    var isBankAccountVerifying = !maxAttemptsReached && bankAccountState === CONST_1.default.BANK_ACCOUNT.STATE.VERIFYING;
    var isBankAccountPending = bankAccountState === CONST_1.default.BANK_ACCOUNT.STATE.PENDING;
