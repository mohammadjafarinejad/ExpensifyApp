 ...
 */
function getStepToOpenFromRouteParams(route, hasConfirmedUSDCurrency) {
    switch (route.params.stepToOpen) {
        case ReimbursementAccountUtils_1.REIMBURSEMENT_ACCOUNT_ROUTE_NAMES.NEW:
            return hasConfirmedUSDCurrency ? CONST_1.default.BANK_ACCOUNT.STEP.BANK_ACCOUNT : CONST_1.default.BANK_ACCOUNT.STEP.COUNTRY;
