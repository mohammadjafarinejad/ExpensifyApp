...
function VerifiedBankAccountFlowEntryPoint(_a) {
    ...
    var reimbursementAccountOptionPressed = (0, useOnyx_1.default)(ONYXKEYS_1.default.REIMBURSEMENT_ACCOUNT_OPTION_PRESSED, { canBeMissing: true })[0];
     ...
     */
    var prepareNextStep = (0, react_1.useCallback)(function (setupType) {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={VerifiedBankAccountFlowEntryPoint.displayName} shouldShowOfflineIndicatorInWideScreen={!!isValidateCodeActionModalVisible}>
                ...
                <Section_1.default title={translate(shouldShowContinueSetupButton === true ? 'workspace.bankAccount.almostDone' : 'workspace.bankAccount.streamlinePayments')} titleStyles={styles.textHeadline} subtitle={translate(shouldShowContinueSetupButton === true ? 'workspace.bankAccount.youAreAlmostDone' : 'bankAccount.toGetStarted')} subtitleStyles={styles.textSupporting} subtitleMuted illustration={LottieAnimations_1.default.FastMoney} illustrationBackgroundColor={theme.fallbackIconColor} isCentralPane>
                    ...
                    <react_native_1.View style={styles.mt4}>
                        {shouldShowContinueSetupButton === true ? (<OfflineWithFeedback_1.default errors={(reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.maxAttemptsReached) ? (0, ErrorUtils_1.getMicroSecondOnyxErrorWithTranslationKey)('connectBankAccountStep.maxAttemptsReached') : (0, ErrorUtils_1.getLatestError)(errors)} errorRowStyles={styles.mt2} shouldShowErrorMessages canDismissError={!(reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.maxAttemptsReached)} onClose={ReimbursementAccount_1.resetReimbursementAccount}>
                                <MenuItem_1.default title={translate('workspace.bankAccount.continueWithSetup')} icon={Expensicons_1.Connect} onPress={onContinuePress} shouldShowRightIcon outerWrapperStyle={shouldUseNarrowLayout ? styles.mhn5 : styles.mhn8} disabled={!!pendingAction || (!(0, EmptyObject_1.isEmptyObject)(errors) && !(reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.maxAttemptsReached))}/>
                                <MenuItem_1.default title={translate('workspace.bankAccount.startOver')} icon={Expensicons_1.RotateLeft} onPress={ReimbursementAccount_1.requestResetBankAccount} shouldShowRightIcon outerWrapperStyle={shouldUseNarrowLayout ? styles.mhn5 : styles.mhn8} disabled={!!pendingAction || (!(0, EmptyObject_1.isEmptyObject)(errors) && !(reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.maxAttemptsReached))}/>
