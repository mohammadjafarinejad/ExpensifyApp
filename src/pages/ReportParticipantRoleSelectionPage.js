...
function ReportParticipantRoleSelectionPage(_a) {
    ...
    var backTo = ROUTES_1.default.REPORT_PARTICIPANTS_DETAILS.getRoute(report.reportID, accountID, route.params.backTo);
    var member = (_d = report.participants) === null || _d === void 0 ? void 0 : _d[accountID];
    if (!member) {
    ...
    var changeRole = function (_a) {
        var value = _a.value;
        (0, Report_1.updateGroupChatMemberRoles)(report.reportID, [accountID], value);
    ...
    return (<ScreenWrapper_1.default testID={ReportParticipantRoleSelectionPage.displayName}>
            ...
            <react_native_1.View style={[styles.containerWithSpaceBetween, styles.pointerEventsBoxNone]}>
                <SelectionList_1.default data={items} ListItem={RadioListItem_1.default} onSelectRow={changeRole} shouldSingleExecuteRowSelect initiallyFocusedItemKey={(_e = items.find(function (item) { return item.isSelected; })) === null || _e === void 0 ? void 0 : _e.keyForList}/>
            </react_native_1.View>
