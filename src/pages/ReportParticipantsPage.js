...
function ReportParticipantsPage(_a) {
    ...
    var canSelectMultiple = isGroupChat && isCurrentUserAdmin && (isSmallScreenWidth ? isMobileSelectionModeEnabled : true);
    ...
    var getParticipants = function () {
        ...
        result = result.sort(function (a, b) { var _a, _b; return localeCompare(((_a = a.text) !== null && _a !== void 0 ? _a : '').toLowerCase(), ((_b = b.text) !== null && _b !== void 0 ? _b : '').toLowerCase()); });
        return result;
    };
