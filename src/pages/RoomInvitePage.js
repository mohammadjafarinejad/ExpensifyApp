...
function RoomInvitePage(_a) {
    ...
    var _d = (0, useDebouncedState_1.default)(userSearchPhrase !== null && userSearchPhrase !== void 0 ? userSearchPhrase : ''), searchTerm = _d[0], debouncedSearchTerm = _d[1], setSearchTerm = _d[2];
    ...
    var _f = (0, OptionListContextProvider_1.useOptionsList)(), options = _f.options, areOptionsInitialized = _f.areOptionsInitialized;
    ...
    var defaultOptions = (0, react_1.useMemo)(function () {
        ...
        var inviteOptions = (0, OptionsListUtils_1.getMemberInviteOptions)(options.personalDetails, nvpDismissedProductTraining, betas !== null && betas !== void 0 ? betas : [], excludedUsers);
    ...
    var inviteOptions = (0, react_1.useMemo)(function () {
        ...
        var filteredOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(defaultOptions, debouncedSearchTerm, countryCode, { excludeLogins: excludedUsers });
    ...
    var sections = (0, react_1.useMemo)(function () {
        ...
        if (debouncedSearchTerm !== '') {
            filterSelectedOptions = selectedOptions.filter(function (option) {
                ...
                var parsedPhoneNumber = (0, PhoneNumber_1.parsePhoneNumber)((0, LoginUtils_1.appendCountryCode)(expensify_common_1.Str.removeSMSDomain(debouncedSearchTerm), countryCode));
        ...
        var hasUnselectedUserToInvite = userToInvite && !selectedLogins.has(userToInvite.login);
        sectionsArr.push({
    ...
    var headerMessage = (0, react_1.useMemo)(function () {
        ...
        return (0, OptionsListUtils_1.getHeaderMessage)(((_a = inviteOptions.personalDetails) !== null && _a !== void 0 ? _a : []).length !== 0, !!inviteOptions.userToInvite, debouncedSearchTerm, countryCode);
    ...
    return (<ScreenWrapper_1.default shouldEnableMaxHeight testID={RoomInvitePage.displayName} includeSafeAreaPaddingBottom>
            <FullPageNotFoundView_1.default shouldShow={(0, EmptyObject_1.isEmptyObject)(report) || isReportArchived} subtitleKey={subtitleKey} onBackButtonPress={goBack}>
                ...
                <SelectionListWithSections_1.default canSelectMultiple sections={sections} ListItem={InviteMemberListItem_1.default} textInputLabel={translate('selectionList.nameEmailOrPhoneNumber')} textInputValue={searchTerm} onChangeText={function (value) {
            setSearchTerm(value);
