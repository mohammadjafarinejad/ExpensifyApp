...
function RoomMembersPage(_a) {
    ...
    var _d = (0, useLocalize_1.default)(), formatPhoneNumber = _d.formatPhoneNumber, translate = _d.translate, localeCompare = _d.localeCompare;
    ...
    var data = (0, react_1.useMemo)(function () {
        ...
        result = result.sort(function (value1, value2) { var _a, _b; return localeCompare((_a = value1.text) !== null && _a !== void 0 ? _a : '', (_b = value2.text) !== null && _b !== void 0 ? _b : ''); });
        return result;
    }, [
        formatPhoneNumber,
        localeCompare,
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} style={[styles.defaultModalContainer]} testID={RoomMembersPage.displayName}>
            <FullPageNotFoundView_1.default shouldShow={(0, EmptyObject_1.isEmptyObject)(report) || isReportArchived || (!(0, ReportUtils_1.isChatThread)(report) && (((0, ReportUtils_1.isUserCreatedPolicyRoom)(report) && !isPolicyEmployee) || (0, ReportUtils_1.isDefaultRoom)(report)))} subtitleKey={subtitleKey} onBackButtonPress={function () {
            Navigation_1.default.goBack(ROUTES_1.default.REPORT_WITH_ID_DETAILS.getRoute(report.reportID, backTo));
        }}>
