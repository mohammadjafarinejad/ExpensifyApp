...
function ScheduleCallConfirmationPage() {
    ...
    var guideDetails = (0, react_1.useMemo)(function () {
        ...
        return ((_a = scheduleCallDraft === null || scheduleCallDraft === void 0 ? void 0 : scheduleCallDraft.guide) === null || _a === void 0 ? void 0 : _a.accountID)
            ? ((_b = personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails[scheduleCallDraft.guide.accountID]) !== null && _b !== void 0 ? _b : {
                ...
                avatar: (0, UserAvatarUtils_1.getDefaultAvatarURL)({
                    accountID: scheduleCallDraft.guide.accountID,
    ...
    var dateTimeString = (0, react_1.useMemo)(function () {
        ...
        var dateString = DateUtils_1.default.formatInTimeZoneWithFallback(scheduleCallDraft.date, userTimezone, CONST_1.default.DATE.MONTH_DAY_YEAR_FORMAT);
    ...
    (0, react_1.useEffect)(function () {
        var _a;
        var guideAccountID = (_a = scheduleCallDraft === null || scheduleCallDraft === void 0 ? void 0 : scheduleCallDraft.guide) === null || _a === void 0 ? void 0 : _a.accountID;
        if (guideAccountID && !(personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails[guideAccountID])) {
            (0, PersonalDetails_1.openPublicProfilePage)(guideAccountID);
        }
    }, [(_d = scheduleCallDraft === null || scheduleCallDraft === void 0 ? void 0 : scheduleCallDraft.guide) === null || _d === void 0 ? void 0 : _d.accountID, personalDetails]);
    return (<ScreenWrapper_1.default shouldEnableKeyboardAvoidingView={false} testID={ScheduleCallConfirmationPage.displayName}>
            ...
            <FullPageOfflineBlockingView_1.default>
                <ScrollView_1.default contentContainerStyle={[styles.flexGrow1]}>
                    ...
                    <MenuItem_1.default style={styles.mb3} title={guideDetails === null || guideDetails === void 0 ? void 0 : guideDetails.displayName} description={guideDetails === null || guideDetails === void 0 ? void 0 : guideDetails.login} label={translate('scheduledCall.confirmation.setupSpecialist')} interactive={false} iconAccountID={(_e = guideDetails === null || guideDetails === void 0 ? void 0 : guideDetails.accountID) !== null && _e !== void 0 ? _e : CONST_1.default.DEFAULT_NUMBER_ID}/>
