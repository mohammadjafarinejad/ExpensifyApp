...
var adminReportNameValuePairsSelector = function (data) { return ({
...
function ScheduleCallPage() {
    ...
    (0, react_1.useEffect)(function () {
        return function () {
            var _a;
            (0, ScheduleCall_1.sendScheduleCallNudge)((_a = session === null || session === void 0 ? void 0 : session.accountID) !== null && _a !== void 0 ? _a : CONST_1.default.DEFAULT_NUMBER_ID, reportID);
        };
                ...
                {((_d = adminReportNameValuePairs === null || adminReportNameValuePairs === void 0 ? void 0 : adminReportNameValuePairs.calendlySchedule) === null || _d === void 0 ? void 0 : _d.isLoading) ? (<FullscreenLoadingIndicator_1.default style={[styles.flex1, styles.pRelative]}/>) : (<ScrollView_1.default style={styles.flexGrow1}>
                        ...
                        {!!(scheduleCallDraft === null || scheduleCallDraft === void 0 ? void 0 : scheduleCallDraft.date) && (<react_native_1.View style={[styles.ph5, styles.mb5]}>
                                <Text_1.default style={[styles.mb5]}>
                                    <RenderHTML_1.default html={translate('scheduledCall.book.slots', {
                    date: DateUtils_1.default.formatInTimeZoneWithFallback(scheduleCallDraft.date, userTimezone, CONST_1.default.DATE.MONTH_DAY_YEAR_FORMAT),
                })}/>
                                </Text_1.default>
