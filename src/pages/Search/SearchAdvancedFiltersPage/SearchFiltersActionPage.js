...
function SearchFiltersActionPage() {
    ...
    var _a = (0, react_1.useState)(searchAdvancedFiltersForm === null || searchAdvancedFiltersForm === void 0 ? void 0 : searchAdvancedFiltersForm.action), selectedItem = _a[0], setSelectedItem = _a[1];
    var listData = (0, react_1.useMemo)(function () {
        return (0, SearchUIUtils_1.getActionOptions)(translate).map(function (action) { return ({
            text: action.text,
    ...
    var applyChanges = (0, react_1.useCallback)(function () {
        (0, Search_1.updateAdvancedFilters)({ action: selectedItem !== null && selectedItem !== void 0 ? selectedItem : null });
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersActionPage.displayName} shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            <HeaderWithBackButton_1.default title={translate('common.action')} onBackButtonPress={function () {
            Navigation_1.default.goBack(ROUTES_1.default.SEARCH_ADVANCED_FILTERS.getRoute());
        }}/>
            <react_native_1.View style={[styles.flex1]}>
                <SelectionListWithSections_1.default shouldSingleExecuteRowSelect sections={[{ data: listData }]} ListItem={SingleSelectListItem_1.default} onSelectRow={updateSelectedItem}/>
            </react_native_1.View>
