...
function SearchFiltersDatePage() {
    return (<SearchDatePresetFilterBasePage_1.default dateKey={CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.DATE} titleKey="common.date"/>);
}
SearchFiltersDatePage.displayName = 'SearchFiltersDatePage';
exports.default = SearchFiltersDatePage;
