...
function SearchFiltersHasPage() {
    ...
    var _c = (0, react_1.useState)(function () {
        if (!(searchAdvancedFiltersForm === null || searchAdvancedFiltersForm === void 0 ? void 0 : searchAdvancedFiltersForm.has)) {
            return [];
        }
        return searchAdvancedFiltersForm.has;
    }), selectedItems = _c[0], setSelectedItems = _c[1];
    var items = (0, react_1.useMemo)(function () { return (0, SearchUIUtils_1.getHasOptions)(currentType); }, [currentType]);
    var listData = (0, react_1.useMemo)(function () {
        return items.map(function (hasOption) { return ({
            text: hasOption.text,
    ...
    var applyChanges = (0, react_1.useCallback)(function () {
        (0, Search_1.updateAdvancedFilters)({ has: selectedItems });
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersHasPage.displayName} shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            <HeaderWithBackButton_1.default title={translate('search.has')} onBackButtonPress={function () {
            Navigation_1.default.goBack(ROUTES_1.default.SEARCH_ADVANCED_FILTERS.getRoute());
        }}/>
...
exports.default = SearchFiltersHasPage;
