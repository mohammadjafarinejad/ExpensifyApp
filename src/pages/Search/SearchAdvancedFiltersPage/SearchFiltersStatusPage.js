...
var MultiSelectListItem_1 = require("@components/SelectionList/ListItem/MultiSelectListItem");
...
function SearchFiltersStatusPage() {
    ...
    var items = (0, react_1.useMemo)(function () { return (0, SearchUIUtils_1.getStatusOptions)(translate, currentType); }, [translate, currentType]);
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersStatusPage.displayName} shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            ...
            <react_native_1.View style={[styles.flex1]}>
                <SelectionList_1.default shouldSingleExecuteRowSelect data={listData} ListItem={MultiSelectListItem_1.default} onSelectRow={updateSelectedItems}/>
            </react_native_1.View>
