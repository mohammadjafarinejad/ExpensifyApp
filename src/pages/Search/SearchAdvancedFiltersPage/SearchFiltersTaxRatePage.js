...
function SearchFiltersTaxRatePage() {
    ...
    var policyIDs = (0, react_1.useMemo)(function () { var _a; return (_a = searchAdvancedFiltersForm === null || searchAdvancedFiltersForm === void 0 ? void 0 : searchAdvancedFiltersForm.policyID) !== null && _a !== void 0 ? _a : []; }, [searchAdvancedFiltersForm]);
    var policiesSelector = (0, react_1.useCallback)(function (allPolicies) { return (allPolicies ? Object.values(allPolicies).filter(function (policy) { return policy && policyIDs.includes(policy.id); }) : undefined); }, [policyIDs]);
    var policies = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.POLICY), {
        selector: policiesSelector,
        canBeMissing: true,
    })[0];
    var selectedPoliciesTaxRates = policies === null || policies === void 0 ? void 0 : policies.map(function (policy) { var _a; return (_a = policy === null || policy === void 0 ? void 0 : policy.taxRates) === null || _a === void 0 ? void 0 : _a.taxes; }).filter(function (taxRates) { return !!taxRates; });
    var taxItems = (0, react_1.useMemo)(function () {
        if (!selectedPoliciesTaxRates || (selectedPoliciesTaxRates === null || selectedPoliciesTaxRates === void 0 ? void 0 : selectedPoliciesTaxRates.length) === 0) {
            return Object.entries(allTaxRates).map(function (_a) {
                var taxRateName = _a[0], taxRateKeys = _a[1];
                return ({ name: taxRateName, value: taxRateKeys });
            });
        }
        var selectedPoliciesTaxRatesItems = selectedPoliciesTaxRates.reduce(function (acc, taxRates) {
            if (!taxRates) {
                return acc;
            }
        ...
        return Object.entries(selectedPoliciesTaxRatesItems).map(function (_a) {
            var taxRateName = _a[0], taxRateKeys = _a[1];
            return ({ name: taxRateName, value: taxRateKeys });
        });
    }, [allTaxRates, selectedPoliciesTaxRates]);
    var updateTaxRateFilters = (0, react_1.useCallback)(function (values) { return (0, Search_1.updateAdvancedFilters)({ taxRate: values }); }, []);
