...
var SingleSelectListItem_1 = require("@components/SelectionList/ListItem/SingleSelectListItem");
...
function SearchFiltersTypePage() {
    ...
    }, [allPolicies, selectedItem, session === null || session === void 0 ? void 0 : session.email]);
    ...
    return (<ScreenWrapper_1.default testID={SearchFiltersTypePage.displayName} shouldShowOfflineIndicatorInWideScreen offlineIndicatorStyle={styles.mtAuto} shouldEnableMaxHeight>
            ...
            <react_native_1.View style={[styles.flex1]}>
                <SelectionList_1.default shouldSingleExecuteRowSelect data={listData} ListItem={SingleSelectListItem_1.default} onSelectRow={updateSelectedItem}/>
            </react_native_1.View>
