...
function SearchPageNarrow(_a) {
    var _b, _c;
    var queryJSON = _a.queryJSON, headerButtonsOptions = _a.headerButtonsOptions, searchResults = _a.searchResults, isMobileSelectionModeEnabled = _a.isMobileSelectionModeEnabled, metadata = _a.metadata, footerData = _a.footerData, currentSelectedPolicyID = _a.currentSelectedPolicyID, currentSelectedReportID = _a.currentSelectedReportID, latestBankItems = _a.latestBankItems, confirmPayment = _a.confirmPayment;
    var translate = (0, useLocalize_1.default)().translate;
    var shouldUseNarrowLayout = (0, useResponsiveLayout_1.default)().shouldUseNarrowLayout;
    var windowHeight = (0, useWindowDimensions_1.default)().windowHeight;
    var styles = (0, useThemeStyles_1.default)();
    var StyleUtils = (0, useStyleUtils_1.default)();
    var _d = (0, SearchContext_1.useSearchContext)(), clearSelectedTransactions = _d.clearSelectedTransactions, selectedTransactions = _d.selectedTransactions;
    var _e = (0, react_1.useState)(false), searchRouterListVisible = _e[0], setSearchRouterListVisible = _e[1];
    ...
    var _f = (0, react_1.useState)(null), searchRequestResponseStatusCode = _f[0], setSearchRequestResponseStatusCode = _f[1];
    ...
    var shouldShowFooter = !!(metadata === null || metadata === void 0 ? void 0 : metadata.count) || Object.keys(selectedTransactions).length > 0;
    ...
    return (<ScreenWrapper_1.default testID={SearchPageNarrow.displayName} shouldEnableMaxHeight offlineIndicatorStyle={styles.mtAuto} bottomContent={<NavigationTabBar_1.default selectedTab={NAVIGATION_TABS_1.default.SEARCH}/>} headerGapStyles={styles.searchHeaderGap} shouldShowOfflineIndicator={!!searchResults}>
            <react_native_1.View style={[styles.flex1, styles.overflowHidden]}>
                ...
                (0, MobileSelectionMode_1.turnOffMobileSelectionMode)();
                        ...
                        <SearchPageHeader_1.default queryJSON={queryJSON} headerButtonsOptions={headerButtonsOptions} handleSearch={handleSearchAction} isMobileSelectionModeEnabled={isMobileSelectionModeEnabled} currentSelectedPolicyID={currentSelectedPolicyID} currentSelectedReportID={currentSelectedReportID} latestBankItems={latestBankItems} confirmPayment={confirmPayment}/>
                    </>)}
