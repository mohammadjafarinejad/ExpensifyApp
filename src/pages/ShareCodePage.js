...
function ShareCodePage(_a) {
    ...
    var subtitle = (0, react_1.useMemo)(function () {
        ...
        if (isReport) {
            ...
            return (_a = (0, ReportUtils_1.getParentNavigationSubtitle)(report, isParentReportArchived).workspaceName) !== null && _a !== void 0 ? _a : (0, ReportUtils_1.getChatRoomSubtitle)(report, false, isReportArchived);
        }
    ...
    var logo = isReport
        ...
        : (0, UserAvatarUtils_1.getAvatarURL)({ avatarSource: currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.avatar, accountID: currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.accountID });
    ...
    return (<ScreenWrapper_1.default testID={ShareCodePage.displayName}>
            ...
            <ScrollView_1.default style={[themeStyles.flex1, themeStyles.pt3]}>
                <react_native_1.View style={[themeStyles.workspaceSectionMobile, themeStyles.ph5]}>
                    <QRShareWithDownload_1.default ref={qrCodeRef} url={url} title={title} subtitle={subtitle} logo={logo} logoRatio={logo === expensify_logo_round_transparent_png_1.default ? CONST_1.default.QR.EXPENSIFY_LOGO_SIZE_RATIO : CONST_1.default.QR.DEFAULT_LOGO_SIZE_RATIO} logoMarginRatio={logo === expensify_logo_round_transparent_png_1.default ? CONST_1.default.QR.EXPENSIFY_LOGO_MARGIN_RATIO : CONST_1.default.QR.DEFAULT_LOGO_MARGIN_RATIO} svgLogo={svgLogo} svgLogoFillColor={svgLogoFillColor} logoBackgroundColor={logoBackgroundColor}/>
                </react_native_1.View>
