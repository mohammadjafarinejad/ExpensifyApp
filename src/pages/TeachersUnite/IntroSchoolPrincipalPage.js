...
function IntroSchoolPrincipalPage() {
    ...
    var formState = (0, useOnyx_1.default)(ONYXKEYS_1.default.FORMS.INTRO_SCHOOL_PRINCIPAL_FORM, { canBeMissing: true })[0];
    var _a = (0, useCurrentUserPersonalDetails_1.default)(), localCurrencyCode = _a.localCurrencyCode, login = _a.login, accountID = _a.accountID;
    var optimisticReportID = (0, react_1.useRef)((0, ReportUtils_1.generateReportID)());
    var hasSubmittedRef = (0, react_1.useRef)(false);
    // eslint-disable-next-line rulesdir/prefer-early-return
    (0, react_1.useEffect)(function () {
        if (hasSubmittedRef.current && formState && !formState.isLoading && !formState.errors) {
            Navigation_1.default.dismissModalWithReport({ reportID: optimisticReportID.current });
    ...
    var onSubmit = function (values) {
        ...
        TeachersUnite_1.default.addSchoolPrincipal(values.firstName.trim(), values.partnerUserID.trim(), values.lastName.trim(), policyID, localCurrencyCode, login !== null && login !== void 0 ? login : '', accountID, optimisticReportID.current);
    };
    /**
