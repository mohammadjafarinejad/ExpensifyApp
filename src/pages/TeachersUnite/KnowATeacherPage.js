...
function KnowATeacherPage() {
    ...
    var onSubmit = function (values) {
        var phoneLogin = (0, LoginUtils_1.getPhoneLogin)(values.partnerUserID, countryCode);
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        var errors = (0, ValidationUtils_1.getFieldRequiredErrors)(values, [IKnowTeacherForm_1.default.FIRST_NAME, IKnowTeacherForm_1.default.LAST_NAME]);
        var phoneLogin = (0, LoginUtils_1.getPhoneLogin)(values.partnerUserID, countryCode);
        var validateIfNumber = (0, LoginUtils_1.validateNumber)(phoneLogin);
