...
function Confirmation() {
    ...
    var reviewDuplicatesReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reviewDuplicates === null || reviewDuplicates === void 0 ? void 0 : reviewDuplicates.reportID)];
    ...
    var compareResult = TransactionUtils.compareDuplicateTransactionFields(transaction, allDuplicates, reviewDuplicates === null || reviewDuplicates === void 0 ? void 0 : reviewDuplicates.reportID, undefined, policyCategories);
    ...
    var duplicates = (0, useTransactionsByID_1.default)(reviewDuplicates === null || reviewDuplicates === void 0 ? void 0 : reviewDuplicates.duplicates)[0];
                ...
                <react_native_1.View style={[styles.flex1]}>
                    ...
                    <ScrollView_1.default>
                        ...
                        <ShowContextMenuContext_1.ShowContextMenuContext.Provider value={contextValue}>
                            <MoneyRequestView_1.default allReports={allReports} report={report} expensePolicy={policy} shouldShowAnimatedBackground={false} readonly isFromReviewDuplicates updatedTransaction={newTransaction}/>
