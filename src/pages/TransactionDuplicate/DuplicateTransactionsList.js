...
function DuplicateTransactionsList(_a) {
    var transactions = _a.transactions, onPreviewPressed = _a.onPreviewPressed;
    ...
    var renderItem = (0, react_1.useCallback)(function (_a) {
        ...
        return (<DuplicateTransactionItem_1.default transaction={item} index={index} allReports={allReports} policies={policies} onPreviewPressed={onPreviewPressed}/>);
