...
function ReviewBillable() {
    ...
    var _c = (0, useReviewDuplicatesNavigation_1.default)(Object.keys((_b = compareResult.change) !== null && _b !== void 0 ? _b : {}), 'billable', route.params.threadReportID, route.params.backTo), currentScreenIndex = _c.currentScreenIndex, goBack = _c.goBack, navigateToNextScreen = _c.navigateToNextScreen;
    var options = (0, react_1.useMemo)(function () {
        var _a;
        return (_a = compareResult.change.billable) === null || _a === void 0 ? void 0 : _a.map(function (billable) { return ({
            text: billable ? translate('common.yes') : translate('common.no'),
            value: billable !== null && billable !== void 0 ? billable : false,
        }); });
    }, [compareResult.change.billable, translate]);
    var setBillable = function (data) {
