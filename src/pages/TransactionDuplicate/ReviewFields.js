...
function ReviewFields(_a) {
    ...
    var optionRows = (0, react_1.useMemo)(function () {
        return filteredOptions === null || filteredOptions === void 0 ? void 0 : filteredOptions.map(function (option, idx) { return ({
            text: option.text,
            keyForList: "".concat(option.text, "-").concat(idx),
            value: option.value,
        }); });
    }, [filteredOptions]);
    return (<react_native_1.View key={index} style={styles.flex1}>
            ...
            <SelectionList_1.default data={optionRows !== null && optionRows !== void 0 ? optionRows : []} ListItem={RadioListItem_1.default} onSelectRow={onSelectRow}/>
        </react_native_1.View>);
}
