...
function ReviewMerchant() {
    ...
    var _c = (0, useReviewDuplicatesNavigation_1.default)(Object.keys((_b = compareResult.change) !== null && _b !== void 0 ? _b : {}), 'merchant', route.params.threadReportID, route.params.backTo), currentScreenIndex = _c.currentScreenIndex, goBack = _c.goBack, navigateToNextScreen = _c.navigateToNextScreen;
    var options = (0, react_1.useMemo)(function () {
        var _a;
        return (_a = compareResult.change.merchant) === null || _a === void 0 ? void 0 : _a.map(function (merchant) {
            return !merchant
    ...
    var setMerchant = function (data) {
        if (data.value !== undefined) {
            (0, Transaction_1.setReviewDuplicatesKey)({ merchant: data.value });
        }
        navigateToNextScreen();
    };
    return (<ScreenWrapper_1.default testID={ReviewMerchant.displayName}>
            <HeaderWithBackButton_1.default title={translate('iou.reviewDuplicates')} onBackButtonPress={goBack}/>
            <ReviewFields_1.default stepNames={stepNames} label={translate('violations.merchantToKeep')} options={options} index={currentScreenIndex} onSelectRow={setMerchant}/>
        </ScreenWrapper_1.default>);
}
ReviewMerchant.displayName = 'ReviewMerchant';
exports.default = ReviewMerchant;
