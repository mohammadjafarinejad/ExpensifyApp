...
var TravelDomainListItem_1 = require("@components/SelectionList/ListItem/TravelDomainListItem");
...
function DomainSelectorPage(_a) {
    ...
    var provisionTravelForDomain = function () {
        ...
        if (!isUserValidated) {
            ...
            var nextStep = (0, EmptyObject_1.isEmptyObject)(policy === null || policy === void 0 ? void 0 : policy.address) ? ROUTES_1.default.TRAVEL_WORKSPACE_ADDRESS.getRoute(domain, Navigation_1.default.getActiveRoute()) : ROUTES_1.default.TRAVEL_TCS.getRoute(domain);
            (0, Travel_1.setTravelProvisioningNextStep)(nextStep);
            Navigation_1.default.navigate(ROUTES_1.default.TRAVEL_VERIFY_ACCOUNT.getRoute(domain));
            return;
        }
    ...
    return (<ScreenWrapper_1.default shouldEnableMaxHeight testID={DomainSelectorPage.displayName}>
            ...
            <react_native_1.View style={[styles.optionsListSectionHeader]}>
                <Text_1.default style={[styles.ph5, styles.textLabelSupporting]}>{translate('travel.domainSelector.title')}</Text_1.default>
            </react_native_1.View>
            <SelectionList_1.default onSelectRow={function (option) { return setSelectedDomain(option.value); }} data={data} ListItem={TravelDomainListItem_1.default} shouldShowTooltips footerContent={<Button_1.default isDisabled={!selectedDomain} success large style={[styles.w100]} onPress={provisionTravelForDomain} text={translate('common.continue')}/>}/>
