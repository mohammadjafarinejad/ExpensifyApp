...
function ManageTrips() {
    ...
    var handleOnContentSizeChange = (0, react_1.useCallback)(function () {
        var _a;
    ...
    return (<ScrollView_1.default contentContainerStyle={styles.pt3} ref={scrollViewRef} onContentSizeChange={handleOnContentSizeChange}>
