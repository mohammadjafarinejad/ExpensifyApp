...
function TripDetailsPage(_a) {
    ...
    var travelerPersonalDetailsSelector = (0, react_1.useCallback)(function (personalDetails) { return pickTravelerPersonalDetails(personalDetails, reservation); }, [reservation]);
    var travelerPersonalDetails = (0, useOnyx_1.default)(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, { selector: travelerPersonalDetailsSelector, canBeMissing: true }, [travelerPersonalDetailsSelector])[0];
