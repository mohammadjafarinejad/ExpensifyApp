...
function TripSummaryPage(_a) {
    ...
    var transaction = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat((0, getNonEmptyStringOnyxID_1.default)(route.params.transactionID)), { canBeMissing: true })[0];
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} shouldEnablePickerAvoiding={false} shouldEnableMaxHeight testID={TripSummaryPage.displayName} shouldShowOfflineIndicatorInWideScreen>
            ...
            return (<OfflineWithFeedback_1.default key={"".concat(transactionID, "-").concat(sequenceIndex)}>
