...
var autoAuthStateSelector = function (session) { return session === null || session === void 0 ? void 0 : session.autoAuthState; };
function ValidateLoginPage(_a) {
    ...
    var autoAuthState = (0, useOnyx_1.default)(ONYXKEYS_1.default.SESSION, { initWithStoredValues: isSignedIn, selector: autoAuthStateSelector, canBeMissing: true })[0];
    ...
    var shouldStartSignInWithValidateCode = !isUserClickedSignIn && !isSignedIn && (!!login || !!exitTo) && (0, ValidationUtils_1.isValidValidateCode)(validateCode);
    ...
    (0, react_1.useEffect)(function () {
        ...
        (0, Session_1.initAutoAuthState)(autoAuthStateWithDefault);
        if (!shouldStartSignInWithValidateCode) {
            if (exitTo) {
                (0, Session_1.handleExitToNavigation)(exitTo);
            }
            return;
        }
        // The user has initiated the sign in process on the same browser, in another tab.
        (0, Session_1.signInWithValidateCode)(Number(accountID), validateCode, preferredLocale);
