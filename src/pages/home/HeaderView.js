...
function HeaderView(_a) {
    ...
    var grandParentReport = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, getNonEmptyStringOnyxID_1.default)(parentReport === null || parentReport === void 0 ? void 0 : parentReport.parentReportID)), { canBeMissing: true })[0];
    var grandParentReportActions = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat((0, getNonEmptyStringOnyxID_1.default)(parentReport === null || parentReport === void 0 ? void 0 : parentReport.parentReportID)), { canBeMissing: true })[0];
    ...
    var isParentOneTransactionThread = (0, ReportUtils_1.isOneTransactionThread)(parentReport, grandParentReport, grandParentReportActions === null || grandParentReportActions === void 0 ? void 0 : grandParentReportActions["".concat(parentReport === null || parentReport === void 0 ? void 0 : parentReport.parentReportActionID)]);
    var parentNavigationReport = isParentOneTransactionThread ? parentReport : reportHeaderData;
    ...
    var title = (0, ReportUtils_1.getReportName)(reportHeaderData, policy, parentReportAction, personalDetails, invoiceReceiverPolicy, undefined, undefined, isReportHeaderDataArchived);
    ...
    var parentNavigationSubtitleData = (0, ReportUtils_1.getParentNavigationSubtitle)(parentNavigationReport, isParentReportHeaderDataArchived);
    ...
    var shouldShowDiscount = (0, react_1.useMemo)(function () { return (0, SubscriptionUtils_1.shouldShowDiscountBanner)(hasTeam2025Pricing, subscriptionPlan, firstDayFreeTrial, lastDayFreeTrial, userBillingFundID) && !isReportArchived; }, 
                            ...
                            <react_native_1.View style={[styles.flex1, styles.flexRow, styles.alignItemsCenter, styles.justifyContentBetween]}>
                                <PressableWithoutFeedback_1.default onPress={function () { return (0, ReportUtils_1.navigateToDetailsPage)(report, Navigation_1.default.getReportRHPActiveRoute(), true); }} style={[styles.flexRow, styles.alignItemsCenter, styles.flex1]} disabled={shouldDisableDetailPage} accessibilityLabel={title} role={CONST_1.default.ROLE.BUTTON}>
                                    ...
                                    <react_native_1.View fsClass={CONST_1.default.FULLSTORY.CLASS.UNMASK} style={[styles.flex1, styles.flexColumn]}>
                                        ...
                                        {!(0, EmptyObject_1.isEmptyObject)(parentNavigationSubtitleData) && (<ParentNavigationSubtitle_1.default parentNavigationSubtitleData={parentNavigationSubtitleData} parentReportID={parentNavigationReport === null || parentNavigationReport === void 0 ? void 0 : parentNavigationReport.parentReportID} parentReportActionID={isParentOneTransactionThread ? undefined : parentNavigationReport === null || parentNavigationReport === void 0 ? void 0 : parentNavigationReport.parentReportActionID} pressableStyles={[styles.alignSelfStart, styles.mw100]}/>)}
