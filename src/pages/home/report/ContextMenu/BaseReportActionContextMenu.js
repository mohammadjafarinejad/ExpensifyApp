...
function BaseReportActionContextMenu(_a) {
    var _b, _c;
    var _d = _a.type, type = _d === void 0 ? CONST_1.default.CONTEXT_MENU_TYPES.REPORT_ACTION : _d, anchor = _a.anchor, contentRef = _a.contentRef, _e = _a.isChronosReport, isChronosReport = _e === void 0 ? false : _e, _f = _a.isArchivedRoom, isArchivedRoom = _f === void 0 ? false : _f, _g = _a.isMini, isMini = _g === void 0 ? false : _g, _h = _a.isVisible, isVisible = _h === void 0 ? false : _h, _j = _a.isPinnedChat, isPinnedChat = _j === void 0 ? false : _j, _k = _a.isUnreadChat, isUnreadChat = _k === void 0 ? false : _k, _l = _a.isThreadReportParentAction, isThreadReportParentAction = _l === void 0 ? false : _l, _m = _a.selection, selection = _m === void 0 ? '' : _m, _o = _a.draftMessage, draftMessage = _o === void 0 ? '' : _o, reportActionID = _a.reportActionID, reportID = _a.reportID, originalReportID = _a.originalReportID, checkIfContextMenuActive = _a.checkIfContextMenuActive, _p = _a.disabledActions, disabledActions = _p === void 0 ? [] : _p, setIsEmojiPickerActive = _a.setIsEmojiPickerActive;
    ...
    var _q = (0, useLocalize_1.default)(), translate = _q.translate, getLocalDateFromDatetime = _q.getLocalDateFromDatetime;
    // eslint-disable-next-line rulesdir/prefer-shouldUseNarrowLayout-instead-of-isSmallScreenWidth
    var _r = (0, useResponsiveLayout_1.default)(), shouldUseNarrowLayout = _r.shouldUseNarrowLayout, isSmallScreenWidth = _r.isSmallScreenWidth;
    var menuItemRefs = (0, react_1.useRef)({});
    var _s = (0, react_1.useState)(false), shouldKeepOpen = _s[0], setShouldKeepOpen = _s[1];
    ...
    var movedFromReport = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, ModifiedExpenseMessage_1.getMovedReportID)(reportAction, CONST_1.default.REPORT.MOVE_TYPE.FROM)), { canBeMissing: true })[0];
    var movedToReport = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat((0, ModifiedExpenseMessage_1.getMovedReportID)(reportAction, CONST_1.default.REPORT.MOVE_TYPE.TO)), { canBeMissing: true })[0];
    ...
    var childReportActions = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportAction === null || reportAction === void 0 ? void 0 : reportAction.childReportID), { canBeMissing: true })[0];
    ...
    var requestParentReportAction = (0, react_1.useMemo)(function () {
        if (isMoneyRequestReport || isInvoiceReport) {
            if (transactionThreadReportID === CONST_1.default.FAKE_REPORT_ID) {
                return Object.values(childReportActions !== null && childReportActions !== void 0 ? childReportActions : {}).find(function (action) { return action.actionName === CONST_1.default.REPORT.ACTIONS.TYPE.IOU; });
            }
    ...
    }, [parentReportAction, isMoneyRequestReport, isInvoiceReport, paginatedReportActions, transactionThreadReport === null || transactionThreadReport === void 0 ? void 0 : transactionThreadReport.parentReportActionID, transactionThreadReportID, childReportActions]);
    ...
    var transactions = (0, useTransactionsAndViolationsForReport_1.default)(childReport === null || childReport === void 0 ? void 0 : childReport.reportID).transactions;
    var tryNewDot = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_TRY_NEW_DOT, { canBeMissing: false })[0];
    var isTryNewDotNVPDismissed = !!((_c = tryNewDot === null || tryNewDot === void 0 ? void 0 : tryNewDot.classicRedirect) === null || _c === void 0 ? void 0 : _c.dismissed);
    ...
    var filteredContextMenuActions = ContextMenuActions_1.default.filter(function (contextAction) {
        return !disabledActions.includes(contextAction) &&
            contextAction.shouldShow({
                ...
                childReportActions: childReportActions,
    ...
    var _t = (0, useArrowKeyFocusManager_1.default)({
        initialFocusedIndex: -1,
        disabledIndexes: disabledIndexes,
        maxIndex: filteredContextMenuActions.length - 1,
        isActive: shouldEnableArrowNavigation,
    }), focusedIndex = _t[0], setFocusedIndex = _t[1];
    /**
    ...
    var card = (0, useGetExpensifyCardFromReportAction_1.default)({ reportAction: (reportAction !== null && reportAction !== void 0 ? reportAction : null), policyID: policyID });
    return ((isVisible || shouldKeepOpen || !isMini) && (<FocusTrapForModal_1.default active={!isMini && !isSmallScreenWidth && (isVisible || shouldKeepOpen)}>
            ...
            var isKeyInActionUpdateKeys = textTranslateKey === 'reportActionContextMenu.editAction' || textTranslateKey === 'reportActionContextMenu.deleteConfirmation';
            ...
            var transactionPayload = textTranslateKey === 'reportActionContextMenu.copyMessage' && transaction && { transaction: transaction };
