...
var ContextMenuActions = [
    ...
    },
    {
        ...
        shouldShow: function (_a) {
            var type = _a.type, reportAction = _a.reportAction, isArchivedRoom = _a.isArchivedRoom, isChronosReport = _a.isChronosReport, moneyRequestAction = _a.moneyRequestAction;
            return type === CONST_1.default.CONTEXT_MENU_TYPES.REPORT_ACTION && ((0, ReportUtils_1.canEditReportAction)(reportAction) || (0, ReportUtils_1.canEditReportAction)(moneyRequestAction)) && !isArchivedRoom && !isChronosReport;
        },
        onPress: function (closePopover, _a) {
            var reportID = _a.reportID, reportAction = _a.reportAction, draftMessage = _a.draftMessage, moneyRequestAction = _a.moneyRequestAction;
    ...
    },
    {
        ...
        onPress: function (closePopover, _a) {
            ...
            var reportAction = _a.reportAction, transaction = _a.transaction, selection = _a.selection, report = _a.report, reportID = _a.reportID, card = _a.card, originalReport = _a.originalReport, isTryNewDotNVPDismissed = _a.isTryNewDotNVPDismissed, movedFromReport = _a.movedFromReport, movedToReport = _a.movedToReport, childReport = _a.childReport, getLocalDateFromDatetime = _a.getLocalDateFromDatetime, policyTags = _a.policyTags, translate = _a.translate;
            ...
            if (!isAttachment) {
                ...
                if (isReportPreviewAction) {
                    ...
                    var _j = (0, TaskUtils_1.getTaskReportActionMessage)(reportAction), text = _j.text, html = _j.html;
                    ...
                    var modifyExpenseMessage = (0, ModifiedExpenseMessage_1.getForReportActionTemp)({
                    ...
                    var displayMessage = (0, ReportUtils_1.getIOUReportActionDisplayMessage)(reportAction, transaction, report);
                    ...
                    var taskPreviewMessage = (0, TaskUtils_1.getTaskCreatedMessage)(reportAction, childReport, true);
                ...
                else if ((0, ReportActionsUtils_1.isActionOfType)(reportAction, CONST_1.default.REPORT.ACTIONS.TYPE.MARKED_REIMBURSED)) {
                    Clipboard_1.default.setString(translate('iou.paidElsewhere'));
                }
                    ...
                    if (harvesting) {
                        ...
                        Clipboard_1.default.setString(translate('iou.submitted', { memo: (_f = (0, ReportActionsUtils_1.getOriginalMessage)(reportAction)) === null || _f === void 0 ? void 0 : _f.message }));
                    }
                }
                    ...
                    if (automaticAction) {
                        ...
                        Clipboard_1.default.setString(translate('iou.approvedMessage'));
                    }
                }
                else if ((0, ReportActionsUtils_1.isUnapprovedAction)(reportAction)) {
                    Clipboard_1.default.setString(translate('iou.unapproved'));
                }
                else if ((0, ReportActionsUtils_1.isActionOfType)(reportAction, CONST_1.default.REPORT.ACTIONS.TYPE.FORWARDED)) {
                    var automaticAction = ((_h = (0, ReportActionsUtils_1.getOriginalMessage)(reportAction)) !== null && _h !== void 0 ? _h : {}).automaticAction;
                    if (automaticAction) {
                        setClipboardMessage(translate('iou.automaticallyForwarded'));
                    }
                    else {
                        Clipboard_1.default.setString(translate('iou.forwarded'));
                    }
                }
                    ...
                    Clipboard_1.default.setString(translate('iou.heldExpense'));
                }
                else if ((reportAction === null || reportAction === void 0 ? void 0 : reportAction.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.UNHOLD) {
                    Clipboard_1.default.setString(translate('iou.unheldExpense'));
                }
                else if ((reportAction === null || reportAction === void 0 ? void 0 : reportAction.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.REJECTEDTRANSACTION_THREAD) {
                    Clipboard_1.default.setString(translate('iou.reject.reportActions.rejectedExpense'));
                }
                else if ((reportAction === null || reportAction === void 0 ? void 0 : reportAction.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.REJECTED_TRANSACTION_MARKASRESOLVED) {
                    Clipboard_1.default.setString(translate('iou.reject.reportActions.markedAsResolved'));
                }
                    ...
                    Clipboard_1.default.setString(translate('iou.retracted'));
                }
                    ...
                    Clipboard_1.default.setString(translate("violationDismissal.".concat(violationName, ".").concat(reason)));
                }
                    ...
                    Clipboard_1.default.setString(translate('violations.resolvedDuplicates'));
                }
                ...
                else if ((reportAction === null || reportAction === void 0 ? void 0 : reportAction.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.ROOM_CHANGE_LOG.UPDATE_ROOM_AVATAR) {
                    setClipboardMessage((0, ReportActionsUtils_1.getRoomAvatarUpdatedMessage)(reportAction));
                }
                    ...
                    setClipboardMessage((0, ReportActionsUtils_1.getIntegrationSyncFailedMessage)(reportAction, report === null || report === void 0 ? void 0 : report.policyID, isTryNewDotNVPDismissed));
                }
                else if ((0, ReportActionsUtils_1.isCardIssuedAction)(reportAction)) {
                    setClipboardMessage((0, ReportActionsUtils_1.getCardIssuedMessage)({ reportAction: reportAction, shouldRenderHTML: true, policyID: report === null || report === void 0 ? void 0 : report.policyID, expensifyCard: card }));
                }
                ...
                else if ((0, ReportActionsUtils_1.isActionOfType)(reportAction, CONST_1.default.REPORT.ACTIONS.TYPE.ACTIONABLE_CARD_FRAUD_ALERT)) {
                    setClipboardMessage((0, ReportActionsUtils_1.getActionableCardFraudAlertMessage)(reportAction, getLocalDateFromDatetime));
                }
    ...
    },
    {
        ...
        shouldShow: function (_a) {
            var type = _a.type, isDebugModeEnabled = _a.isDebugModeEnabled;
            return [CONST_1.default.CONTEXT_MENU_TYPES.REPORT_ACTION, CONST_1.default.CONTEXT_MENU_TYPES.REPORT].some(function (value) { return value === type; }) && !!isDebugModeEnabled;
        },
        onPress: function (closePopover, _a) {
            var reportID = _a.reportID, reportAction = _a.reportAction;
            if (reportAction) {
    ...
    },
    {
        ...
        shouldShow: function (_a) {
            var _b;
            var type = _a.type, reportAction = _a.reportAction, isArchivedRoom = _a.isArchivedRoom, isChronosReport = _a.isChronosReport, reportIDParam = _a.reportID, moneyRequestAction = _a.moneyRequestAction, iouTransaction = _a.iouTransaction, transactions = _a.transactions, childReportActions = _a.childReportActions;
            // Until deleting parent threads is supported in FE, we will prevent the user from deleting a thread parent
            var reportID = reportIDParam;
            if ((0, ReportActionsUtils_1.isMoneyRequestAction)(moneyRequestAction)) {
                reportID = (_b = (0, ReportActionsUtils_1.getOriginalMessage)(moneyRequestAction)) === null || _b === void 0 ? void 0 : _b.IOUReportID;
            }
            else if ((0, ReportActionsUtils_1.isReportPreviewAction)(reportAction)) {
                reportID = reportAction === null || reportAction === void 0 ? void 0 : reportAction.childReportID;
            }
            return (!!reportIDParam &&
                type === CONST_1.default.CONTEXT_MENU_TYPES.REPORT_ACTION &&
                (0, ReportUtils_1.canDeleteReportAction)(moneyRequestAction !== null && moneyRequestAction !== void 0 ? moneyRequestAction : reportAction, reportID, iouTransaction, transactions, childReportActions) &&
                !isArchivedRoom &&
                !isChronosReport &&
...
var restrictedReadOnlyActions = new Set([
    'reportActionContextMenu.replyInThread',
    'reportActionContextMenu.editAction',
    'reportActionContextMenu.joinThread',
    'common.delete',
]);
var RestrictedReadOnlyContextMenuActions = ContextMenuActions.filter(function (action) { return 'textTranslateKey' in action && restrictedReadOnlyActions.has(action.textTranslateKey); });
