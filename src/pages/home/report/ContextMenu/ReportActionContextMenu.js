 ...
 */
function hideContextMenu(shouldDelay, onHideCallback, params) {
    if (onHideCallback === void 0) { onHideCallback = function () { }; }
    if (!contextMenuRef.current) {
        return;
    }
    var paramsWithCallback = __assign({ callbacks: __assign(__assign({}, params === null || params === void 0 ? void 0 : params.callbacks), { onHide: onHideCallback }) }, params);
    if (!shouldDelay) {
