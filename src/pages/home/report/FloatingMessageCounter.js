...
function FloatingMessageCounter(_a) {
    var _b;
    var _c = _a.isActive, isActive = _c === void 0 ? false : _c, _d = _a.onClick, onClick = _d === void 0 ? function () { } : _d, hasNewMessages = _a.hasNewMessages;
                ...
                <react_native_1.View style={[styles.flexRow, styles.justifyContentBetween, styles.alignItemsCenter]}>
                    <Button_1.default success={hasNewMessages} small onPress={onClick}>
                        <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter]}>
                            ...
                            <Text_1.default style={[styles.ml2, styles.buttonSmallText, hasNewMessages && styles.textWhite, styles.userSelectNone]} dataSet={_b = {}, _b[CONST_1.default.SELECTION_SCRAPER_HIDDEN_ELEMENT] = true, _b}>
