...
var IMAGE_TYPES = new Set(['jpg', 'jpeg', 'png']);
...
function LinkPreviewer(_a) {
    ...
    return linksToShow.map(function (linkData) {
        ...
        return (<react_native_1.View style={styles.linkPreviewWrapper} key={url}>
                ...
                {!!(image === null || image === void 0 ? void 0 : image.type) && IMAGE_TYPES.has(image.type) && !!image.width && !!image.height && (<react_native_1.Image style={[
