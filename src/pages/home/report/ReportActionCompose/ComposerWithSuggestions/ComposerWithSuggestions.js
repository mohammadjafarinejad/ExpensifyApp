...
var findNodeHandle_1 = require("@src/utils/findNodeHandle");
 ...
 * on every key press.
 */
function ComposerWithSuggestions(_a) {
    var _b;
    var 
    // Props: Report
    ...
    // Composer
    isComposerFullSize = _a.isComposerFullSize, setIsFullComposerAvailable = _a.setIsFullComposerAvailable, isMenuVisible = _a.isMenuVisible, inputPlaceholder = _a.inputPlaceholder, onPasteFile = _a.onPasteFile, disabled = _a.disabled, setIsCommentEmpty = _a.setIsCommentEmpty, handleSendMessage = _a.handleSendMessage, shouldShowComposeInput = _a.shouldShowComposeInput, _c = _a.measureParentContainer, measureParentContainer = _c === void 0 ? function () { } : _c, isScrollLikelyLayoutTriggered = _a.isScrollLikelyLayoutTriggered, raiseIsScrollLikelyLayoutTriggered = _a.raiseIsScrollLikelyLayoutTriggered, _d = _a.onCleared, onCleared = _d === void 0 ? function () { } : _d, onLayoutProps = _a.onLayout, 
    // Refs
    suggestionsRef = _a.suggestionsRef, isNextModalWillOpenRef = _a.isNextModalWillOpenRef, ref = _a.ref, 
    // For testing
    ...
    var isSidePanelHiddenOrLargeScreen = (0, useSidePanel_1.default)().isSidePanelHiddenOrLargeScreen;
    ...
    var _e = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_DRAFT_COMMENT).concat(reportID), { canBeMissing: true })[0], draftComment = _e === void 0 ? '' : _e;
    ...
    var updateComment = (0, react_1.useCallback)(function (commentValue, shouldDebounceSaveComment) {
        ...
        var prevText = lastTextRef.current;
        // snapshot selection (should be the selection that was active just before the paste/change)
        var prevSelectionStart = (_a = selection === null || selection === void 0 ? void 0 : selection.start) !== null && _a !== void 0 ? _a : 0;
        var prevSelectionEnd = (_b = selection === null || selection === void 0 ? void 0 : selection.end) !== null && _b !== void 0 ? _b : 0;
        // detect newly added text (existing helper)
        var _d = findNewlyAddedChars(prevText, commentValue), startIndex = _d.startIndex, endIndex = _d.endIndex, diff = _d.diff;
        // Try to rewrite if this looks like "selected text replaced with a single URL"
        var _e = (0, MarkdownLinkHelpers_1.detectAndRewritePaste)(prevText, prevSelectionStart, prevSelectionEnd, diff), rewritten = _e.text, didReplace = _e.didReplace;
        // Use the rewritten text when we replaced; otherwise fall back to the original commentValue pipeline
        var effectiveCommentValue = didReplace ? (rewritten !== null && rewritten !== void 0 ? rewritten : commentValue) : commentValue;
        // Emoji handling: skip the "emoji inserted" special-case when we performed the markdown rewrite.
        var isEmojiInserted = !didReplace && // <-- use the didReplace flag instead of searching for '['
            diff.length &&
            endIndex > startIndex &&
            diff.trim() === diff &&
            (0, EmojiUtils_1.containsOnlyEmojis)(diff);
        var commentWithSpaceInserted = isEmojiInserted ? (0, ComposerUtils_1.insertWhiteSpaceAtIndex)(effectiveCommentValue, endIndex) : effectiveCommentValue;
        var _f = (0, EmojiUtils_1.replaceAndExtractEmojis)(commentWithSpaceInserted, preferredSkinTone, preferredLocale), newComment = _f.text, emojis = _f.emojis, cursorPosition = _f.cursorPosition;
        if (emojis.length) {
        ...
        if (commentValue !== newComment) {
            var position_1 = Math.max(((_c = selection.end) !== null && _c !== void 0 ? _c : 0) + (newComment.length - commentRef.current.length), cursorPosition !== null && cursorPosition !== void 0 ? cursorPosition : 0);
        ...
        selection === null || selection === void 0 ? void 0 : selection.end,
        selection === null || selection === void 0 ? void 0 : selection.start,
    ]);
    /**
    ...
    (0, react_1.useEffect)(function () {
        ...
        tag.set((_a = (0, findNodeHandle_1.default)(textInputRef.current)) !== null && _a !== void 0 ? _a : -1);
    }, [tag]);
    ...
    return (<>
            ...
            <Suggestions_1.default ref={suggestionsRef} isComposerFocused={(_b = textInputRef.current) === null || _b === void 0 ? void 0 : _b.isFocused()} updateComment={updateComment} measureParentContainerAndReportCursor={measureParentContainerAndReportCursor} isGroupPolicyReport={isGroupPolicyReport} policyID={policyID} 
    // Input
...
exports.default = (0, react_1.memo)(ComposerWithSuggestions);
