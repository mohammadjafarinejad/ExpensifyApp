...
function SilentCommentUpdater(_a) {
    var updateComment = _a.updateComment, reportID = _a.reportID;
    var _b = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_DRAFT_COMMENT).concat(reportID), { canBeMissing: true })[0], comment = _b === void 0 ? '' : _b;
