...
function SuggestionEmoji(_a) {
    var value = _a.value, selection = _a.selection, setSelection = _a.setSelection, updateComment = _a.updateComment, isAutoSuggestionPickerLarge = _a.isAutoSuggestionPickerLarge, resetKeyboardInput = _a.resetKeyboardInput, measureParentContainerAndReportCursor = _a.measureParentContainerAndReportCursor, isComposerFocused = _a.isComposerFocused, ref = _a.ref;
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.PREFERRED_EMOJI_SKIN_TONE, { canBeMissing: true, selector: EmojiUtils_1.getPreferredSkinToneIndex })[0], preferredSkinTone = _b === void 0 ? CONST_1.default.EMOJI_DEFAULT_SKIN_TONE : _b;
    ...
    var insertSelectedEmoji = (0, react_1.useCallback)(function (highlightedEmojiIndexInner) {
        ...
        updateComment("".concat(commentBeforeColon).concat(emojiCode, " ").concat((0, SuggestionUtils_1.trimLeadingSpace)(commentAfterColonWithEmojiNameRemoved)), true);
    ...
    var calculateEmojiSuggestion = (0, react_1.useCallback)(function (newValue, selectionStart, selectionEnd) {
        ...
        var newSuggestedEmojis = (0, EmojiUtils_1.suggestEmojis)(leftString, preferredLocale);
...
exports.default = SuggestionEmoji;
