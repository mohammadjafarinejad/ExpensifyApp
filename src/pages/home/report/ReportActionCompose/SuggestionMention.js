...
function SuggestionMention(_a) {
    var value = _a.value, selection = _a.selection, setSelection = _a.setSelection, updateComment = _a.updateComment, isAutoSuggestionPickerLarge = _a.isAutoSuggestionPickerLarge, measureParentContainerAndReportCursor = _a.measureParentContainerAndReportCursor, isComposerFocused = _a.isComposerFocused, isGroupPolicyReport = _a.isGroupPolicyReport, policyID = _a.policyID, ref = _a.ref;
...
exports.default = SuggestionMention;
