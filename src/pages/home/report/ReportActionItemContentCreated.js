...
function ReportActionItemContentCreated(_a) {
    var _b;
    var contextValue = _a.contextValue, allReports = _a.allReports, parentReport = _a.parentReport, parentReportAction = _a.parentReportAction, transactionID = _a.transactionID, draftMessage = _a.draftMessage, shouldHideThreadDividerLine = _a.shouldHideThreadDividerLine;
    ...
    if ((0, ReportActionsUtils_1.isTransactionThread)(parentReportAction)) {
        ...
        return (<OfflineWithFeedback_1.default pendingAction={action === null || action === void 0 ? void 0 : action.pendingAction}>
                <ShowContextMenuContext_1.ShowContextMenuContext.Provider value={contextMenuValue}>
                    <react_native_1.View>
                        <MoneyRequestView_1.default allReports={allReports} report={report} expensePolicy={policy} shouldShowAnimatedBackground/>
                        {renderThreadDivider}
                    </react_native_1.View>
    ...
    if ((0, ReportUtils_1.isExpenseReport)(report) || (0, ReportUtils_1.isIOUReport)(report) || (0, ReportUtils_1.isInvoiceReport)(report)) {
        return (<OfflineWithFeedback_1.default pendingAction={action === null || action === void 0 ? void 0 : action.pendingAction}>
                {!(0, EmptyObject_1.isEmptyObject)(transactionThreadReport === null || transactionThreadReport === void 0 ? void 0 : transactionThreadReport.reportID) ? (<>
                        ...
                        <ShowContextMenuContext_1.ShowContextMenuContext.Provider value={contextMenuValue}>
                            <react_native_1.View>
                                <MoneyRequestView_1.default allReports={allReports} report={transactionThreadReport} expensePolicy={policy} shouldShowAnimatedBackground={false}/>
                                {renderThreadDivider}
                            </react_native_1.View>
                        </ShowContextMenuContext_1.ShowContextMenuContext.Provider>
