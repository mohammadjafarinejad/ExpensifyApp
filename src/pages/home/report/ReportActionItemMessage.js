...
function ReportActionItemMessage(_a) {
    var _b;
    var action = _a.action, displayAsGroup = _a.displayAsGroup, reportID = _a.reportID, style = _a.style, _c = _a.isHidden, isHidden = _c === void 0 ? false : _c;
    ...
    var transaction = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat((0, getNonEmptyStringOnyxID_1.default)((0, ReportActionsUtils_1.getLinkedTransactionID)(action))), { canBeMissing: true })[0];
    ...
    var handleEnterSignerInfoPress = function (policyID, bankAccountID, isCompleted) {
    ...
    if ((0, ReportActionsUtils_1.isReimbursementDirectionInformationRequiredAction)(action)) {
        var _d = (_b = (0, ReportActionsUtils_1.getOriginalMessage)(action)) !== null && _b !== void 0 ? _b : {}, bankAccountLastFour = _d.bankAccountLastFour, currency = _d.currency, policyID_1 = _d.policyID, bankAccountID_1 = _d.bankAccountID, completed_1 = _d.completed;
        return (<react_native_1.View style={[styles.chatItemMessage, style]}>
                <Text_1.default>{translate('signerInfoStep.isConnecting', { bankAccountLastFour: bankAccountLastFour, currency: currency })}</Text_1.default>
                <Button_1.default style={[styles.mt2, styles.alignSelfStart]} success isDisabled={completed_1} text={translate(completed_1 ? 'signerInfoStep.thisStep' : 'signerInfoStep.enterSignerInfo')} onPress={function () { return handleEnterSignerInfoPress(policyID_1, bankAccountID_1, !!completed_1); }}/>
            </react_native_1.View>);
    }
    var iouMessage;
    if (isIOUReport) {
