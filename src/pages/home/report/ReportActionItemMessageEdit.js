...
var useScrollBlocker_1 = require("@hooks/useScrollBlocker");
...
var DEFAULT_MODAL_VALUE = {
    willAlertModalBecomeVisible: false,
    isVisible: false,
};
function ReportActionItemMessageEdit(_a) {
    var _b;
    var action = _a.action, draftMessage = _a.draftMessage, reportID = _a.reportID, originalReportID = _a.originalReportID, policyID = _a.policyID, index = _a.index, isGroupPolicyReport = _a.isGroupPolicyReport, _c = _a.shouldDisableEmojiPicker, shouldDisableEmojiPicker = _c === void 0 ? false : _c, ref = _a.ref;
    var _d = (0, useOnyx_1.default)(ONYXKEYS_1.default.PREFERRED_EMOJI_SKIN_TONE, { canBeMissing: true })[0], preferredSkinTone = _d === void 0 ? CONST_1.default.EMOJI_DEFAULT_SKIN_TONE : _d;
    var theme = (0, useTheme_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var StyleUtils = (0, useStyleUtils_1.default)();
    var containerRef = (0, react_1.useRef)(null);
    var reportScrollManager = (0, useReportScrollManager_1.default)();
    var _e = (0, useLocalize_1.default)(), translate = _e.translate, preferredLocale = _e.preferredLocale;
    ...
    var _f = (0, react_1.useState)(function () {
        ...
        return draftMessage;
    }), draft = _f[0], setDraft = _f[1];
    var _g = (0, react_1.useState)({ start: draft.length, end: draft.length, positionX: 0, positionY: 0 }), selection = _g[0], setSelection = _g[1];
    var _h = (0, react_1.useState)(false), isFocused = _h[0], setIsFocused = _h[1];
    var _j = (0, useHandleExceedMaxCommentLength_1.default)(), hasExceededMaxCommentLength = _j.hasExceededMaxCommentLength, validateCommentMaxLength = _j.validateCommentMaxLength;
    ...
    var _k = (0, useIsScrollLikelyLayoutTriggered_1.default)(), isScrollLayoutTriggered = _k.isScrollLayoutTriggered, raiseIsScrollLayoutTriggered = _k.raiseIsScrollLayoutTriggered;
    var _l = (0, useOnyx_1.default)(ONYXKEYS_1.default.MODAL, { canBeMissing: true })[0], modal = _l === void 0 ? DEFAULT_MODAL_VALUE : _l;
    var _m = (0, useOnyx_1.default)(ONYXKEYS_1.default.INPUT_FOCUSED, { canBeMissing: true })[0], onyxInputFocused = _m === void 0 ? false : _m;
    var _o = (0, useScrollBlocker_1.default)(), isScrolling = _o.isScrolling, startScrollBlock = _o.startScrollBlock, endScrollBlock = _o.endScrollBlock;
    ...
    var originalParentReportID = (0, ReportUtils_1.getOriginalReportID)(originalReportID, action);
    var isOriginalParentReportArchived = (0, useReportIsArchived_1.default)(originalParentReportID);
    ...
    var publishDraft = (0, react_1.useCallback)(function () {
        ...
        if (!trimmedNewDraft) {
            ...
            ReportActionContextMenu.showDeleteModal(originalReportID !== null && originalReportID !== void 0 ? originalReportID : reportID, action, true, deleteDraft, function () { return (0, focusEditAfterCancelDelete_1.default)(textInputRef.current); });
            return;
        }
        (0, Report_1.editReportComment)(originalReport, action, ancestors, trimmedNewDraft, isOriginalReportArchived, isOriginalParentReportArchived, Object.fromEntries(draftMessageVideoAttributeCache));
        deleteDraft();
    ...
    var measureParentContainerAndReportCursor = (0, react_1.useCallback)(function (callback) {
        var performMeasurement = function () {
    ...
    onMouseDown={function (e) { return e.preventDefault(); }}>
     ...
     style={[styles.textInputCompose, styles.flex1, styles.bgTransparent]} onFocus={function () {
            ...
            var _a;
            setIsFocused(false);
            var relatedTargetId = (_a = event.nativeEvent) === null || _a === void 0 ? void 0 : _a.target;
            if (relatedTargetId === tag.get() || (0, EmojiPickerAction_1.isEmojiPickerVisible)()) {
                return;
            }
            ...
            ReportActionItemEventHandler_1.default.handleComposerLayoutChange(reportScrollManager, index)(event);
        }} selection={selection} onSelectionChange={function (e) { return setSelection(e.nativeEvent.selection); }} isGroupPolicyReport={isGroupPolicyReport} shouldCalculateCaretPosition onScroll={onSaveScrollAndHideSuggestionMenu} testID="composer"/>
                    </react_native_1.View>
...
exports.default = ReportActionItemMessageEdit;
