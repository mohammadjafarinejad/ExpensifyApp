...
function ReportActionItemThread(_a) {
    var _b, _c;
    var numberOfReplies = _a.numberOfReplies, accountIDs = _a.accountIDs, mostRecentReply = _a.mostRecentReply, reportID = _a.reportID, reportAction = _a.reportAction, isHovered = _a.isHovered, onSecondaryInteraction = _a.onSecondaryInteraction, isActive = _a.isActive;
