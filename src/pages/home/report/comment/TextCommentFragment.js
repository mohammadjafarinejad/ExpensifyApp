...
function TextCommentFragment(_a) {
    ...
    var adjustExpensifyLinksForEnv = (0, useEnvironment_1.default)().adjustExpensifyLinksForEnv;
    ...
    if (!(0, shouldRenderAsText_1.default)(html, text !== null && text !== void 0 ? text : '') && !(containsOnlyEmojis && styleAsDeleted) && (containsOnlyEmojis || !(0, EmojiUtils_1.containsCustomEmoji)(text))) {
        ...
        htmlWithTag = adjustExpensifyLinksForEnv((0, ReportActionsUtils_1.getHtmlWithAttachmentID)(htmlWithTag, reportActionID));
    ...
    return (<Text_1.default style={[containsOnlyEmojis && styles.onlyEmojisText, styles.ltr, style]}>
            ...
            {!!(fragment === null || fragment === void 0 ? void 0 : fragment.isEdited) && (<>
                    ...
                    <Text_1.default fontSize={variables_1.default.fontSizeSmall} color={theme.textSupporting} style={[styles.editedLabelStyles, styleAsDeleted && styles.offlineFeedbackDeleted, style]}>
