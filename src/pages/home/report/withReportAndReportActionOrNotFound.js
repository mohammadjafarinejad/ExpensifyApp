...
function default_1(WrappedComponent) {
    function WithReportOrNotFound(props) {
        ...
        var shouldHideReport = !isLoadingReport && (!(report === null || report === void 0 ? void 0 : report.reportID) || !(0, ReportUtils_1.canAccessReport)(report, betas, isReportArchived));
        // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
        ...
        {...props} report={report} parentReport={parentReport} reportAction={linkedReportAction} parentReportAction={parentReportAction}/>);
    }
