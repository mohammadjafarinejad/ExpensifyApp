    ...
    return function (WrappedComponent) {
        function WithReportOrNotFound(props) {
            ...
            if (shouldRequireReportID || isReportIdInRoute) {
                ...
                var shouldShowNotFoundPage = !isReportLoaded || !(0, ReportUtils_1.canAccessReport)(report, betas, isReportArchived);
            ...
            {...props} report={report} betas={betas} policy={policy} reportMetadata={reportMetadata} isLoadingReportData={isLoadingReportData}/>);
        }
