...
function SplitBillDetailsPage(_a) {
    ...
    var transaction = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat((0, getNonEmptyStringOnyxID_1.default)(IOUTransactionID)), { canBeMissing: true })[0];
    ...
    if ((0, ReportUtils_1.isPolicyExpenseChat)(report)) {
        participants = [
            ...
            (0, OptionsListUtils_1.getPolicyExpenseReportOption)(__assign(__assign({}, report), { selected: true, reportID: reportID }), reportAttributesDerived),
        ];
    }
    else {
    ...
    var isEditingSplitBill = (session === null || session === void 0 ? void 0 : session.accountID) === actorAccountID && (0, TransactionUtils_1.areRequiredFieldsEmpty)(transaction) && !isDistanceRequest;
    ...
    var onConfirm = (0, react_1.useCallback)(function () {
        var _a;
        setIsConfirmed(true);
        (0, IOU_1.completeSplitBill)(reportID, reportAction, draftTransaction, (_a = session === null || session === void 0 ? void 0 : session.accountID) !== null && _a !== void 0 ? _a : CONST_1.default.DEFAULT_NUMBER_ID, isASAPSubmitBetaEnabled, session === null || session === void 0 ? void 0 : session.email);
    }, [reportID, reportAction, draftTransaction, session === null || session === void 0 ? void 0 : session.accountID, session === null || session === void 0 ? void 0 : session.email, isASAPSubmitBetaEnabled]);
