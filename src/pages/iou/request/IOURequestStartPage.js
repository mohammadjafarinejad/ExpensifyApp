...
var isWeb = [CONST_1.default.PLATFORM.WEB, CONST_1.default.PLATFORM.DESKTOP, CONST_1.default.PLATFORM.MOBILE_WEB].includes(platform);
function IOURequestStartPage(_a) {
    ...
    var policiesWithPerDiemEnabled = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.getActivePoliciesWithExpenseChatAndPerDiemEnabled)(allPolicies, currentUserPersonalDetails.login); }, [allPolicies, currentUserPersonalDetails.login]);
    var doesPerDiemPolicyExist = policiesWithPerDiemEnabled.length > 0;
    var moreThanOnePerDiemExist = policiesWithPerDiemEnabled.length > 1;
    var hasCurrentPolicyPerDiemEnabled = !!(policy === null || policy === void 0 ? void 0 : policy.arePerDiemRatesEnabled);
    var shouldShowPerDiemOption = iouType !== CONST_1.default.IOU.TYPE.SPLIT && iouType !== CONST_1.default.IOU.TYPE.TRACK && ((!isFromGlobalCreate && hasCurrentPolicyPerDiemEnabled) || (isFromGlobalCreate && doesPerDiemPolicyExist));
    ...
    var resetIOUTypeIfChanged = (0, react_1.useCallback)(function (newIOUType) {
        ...
        (0, IOU_1.initMoneyRequest)({
            reportID: reportID,
            policy: policy,
            isFromGlobalCreate: (_a = transaction === null || transaction === void 0 ? void 0 : transaction.isFromGlobalCreate) !== null && _a !== void 0 ? _a : isFromGlobalCreate,
            currentIouRequestType: transaction === null || transaction === void 0 ? void 0 : transaction.iouRequestType,
        ...
        transaction === null || transaction === void 0 ? void 0 : transaction.iouRequestType,
    ...
    var _l = (0, ProductTrainingContext_1.useProductTrainingContext)(CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.SCAN_TEST_TOOLTIP, 
    ...
    !(0, OptionsListUtils_1.getIsUserSubmittedExpenseOrScannedReceipt)(nvpDismissedProductTraining) &&
        ...
        selectedTab === CONST_1.default.TAB_REQUEST.SCAN &&
        !(isOffline && isWeb), {
        onConfirm: function () {
            var _a;
    ...
    return (<AccessOrNotFoundWrapper_1.default reportID={reportID} iouType={iouType} policyID={policy === null || policy === void 0 ? void 0 : policy.id} accessVariants={[CONST_1.default.IOU.ACCESS_VARIANTS.CREATE]} allPolicies={allPolicies}>
        ...
        disableSwipe={(isMultiScanEnabled && selectedTab === CONST_1.default.TAB_REQUEST.SCAN) || (selectedTab === CONST_1.default.TAB_REQUEST.PER_DIEM && (0, Browser_1.isMobile)())}>
                ...
                }} isMultiScanEnabled={isMultiScanEnabled} setIsMultiScanEnabled={setIsMultiScanEnabled} isStartingScan/>
                                        </OnyxTabNavigator_1.TabScreenWithFocusTrapWrapper>); }}
                                </OnyxTabNavigator_1.TopTab.Screen>
                                {iouType === CONST_1.default.IOU.TYPE.SPLIT && (<OnyxTabNavigator_1.TopTab.Screen name={CONST_1.default.TAB_REQUEST.DISTANCE}>
                                        {function () { return (<OnyxTabNavigator_1.TabScreenWithFocusTrapWrapper>
                    ...
                    return (<OnyxTabNavigator_1.TabScreenWithFocusTrapWrapper>
                                                {moreThanOnePerDiemExist && !hasCurrentPolicyPerDiemEnabled ? (<IOURequestStepPerDiemWorkspace_1.default route={route} navigation={navigation}/>) : (<IOURequestStepDestination_1.default openedFromStartPage explicitPolicyID={moreThanOnePerDiemExist ? undefined : (_a = policiesWithPerDiemEnabled.at(0)) === null || _a === void 0 ? void 0 : _a.id} route={route} navigation={navigation}/>)}
                                            </OnyxTabNavigator_1.TabScreenWithFocusTrapWrapper>);
                }}
                                    </OnyxTabNavigator_1.TopTab.Screen>)}
