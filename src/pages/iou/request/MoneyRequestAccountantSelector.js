...
var memoizedGetValidOptions = (0, memoize_1.default)(OptionsListUtils_1.getValidOptions, { maxSize: 5, monitoringName: 'MoneyRequestAccountantSelector.getValidOptions' });
function MoneyRequestAccountantSelector(_a) {
    ...
    var defaultOptions = (0, react_1.useMemo)(function () {
        ...
        var optionList = memoizedGetValidOptions({
    ...
    var chatOptions = (0, react_1.useMemo)(function () {
        ...
        var newOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(defaultOptions, debouncedSearchTerm, countryCode, {
            excludeLogins: CONST_1.default.EXPENSIFY_EMAILS_OBJECT,
    ...
    var _e = (0, react_1.useMemo)(function () {
        ...
        var formatResults = (0, OptionsListUtils_1.formatSectionsFromSearchTerm)(debouncedSearchTerm, [], chatOptions.recentReports, chatOptions.personalDetails, personalDetails, true, undefined, reportAttributesDerived);
        ...
        var headerMessage = (0, OptionsListUtils_1.getHeaderMessage)(((_e = chatOptions.personalDetails) !== null && _e !== void 0 ? _e : []).length + ((_f = chatOptions.recentReports) !== null && _f !== void 0 ? _f : []).length !== 0, !!(chatOptions === null || chatOptions === void 0 ? void 0 : chatOptions.userToInvite), debouncedSearchTerm.trim(), countryCode, false);
