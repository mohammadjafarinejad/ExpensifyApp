...
function MoneyRequestAttendeeSelector(_a) {
    ...
    }), options = _e.options, areOptionsInitialized = _e.areOptionsInitialized;
    ...
    var defaultOptions = (0, react_1.useMemo)(function () {
        ...
        var optionList = (0, OptionsListUtils_1.getAttendeeOptions)({
            reports: options.reports,
            personalDetails: options.personalDetails,
            betas: betas,
            attendees: attendees,
            recentAttendees: recentAttendees !== null && recentAttendees !== void 0 ? recentAttendees : [],
            draftComments: draftComments !== null && draftComments !== void 0 ? draftComments : {},
            nvpDismissedProductTraining: nvpDismissedProductTraining,
            includeOwnedWorkspaceChats: iouType === CONST_1.default.IOU.TYPE.SUBMIT,
            includeP2P: true,
    ...
    var chatOptions = (0, react_1.useMemo)(function () {
        ...
        var newOptions = (0, OptionsListUtils_1.filterAndOrderOptions)(defaultOptions, cleanSearchTerm, countryCode, {
    ...
    var addAttendeeToSelection = (0, react_1.useCallback)(function (option) {
        ...
        if (isOptionInList) {
            ...
            var icon = typeof iconSource === 'function' ? '' : (0, SafeString_1.default)(iconSource);
            newSelectedOptions = __spreadArray(__spreadArray([], attendees, true), [
                {
                    accountID: (_c = option.accountID) !== null && _c !== void 0 ? _c : CONST_1.default.DEFAULT_NUMBER_ID,
                    // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
                    login: option.login || option.text,
                    // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
                    email: option.login || ((_d = option.text) !== null && _d !== void 0 ? _d : ''),
                    displayName: (_e = option.text) !== null && _e !== void 0 ? _e : '',
                    selected: true,
                    searchText: option.searchText,
                    avatarUrl: (_f = option.avatarUrl) !== null && _f !== void 0 ? _f : icon,
                    iouType: iouType,
                },
            ], false);
        }
