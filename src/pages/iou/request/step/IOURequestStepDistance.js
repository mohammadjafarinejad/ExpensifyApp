...
function IOURequestStepDistance(_a) {
    ...
    return (<StepScreenWrapper_1.default headerTitle={translate('common.distance')} onBackButtonPress={navigateBack} testID={IOURequestStepDistance.displayName} shouldShowNotFoundPage={(isEditing && !((_h = transaction === null || transaction === void 0 ? void 0 : transaction.comment) === null || _h === void 0 ? void 0 : _h.waypoints)) || shouldShowNotFoundPage} shouldShowWrapper={!isCreatingNewRequest}>
            <>
...
var IOURequestStepDistanceWithCurrentUserPersonalDetails = (0, withCurrentUserPersonalDetails_1.default)(IOURequestStepDistance);
// eslint-disable-next-line rulesdir/no-negated-variables
