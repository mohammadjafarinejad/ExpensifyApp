...
function IOURequestStepMerchant(_a) {
    var _b, _c;
    var _d = _a.route.params, transactionID = _d.transactionID, reportID = _d.reportID, backTo = _d.backTo, action = _d.action, iouType = _d.iouType, reportActionID = _d.reportActionID, transaction = _a.transaction, report = _a.report;
    ...
    var updateMerchant = function (value) {
        ...
        if (isEditingSplitBill) {
            (0, IOU_1.setDraftSplitTransaction)(transactionID, splitDraftTransaction, { merchant: newMerchant });
            navigateBack();
            return;
        }
