...
var Policy_2 = require("@userActions/Policy/Policy");
...
function IOURequestStepParticipants(_a) {
    ...
    var _f = (0, useLocalize_1.default)(), translate = _f.translate, localeCompare = _f.localeCompare;
    ...
    var shouldAutoReport = (0, react_1.useRef)(true);
    ...
    var isActivePolicyRequest = iouType === CONST_1.default.IOU.TYPE.CREATE && (0, PolicyUtils_1.isPaidGroupPolicy)(activePolicy) && (activePolicy === null || activePolicy === void 0 ? void 0 : activePolicy.isPolicyExpenseChatEnabled) && !(0, SubscriptionUtils_1.shouldRestrictUserBillableActions)(activePolicy.id);
    ...
    var isPerDiem = (0, TransactionUtils_1.isPerDiemRequest)(initialTransaction);
    var isCorporateCard = (0, TransactionUtils_1.isCorporateCardTransaction)(initialTransaction);
    ...
    (0, react_1.useEffect)(function () {
        ...
        var firstReceiptFilename = (_a = (0, getReceiptFilenameFromTransaction_1.default)(initialTransaction)) !== null && _a !== void 0 ? _a : '';
    ...
    var trackExpense = (0, react_1.useCallback)(function () {
        ...
        var rateID = CONST_1.default.CUSTOM_UNITS.FAKE_P2P_ID;
        transactions.forEach(function (transaction) {
            (0, IOU_1.setCustomUnitRateID)(transaction.transactionID, rateID);
            var shouldSetParticipantAutoAssignment = iouType === CONST_1.default.IOU.TYPE.CREATE;
    ...
    var addParticipant = (0, react_1.useCallback)(function (val) {
        ...
        if ((firstParticipant === null || firstParticipant === void 0 ? void 0 : firstParticipant.isSelfDM) && !isSplitRequest) {
            trackExpense();
            return;
        }
        var firstParticipantReportID = (_a = val.at(0)) === null || _a === void 0 ? void 0 : _a.reportID;
        var isPolicyExpenseChat = !!(firstParticipant === null || firstParticipant === void 0 ? void 0 : firstParticipant.isPolicyExpenseChat);
        var policy = isPolicyExpenseChat && (firstParticipant === null || firstParticipant === void 0 ? void 0 : firstParticipant.policyID) ? allPolicies === null || allPolicies === void 0 ? void 0 : allPolicies["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(firstParticipant.policyID)] : undefined;
        ...
        if (transactions.length > 0) {
            ...
            (0, IOU_1.setMoneyRequestParticipants)(initialTransactionID, val);
        }
        if (!isMovingTransactionFromTrackExpense) {
            ...
            var rateID_1 = DistanceRequestUtils_1.default.getCustomUnitRateID({ reportID: firstParticipantReportID, isPolicyExpenseChat: isPolicyExpenseChat, policy: policy, lastSelectedDistanceRates: lastSelectedDistanceRates, localeCompare: localeCompare });
            if (transactions.length > 0) {
                transactions.forEach(function (transaction) {
                ...
                (0, IOU_1.setCustomUnitRateID)(initialTransactionID, rateID_1);
            }
        }
        ...
        var hasOneValidParticipant = iouType === CONST_1.default.IOU.TYPE.INVOICE && selectedReportID.current !== reportID ? val.filter(function (item) { return !!item.login; }).length !== 1 : val.length !== 1;
        ...
        if (!isPolicyExpenseChat || action !== CONST_1.default.IOU.ACTION.CREATE) {
            shouldAutoReport.current = true;
        }
        else {
            shouldAutoReport.current = !!(policy === null || policy === void 0 ? void 0 : policy.autoReporting) || !!(personalPolicy === null || personalPolicy === void 0 ? void 0 : personalPolicy.autoReporting);
        }
    }, [
        isSplitRequest,
        allPolicies,
    ...
    var goToNextStep = (0, react_1.useCallback)(function () {
        ...
        var shouldUpdateTransactionReportID = ((_a = participants === null || participants === void 0 ? void 0 : participants.at(0)) === null || _a === void 0 ? void 0 : _a.reportID) !== newReportID;
        var transactionReportID = shouldAutoReport.current ? newReportID : CONST_1.default.REPORT.UNREPORTED_REPORT_ID;
        // TODO: probably should also change participants here for selectedParticipants.current, but out of scope of this PR
        transactions.forEach(function (transaction) {
            var tag = isMovingTransactionFromTrackExpense && (transaction === null || transaction === void 0 ? void 0 : transaction.tag) ? transaction === null || transaction === void 0 ? void 0 : transaction.tag : '';
            (0, IOU_1.setMoneyRequestTag)(transaction.transactionID, tag);
            var category = isMovingTransactionFromTrackExpense && (transaction === null || transaction === void 0 ? void 0 : transaction.category) ? transaction === null || transaction === void 0 ? void 0 : transaction.category : '';
            (0, IOU_1.setMoneyRequestCategory)(transaction.transactionID, category);
            if (shouldUpdateTransactionReportID) {
                (0, Transaction_1.setTransactionReport)(transaction.transactionID, { reportID: transactionReportID }, true);
            }
        });
        if ((isCategorizing || isShareAction) && numberOfParticipants.current === 0) {
            var _b = (0, Policy_2.createDraftWorkspace)(introSelected), expenseChatReportID_1 = _b.expenseChatReportID, policyID_1 = _b.policyID, policyName_1 = _b.policyName;
            transactions.forEach(function (transaction) {
        ...
        var iouConfirmationPageRoute = ROUTES_1.default.MONEY_REQUEST_STEP_CONFIRMATION.getRoute(action, iouType === CONST_1.default.IOU.TYPE.CREATE || iouType === CONST_1.default.IOU.TYPE.TRACK ? CONST_1.default.IOU.TYPE.SUBMIT : iouType, initialTransactionID, newReportID, undefined, undefined, action === CONST_1.default.IOU.ACTION.SHARE ? Navigation_1.default.getActiveRoute() : undefined);
    ...
    var navigateBack = (0, react_1.useCallback)(function () {
        ...
        var shouldForceIOUType = action === CONST_1.default.IOU.ACTION.CREATE && iouType === CONST_1.default.IOU.TYPE.SUBMIT && (iouRequestType === CONST_1.default.IOU.REQUEST_TYPE.MANUAL || iouRequestType === CONST_1.default.IOU.REQUEST_TYPE.SCAN);
        var iouTypeValue = shouldForceIOUType ? CONST_1.default.IOU.TYPE.CREATE : iouType;
        (0, IOUUtils_1.navigateToStartMoneyRequestStep)(iouRequestType, iouTypeValue, initialTransactionID, reportID, action);
    ...
    return (<StepScreenWrapper_1.default headerTitle={headerTitle} onBackButtonPress={navigateBack} shouldShowWrapper testID={IOURequestStepParticipants.displayName}>
            ...
            <MoneyRequestParticipantsSelector_1.default participants={isSplitRequest ? participants : (0, getEmptyArray_1.default)()} onParticipantsAdded={addParticipant} onFinish={goToNextStep} iouType={iouType} action={action} isPerDiemRequest={isPerDiem} isWorkspacesOnly={isWorkspacesOnly} isCorporateCardTransaction={isCorporateCard}/>
