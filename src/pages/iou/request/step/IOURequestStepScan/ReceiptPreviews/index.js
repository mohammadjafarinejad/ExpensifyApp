...
function ReceiptPreviews(_a) {
    ...
    var optimisticTransactionsReceipts = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.TRANSACTION_DRAFT, {
        selector: TransactionDraft_1.transactionDraftReceiptsSelector,
        canBeMissing: true,
    })[0];
    ...
    (0, react_1.useEffect)(function () {
        var _a;
        var hasRemovedReceipt = receiptsPhotosLength < previousReceiptsPhotosLength;
    ...
    var renderItem = function (_a) {
        ...
        return (<Pressable_1.PressableWithFeedback accessible accessibilityLabel={translate('common.receipt')} accessibilityRole={CONST_1.default.ROLE.BUTTON} onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.MONEY_REQUEST_RECEIPT_VIEW.getRoute(item.transactionID, Navigation_1.default.getActiveRoute())); }}>
                <Image_1.default source={typeof item.source === 'string' ? { uri: item.source } : item.source} style={[styles.receiptPlaceholder, styles.overflowHidden]} loadingIconSize="small" loadingIndicatorStyles={styles.bgTransparent}/>
