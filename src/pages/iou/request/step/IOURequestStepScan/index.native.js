...
function IOURequestStepScan(_a) {
    var _b, _c, _d;
    var report = _a.report, _e = _a.route.params, action = _e.action, iouType = _e.iouType, reportID = _e.reportID, initialTransactionID = _e.transactionID, backTo = _e.backTo, backToReport = _e.backToReport, initialTransaction = _a.transaction, currentUserPersonalDetails = _a.currentUserPersonalDetails, onLayout = _a.onLayout, _f = _a.isMultiScanEnabled, isMultiScanEnabled = _f === void 0 ? false : _f, _g = _a.isStartingScan, isStartingScan = _g === void 0 ? false : _g, setIsMultiScanEnabled = _a.setIsMultiScanEnabled;
    var theme = (0, useTheme_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var isBetaEnabled = (0, usePermissions_1.default)().isBetaEnabled;
    var _h = (0, FullScreenLoaderContext_1.useFullScreenLoader)(), isLoaderVisible = _h.isLoaderVisible, setIsLoaderVisible = _h.setIsLoaderVisible;
    ...
    var _j = (0, react_1.useState)(false), flash = _j[0], setFlash = _j[1];
    var canUseMultiScan = isStartingScan && iouType !== CONST_1.default.IOU.TYPE.SPLIT;
    var _k = (0, react_1.useState)(false), startLocationPermissionFlow = _k[0], setStartLocationPermissionFlow = _k[1];
    var _l = (0, react_1.useState)([]), receiptFiles = _l[0], setReceiptFiles = _l[1];
    ...
    var _m = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_MUTED_PLATFORMS, { canBeMissing: true })[0], mutedPlatforms = _m === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _m;
    var isPlatformMuted = mutedPlatforms[platform];
    var _o = (0, react_1.useState)(null), cameraPermissionStatus = _o[0], setCameraPermissionStatus = _o[1];
    var _p = (0, react_1.useState)(false), didCapturePhoto = _p[0], setDidCapturePhoto = _p[1];
    var _q = (0, react_1.useState)(false), shouldShowMultiScanEducationalPopup = _q[0], setShouldShowMultiScanEducationalPopup = _q[1];
            ...
            if (shouldSkipConfirmation) {
                ...
                if (locationPermissionGranted) {
                    (0, getCurrentPosition_1.default)(function (successData) {
                        ...
                        createTransaction(files, participant_1, gpsPoint, policyParams, false);
                    }, function (errorData) {
    ...
    var updateScanAndNavigate = (0, react_1.useCallback)(function (file, source) {
        ...
        var navigationState = (_a = navigationRef_1.default.current) === null || _a === void 0 ? void 0 : _a.getState();
        var reportsSplitNavigator = (_b = navigationState === null || navigationState === void 0 ? void 0 : navigationState.routes) === null || _b === void 0 ? void 0 : _b.findLast(function (route) { return route.name === 'ReportsSplitNavigator'; });
        var hasLostNavigationsState = reportsSplitNavigator && !reportsSplitNavigator.state;
        if (hasLostNavigationsState) {
            if (backTo) {
                Navigation_1.default.navigate(backTo);
            }
            else {
    ...
    var setTestReceiptAndNavigate = (0, react_1.useCallback)(function () {
        (0, setTestReceipt_1.default)(fake_receipt_png_1.default, 'png', function (source, file, filename) {
            ...
            (0, IOU_1.setMoneyRequestReceipt)(initialTransactionID, source, filename, !isEditing, 'image/png', true);
    ...
    var setReceiptFilesAndNavigate = function (files) {
        ...
        if (isEditing) {
            ...
            (0, IOU_1.setMoneyRequestReceipt)(initialTransactionID, (_a = file.uri) !== null && _a !== void 0 ? _a : '', (_b = file.name) !== null && _b !== void 0 ? _b : '', !isEditing, file.type);
            updateScanAndNavigate(file, (_c = file.uri) !== null && _c !== void 0 ? _c : '');
            return;
        }
        files.forEach(function (file, index) {
            ...
            newReceiptFiles.push({ file: file, source: (_d = file.uri) !== null && _d !== void 0 ? _d : '', transactionID: transactionID });
            (0, IOU_1.setMoneyRequestReceipt)(transactionID, (_e = file.uri) !== null && _e !== void 0 ? _e : '', (_f = file.name) !== null && _f !== void 0 ? _f : '', true, file.type);
        });
        if (shouldSkipConfirmation) {
    ...
    var capturePhoto = (0, react_1.useCallback)(function () {
        ...
        react_native_blob_util_1.default.fs
            ...
            (_a = camera === null || camera === void 0 ? void 0 : camera.current) === null || _a === void 0 ? void 0 : _a.takePhoto({
                ...
                var imageObject = { file: photo, filename: photo.path, source: (0, getPhotoSource_1.default)(photo.path) };
                (0, cropImageToAspectRatio_1.cropImageToAspectRatio)(imageObject, (_c = viewfinderLayout.current) === null || _c === void 0 ? void 0 : _c.width, (_d = viewfinderLayout.current) === null || _d === void 0 ? void 0 : _d.height, undefined, photo.orientation).then(function (_a) {
                    ...
                    var cameraFile = __assign(__assign({}, file), { source: source });
                    (0, IOU_1.setMoneyRequestReceipt)(transactionID, source, filename, !isEditing, file.type);
                    if (isEditing) {
                        updateScanAndNavigate(cameraFile, source);
                        return;
                    }
                    var newReceiptFiles = __spreadArray(__spreadArray([], receiptFiles, true), [{ file: cameraFile, source: source, transactionID: transactionID }], false);
                    setReceiptFiles(newReceiptFiles);
                    if (isMultiScanEnabled) {
                        setDidCapturePhoto(false);
                        return;
            ...
            onLayout(setTestReceiptAndNavigate);
                ...
                <react_native_1.View style={[styles.flex1]}>
                    ...
                    {cameraPermissionStatus === react_native_permissions_1.RESULTS.GRANTED && device == null && (<react_native_1.View style={[styles.cameraView]}>
                            <ActivityIndicator_1.default size={CONST_1.default.ACTIVITY_INDICATOR_SIZE.LARGE} style={[styles.flex1]} color={theme.textSupporting}/>
                        </react_native_1.View>)}
                    {cameraPermissionStatus === react_native_permissions_1.RESULTS.GRANTED && device != null && (<react_native_1.View style={[styles.cameraView]}>
                            <react_native_gesture_handler_1.GestureDetector gesture={tapGesture}>
                                <react_native_1.View style={styles.flex1}>
                                    <Camera_1.default ref={camera} device={device} style={styles.flex1} zoom={device.neutralZoom} photo cameraTabIndex={1} onLayout={function (e) { return (viewfinderLayout.current = e.nativeEvent.layout); }}/>
                ...
                <react_native_1.View style={[styles.flexRow, styles.justifyContentAround, styles.alignItemsCenter, styles.pv3]}>
                    <AttachmentPicker_1.default onOpenPicker={function () { return setIsLoaderVisible(true); }} fileLimit={shouldAcceptMultipleFiles ? CONST_1.default.API_ATTACHMENT_VALIDATIONS.MAX_FILE_LIMIT : 1} shouldValidateImage={false}>
                        {function (_a) {
