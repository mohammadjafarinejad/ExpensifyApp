...
function IOURequestStepSubrate(_a) {
    ...
    var validate = function (values) {
        var _a;
        var errors = {};
        var quantityVal = (0, SafeString_1.default)(values["quantity".concat(pageIndex)]);
        var subrateVal = (_a = values["subrate".concat(pageIndex)]) !== null && _a !== void 0 ? _a : '';
    ...
    var submit = function (values) {
        ...
        var quantityVal = (0, SafeString_1.default)(values["quantity".concat(pageIndex)]);
        var subrateVal = (0, SafeString_1.default)(values["subrate".concat(pageIndex)]);
        var quantityInt = parseInt(quantityVal, 10);
        var selectedSubrate = allPossibleSubrates.find(function (_a) {
            var id = _a.id;
            return id === subrateVal;
        });
        var name = (_a = selectedSubrate === null || selectedSubrate === void 0 ? void 0 : selectedSubrate.name) !== null && _a !== void 0 ? _a : '';
        var rate = (_b = selectedSubrate === null || selectedSubrate === void 0 ? void 0 : selectedSubrate.rate) !== null && _b !== void 0 ? _b : 0;
        var transactionReportID = (_f = (_e = (_d = (_c = transaction === null || transaction === void 0 ? void 0 : transaction.participants) === null || _c === void 0 ? void 0 : _c.at(0)) === null || _d === void 0 ? void 0 : _d.reportID) !== null && _e !== void 0 ? _e : transaction === null || transaction === void 0 ? void 0 : transaction.reportID) !== null && _f !== void 0 ? _f : reportID;
        ...
        if (backTo) {
            ...
            Navigation_1.default.navigate(ROUTES_1.default.MONEY_REQUEST_STEP_CONFIRMATION.getRoute(action, iouType, transactionID, transactionReportID));
        }
    };
