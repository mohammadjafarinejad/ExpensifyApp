...
function IOURequestStepTaxAmountPage(_a) {
    var _b;
    var _c = _a.route.params, action = _c.action, iouType = _c.iouType, reportID = _c.reportID, transactionID = _c.transactionID, backTo = _c.backTo, _d = _c.currency, selectedCurrency = _d === void 0 ? '' : _d, transaction = _a.transaction, report = _a.report;
    ...
    var updateTaxAmount = function (currentAmount) {
        ...
        if (isEditingSplitBill) {
            (0, IOU_1.setDraftSplitTransaction)(transactionID, splitDraftTransaction, { taxAmount: taxAmountInSmallestCurrencyUnits });
            navigateBack();
            return;
        }
        if (isEditing) {
...
var IOURequestStepTaxAmountPageWithWritableReportOrNotFound = (0, withWritableReportOrNotFound_1.default)(IOURequestStepTaxAmountPage);
// eslint-disable-next-line rulesdir/no-negated-variables
