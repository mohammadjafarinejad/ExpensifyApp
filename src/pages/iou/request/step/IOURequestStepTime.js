...
function IOURequestStepTime(_a) {
    var _b;
    var _c, _d, _e, _f;
    var _g = _a.route, _h = _g.params, action = _h.action, iouType = _h.iouType, reportID = _h.reportID, transactionID = _h.transactionID, backTo = _h.backTo, name = _g.name, transaction = _a.transaction, isLoadingTransaction = _a.isLoadingTransaction, report = _a.report;
    ...
    var policiesWithPerDiemEnabled = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.getActivePoliciesWithExpenseChatAndPerDiemEnabled)(allPolicies, currentUserLogin); }, [allPolicies, currentUserLogin]);
    var hasMoreThanOnePolicyWithPerDiemEnabled = policiesWithPerDiemEnabled.length > 1;
    ...
    if (isLoadingTransaction) {
        return <FullscreenLoadingIndicator_1.default style={[styles.flex1, styles.pRelative]}/>;
    }
