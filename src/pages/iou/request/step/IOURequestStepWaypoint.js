...
function IOURequestStepWaypoint(_a) {
    ...
    var allRecentWaypoints = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_RECENT_WAYPOINTS, { canBeMissing: true })[0];
    ...
    var save = function (waypoint) {
        (0, Transaction_1.saveWaypoint)({ transactionID: transactionID, index: pageIndex, waypoint: waypoint, isDraft: (0, IOUUtils_1.shouldUseTransactionDraft)(action), recentWaypointsList: allRecentWaypoints });
    };
