...
var exitReasonSelector = function (value) { var _a; return (_a = value === null || value === void 0 ? void 0 : value[ExitSurveyReasonForm_1.default.REASON]) !== null && _a !== void 0 ? _a : null; };
var exitResponseSelector = function (value) { return value === null || value === void 0 ? void 0 : value[ExitSurveyResponseForm_1.default.RESPONSE]; };
function ExitSurveyConfirmPage(_a) {
    ...
    return (<ScreenWrapper_1.default testID={ExitSurveyConfirmPage.displayName} shouldShowOfflineIndicatorInWideScreen>
