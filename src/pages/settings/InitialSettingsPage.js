...
function InitialSettingsPage(_a) {
    ...
    var stripeCustomerId = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_PRIVATE_STRIPE_CUSTOMER_ID, { canBeMissing: true })[0];
    ...
    var retryBillingSuccessful = (0, useOnyx_1.default)(ONYXKEYS_1.default.SUBSCRIPTION_RETRY_BILLING_STATUS_SUCCESSFUL, { canBeMissing: true })[0];
    var billingDisputePending = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_PRIVATE_BILLING_DISPUTE_PENDING, { canBeMissing: true })[0];
    var retryBillingFailed = (0, useOnyx_1.default)(ONYXKEYS_1.default.SUBSCRIPTION_RETRY_BILLING_STATUS_FAILED, { canBeMissing: true })[0];
    var shouldUseNarrowLayout = (0, useResponsiveLayout_1.default)().shouldUseNarrowLayout;
    var network = (0, useNetwork_1.default)();
    var theme = (0, useTheme_1.default)();
    var styles = (0, useThemeStyles_1.default)();
    var _e = (0, useSingleExecution_1.default)(), isExecuting = _e.isExecuting, singleExecution = _e.singleExecution;
    ...
    var previousUserPersonalDetails = (0, usePrevious_1.default)(currentUserPersonalDetails);
    var shouldLogout = (0, react_1.useRef)(false);
    var freeTrialText = (0, SubscriptionUtils_1.getFreeTrialText)(translate, policies, introSelected, firstDayFreeTrial, lastDayFreeTrial);
    ...
    var walletBrickRoadIndicator = (0, PaymentMethods_1.hasPaymentMethodError)(bankAccountList, fundList, allCards) || !(0, EmptyObject_1.isEmptyObject)(userWallet === null || userWallet === void 0 ? void 0 : userWallet.errors) || !(0, EmptyObject_1.isEmptyObject)(walletTerms === null || walletTerms === void 0 ? void 0 : walletTerms.errors) || hasBrokenFeedConnection
        ? 'error'
        : undefined;
    var _f = (0, react_1.useState)(false), shouldShowSignoutConfirmModal = _f[0], setShouldShowSignoutConfirmModal = _f[1];
    var hasAccountBeenSwitched = (0, react_1.useMemo)(function () { return currentUserPersonalDetails.accountID !== previousUserPersonalDetails.accountID; }, [currentUserPersonalDetails.accountID, previousUserPersonalDetails.accountID]);
    ...
    var accountMenuItemsData = (0, react_1.useMemo)(function () {
        var profileBrickRoadIndicator = (0, UserUtils_1.getProfilePageBrickRoadIndicator)(loginList, privatePersonalDetails, vacationDelegate, session === null || session === void 0 ? void 0 : session.email);
        var items = [
            {
        ...
        if (subscriptionPlan) {
            items.splice(1, 0, {
                ...
                brickRoadIndicator: !!(privateSubscription === null || privateSubscription === void 0 ? void 0 : privateSubscription.errors) || (0, SubscriptionUtils_1.hasSubscriptionRedDotError)(stripeCustomerId, retryBillingSuccessful, billingDisputePending, retryBillingFailed)
    ...
    var generalMenuItemsData = (0, react_1.useMemo)(function () {
        var signOutTranslationKey = (0, Session_1.isSupportAuthToken)() && (0, Session_1.hasStashedSession)() ? 'initialSettingsPage.restoreStashed' : 'initialSettingsPage.signOut';
        return {
            ...
            items: [
                ...
                },
                {
                    ...
                    action: function () { return signOut(false); },
                },
            ],
        };
    }, [styles.pt4, signOut]);
