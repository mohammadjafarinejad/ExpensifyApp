...
function LanguagePage() {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={LanguagePage.displayName}>
            ...
            <FullPageOfflineBlockingView_1.default>
                <SelectionList_1.default data={locales} ListItem={RadioListItem_1.default} onSelectRow={updateLanguage} shouldSingleExecuteRowSelect initiallyFocusedItemKey={(_a = locales.find(function (locale) { return locale.isSelected; })) === null || _a === void 0 ? void 0 : _a.keyForList}/>
            </FullPageOfflineBlockingView_1.default>
