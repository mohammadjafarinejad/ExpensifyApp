...
function ThemePage() {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={ThemePage.displayName}>
            ...
            <SelectionList_1.default data={localesToThemes} ListItem={RadioListItem_1.default} onSelectRow={updateTheme} shouldSingleExecuteRowSelect initiallyFocusedItemKey={(_a = localesToThemes.find(function (theme) { return theme.isSelected; })) === null || _a === void 0 ? void 0 : _a.keyForList}/>
