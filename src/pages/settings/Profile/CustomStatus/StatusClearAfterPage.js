...
function StatusClearAfterPage() {
    ...
    var updateMode = (0, react_1.useCallback)(function (mode) {
        ...
        if (mode.value === CONST_1.default.CUSTOM_STATUS_TYPES.CUSTOM) {
            (0, User_1.updateStatusDraftCustomClearAfterDate)(DateUtils_1.default.getOneHourFromNow());
        }
    }, [draftPeriod]);
    (0, react_1.useEffect)(function () {
        (0, User_1.updateStatusDraftCustomClearAfterDate)(draftClearAfter || clearAfter);
        // eslint-disable-next-line react-compiler/react-compiler, react-hooks/exhaustive-deps
    }, []);
    var customStatusDate = DateUtils_1.default.extractDate(statusDraftCustomClearAfterDate !== null && statusDraftCustomClearAfterDate !== void 0 ? statusDraftCustomClearAfterDate : '');
    var customStatusTime = DateUtils_1.default.extractTime12Hour(statusDraftCustomClearAfterDate !== null && statusDraftCustomClearAfterDate !== void 0 ? statusDraftCustomClearAfterDate : '');
    ...
    var saveAndGoBack = (0, react_1.useCallback)(function () {
        var _a;
        if (!draftPeriod) {
            return;
        }
        var calculatedDraftDate = '';
        if (draftPeriod === CONST_1.default.CUSTOM_STATUS_TYPES.CUSTOM) {
            calculatedDraftDate = statusDraftCustomClearAfterDate !== null && statusDraftCustomClearAfterDate !== void 0 ? statusDraftCustomClearAfterDate : DateUtils_1.default.getOneHourFromNow();
        }
        else {
            var selectedRange = statusType.find(function (item) { return item.value === draftPeriod; });
            calculatedDraftDate = DateUtils_1.default.getDateFromStatusType((_a = selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.value) !== null && _a !== void 0 ? _a : CONST_1.default.CUSTOM_STATUS_TYPES.NEVER);
        }
    ...
    var initialFocusedIndex = (0, react_1.useMemo)(function () {
        var _a;
        return (_a = statusType.find(function (item) { return item.isSelected; })) === null || _a === void 0 ? void 0 : _a.keyForList;
    }, [statusType]);
    var timePeriodOptions = (0, react_1.useCallback)(function () { return (<SelectionListWithSections_1.default sections={[{ data: statusType }]} ListItem={RadioListItem_1.default} onSelectRow={updateMode} listFooterContent={listFooterContent} showConfirmButton initiallyFocusedOptionKey={initialFocusedIndex} shouldUpdateFocusedIndex confirmButtonText={translate('statusPage.save')} onConfirm={saveAndGoBack}/>); }, [statusType, updateMode, listFooterContent, saveAndGoBack, translate, initialFocusedIndex]);
