 ...
 */
var updateDisplayName = function (values, formatPhoneNumber, currentUserAccountID, currentUserEmail) {
    (0, PersonalDetails_1.updateDisplayName)(values.firstName.trim(), values.lastName.trim(), formatPhoneNumber, currentUserAccountID, currentUserEmail);
...
function DisplayNamePage(_a) {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom shouldEnableMaxHeight testID={DisplayNamePage.displayName}>
            ...
            {isLoadingApp ? (<FullscreenLoadingIndicator_1.default style={[styles.flex1, styles.pRelative]}/>) : (<FormProvider_1.default style={[styles.flexGrow1, styles.ph5]} formID={ONYXKEYS_1.default.FORMS.DISPLAY_NAME_FORM} validate={validate} onSubmit={function (values) { var _a; return updateDisplayName(values, formatPhoneNumber, currentUserDetails === null || currentUserDetails === void 0 ? void 0 : currentUserDetails.accountID, (_a = currentUserDetails === null || currentUserDetails === void 0 ? void 0 : currentUserDetails.email) !== null && _a !== void 0 ? _a : ''); }} submitButtonText={translate('common.save')} enabledWhenOffline shouldValidateOnBlur shouldValidateOnChange>
