...
function ProfilePage() {
    ...
    var _s = (0, useLocalize_1.default)(), translate = _s.translate, formatPhoneNumber = _s.formatPhoneNumber;
    ...
    var avatarStyle = [styles.avatarXLarge, styles.alignSelfStart];
    var contactMethodBrickRoadIndicator = (0, UserUtils_1.getLoginListBrickRoadIndicator)(loginList, currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.email);
    ...
    var _t = (0, react_1.useContext)(DelegateNoAccessModalProvider_1.DelegateNoAccessContext), isActingAsDelegate = _t.isActingAsDelegate, showDelegateNoAccessModal = _t.showDelegateNoAccessModal;
    var publicOptions = [
        {
            description: translate('displayNamePage.headerTitle'),
            title: formatPhoneNumber((0, PersonalDetailsUtils_1.getDisplayNameOrDefault)(currentUserPersonalDetails)),
            pageRoute: ROUTES_1.default.SETTINGS_DISPLAY_NAME,
        },
        {
            description: translate('contacts.contactMethods'),
            title: formatPhoneNumber((_g = currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.login) !== null && _g !== void 0 ? _g : ''),
        ...
        },
        {
            ...
            title: emojiCode ? "".concat(emojiCode, " ").concat((_j = (_h = currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.status) === null || _h === void 0 ? void 0 : _h.text) !== null && _j !== void 0 ? _j : '') : '',
            pageRoute: ROUTES_1.default.SETTINGS_STATUS,
            brickRoadIndicator: (0, EmptyObject_1.isEmptyObject)(vacationDelegate === null || vacationDelegate === void 0 ? void 0 : vacationDelegate.errors) ? undefined : CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR,
        },
        {
        ...
        },
        {
            ...
            title: (_l = (_k = currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.timezone) === null || _k === void 0 ? void 0 : _k.selected) !== null && _l !== void 0 ? _l : '',
    ...
    var privateOptions = [
        ...
        },
        {
            ...
            title: (_m = privateDetails.dob) !== null && _m !== void 0 ? _m : '',
            action: function () {
                if (isActingAsDelegate) {
                    showDelegateNoAccessModal();
                    return;
        ...
        },
        {
            ...
            title: (_o = privateDetails.phoneNumber) !== null && _o !== void 0 ? _o : '',
            action: function () {
                if (isActingAsDelegate) {
                    showDelegateNoAccessModal();
                    return;
            ...
            brickRoadIndicator: ((_p = privatePersonalDetails === null || privatePersonalDetails === void 0 ? void 0 : privatePersonalDetails.errorFields) === null || _p === void 0 ? void 0 : _p.phoneNumber) ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined,
        },
        {
                        ...
                        <Section_1.default title={translate('profilePage.publicSection.title')} subtitle={translate('profilePage.publicSection.subtitle')} isCentralPane subtitleMuted childrenStyles={styles.pt5} titleStyles={styles.accountSettingsSectionTitle}>
                            <react_native_1.View style={[styles.pt3, styles.pb6, styles.alignSelfStart, styles.w100]}>
                                {(0, EmptyObject_1.isEmptyObject)(currentUserPersonalDetails) || accountID === -1 || !avatarURL ? (<AvatarSkeleton_1.default size={CONST_1.default.AVATAR_SIZE.X_LARGE}/>) : (<MenuItemGroup_1.default shouldUseSingleExecution={false}>
                                        <AvatarButtonWithIcon_1.default text={translate('avatarWithImagePicker.editImage')} source={avatarURL} avatarID={accountID} onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_AVATAR); }} size={CONST_1.default.AVATAR_SIZE.X_LARGE} avatarStyle={avatarStyle} pendingAction={(_r = (_q = currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.pendingFields) === null || _q === void 0 ? void 0 : _q.avatar) !== null && _r !== void 0 ? _r : undefined} fallbackIcon={currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.fallbackIcon} editIconStyle={styles.profilePageAvatar}/>
                                    </MenuItemGroup_1.default>)}
                            </react_native_1.View>
                            {publicOptions.map(function (detail, index) { return (<MenuItemWithTopDescription_1.default 
        // eslint-disable-next-line react/no-array-index-key
        key={"".concat(detail.title, "_").concat(index)} shouldShowRightIcon title={detail.title} description={detail.description} wrapperStyle={styles.sectionMenuItemTopDescription} onPress={function () { return Navigation_1.default.navigate(detail.pageRoute); }} brickRoadIndicator={detail.brickRoadIndicator} pressableTestID={detail === null || detail === void 0 ? void 0 : detail.testID}/>); })}
