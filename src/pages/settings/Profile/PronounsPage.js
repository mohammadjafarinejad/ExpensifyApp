...
function PronounsPage(_a) {
    ...
    var _e = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_LOADING_APP, { canBeMissing: true })[0], isLoadingApp = _e === void 0 ? true : _e;
    ...
    var currentUserAccountID = (_c = currentUserPersonalDetails === null || currentUserPersonalDetails === void 0 ? void 0 : currentUserPersonalDetails.accountID) !== null && _c !== void 0 ? _c : CONST_1.default.DEFAULT_NUMBER_ID;
    ...
    var filteredPronounsList = (0, react_1.useMemo)(function () {
        ...
        }).sort(function (a, b) { return localeCompare(a.text.toLowerCase(), b.text.toLowerCase()); });
    ...
    var updatePronouns = function (selectedPronouns) {
        ...
        (0, PersonalDetails_1.updatePronouns)(selectedPronouns.keyForList === currentPronounsKey ? '' : ((_a = selectedPronouns === null || selectedPronouns === void 0 ? void 0 : selectedPronouns.value) !== null && _a !== void 0 ? _a : ''), currentUserAccountID);
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={PronounsPage.displayName}>
            {isLoadingApp && !currentUserPersonalDetails.pronouns ? (<FullscreenLoadingIndicator_1.default />) : (<>
                    ...
                    <SelectionListWithSections_1.default headerMessage={headerMessage} textInputLabel={translate('pronounsPage.pronouns')} textInputPlaceholder={translate('pronounsPage.placeholderText')} textInputValue={searchValue} sections={[{ data: filteredPronounsList }]} ListItem={RadioListItem_1.default} onSelectRow={updatePronouns} shouldSingleExecuteRowSelect onChangeText={setSearchValue} initiallyFocusedOptionKey={currentPronounsKey}/>
                </>)}
