...
function TimezoneSelectPage(_a) {
    ...
    var saveSelectedTimezone = function (_a) {
        var text = _a.text;
        PersonalDetails.updateSelectedTimezone(text, currentUserPersonalDetails.accountID);
    };
