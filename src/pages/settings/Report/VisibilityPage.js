...
function VisibilityPage(_a) {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={VisibilityPage.displayName}>
            <FullPageNotFoundView_1.default shouldShow={shouldDisableVisibility}>
                ...
                <SelectionList_1.default shouldPreventDefaultFocusOnSelectRow data={visibilityOptions} onSelectRow={function (option) {
            if (option.value === CONST_1.default.REPORT.VISIBILITY.PUBLIC) {
                setShowConfirmModal(true);
                return;
            }
            changeVisibility(option.value);
        }} shouldSingleExecuteRowSelect initiallyFocusedItemKey={(_b = visibilityOptions.find(function (visibility) { return visibility.isSelected; })) === null || _b === void 0 ? void 0 : _b.keyForList} ListItem={RadioListItem_1.default}/>
