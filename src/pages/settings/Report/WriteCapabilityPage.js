...
function WriteCapabilityPage(_a) {
    ...
    var selectedOptionKey = (_b = writeCapabilityOptions.find(function (locale) { return locale.isSelected; })) === null || _b === void 0 ? void 0 : _b.keyForList;
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={WriteCapabilityPage.displayName}>
            <FullPageNotFoundView_1.default shouldShow={!isAbleToEdit}>
                ...
                <SelectionList_1.default data={writeCapabilityOptions} ListItem={RadioListItem_1.default} onSelectRow={function (option) { return updateWriteCapability(option.value); }} shouldSingleExecuteRowSelect initiallyFocusedItemKey={selectedOptionKey}/>
