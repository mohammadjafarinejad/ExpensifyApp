...
function SelectDelegateRolePage(_a) {
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom={false} testID={SelectDelegateRolePage.displayName}>
            <DelegateNoAccessWrapper_1.default accessDeniedVariants={[CONST_1.default.DELEGATE.DENIED_ACCESS_VARIANTS.DELEGATE]}>
                ...
                <SelectionList_1.default alternateNumberOfSupportedLines={4} initiallyFocusedItemKey={(_b = roleOptions.find(function (role) { return role.isSelected; })) === null || _b === void 0 ? void 0 : _b.keyForList} shouldUpdateFocusedIndex customListHeader={<DelegateRoleSelectionListHeader />} onSelectRow={function (option) {
