...
function BaseValidateCodeForm(_a) {
    ...
    var validateLoginError = (0, ErrorUtils_1.getLatestError)((_f = errorFields.updateDelegateRole) === null || _f === void 0 ? void 0 : _f[(_g = currentDelegate === null || currentDelegate === void 0 ? void 0 : currentDelegate.email) !== null && _g !== void 0 ? _g : '']);
    ...
    var resendValidateCode = function () {
        ...
        (0, Delegate_1.requestValidationCode)();
    ...
    }, [currentDelegate === null || currentDelegate === void 0 ? void 0 : currentDelegate.email, validateLoginError, account === null || account === void 0 ? void 0 : account.delegatedAccess]);
    /**
    ...
    var validateAndSubmitForm = (0, react_1.useCallback)(function () {
        ...
        setFormError({});
        (0, Delegate_1.updateDelegateRole)({ email: delegate, role: role, validateCode: validateCode, delegatedAccess: account === null || account === void 0 ? void 0 : account.delegatedAccess });
    }, [delegate, role, validateCode, account === null || account === void 0 ? void 0 : account.delegatedAccess]);
    return (<react_native_1.View style={[styles.flex1, styles.justifyContentBetween, wrapperStyle]}>
            ...
            <FixedFooter_1.default>
                <OfflineWithFeedback_1.default>
                    <Button_1.default isDisabled={isOffline || !!(account === null || account === void 0 ? void 0 : account.delegatedAccess)} text={translate('common.verify')} onPress={validateAndSubmitForm} style={[styles.mt4]} success pressOnEnter large isLoading={currentDelegate === null || currentDelegate === void 0 ? void 0 : currentDelegate.isLoading}/>
                </OfflineWithFeedback_1.default>
            </FixedFooter_1.default>
        </react_native_1.View>);
}
