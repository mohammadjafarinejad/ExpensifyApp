...
function CloseAccountPage() {
    ...
    var _a = (0, useOnyx_1.default)(ONYXKEYS_1.default.COUNTRY_CODE, { canBeMissing: false })[0], countryCode = _a === void 0 ? CONST_1.default.DEFAULT_COUNTRY_CODE : _a;
    var styles = (0, useThemeStyles_1.default)();
    var _b = (0, useLocalize_1.default)(), translate = _b.translate, formatPhoneNumber = _b.formatPhoneNumber;
    var _c = (0, react_1.useState)(false), isConfirmModalVisible = _c[0], setConfirmModalVisibility = _c[1];
    var _d = (0, react_1.useState)(''), reasonForLeaving = _d[0], setReasonForLeaving = _d[1];
    ...
    var validate = function (values) {
        ...
        if (values.phoneOrEmail && userEmailOrPhone) {
            ...
            if (expensify_common_1.Str.isValidEmail(userEmailOrPhone)) {
                ...
                var storedE164Phone = (0, LoginUtils_1.formatE164PhoneNumber)((0, LoginUtils_1.getPhoneNumberWithoutSpecialChars)(userEmailOrPhone), countryCode);
                var inputE164Phone = (0, LoginUtils_1.formatE164PhoneNumber)((0, LoginUtils_1.getPhoneNumberWithoutSpecialChars)(values.phoneOrEmail), countryCode);
