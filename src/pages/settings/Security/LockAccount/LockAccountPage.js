...
function LockAccountPage() {
    ...
    return (<>
            <HeaderPageLayout_1.default onBackButtonPress={function () { return Navigation_1.default.goBack(); }} title={translate('lockAccountPage.reportSuspiciousActivity')} testID={LockAccountPage.displayName} footer={lockAccountButton} childrenContainerStyles={[styles.pt3, styles.gap6]} shouldShowOfflineIndicatorInWideScreen>
            ...
            (0, User_1.lockAccount)().then(function (response) {
                ...
                if (response.jsonCode === CONST_1.default.JSON_CODE.SUCCESS) {
                    ...
                    Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_FAILED_TO_LOCK_ACCOUNT);
                        ...
                        <Text_1.default style={[styles.mb5]}>{translate('lockAccountPage.onceLocked')}</Text_1.default>
