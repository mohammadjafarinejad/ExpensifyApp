...
var getValidateCodeForAccountMergeSelector = function (account) { return account === null || account === void 0 ? void 0 : account.getValidateCodeForAccountMerge; };
function AccountDetailsPage() {
    ...
    var getValidateCodeForAccountMerge = (0, useOnyx_1.default)(ONYXKEYS_1.default.ACCOUNT, { selector: getValidateCodeForAccountMergeSelector, canBeMissing: true })[0];
    ...
    var _c = (0, react_1.useState)((_a = params === null || params === void 0 ? void 0 : params.email) !== null && _a !== void 0 ? _a : ''), email = _c[0], setEmail = _c[1];
    ...
    var validate = function (values) {
        ...
        if (!login) {
            ...
            var phoneLogin = (0, LoginUtils_1.getPhoneLogin)(login, countryCode);
            ...
            (0, MergeAccounts_1.requestValidationCodeForAccountMerge)(values[MergeAccountDetailsForm_1.default.PHONE_OR_EMAIL]);
                    ...
                    <react_native_1.View style={[styles.flexGrow1, styles.mt3]}>
                        <react_native_1.View style={[styles.renderHTML]}>
                            <RenderHTML_1.default html={translate('mergeAccountsPage.accountDetails.accountToMergeInto', { login: userEmailOrPhone !== null && userEmailOrPhone !== void 0 ? userEmailOrPhone : '' })}/>
                        </react_native_1.View>
