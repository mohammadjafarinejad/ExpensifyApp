...
var accountSelector = function (account) { return ({
    mergeWithValidateCode: account === null || account === void 0 ? void 0 : account.mergeWithValidateCode,
    getValidateCodeForAccountMerge: account === null || account === void 0 ? void 0 : account.getValidateCodeForAccountMerge,
}); };
function AccountValidatePage() {
    ...
    return (<ScreenWrapper_1.default shouldEnableMaxHeight includeSafeAreaPaddingBottom testID={AccountValidatePage.displayName} shouldShowOfflineIndicatorInWideScreen>
            ...
            <ScrollView_1.default style={[styles.w100, styles.h100, styles.flex1]} contentContainerStyle={[styles.flexGrow1]}>
                <ValidateCodeActionForm_1.default descriptionPrimary={translate('mergeAccountsPage.accountValidate.confirmMerge')} descriptionPrimaryStyles={__assign(__assign({}, styles.mb8), styles.textStrong)} descriptionSecondary={<react_native_1.View style={[styles.w100]}>
                            <react_native_1.View style={[styles.mb8, styles.renderHTML, styles.flexRow]}>
                                <RenderHTML_1.default html={translate('mergeAccountsPage.accountValidate.lossOfUnsubmittedData', { login: email })}/>
                            </react_native_1.View>
                            <react_native_1.View style={[styles.renderHTML, styles.flexRow]}>
                                <RenderHTML_1.default html={translate('mergeAccountsPage.accountValidate.enterMagicCode', { login: email })}/>
                            </react_native_1.View>
