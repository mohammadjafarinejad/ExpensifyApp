...
function SecuritySettingsPage() {
    ...
    var delegateMenuItems = (0, react_1.useMemo)(function () {
        return delegates
            ...
            var onPress = function (e) {
                ...
                Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_DELEGATE_CONFIRM.getRoute(email, role));
            };
            ...
            return {
                ...
                onPendingActionDismiss: function () { return (0, Delegate_1.clearDelegateErrorsByField)({ email: email, fieldName: 'addDelegate', delegatedAccess: account === null || account === void 0 ? void 0 : account.delegatedAccess }); },
                error: error,
                onPress: onPress,
    ...
    return (<ScreenWrapper_1.default testID={SecuritySettingsPage.displayName} includeSafeAreaPaddingBottom={false} shouldEnablePickerAvoiding={false} shouldShowOfflineIndicatorInWideScreen>
            ...
            return (<>
                    ...
                    var _a;
                    (0, Delegate_1.removeDelegate)({ email: (_a = selectedDelegate === null || selectedDelegate === void 0 ? void 0 : selectedDelegate.email) !== null && _a !== void 0 ? _a : '', delegatedAccess: account === null || account === void 0 ? void 0 : account.delegatedAccess });
