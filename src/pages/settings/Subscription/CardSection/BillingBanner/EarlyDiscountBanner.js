...
function EarlyDiscountBanner(_a) {
    ...
    var initialDiscountInfo = (0, SubscriptionUtils_1.getEarlyDiscountInfo)(firstDayFreeTrial);
    ...
    (0, react_1.useEffect)(function () {
        var intervalID = setInterval(function () {
            setDiscountInfo((0, SubscriptionUtils_1.getEarlyDiscountInfo)(firstDayFreeTrial));
        }, 1000);
