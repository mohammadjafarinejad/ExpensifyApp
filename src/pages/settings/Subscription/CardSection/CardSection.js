...
var CardSectionButton_1 = require("./CardSectionButton");
var CardSectionDataEmpty_1 = require("./CardSectionDataEmpty");
var CardSectionSubtitle_1 = require("./CardSectionSubtitle");
...
function CardSection() {
    ...
    var hasFailedLastBilling = (0, react_1.useMemo)(function () { var _a, _b; return ((_a = purchaseList === null || purchaseList === void 0 ? void 0 : purchaseList[0]) === null || _a === void 0 ? void 0 : _a.message.billingType) === CONST_1.default.BILLING.TYPE_STRIPE_FAILED_AUTHENTICATION || ((_b = purchaseList === null || purchaseList === void 0 ? void 0 : purchaseList[0]) === null || _b === void 0 ? void 0 : _b.message.billingType) === CONST_1.default.BILLING.TYPE_FAILED_2018; }, [purchaseList]);
    ...
    var _h = (0, react_1.useState)(function () {
        var _a;
        return utils_1.default.getBillingStatus({
            translate: translate,
    ...
    (0, react_1.useEffect)(function () {
        if (!authenticationLink || ((privateStripeCustomerID === null || privateStripeCustomerID === void 0 ? void 0 : privateStripeCustomerID.status) !== CONST_1.default.STRIPE_SCA_AUTH_STATUSES.CARD_AUTHENTICATION_REQUIRED && !hasFailedLastBilling)) {
            return;
        }
        Navigation_1.default.navigate(ROUTES_1.default.SETTINGS_SUBSCRIPTION_ADD_PAYMENT_CARD);
    }, [authenticationLink, privateStripeCustomerID === null || privateStripeCustomerID === void 0 ? void 0 : privateStripeCustomerID.status, hasFailedLastBilling]);
    ...
    var BillingBanner;
    if ((0, SubscriptionUtils_1.shouldShowDiscountBanner)(hasTeam2025Pricing, subscriptionPlan, firstDayFreeTrial, lastDayFreeTrial, userBillingFundID)) {
        BillingBanner = <EarlyDiscountBanner_1.default isSubscriptionPage/>;
    }
    else if ((0, SubscriptionUtils_1.shouldShowPreTrialBillingBanner)(introSelected, firstDayFreeTrial, lastDayFreeTrial)) {
        BillingBanner = <PreTrialBillingBanner_1.default />;
    }
    else if ((0, SubscriptionUtils_1.isUserOnFreeTrial)(firstDayFreeTrial, lastDayFreeTrial)) {
        BillingBanner = <TrialStartedBillingBanner_1.default />;
    }
    else if ((0, SubscriptionUtils_1.hasUserFreeTrialEnded)(lastDayFreeTrial)) {
                ...
                <react_native_1.View style={[styles.mt8, styles.mb3, styles.flexRow]}>
                    {!(0, EmptyObject_1.isEmptyObject)(defaultCard === null || defaultCard === void 0 ? void 0 : defaultCard.accountData) && (<react_native_1.View style={[styles.flexRow, styles.flex1, styles.gap3]}>
                            ...
                            <react_native_1.View style={styles.flex1}>
                                <Text_1.default style={styles.textStrong}>{(0, PaymentUtils_1.getPaymentMethodDescription)(defaultCard === null || defaultCard === void 0 ? void 0 : defaultCard.accountType, defaultCard === null || defaultCard === void 0 ? void 0 : defaultCard.accountData, translate)}</Text_1.default>
