...
function getBillingStatus(_a) {
    var _b, _c, _d, _e;
    var translate = _a.translate, stripeCustomerId = _a.stripeCustomerId, accountData = _a.accountData, purchase = _a.purchase, retryBillingSuccessful = _a.retryBillingSuccessful, billingDisputePending = _a.billingDisputePending, retryBillingFailed = _a.retryBillingFailed;
    ...
    var subscriptionStatus = (0, SubscriptionUtils_1.getSubscriptionStatus)(stripeCustomerId, retryBillingSuccessful, billingDisputePending, retryBillingFailed);
