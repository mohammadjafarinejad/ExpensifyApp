...
function RequestEarlyCancellationPage() {
    ...
    var workspacesListRoute = "".concat(environmentURL, "/").concat(ROUTES_1.default.WORKSPACES_LIST.route);
    ...
    var automaticCancellationContent = (0, react_1.useMemo)(function () { return (<react_native_1.View style={[styles.flexGrow1, styles.justifyContentBetween, styles.mh5]}>
                <react_native_1.View>
                    ...
                    <RenderHTML_1.default html={translate('subscription.requestEarlyCancellation.subscriptionCanceled.preventFutureActivity', { workspacesListRoute: workspacesListRoute })}/>
                </react_native_1.View>
                <FixedFooter_1.default style={styles.ph0}>
                    <Button_1.default success text={translate('common.done')} onPress={function () { return Navigation_1.default.goBack(); }} large/>
                </FixedFooter_1.default>
    ...
    var contentMap = (_a = {},
        ...
        _a[CONST_1.default.CANCELLATION_TYPE.NONE] = manualCancellationContent,
        _a);
    var screenContent = cancellationType ? contentMap[cancellationType] : surveyContent;
    return (<ScreenWrapper_1.default testID={RequestEarlyCancellationPage.displayName} includeSafeAreaPaddingBottom={false} shouldEnablePickerAvoiding={false} shouldEnableMaxHeight shouldShowOfflineIndicatorInWideScreen={!cancellationType}>
