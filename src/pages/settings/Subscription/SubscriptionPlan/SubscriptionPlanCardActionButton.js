...
function SubscriptionPlanCardActionButton(_a) {
    ...
    var _c = (0, react_1.useMemo)(function () {
        ...
        return [(0, PolicyUtils_1.isPolicyAdmin)(firstPolicy), firstPolicy];
    ...
    var handlePlanPress = function (planType) {
        ...
        if (planType === CONST_1.default.POLICY.TYPE.TEAM && (privateSubscription === null || privateSubscription === void 0 ? void 0 : privateSubscription.type) === CONST_1.default.SUBSCRIPTION.TYPE.ANNUAL && !(account === null || account === void 0 ? void 0 : account.canDowngrade)) {
