...
function SubscriptionSettings() {
    ...
    var _j = (0, react_1.useContext)(DelegateNoAccessModalProvider_1.DelegateNoAccessContext), isActingAsDelegate = _j.isActingAsDelegate, showDelegateNoAccessModal = _j.showDelegateNoAccessModal;
    ...
    var subscriptionPrice = (0, SubscriptionUtils_1.getSubscriptionPrice)(subscriptionPlan, preferredCurrency, privateSubscription === null || privateSubscription === void 0 ? void 0 : privateSubscription.type, hasTeam2025Pricing);
    ...
    return (<ScreenWrapper_1.default testID={SubscriptionSettings.displayName} shouldShowOfflineIndicatorInWideScreen>
            ...
            <ScrollView_1.default contentContainerStyle={[styles.flexGrow1, styles.ph5]}>
                ...
                {isAnnual ? (<>
                        ...
                        <OfflineWithFeedback_1.default pendingAction={(_g = privateSubscription === null || privateSubscription === void 0 ? void 0 : privateSubscription.pendingFields) === null || _g === void 0 ? void 0 : _g.addNewUsersAutomatically}>
                            <react_native_1.View style={styles.mt3}>
                                <ToggleSettingsOptionRow_1.default customTitle={customTitle} switchAccessibilityLabel={translate('subscription.subscriptionSettings.autoRenew')} onToggle={handleAutoIncreaseToggle} isActive={(_h = privateSubscription === null || privateSubscription === void 0 ? void 0 : privateSubscription.addNewUsersAutomatically) !== null && _h !== void 0 ? _h : false}/>
