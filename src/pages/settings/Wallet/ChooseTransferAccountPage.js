...
function ChooseTransferAccountPage() {
    var _a;
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.WALLET_TRANSFER, { canBeMissing: true }), walletTransfer = _b[0], walletTransferResult = _b[1];
    ...
    var selectAccountAndNavigateBack = function (accountType, account) {
        var _a, _b, _c;
        (0, PaymentMethods_1.saveWalletTransferAccountTypeAndID)(accountType !== null && accountType !== void 0 ? accountType : '', (_c = (accountType === CONST_1.default.PAYMENT_METHODS.PERSONAL_BANK_ACCOUNT ? (_a = account === null || account === void 0 ? void 0 : account.bankAccountID) === null || _a === void 0 ? void 0 : _a.toString() : (_b = account === null || account === void 0 ? void 0 : account.fundID) === null || _b === void 0 ? void 0 : _b.toString())) !== null && _c !== void 0 ? _c : '');
    ...
    return (<ScreenWrapper_1.default testID={ChooseTransferAccountPage.displayName}>
            ...
            <SelectionListWithSections_1.default sections={[{ data: data }]} ListItem={RadioListItem_1.default} onSelectRow={function (value) {
            var _a, _b;
