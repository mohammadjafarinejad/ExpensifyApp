...
function InternationalDepositAccountContent(_a) {
    ...
    var topmostFullScreenRoute = (0, useRootNavigationState_1.default)(function (state) { return state === null || state === void 0 ? void 0 : state.routes.findLast(function (route) { return (0, isNavigatorName_1.isFullScreenName)(route.name); }); });
    ...
    return (<ScreenWrapper_1.default shouldEnableMaxHeight testID={InternationalDepositAccountContent.displayName} forwardedFSClass={CONST_1.default.FULLSTORY.CLASS.MASK} shouldShowOfflineIndicatorInWideScreen={screenIndex === CONST_1.default.CORPAY_FIELDS.INDEXES.MAPPING.CONFIRMATION}>
