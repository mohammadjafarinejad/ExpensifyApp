...
function ReportCardLostPage(_a) {
    ...
    (0, react_1.useEffect)(function () {
        var newID = Object.keys(cardList !== null && cardList !== void 0 ? cardList : {}).find(function (cardKey) { var _a; return ((_a = cardList === null || cardList === void 0 ? void 0 : cardList[cardKey]) === null || _a === void 0 ? void 0 : _a.cardID) && !(cardKey in (previousCardList !== null && previousCardList !== void 0 ? previousCardList : {})); });
    ...
    return (<ScreenWrapper_1.default includeSafeAreaPaddingBottom testID={ReportCardLostPage.displayName} shouldShowOfflineIndicatorInWideScreen={!!isValidateCodeActionModalVisible}>
