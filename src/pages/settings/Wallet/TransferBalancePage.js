...
var TRANSFER_TIER_NAMES = new Set([CONST_1.default.WALLET.TIER_NAME.GOLD, CONST_1.default.WALLET.TIER_NAME.PLATINUM]);
function TransferBalancePage() {
    ...
    var walletTransfer = (0, useOnyx_1.default)(ONYXKEYS_1.default.WALLET_TRANSFER, { canBeMissing: true })[0];
    ...
    function navigateToChooseTransferAccount(filterPaymentMethodType) {
        ...
        var combinedPaymentMethods = (0, PaymentUtils_1.formatPaymentMethods)(bankAccountList !== null && bankAccountList !== void 0 ? bankAccountList : {}, paymentCardList, styles, translate);
    ...
    var shouldShowTransferView = (0, PaymentUtils_1.hasExpensifyPaymentMethod)(paymentCardList, bankAccountList !== null && bankAccountList !== void 0 ? bankAccountList : {}) && TRANSFER_TIER_NAMES.has((_c = userWallet === null || userWallet === void 0 ? void 0 : userWallet.tierName) !== null && _c !== void 0 ? _c : '');
    return (<ScreenWrapper_1.default testID={TransferBalancePage.displayName} shouldShowOfflineIndicatorInWideScreen>
            <FullPageNotFoundView_1.default shouldShow={!shouldShowTransferView} titleKey="notFound.pageNotFound" subtitleKey="transferAmountPage.notHereSubTitle" linkTranslationKey="transferAmountPage.goToWallet" onLinkPress={function () { return Navigation_1.default.goBack(ROUTES_1.default.SETTINGS_WALLET); }}>
