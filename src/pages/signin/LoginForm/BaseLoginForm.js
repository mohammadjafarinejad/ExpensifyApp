...
function BaseLoginForm(_a) {
    var _b;
    var _c = _a.blurOnSubmit, blurOnSubmit = _c === void 0 ? false : _c, isVisible = _a.isVisible, ref = _a.ref;
    ...
    var _g = (0, useResponsiveLayout_1.default)(), shouldUseNarrowLayout = _g.shouldUseNarrowLayout, isInNarrowPaneModal = _g.isInNarrowPaneModal;
    ...
    var validate = (0, react_1.useCallback)(function (value) {
        ...
        var phoneLogin = (0, LoginUtils_1.appendCountryCode)((0, LoginUtils_1.getPhoneNumberWithoutSpecialChars)(loginTrim), countryCode);
