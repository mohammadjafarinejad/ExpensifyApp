    ...
    return (<react_native_1.View style={containerStyles}>
            {!shouldUseNarrowLayout ? (<react_native_1.View style={contentContainerStyles}>
                    ...
                    <ScrollView_1.default style={[styles.flex1, StyleUtils.getBackgroundColorStyle(theme.signInPage)]} contentContainerStyle={[styles.flex1]} ref={scrollViewRef}>
                        <react_native_1.View style={[styles.flex1]}>
                            <react_native_1.View style={styles.signInPageHeroCenter}>
                                <BackgroundImage_1.default isSmallScreen={false} width={variables_1.default.signInHeroBackgroundWidth}/>
                            </react_native_1.View>
                            <react_native_1.View>
                ...
                isLargeScreenWidth ? styles.ph25 : {},
                    ...
                    <react_native_1.View style={[styles.flex1, styles.flexColumn, (0, Browser_1.isMobileSafari)() ? styles.overflowHidden : {}, StyleUtils.getMinimumHeight(backgroundImageHeight)]}>
                        <react_native_1.View style={[styles.pAbsolute, styles.b0, styles.w100, StyleUtils.getHeight(backgroundImageHeight), StyleUtils.getBackgroundColorStyle(theme.highlightBG)]}>
                            <BackgroundImage_1.default isSmallScreen width={variables_1.default.signInHeroBackgroundWidthMobile}/>
                        </react_native_1.View>
                        <SignInPageContent_1.default welcomeHeader={welcomeHeader} welcomeText={welcomeText} shouldShowWelcomeText={shouldShowWelcomeText} shouldShowWelcomeHeader={shouldShowWelcomeHeader}>
                            {children}
                        </SignInPageContent_1.default>
