...
function UnlinkLoginForm() {
    ...
    return (<>
        ...
        messages={{ 0: unlinkMessage }}/>)}
            {!!(account === null || account === void 0 ? void 0 : account.errors) && !(0, EmptyObject_1.isEmptyObject)(account.errors) && (<DotIndicatorMessage_1.default style={[styles.mb5]} type="error" messages={(0, ErrorUtils_1.getErrorsWithTranslationData)(account.errors)}/>)}
