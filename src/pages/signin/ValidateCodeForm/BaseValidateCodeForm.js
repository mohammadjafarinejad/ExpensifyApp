...
function BaseValidateCodeForm(_a) {
    ...
    var validateAndSubmitForm = (0, react_1.useCallback)(function () {
        ...
        if (accountID) {
            (0, Session_1.signInWithValidateCode)(accountID, validateCode, preferredLocale, recoveryCodeOr2faCode);
        }
        else {
            (0, Session_1.signIn)(validateCode, preferredLocale, recoveryCodeOr2faCode);
        }
    }, [
            ...
            {(account === null || account === void 0 ? void 0 : account.requiresTwoFactorAuth) && !!(credentials === null || credentials === void 0 ? void 0 : credentials.validateCode) ? (<react_native_1.View style={[styles.mv3]}>
                ...
                inputValidateCodeRef.current = magicCodeInput;
                    ...
                    <react_native_1.View style={[styles.alignItemsStart]}>
                        {timeRemaining > 0 && !isOffline ? (<react_native_1.View style={[styles.mt2, styles.flexRow, styles.renderHTML]}>
                    ...
                    timeRemaining: "00:".concat(String(timeRemaining).padStart(2, '0')),
                            ...
                            </react_native_1.View>) : (<PressableWithFeedback_1.default style={[styles.mt2]} onPress={resendValidateCode} disabled={shouldDisableResendValidateCode} hoverDimmingValue={1} pressDimmingValue={0.2} role={CONST_1.default.ROLE.BUTTON} accessibilityLabel={translate('validateCodeForm.magicCodeNotReceived')}>
...
exports.default = (0, withToggleVisibilityView_1.default)(BaseValidateCodeForm);
