...
function NewTaskDetailsPage(_a) {
    ...
    var parentReport = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(task === null || task === void 0 ? void 0 : task.parentReportID), { canBeMissing: true }, [task === null || task === void 0 ? void 0 : task.parentReportID])[0];
    ...
    var onSubmit = function (values) {
        ...
        if (skipConfirmation) {
            ...
            (0, Task_1.createTaskAndNavigate)({
                parentReportID: task === null || task === void 0 ? void 0 : task.parentReportID,
                title: values.taskTitle,
                description: (_a = values.taskDescription) !== null && _a !== void 0 ? _a : '',
