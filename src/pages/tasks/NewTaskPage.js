...
function NewTaskPage(_a) {
    ...
    var _e = (0, useLocalize_1.default)(), translate = _e.translate, formatPhoneNumber = _e.formatPhoneNumber, localeCompare = _e.localeCompare;
    ...
    var assigneeTooltipDetails = (0, ReportUtils_1.getDisplayNamesWithTooltips)((0, OptionsListUtils_1.getPersonalDetailsForAccountIDs)((task === null || task === void 0 ? void 0 : task.assigneeAccountID) ? [task.assigneeAccountID] : [], personalDetails), false, localeCompare);
    var shareDestination = (0, react_1.useMemo)(function () { return ((task === null || task === void 0 ? void 0 : task.shareDestination) ? (0, Task_1.getShareDestination)(task.shareDestination, reports, personalDetails, localeCompare) : undefined); }, [task === null || task === void 0 ? void 0 : task.shareDestination, reports, personalDetails, localeCompare]);
    ...
    var ancestors = (0, useAncestors_1.default)(parentReport);
    ...
    var onSubmit = function () {
        ...
        (0, Task_1.createTaskAndNavigate)({
            ...
            title: task.title,
            description: (_a = task === null || task === void 0 ? void 0 : task.description) !== null && _a !== void 0 ? _a : '',
            assigneeEmail: (_b = task === null || task === void 0 ? void 0 : task.assignee) !== null && _b !== void 0 ? _b : '',
            currentUserAccountID: currentUserPersonalDetails.accountID,
            currentUserEmail: (_c = currentUserPersonalDetails.email) !== null && _c !== void 0 ? _c : '',
            assigneeAccountID: task.assigneeAccountID,
            assigneeChatReport: task.assigneeChatReport,
            policyID: parentReport === null || parentReport === void 0 ? void 0 : parentReport.policyID,
