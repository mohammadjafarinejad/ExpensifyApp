...
var ACCESS_VARIANTS = (_a = {},
    ...
    _a[CONST_1.default.IOU.ACCESS_VARIANTS.CREATE] = function (policy, login, report, allPolicies, iouType, isReportArchived, isRestrictedToPreferredPolicy) {
        return !!iouType &&
            ...
            ((0, EmptyObject_1.isEmptyObject)(report === null || report === void 0 ? void 0 : report.reportID) || (0, ReportUtils_1.canCreateRequest)(report, policy, iouType, isReportArchived, isRestrictedToPreferredPolicy)) &&
...
function AccessOrNotFoundWrapper(_a) {
    ...
    var _d = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_LOADING_REPORT_DATA, { canBeMissing: true })[0], isLoadingReportData = _d === void 0 ? true : _d;
    var _e = (0, useCurrentUserPersonalDetails_1.default)().login, login = _e === void 0 ? '' : _e;
    ...
    var isPageAccessible = accessVariants.reduce(function (acc, variant) {
        ...
        if (variant === CONST_1.default.IOU.ACCESS_VARIANTS.CREATE) {
            return acc && accessFunction(policy, login, report, allPolicies !== null && allPolicies !== void 0 ? allPolicies : null, iouType, isReportArchived, isRestrictedToPreferredPolicy);
        }
        return acc && accessFunction(policy, login, report, allPolicies !== null && allPolicies !== void 0 ? allPolicies : null, iouType, isReportArchived);
    }, true);
    var isPolicyNotAccessible = !(0, PolicyUtils_1.isPolicyAccessible)(policy, login);
