...
function WorkspaceConfirmationPage() {
    ...
    var onSubmit = function (params) {
        ...
        (0, App_1.createWorkspaceWithPolicyDraftAndNavigateToIt)({
            ...
            lastUsedPaymentMethod: lastPaymentMethod === null || lastPaymentMethod === void 0 ? void 0 : lastPaymentMethod[policyID],
        });
    };
