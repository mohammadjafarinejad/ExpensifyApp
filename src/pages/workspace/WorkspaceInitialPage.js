...
function WorkspaceInitialPage(_a) {
    ...
    var expensifyIcons = (0, useLazyAsset_1.useMemoizedLazyExpensifyIcons)([
        'Building',
        'CalendarSolid',
        'Car',
        'Coins',
    ...
    var shouldShowEnterCredentialsError = (0, useGetReceiptPartnersIntegrationData_1.default)(policy === null || policy === void 0 ? void 0 : policy.id).shouldShowEnterCredentialsError;
    ...
    var isUberForBusinessEnabled = isBetaEnabled(CONST_1.default.BETAS.UBER_FOR_BUSINESS);
    ...
    var currentUserPolicyExpenseChatReportID = (_d = (0, ReportUtils_1.getPolicyExpenseChat)(accountID, policy === null || policy === void 0 ? void 0 : policy.id, allReports)) === null || _d === void 0 ? void 0 : _d.reportID;
    ...
    var policyFeatureStates = (0, react_1.useMemo)(function () {
        ...
        return (_a = {},
            ...
            _a[CONST_1.default.POLICY.MORE_FEATURES.ARE_RECEIPT_PARTNERS_ENABLED] = isUberForBusinessEnabled && ((_d = (_c = policy === null || policy === void 0 ? void 0 : policy.receiptPartners) === null || _c === void 0 ? void 0 : _c.enabled) !== null && _d !== void 0 ? _d : false),
            _a);
    ...
    var workspaceMenuItems = (0, react_1.useMemo)(function () {
        ...
        protectedMenuItems.push({
            ...
            action: singleExecution(waitForNavigate(function () { return Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_REPORTS.getRoute(policyID)); })),
        ...
        if (featureStates === null || featureStates === void 0 ? void 0 : featureStates[CONST_1.default.POLICY.MORE_FEATURES.ARE_RECEIPT_PARTNERS_ENABLED]) {
            protectedMenuItems.push({
                translationKey: 'workspace.common.receiptPartners',
                brickRoadIndicator: shouldShowEnterCredentialsError ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined,
                icon: expensifyIcons.Receipt,
                action: singleExecution(waitForNavigate(function () {
    ...
    var shouldShowPolicy = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.shouldShowPolicy)(policy, true, currentUserLogin); }, [policy, currentUserLogin]);
    ...
    (0, react_1.useEffect)(function () {
        if (!isFocused || (0, EmptyObject_1.isEmptyObject)(prevPolicy) || prevIsPendingDelete || !isPendingDelete) {
            return;
        }
        (0, PolicyUtils_1.goBackFromInvalidPolicy)();
    ...
    var policyAvatar = (0, react_1.useMemo)(function () {
        var _a;
        if (!policy) {
            return { source: expensifyIcons.ExpensifyAppIcon, name: CONST_1.default.EXPENSIFY_ICON_NAME, type: CONST_1.default.ICON_TYPE_AVATAR };
        }
    ...
    return (<ScreenWrapper_1.default testID={WorkspaceInitialPage.displayName} enableEdgeToEdgeBottomSafeAreaPadding={false} bottomContent={shouldShowNavigationTabBar &&
            !shouldDisplayLHB && (<NavigationTabBar_1.default selectedTab={NAVIGATION_TABS_1.default.WORKSPACES} shouldShowFloatingCameraButton={false}/>)}>
        ...
        */}
                    ...
                    {isPolicyExpenseChatEnabled && !!currentUserPolicyExpenseChatReportID && (<react_native_1.View style={[styles.pb4, styles.mh3, styles.mt3]}>
                            ...
                            <OfflineWithFeedback_1.default pendingAction={reportPendingAction} shouldShowErrorMessages={false}>
                                <MenuItem_1.default title={(0, ReportUtils_1.getReportName)(currentUserPolicyExpenseChat)} description={translate('workspace.common.workspace')} onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.REPORT_WITH_ID.getRoute(currentUserPolicyExpenseChat === null || currentUserPolicyExpenseChat === void 0 ? void 0 : currentUserPolicyExpenseChat.reportID)); }} shouldShowRightIcon wrapperStyle={[styles.br2, styles.pl2, styles.pr0, styles.pv3, styles.mt1, styles.alignItemsCenter]} iconReportID={currentUserPolicyExpenseChatReportID}/>
                            </OfflineWithFeedback_1.default>
                        </react_native_1.View>)}
