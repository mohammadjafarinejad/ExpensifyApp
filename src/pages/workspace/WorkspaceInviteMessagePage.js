...
function WorkspaceInviteMessagePage(_a) {
    ...
    var _c = (0, useOnyx_1.default)(ONYXKEYS_1.default.FORMS.WORKSPACE_INVITE_MESSAGE_FORM_DRAFT, { canBeMissing: true }), formData = _c[0], formDataResult = _c[1];
    ...
    var _d = (0, react_1.useState)(), welcomeNote = _d[0], setWelcomeNote = _d[1];
    var _e = (0, useAutoFocusInput_1.default)(), inputCallbackRef = _e.inputCallbackRef, inputRef = _e.inputRef;
    var _f = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.WORKSPACE_INVITE_MEMBERS_DRAFT).concat(route.params.policyID.toString()), {
        canBeMissing: true,
    }), invitedEmailsToAccountIDsDraft = _f[0], invitedEmailsToAccountIDsDraftResult = _f[1];
    var _g = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.WORKSPACE_INVITE_MESSAGE_DRAFT).concat(route.params.policyID.toString()), {
        canBeMissing: true,
    }), workspaceInviteMessageDraft = _g[0], workspaceInviteMessageDraftResult = _g[1];
    var _h = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.WORKSPACE_INVITE_ROLE_DRAFT).concat(route.params.policyID.toString()), { canBeMissing: true })[0], workspaceInviteRoleDraft = _h === void 0 ? CONST_1.default.POLICY.ROLE.USER : _h;
    ...
    var personalDetailsOfInvitedEmails = (0, OptionsListUtils_1.getPersonalDetailsForAccountIDs)(Object.values(invitedEmailsToAccountIDsDraft !== null && invitedEmailsToAccountIDsDraft !== void 0 ? invitedEmailsToAccountIDsDraft : {}), allPersonalDetails !== null && allPersonalDetails !== void 0 ? allPersonalDetails : {});
    var memberNames = Object.values(personalDetailsOfInvitedEmails)
        .map(function (personalDetail) {
        var _a;
        var displayName = (0, PersonalDetailsUtils_1.getDisplayNameOrDefault)(personalDetail, '', false);
        if (displayName) {
            return displayName;
        }
        ...
        var accountID = personalDetail.accountID;
        var loginFromInviteMap = (_a = Object.entries(invitedEmailsToAccountIDsDraft !== null && invitedEmailsToAccountIDsDraft !== void 0 ? invitedEmailsToAccountIDsDraft : {}).find(function (_a) {
            var id = _a[1];
            return id === accountID;
    ...
    return (<AccessOrNotFoundWrapper_1.default policyID={route.params.policyID} accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN]} fullPageNotFoundViewProps={{ subtitleKey: (0, EmptyObject_1.isEmptyObject)(policy) ? undefined : 'workspace.common.notAuthorized', onLinkPress: PolicyUtils_1.goBackFromInvalidPolicy }}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding testID={WorkspaceInviteMessagePage.displayName} shouldEnableMaxHeight style={{ marginTop: viewportOffsetTop }}>
                ...
                <FormProvider_1.default style={[styles.flexGrow1, styles.ph5]} formID={ONYXKEYS_1.default.FORMS.WORKSPACE_INVITE_MESSAGE_FORM} validate={validate} onSubmit={sendInvitation} submitButtonText={translate('common.invite')} enabledWhenOffline shouldHideFixErrorsAlert addBottomSafeAreaPadding>
            ...
            displayInRows: true,
                    ...
                    <react_native_1.View style={[styles.mb3]}>
                        <react_native_1.View style={[styles.mhn5, styles.mb3]}>
                            <MenuItemWithTopDescription_1.default title={memberNames} description={translate('common.members')} numberOfLinesTitle={2} shouldShowRightIcon onPress={function () {
            Navigation_1.default.goBack(route.params.backTo);
        }}/>
            ...
            Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_INVITE_MESSAGE_ROLE.getRoute(route.params.policyID, Navigation_1.default.getActiveRoute()));
                        ...
                        <react_native_1.View style={[styles.mb3]}>
                            <Text_1.default style={[styles.textSupportingNormal]}>{translate('workspace.inviteMessage.inviteMessagePrompt')}</Text_1.default>
                        </react_native_1.View>
            ...
            inputCallbackRef(element);
                        ...
                        <PressableWithoutFeedback_1.default onPress={openPrivacyURL} role={CONST_1.default.ROLE.LINK} accessibilityLabel={translate('common.privacy')} href={CONST_1.default.OLD_DOT_PUBLIC_URLS.PRIVACY_URL} style={[styles.mt6, styles.alignSelfStart]}>
