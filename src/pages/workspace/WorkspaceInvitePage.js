...
function WorkspaceInvitePage(_a) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (firstRenderRef.current) {
            ...
            Object.entries(invitedEmailsToAccountIDsDraft !== null && invitedEmailsToAccountIDsDraft !== void 0 ? invitedEmailsToAccountIDsDraft : {}).forEach(function (_a) {
                var login = _a[0], accountID = _a[1];
                if (login in detailsMap) {
                    newSelectedOptions.push(__assign(__assign({}, detailsMap[login]), { isSelected: true }));
                }
                else {
                    var optimisticOption = (0, OptionsListUtils_1.getUserToInviteOption)({
                        searchValue: login,
                    });
                    if (optimisticOption) {
                        optimisticOption.accountID = Number(accountID);
                        var memberOption = (0, OptionsListUtils_1.formatMemberForList)(__assign(__assign({}, optimisticOption), { accountID: Number(accountID), isSelected: true }));
    ...
    var _j = (0, react_1.useMemo)(function () { var _a; return [(_a = policy === null || policy === void 0 ? void 0 : policy.name) !== null && _a !== void 0 ? _a : '', !(0, EmptyObject_1.isEmptyObject)(policy === null || policy === void 0 ? void 0 : policy.errors) || !!(policy === null || policy === void 0 ? void 0 : policy.alertMessage)]; }, [policy]), policyName = _j[0], shouldShowAlertPrompt = _j[1];
