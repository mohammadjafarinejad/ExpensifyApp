...
function WorkspaceMemberDetailsRoleSelectionModal(_a) {
    ...
    return (<Modal_1.default type={CONST_1.default.MODAL.MODAL_TYPE.RIGHT_DOCKED} isVisible={isVisible} onClose={function () { return onClose === null || onClose === void 0 ? void 0 : onClose(); }} onModalHide={onClose} enableEdgeToEdgeBottomSafeAreaPadding>
            <ScreenWrapper_1.default testID={WorkspaceMemberDetailsRoleSelectionModal.displayName} includePaddingTop={false} enableEdgeToEdgeBottomSafeAreaPadding>
                ...
                <react_native_1.View style={[styles.containerWithSpaceBetween, styles.pointerEventsBoxNone]}>
                    <SelectionList_1.default data={items} ListItem={RadioListItem_1.default} onSelectRow={onRoleChange} shouldSingleExecuteRowSelect initiallyFocusedItemKey={(_b = items.find(function (item) { return item.isSelected; })) === null || _b === void 0 ? void 0 : _b.keyForList} addBottomSafeAreaPadding/>
                </react_native_1.View>
