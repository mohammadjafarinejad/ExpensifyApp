...
function WorkspaceNewRoomPage(_a) {
    var ref = _a.ref;
    var styles = (0, useThemeStyles_1.default)();
    var isFocused = (0, core_1.useIsFocused)();
    var _b = (0, useLocalize_1.default)(), translate = _b.translate, localeCompare = _b.localeCompare;
    var _c = (0, react_1.useState)(false), shouldEnableValidation = _c[0], setShouldEnableValidation = _c[1];
    ...
    var _d = (0, react_1.useState)(CONST_1.default.REPORT.VISIBILITY.RESTRICTED), visibility = _d[0], setVisibility = _d[1];
    var _e = (0, react_1.useState)(CONST_1.default.REPORT.WRITE_CAPABILITIES.ALL), writeCapability = _e[0], setWriteCapability = _e[1];
    ...
    var _f = (0, react_1.useState)(function () {
        ...
        return '';
    }), policyID = _f[0], setPolicyID = _f[1];
...
exports.default = WorkspaceNewRoomPage;
