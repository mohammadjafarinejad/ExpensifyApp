            ...
            <ScreenWrapper_1.default testID={WorkspaceOverviewPlanTypePage.displayName} shouldShowOfflineIndicatorInWideScreen enableEdgeToEdgeBottomSafeAreaPadding>
                ...
                {(policy === null || policy === void 0 ? void 0 : policy.isLoading) ? (<react_native_1.View style={styles.flex1}>
                    ...
                    annualSubscriptionEndDate: autoRenewalDate,
                        ...
                        <SelectionList_1.default data={workspacePlanTypes} isDisabled={isPlanTypeLocked} ListItem={RadioListItem_1.default} onSelectRow={function (option) {
                setCurrentPlan(option.value);
            }} rightHandSideComponent={isPlanTypeLocked ? lockedIcon : null} shouldUpdateFocusedIndex shouldSingleExecuteRowSelect shouldIgnoreFocus initiallyFocusedItemKey={(_c = workspacePlanTypes.find(function (mode) { return mode.isSelected; })) === null || _c === void 0 ? void 0 : _c.keyForList} addBottomSafeAreaPadding footerContent={<Button_1.default success large text={isPlanTypeLocked ? translate('common.buttonConfirm') : translate('common.save')} style={styles.mt6} onPress={handleUpdatePlan}/>}/>
                    </>)}
