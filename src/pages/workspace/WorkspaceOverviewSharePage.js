...
function WorkspaceOverviewSharePage(_a) {
    ...
    var urlWithTrailingSlash = (0, UrlUtils_1.default)(environmentURL);
    ...
    var adminRoomReportID = (0, react_1.useMemo)(function () {
        var _a, _b;
        if (!(policy === null || policy === void 0 ? void 0 : policy.id)) {
            return undefined;
        }
        return (_b = (_a = (0, ReportUtils_1.getRoom)(CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS, policy === null || policy === void 0 ? void 0 : policy.id)) === null || _a === void 0 ? void 0 : _a.reportID) !== null && _b !== void 0 ? _b : String(policy === null || policy === void 0 ? void 0 : policy.chatReportIDAdmins);
    }, [policy === null || policy === void 0 ? void 0 : policy.chatReportIDAdmins, policy === null || policy === void 0 ? void 0 : policy.id]);
    var adminsRoomLink = adminRoomReportID ? "".concat(urlWithTrailingSlash).concat(ROUTES_1.default.REPORT_WITH_ID.getRoute(adminRoomReportID)) : '';
                ...
                <ScrollView_1.default style={[styles.flex1, styles.pt3]} addBottomSafeAreaPadding>
                    <react_native_1.View style={[styles.flex1, shouldUseNarrowLayout ? styles.workspaceSectionMobile : styles.workspaceSection]}>
                        ...
                        <react_native_1.View style={[styles.renderHTML, styles.mh5, styles.mb9]}>
                            <RenderHTML_1.default html={translate('workspace.common.shareNote.content', { adminsRoomLink: adminsRoomLink })}/>
                        </react_native_1.View>
                        ...
                        <react_native_1.View style={[styles.mt3, styles.ph4]}>
                            <ContextMenuItem_1.default isAnonymousAction text={translate('qrCodes.copy')} icon={Expensicons.Copy} successIcon={Expensicons.Checkmark} successText={translate('qrCodes.copied')} onPress={function () { return Clipboard_1.default.setString(url); }} shouldLimitWidth={false} wrapperStyle={styles.sectionMenuItemTopDescription}/>
