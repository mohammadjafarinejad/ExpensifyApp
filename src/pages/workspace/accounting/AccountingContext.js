...
function AccountingContextProvider(_a) {
    ...
    var startIntegrationFlow = react_1.default.useCallback(function (newActiveIntegration) {
        ...
        var accountingIntegrationData = (0, utils_1.getAccountingIntegrationData)(newActiveIntegration.name, policyID, translate, undefined, undefined, newActiveIntegration.integrationToDisconnect, newActiveIntegration.shouldDisconnectIntegrationBeforeConnecting, undefined);
    ...
    return (<AccountingContext.Provider value={accountingContext}>
            ...
            {shouldShowConfirmationModal && (<AccountingConnectionConfirmationModal_1.default onConfirm={function () {
                ...
                (0, connections_1.removePolicyConnection)(policy, activeIntegration === null || activeIntegration === void 0 ? void 0 : activeIntegration.integrationToDisconnect);
