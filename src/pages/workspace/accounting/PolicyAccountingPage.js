...
function PolicyAccountingPage(_a) {
    ...
    var oldDotEnvironmentURL = (0, Environment_1.getOldDotURLFromEnvironment)(environment);
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['Accounting']);
    ...
    var hasUnsupportedNDIntegration = !(0, EmptyObject_1.isEmptyObject)(policy === null || policy === void 0 ? void 0 : policy.connections) && (0, PolicyUtils_1.hasSupportedOnlyOnOldDotIntegration)(policy);
    ...
    }, [account === null || account === void 0 ? void 0 : account.accountManagerAccountID, account === null || account === void 0 ? void 0 : account.accountManagerReportID, conciergeReportID, policy === null || policy === void 0 ? void 0 : policy.chatReportIDAdmins, translate]), chatTextLink = _o[0], chatReportID = _o[1];
    var oldDotPolicyConnectionsURL = policyID ? "".concat(oldDotEnvironmentURL, "/").concat(CONST_1.default.OLDDOT_URLS.POLICY_CONNECTIONS_URL_ENCODED(policyID)) : '';
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED}>
            ...
            {...menuItem}/>
                            ...
                            {hasUnsupportedNDIntegration && hasSyncError && !!policyID && (<FormHelpMessage_1.default isError style={styles.menuItemError} message={translate('workspace.accounting.errorODIntegration', { oldDotPolicyConnectionsURL: oldDotPolicyConnectionsURL })} shouldRenderMessageAsHTML/>)}
