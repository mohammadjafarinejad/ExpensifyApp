    ...
    var sections = (0, react_1.useMemo)(function () { return [
        {
            ...
            title: exportConfig === null || exportConfig === void 0 ? void 0 : exportConfig.exporter,
        ...
        },
        {
            ...
            title: (exportConfig === null || exportConfig === void 0 ? void 0 : exportConfig.exportDate) ? translate("workspace.sageIntacct.exportDate.values.".concat(exportConfig.exportDate, ".label")) : undefined,
        ...
        },
        {
            ...
            title: (exportConfig === null || exportConfig === void 0 ? void 0 : exportConfig.reimbursable) ? translate("workspace.sageIntacct.reimbursableExpenses.values.".concat(exportConfig.reimbursable)) : undefined,
        ...
        },
        {
            ...
            title: (exportConfig === null || exportConfig === void 0 ? void 0 : exportConfig.nonReimbursable) ? translate("workspace.sageIntacct.nonReimbursableExpenses.values.".concat(exportConfig.nonReimbursable)) : undefined,
            subscribedSettings: [
