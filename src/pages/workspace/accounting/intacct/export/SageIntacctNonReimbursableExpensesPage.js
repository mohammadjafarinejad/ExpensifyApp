...
function SageIntacctNonReimbursableExpensesPage(_a) {
    ...
    var menuItems = [
        {
            type: 'menuitem',
            title: (config === null || config === void 0 ? void 0 : config.export.nonReimbursable) ? translate("workspace.sageIntacct.nonReimbursableExpenses.values.".concat(config === null || config === void 0 ? void 0 : config.export.nonReimbursable)) : undefined,
        ...
        {
            type: 'menuitem',
            title: (config === null || config === void 0 ? void 0 : config.export.nonReimbursableAccount) ? config.export.nonReimbursableAccount : undefined,
