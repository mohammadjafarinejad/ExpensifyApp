...
function NetSuiteJournalEntryApprovalLevelSelectPage(_a) {
    var _b, _c, _d;
    ...
    var data = Object.values(CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL).map(function (approvalType) { return ({
        value: approvalType,
        text: translate("workspace.netsuite.advancedConfig.exportJournalsTo.values.".concat(approvalType)),
        keyForList: approvalType,
        isSelected: (config === null || config === void 0 ? void 0 : config.syncOptions.exportJournalsTo) === approvalType,
    }); });
