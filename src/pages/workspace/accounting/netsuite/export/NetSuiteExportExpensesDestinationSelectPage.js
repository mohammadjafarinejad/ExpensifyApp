...
function NetSuiteExportExpensesDestinationSelectPage(_a) {
    ...
    var selectDestination = (0, react_1.useCallback)(function (row, isWarningConfirmed) {
        if (row.value === currentDestination || !policyID) {
            goBack();
            return;
        }
        if (!isReimbursable && !isWarningConfirmed && row.value === CONST_1.default.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT && (policy === null || policy === void 0 ? void 0 : policy.areCompanyCardsEnabled)) {
