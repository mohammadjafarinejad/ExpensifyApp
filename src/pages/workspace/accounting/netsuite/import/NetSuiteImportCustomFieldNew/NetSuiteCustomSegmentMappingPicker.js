...
function NetSuiteCustomSegmentMappingPicker(_a) {
    ...
    return (<>
            <SelectionList_1.default data={selectionData} onSelectRow={function (selected) {
            onInputChange === null || onInputChange === void 0 ? void 0 : onInputChange(selected.value);
        }} ListItem={RadioListItem_1.default} initiallyFocusedItemKey={value !== null && value !== void 0 ? value : CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG} shouldSingleExecuteRowSelect shouldUpdateFocusedIndex/>
