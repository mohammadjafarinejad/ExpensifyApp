...
function NetSuiteImportAddCustomListContent(_a) {
    ...
    var handleFinishStep = (0, react_1.useCallback)(function () {
        ...
        react_native_1.InteractionManager.runAfterInteractions(function () {
            ...
            (0, NetSuiteCommands_1.updateNetSuiteCustomLists)(policyID, updatedCustomLists, customLists, "".concat(CONST_1.default.NETSUITE_CONFIG.IMPORT_CUSTOM_FIELDS.CUSTOM_LISTS, "_").concat(customLists.length), CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.ADD);
            (0, FormActions_1.clearDraftValues)(ONYXKEYS_1.default.FORMS.NETSUITE_CUSTOM_LIST_ADD_FORM);
