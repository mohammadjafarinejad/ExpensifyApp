...
function ConfirmCustomListStep(_a) {
    ...
    return (<react_native_1.View style={[styles.flex1, styles.mt3, bottomSafeAreaPaddingStyle]}>
            ...
            {fieldNames.map(function (fieldName, index) { return (<MenuItemWithTopDescription_1.default key={fieldName} description={translate("workspace.netsuite.import.importCustomFields.customLists.fields.".concat(fieldName))} title={fieldName === NetSuiteCustomFieldForm_1.default.MAPPING && values[fieldName]
