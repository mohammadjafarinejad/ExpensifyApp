...
function ConfirmCustomSegmentStep(_a) {
    ...
    return (<react_native_1.View style={[styles.flex1, bottomSafeAreaPaddingStyle]}>
            ...
            {fieldNames.map(function (fieldName, index) { return (<MenuItemWithTopDescription_1.default key={fieldName} description={translate("workspace.netsuite.import.importCustomFields.customSegments.fields.".concat(fieldName === NetSuiteCustomFieldForm_1.default.SCRIPT_ID && customSegmentType === CONST_1.default.NETSUITE_CUSTOM_RECORD_TYPES.CUSTOM_RECORD
