...
function RequireQuickBooksDesktopModal() {
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['LaptopWithSecondScreenX']);
            ...
            <react_native_1.View style={[styles.flex1]}>
                <react_native_1.View style={[styles.flex1, styles.justifyContentCenter, styles.ph5]}>
                    <react_native_1.View style={[styles.alignSelfCenter, styles.pendingStateCardIllustration]}>
                        <ImageSVG_1.default src={illustrations.LaptopWithSecondScreenX}/>
                    </react_native_1.View>
                ...
                <FixedFooter_1.default addBottomSafeAreaPadding>
                    <Button_1.default success text={translate('common.buttonConfirm')} onPress={function () { return Navigation_1.default.dismissModal(); }} pressOnEnter large/>
