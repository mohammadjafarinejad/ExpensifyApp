...
function QuickbooksDesktopNonReimbursableDefaultVendorSelectPage(_a) {
    ...
    var policyID = (_h = policy === null || policy === void 0 ? void 0 : policy.id) !== null && _h !== void 0 ? _h : CONST_1.default.DEFAULT_NUMBER_ID.toString();
    ...
    var selectVendor = (0, react_1.useCallback)(function (row) {
        if (row.value !== nonReimbursableBillDefaultVendor) {
            (0, QuickbooksDesktop_1.updateQuickbooksDesktopNonReimbursableBillDefaultVendor)(policyID, row.value, nonReimbursableBillDefaultVendor);
        }
        Navigation_1.default.goBack();
    }, [nonReimbursableBillDefaultVendor, policyID]);
    var listEmptyContent = (0, react_1.useMemo)(function () { return (<BlockingView_1.default icon={illustrations.Telescope} iconWidth={variables_1.default.emptyListIconWidth} iconHeight={variables_1.default.emptyListIconHeight} title={translate('workspace.qbd.noAccountsFound')} subtitle={translate('workspace.qbd.noAccountsFoundDescription')} containerStyle={styles.pb10}/>); }, [illustrations.Telescope, translate, styles.pb10]);
    return (<SelectionScreen_1.default policyID={policyID} accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.CONTROL]} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED} displayName={QuickbooksDesktopNonReimbursableDefaultVendorSelectPage.displayName} title="workspace.accounting.defaultVendor" sections={sections} listItem={RadioListItem_1.default} onSelectRow={selectVendor} shouldSingleExecuteRowSelect initiallyFocusedOptionKey={(_k = (_j = sections.at(0)) === null || _j === void 0 ? void 0 : _j.data.find(function (mode) { return mode.isSelected; })) === null || _k === void 0 ? void 0 : _k.keyForList} listEmptyContent={listEmptyContent} connectionName={CONST_1.default.POLICY.CONNECTIONS.NAME.QBD} onBackButtonPress={function () { return Navigation_1.default.goBack(); }} pendingAction={(0, PolicyUtils_1.settingsPendingAction)([CONST_1.default.QUICKBOOKS_DESKTOP_CONFIG.NON_REIMBURSABLE_BILL_DEFAULT_VENDOR], qbdConfig === null || qbdConfig === void 0 ? void 0 : qbdConfig.pendingFields)} errors={(0, ErrorUtils_1.getLatestErrorField)(qbdConfig, CONST_1.default.QUICKBOOKS_DESKTOP_CONFIG.NON_REIMBURSABLE_BILL_DEFAULT_VENDOR)} errorRowStyles={[styles.ph5, styles.pv3]} onClose={function () { return (0, Policy_1.clearQBDErrorField)(policyID, CONST_1.default.QUICKBOOKS_DESKTOP_CONFIG.NON_REIMBURSABLE_BILL_DEFAULT_VENDOR); }}/>);
}
