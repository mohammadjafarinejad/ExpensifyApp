...
function QuickbooksInvoiceAccountSelectPage(_a) {
    ...
    var _h = (_e = (_d = (_c = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _c === void 0 ? void 0 : _c.quickbooksOnline) === null || _d === void 0 ? void 0 : _d.data) !== null && _e !== void 0 ? _e : {}, bankAccounts = _h.bankAccounts, otherCurrentAssetAccounts = _h.otherCurrentAssetAccounts;
    var accountOptions = (0, react_1.useMemo)(function () { return __spreadArray(__spreadArray([], (bankAccounts !== null && bankAccounts !== void 0 ? bankAccounts : []), true), (otherCurrentAssetAccounts !== null && otherCurrentAssetAccounts !== void 0 ? otherCurrentAssetAccounts : []), true); }, [bankAccounts, otherCurrentAssetAccounts]);
    ...
    var qboOnlineSelectorOptions = (0, react_1.useMemo)(function () {
        return accountOptions === null || accountOptions === void 0 ? void 0 : accountOptions.map(function (_a) {
            ...
            return ({
                ...
                text: name,
                keyForList: id,
                isSelected: (qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.collectionAccountID) === id,
            });
        });
    }, [qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.collectionAccountID, accountOptions]);
    var listHeaderComponent = (0, react_1.useMemo)(function () { return (<react_native_1.View style={[styles.pb2, styles.ph5]}>
                <Text_1.default style={[styles.pb5, styles.textNormal]}>{translate('workspace.qbo.advancedConfig.invoiceAccountSelectorDescription')}</Text_1.default>
    ...
    var updateAccount = (0, react_1.useCallback)(function (_a) {
        var value = _a.value;
        (0, QuickbooksOnline_1.updateQuickbooksOnlineCollectionAccountID)(policyID, value, qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.collectionAccountID);
        Navigation_1.default.goBack(ROUTES_1.default.WORKSPACE_ACCOUNTING_QUICKBOOKS_ONLINE_ADVANCED.getRoute(policyID));
    }, [policyID, qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.collectionAccountID]);
    var listEmptyContent = (0, react_1.useMemo)(function () { return (<BlockingView_1.default icon={illustrations.Telescope} iconWidth={variables_1.default.emptyListIconWidth} iconHeight={variables_1.default.emptyListIconHeight} title={translate('workspace.qbo.noAccountsFound')} subtitle={translate('workspace.qbo.noAccountsFoundDescription')} containerStyle={styles.pb10}/>); }, [illustrations.Telescope, translate, styles.pb10]);
    return (<SelectionScreen_1.default policyID={policyID} accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED} displayName={QuickbooksInvoiceAccountSelectPage.displayName} sections={qboOnlineSelectorOptions.length ? [{ data: qboOnlineSelectorOptions }] : []} listItem={RadioListItem_1.default} headerContent={listHeaderComponent} onSelectRow={updateAccount} shouldSingleExecuteRowSelect initiallyFocusedOptionKey={initiallyFocusedOptionKey} listEmptyContent={listEmptyContent} title="workspace.qbo.advancedConfig.qboInvoiceCollectionAccount" connectionName={CONST_1.default.POLICY.CONNECTIONS.NAME.QBO} onBackButtonPress={function () { return Navigation_1.default.goBack(ROUTES_1.default.WORKSPACE_ACCOUNTING_QUICKBOOKS_ONLINE_ADVANCED.getRoute(policyID)); }} pendingAction={(0, PolicyUtils_1.settingsPendingAction)([CONST_1.default.QUICKBOOKS_CONFIG.COLLECTION_ACCOUNT_ID], qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.pendingFields)} errors={(0, ErrorUtils_1.getLatestErrorField)(qboConfig, CONST_1.default.QUICKBOOKS_CONFIG.COLLECTION_ACCOUNT_ID)} errorRowStyles={[styles.ph5, styles.mv3]} onClose={function () { return (0, Policy_1.clearQBOErrorField)(policyID, CONST_1.default.QUICKBOOKS_CONFIG.COLLECTION_ACCOUNT_ID); }}/>);
}
QuickbooksInvoiceAccountSelectPage.displayName = 'QuickbooksInvoiceAccountSelectPage';
exports.default = (0, withPolicyConnections_1.default)(QuickbooksInvoiceAccountSelectPage);
