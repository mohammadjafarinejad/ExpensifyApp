...
function QuickbooksCompanyCardExpenseAccountPage(_a) {
    ...
    var _j = (0, useAccordionAnimation_1.default)(!!(qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.autoCreateVendor)), isAccordionExpanded = _j.isAccordionExpanded, shouldAnimateAccordionSection = _j.shouldAnimateAccordionSection;
    var sections = [
        {
        ...
        {
            title: (_h = qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.nonReimbursableExpensesAccount) === null || _h === void 0 ? void 0 : _h.name,
