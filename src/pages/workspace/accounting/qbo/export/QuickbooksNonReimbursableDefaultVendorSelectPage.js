...
function QuickbooksNonReimbursableDefaultVendorSelectPage(_a) {
    ...
    var policyID = (_g = policy === null || policy === void 0 ? void 0 : policy.id) !== null && _g !== void 0 ? _g : CONST_1.default.DEFAULT_NUMBER_ID.toString();
    ...
    var selectVendor = (0, react_1.useCallback)(function (row) {
        if (row.value !== (qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.nonReimbursableBillDefaultVendor)) {
            (0, QuickbooksOnline_1.updateQuickbooksOnlineNonReimbursableBillDefaultVendor)(policyID, row.value, qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.nonReimbursableBillDefaultVendor);
        }
    ...
    return (<SelectionScreen_1.default policyID={policyID} accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN]} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED} displayName={QuickbooksNonReimbursableDefaultVendorSelectPage.displayName} title="workspace.accounting.defaultVendor" sections={sections} listItem={RadioListItem_1.default} onSelectRow={selectVendor} shouldSingleExecuteRowSelect initiallyFocusedOptionKey={(_j = (_h = sections.at(0)) === null || _h === void 0 ? void 0 : _h.data.find(function (mode) { return mode.isSelected; })) === null || _j === void 0 ? void 0 : _j.keyForList} listEmptyContent={listEmptyContent} connectionName={CONST_1.default.POLICY.CONNECTIONS.NAME.QBO} onBackButtonPress={function () { return Navigation_1.default.goBack(); }} pendingAction={(0, PolicyUtils_1.settingsPendingAction)([CONST_1.default.QUICKBOOKS_CONFIG.NON_REIMBURSABLE_BILL_DEFAULT_VENDOR], qboConfig === null || qboConfig === void 0 ? void 0 : qboConfig.pendingFields)} errors={(0, ErrorUtils_1.getLatestErrorField)(qboConfig, CONST_1.default.QUICKBOOKS_CONFIG.NON_REIMBURSABLE_BILL_DEFAULT_VENDOR)} errorRowStyles={[styles.ph5, styles.pv3]} onClose={function () { return (0, Policy_1.clearQBOErrorField)(policyID, CONST_1.default.QUICKBOOKS_CONFIG.NON_REIMBURSABLE_BILL_DEFAULT_VENDOR); }}/>);
}
