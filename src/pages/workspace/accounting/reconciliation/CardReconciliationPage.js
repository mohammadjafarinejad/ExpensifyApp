    ...
    var accountingAdvancedSettingsLink = (0, react_1.useMemo)(function () {
        ...
        switch (connection) {
            ...
            case CONST_1.default.POLICY.CONNECTIONS.ROUTE.SAGE_INTACCT:
                return "".concat(environmentURL, "/").concat(ROUTES_1.default.POLICY_ACCOUNTING_CARD_RECONCILIATION_SAGE_INTACCT_AUTO_SYNC.getRoute(policyID));
            case CONST_1.default.POLICY.CONNECTIONS.ROUTE.QBD:
                return "".concat(environmentURL, "/").concat(ROUTES_1.default.POLICY_ACCOUNTING_CARD_RECONCILIATION_QUICKBOOKS_DESKTOP_AUTO_SYNC.getRoute(policyID));
            default:
                return '';
        }
