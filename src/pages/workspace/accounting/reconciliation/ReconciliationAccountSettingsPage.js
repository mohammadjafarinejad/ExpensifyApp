...
function ReconciliationAccountSettingsPage(_a) {
    ...
    var options = (0, react_1.useMemo)(function () {
        ...
        return eligibleBankAccounts.map(function (bankAccount, index) {
            var _a, _b, _c, _d, _e;
            return ({
                text: bankAccount.title,
                value: (_a = bankAccount.accountData) === null || _a === void 0 ? void 0 : _a.bankAccountID,
                keyForList: (_d = (_c = (_b = bankAccount.accountData) === null || _b === void 0 ? void 0 : _b.bankAccountID) === null || _c === void 0 ? void 0 : _c.toString()) !== null && _d !== void 0 ? _d : "".concat(bankAccount.title, "-").concat(index),
                isSelected: ((_e = bankAccount.accountData) === null || _e === void 0 ? void 0 : _e.bankAccountID) === paymentBankAccountID,
            });
        });
    }, [bankAccountList, paymentBankAccountID]);
    var goBack = (0, react_1.useCallback)(function () {
        Navigation_1.default.goBack(backTo !== null && backTo !== void 0 ? backTo : ROUTES_1.default.WORKSPACE_ACCOUNTING_CARD_RECONCILIATION.getRoute(policyID, connection));
    ...
    return (<ConnectionLayout_1.default displayName={ReconciliationAccountSettingsPage.displayName} headerTitle="workspace.accounting.reconciliationAccount" accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED} contentContainerStyle={[styles.flex1, styles.pb2]} connectionName={connectionName} shouldUseScrollView={false} onBackButtonPress={goBack}>
            ...
            <Text_1.default style={[styles.textNormal, styles.mb6, styles.ph5]}>
                <RenderHTML_1.default html={translate('workspace.accounting.chooseReconciliationAccount.settlementAccountReconciliation', {
            settlementAccountUrl: "".concat(environmentURL, "/").concat(ROUTES_1.default.WORKSPACE_EXPENSIFY_CARD_SETTINGS_ACCOUNT.getRoute(policyID, Navigation_1.default.getActiveRoute())),
            lastFourPAN: settlementAccountEnding,
        })}/>
            </Text_1.default>

            <SelectionList_1.default data={options} onSelectRow={function (_a) {
        var value = _a.value;
        return selectBankAccount(value);
    }} ListItem={RadioListItem_1.default} initiallyFocusedItemKey={paymentBankAccountID === null || paymentBankAccountID === void 0 ? void 0 : paymentBankAccountID.toString()}/>
