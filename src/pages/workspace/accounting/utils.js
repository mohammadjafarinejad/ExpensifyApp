...
var isMobile = [CONST_1.default.PLATFORM.MOBILE_WEB, CONST_1.default.PLATFORM.IOS, CONST_1.default.PLATFORM.ANDROID].some(function (value) { return value === platform; });
    ...
    switch (connectionName) {
        ...
        case CONST_1.default.POLICY.CONNECTIONS.NAME.QBD:
            return {
                ...
                onCardReconciliationPagePress: function () { return Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_ACCOUNTING_CARD_RECONCILIATION.getRoute(policyID, CONST_1.default.POLICY.CONNECTIONS.ROUTE.QBD)); },
...
function getSynchronizationErrorMessage(policy, connectionName, isSyncInProgress, translate, styles) {
    ...
    if ((0, connections_1.isAuthenticationError)(policy, connectionName)) {
        return (<Text_1.default style={[styles === null || styles === void 0 ? void 0 : styles.formError]}>
                ...
                {connectionName in CONST_1.default.POLICY.CONNECTIONS.AUTH_HELP_LINKS && (<>
                        <TextLink_1.default style={[styles === null || styles === void 0 ? void 0 : styles.link, styles === null || styles === void 0 ? void 0 : styles.fontSizeLabel]} href={CONST_1.default.POLICY.CONNECTIONS.AUTH_HELP_LINKS[connectionName]}>
    ...
    var syncError = translate('workspace.accounting.syncError', { connectionName: connectionName });
