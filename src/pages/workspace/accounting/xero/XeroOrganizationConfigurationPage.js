...
function XeroOrganizationConfigurationPage(_a) {
    ...
    var policyID = (_d = policy === null || policy === void 0 ? void 0 : policy.id) !== null && _d !== void 0 ? _d : CONST_1.default.DEFAULT_NUMBER_ID.toString();
    ...
    var saveSelection = function (_a) {
        ...
        (0, Xero_1.updateXeroTenantID)(policyID, keyForList, xeroConfig === null || xeroConfig === void 0 ? void 0 : xeroConfig.tenantID);
