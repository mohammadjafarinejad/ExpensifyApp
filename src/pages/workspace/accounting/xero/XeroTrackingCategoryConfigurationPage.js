...
function XeroTrackingCategoryConfigurationPage(_a) {
    ...
    var menuItems = (0, react_1.useMemo)(function () {
        var trackingCategories = (0, Xero_1.getTrackingCategories)(policy);
        return trackingCategories.map(function (category) {
            var decodedCategoryName = (0, CategoryUtils_1.getDecodedCategoryName)(category.name);
            return {
                id: category.id,
                description: translate('workspace.xero.mapTrackingCategoryTo', { categoryName: decodedCategoryName }),
