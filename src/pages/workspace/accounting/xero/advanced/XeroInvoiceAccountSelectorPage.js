...
function XeroInvoiceAccountSelectorPage(_a) {
    ...
    var _h = (_g = (_f = (_e = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _e === void 0 ? void 0 : _e.xero) === null || _f === void 0 ? void 0 : _f.config.sync) !== null && _g !== void 0 ? _g : {}, invoiceCollectionsAccountID = _h.invoiceCollectionsAccountID, syncReimbursedReports = _h.syncReimbursedReports;
    var xeroSelectorOptions = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.getXeroBankAccounts)(policy !== null && policy !== void 0 ? policy : undefined, invoiceCollectionsAccountID); }, [invoiceCollectionsAccountID, policy]);
