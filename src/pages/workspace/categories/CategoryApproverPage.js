...
function CategoryApproverPage(_a) {
    ...
    var selectedApprover = (_e = (_d = (0, CategoryUtils_1.getCategoryApproverRule)((_c = (_b = policy === null || policy === void 0 ? void 0 : policy.rules) === null || _b === void 0 ? void 0 : _b.approvalRules) !== null && _c !== void 0 ? _c : [], categoryName)) === null || _d === void 0 ? void 0 : _d.approver) !== null && _e !== void 0 ? _e : '';
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.CONTROL]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CATEGORIES_ENABLED}>
            ...
            var _a, _b;
            (0, Category_1.setPolicyCategoryApprover)(policyID, categoryName, email, (_b = (_a = policy === null || policy === void 0 ? void 0 : policy.rules) === null || _a === void 0 ? void 0 : _a.approvalRules) !== null && _b !== void 0 ? _b : []);
