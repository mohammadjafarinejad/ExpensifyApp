...
function CategoryDefaultTaxRatePage(_a) {
    ...
    var selectedTaxRate = (0, CategoryUtils_1.getCategoryDefaultTaxRate)((_c = (_b = policy === null || policy === void 0 ? void 0 : policy.rules) === null || _b === void 0 ? void 0 : _b.expenseRules) !== null && _c !== void 0 ? _c : [], categoryName, (_d = policy === null || policy === void 0 ? void 0 : policy.taxRates) === null || _d === void 0 ? void 0 : _d.defaultExternalID);
    var textForDefault = (0, react_1.useCallback)(function (taxID, taxRate) { return (0, CategoryUtils_1.formatDefaultTaxRateText)(translate, taxID, taxRate, policy === null || policy === void 0 ? void 0 : policy.taxRates); }, [policy === null || policy === void 0 ? void 0 : policy.taxRates, translate]);
    var taxesList = (0, react_1.useMemo)(function () {
        ...
        return Object.entries((_b = (_a = policy.taxRates) === null || _a === void 0 ? void 0 : _a.taxes) !== null && _b !== void 0 ? _b : {})
            ...
            .sort(function (a, b) { var _a, _b, _c, _d; return localeCompare((_b = (_a = a.text) !== null && _a !== void 0 ? _a : a.keyForList) !== null && _b !== void 0 ? _b : '', (_d = (_c = b.text) !== null && _c !== void 0 ? _c : b.keyForList) !== null && _d !== void 0 ? _d : ''); });
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.CONTROL]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_CATEGORIES_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding style={[styles.defaultModalContainer]} testID={CategoryDefaultTaxRatePage.displayName} shouldEnableMaxHeight>
                ...
                <SelectionList_1.default data={taxesList} ListItem={RadioListItem_1.default} onSelectRow={handleSelectRow} shouldSingleExecuteRowSelect addBottomSafeAreaPadding initiallyFocusedItemKey={selectedTaxRate} style={{ containerStyle: styles.pt3 }}/>
