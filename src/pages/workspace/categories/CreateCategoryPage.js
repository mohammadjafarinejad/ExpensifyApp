...
function CreateCategoryPage(_a) {
    ...
    var _c = (0, useOnboardingTaskInformation_1.default)(CONST_1.default.ONBOARDING_TASK_TYPE.SETUP_CATEGORIES), setupCategoryTaskReport = _c.taskReport, setupCategoryTaskParentReport = _c.taskParentReport, isSetupCategoryTaskParentReportArchived = _c.isOnboardingTaskParentReportArchived;
    var createCategory = (0, react_1.useCallback)(function (values) {
        (0, Category_1.createPolicyCategory)(route.params.policyID, values.categoryName.trim(), isSetupCategoryTaskParentReportArchived, setupCategoryTaskReport, setupCategoryTaskParentReport, currentUserPersonalDetails.accountID);
