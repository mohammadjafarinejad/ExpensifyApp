...
function EditCategoryPage(_a) {
    var route = _a.route;
    var _b = route.params, backTo = _b.backTo, policyID = _b.policyID, currentCategoryName = _b.categoryName;
    var policyData = (0, usePolicyData_1.default)(policyID);
    var policyCategories = policyData.categories;
    ...
    var editCategory = (0, react_1.useCallback)(function (values) {
        ...
        if (currentCategoryName !== newCategoryName) {
            (0, Category_1.renamePolicyCategory)(policyData, { oldName: currentCategoryName, newName: values.categoryName });
        }
