...
function ExpenseLimitTypeSelectorModal(_a) {
    ...
    return (<Modal_1.default type={CONST_1.default.MODAL.MODAL_TYPE.RIGHT_DOCKED} isVisible={isVisible} onClose={onClose} onModalHide={onClose} enableEdgeToEdgeBottomSafeAreaPadding>
            <ScreenWrapper_1.default style={[styles.pb0]} includePaddingTop={false} enableEdgeToEdgeBottomSafeAreaPadding testID={ExpenseLimitTypeSelectorModal.displayName}>
                ...
                <SelectionList_1.default data={expenseLimitTypes} ListItem={RadioListItem_1.default} onSelectRow={function (item) { return onExpenseLimitTypeSelected(item.value); }} shouldSingleExecuteRowSelect style={{ containerStyle: [styles.pt3] }} initiallyFocusedItemKey={currentExpenseLimitType} alternateNumberOfSupportedLines={3} addBottomSafeAreaPadding/>
