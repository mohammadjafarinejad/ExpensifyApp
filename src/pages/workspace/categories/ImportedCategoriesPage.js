...
function ImportedCategoriesPage(_a) {
    ...
    var _e = (0, react_1.useState)(false), isImportingCategories = _e[0], setIsImportingCategories = _e[1];
    ...
    return (<ScreenWrapper_1.default testID={ImportedCategoriesPage.displayName} enableEdgeToEdgeBottomSafeAreaPadding shouldShowOfflineIndicatorInWideScreen>
