...
function WorkspaceCompanyCardDetailsPage(_a) {
    ...
    var updateCard = function () {
        (0, CompanyCards_1.updateWorkspaceCompanyCard)(domainOrWorkspaceAccountID, cardID, bank, card === null || card === void 0 ? void 0 : card.lastScrapeResult);
    };
    ...
    return (<AccessOrNotFoundWrapper_1.default policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_COMPANY_CARDS_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding testID={WorkspaceCompanyCardDetailsPage.displayName}>
                ...
                (0, CompanyCards_1.clearCompanyCardErrorField)(domainOrWorkspaceAccountID, cardID, bank, exportMenuItem.exportType);
                            ...
                            <MenuItemWithTopDescription_1.default description={exportMenuItem.description} title={exportMenuItem.title} shouldShowRightIcon onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_COMPANY_CARD_EXPORT.getRoute(policyID, cardID, bank, backTo)); }}/>
                        </OfflineWithFeedback_1.default>) : null}
                    <MenuItemWithTopDescription_1.default shouldShowRightComponent={card === null || card === void 0 ? void 0 : card.isLoadingLastUpdated} rightComponent={<ActivityIndicator_1.default style={[styles.popoverMenuIcon]}/>} description={translate('workspace.moreFeatures.companyCards.lastUpdated')} title={(card === null || card === void 0 ? void 0 : card.isLoadingLastUpdated) ? translate('workspace.moreFeatures.companyCards.updating') : lastScrape} interactive={false}/>
