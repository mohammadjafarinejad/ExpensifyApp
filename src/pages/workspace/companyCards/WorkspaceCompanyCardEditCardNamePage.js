...
function WorkspaceCompanyCardEditCardNamePage(_a) {
    var route = _a.route;
    var _b = route.params, policyID = _b.policyID, cardID = _b.cardID;
    var workspaceAccountID = (0, useWorkspaceAccountID_1.default)(policyID);
    var bank = decodeURIComponent(route.params.bank);
    var _c = (0, useOnyx_1.default)(ONYXKEYS_1.default.NVP_EXPENSIFY_COMPANY_CARDS_CUSTOM_NAMES, { canBeMissing: true }), customCardNames = _c[0], customCardNamesMetadata = _c[1];
    var defaultValue = customCardNames === null || customCardNames === void 0 ? void 0 : customCardNames[cardID];
