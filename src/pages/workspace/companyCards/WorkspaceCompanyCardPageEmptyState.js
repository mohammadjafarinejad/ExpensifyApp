...
function WorkspaceCompanyCardPageEmptyState(_a) {
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['CreditCardsNew', 'HandCard', 'MagnifyingGlassMoney', 'CompanyCardsEmptyState']);
    var companyCardFeatures = (0, react_1.useMemo)(function () {
        var features = [
            {
