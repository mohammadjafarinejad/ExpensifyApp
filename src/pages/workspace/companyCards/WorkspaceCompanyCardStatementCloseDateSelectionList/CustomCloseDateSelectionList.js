...
function CustomCloseDateSelectionList(_a) {
    ...
    var _e = (0, react_1.useMemo)(function () {
        ...
        return {
            sections: [{ data: data, indexOffset: 0 }],
            headerMessage: data.length === 0 ? translate('common.noResultsFound') : undefined,
        };
    }, [selectedDay, debouncedSearchValue, translate]), sections = _e.sections, headerMessage = _e.headerMessage;
