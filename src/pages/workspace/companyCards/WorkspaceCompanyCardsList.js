...
function WorkspaceCompanyCardsList(_a) {
    ...
    var _c = (0, useSearchResults_1.default)(allCards, filterCard, sortCards), inputValue = _c[0], setInputValue = _c[1], filteredSortedCards = _c[2];
    var renderItem = (0, react_1.useCallback)(function (_a) {
        ...
        return (<OfflineWithFeedback_1.default key={"".concat((_b = item.nameValuePairs) === null || _b === void 0 ? void 0 : _b.cardTitle, "_").concat(index)} errorRowStyles={styles.ph5} errors={item.errors} pendingAction={item.pendingAction}>
                ...
                return (<WorkspaceCompanyCardsListRow_1.default cardholder={personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails[(_b = item.accountID) !== null && _b !== void 0 ? _b : CONST_1.default.DEFAULT_NUMBER_ID]} cardNumber={(_c = item.lastFourPAN) !== null && _c !== void 0 ? _c : ''} name={(_d = customCardNames === null || customCardNames === void 0 ? void 0 : customCardNames[item.cardID]) !== null && _d !== void 0 ? _d : (0, CardUtils_1.getDefaultCardName)((_f = personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails[(_e = item.accountID) !== null && _e !== void 0 ? _e : CONST_1.default.DEFAULT_NUMBER_ID]) === null || _f === void 0 ? void 0 : _f.firstName)} isHovered={hovered}/>);
            }}
    ...
    var renderListHeader = (<>
            ...
            {!isSearchEmpty && (<react_native_1.View style={[styles.flexRow, styles.appBG, styles.justifyContentBetween, styles.mh5, styles.gap5, styles.p4]}>
                    ...
                    <Text_1.default numberOfLines={1} style={[styles.textMicroSupporting, styles.lh16, styles.mr7]}>
