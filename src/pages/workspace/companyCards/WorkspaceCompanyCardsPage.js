...
function WorkspaceCompanyCardsPage(_a) {
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['CompanyCard']);
    ...
    var workspaceCardFeeds = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.WORKSPACE_CARDS_LIST), { canBeMissing: true })[0];
    ...
    var _e = (0, useOnyx_1.default)(ONYXKEYS_1.default.CURRENCY_LIST, { canBeMissing: true })[0], currencyList = _e === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _e;
    ...
    var filteredCardList = (0, CardUtils_1.getFilteredCardList)(cardsList, selectedFeed ? (_d = (_c = cardFeeds === null || cardFeeds === void 0 ? void 0 : cardFeeds.settings) === null || _c === void 0 ? void 0 : _c.oAuthAccountDetails) === null || _d === void 0 ? void 0 : _d[selectedFeed] : undefined, workspaceCardFeeds);
    ...
    var isAllowedToIssueCompanyCard = (0, useIsAllowedToIssueCompanyCard_1.default)({ policyID: policyID });
    ...
    var handleAssignCard = function () {
        ...
        var selectedFeedCompanyCardsData = selectedFeed ? (_c = (_b = cardFeeds === null || cardFeeds === void 0 ? void 0 : cardFeeds.settings) === null || _b === void 0 ? void 0 : _b.companyCards) === null || _c === void 0 ? void 0 : _c[selectedFeed] : undefined;
        var selectedFeedOAuthData = selectedFeed ? (_e = (_d = cardFeeds === null || cardFeeds === void 0 ? void 0 : cardFeeds.settings) === null || _d === void 0 ? void 0 : _d.oAuthAccountDetails) === null || _e === void 0 ? void 0 : _e[selectedFeed] : undefined;
        var isFeedExpired = (0, CardUtils_1.isSelectedFeedExpired)(selectedFeedOAuthData);
        var plaidAccessToken = selectedFeedCompanyCardsData === null || selectedFeedCompanyCardsData === void 0 ? void 0 : selectedFeedCompanyCardsData.plaidAccessToken;
        // Refetch plaid card list
        if (!isFeedExpired && plaidAccessToken) {
            var country = (_f = selectedFeedCompanyCardsData === null || selectedFeedCompanyCardsData === void 0 ? void 0 : selectedFeedCompanyCardsData.country) !== null && _f !== void 0 ? _f : '';
            (0, Plaid_1.importPlaidAccounts)('', selectedFeed, '', country, (0, PolicyUtils_1.getDomainNameForPolicy)(policyID), '', undefined, undefined, plaidAccessToken);
        }
        if (employeeList.length === 1) {
            var userEmail = (_h = Object.keys((_g = policy === null || policy === void 0 ? void 0 : policy.employeeList) !== null && _g !== void 0 ? _g : {}).at(0)) !== null && _h !== void 0 ? _h : '';
    ...
    return (<AccessOrNotFoundWrapper_1.default policyID={route.params.policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_COMPANY_CARDS_ENABLED}>
            ...
            {!isLoading && (<WorkspacePageWithSections_1.default shouldUseScrollView={isNoFeed} icon={illustrations.CompanyCard} headerText={translate('workspace.common.companyCards')} route={route} shouldShowOfflineIndicatorInWideScreen showLoadingAsFirstRender={false} addBottomSafeAreaPadding>
                    ...
                    {isFeedAdded && !isPending && (<WorkspaceCompanyCardsList_1.default cardsList={cardsList} shouldShowGBDisclaimer={shouldShowGBDisclaimer} policyID={policyID} handleAssignCard={handleAssignCard} isDisabledAssignCardButton={!selectedFeedData || isFeedConnectionBroken || !isAllowedToIssueCompanyCard}/>)}
