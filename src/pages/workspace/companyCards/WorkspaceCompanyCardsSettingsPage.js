...
function WorkspaceCompanyCardsSettingsPage(_a) {
    ...
    var _f = (0, react_1.useState)(false), deleteCompanyCardConfirmModalVisible = _f[0], setDeleteCompanyCardConfirmModalVisible = _f[1];
    ...
    var statementCloseDate = (0, react_1.useMemo)(function () {
        if (!(selectedFeedData === null || selectedFeedData === void 0 ? void 0 : selectedFeedData.statementPeriodEndDay)) {
            return undefined;
        }
        if (typeof (selectedFeedData === null || selectedFeedData === void 0 ? void 0 : selectedFeedData.statementPeriodEndDay) === 'number') {
            return selectedFeedData.statementPeriodEndDay;
        }
        return translate("workspace.companyCards.statementCloseDate.".concat(selectedFeedData.statementPeriodEndDay));
    }, [translate, selectedFeedData === null || selectedFeedData === void 0 ? void 0 : selectedFeedData.statementPeriodEndDay]);
    ...
    var navigateToChangeStatementCloseDate = function () {
    ...
    var deleteCompanyCardFeed = function () {
        ...
        if (selectedFeed) {
            ...
            var feedToOpen_1 = Object.keys(companyFeeds).find(function (feed) { var _a; return feed !== selectedFeed && ((_a = companyFeeds[feed]) === null || _a === void 0 ? void 0 : _a.pendingAction) !== CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE; });
            ...
            <ScreenWrapper_1.default testID={WorkspaceCompanyCardsSettingsPage.displayName} style={styles.defaultModalContainer} enableEdgeToEdgeBottomSafeAreaPadding>
                <ScrollView_1.default contentContainerStyle={styles.flexGrow1} addBottomSafeAreaPadding>
                    ...
                    <react_native_1.View style={styles.flex1}>
                        ...
                        <OfflineWithFeedback_1.default pendingAction={(_d = selectedFeedData === null || selectedFeedData === void 0 ? void 0 : selectedFeedData.pendingFields) === null || _d === void 0 ? void 0 : _d.statementPeriodEndDay}>
                            <MenuItemWithTopDescription_1.default shouldShowRightIcon title={statementCloseDate === null || statementCloseDate === void 0 ? void 0 : statementCloseDate.toString()} description={translate('workspace.moreFeatures.companyCards.statementCloseDateTitle')} style={[styles.moneyRequestMenuItem]} titleStyle={styles.flex1} onPress={navigateToChangeStatementCloseDate} brickRoadIndicator={((_e = selectedFeedData === null || selectedFeedData === void 0 ? void 0 : selectedFeedData.errorFields) === null || _e === void 0 ? void 0 : _e.statementPeriodEndDay) ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined}/>
