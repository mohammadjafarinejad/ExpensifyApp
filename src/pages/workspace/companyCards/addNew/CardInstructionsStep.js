...
function CardInstructionsStep(_a) {
    ...
    return (<ScreenWrapper_1.default testID={CardInstructionsStep.displayName} shouldEnablePickerAvoiding={false} shouldEnableMaxHeight enableEdgeToEdgeBottomSafeAreaPadding shouldShowOfflineIndicatorInWideScreen>
