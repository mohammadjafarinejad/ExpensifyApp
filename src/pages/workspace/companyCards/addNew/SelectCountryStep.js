...
function SelectCountryStep(_a) {
    ...
    var _b = (0, useOnyx_1.default)(ONYXKEYS_1.default.CURRENCY_LIST, { canBeMissing: true })[0], currencyList = _b === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _b;
