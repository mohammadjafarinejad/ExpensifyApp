...
function SelectFeedType() {
    ...
    return (<ScreenWrapper_1.default testID={SelectFeedType.displayName} enableEdgeToEdgeBottomSafeAreaPadding shouldEnablePickerAvoiding={false} shouldEnableMaxHeight>
            ...
            <react_native_1.View style={[styles.renderHTML, styles.flexRow, styles.ph5, styles.mb6]}>
                <RenderHTML_1.default html={translate('workspace.companyCards.addNewCard.learnMoreAboutOptions')}/>
            </react_native_1.View>

            <SelectionListWithSections_1.default ListItem={RadioListItem_1.default} onSelectRow={function (_a) {
            var value = _a.value;
