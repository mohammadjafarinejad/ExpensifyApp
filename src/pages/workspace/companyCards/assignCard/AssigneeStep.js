...
function AssigneeStep(_a) {
    ...
    var _h = (0, react_1.useState)((_e = (_d = assignCard === null || assignCard === void 0 ? void 0 : assignCard.data) === null || _d === void 0 ? void 0 : _d.email) !== null && _e !== void 0 ? _e : ''), selectedMember = _h[0], setSelectedMember = _h[1];
    var _j = (0, useDebouncedState_1.default)(''), searchTerm = _j[0], debouncedSearchTerm = _j[1], setSearchTerm = _j[2];
    var _k = (0, react_1.useState)(false), shouldShowError = _k[0], setShouldShowError = _k[1];
