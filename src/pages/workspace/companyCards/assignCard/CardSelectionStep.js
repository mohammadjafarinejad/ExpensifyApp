...
function CardSelectionStep(_a) {
    ...
    var _k = (0, react_1.useState)(''), searchText = _k[0], setSearchText = _k[1];
    ...
    var assigneeDisplayName = (_e = (_d = (0, PersonalDetailsUtils_1.getPersonalDetailByEmail)((_c = (_b = assignCard === null || assignCard === void 0 ? void 0 : assignCard.data) === null || _b === void 0 ? void 0 : _b.email) !== null && _c !== void 0 ? _c : '')) === null || _d === void 0 ? void 0 : _d.displayName) !== null && _e !== void 0 ? _e : '';
    var filteredCardList = (0, CardUtils_1.getFilteredCardList)(list, (_g = (_f = cardFeeds === null || cardFeeds === void 0 ? void 0 : cardFeeds.settings) === null || _f === void 0 ? void 0 : _f.oAuthAccountDetails) === null || _g === void 0 ? void 0 : _g[feed], workspaceCardFeeds);
    var _l = (0, react_1.useState)((_j = (_h = assignCard === null || assignCard === void 0 ? void 0 : assignCard.data) === null || _h === void 0 ? void 0 : _h.encryptedCardNumber) !== null && _j !== void 0 ? _j : ''), cardSelected = _l[0], setCardSelected = _l[1];
    var _m = (0, react_1.useState)(false), shouldShowError = _m[0], setShouldShowError = _m[1];
    ...
    return (<InteractiveStepWrapper_1.default wrapperID={CardSelectionStep.displayName} handleBackButtonPress={handleBackButtonPress} headerTitle={translate('workspace.companyCards.assignCard')} headerSubtitle={assigneeDisplayName} enableEdgeToEdgeBottomSafeAreaPadding>
            ...
            return handleSelectCard(value);
                            ...
                            <react_native_1.View style={[styles.ph5, styles.mv3, styles.textSupporting]}>
                                <RenderHTML_1.default html={translate('workspace.companyCards.chooseCardFor', {
