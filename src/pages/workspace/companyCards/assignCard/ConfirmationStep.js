...
function ConfirmationStep(_a) {
    ...
    var _j = (0, useOnyx_1.default)(ONYXKEYS_1.default.CURRENCY_LIST, { canBeMissing: true })[0], currencyList = _j === void 0 ? (0, EmptyObject_1.getEmptyObject)() : _j;
    var bankName = (_c = (_b = assignCard === null || assignCard === void 0 ? void 0 : assignCard.data) === null || _b === void 0 ? void 0 : _b.bankName) !== null && _c !== void 0 ? _c : feed;
    var cardFeeds = (0, useCardFeeds_1.default)(policyID)[0];
    var data = assignCard === null || assignCard === void 0 ? void 0 : assignCard.data;
    var cardholderName = (_f = (_e = (0, PersonalDetailsUtils_1.getPersonalDetailByEmail)((_d = data === null || data === void 0 ? void 0 : data.email) !== null && _d !== void 0 ? _d : '')) === null || _e === void 0 ? void 0 : _e.displayName) !== null && _f !== void 0 ? _f : '';
    ...
    }, [assignCard, backTo, policyID, (_g = currentFullScreenRoute === null || currentFullScreenRoute === void 0 ? void 0 : currentFullScreenRoute.state) === null || _g === void 0 ? void 0 : _g.routes]);
    var submit = function () {
        var _a, _b;
        if (!policyID) {
            return;
        }
        var isFeedExpired = (0, CardUtils_1.isSelectedFeedExpired)(bankName ? (_b = (_a = cardFeeds === null || cardFeeds === void 0 ? void 0 : cardFeeds.settings) === null || _a === void 0 ? void 0 : _a.oAuthAccountDetails) === null || _b === void 0 ? void 0 : _b[bankName] : undefined);
        var institutionId = !!(0, CardUtils_1.getPlaidInstitutionId)(bankName);
        if (isFeedExpired) {
            if (institutionId) {
        ...
        (0, CompanyCards_1.assignWorkspaceCompanyCard)(policyID, __assign(__assign({}, data), { bankName: bankName }));
    };
