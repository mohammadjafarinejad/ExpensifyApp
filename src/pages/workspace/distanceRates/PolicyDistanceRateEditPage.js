...
function PolicyDistanceRateEditPage(_a) {
    ...
    var submitRate = function (values) {
        ...
        (0, DistanceRate_1.updatePolicyDistanceRateValue)(policyID, customUnit, [__assign(__assign({}, rate), { rate: Number(values.rate) * CONST_1.default.POLICY.CUSTOM_UNIT_RATE_BASE_OFFSET })]);
