...
function PayAndDowngradePage() {
    ...
    var _c = (0, useOnyx_1.default)(ONYXKEYS_1.default.BILLING_RECEIPT_DETAILS, { canBeMissing: true }), billingDetails = _c[0], metadata = _c[1];
    ...
    return (<ScreenWrapper_1.default shouldShowOfflineIndicator testID="PayAndDowngradePage" offlineIndicatorStyle={styles.mtAuto}>
            ...
            formattedAmount: (_a = billingDetails === null || billingDetails === void 0 ? void 0 : billingDetails.formattedSubtotal) !== null && _a !== void 0 ? _a : '',
        })}/>
                        </react_native_1.View>
                        <Text_1.default style={[styles.mb5]}>
                            {translate('workspace.payAndDowngrade.description2', {
            date: (_b = billingDetails === null || billingDetails === void 0 ? void 0 : billingDetails.billingMonth) !== null && _b !== void 0 ? _b : '',
        })}
                        </Text_1.default>
