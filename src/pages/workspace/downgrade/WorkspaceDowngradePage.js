...
var Policy_2 = require("@src/selectors/Policy");
...
function WorkspaceDowngradePage(_a) {
    ...
    var ownerPoliciesSelectorWithAccountID = (0, react_1.useCallback)(function (policies) { return (0, Policy_2.ownerPoliciesSelector)(policies, accountID); }, [accountID]);
    var ownerPolicies = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.POLICY, { canBeMissing: false, selector: ownerPoliciesSelectorWithAccountID })[0];
    ...
    var canPerformDowngrade = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.canModifyPlan)(ownerPolicies, policy); }, [ownerPolicies, policy]);
    ...
    var dismissModalAndNavigate = function (targetPolicyID) {
        Navigation_1.default.dismissModal();
        Navigation_1.default.isNavigationReady().then(function () {
            Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_COMPANY_CARDS.getRoute(targetPolicyID));
            // eslint-disable-next-line @typescript-eslint/no-deprecated
            react_native_1.InteractionManager.runAfterInteractions(function () {
                Navigation_1.default.navigate(ROUTES_1.default.WORKSPACE_COMPANY_CARDS_SELECT_FEED.getRoute(targetPolicyID));
            });
        });
    };
    var onMoveToCompanyCardFeeds = function () {
        ...
        setIsDowngradeWarningModalOpen(false);
        // eslint-disable-next-line @typescript-eslint/no-deprecated
        react_native_1.InteractionManager.runAfterInteractions(function () { return dismissModalAndNavigate(policyID); });
    };
    if (!canPerformDowngrade) {
        return <NotFoundPage_1.default />;
    }
    return (<ScreenWrapper_1.default shouldShowOfflineIndicator testID="workspaceDowngradePage" offlineIndicatorStyle={styles.mtAuto} shouldShowOfflineIndicatorInWideScreen>
            ...
            <ConfirmModal_1.default title={translate('workspace.moreFeatures.companyCards.downgradeTitle')} isVisible={isDowngradeWarningModalOpen} onConfirm={onClose} shouldShowCancelButton={false} onCancel={onClose} prompt={<react_native_1.View style={styles.flexRow}>
                        <RenderHTML_1.default html={translate('workspace.moreFeatures.companyCards.downgradeSubTitle')} onLinkPress={onMoveToCompanyCardFeeds}/>
                    </react_native_1.View>} confirmText={translate('common.buttonConfirm')}/>
