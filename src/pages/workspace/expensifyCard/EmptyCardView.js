...
function EmptyCardView(_a) {
    var isBankAccountVerified = _a.isBankAccountVerified, policyID = _a.policyID, buttons = _a.buttons;
    ...
    return (<ScrollView_1.default contentContainerStyle={[styles.flexGrow1, styles.flexShrink0]} addBottomSafeAreaPadding>
            <react_native_1.View style={[{ minHeight: windowHeight - headerHeight }, styles.pt5]}>
