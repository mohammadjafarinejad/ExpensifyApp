...
function WorkspaceCardListLabels(_a) {
    ...
    var cardManualBilling = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.PRIVATE_EXPENSIFY_CARD_MANUAL_BILLING).concat(defaultFundID), { canBeMissing: true })[0];
    ...
    if (!isLessThanMediumScreen) {
        return (<react_native_1.View style={[styles.flexRow, styles.mt5, styles.mh5, styles.pr4]}>
                ...
                {!isUkEuCurrencySupported && (<WorkspaceCardsListLabel_1.default type={CONST_1.default.WORKSPACE_CARDS_LIST_LABEL_TYPE.CASH_BACK} value={(_d = cardSettings === null || cardSettings === void 0 ? void 0 : cardSettings[CONST_1.default.WORKSPACE_CARDS_LIST_LABEL_TYPE.CASH_BACK]) !== null && _d !== void 0 ? _d : 0}/>)}
            </react_native_1.View>);
    }
    return shouldShowSettlementButtonOrDate ? (<react_native_1.View style={[styles.flexColumn, styles.mt5, styles.mh5, styles.pr4]}>
            ...
            <react_native_1.View style={[styles.flexRow, !isLessThanMediumScreen ? styles.flex2 : styles.mt5]}>
                ...
                {!isUkEuCurrencySupported && (<WorkspaceCardsListLabel_1.default type={CONST_1.default.WORKSPACE_CARDS_LIST_LABEL_TYPE.CASH_BACK} value={(_g = cardSettings === null || cardSettings === void 0 ? void 0 : cardSettings[CONST_1.default.WORKSPACE_CARDS_LIST_LABEL_TYPE.CASH_BACK]) !== null && _g !== void 0 ? _g : 0}/>)}
            </react_native_1.View>
            ...
            {!isUkEuCurrencySupported && (<WorkspaceCardsListLabel_1.default type={CONST_1.default.WORKSPACE_CARDS_LIST_LABEL_TYPE.CASH_BACK} value={(_k = cardSettings === null || cardSettings === void 0 ? void 0 : cardSettings[CONST_1.default.WORKSPACE_CARDS_LIST_LABEL_TYPE.CASH_BACK]) !== null && _k !== void 0 ? _k : 0}/>)}
        </react_native_1.View>);
}
