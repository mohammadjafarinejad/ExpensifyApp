...
function WorkspaceCardListRow(_a) {
    var _b;
    var limit = _a.limit, cardholder = _a.cardholder, lastFourPAN = _a.lastFourPAN, name = _a.name, currency = _a.currency, isVirtual = _a.isVirtual, isHovered = _a.isHovered;
    ...
    return (<react_native_1.View style={[styles.flexRow, styles.gap3, styles.br3, styles.p4]}>
            <react_native_1.View style={[styles.flexRow, styles.flex4, styles.gap3, styles.alignItemsCenter]}>
                <Avatar_1.default source={(_b = cardholder === null || cardholder === void 0 ? void 0 : cardholder.avatar) !== null && _b !== void 0 ? _b : Expensicons.FallbackAvatar} avatarID={cardholder === null || cardholder === void 0 ? void 0 : cardholder.accountID} type={CONST_1.default.ICON_TYPE_AVATAR} size={CONST_1.default.AVATAR_SIZE.DEFAULT}/>
            ...
            <react_native_1.View style={[styles.justifyContentCenter, styles.alignItemsCenter]}>
