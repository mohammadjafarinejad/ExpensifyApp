...
function WorkspaceCardsListLabel(_a) {
    ...
    var _d = (0, react_1.useState)({ top: 0, left: 0 }), anchorPosition = _d[0], setAnchorPosition = _d[1];
    ...
    var handleSettleBalanceButtonClick = function () {
        (0, Card_1.queueExpensifyCardForBilling)(CONST_1.default.COUNTRY.US, defaultFundID);
    };
