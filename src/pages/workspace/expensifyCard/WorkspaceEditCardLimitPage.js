...
function WorkspaceEditCardLimitPage(_a) {
    ...
    var updateCardLimit = function (newLimit) {
        ...
        (0, Card_1.updateExpensifyCardLimit)(defaultFundID, Number(cardID), newLimit, newAvailableSpend, (_a = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _a === void 0 ? void 0 : _a.unapprovedExpenseLimit, card === null || card === void 0 ? void 0 : card.availableSpend, (_b = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _b === void 0 ? void 0 : _b.isVirtual);
        goBack();
    };
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_EXPENSIFY_CARDS_ENABLED}>
            ...
            return (<>
                            <InputWrapper_1.default InputComponent={AmountForm_1.default} defaultValue={(0, CurrencyUtils_1.convertToFrontendAmountAsString)((_b = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _b === void 0 ? void 0 : _b.unapprovedExpenseLimit, currency, false)} isCurrencyPressable={false} currency={currency} inputID={EditExpensifyCardLimitForm_1.default.LIMIT} ref={inputCallbackRef}/>
