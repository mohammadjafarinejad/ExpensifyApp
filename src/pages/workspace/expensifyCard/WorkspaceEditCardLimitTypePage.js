...
function WorkspaceEditCardLimitTypePage(_a) {
    var _b, _c, _d;
    var route = _a.route;
    var _e = route.params, policyID = _e.policyID, cardID = _e.cardID, backTo = _e.backTo;
    ...
    var initialLimitType = (_c = (_b = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _b === void 0 ? void 0 : _b.limitType) !== null && _c !== void 0 ? _c : defaultLimitType;
    ...
    var _f = (0, react_1.useState)(initialLimitType), typeSelected = _f[0], setTypeSelected = _f[1];
    var _g = (0, react_1.useState)(false), isConfirmModalVisible = _g[0], setIsConfirmModalVisible = _g[1];
    ...
    var updateCardLimitType = function () {
        ...
        (0, Card_1.updateExpensifyCardLimitType)(defaultFundID, Number(cardID), typeSelected, (_a = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _a === void 0 ? void 0 : _a.limitType);
        goBack();
    };
    var submit = function () {
        var _a;
    ...
    }} data={data} shouldUpdateFocusedIndex alternateNumberOfSupportedLines={2} initiallyFocusedItemKey={typeSelected}/>
                    <ConfirmModal_1.default title={translate('workspace.expensifyCard.changeCardLimitType')} isVisible={isConfirmModalVisible} onConfirm={updateCardLimitType} onCancel={function () { return setIsConfirmModalVisible(false); }} prompt={translate(promptTranslationKey, { limit: (0, CurrencyUtils_1.convertToDisplayString)((_d = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _d === void 0 ? void 0 : _d.unapprovedExpenseLimit, currency) })} confirmText={translate('workspace.expensifyCard.changeLimitType')} cancelText={translate('common.cancel')} danger shouldEnableNewFocusManagement/>
