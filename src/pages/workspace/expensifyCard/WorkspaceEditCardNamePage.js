...
function WorkspaceEditCardNamePage(_a) {
    ...
    var submit = function (values) {
        var _a;
        (0, Card_1.updateExpensifyCardTitle)(defaultFundID, Number(cardID), values[EditExpensifyCardNameForm_1.default.NAME], (_a = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _a === void 0 ? void 0 : _a.cardTitle);
        goBack();
    };
