...
function WorkspaceExpensifyCardBankAccounts(_a) {
    ...
    var cardBankAccountMetadata = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.EXPENSIFY_CARD_BANK_ACCOUNT_METADATA).concat(defaultFundID), { canBeMissing: true })[0];
    ...
    var renderBankOptions = function () {
        ...
        var eligibleBankAccounts = isUkEuCurrencySupported
            ? (0, CardUtils_1.getEligibleBankAccountsForUkEuCard)(bankAccountsList, policy === null || policy === void 0 ? void 0 : policy.outputCurrency)
