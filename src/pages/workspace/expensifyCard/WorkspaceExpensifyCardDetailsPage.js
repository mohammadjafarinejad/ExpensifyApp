...
function WorkspaceExpensifyCardDetailsPage(_a) {
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['ExpensifyCardImage']);
    ...
    var _t = (0, useOnyx_1.default)(ONYXKEYS_1.default.COLLECTION.WORKSPACE_CARDS_LIST, { canBeMissing: true }), allFeedsCards = _t[0], allFeedsCardsResult = _t[1];
    var workspaceCards = (0, CardUtils_1.getAllCardsForWorkspace)(defaultFundID, allFeedsCards, cardFeeds, expensifyCardSettings);
    var isWorkspaceCardRhp = route.name === SCREENS_1.default.WORKSPACE.EXPENSIFY_CARD_DETAILS;
    var card = workspaceCards === null || workspaceCards === void 0 ? void 0 : workspaceCards[cardID];
    ...
    var formattedAvailableSpendAmount = (0, CurrencyUtils_1.convertToDisplayString)(card === null || card === void 0 ? void 0 : card.availableSpend, currency);
    var formattedLimit = (0, CurrencyUtils_1.convertToDisplayString)((_d = card === null || card === void 0 ? void 0 : card.nameValuePairs) === null || _d === void 0 ? void 0 : _d.unapprovedExpenseLimit, currency);
    ...
    var shouldGoBack = (0, react_1.useRef)(false);
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_EXPENSIFY_CARDS_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding testID={WorkspaceExpensifyCardDetailsPage.displayName}>
                ...
                <ScrollView_1.default addBottomSafeAreaPadding>
                    <react_native_1.View style={[styles.walletCard, styles.mb3]}>
                        <ImageSVG_1.default contentFit="contain" src={illustrations.ExpensifyCardImage} pointerEvents="none" height={variables_1.default.cardPreviewHeight} width={variables_1.default.cardPreviewWidth}/>
                    ...
                    {!(cardholder === null || cardholder === void 0 ? void 0 : cardholder.validated) && (<MenuItem_1.default icon={Expensicons_1.Hourglass} iconStyles={styles.mln2} descriptionTextStyle={StyleUtils.combineStyles([styles.textLabelSupporting, styles.ml0, StyleUtils.getLineHeightStyle(variables_1.default.fontSizeNormal)])} description={translate('workspace.expensifyCard.cardPending', { name: displayName })} numberOfLinesDescription={0} interactive={false}/>)}
            ...
            Navigation_1.default.navigate(ROUTES_1.default.SEARCH_ROOT.getRoute({
                query: (0, SearchQueryUtils_1.buildCannedSearchQuery)({
                    ...
                    <ConfirmModal_1.default title={translate('workspace.card.deactivateCardModal.deactivateCard')} isVisible={isDeactivateModalVisible} onConfirm={deactivateCard} onCancel={function () { return setIsDeactivateModalVisible(false); }} shouldSetModalVisibility={false} prompt={translate('workspace.card.deactivateCardModal.deactivateConfirmation')} confirmText={translate('workspace.card.deactivateCardModal.deactivate')} cancelText={translate('common.cancel')} danger onModalHide={function () { return shouldGoBack.current && Navigation_1.default.goBack(); }}/>
