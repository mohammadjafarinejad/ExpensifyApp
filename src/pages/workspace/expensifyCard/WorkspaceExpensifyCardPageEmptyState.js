...
function WorkspaceExpensifyCardPageEmptyState(_a) {
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['MoneyReceipts', 'CreditCardsNew', 'MoneyWings', 'HandCard', 'ExpensifyCardIllustration']);
    ...
    var isUkEuCurrencySupported = (0, useExpensifyCardUkEuSupported_1.default)(policy === null || policy === void 0 ? void 0 : policy.id);
    var eligibleBankAccounts = isUkEuCurrencySupported ? (0, CardUtils_1.getEligibleBankAccountsForUkEuCard)(bankAccountList, policy === null || policy === void 0 ? void 0 : policy.outputCurrency) : (0, CardUtils_1.getEligibleBankAccountsForCard)(bankAccountList);
    ...
    var expensifyCardFeatures = (0, react_1.useMemo)(function () {
        var features = [
            {
        ...
        return features
            .filter(function (feature) { return feature.icon !== null; })
    ...
    return (<WorkspacePageWithSections_1.default shouldUseScrollView icon={illustrations.HandCard} headerText={translate('workspace.common.expensifyCard')} route={route} showLoadingAsFirstRender={false} shouldShowOfflineIndicatorInWideScreen addBottomSafeAreaPadding>
            ...
            if (!((policy === null || policy === void 0 ? void 0 : policy.outputCurrency) === CONST_1.default.CURRENCY.USD || isUkEuCurrencySupported)) {
