...
function LimitTypeStep(_a) {
    ...
    }} data={data} shouldSingleExecuteRowSelect initiallyFocusedItemKey={typeSelected} shouldUpdateFocusedIndex alternateNumberOfSupportedLines={2} addBottomSafeAreaPadding footerContent={<Button_1.default success large pressOnEnter text={translate(isEditing ? 'common.confirm' : 'common.next')} onPress={submit}/>}/>
