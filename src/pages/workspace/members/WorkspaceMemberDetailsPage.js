...
function WorkspaceMemberDetailsPage(_a) {
    ...
    var _u = (0, useLocalize_1.default)(), formatPhoneNumber = _u.formatPhoneNumber, translate = _u.translate, localeCompare = _u.localeCompare;
    ...
    var _v = (0, react_1.useState)(false), isRemoveMemberConfirmModalVisible = _v[0], setIsRemoveMemberConfirmModalVisible = _v[1];
    var _w = (0, react_1.useState)(false), isRoleSelectionModalVisible = _w[0], setIsRoleSelectionModalVisible = _w[1];
    ...
    var isReimburser = ((_p = policy === null || policy === void 0 ? void 0 : policy.achAccount) === null || _p === void 0 ? void 0 : _p.reimburser) === memberLogin;
    var _x = (0, react_1.useState)(false), isCannotRemoveUser = _x[0], setIsCannotRemoveUser = _x[1];
    var _y = (0, react_1.useContext)(LockedAccountModalProvider_1.LockedAccountContext), isAccountLocked = _y.isAccountLocked, showLockedAccountModal = _y.showLockedAccountModal;
    ...
    var confirmModalPrompt = (0, react_1.useMemo)(function () {
        ...
        var isApprover = (0, Member_1.isApprover)(policy, memberLogin);
        var isTechnicalContact = (policy === null || policy === void 0 ? void 0 : policy.technicalContact) === (details === null || details === void 0 ? void 0 : details.login);
        var exporters = [
        ...
        var isUserExporter = exporters.includes(details.login);
    ...
    var roleItems = (0, react_1.useMemo)(function () {
        ...
        return (member === null || member === void 0 ? void 0 : member.role) === CONST_1.default.POLICY.ROLE.AUDITOR ? items : items.filter(function (item) { return item.value !== CONST_1.default.POLICY.ROLE.AUDITOR; });
    }, [member === null || member === void 0 ? void 0 : member.role, translate, policy]);
    (0, react_1.useEffect)(function () {
        ...
        (0, navigateAfterInteraction_1.default)(function () { return Navigation_1.default.goBack(); });
    }, [member, prevMember]);
    ...
    var removeMemberAndCloseModal = (0, react_1.useCallback)(function () {
        var _a;
        var _b;
        (0, Member_1.removeMembers)(policyID, [memberLogin], (_a = {}, _a[memberLogin] = accountID, _a));
        var previousEmployeesCount = Object.keys((_b = policy === null || policy === void 0 ? void 0 : policy.employeeList) !== null && _b !== void 0 ? _b : {}).length;
        ...
        if (remainingEmployeeCount === 1 && (policy === null || policy === void 0 ? void 0 : policy.preventSelfApproval)) {
            ...
            (0, Policy_1.setPolicyPreventSelfApproval)(policyID, false);
        }
        setIsRemoveMemberConfirmModalVisible(false);
    }, [accountID, memberLogin, policy === null || policy === void 0 ? void 0 : policy.employeeList, policy === null || policy === void 0 ? void 0 : policy.preventSelfApproval, policyID]);
    var removeUser = (0, react_1.useCallback)(function () {
        ...
        if (!(0, Member_1.isApprover)(policy, memberLogin) || !(removedApprover === null || removedApprover === void 0 ? void 0 : removedApprover.login) || !ownerEmail) {
    ...
    var changeRole = (0, react_1.useCallback)(function (_a) {
        ...
        if (value !== (member === null || member === void 0 ? void 0 : member.role)) {
            (0, Member_1.updateWorkspaceMembersRole)(policyID, [memberLogin], [accountID], value);
        }
    }, [accountID, member === null || member === void 0 ? void 0 : member.role, memberLogin, policyID]);
                ...
                <ScrollView_1.default addBottomSafeAreaPadding>
                    <react_native_1.View style={[styles.containerWithSpaceBetween, styles.pointerEventsBoxNone, styles.justifyContentStart]}>
                        <react_native_1.View style={[styles.avatarSectionWrapper, styles.pb0]}>
                            <OfflineWithFeedback_1.default pendingAction={(_q = details.pendingFields) === null || _q === void 0 ? void 0 : _q.avatar}>
                            ...
                            {!!((_r = details.displayName) !== null && _r !== void 0 ? _r : '') && (<Text_1.default style={[styles.textHeadline, styles.pre, styles.mb8, styles.w100, styles.textAlignCenter]} numberOfLines={1}>
                                    {displayName}
                                </Text_1.default>)}
            ...
            setIsCannotRemoveUser(false);
                        ...
                        <react_native_1.View style={styles.w100}>
                            ...
                            {(0, PolicyUtils_1.isControlPolicy)(policy) && (<>
                                    <OfflineWithFeedback_1.default pendingAction={(_s = member === null || member === void 0 ? void 0 : member.pendingFields) === null || _s === void 0 ? void 0 : _s.employeeUserID}>
                                    ...
                                    <OfflineWithFeedback_1.default pendingAction={(_t = member === null || member === void 0 ? void 0 : member.pendingFields) === null || _t === void 0 ? void 0 : _t.employeePayrollID}>
