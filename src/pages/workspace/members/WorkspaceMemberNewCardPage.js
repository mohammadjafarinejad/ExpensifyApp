...
function WorkspaceMemberNewCardPage(_a) {
    ...
    var lazyIllustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['ExpensifyCardImage']);
    ...
    var filteredCardList = (0, CardUtils_1.getFilteredCardList)(list, (_l = (_k = cardFeeds === null || cardFeeds === void 0 ? void 0 : cardFeeds.settings) === null || _k === void 0 ? void 0 : _k.oAuthAccountDetails) === null || _l === void 0 ? void 0 : _l[selectedFeed], workspaceCardFeeds);
    ...
    var handleSelectFeed = function (feed) {
        ...
        var workspaceCards = (_a = workspaceCardFeeds === null || workspaceCardFeeds === void 0 ? void 0 : workspaceCardFeeds["".concat(ONYXKEYS_1.default.COLLECTION.WORKSPACE_CARDS_LIST).concat(workspaceAccountID, "_").concat(feed.value)]) !== null && _a !== void 0 ? _a : {};
        var hasAllCardsData = !!workspaceCards.cardList;
        ...
        ? __spreadArray(__spreadArray([], companyCardFeeds, true), [
            {
                ...
                leftElement: (<Icon_1.default src={lazyIllustrations.ExpensifyCardImage} width={variables_1.default.cardIconWidth} height={variables_1.default.cardIconHeight} additionalStyles={[styles.cardIcon, styles.mr3]}/>),
            },
    ...
    return (<AccessOrNotFoundWrapper_1.default policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_COMPANY_CARDS_ENABLED}>
            <ScreenWrapper_1.default testID={WorkspaceMemberNewCardPage.displayName} shouldEnablePickerAvoiding={false} shouldEnableMaxHeight>
                ...
                <SelectionList_1.default data={feeds} ListItem={RadioListItem_1.default} onSelectRow={handleSelectFeed} shouldUpdateFocusedIndex alternateNumberOfSupportedLines={2}/>
