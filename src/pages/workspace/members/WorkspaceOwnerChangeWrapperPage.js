...
var shouldShowChangeWorkspaceOwnerPage_1 = require("@libs/shouldShowChangeWorkspaceOwnerPage");
...
function WorkspaceOwnerChangeWrapperPage(_a) {
    ...
    }, [accountID, backTo, policy, (_b = policy === null || policy === void 0 ? void 0 : policy.errorFields) === null || _b === void 0 ? void 0 : _b.changeOwner, policyID]);
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} shouldBeBlocked={!(0, shouldShowChangeWorkspaceOwnerPage_1.default)(fundList, error)}>
