...
function ImportedPerDiemPage(_a) {
    ...
    var _e = (0, react_1.useState)(false), isImportingPerDiemRates = _e[0], setIsImportingPerDiemRates = _e[1];
    ...
    return (<ScreenWrapper_1.default testID={ImportedPerDiemPage.displayName} enableEdgeToEdgeBottomSafeAreaPadding shouldShowOfflineIndicatorInWideScreen>
