...
function WorkspacePerDiemPage(_a) {
    ...
    var _f = (0, react_1.useState)([]), selectedPerDiem = _f[0], setSelectedPerDiem = _f[1];
    var _g = (0, react_1.useState)(false), deletePerDiemConfirmModalVisible = _g[0], setDeletePerDiemConfirmModalVisible = _g[1];
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['PerDiem']);
    ...
    }, [policy]), customUnit = _j[0], allRatesArray = _j[1], allSubRates = _j[2];
    ...
    var _k = (0, useSearchResults_1.default)(subRatesList, filterRate, sortRates), inputValue = _k[0], setInputValue = _k[1], filteredSubRatesList = _k[2];
    ...
    var getCustomListHeader = function () {
        ...
        var header = (<react_native_1.View style={[styles.flex1, styles.flexRow, styles.justifyContentBetween, canSelectMultiple && styles.pl3, styles.mr6]}>
    ...
    var headerContent = (<>
            <react_native_1.View style={[styles.renderHTML, styles.ph5, styles.pb5, styles.pt3, styles.flexRow, shouldUseNarrowLayout ? styles.workspaceSectionMobile : styles.workspaceSection]}>
                <RenderHTML_1.default html={translate('workspace.perDiem.subtitle')}/>
            </react_native_1.View>
