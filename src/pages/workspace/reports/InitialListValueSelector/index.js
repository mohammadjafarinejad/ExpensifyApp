...
function InitialListValueSelector(_a) {
    var _b = _a.value, value = _b === void 0 ? '' : _b, _c = _a.label, label = _c === void 0 ? '' : _c, rightLabel = _a.rightLabel, _d = _a.subtitle, subtitle = _d === void 0 ? '' : _d, _e = _a.errorText, errorText = _e === void 0 ? '' : _e, onInputChange = _a.onInputChange, ref = _a.ref;
    ...
    return (<react_native_1.View>
            <MenuItemWithTopDescription_1.default ref={ref} shouldShowRightIcon title={value} description={label} rightLabel={rightLabel} brickRoadIndicator={errorText ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined} errorText={errorText} onPress={showPickerModal}/>
...
exports.default = InitialListValueSelector;
