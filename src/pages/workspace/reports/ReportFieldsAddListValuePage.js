...
function ReportFieldsAddListValuePage(_a) {
    ...
    var createValue = (0, react_1.useCallback)(function (values) {
        var _a, _b;
        if (reportFieldID) {
            (0, ReportField_1.addReportFieldListValue)({ policy: policy, reportFieldID: reportFieldID, valueName: values[WorkspaceReportFieldForm_1.default.VALUE_NAME] });
        }
        else {
            (0, ReportField_1.createReportFieldsListValue)({
                valueName: values[WorkspaceReportFieldForm_1.default.VALUE_NAME],
