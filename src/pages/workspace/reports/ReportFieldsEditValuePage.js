...
function ReportFieldsEditValuePage(_a) {
    ...
    var editValue = (0, react_1.useCallback)(function (values) {
        ...
        if (currentValueName !== valueName) {
            (0, ReportField_1.renameReportFieldsListValue)({
                valueIndex: valueIndex,
                newValueName: valueName,
                listValues: (_b = formDraft === null || formDraft === void 0 ? void 0 : formDraft[WorkspaceReportFieldForm_1.default.LIST_VALUES]) !== null && _b !== void 0 ? _b : [],
            });
        }
