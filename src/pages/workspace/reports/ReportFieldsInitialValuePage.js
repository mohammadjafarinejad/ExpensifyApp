...
function ReportFieldsInitialValuePage(_a) {
    ...
    var submitForm = (0, react_1.useCallback)(function (values) {
        if (currentInitialValue !== values.initialValue) {
            (0, ReportField_1.updateReportFieldInitialValue)({ policy: policy, reportFieldID: reportFieldID, newInitialValue: values.initialValue });
        }
        Navigation_1.default.goBack();
    }, [currentInitialValue, policy, reportFieldID]);
    var submitListValueUpdate = function (value) {
        (0, ReportField_1.updateReportFieldInitialValue)({ policy: policy, reportFieldID: reportFieldID, newInitialValue: currentInitialValue === value ? '' : value });
        Navigation_1.default.goBack();
    };
    var validateForm = (0, react_1.useCallback)(function (values) {
        var formInitialValue = values.initialValue;
        var errors = {};
        if (formInitialValue.length > CONST_1.default.WORKSPACE_REPORT_FIELD_POLICY_MAX_LENGTH) {
        ...
        if (((reportField === null || reportField === void 0 ? void 0 : reportField.type) === CONST_1.default.REPORT_FIELD_TYPES.TEXT || (reportField === null || reportField === void 0 ? void 0 : reportField.type) === CONST_1.default.REPORT_FIELD_TYPES.FORMULA) &&
            (0, Formula_1.hasCircularReferences)(formInitialValue, reportField === null || reportField === void 0 ? void 0 : reportField.name, policy === null || policy === void 0 ? void 0 : policy.fieldList)) {
        ...
        return errors;
    }, [availableListValuesLength, reportField === null || reportField === void 0 ? void 0 : reportField.name, reportField === null || reportField === void 0 ? void 0 : reportField.type, policy === null || policy === void 0 ? void 0 : policy.fieldList, translate]);
    if (!reportField) {
        return <NotFoundPage_1.default />;
    }
    var isTextFieldType = reportField.type === CONST_1.default.REPORT_FIELD_TYPES.TEXT;
    var isFormulaFieldType = reportField.type === CONST_1.default.REPORT_FIELD_TYPES.FORMULA;
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_REPORT_FIELDS_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding style={styles.defaultModalContainer} testID={ReportFieldsInitialValuePage.displayName} shouldEnableMaxHeight>
                ...
                {(isTextFieldType || isFormulaFieldType) && (<FormProvider_1.default addBottomSafeAreaPadding formID={ONYXKEYS_1.default.FORMS.WORKSPACE_REPORT_FIELDS_FORM} onSubmit={submitForm} submitButtonText={translate('common.save')} validate={validateForm} style={styles.flex1} enabledWhenOffline isSubmitButtonVisible submitButtonStyles={styles.mh5} shouldHideFixErrorsAlert>
