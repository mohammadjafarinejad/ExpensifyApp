...
function ReportFieldsListValuesPage(_a) {
    ...
    var _d = (0, react_1.useState)({}), selectedValues = _d[0], setSelectedValues = _d[1];
    var _e = (0, react_1.useState)(false), deleteValuesConfirmModalVisible = _e[0], setDeleteValuesConfirmModalVisible = _e[1];
    ...
    }, [formDraft === null || formDraft === void 0 ? void 0 : formDraft.disabledListValues, formDraft === null || formDraft === void 0 ? void 0 : formDraft.listValues, policy === null || policy === void 0 ? void 0 : policy.fieldList, reportFieldID]), listValues = _f[0], disabledListValues = _f[1];
    var updateReportFieldListValueEnabled = (0, react_1.useCallback)(function (value, valueIndex) {
        if (reportFieldID) {
            (0, ReportField_1.updateReportFieldListValueEnabled)({ policy: policy, reportFieldID: reportFieldID, valueIndexes: [Number(valueIndex)], enabled: value });
            return;
        }
        (0, ReportField_1.setReportFieldsListValueEnabled)({
            valueIndexes: [valueIndex],
            enabled: value,
            disabledListValues: disabledListValues,
        });
    ...
    var data = (0, react_1.useMemo)(function () {
        return listValues.map(function (value, index) { return ({
            value: value,
            index: index,
            text: value,
            keyForList: value,
            ...
            rightElement: (<Switch_1.default isOn={!disabledListValues.at(index)} accessibilityLabel={translate('workspace.distanceRates.trackTax')} onToggle={function (newValue) { return updateReportFieldListValueEnabled(newValue, index); }}/>),
        }); });
    ...
    var sortListValues = (0, react_1.useCallback)(function (values) { return values.sort(function (a, b) { return localeCompare(a.value, b.value); }); }, [localeCompare]);
    var _g = (0, useSearchResults_1.default)(data, filterListValue, sortListValues), inputValue = _g[0], setInputValue = _g[1], filteredListValues = _g[2];
    ...
    var handleDeleteValues = function () {
        ...
        if (reportFieldID) {
            (0, ReportField_1.removeReportFieldListValue)({ policy: policy, reportFieldID: reportFieldID, valueIndexes: valuesToDelete });
        }
        else {
            (0, ReportField_1.deleteReportFieldsListValue)({
            ...
            if (enabledValues.length > 0) {
                ...
                options.push({
                    ...
                    onSelected: function () {
                        setSelectedValues({});
                        if (reportFieldID) {
                            (0, ReportField_1.updateReportFieldListValueEnabled)({ policy: policy, reportFieldID: reportFieldID, valueIndexes: valuesToDisable_1, enabled: false });
                            return;
                        }
                        (0, ReportField_1.setReportFieldsListValueEnabled)({
                            valueIndexes: valuesToDisable_1,
                            enabled: false,
                            disabledListValues: disabledListValues,
                        });
                    },
            ...
            if (disabledValues.length > 0) {
                ...
                options.push({
                    ...
                    onSelected: function () {
                        setSelectedValues({});
                        if (reportFieldID) {
                            (0, ReportField_1.updateReportFieldListValueEnabled)({ policy: policy, reportFieldID: reportFieldID, valueIndexes: valuesToEnable_1, enabled: true });
                            return;
                        }
                        (0, ReportField_1.setReportFieldsListValueEnabled)({
                            valueIndexes: valuesToEnable_1,
                            enabled: true,
                            disabledListValues: disabledListValues,
                        });
                    },
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_REPORT_FIELDS_ENABLED}>
            ...
            Navigation_1.default.goBack();
                ...
                {isSmallScreenWidth && <react_native_1.View style={[styles.pl5, styles.pr5]}>{getHeaderButtons()}</react_native_1.View>}
