...
function ReportFieldsValueSettingsPage(_a) {
    ...
    var deleteListValueAndHideModal = function () {
        var _a, _b;
        if (reportFieldID) {
            (0, ReportField_1.removeReportFieldListValue)({ policy: policy, reportFieldID: reportFieldID, valueIndexes: [valueIndex] });
        }
        else {
            (0, ReportField_1.deleteReportFieldsListValue)({
                valueIndexes: [valueIndex],
                listValues: (_a = formDraft === null || formDraft === void 0 ? void 0 : formDraft.listValues) !== null && _a !== void 0 ? _a : [],
                disabledListValues: (_b = formDraft === null || formDraft === void 0 ? void 0 : formDraft.disabledListValues) !== null && _b !== void 0 ? _b : [],
            });
        }
    ...
    var updateListValueEnabled = function (value) {
        ...
        (0, ReportField_1.setReportFieldsListValueEnabled)({
            valueIndexes: [valueIndex],
            enabled: value,
            disabledListValues: (_a = formDraft === null || formDraft === void 0 ? void 0 : formDraft.disabledListValues) !== null && _a !== void 0 ? _a : [],
        });
    };
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_REPORT_FIELDS_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding style={styles.defaultModalContainer} testID={ReportFieldsValueSettingsPage.displayName}>
                ...
                <ConfirmModal_1.default title={translate('workspace.reportFields.deleteValue')} isVisible={isDeleteTagModalOpen && !hasAccountingConnections} onConfirm={deleteListValueAndHideModal} onCancel={function () { return setIsDeleteTagModalOpen(false); }} shouldSetModalVisibility={false} prompt={translate('workspace.reportFields.deleteValuePrompt')} confirmText={translate('common.delete')} cancelText={translate('common.cancel')} danger/>
                <react_native_1.View style={styles.flexGrow1}>
                    ...
                    {!hasAccountingConnections && (<MenuItem_1.default icon={Expensicons.Trashcan} title={translate('common.delete')} onPress={function () { return setIsDeleteTagModalOpen(true); }}/>)}
                </react_native_1.View>
