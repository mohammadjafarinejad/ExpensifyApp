...
function TypeSelector(_a) {
    var value = _a.value, _b = _a.label, label = _b === void 0 ? '' : _b, rightLabel = _a.rightLabel, _c = _a.subtitle, subtitle = _c === void 0 ? '' : _c, _d = _a.errorText, errorText = _d === void 0 ? '' : _d, onInputChange = _a.onInputChange, onTypeSelected = _a.onTypeSelected, ref = _a.ref;
    ...
    return (<react_native_1.View>
            <MenuItemWithTopDescription_1.default ref={ref} shouldShowRightIcon title={value ? expensify_common_1.Str.recapitalize(translate((0, WorkspaceReportFieldUtils_1.getReportFieldTypeTranslationKey)(value))) : ''} description={label} rightLabel={rightLabel} brickRoadIndicator={errorText ? CONST_1.default.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined} errorText={errorText} onPress={showPickerModal}/>
