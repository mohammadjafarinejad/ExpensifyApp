...
function ExpenseReportRulesSection(_a) {
    ...
    var renderFallbackSubtitle = function (_a) {
        ...
        var moreFeaturesLink = "".concat(environmentURL, "/").concat(ROUTES_1.default.WORKSPACE_MORE_FEATURES.getRoute(policyID));
        if (variant === 'unlock') {
            return translate('workspace.rules.expenseReportRules.unlockFeatureEnableWorkflowsSubtitle', { featureName: featureName, moreFeaturesLink: moreFeaturesLink });
        }
        return translate('workspace.rules.expenseReportRules.enableFeatureSubtitle', { featureName: featureName, moreFeaturesLink: moreFeaturesLink });
    };
    var optionItems = [
        {
        ...
        },
        {
            ...
            subMenuItems: [
                <OfflineWithFeedback_1.default pendingAction={!((_v = policy === null || policy === void 0 ? void 0 : policy.pendingFields) === null || _v === void 0 ? void 0 : _v.shouldShowAutoReimbursementLimitOption) && ((_x = (_w = policy === null || policy === void 0 ? void 0 : policy.autoReimbursement) === null || _w === void 0 ? void 0 : _w.pendingFields) === null || _x === void 0 ? void 0 : _x.limit)
                    ...
                    <MenuItemWithTopDescription_1.default description={translate('workspace.rules.expenseReportRules.autoPayReportsUnderTitle')} title={(0, CurrencyUtils_1.convertToDisplayString)((_1 = (_0 = policy === null || policy === void 0 ? void 0 : policy.autoReimbursement) === null || _0 === void 0 ? void 0 : _0.limit) !== null && _1 !== void 0 ? _1 : CONST_1.default.POLICY.AUTO_REIMBURSEMENT_LIMIT_DEFAULT_CENTS, (_2 = policy === null || policy === void 0 ? void 0 : policy.outputCurrency) !== null && _2 !== void 0 ? _2 : CONST_1.default.CURRENCY.USD)} shouldShowRightIcon style={[styles.sectionMenuItemTopDescription, styles.mt6, styles.mbn3]} onPress={function () { return Navigation_1.default.navigate(ROUTES_1.default.RULES_AUTO_PAY_REPORTS_UNDER.getRoute(policyID)); }}/>
                </OfflineWithFeedback_1.default>,
            ],
        },
    ];
    return (<Section_1.default isCentralPane title={translate('workspace.rules.expenseReportRules.title')} subtitle={translate('workspace.rules.expenseReportRules.subtitle')} titleStyles={styles.accountSettingsSectionTitle} subtitleMuted>
            ...
            var title = _a.title, subtitle = _a.subtitle, shouldParseSubtitle = _a.shouldParseSubtitle, isActive = _a.isActive, subMenuItems = _a.subMenuItems, showLockIcon = _a.showLockIcon, disabled = _a.disabled, onToggle = _a.onToggle, pendingAction = _a.pendingAction;
