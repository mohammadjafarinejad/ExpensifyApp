...
function EditTagPage(_a) {
    var route = _a.route;
    var _b = route.params, backTo = _b.backTo, policyID = _b.policyID;
    ...
    var validate = (0, react_1.useCallback)(function (values) {
        ...
        var tags = (0, PolicyUtils_1.getTagListByOrderWeight)(policyTags, route.params.orderWeight).tags;
    ...
    var editTag = (0, react_1.useCallback)(function (values) {
        ...
        if (currentTagName !== tagName) {
            (0, Tag_1.renamePolicyTag)(policyData, { oldName: route.params.tagName, newName: values.tagName.trim() }, route.params.orderWeight);
        }
