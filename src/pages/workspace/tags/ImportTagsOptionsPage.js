...
function ImportTagsOptionsPage(_a) {
    ...
    var _c = (0, react_1.useState)(false), isOverridingMultiTag = _c[0], setIsOverridingMultiTag = _c[1];
    var _d = (0, react_1.useState)(false), isDownloadFailureModalVisible = _d[0], setIsDownloadFailureModalVisible = _d[1];
    var _e = (0, react_1.useState)(false), shouldRunPostUpgradeFlow = _e[0], setShouldRunPostUpgradeFlow = _e[1];
    var policyTags = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.POLICY_TAGS).concat(policyID), { canBeMissing: true })[0];
    var _f = (0, react_1.useMemo)(function () { return [(0, PolicyUtils_1.getTagLists)(policyTags), (0, PolicyUtils_1.isMultiLevelTags)(policyTags), (0, PolicyUtils_1.hasDependentTags)(policy, policyTags), (0, PolicyUtils_1.hasIndependentTags)(policy, policyTags)]; }, [policy, policyTags]), policyTagLists = _f[0], isMultiLevelTags = _f[1], hasDependentTags = _f[2], hasIndependentTags = _f[3];
    ...
    var overrideMultiTagPrompt = (<Text_1.default>
    ...
    var switchSingleToMultiLevelTagPrompt = (<Text_1.default>
    ...
    icon={Expensicons_1.MultiTag} shouldShowRightIcon onPress={function () {
            ...
            Navigation_1.default.navigate(isQuickSettingsFlow
                ? ROUTES_1.default.SETTINGS_TAGS_IMPORT.getRoute(policyID, ROUTES_1.default.SETTINGS_TAGS_ROOT.getRoute(policyID, backTo))
                : ROUTES_1.default.WORKSPACE_TAGS_IMPORT.getRoute(policyID));
        }} title={translate('workspace.tags.switchSingleToMultiLevelTagWarning.title')} prompt={switchSingleToMultiLevelTagPrompt} confirmText={translate('workspace.tags.switchSingleToMultiLevelTagWarning.title')} danger cancelText={translate('common.cancel')} onCancel={function () {
            setIsSwitchSingleToMultipleLevelTagWarningModalVisible(false);
            (0, Tag_1.setImportedSpreadsheetIsImportingMultiLevelTags)(false);
        }}/>
            <ConfirmModal_1.default isVisible={isOverridingMultiTag} onConfirm={function () {
            setIsOverridingMultiTag(false);
            Navigation_1.default.navigate(isQuickSettingsFlow
                ? ROUTES_1.default.SETTINGS_TAGS_IMPORT.getRoute(policyID, ROUTES_1.default.SETTINGS_TAGS_ROOT.getRoute(policyID, backTo))
                : ROUTES_1.default.WORKSPACE_TAGS_IMPORT.getRoute(policyID));
        }} title={translate('workspace.tags.overrideMultiTagWarning.title')} prompt={overrideMultiTagPrompt} confirmText={translate('workspace.tags.overrideMultiTagWarning.title')} danger cancelText={translate('common.cancel')} onCancel={function () {
            setIsOverridingMultiTag(false);
            (0, Tag_1.setImportedSpreadsheetIsImportingMultiLevelTags)(false);
        }}/>
