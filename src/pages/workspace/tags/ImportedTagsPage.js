...
function ImportedTagsPage(_a) {
    ...
    var _f = (spreadsheet !== null && spreadsheet !== void 0 ? spreadsheet : {}).containsHeader, containsHeader = _f === void 0 ? true : _f;
    var _g = (0, react_1.useState)(false), isValidationEnabled = _g[0], setIsValidationEnabled = _g[1];
    ...
    var validate = (0, react_1.useCallback)(function () {
        ...
        if (missingRequiredColumns) {
            ...
            var tagsNames = tagsNamesColumn !== -1 ? spreadsheet === null || spreadsheet === void 0 ? void 0 : spreadsheet.data[tagsNamesColumn] : [];
            var containsEmptyName = tagsNames === null || tagsNames === void 0 ? void 0 : tagsNames.some(function (name, index) { return (!containsHeader || index > 0) && !(name === null || name === void 0 ? void 0 : name.toString().trim()); });
            if (duplicate) {
        ...
        return errors;
    }, [requiredColumns, spreadsheet === null || spreadsheet === void 0 ? void 0 : spreadsheet.columns, translate, containsHeader, spreadsheet === null || spreadsheet === void 0 ? void 0 : spreadsheet.data]);
    ...
    return (<ScreenWrapper_1.default testID={ImportedTagsPage.displayName} enableEdgeToEdgeBottomSafeAreaPadding shouldShowOfflineIndicatorInWideScreen>
