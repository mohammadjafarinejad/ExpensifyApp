...
function TagSettingsPage(_a) {
    ...
    var _g = route.params, orderWeight = _g.orderWeight, policyID = _g.policyID, tagName = _g.tagName, backTo = _g.backTo, parentTagsFilter = _g.parentTagsFilter;
    var styles = (0, useThemeStyles_1.default)();
    var translate = (0, useLocalize_1.default)().translate;
    var policyData = (0, usePolicyData_1.default)(policyID);
    var policy = policyData.policy, policyTags = policyData.tags;
    var policyTag = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.getTagListByOrderWeight)(policyTags, orderWeight); }, [policyTags, orderWeight]);
    ...
    var _h = react_1.default.useState(false), isDeleteTagModalOpen = _h[0], setIsDeleteTagModalOpen = _h[1];
    var _j = (0, react_1.useState)(false), isCannotDeleteOrDisableLastTagModalVisible = _j[0], setIsCannotDeleteOrDisableLastTagModalVisible = _j[1];
    ...
    var approverText = (0, react_1.useMemo)(function () {
        var _a, _b, _c, _d;
        var tagApprover = (_c = (_b = (0, PolicyUtils_1.getTagApproverRule)(policy, (_a = route.params) === null || _a === void 0 ? void 0 : _a.tagName)) === null || _b === void 0 ? void 0 : _b.approver) !== null && _c !== void 0 ? _c : '';
        var approver = (0, PersonalDetailsUtils_1.getPersonalDetailByEmail)(tagApprover);
        return (_d = approver === null || approver === void 0 ? void 0 : approver.displayName) !== null && _d !== void 0 ? _d : tagApprover;
    }, [(_b = route.params) === null || _b === void 0 ? void 0 : _b.tagName, policy]);
    ...
    var deleteTagAndHideModal = function () {
        (0, Tag_1.deletePolicyTags)(policyData, [currentPolicyTag.name]);
    ...
    var updateWorkspaceTagEnabled = function (value) {
        ...
        (0, Tag_1.setWorkspaceTagEnabled)(policyData, (_a = {}, _a[currentPolicyTag.name] = { name: currentPolicyTag.name, enabled: value }, _a), policyTag.orderWeight);
    };
    ...
    var isThereAnyAccountingConnection = Object.keys((_c = policy === null || policy === void 0 ? void 0 : policy.connections) !== null && _c !== void 0 ? _c : {}).length !== 0;
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_TAGS_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding style={[styles.defaultModalContainer]} testID={TagSettingsPage.displayName}>
                ...
                <react_native_1.View style={styles.flexGrow1}>
                    {!hasDependentTags && (<OfflineWithFeedback_1.default errors={(0, ErrorUtils_1.getLatestErrorMessageField)(currentPolicyTag)} pendingAction={(_d = currentPolicyTag.pendingFields) === null || _d === void 0 ? void 0 : _d.enabled} errorRowStyles={styles.mh5} onClose={function () { return (0, Tag_1.clearPolicyTagErrors)({ policyID: policyID, tagName: tagName, tagListIndex: orderWeight, policyTags: policyTags }); }}>
                    ...
                    <OfflineWithFeedback_1.default pendingAction={(_e = currentPolicyTag.pendingFields) === null || _e === void 0 ? void 0 : _e.name}>
                    ...
                    {(!hasDependentTags || !!(currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag['GL Code'])) && (<OfflineWithFeedback_1.default pendingAction={(_f = currentPolicyTag.pendingFields) === null || _f === void 0 ? void 0 : _f['GL Code']}>
