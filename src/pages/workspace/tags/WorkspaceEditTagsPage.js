...
function WorkspaceEditTagsPage(_a) {
    ...
    var isMultiLevelTagsEnabled = (0, PolicyUtils_1.isMultiLevelTags)(policyTags);
    ...
    var goBackToTagsSettings = (0, react_1.useCallback)(function () {
        ...
        Navigation_1.default.goBack(isMultiLevelTagsEnabled
    ...
    }, [isQuickSettingsFlow, isMultiLevelTagsEnabled, (_c = route.params) === null || _c === void 0 ? void 0 : _c.policyID, route.params.orderWeight, backTo]);
