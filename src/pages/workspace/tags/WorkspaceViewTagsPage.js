...
function WorkspaceViewTagsPage(_a) {
    var _b, _c, _d, _e, _f;
    var route = _a.route;
    var _g = route.params, policyID = _g.policyID, backTo = _g.backTo, orderWeight = _g.orderWeight;
    ...
    var _k = (0, react_1.useState)(false), isDeleteTagsConfirmModalVisible = _k[0], setIsDeleteTagsConfirmModalVisible = _k[1];
    ...
    var currentTagListName = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.getTagListName)(policyTags, orderWeight); }, [policyTags, orderWeight]);
    ...
    var _l = (0, react_1.useState)(false), isCannotMakeAllTagsOptionalModalVisible = _l[0], setIsCannotMakeAllTagsOptionalModalVisible = _l[1];
    ...
    var _o = (0, react_1.useState)(false), isRequiresMultiLevelTagsModalVisible = _o[0], setIsRequiresMultiLevelTagsModalVisible = _o[1];
    ...
    var _p = (0, useFilteredSelection_1.default)(currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.tags, filterFunction), selectedTags = _p[0], setSelectedTags = _p[1];
    ...
    var updateWorkspaceTagEnabled = (0, react_1.useCallback)(function (value, tagName) {
        var _a;
        (0, Tag_1.setWorkspaceTagEnabled)(policyData, (_a = {}, _a[tagName] = { name: tagName, enabled: value }, _a), orderWeight);
    ...
    var tagList = (0, react_1.useMemo)(function () {
        ...
        return Object.values((_a = currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.tags) !== null && _a !== void 0 ? _a : {}).map(function (tag) {
            ...
            return ({
                ...
                rightElement: hasDependentTags ? (<ListItemRightCaretWithLabel_1.default />) : (<Switch_1.default isOn={tag.enabled} disabled={tag.pendingAction === CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE} accessibilityLabel={translate('workspace.tags.enableTag')} onToggle={function (newValue) {
    ...
    var sortTags = (0, react_1.useCallback)(function (tags) { return tags.sort(function (tagA, tagB) { return localeCompare(tagA.value, tagB.value); }); }, [localeCompare]);
    var _q = (0, useSearchResults_1.default)(tagList, filterTag, sortTags), inputValue = _q[0], setInputValue = _q[1], filteredTagList = _q[2];
    ...
    var getCustomListHeader = function () {
        ...
        return (<CustomListHeader_1.default canSelectMultiple={canSelectMultiple} leftHeaderText={translate('common.name')} rightHeaderText={hasDependentTags ? undefined : translate('common.enabled')} shouldShowRightCaret/>);
    };
    var navigateToTagSettings = function (tag) {
        var _a, _b;
        Navigation_1.default.navigate(isQuickSettingsFlow
            ? ROUTES_1.default.SETTINGS_TAG_SETTINGS.getRoute(policyID, orderWeight, tag.value, backTo)
            : ROUTES_1.default.WORKSPACE_TAG_SETTINGS.getRoute(policyID, orderWeight, tag.value, (_b = (_a = tag === null || tag === void 0 ? void 0 : tag.rules) === null || _a === void 0 ? void 0 : _a.parentTagsFilter) !== null && _b !== void 0 ? _b : undefined));
    };
    ...
    var getHeaderButtons = function () {
        ...
        if (enabledTagCount > 0) {
            ...
            options.push({
                ...
                onSelected: function () {
                    ...
                    (0, Tag_1.setWorkspaceTagEnabled)(policyData, tagsToDisable, orderWeight);
                },
            });
        }
        if (disabledTagCount > 0) {
            options.push({
                ...
                onSelected: function () {
                    setSelectedTags([]);
                    (0, Tag_1.setWorkspaceTagEnabled)(policyData, tagsToEnable, orderWeight);
                },
            });
        }
    ...
    if (!!(currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.required) && !Object.values((_b = currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.tags) !== null && _b !== void 0 ? _b : {}).some(function (tag) { return tag.enabled; })) {
        (0, Tag_1.setPolicyTagsRequired)(policyData, false, orderWeight);
    }
    ...
    var selectionModeHeader = isMobileSelectionModeEnabled && isSmallScreenWidth;
    return (<AccessOrNotFoundWrapper_1.default policyID={policyID} accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_TAGS_ENABLED}>
            ...
            Navigation_1.default.goBack(isQuickSettingsFlow ? ROUTES_1.default.SETTINGS_TAGS_ROOT.getRoute(policyID) : undefined);
                ...
                (0, Tag_1.setPolicyTagsRequired)(policyData, on, orderWeight);
            }} pendingAction={(_c = currentPolicyTag.pendingFields) === null || _c === void 0 ? void 0 : _c.required} errors={(_e = (_d = currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.errorFields) === null || _d === void 0 ? void 0 : _d.required) !== null && _e !== void 0 ? _e : undefined} onCloseError={function () { return (0, Tag_1.clearPolicyTagListErrorField)({ policyID: policyID, tagListIndex: orderWeight, errorField: 'required', policyTags: policyTags }); }} disabled={!(currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.required) && !Object.values((_f = currentPolicyTag === null || currentPolicyTag === void 0 ? void 0 : currentPolicyTag.tags) !== null && _f !== void 0 ? _f : {}).some(function (tag) { return tag.enabled; })} showLockIcon={!isMultiLevelTags || (0, OptionsListUtils_1.isMakingLastRequiredTagListOptional)(policy, policyTags, [currentPolicyTag])}/>
                    </react_native_1.View>)}
                <OfflineWithFeedback_1.default errors={currentPolicyTag.errors} onClose={function () { return (0, Tag_1.clearPolicyTagListErrors)({ policyID: policyID, tagListIndex: currentPolicyTag.orderWeight, policyTags: policyTags }); }} pendingAction={currentPolicyTag.pendingAction} errorRowStyles={styles.mh5}>
                ...
                (0, Tag_1.clearPolicyTagErrors)({ policyID: policyID, tagName: item.value, tagListIndex: orderWeight, policyTags: policyTags });
                ...
                <ConfirmModal_1.default isVisible={isRequiresMultiLevelTagsModalVisible} onConfirm={function () { return setIsRequiresMultiLevelTagsModalVisible(false); }} onCancel={function () { return setIsRequiresMultiLevelTagsModalVisible(false); }} title={translate('workspace.tags.cannotMakeTagListRequired.title')} prompt={translate('workspace.tags.cannotMakeTagListRequired.description')} confirmText={translate('common.buttonConfirm')} shouldShowCancelButton={false}/>
