...
function WorkspaceTaxesPage(_a) {
    ...
    var _j = (0, react_1.useState)([]), selectedTaxesIDs = _j[0], setSelectedTaxesIDs = _j[1];
    ...
    var illustrations = (0, useLazyAsset_1.useMemoizedLazyIllustrations)(['Coins']);
    ...
    var filterTax = (0, react_1.useCallback)(function (tax, searchInput) {
        var results = (0, tokenizedSearch_1.default)([tax], searchInput, function (option) { var _a, _b; return [(_a = option.text) !== null && _a !== void 0 ? _a : '', (_b = option.alternateText) !== null && _b !== void 0 ? _b : '']; });
    ...
    var _l = (0, useSearchResults_1.default)(taxesList, filterTax, sortTaxes), inputValue = _l[0], setInputValue = _l[1], filteredTaxesList = _l[2];
    ...
    var shouldShowBulkActionsButton = shouldUseNarrowLayout ? isMobileSelectionModeEnabled : selectedTaxesIDs.length > 0;
    ...
    var headerButtons = !shouldShowBulkActionsButton ? (<react_native_1.View style={[styles.w100, styles.flexRow, styles.gap2, shouldUseNarrowLayout && styles.mb3]}>
            ...
            <ButtonWithDropdownMenu_1.default success={false} onPress={function () { }} shouldUseOptionIcon customText={translate('common.more')} options={secondaryActions} isSplitButton={false} wrapperStyle={hasAccountingConnections ? styles.flexGrow1 : styles.flexGrow0}/>
