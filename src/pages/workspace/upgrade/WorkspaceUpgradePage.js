...
function WorkspaceUpgradePage(_a) {
    ...
    var canPerformUpgrade = (0, react_1.useMemo)(function () { return (0, PolicyUtils_1.canModifyPlan)(ownerPolicies, policy); }, [ownerPolicies, policy]);
    ...
    var goBack = (0, react_1.useCallback)(function () {
        ...
        switch (feature === null || feature === void 0 ? void 0 : feature.id) {
            ...
            case CONST_1.default.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id:
    ...
    return (<ScreenWrapper_1.default shouldShowOfflineIndicator testID="workspaceUpgradePage" offlineIndicatorStyle={styles.mtAuto} shouldShowOfflineIndicatorInWideScreen={!isUpgraded}>
            ...
            <ScrollView_1.default contentContainerStyle={styles.flexGrow1}>
                {!!policy && isUpgraded && (<UpgradeConfirmation_1.default afterUpgradeAcknowledged={goBack} policyName={policy.name}/>)}
