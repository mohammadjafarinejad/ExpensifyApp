...
function withPolicyAndFullscreenLoading(WrappedComponent) {
    function WithPolicyAndFullscreenLoading(_a) {
        ...
        var _e = (0, useOnyx_1.default)(ONYXKEYS_1.default.IS_LOADING_REPORT_DATA, { canBeMissing: false })[0], isLoadingReportData = _e === void 0 ? true : _e;
        ...
        {...rest} isLoadingReportData={isLoadingReportData} personalDetails={personalDetails} policy={policy} policyDraft={policyDraft}/>);
    }
    WithPolicyAndFullscreenLoading.displayName = "WithPolicyAndFullscreenLoading";
    return (0, withPolicy_1.default)(WithPolicyAndFullscreenLoading);
}
