...
function ToggleSettingOptionRow(_a) {
    ...
    var contentArea = (<react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.flex1]}>
    ...
    var shouldMakeContentPressable = isActive && onPress;
    return (<OfflineWithFeedback_1.default pendingAction={pendingAction} errors={errors} errorRowStyles={[styles.mt2]} style={[wrapperStyle]} onClose={onCloseError}>
            <react_native_1.View style={styles.pRelative}>
                <react_native_1.View style={[styles.flexRow, styles.alignItemsCenter, styles.justifyContentBetween, shouldPlaceSubtitleBelowSwitch && styles.h10]}>
                    {shouldMakeContentPressable ? (<PressableWithoutFeedback_1.default style={[styles.flexRow, styles.alignItemsCenter, styles.flex1]} onPress={onPress} accessibilityLabel={title} role="button" accessible={false}>
                            {contentArea}
                        </PressableWithoutFeedback_1.default>) : (contentArea)}
