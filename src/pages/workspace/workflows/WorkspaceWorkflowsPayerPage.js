...
function WorkspaceWorkflowsPayerPage(_a) {
    ...
    var _f = (0, useLocalize_1.default)(), translate = _f.translate, formatPhoneNumber = _f.formatPhoneNumber;
    ...
    }, [personalDetails, policy === null || policy === void 0 ? void 0 : policy.employeeList, translate, (_c = policy === null || policy === void 0 ? void 0 : policy.achAccount) === null || _c === void 0 ? void 0 : _c.reimburser, isDeletedPolicyEmployee, policy === null || policy === void 0 ? void 0 : policy.owner, (_d = policy === null || policy === void 0 ? void 0 : policy.pendingFields) === null || _d === void 0 ? void 0 : _d.reimburser, formatPhoneNumber]), formattedPolicyAdmins = _j[0], formattedAuthorizedPayer = _j[1];
    var sections = (0, react_1.useMemo)(function () {
        var sectionsArray = [];
        if (searchTerm !== '') {
            var searchValue = (0, OptionsListUtils_1.getSearchValueForPhoneOrEmail)(searchTerm, countryCode);
    ...
    var totalNumberOfEmployeesEitherOwnerOrAdmin = (0, react_1.useMemo)(function () {
        var _a;
        return Object.entries((_a = policy === null || policy === void 0 ? void 0 : policy.employeeList) !== null && _a !== void 0 ? _a : {}).filter(function (_a) {
            var email = _a[0], policyEmployee = _a[1];
            var isOwner = (policy === null || policy === void 0 ? void 0 : policy.owner) === email;
            var isAdmin = policyEmployee.role === CONST_1.default.POLICY.ROLE.ADMIN;
            return !isDeletedPolicyEmployee(policyEmployee) && (isOwner || isAdmin);
        });
    }, [isDeletedPolicyEmployee, policy === null || policy === void 0 ? void 0 : policy.employeeList, policy === null || policy === void 0 ? void 0 : policy.owner]);
    var shouldShowSearchInput = totalNumberOfEmployeesEitherOwnerOrAdmin.length >= CONST_1.default.STANDARD_LIST_ITEM_LIMIT;
    var textInputLabel = shouldShowSearchInput ? translate('selectionList.findMember') : undefined;
