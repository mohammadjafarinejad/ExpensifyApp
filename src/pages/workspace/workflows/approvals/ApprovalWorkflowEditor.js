...
function ApprovalWorkflowEditor(_a) {
    var _b, _c, _d, _e;
    var approvalWorkflow = _a.approvalWorkflow, removeApprovalWorkflow = _a.removeApprovalWorkflow, policy = _a.policy, policyID = _a.policyID, ref = _a.ref;
    var styles = (0, useThemeStyles_1.default)();
    var _f = (0, useLocalize_1.default)(), translate = _f.translate, toLocaleOrdinal = _f.toLocaleOrdinal, localeCompare = _f.localeCompare;
    ...
    var approverErrorMessage = (0, react_1.useCallback)(function (approver, approverIndex) {
        var _a;
        var previousApprover = approvalWorkflow.approvers.slice(0, approverIndex).findLast(Boolean);
...
exports.default = ApprovalWorkflowEditor;
