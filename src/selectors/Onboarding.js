...
exports.isOnboardingLoadingSelector = isOnboardingLoadingSelector;
 ...
 */
function isOnboardingLoadingSelector(onboarding) {
    return !!(onboarding === null || onboarding === void 0 ? void 0 : onboarding.isLoading);
}
