...
var createModalStyleUtils = function (_a) {
    ...
    return ({
        getModalStyles: function (type, windowDimensions, popoverAnchorPosition, innerContainerStyle, outerStyle, shouldUseModalPaddingStyle, safeAreaOptions) {
            ...
            if (safeAreaOptions === void 0) { safeAreaOptions = { modalOverlapsWithTopSafeArea: false, shouldDisableBottomSafeAreaPadding: false }; }
            ...
            switch (type) {
                ...
                case CONST_1.default.MODAL.MODAL_TYPE.CONFIRM:
                    ...
                    modalStyle = __assign(__assign({}, modalStyle), { justifyContent: 'center', alignItems: 'center', height: '100%' });
                    modalContainerStyle = {
                ...
                case CONST_1.default.MODAL.MODAL_TYPE.CENTERED:
                    ...
                    modalStyle = __assign(__assign({}, modalStyle), { alignItems: 'center', height: '100%' });
                ...
                case CONST_1.default.MODAL.MODAL_TYPE.CENTERED_UNSWIPEABLE:
                    ...
                    modalStyle = __assign(__assign({}, modalStyle), { alignItems: 'center', justifyContent: 'center', height: '100%' });
                ...
                case CONST_1.default.MODAL.MODAL_TYPE.BOTTOM_DOCKED:
                    modalStyle = __assign(__assign({}, modalStyle), { alignItems: 'center', justifyContent: 'flex-end', height: '100%' });
                    modalContainerStyle = __assign({ width: '100%', borderTopLeftRadius: variables_1.default.componentBorderRadiusLarge, borderTopRightRadius: variables_1.default.componentBorderRadiusLarge, justifyContent: 'center', overflow: 'hidden', boxShadow: theme.shadow }, ((0, Browser_1.isMobileSafari)() ? { maxHeight: "".concat(windowDimensions.windowHeight, "px") } : {}));
                    ...
                    shouldAddBottomSafeAreaPadding = !(safeAreaOptions === null || safeAreaOptions === void 0 ? void 0 : safeAreaOptions.shouldDisableBottomSafeAreaPadding);
                    shouldAddTopSafeAreaMargin = !!(safeAreaOptions === null || safeAreaOptions === void 0 ? void 0 : safeAreaOptions.modalOverlapsWithTopSafeArea);
                    swipeDirection = undefined;
                    animationIn = 'slideInUp';
                    animationOut = 'slideOutDown';
                    break;
                case CONST_1.default.MODAL.MODAL_TYPE.POPOVER:
                    modalStyle = __assign(__assign(__assign({}, modalStyle), popoverAnchorPosition), { position: 'absolute', alignItems: 'center', justifyContent: 'flex-end' });
                    modalContainerStyle = {
                        borderRadius: variables_1.default.componentBorderRadiusLarge,
                        borderWidth: 1,
                ...
                case CONST_1.default.MODAL.MODAL_TYPE.RIGHT_DOCKED:
                    modalStyle = __assign(__assign({}, modalStyle), { marginLeft: isSmallScreenWidth ? 0 : windowWidth - variables_1.default.sideBarWidth, width: isSmallScreenWidth ? '100%' : variables_1.default.sideBarWidth, flexDirection: 'row', justifyContent: 'flex-end', height: '100%' });
                    modalContainerStyle = {
