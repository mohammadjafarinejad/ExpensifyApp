...
var workspaceColorOptions = PresetAvatarCatalog_1.LETTER_AVATAR_COLOR_OPTIONS.map(function (_a) {
    var backgroundColor = _a.backgroundColor, fillColor = _a.fillColor;
    return ({ backgroundColor: backgroundColor, fill: fillColor });
});
var DEFAULT_WORKSPACE_COLOR = { backgroundColor: colors_1.default.blue400, fill: colors_1.default.blue700 };
...
function getDefaultWorkspaceAvatarColor(text) {
    ...
    return (_a = workspaceColorOptions.at(colorHash)) !== null && _a !== void 0 ? _a : DEFAULT_WORKSPACE_COLOR;
}
/**
...
function getZoomSizingStyle(_a) {
    var imageSize = _a.imageSize, containerSize = _a.containerSize, zoomScale = _a.zoomScale, isZoomed = _a.isZoomed, isLoading = _a.isLoading;
    // Hide image until finished loading to prevent showing preview with wrong dimensions
    if (isLoading || imageSize.width === 0 || imageSize.height === 0) {
        return undefined;
    }
    var top = "".concat(Math.max((containerSize.height - imageSize.height) / 2, 0), "px");
    var left = "".concat(Math.max((containerSize.width - imageSize.width) / 2, 0), "px");
    ...
    if (isZoomed) {
        ...
        if (zoomScale >= 1) {
            return {
                height: "".concat(imageSize.height * zoomScale, "px"),
                width: "".concat(imageSize.width * zoomScale, "px"),
            };
        }
    ...
    var scaledTop = "".concat(Math.max((containerSize.height - imageSize.height * zoomScale) / 2, 0), "px");
    var scaledLeft = "".concat(Math.max((containerSize.width - imageSize.width * zoomScale) / 2, 0), "px");
    return {
        height: "".concat(imageSize.height * zoomScale, "px"),
        width: "".concat(imageSize.width * zoomScale, "px"),
        top: scaledTop,
...
function getIconWidthAndHeightStyle(extraSmall, small, medium, large, width, height, isButtonIcon) {
    switch (true) {
        case extraSmall:
            return { width: isButtonIcon ? variables_1.default.iconSizeXXSmall : variables_1.default.iconSizeExtraSmall, height: isButtonIcon ? variables_1.default.iconSizeXXSmall : variables_1.default.iconSizeExtraSmall };
        case small:
...
function getButtonStyleWithIcon(styles, extraSmall, small, medium, large, hasIcon, hasText, shouldShowRightIcon) {
    ...
    switch (true) {
        case extraSmall: {
            ...
            return useDefaultButtonStyles ? styles.buttonExtraSmall : __assign(__assign({}, styles.buttonExtraSmall), (hasText ? verticalStyle : styles.ph0));
        }
        case small: {
            var verticalStyle = hasIcon ? styles.pl2 : styles.pr2;
...
function hasSafeAreas(windowWidth, windowHeight) {
    var heightsIPhonesWithNotches = new Set([812, 896, 844, 926]);
...
function getDropDownButtonHeight(buttonSize) {
    ...
    if (buttonSize === CONST_1.default.DROPDOWN_BUTTON_SIZE.EXTRA_SMALL) {
        return {
            height: variables_1.default.componentSizeXSmall,
        };
    }
    return {
...
var createStyleUtils = function (theme, styles) { return (__assign(__assign(__assign(__assign(__assign({}, staticStyleUtils), (0, ModalStyleUtils_1.default)({ theme: theme, styles: styles })), (0, TooltipStyleUtils_1.default)({ theme: theme, styles: styles })), (0, ReportActionContextMenuStyleUtils_1.default)({ theme: theme, styles: styles })), { getCompactContentContainerStyles: function () { return (0, optionRowStyles_1.compactContentContainerStyles)(styles); }, getContextMenuItemStyles: function (windowWidth) { return (0, getContextMenuItemStyles_1.default)(styles, windowWidth); }, getContainerComposeStyles: function () { return (0, containerComposeStyles_1.default)(styles); }, 
    ...
    getDotIndicatorTextStyles: function (isErrorText) {
        ...
        return (isErrorText ? __assign(__assign({}, styles.offlineFeedbackText), { color: styles.formError.color }) : __assign({}, styles.offlineFeedbackText));
    ...
    getThemeBackgroundColor: function (bgColor) {
        ...
        switch (columnName) {
            ...
            case CONST_1.default.SEARCH.TABLE_COLUMNS.RECEIPT:
                ...
                break;
            case CONST_1.default.SEARCH.TABLE_COLUMNS.AVATAR:
                columnWidth = __assign(__assign({}, getWidthStyle(variables_1.default.w40)), styles.alignItemsCenter);
                break;
            case CONST_1.default.SEARCH.TABLE_COLUMNS.STATUS:
            ...
            case CONST_1.default.SEARCH.TABLE_COLUMNS.TOTAL:
