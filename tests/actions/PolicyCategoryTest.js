...
describe('actions/PolicyCategory', function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        Category.createPolicyCategory(fakePolicy.id, newCategoryName, false, undefined, undefined, CONST_1.default.DEFAULT_NUMBER_ID);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 1:
                        _c.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
    ...
    describe('renameWorkspaceCategory', function () {
        it('Rename category', function () { return __awaiter(void 0, void 0, void 0, function () {
            var fakePolicy, fakeCategories, oldCategoryName, newCategoryName, policyData;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
    ...
    describe('setWorkspaceCategoriesEnabled', function () {
        it('Enable category', function () { return __awaiter(void 0, void 0, void 0, function () {
            var fakePolicy, fakeCategories, categoryNameToUpdate, categoriesToUpdate, policyData;
            var _a;
            var _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.POLICY_CATEGORIES).concat(fakePolicy.id), fakeCategories);
                        policyData = (0, react_native_1.renderHook)(function () { return (0, usePolicyData_1.default)(fakePolicy.id); }, { wrapper: OnyxListItemProvider_1.default }).result;
                        Category.setWorkspaceCategoryEnabled(policyData.current, categoriesToUpdate, false, undefined, undefined, CONST_1.default.DEFAULT_NUMBER_ID);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 1:
                        _e.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
    ...
    describe('deleteWorkspaceCategories', function () {
        it('Delete category', function () { return __awaiter(void 0, void 0, void 0, function () {
            var fakePolicy, fakeCategories, categoryNameToDelete, categoriesToDelete, policyData;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.POLICY_CATEGORIES).concat(fakePolicy.id), fakeCategories);
                        policyData = (0, react_native_1.renderHook)(function () { return (0, usePolicyData_1.default)(fakePolicy.id); }, { wrapper: OnyxListItemProvider_1.default }).result;
                        Category.deleteWorkspaceCategories(policyData.current, categoriesToDelete, false, undefined, undefined, CONST_1.default.DEFAULT_NUMBER_ID);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 1:
                        _d.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
