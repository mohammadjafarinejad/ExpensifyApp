...
describe('actions/PolicyMember', function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        fakeReport = __assign(__assign({}, (0, reports_1.createRandomReport)(0, undefined)), { policyID: fakePolicy.id });
                ...
                switch (_h.label) {
                    case 0:
                        ...
                        fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { employeeList: (_a = {},
                                ...
                                _a) });
                        adminRoom = __assign(__assign({}, (0, reports_1.createRandomReport)(1, CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS)), { policyID: fakePolicy.id });
                    ...
                    case 1:
                        ...
                        Member.updateWorkspaceMembersRole(fakePolicy.id, [(_e = fakeUser2.login) !== null && _e !== void 0 ? _e : ''], [fakeUser2.accountID], CONST_1.default.POLICY.ROLE.ADMIN);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 2:
                        _h.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
                    ...
                    case 4:
                        _h.sent();
                        return [4 /*yield*/, ((_f = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.resume) === null || _f === void 0 ? void 0 : _f.call(mockFetch))];
                    case 5:
                        _h.sent();
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 6:
                    ...
                    case 8:
                        ...
                        Member.updateWorkspaceMembersRole(fakePolicy.id, [(_g = fakeUser2.login) !== null && _g !== void 0 ? _g : ''], [fakeUser2.accountID], CONST_1.default.POLICY.ROLE.USER);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 9:
                        _h.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.sent();
                        (_b = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.pause) === null || _b === void 0 ? void 0 : _b.call(mockFetch);
                        Member.addMembersToWorkspace((_a = {}, _a[newUserEmail] = 1234, _a), 'Welcome', policyID, [], CONST_1.default.POLICY.ROLE.USER, TestHelper.formatPhoneNumber);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 2:
                        _d.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
        ...
        it('Add new members with admin/auditor role to the #admins room', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        _h.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(adminRoomID), __assign(__assign({}, (0, reports_1.createRandomReport)(Number(adminRoomID), CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS)), { policyID: policyID, participants: (_a = {},
                                    _a[ownerAccountID] = { notificationPreference: 'always' },
                                    _a) }))];
                    case 2:
                        _h.sent();
                        // When adding a new admin, auditor, and user members
                        Member.addMembersToWorkspace((_b = {}, _b[adminEmail] = adminAccountID, _b), 'Welcome', policyID, [], CONST_1.default.POLICY.ROLE.ADMIN, TestHelper.formatPhoneNumber);
                        Member.addMembersToWorkspace((_c = {}, _c[auditorEmail] = auditorAccountID, _c), 'Welcome', policyID, [], CONST_1.default.POLICY.ROLE.AUDITOR, TestHelper.formatPhoneNumber);
                        Member.addMembersToWorkspace((_d = {}, _d[userEmail] = userAccountID, _d), 'Welcome', policyID, [], CONST_1.default.POLICY.ROLE.USER, TestHelper.formatPhoneNumber);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 3:
                        _h.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        userAccountID = 1236;
                        userEmail = 'user@example.com';
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(workspaceReportID), __assign(__assign({}, (0, reports_1.createRandomReport)(Number(workspaceReportID), CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT)), { policyID: policyID, ownerAccountID: userAccountID }))];
                    case 1:
                        _c.sent();
                    ...
                    case 4:
                        ...
                        Member.addMembersToWorkspace((_b = {}, _b[userEmail] = userAccountID, _b), 'Welcome', policyID, [], CONST_1.default.POLICY.ROLE.USER, TestHelper.formatPhoneNumber);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 5:
                        _c.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
    ...
    describe('removeMembers', function () {
        it('Remove members with admin/auditor role from the #admins room', function () { return __awaiter(void 0, void 0, void 0, function () {
            var policyID, adminRoomID, defaultApprover, ownerAccountID, ownerEmail, adminAccountID, adminEmail, auditorAccountID, auditorEmail, userAccountID, userEmail, memberEmailsToAccountIDs, optimisticAdminRoomMetadata, successAdminRoomMetadata;
            var _a, _b, _c, _d;
            ...
            return __generator(this, function (_m) {
                switch (_m.label) {
                    ...
                    case 2:
                        _m.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(adminRoomID), __assign(__assign({}, (0, reports_1.createRandomReport)(Number(adminRoomID), CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS)), { policyID: policyID, participants: (_c = {},
                    ...
                    case 3:
                        ...
                        memberEmailsToAccountIDs = (_d = {},
                            _d[adminEmail] = adminAccountID,
                            _d[auditorEmail] = auditorAccountID,
                            _d[userEmail] = userAccountID,
                            _d);
                    ...
                    case 5:
                        optimisticAdminRoomMetadata = _m.sent();
                        expect((_f = optimisticAdminRoomMetadata === null || optimisticAdminRoomMetadata === void 0 ? void 0 : optimisticAdminRoomMetadata.pendingChatMembers) === null || _f === void 0 ? void 0 : _f.length).toBe(2);
                        expect((_h = (_g = optimisticAdminRoomMetadata === null || optimisticAdminRoomMetadata === void 0 ? void 0 : optimisticAdminRoomMetadata.pendingChatMembers) === null || _g === void 0 ? void 0 : _g.find(function (pendingMember) { return pendingMember.accountID === String(adminAccountID); })) === null || _h === void 0 ? void 0 : _h.pendingAction).toBe(CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE);
                        expect((_k = (_j = optimisticAdminRoomMetadata === null || optimisticAdminRoomMetadata === void 0 ? void 0 : optimisticAdminRoomMetadata.pendingChatMembers) === null || _j === void 0 ? void 0 : _j.find(function (pendingMember) { return pendingMember.accountID === String(auditorAccountID); })) === null || _k === void 0 ? void 0 : _k.pendingAction).toBe(CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE);
                        return [4 /*yield*/, ((_l = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.resume) === null || _l === void 0 ? void 0 : _l.call(mockFetch))];
                    case 6:
                        _m.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
                                var connection = react_native_onyx_1.default.connect({
                    ...
                    case 7:
                        successAdminRoomMetadata = _m.sent();
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        Member.removeMembers(policyID, [userEmail], (_b = {}, _b[userEmail] = userAccountID, _b));
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 3:
                        _e.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
                    ...
                    case 4:
                        isWorkspaceChatArchived = _e.sent();
                        return [4 /*yield*/, new Promise(function (resolve) {
                                var connection = react_native_onyx_1.default.connect({
                                    key: "".concat(ONYXKEYS_1.default.COLLECTION.REPORT_NAME_VALUE_PAIRS).concat(expenseReportID),
                                    callback: function (nvp) {
                    ...
                    case 5:
                        isExpenseReportArchived = _e.sent();
        ...
        it('should preserve pendingAction DELETE when member removal fails', function () { return __awaiter(void 0, void 0, void 0, function () {
            var policyID, userAccountID, userEmail, ownerEmail, policy, failedMember;
            var _a, _b, _c;
            var _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        _g.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID), __assign(__assign({}, (0, policies_1.default)(Number(policyID))), { owner: ownerEmail, employeeList: (_b = {},
                                    _b[ownerEmail] = { role: CONST_1.default.POLICY.ROLE.ADMIN },
                                    _b[userEmail] = { role: CONST_1.default.POLICY.ROLE.USER },
                                    _b) }))];
                    case 2:
                        ...
                        Member.removeMembers(policyID, [userEmail], (_c = {}, _c[userEmail] = userAccountID, _c));
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 3:
                        _g.sent();
                    ...
                    case 4:
                        policy = _g.sent();
                        failedMember = (_e = policy === null || policy === void 0 ? void 0 : policy.employeeList) === null || _e === void 0 ? void 0 : _e[userEmail];
                        expect(failedMember === null || failedMember === void 0 ? void 0 : failedMember.pendingAction).toBe(CONST_1.default.RED_BRICK_ROAD_PENDING_ACTION.DELETE);
                        expect(failedMember === null || failedMember === void 0 ? void 0 : failedMember.errors).toBeTruthy();
                        expect(Object.keys((_f = failedMember === null || failedMember === void 0 ? void 0 : failedMember.errors) !== null && _f !== void 0 ? _f : {}).length).toBeGreaterThan(0);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 1, updated: 0 });
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 2, updated: 0 });
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 0, updated: 0 });
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 0, updated: 1 });
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 0, updated: 2 });
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 1, updated: 1 });
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKey).toBe('spreadsheet.importMembersSuccessfulDescription');
                        expect(importedSpreadsheet === null || importedSpreadsheet === void 0 ? void 0 : importedSpreadsheet.importFinalModal.promptKeyParams).toStrictEqual({ added: 2, updated: 2 });
                        return [2 /*return*/];
                }
            });
        }); });
