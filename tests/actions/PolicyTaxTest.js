...
describe('actions/PolicyTax', function () {
    var _a;
    var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { taxRates: CONST_1.default.DEFAULT_TAX, customUnits: (_a = {},
            _a[CONST_1.default.CUSTOM_UNITS.NAME_DISTANCE] = {
    ...
    describe('RenamePolicyTax', function () {
        it('Rename tax', function () {
            ...
            (0, TaxRate_1.renamePolicyTax)(fakePolicy.id, taxID, newTaxName, (_b = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _b === void 0 ? void 0 : _b.taxes[taxID]);
            return (0, waitForBatchedUpdates_1.default)()
                .then(function () {
                return new Promise(function (resolve) {
                    var connection = react_native_onyx_1.default.connect({
        ...
        it('Rename tax but API returns an error, then recover the original tax`s name', function () {
            ...
            (_b = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.pause) === null || _b === void 0 ? void 0 : _b.call(mockFetch);
            // @ts-expect-error - we can send undefined tax rate here for testing
            (0, TaxRate_1.renamePolicyTax)(fakePolicy.id, taxID, newTaxName, (_c = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _c === void 0 ? void 0 : _c.taxes[taxID]);
            return (0, waitForBatchedUpdates_1.default)()
                .then(function () {
                return new Promise(function (resolve) {
                    var connection = react_native_onyx_1.default.connect({
    ...
    describe('UpdatePolicyTaxValue', function () {
        it('Update tax`s value', function () {
            ...
            (_a = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.pause) === null || _a === void 0 ? void 0 : _a.call(mockFetch);
            // @ts-expect-error - we can send undefined tax rate here for testing
            (0, TaxRate_1.updatePolicyTaxValue)(fakePolicy.id, taxID, newTaxValue, (_b = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _b === void 0 ? void 0 : _b.taxes[taxID]);
            return (0, waitForBatchedUpdates_1.default)()
                .then(function () {
                return new Promise(function (resolve) {
                    var connection = react_native_onyx_1.default.connect({
        ...
        it('Update tax`s value but API returns an error, then recover the original tax`s value', function () {
            ...
            (_b = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.pause) === null || _b === void 0 ? void 0 : _b.call(mockFetch);
            // @ts-expect-error - we can send undefined tax rate here for testing
            (0, TaxRate_1.updatePolicyTaxValue)(fakePolicy.id, taxID, newTaxValue, (_c = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _c === void 0 ? void 0 : _c.taxes[taxID]);
            return (0, waitForBatchedUpdates_1.default)()
                .then(function () {
                return new Promise(function (resolve) {
                    var connection = react_native_onyx_1.default.connect({
    ...
    describe('SetPolicyTaxCode', function () {
        var _a, _b;
        var oldTaxCode = 'id_TAX_RATE_1';
        var newTaxCode = 'id_TAX_RATE_2';
        var oldTaxRateName = (_b = (_a = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _a === void 0 ? void 0 : _a.taxes[oldTaxCode]) === null || _b === void 0 ? void 0 : _b.name;
        it('Set policy`s tax code', function () {
            var _a, _b, _c, _d, _e;
            (_a = mockFetch === null || mockFetch === void 0 ? void 0 : mockFetch.pause) === null || _a === void 0 ? void 0 : _a.call(mockFetch);
            var distanceRateCustomUnit = (_b = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.customUnits) === null || _b === void 0 ? void 0 : _b[CONST_1.default.CUSTOM_UNITS.NAME_DISTANCE];
            (0, TaxRate_1.setPolicyTaxCode)(fakePolicy.id, oldTaxCode, newTaxCode, 
            // @ts-expect-error - we can send undefined tax rate here for testing
            (_c = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _c === void 0 ? void 0 : _c.taxes[oldTaxCode], (_d = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _d === void 0 ? void 0 : _d.foreignTaxDefault, (_e = fakePolicy === null || fakePolicy === void 0 ? void 0 : fakePolicy.taxRates) === null || _e === void 0 ? void 0 : _e.defaultExternalID, distanceRateCustomUnit);
                ...
                return new Promise(function (resolve) {
                    var connection = react_native_onyx_1.default.connect({
                        ...
                        callback: function (policy) {
                            ...
                            react_native_onyx_1.default.disconnect(connection);
                            var taxRates = policy === null || policy === void 0 ? void 0 : policy.taxRates;
                            var updatedTaxRate = (_a = taxRates === null || taxRates === void 0 ? void 0 : taxRates.taxes) === null || _a === void 0 ? void 0 : _a[newTaxCode];
                            // We expected to have a new tax rate with the new tax code
                            expect(updatedTaxRate).toBeDefined();
                            expect(updatedTaxRate === null || updatedTaxRate === void 0 ? void 0 : updatedTaxRate.previousTaxCode).toBe(oldTaxCode);
                            expect(updatedTaxRate === null || updatedTaxRate === void 0 ? void 0 : updatedTaxRate.name).toBe(oldTaxRateName);
                            resolve();
                        },
                    });
                });
