...
globals_1.jest.mock('@libs/actions/Link', function () {
    return {
        buildOldDotURL: globals_1.jest.fn(function () { return Promise.resolve('mockOldDotURL'); }),
        openExternalLink: globals_1.jest.fn(),
    };
});
...
describe('Session', function () {
    ...
    (0, globals_1.test)('Push notifications are subscribed after signing in', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    expect(PushNotification_1.default.register).toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, globals_1.test)('Push notifications are unsubscribed after signing out', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    expect(PushNotification_1.default.deregister).toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    describe('SignOutAndRedirectToSignIn', function () {
        (0, globals_1.test)('SignOutAndRedirectToSignIn should redirect to OldDot when LogOut returns truthy hasOldDotAuthCookies', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        expect(asyncOpenURL_1.default).toHaveBeenCalledWith(expect.any(Promise), "".concat(CONFIG_1.default.EXPENSIFY.EXPENSIFY_URL).concat(CONST_1.default.OLDDOT_URLS.SIGN_OUT), true, true);
        ...
        (0, globals_1.test)('SignOutAndRedirectToSignIn should restore stashed session and redirect to OldDot supportal of supportal agent', function () { return __awaiter(void 0, void 0, void 0, function () {
            var testStashedCredentials, testStashedSession, onyxClearSpy, onyxMultiSetSpy;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        globals_1.jest.spyOn(SessionUtil, 'isSupportAuthToken').mockReturnValue(true);
                        globals_1.jest.spyOn(SessionUtil, 'hasStashedSession').mockReturnValue(true);
                        globals_1.jest.spyOn(SessionUtil, 'signOut').mockResolvedValue(undefined);
                        globals_1.jest.spyOn(react_native_onyx_1.default, 'clear').mockResolvedValue(undefined);
                        globals_1.jest.spyOn(react_native_onyx_1.default, 'multiSet').mockResolvedValue(undefined);
                        testStashedCredentials = { login: 'stashed@expensify.com', autoGeneratedLogin: 'stashedAutoLogin', autoGeneratedPassword: 'stashedAutoPassword' };
                        testStashedSession = { authToken: 'stashedAuthToken', email: 'stashed@expensify.com', accountID: 123, creationDate: new Date().getTime() };
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.STASHED_CREDENTIALS, testStashedCredentials)];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.STASHED_SESSION, testStashedSession)];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.SESSION, { authTokenType: CONST_1.default.AUTH_TOKEN_TYPES.SUPPORT })];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 4:
                        _b.sent();
                        onyxClearSpy = react_native_onyx_1.default.clear;
                        onyxMultiSetSpy = react_native_onyx_1.default.multiSet;
                        (0, Session_1.signOutAndRedirectToSignIn)(false, false, true, true);
                        return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                    case 5:
                        _b.sent();
                        expect(SessionUtil.signOut).not.toHaveBeenCalled();
                        expect(onyxClearSpy).toHaveBeenCalledWith(Session_1.KEYS_TO_PRESERVE_SUPPORTAL);
                        expect(onyxMultiSetSpy).toHaveBeenCalledWith((_a = {},
                            _a[ONYXKEYS_1.default.CREDENTIALS] = testStashedCredentials,
                            _a[ONYXKEYS_1.default.SESSION] = testStashedSession,
                            _a));
                        expect(Link_1.buildOldDotURL).toHaveBeenCalledWith(CONST_1.default.OLDDOT_URLS.SUPPORTAL_RESTORE_STASHED_LOGIN);
                        expect(Link_1.openExternalLink).toHaveBeenCalledWith('mockOldDotURL', undefined, true);
                        return [2 /*return*/];
                }
            });
        }); });
