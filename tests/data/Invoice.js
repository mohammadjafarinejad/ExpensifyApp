...
var convertedInvoiceChat = {
    ...
    lastActionType: CONST_1.default.REPORT.ACTIONS.TYPE.REPORT_PREVIEW,
    ...
    participants: {
        ...
        '33': {
            notificationPreference: 'always',
            permissions: [CONST_1.default.REPORT.PERMISSIONS.READ, CONST_1.default.REPORT.PERMISSIONS.WRITE, CONST_1.default.REPORT.PERMISSIONS.SHARE, CONST_1.default.REPORT.PERMISSIONS.OWN],
        },
    },
    policyAvatar: '',
    policyID: 'CC048FA711B35B1F',
...
exports.convertedInvoiceChat = convertedInvoiceChat;
