...
var getMockedReports = function (length) {
    ...
    return (0, createCollection_1.default)(function (item) { return "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(item.reportID); }, function (index) { return (0, reports_1.createRandomReport)(index, undefined); }, length);
};
...
test('[ModifiedExpenseMessage] getForReportAction on 1k reports and policies', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, react_native_onyx_1.default.multiSet(__assign(__assign({}, mockedPoliciesMap), mockedReportsMap))];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return (0, ModifiedExpenseMessage_1.getForReportAction)({ reportAction: reportAction, policyID: report.policyID }); })];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
