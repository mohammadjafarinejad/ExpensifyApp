    ...
    test('[OptionsListUtils] getSearchOptions', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return (0, OptionsListUtils_1.getSearchOptions)({ options: options, betas: mockedBetas, draftComments: {}, nvpDismissedProductTraining: nvpDismissedProductTraining }); })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('[OptionsListUtils] getFilteredOptions with search value', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    formattedOptions = (0, OptionsListUtils_1.getValidOptions)({ reports: options.reports, personalDetails: options.personalDetails }, {}, nvpDismissedProductTraining, ValidOptionsConfig);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () {
                            return (0, OptionsListUtils_1.getValidOptions)({ reports: options.reports, personalDetails: options.personalDetails }, {}, nvpDismissedProductTraining, {
                                betas: mockedBetas,
                                includeMultipleParticipantReports: true,
    ...
    test('[OptionsListUtils] getMemberInviteOptions', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return (0, OptionsListUtils_1.getMemberInviteOptions)(options.personalDetails, nvpDismissedProductTraining, mockedBetas); })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
