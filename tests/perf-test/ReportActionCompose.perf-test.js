...
jest.mock('react-native-reanimated', function () { return (__assign(__assign({}, jest.requireActual('react-native-reanimated/mock')), { useAnimatedRef: jest.fn(), LayoutAnimationConfig: function (_a) {
        var children = _a.children;
        return children;
    }, Keyframe: jest.fn().mockImplementation(function () { return ({
...
jest.mock('../../src/libs/Navigation/Navigation', function () { return ({
    ...
    isTopmostRouteModalScreen: jest.fn(function () { return false; }),
}); });
...
function ReportActionComposeWrapper() {
    return (<ComposeProviders_1.default components={[OnyxListItemProvider_1.default, LocaleContextProvider_1.LocaleContextProvider, withKeyboardState_1.KeyboardStateProvider]}>
            <ReportActionCompose_1.default onSubmit={function () { return jest.fn(); }} reportID="1" report={LHNTestUtils.getFakeReport()} isComposerFullSize/>
            ...
            case 0:
                scenario = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                hintAttachmentButtonText = (0, TestHelper_1.translateLocal)('common.create');
            ...
            case 0:
                scenario = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                hintSendButtonText = (0, TestHelper_1.translateLocal)('common.send');
