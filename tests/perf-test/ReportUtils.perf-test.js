...
var getMockedReports = function (length) {
    ...
    return (0, createCollection_1.default)(function (item) { return "".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(item.reportID); }, function (index) { return (0, reports_2.createRandomReport)(index, undefined); }, length);
};
...
describe('ReportUtils', function () {
    ...
    test('[ReportUtils] canDeleteReportAction on 1k reports and policies', function () { return __awaiter(void 0, void 0, void 0, function () {
        var reportID, transaction, reportAction;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    reportID = '1';
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return (0, ReportUtils_1.canDeleteReportAction)(reportAction, reportID, transaction, undefined, undefined); })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('[ReportUtils] getReportRecipientAccountID on 1k participants', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = __assign(__assign({}, (0, reports_2.createRandomReport)(1, undefined)), { participantAccountIDs: participantAccountIDs });
    ...
    test('[ReportUtils] getIcons on 1k participants', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = __assign(__assign({}, (0, reports_2.createRandomReport)(1, undefined)), { parentReportID: '1', parentReportActionID: '1', type: CONST_1.default.REPORT.TYPE.CHAT });
    ...
    test('[ReportUtils] getDisplayNamesWithTooltips 1k participants', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return (0, ReportUtils_1.getDisplayNamesWithTooltips)(personalDetails, isMultipleParticipantReport, TestHelper_1.localeCompare, shouldFallbackToHidden); })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    report = (0, reports_2.createRandomReport)(1, undefined);
                    policy = (0, policies_1.default)(1);
    ...
    test('[ReportUtils] shouldReportBeInOptionList on 1k participant', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = __assign(__assign({}, (0, reports_2.createRandomReport)(1, undefined)), { participantAccountIDs: participantAccountIDs, type: CONST_1.default.REPORT.TYPE.CHAT });
                    currentReportId = '2';
                    isInFocusMode = true;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () {
                            return (0, ReportUtils_1.shouldReportBeInOptionList)({
                                report: report,
    ...
    test('[ReportUtils] getMoneyRequestOptions on 1k participants', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = __assign(__assign({}, (0, reports_2.createRandomReport)(1, CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT)), { isOwnPolicyExpenseChat: true });
                    policy = (0, policies_1.default)(1);
    ...
    test('[ReportUtils] pushTransactionViolationsOnyxData on 1k reports with random expenses on each report', function () { return __awaiter(void 0, void 0, void 0, function () {
        var policyID, reports, policyData, policyUpdateData, onyxData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    policyID = '1';
                    reports = Object.values(getMockedReports(1000)).map(function (report) { return (__assign(__assign({}, report), { policyID: policyID })); });
                    policyData = {
                        reports: reports,
                        tags: (0, policyTags_1.default)('Tags', 8),
                        categories: (0, policyCategory_1.default)(8),
                        // Current policy with categories and tags enabled but does not require them
                        policy: __assign(__assign({}, (0, policies_1.default)(Number(policyID))), { areCategoriesEnabled: true, areTagsEnabled: true, requiresCategory: false, requiresTag: false }),
                        transactionsAndViolations: reports.reduce(function (acc, report, reportIndex) {
                            // Random number of transactions between 2 and 8
                            var numOfTransactionsInReport = (0, crypto_1.randomInt)(2, 8);
                            ...
                            for (var transactionID = reportIndex * numOfTransactionsInReport; transactionID < (reportIndex + 1) * numOfTransactionsInReport; transactionID++) {
                                acc[report.reportID].transactions[transactionID] = __assign(__assign({}, (0, transaction_1.default)(transactionID)), { reportID: report.reportID, category: undefined, tag: undefined });
                            }
                            return acc;
                        }, {}),
                    };
                    ...
                    return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return (0, ReportUtils_1.pushTransactionViolationsOnyxData)(onyxData, policyData, policyUpdateData); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
