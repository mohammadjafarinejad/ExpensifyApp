...
function SelectionListWrapper(_a) {
    ...
    return (<SelectionListWithSections_1.default textInputLabel="Perf test" sections={sections} onSelectRow={onSelectRow} initiallyFocusedOptionKey="item-0" ListItem={RadioListItem_1.default} canSelectMultiple={canSelectMultiple}/>);
}
