                ...
                case 0:
                    scenario = function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, react_native_1.screen.findByTestId('lhn-options-list')];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                    ...
                    scenario = function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                return [4 /*yield*/, (0, react_native_1.waitFor)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, react_native_1.screen.findByTestId('lhn-options-list')];
                                                case 1:
                                ...
                                case 1:
                                    // Wait for the sidebar container to be rendered first
                                    _a.sent();
                                    return [4 /*yield*/, react_native_1.screen.findByTestId('1')];
                                case 2:
                                    button = _a.sent();
