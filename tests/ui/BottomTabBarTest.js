...
jest.mock('@libs/Navigation/helpers/navigateToWorkspacesPage', function () { return ({
    default: jest.fn(),
    getWorkspaceNavigationRouteState: jest.fn(function () { return ({
...
var renderWithNavigation = function (component) {
    return (0, react_native_1.render)(<ComposeProviders_1.default components={[OnyxListItemProvider_1.default, LocaleContextProvider_1.LocaleContextProvider, useSidebarOrderedReports_1.SidebarOrderedReportsContextProvider]}>
            <native_1.NavigationContainer ref={navigationRef_1.default} onReady={function () {
                ...
                it('renders DebugTabView', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.sent();
                                renderWithNavigation(<NavigationTabBar_1.default selectedTab={NAVIGATION_TABS_1.default.HOME}/>);
                                _a = expect;
                ...
                it('renders DebugTabView', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                _c.sent();
                                renderWithNavigation(<NavigationTabBar_1.default selectedTab={NAVIGATION_TABS_1.default.SETTINGS}/>);
                                _a = expect;
                                return [4 /*yield*/, react_native_1.screen.findByTestId(DebugTabView_1.default.displayName)];
                            case 2:
