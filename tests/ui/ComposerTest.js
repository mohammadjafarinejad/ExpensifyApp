...
jest.mock('@components/RNMarkdownTextInput', function () {
    return jest.fn().mockImplementation(function () { return null; });
});
describe('Composer', function () {
    ...
    it('should show large emoji size if only has header markdown + emoji', function () { return __awaiter(void 0, void 0, void 0, function () {
        var props;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    props = (_a = RNMarkdownTextInput_1.default.mock.calls.at(0)) === null || _a === void 0 ? void 0 : _a.at(0);
