        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    report = __assign(__assign({}, (0, reports_1.createRandomReport)(Number(reportID), CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM)), { policyID: policyID });
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.NVP_PREFERRED_LOCALE), 'en')];
                                    case 1:
                                        _b.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(reportID), (_a = {},
                                                _a[reportActionID] = reportActionL,
                                                _a))];
                                    case 4:
                                        _b.sent();
                                        return [2 /*return*/];
