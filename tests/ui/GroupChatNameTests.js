...
jest.mock('@src/components/ReportActionAvatars', function () {
    var View = require('react-native').View;
    return function (_a) {
        var participants = _a.participants, _b = _a.size, size = _b === void 0 ? 'default' : _b;
        return (<View dataSet={{
...
jest.mock('@src/components/Indicator', function () {
    var View = require('react-native').View;
    return function (_a) {
        var _b = _a.isVisible, isVisible = _b === void 0 ? false : _b, props = __rest(_a, ["isVisible"]);
        return (<View dataSet={__assign({ isVisible: isVisible }, props)} testID="MockedIndicator"/>);
    };
});
// Mock TopBar component to prevent act() warnings
jest.mock('@src/components/Navigation/TopBar', function () {
    var View = require('react-native').View;
    return function (_a) {
        var title = _a.title, props = __rest(_a, ["title"]);
        return (<View dataSet={__assign({ title: title }, props)} testID="MockedTopBar"/>);
    };
});
// Mock NavigationTabBar component to prevent act() warnings
jest.mock('@src/components/Navigation/NavigationTabBar', function () {
    var View = require('react-native').View;
    return function (props) {
        return (<View dataSet={props} testID="MockedNavigationTabBar"/>);
    };
});
// Mock FloatingActionButtonAndPopover component to prevent act() warnings
jest.mock('@src/pages/home/sidebar/FloatingActionButtonAndPopover', function () {
    var View = require('react-native').View;
    return function (props) {
        return (<View dataSet={props} testID="MockedFloatingActionButtonAndPopover"/>);
    };
});
// Mock ProfileAvatarWithIndicator component to prevent act() warnings
jest.mock('@src/pages/home/sidebar/ProfileAvatarWithIndicator', function () {
    var View = require('react-native').View;
    return function (props) {
        return (<View dataSet={props} testID="MockedProfileAvatarWithIndicator"/>);
    };
});
TestHelper.setupApp();
var REPORT_ID = '1';
    ...
    return (0, waitForBatchedUpdatesWithAct_1.default)()
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    hintText = TestHelper.translateLocal('loginForm.loginForm');
...
describe('Tests for group chat name', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // Wait for sidebar to be rendered
                        _a.sent();
                        sidebarLinksHintText = TestHelper.translateLocal('sidebarScreen.listOfChats');
                        displayNameHintText = TestHelper.translateLocal('accessibilityHints.chatUserDisplayNames');
                        // Check sidebar links
    ...
    it('Should show last message preview in LHN', function () {
        return signInAndGetApp('A, B, C, D', participantAccountIDs4).then(function () {
            ...
            var optionRows = react_native_1.screen.queryAllByAccessibilityHint(TestHelper.getNavigateToChatHintRegex());
            expect(optionRows).toHaveLength(1);
            var lastChatHintText = TestHelper.translateLocal('accessibilityHints.lastChatMessagePreview');
