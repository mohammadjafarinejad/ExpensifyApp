...
jest.mock('@src/hooks/useRootNavigationState', function () {
...
describe('SidebarLinksData', function () {
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.NVP_PREFERRED_LOCALE, CONST_1.default.LOCALES.EN)];
                                    case 2:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
    ...
    describe('Report that should be included in the LHN', function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_DRAFT_COMMENT).concat(draftReport.reportID), 'draft report message')];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID), { isPinned: true })];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.NVP_PRIORITY_MODE, CONST_1.default.PRIORITY_MODE.DEFAULT)];
                                        case 1:
                                            _a.sent();
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.NVP_PRIORITY_MODE, CONST_1.default.PRIORITY_MODE.GSD)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(report.reportID), {
        ...
        it('should not change the current user personal detail when a report with last action is REPORTPREVIEW is displayed', function () { return __awaiter(void 0, void 0, void 0, function () {
            var report, lastReportAction, personalDetail;
            var _a, _b;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        // Given the SidebarLinks are rendered.
                        LHNTestUtils.getDefaultRenderedSidebarLinks();
                        report = __assign(__assign({}, createReport(undefined, [1, 2], undefined, undefined, undefined, true)), { lastActorAccountID: 1, lastMessageText: '123456' });
                        lastReportAction = __assign(__assign({}, (0, reportActions_1.default)(2)), { actionName: 'REPORTPREVIEW', actorAccountID: 2, message: [], originalMessage: undefined, person: [
                                {
                                    type: 'TEXT',
                                    style: 'strong',
                    ...
                    case 2:
                        _d.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.set("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(report.reportID), (_b = {}, _b[lastReportAction.reportActionID] = lastReportAction, _b))];
                    case 3:
                        _d.sent();
                        return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                    case 4:
                        _d.sent();
                        return [4 /*yield*/, (0, getOnyxValue_1.default)(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST)];
                    case 5:
                        personalDetail = _d.sent();
                        expect((_c = personalDetail === null || personalDetail === void 0 ? void 0 : personalDetail[TEST_USER_ACCOUNT_ID]) === null || _c === void 0 ? void 0 : _c.accountID).toBe(TEST_USER_ACCOUNT_ID);
                        return [2 /*return*/];
                }
            });
        }); });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.BETAS, [])];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reports_1.chatReportR14932.reportID), reports_1.chatReportR14932)];
                                        case 1:
                                            _b.sent();
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(parentReport.reportID), parentReport)];
                                        case 1:
                                            _b.sent();
                        ...
                        return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(report.reportID), (_a = {},
                                                _a[reportActionID] = reportAction,
                                                _a))];
                                        case 1:
                                            // And a report action collection with only a CREATED action is added
                                            _b.sent();
    ...
    describe('Inbox - GBR', function () {
        it('should display the report with GBR when the report has outstanding child task', function () { return __awaiter(void 0, void 0, void 0, function () {
            var reportWithOutstandingChildTask;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        // Given SidebarLinks are rendered initially.
                        LHNTestUtils.getDefaultRenderedSidebarLinks();
                        reportWithOutstandingChildTask = __assign(__assign({}, createReport(false, [1, 2], 0)), { hasOutstandingChildTask: true });
                        // When Onyx state is initialized with a draft report.
                        return [4 /*yield*/, initializeState((_a = {},
                                _a["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportWithOutstandingChildTask.reportID)] = reportWithOutstandingChildTask,
                                _a))];
                    case 1:
                        // When Onyx state is initialized with a draft report.
                        _b.sent();
