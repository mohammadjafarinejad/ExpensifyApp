...
var renderPage = function (_a) {
    var _b;
    var _c = _a.isWhisper, isWhisper = _c === void 0 ? false : _c, _d = _a.isHovered, isHovered = _d === void 0 ? false : _d, _e = _a.contextMenuAnchor, contextMenuAnchor = _e === void 0 ? null : _e;
            ...
            <OptionListContextProvider_1.default>
                <ScreenWrapper_1.default testID="test">
                    <portal_1.PortalProvider>
                        <MoneyRequestReportPreview_1.default allReports={_b = {},
            _b["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reports_1.chatReportR14932.iouReportID)] = reports_1.chatReportR14932,
            _b} policies={{}} policyID={reports_1.chatReportR14932.policyID} action={actions_1.actionR14932} iouReportID={reports_1.iouReportR14932.reportID} chatReportID={reports_1.chatReportR14932.chatReportID} contextMenuAnchor={contextMenuAnchor} checkIfContextMenuActive={function () { }} onPaymentOptionsShow={function () { }} onPaymentOptionsHide={function () { }} isHovered={isHovered} isWhisper={isWhisper}/>
                    </portal_1.PortalProvider>
...
var getTransactionDisplayAmountAndHeaderText = function (transaction) {
    ...
    var cashOrCard = isTransactionMadeWithCard ? TestHelper.translateLocal('iou.card') : TestHelper.translateLocal('iou.cash');
...
describe('MoneyRequestReportPreview', function () {
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.mergeCollection(ONYXKEYS_1.default.COLLECTION.TRANSACTION, mockOnyxTransactions)];
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                                    case 2:
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet(__assign(__assign({}, mockOnyxTransactions), mockOnyxViolations))];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                ...
                case 3:
                    _a.sent();
                    expect(react_native_1.screen.getAllByText(TestHelper.translateLocal('violations.reviewRequired'))).toHaveLength(2);
                    return [2 /*return*/];
            }
        });
    }); });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat(transactions_1.transactionR14932.transactionID), {})];
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION).concat(mockSecondTransactionID), {})];
                                    case 2:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
    ...
    it('renders Review button when violations exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var canReviewSpy, getReportPreviewActionSpy, reportWithViolations, reviewButton;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    canReviewSpy = jest.spyOn(require('@libs/ReportPreviewActionUtils'), 'canReview').mockReturnValue(true);
                    getReportPreviewActionSpy = jest.spyOn(require('@libs/ReportPreviewActionUtils'), 'getReportPreviewAction').mockReturnValue(CONST_1.default.REPORT.REPORT_PREVIEW_ACTIONS.REVIEW);
                    renderPage({});
                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                case 1:
                    _b.sent();
                    setCurrentWidth();
                    reportWithViolations = __assign(__assign({}, reports_1.iouReportR14932), { type: CONST_1.default.REPORT.TYPE.EXPENSE, statusNum: CONST_1.default.REPORT.STATUS_NUM.OPEN, stateNum: CONST_1.default.REPORT.STATE_NUM.OPEN });
                    return [4 /*yield*/, react_native_onyx_1.default.multiSet(__assign(__assign(__assign({}, mockOnyxTransactions), mockOnyxViolations), (_a = {}, _a["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reports_1.iouReportR14932.reportID)] = reportWithViolations, _a)))];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                case 3:
                    ...
                    expect(react_native_1.screen.getByText(TestHelper.translateLocal('common.review'))).toBeOnTheScreen();
                    reviewButton = react_native_1.screen.getByText(TestHelper.translateLocal('common.review'));
    ...
    it('does not render Review button when no violations exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var canReviewSpy, getReportPreviewActionSpy;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    canReviewSpy = jest.spyOn(require('@libs/ReportPreviewActionUtils'), 'canReview').mockReturnValue(false);
                    getReportPreviewActionSpy = jest.spyOn(require('@libs/ReportPreviewActionUtils'), 'getReportPreviewAction').mockReturnValue(CONST_1.default.REPORT.REPORT_PREVIEW_ACTIONS.VIEW);
                    renderPage({});
                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                case 1:
                    _a.sent();
                    ...
                    return [4 /*yield*/, react_native_onyx_1.default.mergeCollection(ONYXKEYS_1.default.COLLECTION.TRANSACTION, mockOnyxTransactions)];
                case 2:
                    // Set up transactions without violations
                    _a.sent();
                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                case 3:
                    ...
                    expect(react_native_1.screen.queryByText(TestHelper.translateLocal('common.review'))).not.toBeOnTheScreen();
                    // But View button should be rendered instead
                    expect(react_native_1.screen.getByText(TestHelper.translateLocal('common.view'))).toBeOnTheScreen();
                    // Clean up mocks
                    canReviewSpy.mockRestore();
                    getReportPreviewActionSpy.mockRestore();
                    return [2 /*return*/];
    ...
    it('Review button can be pressed when violations exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var canReviewSpy, getReportPreviewActionSpy, reviewButton;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    canReviewSpy = jest.spyOn(require('@libs/ReportPreviewActionUtils'), 'canReview').mockReturnValue(true);
                ...
                case 3:
                    ...
                    reviewButton = react_native_1.screen.getByText(TestHelper.translateLocal('common.review'));
                    expect(reviewButton).toBeOnTheScreen();
                    react_native_1.fireEvent.press(reviewButton);
