...
jest.mock('react-native-permissions', function () { return ({
    ...
    check: jest.fn(function () { return Promise.resolve('unavailable'); }),
    request: jest.fn(function () { return Promise.resolve('unavailable'); }),
    PERMISSIONS: {
        IOS: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () { return react_native_1.screen.getAllByText((0, TestHelper_1.translateLocal)('newChatPage.addToGroup')).at(0); })];
                case 3:
                    addButton = _a.sent();
                    if (addButton) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, {
                                            // eslint-disable-next-line @typescript-eslint/naming-convention
                    ...
                    case 3:
                        ...
                        addButton = (0, react_native_1.within)(userOption).queryByText((0, TestHelper_1.translateLocal)('newChatPage.addToGroup'));
