            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('onboarding.employees.1-10'))).toBeOnTheScreen();
                        })];
                case 4:
                    _a.sent();
                    unmount();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.queryByText(TestHelper.translateLocal('onboarding.employees.1-10'))).not.toBeOnTheScreen();
                        })];
                case 4:
                    _a.sent();
                    unmount();
