...
function getReportActions(reportID) {
    var report = getReportScreen(reportID);
    return __spreadArray(__spreadArray([], (0, react_native_1.within)(report).queryAllByLabelText(TestHelper.translateLocal('accessibilityHints.chatMessage')), true), (0, react_native_1.within)(report).queryAllByLabelText(TestHelper.translateLocal('accessibilityHints.chatWelcomeMessage')), true);
}
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0: return [4 /*yield*/, Promise.all([
                                            ...
                                            react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(COMMENT_LINKING_REPORT_ID), {
                                            ...
                                            react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(COMMENT_LINKING_REPORT_ID), {
