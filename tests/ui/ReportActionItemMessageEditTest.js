...
var ReportActionItemMessageEdit_1 = require("@pages/home/report/ReportActionItemMessageEdit");
var CONST_1 = require("@src/CONST");
var ONYXKEYS_1 = require("@src/ONYXKEYS");
var LHNTestUtils = require("../utils/LHNTestUtils");
var TestHelper = require("../utils/TestHelper");
var mockEditReportComment = jest.mocked(Report_1.editReportComment);
jest.mock('@libs/actions/Report', function () {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    var actual = jest.requireActual('@libs/actions/Report');
    // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    return __assign(__assign({}, actual), { editReportComment: jest.fn() });
});
...
var renderReportActionItemMessageEdit = function (props) {
    return (0, react_native_1.render)(<ComposeProviders_1.default components={[OnyxListItemProvider_1.default, LocaleContextProvider_1.LocaleContextProvider]}>
            <ReportActionItemMessageEdit_1.default 
...
describe('ReportActionCompose Integration Tests', function () {
    ...
    describe('Message validation', function () {
        it('should edit when length is within the limit', function () { return __awaiter(void 0, void 0, void 0, function () {
            var composer, saveChangesButton, validMessage;
            return __generator(this, function (_a) {
                renderReportActionItemMessageEdit();
                composer = react_native_1.screen.getByTestId('composer');
                saveChangesButton = react_native_1.screen.getByLabelText('common.saveChanges');
                ...
                react_native_1.fireEvent.press(saveChangesButton);
                // Then the message should be edited
                expect(mockEditReportComment).toHaveBeenCalledTimes(1);
                return [2 /*return*/];
            });
        }); });
        it('should not edit when length exceeds the limit', function () { return __awaiter(void 0, void 0, void 0, function () {
            var composer, saveChangesButton, invalidMessage;
            return __generator(this, function (_a) {
                renderReportActionItemMessageEdit();
                composer = react_native_1.screen.getByTestId('composer');
                saveChangesButton = react_native_1.screen.getByLabelText('common.saveChanges');
