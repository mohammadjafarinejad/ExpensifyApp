    ...
    return (0, react_native_1.render)(<ComposeProviders_1.default components={[OnyxListItemProvider_1.default, LocaleContextProvider_1.LocaleContextProvider, AttachmentModalContext_1.AttachmentModalContextProvider, useCurrentReportID_1.CurrentReportIDContextProvider, portal_1.PortalProvider, PlaybackContext_1.PlaybackContextProvider]}>
            <native_1.NavigationContainer>
                <Stack.Navigator initialRouteName={initialRouteName}>
                    <Stack.Screen name={SCREENS_1.default.REPORT_ATTACHMENTS} component={AttachmentModalScreen_1.default} initialParams={initialParams}/>
                </Stack.Navigator>
            </native_1.NavigationContainer>
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.IS_LOADING_APP, false)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    renderPage(SCREENS_1.default.REPORT_ATTACHMENTS, params);
                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                case 3:
                    _a.sent();
                    // Then the not here page and the loading spinner should not appear.
                    expect(react_native_1.screen.queryByText((0, TestHelper_1.translateLocal)('notFound.notHere'))).toBeNull();
