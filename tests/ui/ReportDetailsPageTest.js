...
describe('ReportDetailsPage', function () {
    ...
    it('self DM track options should disappear when report moved to workspace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var selfDMReportID, trackExpenseReportID, trackExpenseActionID, transactionID, transaction, trackExpenseReport, rerender, submitText, movedTrackExpenseReport;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    selfDMReportID = '1';
                    ...
                    trackExpenseReport = __assign(__assign({}, (0, reports_1.createRandomReport)(Number(trackExpenseReportID), undefined)), { parentReportID: selfDMReportID, parentReportActionID: trackExpenseActionID });
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(selfDMReportID), __assign({}, (0, reports_1.createRandomReport)(Number(selfDMReportID), CONST_1.default.REPORT.CHAT_TYPE.SELF_DM)))];
                                    case 1:
                                        _b.sent();
                ...
                case 1:
                    _a.sent();
                    rerender = (0, react_native_1.render)(<OnyxListItemProvider_1.default>
            ...
            </OnyxListItemProvider_1.default>).rerender;
                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                case 2:
                    _a.sent();
                    submitText = (0, TestHelper_1.translateLocal)('actionableMentionTrackExpense.submit');
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(trackExpenseReportID), movedTrackExpenseReport)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
