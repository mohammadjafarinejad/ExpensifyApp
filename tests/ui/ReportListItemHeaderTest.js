...
var ReportListItemHeader_1 = require("@components/SelectionListWithSections/Search/ReportListItemHeader");
...
var renderReportListItemHeader = function (reportItem) {
    return (0, react_native_1.render)(<ComposeProviders_1.default components={[OnyxListItemProvider_1.default, LocaleContextProvider_1.LocaleContextProvider]}>
            ...
            <SearchContext_1.SearchContext.Provider value={mockSearchContext}>
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            expect(react_native_1.screen.queryByTestId('UserInfoToIndicator')).not.toBeOnTheScreen();
                            return [2 /*return*/];
                    }
                });
            }); });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            expect(react_native_1.screen.getByTestId('UserInfoToIndicator')).toBeOnTheScreen();
                            return [2 /*return*/];
                    }
                });
            }); });
