...
var renderTransactionItemRow = function (transactionItem) {
...
describe('TransactionItemRowRBR', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            jest.clearAllMocks();
            return [2 /*return*/, react_native_onyx_1.default.clear([ONYXKEYS_1.default.NVP_PREFERRED_LOCALE]).then(waitForBatchedUpdates_1.default)];
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mockReport = __assign(__assign({}, (0, reports_1.createRandomReport)(1, undefined)), { pendingAction: null, type: CONST_1.default.REPORT.TYPE.EXPENSE });
