...
function scrollUpToRevealNewMessagesBadge() {
    var hintText = TestHelper.translateLocal('sidebarScreen.listOfChatMessages');
...
function isNewMessagesBadgeVisible() {
    var _a;
    var hintText = TestHelper.translateLocal('accessibilityHints.scrollToNewestMessages');
...
function navigateToSidebar() {
    var hintText = TestHelper.translateLocal('accessibilityHints.navigateToChatsList');
...
function areYouOnChatListScreen() {
    var _a, _b;
    var hintText = TestHelper.translateLocal('sidebarScreen.listOfChats');
...
var TEST_AUTH_TOKEN = 'test-auth-token';
var TEST_AUTO_GENERATED_LOGIN = 'expensify.cash-abc123';
...
function fastSignInWithTestUser() {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                        ...
                        _a[ONYXKEYS_1.default.BETAS] = ['all'],
                        _a[ONYXKEYS_1.default.NVP_PRIVATE_PUSH_NOTIFICATION_ID] = 'randomID',
                        _a[ONYXKEYS_1.default.PERSONAL_DETAILS_LIST] = (_b = {},
                            _b[USER_A_ACCOUNT_ID] = TestHelper.buildPersonalDetails(USER_A_EMAIL, USER_A_ACCOUNT_ID, 'A'),
                            _b),
                        _a))];
                case 1:
                    _c.sent();
...
function signInAndGetAppWithUnreadChat() {
    return __awaiter(this, void 0, void 0, function () {
        var personalDetails, report, reportActions;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, fastSignInWithTestUser()];
                case 1:
                    _d.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Promise.all([
                            react_native_onyx_1.default.merge(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, personalDetails),
                            react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(REPORT_ID), report),
                            react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(REPORT_ID), reportActions),
                        ])];
                case 4:
                    _d.sent();
...
describe('Unread Indicators', function () {
    ...
    it('Display bold in the LHN for unread chat and new line indicator above the chat message when we navigate to it', function () {
        return signInAndGetAppWithUnreadChat()
            ...
            var sidebarLinksHintText = TestHelper.translateLocal('sidebarScreen.listOfChats');
            ...
            var displayNameHintText = TestHelper.translateLocal('accessibilityHints.chatUserDisplayNames');
            ...
            return __generator(this, function (_c) {
                ...
                welcomeMessageHintText = TestHelper.translateLocal('accessibilityHints.chatWelcomeMessage');
                createdAction = react_native_1.screen.queryByLabelText(welcomeMessageHintText);
                expect(createdAction).toBeTruthy();
                reportCommentsHintText = TestHelper.translateLocal('accessibilityHints.chatMessage');
                reportComments = react_native_1.screen.queryAllByLabelText(reportCommentsHintText);
                expect(reportComments).toHaveLength(9);
                newMessageLineIndicatorHintText = TestHelper.translateLocal('accessibilityHints.newMessageLineIndicator');
    ...
    it('Clear the new line indicator and bold when we navigate away from a chat that is now read', function () {
        return signInAndGetAppWithUnreadChat()
            ...
            var newMessageLineIndicatorHintText = TestHelper.translateLocal('accessibilityHints.newMessageLineIndicator');
    ...
    it('Shows a browser notification and bold text when a new message arrives for a chat that is read', function () {
        return signInAndGetAppWithUnreadChat()
            ...
            var displayNameHintTexts = TestHelper.translateLocal('accessibilityHints.chatUserDisplayNames');
            ...
            expect(react_native_1.screen.getAllByText('B User').at(0)).toBeOnTheScreen();
            ...
            expect(react_native_1.screen.getByText('C User', { includeHiddenElements: true })).toBeOnTheScreen();
        });
    });
    ...
    it('Keep showing the new line indicator when a new message is created by the current user', function () {
        return signInAndGetAppWithUnreadChat()
            ...
            return __generator(this, function (_a) {
                ...
                (0, Report_1.addComment)(REPORT_ID, REPORT_ID, 'Current User Comment 1', CONST_1.default.DEFAULT_TIME_ZONE);
    ...
    it('Displays the correct chat message preview in the LHN when a comment is added then deleted', function () {
        ...
        return (signInAndGetAppWithUnreadChat()
            ...
            var hintText = TestHelper.translateLocal('accessibilityHints.lastChatMessagePreview');
            ...
            if (lastReportAction) {
                (0, Report_1.deleteReportComment)(REPORT_ID, lastReportAction, [], undefined, undefined);
            }
            return (0, waitForBatchedUpdates_1.default)();
        })
            .then(function () {
    ...
    it('Move the new line indicator to the next message when the unread message is deleted', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _c.sent();
                    (0, Report_1.addComment)(REPORT_ID, REPORT_ID, 'Comment 1', CONST_1.default.DEFAULT_TIME_ZONE);
                    return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                case 3:
                    _c.sent();
                ...
                case 4:
                    _c.sent();
                    (0, Report_1.addComment)(REPORT_ID, REPORT_ID, 'Comment 2', CONST_1.default.DEFAULT_TIME_ZONE);
                    return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                case 5:
                    _c.sent();
                    (0, Report_1.deleteReportComment)(REPORT_ID, firstNewReportAction, [], undefined, undefined);
                    return [4 /*yield*/, (0, waitForBatchedUpdates_1.default)()];
                case 6:
                    _c.sent();
                    _c.label = 7;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    // Remove unnecessary report
                    _a.sent();
                    selfDMReport = __assign(__assign({}, (0, reports_1.createRandomReport)(2, CONST_1.default.REPORT.CHAT_TYPE.SELF_DM)), { type: CONST_1.default.REPORT.TYPE.CHAT, lastMessageText: 'test' });
    ...
    it('Mark the chat as unread on clicking "Mark as unread" on an item in LHN when the last message of the chat was deleted by another user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 6:
                    _d.sent();
                    hintText = TestHelper.translateLocal('accessibilityHints.chatUserDisplayNames');
