...
describe('ExpensifyCardPage', function () {
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('cardPage.reportFraud'))).toBeOnTheScreen();
                        })];
                case 4:
                    // Verify that the "Report Fraud" option is displayed on the screen.
                    _a.sent();
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('cardPage.cardDetails.revealDetails'))).toBeOnTheScreen();
                        })];
                case 5:
                    // Verify that the "Reveal Details" option is displayed on the screen.
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.queryByText(TestHelper.translateLocal('cardPage.reportFraud'))).not.toBeOnTheScreen();
                        })];
                case 4:
                    // Verify that the "Report Fraud" option is NOT displayed on the screen.
                    _a.sent();
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.queryByText(TestHelper.translateLocal('cardPage.cardDetails.revealDetails'))).not.toBeOnTheScreen();
                        })];
                case 5:
                    // Verify that the "Reveal Details" option is NOT displayed on the screen.
                    _a.sent();
    ...
    it('should not show the PIN option on screen', function () { return __awaiter(void 0, void 0, void 0, function () {
        var unmount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                                    ...
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.CARD_LIST, (_a = {},
                                            _a[userCardID] = {
                                                ...
                                                nameValuePairs: {
                                                    isVirtual: false,
                                                    cardTitle: 'Test Card',
                                                    feedCountry: CONST_1.default.COUNTRY.US,
                                                },
                                                availableSpend: 50000,
                                                fraud: null,
                                            },
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.queryByText(TestHelper.translateLocal('cardPage.physicalCardPin'))).not.toBeOnTheScreen();
                        })];
                case 4:
                    // Verify that the "PIN" option is not displayed on the screen.
                    _a.sent();
    ...
    it('should show the PIN option on screen', function () { return __awaiter(void 0, void 0, void 0, function () {
        var unmount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                                    ...
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.CARD_LIST, (_a = {},
                                            _a[userCardID] = {
                                                ...
                                                nameValuePairs: {
                                                    isVirtual: false,
                                                    cardTitle: 'Test Card',
                                                    feedCountry: CONST_1.default.COUNTRY.GB,
                                                },
                                                availableSpend: 50000,
                                                fraud: null,
                                            },
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('cardPage.physicalCardPin'))).toBeOnTheScreen();
                        })];
                case 4:
                    // Verify that the "PIN" option is displayed on the screen.
                    _a.sent();
