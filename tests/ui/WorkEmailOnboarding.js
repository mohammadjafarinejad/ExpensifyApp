...
jest.mock('@libs/actions/Link', function () { return ({
    ...
    getInternalNewExpensifyPath: jest.fn(function () { return '/mock-path'; }),
    getInternalExpensifyPath: jest.fn(function () { return '/mock-path'; }),
}); });
...
function HTMLProviderWrapper(_a) {
    var children = _a.children;
    return <HTMLEngineProvider_1.default>{children}</HTMLEngineProvider_1.default>;
}
var renderOnboardingWorkEmailPage = function (initialRouteName, initialParams) {
    return (0, react_native_1.render)(<ComposeProviders_1.default components={[OnyxListItemProvider_1.default, LocaleContextProvider_1.LocaleContextProvider, useCurrentReportID_1.CurrentReportIDContextProvider]}>
        ...
        </ComposeProviders_1.default>, { wrapper: HTMLProviderWrapper });
};
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('onboarding.workEmail.title'))).toBeOnTheScreen();
                        })];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('onboarding.workEmail.addWorkEmail'))).toBeOnTheScreen();
                        })];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('common.skip'))).toBeOnTheScreen();
                        })];
                case 6:
                    _a.sent();
                    unmount();
...
describe('OnboardingWorkEmailValidation Page', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('onboarding.workEmailValidation.magicCodeSent', { workEmail: workEmail }))).toBeOnTheScreen();
                        })];
                case 4:
                    _a.sent();
                    unmount();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('onboarding.mergeBlockScreen.subtitle', { workEmail: workEmail }))).toBeOnTheScreen();
                        })];
                case 6:
                    _a.sent();
                    unmount();
    ...
    it('should navigate to Onboarding purpose page when skip is pressed and there is no signupQualifier', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    skipButton = react_native_1.screen.getByText(TestHelper.translateLocal('common.skip'));
                    mockEvent = {
                        nativeEvent: {},
                        type: 'press',
                        target: skipButton,
    ...
    it('should display specific error message when ONBOARDING_ERROR_MESSAGE is set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var specificErrorMessage, unmount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, TestHelper.signInWithTestUser()];
                case 1:
                    _a.sent();
                    specificErrorMessage = 'onboarding.errorSelection';
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.NVP_ONBOARDING, {
                                    ...
                                    case 2:
                                        _a.sent();
                                        return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.ONBOARDING_ERROR_MESSAGE_TRANSLATION_KEY, specificErrorMessage)];
                                    case 3:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal(specificErrorMessage))).toBeOnTheScreen();
                        })];
                case 4:
                    _a.sent();
                    unmount();
    ...
    it('should fallback to generic error message when ONBOARDING_ERROR_MESSAGE is not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var unmount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, TestHelper.signInWithTestUser()];
