        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            var deleteText = TestHelper.translateLocal('workspace.categories.deleteCategories');
                ...
                case 9:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            var confirmModalPrompt = TestHelper.translateLocal('workspace.categories.deleteCategoriesPrompt');
                ...
                case 10:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            var deleteConfirmButton = react_native_1.screen.getByLabelText(TestHelper.translateLocal('common.delete'));
                            expect(deleteConfirmButton).toBeOnTheScreen();
                        })];
                case 11:
                    // Verify the delete button in the modal is visible
                    _b.sent();
                    deleteConfirmButton = react_native_1.screen.getByLabelText(TestHelper.translateLocal('common.delete'));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    // Wait for menu items to be visible
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            var disableText = TestHelper.translateLocal('workspace.categories.disableCategories');
                ...
                case 9:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            var blockingPrompt = TestHelper.translateLocal('workspace.categories.cannotDeleteOrDisableAllCategories.title');
