        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('common.select'))).toBeOnTheScreen();
                        })];
                case 7:
                    // Wait for the "Select" option to appear
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('workspace.tags.disableTags'))).toBeOnTheScreen();
                        })];
                case 6:
                    _a.sent();
                    ...
                    return [4 /*yield*/, (0, react_native_1.waitFor)(function () {
                            expect(react_native_1.screen.getByText(TestHelper.translateLocal('workspace.tags.cannotDeleteOrDisableAllTags.title'))).toBeOnTheScreen();
                        })];
                case 7:
                    _a.sent();
                    unmount();
