        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    accountID = 2;
                    displayName = 'test';
                    report = __assign(__assign({}, (0, reports_1.createRandomReport)(Number(chatReportID), CONST_1.default.REPORT.CHAT_TYPE.INVOICE)), { invoiceReceiver: {
                            accountID: accountID,
                    ...
                    return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.PERSONAL_DETAILS_LIST, (_a = {},
                                            _a[accountID] = {
                ...
                <HeaderView_1.default report={report} onNavigationMenuButtonClicked={function () { }} parentReportAction={null} reportID={report.reportID}/>
