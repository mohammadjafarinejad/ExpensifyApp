...
function exec(command) {
    try {
        Log.info(command);
        (0, child_process_1.execSync)(command, { stdio: isVerbose ? 'inherit' : 'pipe' });
    }
    catch (error) {
        if (error.stderr) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    checkoutRepo();
                    return [4 /*yield*/, GitUtils_1.default.getPullRequestsDeployedBetween(from, to, CONST_1.default.APP_REPO)];
                case 1:
                    PRs = _a.sent();
