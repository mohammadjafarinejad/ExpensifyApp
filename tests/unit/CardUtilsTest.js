...
var commercialFeedCardsSingleList = {
    // eslint-disable-next-line @typescript-eslint/naming-convention
    '21570652': {
        accountID: 18439984,
        bank: CONST_1.default.COMPANY_CARD.FEED_BANK_NAME.CHASE,
...
describe('CardUtils', function () {
    ...
    describe('getCustomOrFormattedFeedName', function () {
        ...
        it('Should return feed key name for unknown feed', function () {
            var _a, _b;
            var companyCardNicknames = (_b = (_a = cardFeedsCollection.FAKE_ID_7) === null || _a === void 0 ? void 0 : _a.settings) === null || _b === void 0 ? void 0 : _b.companyCardNicknames;
            var feedName = (0, CardUtils_1.getCustomOrFormattedFeedName)(unknownFeed, companyCardNicknames);
    ...
    describe('getCardFeedName', function () {
        ...
        it('Should return empty string if feed is not provided (instead of TypeError crashing the app)', function () {
            var feed = undefined;
            var feedName = (0, CardUtils_1.getBankName)(feed);
            expect(feedName).toBe('');
        });
    ...
    describe('getFilteredCardList', function () {
        it('Should return filtered custom feed cards list', function () {
            var cardsList = (0, CardUtils_1.getFilteredCardList)(customFeedCardsList, undefined, undefined);
        ...
        it('Should return filtered direct feed cards list with a single card', function () {
            var cardsList = (0, CardUtils_1.getFilteredCardList)(directFeedCardsSingleList, oAuthAccountDetails[CONST_1.default.COMPANY_CARD.FEED_BANK_NAME.CHASE], undefined);
            // eslint-disable-next-line @typescript-eslint/naming-convention
        ...
        it('Should return filtered direct feed cards list with multiple cards', function () {
            var cardsList = (0, CardUtils_1.getFilteredCardList)(directFeedCardsMultipleList, oAuthAccountDetails[CONST_1.default.COMPANY_CARD.FEED_BANK_NAME.CAPITAL_ONE], undefined);
            expect(cardsList).toStrictEqual({
                // eslint-disable-next-line @typescript-eslint/naming-convention
        ...
        it('Should return empty object if no data was provided', function () {
            var cardsList = (0, CardUtils_1.getFilteredCardList)(undefined, undefined, undefined);
            expect(cardsList).toStrictEqual({});
        });
        ...
        it('Should filter out cards that are already assigned in another workspace (custom feed)', function () {
            ...
            var filteredCards = (0, CardUtils_1.getFilteredCardList)(customFeedWorkspaceCardsList, undefined, undefined);
            expect(filteredCards).toStrictEqual({});
        });
    ...
    describe('checkIfFeedConnectionIsBroken', function () {
        ...
        it('should return false if all of the feed(s) cards has the lastScrapeResult equal to 531', function () {
    ...
    describe('hasIssuedExpensifyCard', function () {
        ...
        it('should not erroneously return true when workspaceAccountID is 0', function () {
            var workspaceAccountID = 0;
            expect((0, CardUtils_1.hasIssuedExpensifyCard)(workspaceAccountID, allCardsList)).toBe(false);
        });
    });
    describe('getAllCardsForWorkspace', function () {
        it('should return all cards for a given workspace', function () {
            var workspaceAccountID = 11111111;
    ...
    describe('sortCardsByCardholderName', function () {
        ...
        it('should sort cards by cardholder name in ascending order', function () {
            ...
            var sortedCards = (0, CardUtils_1.sortCardsByCardholderName)(cards, mockPersonalDetails, TestHelper_1.localeCompare);
        ...
        it('should handle undefined personalDetails', function () {
            ...
            var policyMembersAccountIDs = [1, 2, 3];
            var cards = (0, CardUtils_1.getCardsByCardholderName)(mockCards, policyMembersAccountIDs);
            var sortedCards = (0, CardUtils_1.sortCardsByCardholderName)(cards, undefined, TestHelper_1.localeCompare);
            expect(sortedCards).toHaveLength(3);
    ...
    describe('getCardDescription', function () {
        it('should return the correct card description for company card', function () {
            var card = {
                accountID: 18439984,
                bank: CONST_1.default.COMPANY_CARD.FEED_BANK_NAME.VISA,
                cardID: 21310091,
            ...
            var description = (0, CardUtils_1.getCardDescription)(card);
            expect(description).toBe('Visa - 2554');
        });
        it('should return the correct card description for Expensify card', function () {
            var card = {
                accountID: 18439984,
                bank: CONST_1.default.EXPENSIFY_CARD.BANK,
                cardID: 21570657,
    ...
    describe('isExpensifyCard', function () {
        it('should return true for Expensify Card', function () {
            var card = {
                accountID: 18439984,
                bank: CONST_1.default.EXPENSIFY_CARD.BANK,
                cardID: 21570657,
        ...
        it('should return false for non-Expensify Card', function () {
            var card = {
                accountID: 18439984,
                bank: CONST_1.default.COMPANY_CARD.FEED_BANK_NAME.VISA,
                cardID: 21310091,
    ...
    describe('getCompanyCardDescription', function () {
        var cardList = {
            '21310091': {
                accountID: 18439984,
                bank: CONST_1.default.COMPANY_CARD.FEED_BANK_NAME.VISA,
        ...
        it('should return the correct description for a company card', function () {
            var description = (0, CardUtils_1.getCompanyCardDescription)('Test', 21310091, cardList);
            expect(description).toBe('480801XXXXXX2554');
        });
        it('should return the correct description for an Expensify card', function () {
            var description = (0, CardUtils_1.getCompanyCardDescription)('Test', 21570657, cardList);
            expect(description).toBe('Test');
        });
    });
    describe('Expensify card sort comparator', function () {
        it('should not change the order of non-Expensify cards', function () {
            var cardList = {
                10: { cardID: 10, bank: 'chase' }, // non-Expensify
                11: { cardID: 11, bank: 'chase' }, // non-Expensify
            };
            var sorted = (0, sortBy_1.default)(Object.values(cardList), CardUtils_1.getAssignedCardSortKey);
            expect(sorted.map(function (r) { return r.cardID; })).toEqual([10, 11]);
        });
        it('places physical Expensify card before its virtual sibling', function () {
            var cardList = {
            ...
            var sorted = (0, sortBy_1.default)(Object.values(cardList), CardUtils_1.getAssignedCardSortKey);
            expect(sorted.map(function (r) { return r.cardID; })).toEqual([11, 10, 99]);
        });
    });
});
