...
describe('CategoryOptionListUtils', function () {
    ...
    it('getCategoryListSections()', function () {
        ...
        var smallSearchResult = (0, CategoryOptionListUtils_1.getCategoryListSections)({ searchValue: search, categories: smallCategoriesList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(smallSearchResult).toStrictEqual(smallSearchResultList);
        var smallWrongSearchResult = (0, CategoryOptionListUtils_1.getCategoryListSections)({ searchValue: wrongSearch, categories: smallCategoriesList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(smallWrongSearchResult).toStrictEqual(smallWrongSearchResultList);
        var employeeSearchResult = (0, CategoryOptionListUtils_1.getCategoryListSections)({ searchValue: employeeSearch, categories: smallCategoriesList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        ...
        var emptyResult = (0, CategoryOptionListUtils_1.getCategoryListSections)({ searchValue: search, selectedOptions: selectedOptions, categories: emptyCategoriesList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
    ...
    it('sortCategories', function () {
        ...
        expect((0, CategoryOptionListUtils_1.sortCategories)(categoriesIncorrectOrdering, TestHelper_1.localeCompare)).toStrictEqual(result);
        expect((0, CategoryOptionListUtils_1.sortCategories)(categoriesIncorrectOrdering2, TestHelper_1.localeCompare)).toStrictEqual(result2);
        expect((0, CategoryOptionListUtils_1.sortCategories)(categoriesIncorrectOrdering3, TestHelper_1.localeCompare)).toStrictEqual(result3);
    });
});
