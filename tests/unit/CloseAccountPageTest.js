...
var validatePhoneOrEmail = function (inputValue, storedValue, translate, countryCode) {
    var _a, _b;
    var errors = {};
    if (inputValue && storedValue) {
        ...
        if (expensify_common_1.Str.isValidEmail(storedValue)) {
            ...
            var normalizedStored = (_a = (0, LoginUtils_1.formatE164PhoneNumber)((0, LoginUtils_1.getPhoneNumberWithoutSpecialChars)(storedValue), countryCode !== null && countryCode !== void 0 ? countryCode : CONST_1.default.DEFAULT_COUNTRY_CODE)) !== null && _a !== void 0 ? _a : '';
            var normalizedInput = (_b = (0, LoginUtils_1.formatE164PhoneNumber)((0, LoginUtils_1.getPhoneNumberWithoutSpecialChars)(inputValue), countryCode !== null && countryCode !== void 0 ? countryCode : CONST_1.default.DEFAULT_COUNTRY_CODE)) !== null && _b !== void 0 ? _b : '';
    ...
    describe('Phone Number Validation', function () {
        it('Should validate matching phone numbers in different formats', function () {
            ...
            testCases.forEach(function (inputPhone) {
                var errors = validatePhoneOrEmail(inputPhone, storedPhone, mockTranslate, countryCode);
