...
describe('ContactMethodDetailsPage', function () {
    ...
    function ContactMethodDetailsPageRenderer() {
        return (<HTMLProviderWrapper>
                <ContactMethodDetailsPage_1.default 
    ...
    it('should not call resetContactMethodValidateCodeSentState when the login data has no partnerUserID', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
