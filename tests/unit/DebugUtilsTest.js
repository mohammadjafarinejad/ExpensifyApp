...
var MOCK_REPORT = __assign({}, (0, reports_2.createRandomReport)(0, undefined));
...
describe('DebugUtils', function () {
    ...
    describe('getReasonForShowingRowInLHN', function () {
        ...
        it('returns null when report is not defined', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                report: undefined,
        ...
        it('returns correct reason when report has a valid draft comment', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                            report: baseReport,
                            chatReport: reports_1.chatReportR14932,
                            doesReportHaveViolations: false,
        ...
        it('returns correct reason when report has GBR', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                report: __assign(__assign({}, baseReport), { lastMentionedTime: '2024-08-10 18:70:44.171', lastReadTime: '2024-08-08 18:70:44.171' }),
                chatReport: reports_1.chatReportR14932,
                doesReportHaveViolations: false,
                draftComment: '',
                isReportArchived: undefined,
        ...
        it('returns correct reason when report is pinned', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                report: __assign(__assign({}, baseReport), { isPinned: true }),
                chatReport: reports_1.chatReportR14932,
                doesReportHaveViolations: false,
                draftComment: '',
                isReportArchived: undefined,
        ...
        it('returns correct reason when report has add workspace room errors', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                report: __assign(__assign({}, baseReport), { errorFields: {
                        addWorkspaceRoom: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                            report: __assign(__assign({}, baseReport), { participants: {
                                    // eslint-disable-next-line @typescript-eslint/naming-convention
                                    1234: {
                                        notificationPreference: CONST_1.default.REPORT.NOTIFICATION_PREFERENCE.ALWAYS,
                                    },
                                }, lastVisibleActionCreated: '2024-08-10 18:70:44.171', lastReadTime: '2024-08-08 18:70:44.171', lastMessageText: 'Hello world!' }),
                            chatReport: reports_1.chatReportR14932,
                            isInFocusMode: true,
                            doesReportHaveViolations: false,
                            draftComment: '',
        ...
        it('returns correct reason when report is self DM', function () {
            var reason = DebugUtils_1.default.getReasonForShowingRowInLHN({
                report: __assign(__assign({}, baseReport), { chatType: CONST_1.default.REPORT.CHAT_TYPE.SELF_DM }),
                chatReport: reports_1.chatReportR14932,
                doesReportHaveViolations: false,
                draftComment: '',
                isReportArchived: undefined,
    ...
    describe('getReasonAndReportActionForRBRInLHNRow', function () {
        ...
        describe('reportAction', function () {
            ...
            it('returns undefined when report has no RBR', function () {
                ...
                var reportAction = ((_a = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow({
                    reportID: '1',
                }, reports_1.chatReportR14932, undefined, {}, undefined, false, {})) !== null && _a !== void 0 ? _a : {}).reportAction;
                expect(reportAction).toBeUndefined();
            });
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            ...
                            MOCK_REPORTS["".concat(ONYXKEYS_1.default.COLLECTION.REPORT, "1")], reports_1.chatReportR14932, undefined, {}, undefined, false, {})) !== null && _d !== void 0 ? _d : {}).reportAction;
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                ...
                                reportAction = ((_b = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow(MOCK_CHAT_REPORT, reports_1.chatReportR14932, MOCK_CHAT_REPORT_ACTIONS, {}, undefined, false, reportErrors)) !== null && _b !== void 0 ? _b : {}).reportAction;
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                ...
                                reportAction = ((_b = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow(MOCK_CHAT_REPORT, reports_1.chatReportR14932, MOCK_REPORT_ACTIONS, {}, undefined, false, reportErrors)) !== null && _b !== void 0 ? _b : {}).reportAction;
            ...
            it('returns report action that contains errors', function () {
                ...
                var reportAction = ((_a = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow({
                    reportID: '1',
                }, reports_1.chatReportR14932, MOCK_REPORT_ACTIONS, {}, undefined, false, reportErrors)) !== null && _a !== void 0 ? _a : {}).reportAction;
                expect(reportAction).toMatchObject(MOCK_REPORT_ACTIONS['1']);
            });
        });
        describe('reason', function () {
            it('returns correct reason when there are errors', function () {
                ...
                var reason = ((_b = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow(mockedReport, reports_1.chatReportR14932, mockedReportActions, {}, undefined, false, reportErrors)) !== null && _b !== void 0 ? _b : {}).reason;
            ...
            it('returns correct reason when there are violations', function () {
                ...
                var reason = ((_a = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow({
                    reportID: '1',
                }, reports_1.chatReportR14932, undefined, {}, undefined, true, {})) !== null && _a !== void 0 ? _a : {}).reason;
            ...
            it('returns an undefined reason when the report is archived', function () {
                ...
                var reason = ((_a = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow({
                    reportID: '1',
                }, reports_1.chatReportR14932, undefined, {}, undefined, true, {}, true)) !== null && _a !== void 0 ? _a : {}).reason;
            ...
            it('returns correct reason when there are reports on the expense chat with violations', function () { return __awaiter(void 0, void 0, void 0, function () {
                var report, transactionViolations, reason;
                var _a, _b;
                var _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            transactionViolations = (_a = {},
                                ...
                                _a);
                            return [4 /*yield*/, react_native_onyx_1.default.multiSet((_b = {},
                                    _b[ONYXKEYS_1.default.SESSION] = {
                                        accountID: 1234,
                                    },
                                    _b["".concat(ONYXKEYS_1.default.COLLECTION.REPORT, "0")] = report,
                                    _b["".concat(ONYXKEYS_1.default.COLLECTION.REPORT, "1")] = {
                                        reportID: '1',
                                    ...
                                    _b["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS, "1")] = [
                                        {
                                            type: CONST_1.default.VIOLATION_TYPES.VIOLATION,
                                            name: CONST_1.default.VIOLATIONS.MISSING_CATEGORY,
                                            showInReview: true,
                        ...
                        case 1:
                            _d.sent();
                            reason = ((_c = DebugUtils_1.default.getReasonAndReportActionForRBRInLHNRow(report, reports_1.chatReportR14932, {}, {}, transactionViolations, false, {})) !== null && _c !== void 0 ? _c : {}).reason;
