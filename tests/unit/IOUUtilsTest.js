...
describe('IOUUtils', function () {
    ...
    describe('calculateAmount', function () {
        ...
        describe('calculateAmount - floorToLast rounding', function () {
            beforeAll(function () { return initCurrencyList(); });
            test('Positive total: remainder added entirely to default user', function () {
                // $10.00 among 3 -> base 3.33, remainder 0.01 -> default gets 3.34
                var numberOfSplits = 2; // total participants = 3
            ...
            test('Negative total: use ceil to move toward zero and remainder applied to default user', function () {
    ...
    describe('insertTagIntoTransactionTagsString', function () {
        ...
        test('Return single tag directly when hasMultipleTagLists is false', function () {
            expect(IOUUtils.insertTagIntoTransactionTagsString('East:NY:California', 'NewTag', 1, false)).toBe('NewTag');
        });
        test('Return multiple tags when hasMultipleTagLists is true', function () {
...
describe('canSubmitReport', function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    expenseReport = __assign(__assign({}, (0, reports_1.createRandomReport)(6, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, managerID: currentUserAccountID, ownerAccountID: currentUserAccountID, policyID: fakePolicy.id, stateNum: CONST_1.default.REPORT.STATE_NUM.OPEN, statusNum: CONST_1.default.REPORT.STATUS_NUM.OPEN });
                    transactionIDWithViolation = 1;
                    transactionIDWithoutViolation = 2;
    ...
    test('Return true if report can be submitted after being reopened', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakePolicy, expenseReport, transactionIDWithViolation, transactionIDWithoutViolation, transactionWithViolation, transactionWithoutViolation, transactionViolations, violations;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    fakePolicy = __assign(__assign({}, (0, policies_1.default)(6)), { ownerAccountID: currentUserAccountID, areRulesEnabled: true, preventSelfApproval: false, autoReportingFrequency: CONST_1.default.POLICY.AUTO_REPORTING_FREQUENCIES.INSTANT, harvesting: {
                            enabled: false,
                        } });
                    expenseReport = __assign(__assign({}, (0, reports_1.createRandomReport)(6, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, managerID: currentUserAccountID, ownerAccountID: currentUserAccountID, policyID: fakePolicy.id, stateNum: CONST_1.default.REPORT.STATE_NUM.OPEN, statusNum: CONST_1.default.REPORT.STATUS_NUM.OPEN });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expenseReport = __assign(__assign({}, (0, reports_1.createRandomReport)(6, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, managerID: currentUserAccountID, ownerAccountID: currentUserAccountID, policyID: fakePolicy.id });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    report = __assign(__assign({}, (0, reports_1.createRandomReport)(7, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, managerID: currentUserAccountID, ownerAccountID: currentUserAccountID, policyID: policy.id });
...
describe('Check valid amount for IOU/Expense request', function () {
    ...
    test('Unreported expense amount should retain negative sign', function () {
        var unreportedTransaction = TransactionUtils.buildOptimisticTransaction({
            transactionParams: {
                amount: 100,
                currency: 'USD',
        ...
        var unreportedAmount = TransactionUtils.getAmount(unreportedTransaction, true, false);
