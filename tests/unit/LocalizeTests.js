...
function mockEnvironmentConfig(config) {
    ...
    var originalConfig = __assign({}, CONFIG.default);
...
function setupSession(email) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, react_native_onyx_1.default.merge(ONYXKEYS_1.default.SESSION, email ? { email: email } : null)];
                case 1:
                    _a.sent();
...
function testMissingTranslationBehavior(environmentConfig, sessionEmail, expectedResult) {
    return __awaiter(this, void 0, void 0, function () {
        var cleanup, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cleanup = mockEnvironmentConfig(environmentConfig);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, setupSession(sessionEmail)];
                case 2:
                    _a.sent();
                    result = Localize.translate(CONST_1.default.LOCALES.EN, 'missing.translation.key');
...
describe('localize', function () {
    ...
    describe('translate method - missing translation behavior', function () {
        ...
        ])('%s', function (description, environmentConfig, sessionEmail, expectedResult) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, testMissingTranslationBehavior(environmentConfig, sessionEmail, expectedResult)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
