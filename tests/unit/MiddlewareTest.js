    ...
    describe('HandleUnusedOptimisticID', function () {
        test('Normal request', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        Request.addMiddleware(HandleUnusedOptimisticID_1.default);
                        requests = [
                            {
                                command: 'OpenReport',
        ...
        test('Request with preexistingReportID and optimisticReportID param', function () { return __awaiter(void 0, void 0, void 0, function () {
            var requests, _i, requests_4, request;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        for (_i = 0, requests_4 = requests; _i < requests_4.length; _i++) {
                            request = requests_4[_i];
                            SequentialQueue.push(request);
                        }
                        // eslint-disable-next-line @typescript-eslint/require-await
                        global.fetch.mockImplementationOnce(function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    case 1:
                        ...
                        TestHelper.assertFormDataMatchesObject({ optimisticReportID: '1234' }, (_a = global.fetch.mock.calls.at(0).at(1)) === null || _a === void 0 ? void 0 : _a.body);
                        return [2 /*return*/];
                }
            });
        }); });
