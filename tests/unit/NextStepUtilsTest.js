...
describe('libs/NextStepUtils', function () {
        ...
        describe('it generates an optimistic nextStep once a report has been submitted', function () {
            ...
            test('another owner', function () {
                ...
                return react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID), {
                    ...
                    // TODO: Replace onyx.connect with useOnyx hook (https://github.com/Expensify/App/issues/66365)
                    // eslint-disable-next-line @typescript-eslint/no-deprecated
                    var result = (0, NextStepUtils_1.buildNextStep)(report, CONST_1.default.REPORT.STATUS_NUM.SUBMITTED, undefined, true, undefined);
                    expect(result).toMatchObject(optimisticNextStep);
                });
            });
    ...
    describe('buildOptimisticNextStepForStrictPolicyRuleViolations', function () {
        test('returns correct next step message for strict policy rule violations', function () {
            var result = (0, NextStepUtils_1.buildOptimisticNextStepForStrictPolicyRuleViolations)();
