...
describe('PolicyDistanceRatesUtils', function () {
    describe('validateTaxClaimableValue', function () {
        it('should return an error when taxClaimableValue is equal to tax rate', function () {
            ...
            var validate = (0, PolicyDistanceRatesUtils_1.validateTaxClaimableValue)({ taxClaimableValue: '0.70' }, { rate: 70, customUnitRateID: '' }, TestHelper_1.translateLocal);
            ...
            var validate2 = (0, PolicyDistanceRatesUtils_1.validateTaxClaimableValue)({ taxClaimableValue: '0.72' }, { rate: 70, customUnitRateID: '' }, TestHelper_1.translateLocal);
            // Then validateTaxClaimableValue will return an error.
            expect(validate2.taxClaimableValue).toBeDefined();
            // When the taxClaimableValue is less than the tax rate
            var validate3 = (0, PolicyDistanceRatesUtils_1.validateTaxClaimableValue)({ taxClaimableValue: '0.65' }, { rate: 70, customUnitRateID: '' }, TestHelper_1.translateLocal);
