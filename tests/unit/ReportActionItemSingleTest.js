...
describe('ReportActionItemSingle', function () {
    ...
    describe('when the Report is a DM chat', function () {
        describe('component properly renders both avatar & name of the sender', function () {
            var _a;
            var _b;
            var fakeReport = __assign(__assign({}, LHNTestUtils.getFakeReportWithPolicy([1, 2])), { chatType: undefined });
            ...
            function setup() {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                policyCollectionDataSet = (0, CollectionDataSet_1.toCollectionDataSet)(ONYXKEYS_1.default.COLLECTION.POLICY, [fakePolicy], function (item) { return item.id; });
                                return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, (0, react_native_1.act)(function () { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_e) {
                                            switch (_e.label) {
                                                case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet(__assign((_a = {}, _a[ONYXKEYS_1.default.PERSONAL_DETAILS_LIST] = fakePersonalDetails, _a[ONYXKEYS_1.default.IS_LOADING_REPORT_DATA] = false, _a[ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS] = (_b = {},
                                                        _b["".concat(ONYXKEYS_1.default.COLLECTION.REPORT_ACTIONS).concat(fakeReport.reportID)] = (_c = {},
                                                            _c[fakeReportAction.reportActionID] = fakeReportAction,
                                                            _c),
                                                        _b), _a[ONYXKEYS_1.default.COLLECTION.REPORT] = (_d = {},
                                                        _d[fakeReport.reportID] = fakeReport,
                                                        _d), _a), policyCollectionDataSet))];
                                                case 1:
                                                    _e.sent();
                                                    return [4 /*yield*/, (0, waitForBatchedUpdatesWithAct_1.default)()];
                                                case 2:
            ...
            it('renders avatar properly', function () { return __awaiter(void 0, void 0, void 0, function () {
                var expectedIconTestID;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            expectedIconTestID = 'ReportActionAvatars-SingleAvatar';
