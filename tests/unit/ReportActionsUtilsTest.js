...
describe('ReportActionsUtils', function () {
    ...
    describe('getRenamedAction', function () {
        it('should return the correct translated message for a renamed action', function () {
            ...
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(2, undefined)), { type: CONST_1.default.REPORT.TYPE.CHAT });
        ...
        it('should return the correct translated message for a renamed action in expense report', function () {
            ...
            var report = __assign(__assign({}, (0, reports_2.createRandomReport)(2, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE });
    ...
    describe('getCardIssuedMessage', function () {
        var mockVirtualCardIssuedAction = {
            actionName: CONST_1.default.REPORT.ACTIONS.TYPE.CARD_ISSUED_VIRTUAL,
        ...
        describe('render virtual card issued messages', function () {
            it('should render a plain text message without card link when no card data is available', function () {
                var messageResult = (0, ReportActionsUtils_1.getCardIssuedMessage)({
            ...
            it('should render a message with clickable card link when the card is active', function () {
                var messageResult = (0, ReportActionsUtils_1.getCardIssuedMessage)({
                    reportAction: mockVirtualCardIssuedAction,
                    shouldRenderHTML: true,
                    policyID: testPolicyID,
                ...
                expect(messageResult).toBe("issued <mention-user accountID=\"456\"/> a virtual <a href='https://dev.new.expensify.com:8082/settings/card/789'>Expensify Card</a>! The card can be used right away.");
            });
        });
    });
    describe('shouldReportActionBeVisible', function () {
        it('should return false for moved transaction if the report destination is unavailable', function () {
            // Given a moved transaction action but the report destination is not available
            var reportAction = {
                actionName: CONST_1.default.REPORT.ACTIONS.TYPE.MOVED_TRANSACTION,
                reportActionID: '1',
                created: '2025-09-29',
                originalMessage: {
                    toReportID: '2',
            ...
            var actual = ReportActionsUtils.shouldReportActionBeVisible(reportAction, reportAction.reportActionID, true);
            expect(actual).toBe(false);
        });
        it('should return false for actionable card fraud alert if the resolution is recognized', function () {
            var reportAction = {
                actionName: CONST_1.default.REPORT.ACTIONS.TYPE.ACTIONABLE_CARD_FRAUD_ALERT,
                reportActionID: '1',
                originalMessage: {
                    resolution: CONST_1.default.CARD_FRAUD_ALERT_RESOLUTION.RECOGNIZED,
                    cardID: 123,
            ...
            var actual = ReportActionsUtils.shouldReportActionBeVisible(reportAction, reportAction.reportActionID, false);
            expect(actual).toBe(false);
        });
        it('should return true for moved transaction if the report destination is available', function () { return __awaiter(void 0, void 0, void 0, function () {
            var report, reportAction, actual;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        report = (0, reports_2.createRandomReport)(2, undefined);
                    ...
                    case 1:
                        ...
                        actual = ReportActionsUtils.shouldReportActionBeVisible(reportAction, reportAction.reportActionID, true);
    ...
    describe('getPolicyChangeLogUpdateEmployee', function () {
        it('should remove SMS domain when the email is a phone number', function () {
            var email = '+919383833920@expensify.sms';
            var newValue = 'test';
            var previousValue = '';
            var action = __assign(__assign({}, (0, reportActions_1.default)(0)), { actionName: CONST_1.default.REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.UPDATE_EMPLOYEE, message: [], previousMessage: [], originalMessage: {
                    email: email,
                    field: CONST_1.default.CUSTOM_FIELD_KEYS.customField1,
                    newValue: newValue,
                    oldValue: previousValue,
                } });
            var actual = ReportActionsUtils.getPolicyChangeLogUpdateEmployee(action);
            var expected = (0, TestHelper_1.translateLocal)('report.actions.type.updatedCustomField1', { email: (0, LocalePhoneNumber_1.formatPhoneNumber)(email), newValue: newValue, previousValue: previousValue });
            expect(actual).toBe(expected);
        });
    });
    describe('getPolicyChangeLogDeleteMemberMessage', function () {
        it('should remove SMS domain when the email is a phone number', function () {
            var email = '+919383833920@expensify.sms';
            var role = CONST_1.default.POLICY.ROLE.USER;
            var action = __assign(__assign({}, (0, reportActions_1.default)(0)), { actionName: CONST_1.default.REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.DELETE_EMPLOYEE, message: [], previousMessage: [], originalMessage: {
                    email: email,
                    role: role,
                } });
            var actual = ReportActionsUtils.getPolicyChangeLogDeleteMemberMessage(action);
            var expected = (0, TestHelper_1.translateLocal)('report.actions.type.removeMember', { email: (0, LocalePhoneNumber_1.formatPhoneNumber)(email), role: (0, TestHelper_1.translateLocal)('workspace.common.roleName', { role: role }).toLowerCase() });
            expect(actual).toBe(expected);
        });
    });
    describe('isDeletedAction', function () {
        it('should return false if the action is a hold or unhold action', function () {
            var action = __assign(__assign({}, (0, reportActions_1.default)(0)), { actionName: CONST_1.default.REPORT.ACTIONS.TYPE.HOLD, created: '2025-09-29', reportActionID: '1', originalMessage: undefined, message: [
                    {
