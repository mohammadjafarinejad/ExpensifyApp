...
describe('getSecondaryAction', function () {
    ...
    it('should always return default options', function () {
        var report = {};
        var policy = {};
        var result = [CONST_1.default.REPORT.SECONDARY_ACTIONS.EXPORT, CONST_1.default.REPORT.SECONDARY_ACTIONS.DOWNLOAD_PDF, CONST_1.default.REPORT.SECONDARY_ACTIONS.VIEW_DETAILS];
        expect((0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: policy })).toEqual(result);
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy });
    ...
    it('includes SUBMIT option', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: policy });
    ...
    it('include SUBMIT option if the report is retracted', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    policy = {
                        autoReportingFrequency: CONST_1.default.POLICY.AUTO_REPORTING_FREQUENCIES.MANUAL,
                        harvesting: {
                            enabled: true,
                        },
    ...
    it('should not include SUBMIT option for the user who is not submitter/admin/manager', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, policy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('does not include APPROVE option for approver and report with only pending transactions', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, policy, TRANSACTION_ID, transaction, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('does not include APPROVE option for report with transactions that are being scanned', function () {
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy });
        expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.APPROVE)).toBe(false);
    });
    it('includes UNAPPROVE option', function () {
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: policy });
        expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.UNAPPROVE)).toBe(true);
    });
    it('includes UNAPPROVE option for admin on finally approved report', function () {
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
            ownerAccountID: EMPLOYEE_ACCOUNT_ID,
    ...
    it('includes UNAPPROVE option for manager on finally approved report', function () {
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
            ownerAccountID: EMPLOYEE_ACCOUNT_ID,
    ...
    it('does not include UNAPPROVE option for non-admin, non-manager on finally approved report', function () {
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
            ownerAccountID: EMPLOYEE_ACCOUNT_ID,
    ...
    it('does not include UNAPPROVE option for non-approved report', function () {
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
            ownerAccountID: EMPLOYEE_ACCOUNT_ID,
    ...
    it('does not include UNAPPROVE option for settled report', function () {
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
            ownerAccountID: EMPLOYEE_ACCOUNT_ID,
    ...
    it('does not include UNAPPROVE option for payment processing report', function () {
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
            ownerAccountID: EMPLOYEE_ACCOUNT_ID,
    ...
    it('includes HOLD option ', function () {
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({
            ...
            violations: {},
            policy: policy,
            reportActions: [actions_1.actionR14932],
        });
        expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.HOLD)).toBe(true);
    });
    it('does not include CHANGE_WORKSPACE option for submitted IOU report and manager being the payer of the new policy', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    _d.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: policy, policies: policies });
    ...
    it('includes DELETE option for invoice report submitter when total is zero', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, policy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(EMPLOYEE_EMAIL, report, {}, undefined, policy);
                    expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.DELETE)).toBe(true);
                    return [2 /*return*/];
            }
        });
    ...
    it('includes DELETE option for owner of unreported transaction', function () {
        ...
        var policy = {};
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, reportActions: reportActions });
        expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.DELETE)).toBe(true);
    });
    ...
    it('includes DELETE option for owner of processing expense report', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction1, transaction2], violations: {}, policy: policy });
                    expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.DELETE)).toBe(true);
                    return [2 /*return*/];
            }
        });
    ...
    it('does not include DELETE option for unreported card expense imported with deleting disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, TRANSACTION_ID, transaction, reportActions, policy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    report = {
                ...
                case 1:
                    _a.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [transaction], violations: {}, policy: policy, reportActions: reportActions });
                    expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.DELETE)).toBe(false);
                    return [2 /*return*/];
            }
        });
    ...
    it('include DELETE option for demo transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, TRANSACTION_ID, transaction, policy, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('includes REMOVE HOLD option for admin if he is the holder and primary action is not REMOVE HOLD', function () {
        var report = {};
        var policy = {
            role: CONST_1.default.POLICY.ROLE.ADMIN,
        };
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: reportTransactions, violations: {}, policy: policy });
        expect(result).toContain(CONST_1.default.REPORT.SECONDARY_ACTIONS.REMOVE_HOLD);
    });
});
describe('getSecondaryExportReportActions', function () {
    beforeAll(function () {
        react_native_onyx_1.default.init({
            keys: ONYXKEYS_1.default,
        });
    ...
    it('should always return default options', function () {
        var report = {};
        var policy = {};
        var result = [CONST_1.default.REPORT.EXPORT_OPTIONS.DOWNLOAD_CSV];
        expect((0, ReportSecondaryActionUtils_1.getSecondaryExportReportActions)(report, policy)).toEqual(result);
    });
    it('should include export templates when provided', function () {
        var report = {};
        var policy = {};
        var exportTemplates = [
            {
                name: 'All Data - expense level',
                templateName: CONST_1.default.REPORT.EXPORT_OPTIONS.EXPENSE_LEVEL_EXPORT,
                type: CONST_1.default.EXPORT_TEMPLATE_TYPES.INTEGRATIONS,
                description: '',
                policyID: undefined,
            },
            {
                name: 'All Data - report level',
                templateName: CONST_1.default.REPORT.EXPORT_OPTIONS.REPORT_LEVEL_EXPORT,
                type: CONST_1.default.EXPORT_TEMPLATE_TYPES.INTEGRATIONS,
                description: '',
                policyID: undefined,
            },
            {
                ...
                type: CONST_1.default.EXPORT_TEMPLATE_TYPES.IN_APP,
                description: 'Custom description',
                policyID: 'POLICY_123',
            },
        ];
        var result = [CONST_1.default.REPORT.EXPORT_OPTIONS.DOWNLOAD_CSV, 'All Data - expense level', 'All Data - report level', 'Custom Template'];
        expect((0, ReportSecondaryActionUtils_1.getSecondaryExportReportActions)(report, policy, exportTemplates)).toEqual(result);
    });
    it('does not include EXPORT option for invoice reports', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryExportReportActions)(report, policy);
    ...
    it('includes EXPORT option for expense report with payments enabled', function () {
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryExportReportActions)(report, policy);
        expect(result.includes(CONST_1.default.REPORT.EXPORT_OPTIONS.EXPORT_TO_INTEGRATION)).toBe(true);
    });
    it('includes EXPORT option and templates together', function () {
        var _a;
        var report = {
            reportID: REPORT_ID,
            type: CONST_1.default.REPORT.TYPE.EXPENSE,
        ...
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryExportReportActions)(report, policy, exportTemplates);
        expect(result.includes(CONST_1.default.REPORT.EXPORT_OPTIONS.EXPORT_TO_INTEGRATION)).toBe(true);
        expect(result.includes(CONST_1.default.REPORT.EXPORT_OPTIONS.DOWNLOAD_CSV)).toBe(true);
    ...
    it('includes REMOVE HOLD option for admin if he is not the holder', function () {
        var report = {};
        var policy = {
            role: CONST_1.default.POLICY.ROLE.ADMIN,
        };
...
describe('getSecondaryTransactionThreadActions', function () {
    ...
    it('should always return VIEW_DETAILS', function () {
        ...
        expect((0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(EMPLOYEE_EMAIL, report, {}, undefined, policy)).toEqual(result);
    });
    it('includes HOLD option', function () {
        var report = {
            reportID: REPORT_ID,
        ...
        var policy = {};
        jest.spyOn(ReportUtils, 'canHoldUnholdReportAction').mockReturnValueOnce({ canHoldRequest: true, canUnholdRequest: true });
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(EMPLOYEE_EMAIL, report, transaction, actions_1.actionR14932, policy);
        expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.HOLD)).toBe(true);
    });
    it('includes REMOVE HOLD option for transaction thread report admin if he is not the holder', function () {
        var report = {};
        ...
        jest.spyOn(ReportUtils, 'isHoldCreator').mockReturnValue(false);
        var result = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(EMPLOYEE_EMAIL, report, transaction, undefined, policy, transactionThreadReport);
        expect(result).toContain(CONST_1.default.REPORT.SECONDARY_ACTIONS.REMOVE_HOLD);
        // Do not show if admin is the holder
        jest.spyOn(ReportUtils, 'isHoldCreator').mockReturnValue(true);
        var result2 = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(EMPLOYEE_EMAIL, report, transaction, undefined, policy, transactionThreadReport);
    ...
    it('should not include CHANGE_WORKSPACE option for exported report', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, personalDetails, policy, reportActions, policies, result;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 4:
                    _d.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryReportActions)({ currentUserEmail: EMPLOYEE_EMAIL, report: report, chatReport: reports_1.chatReportR14932, reportTransactions: [], violations: {}, policy: policy, policies: policies, reportActions: reportActions });
                    expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.CHANGE_WORKSPACE)).toBe(false);
                    return [2 /*return*/];
            }
        });
    }); });
    it('includes the SPLIT option if the current user belongs to the workspace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, transaction, policy, result;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    _b.sent();
                    result = (0, ReportSecondaryActionUtils_1.getSecondaryTransactionThreadActions)(EMPLOYEE_EMAIL, report, transaction, actions_1.actionR14932, policy);
                    expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.SPLIT)).toBe(true);
                    return [2 /*return*/];
            }
        });
    }); });
    it('does not include the SPLIT option if the current user does not belong to the workspace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, transaction, policy, result;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
    ...
    it('does not include the SPLIT option if the policy is not expense chat enabled', function () { return __awaiter(void 0, void 0, void 0, function () {
        var report, transaction, policy, result;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
    ...
    describe('isMergeAction', function () {
        beforeEach(function () {
            jest.clearAllMocks();
        });
        it('should return false for transactions with negative amounts', function () {
            var report = {
                reportID: REPORT_ID,
                type: CONST_1.default.REPORT.TYPE.EXPENSE,
                stateNum: CONST_1.default.REPORT.STATE_NUM.OPEN,
            ...
            expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.MERGE)).toBe(false);
        });
        it('should return true for transactions with positive amounts when eligible', function () {
            var report = {
                reportID: REPORT_ID,
                type: CONST_1.default.REPORT.TYPE.EXPENSE,
                stateNum: CONST_1.default.REPORT.STATE_NUM.OPEN,
            ...
            expect(result.includes(CONST_1.default.REPORT.SECONDARY_ACTIONS.MERGE)).toBe(true);
        });
    });
});
