...
var tests = [
    ...
    {
        query: searchParsersCommonQueries_1.default.userFriendlyNames,
        expected: {
            type: 'expense',
            status: CONST_1.default.SEARCH.STATUS.EXPENSE.ALL,
            sortBy: 'date',
    ...
    {
        query: searchParsersCommonQueries_1.default.oldNames,
        expected: {
            type: 'expense',
            status: CONST_1.default.SEARCH.STATUS.EXPENSE.ALL,
            sortBy: 'date',
    ...
    {
        query: searchParsersCommonQueries_1.default.complex,
        expected: {
            type: 'expense',
            status: CONST_1.default.SEARCH.STATUS.EXPENSE.ALL,
            sortBy: 'date',
    ...
    {
        query: searchParsersCommonQueries_1.default.quotesIOS,
        expected: {
            type: 'expense',
            status: CONST_1.default.SEARCH.STATUS.EXPENSE.ALL,
            sortBy: 'date',
    ...
    },
    {
        ...
        expected: {
            ...
            status: CONST_1.default.SEARCH.STATUS.EXPENSE.ALL,
            sortBy: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.DATE,
            sortOrder: CONST_1.default.SEARCH.SORT_ORDER.DESC,
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.WITHDRAWAL_TYPE,
                right: CONST_1.default.SEARCH.WITHDRAWAL_TYPE.EXPENSIFY_CARD,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.WITHDRAWAL_ID,
                right: '1234567890',
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.WITHDRAWN,
                right: CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.IS,
                right: CONST_1.default.SEARCH.IS_VALUES.READ,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.IS,
                right: CONST_1.default.SEARCH.IS_VALUES.UNREAD,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.IS,
                right: CONST_1.default.SEARCH.IS_VALUES.PINNED,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.IS,
                right: [CONST_1.default.SEARCH.IS_VALUES.PINNED, CONST_1.default.SEARCH.IS_VALUES.READ, CONST_1.default.SEARCH.IS_VALUES.UNREAD],
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.HAS,
                right: CONST_1.default.SEARCH.HAS_VALUES.ATTACHMENT,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.HAS,
                right: CONST_1.default.SEARCH.HAS_VALUES.LINK,
            },
        },
    },
    {
        ...
        expected: {
            ...
            filters: {
                operator: CONST_1.default.SEARCH.SYNTAX_OPERATORS.EQUAL_TO,
                left: CONST_1.default.SEARCH.SYNTAX_FILTER_KEYS.HAS,
                right: [CONST_1.default.SEARCH.HAS_VALUES.LINK, CONST_1.default.SEARCH.HAS_VALUES.ATTACHMENT],
            },
        },
    },
    {
