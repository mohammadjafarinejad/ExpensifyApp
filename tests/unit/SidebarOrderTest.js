...
function assertSidebarOptionsAlphabetical() {
    var firstElement = react_native_1.screen.queryByTestId('DisplayNames-0');
    var secondElement = react_native_1.screen.queryByTestId('DisplayNames-1');
    var thirdElement = react_native_1.screen.queryByTestId('DisplayNames-2');
    var fourthElement = react_native_1.screen.queryByTestId('DisplayNames-3');
...
describe('Sidebar', function () {
    ...
    describe('in default mode', function () {
        it('is rendered with empty state when no reports are available', function () {
            ...
            expect(react_native_1.screen.getByText(TestHelper.translateLocal('common.emptyLHN.title'))).toBeOnTheScreen();
        ...
        it('orders items with most recently updated on top', function () {
            ...
            (0, Report_1.addComment)(report1.reportID, report1.reportID, 'Hi, this is a comment', CONST_1.default.DEFAULT_TIME_ZONE);
            (0, Report_1.addComment)(report2.reportID, report2.reportID, 'Hi, this is a comment', CONST_1.default.DEFAULT_TIME_ZONE);
            (0, Report_1.addComment)(report3.reportID, report3.reportID, 'Hi, this is a comment', CONST_1.default.DEFAULT_TIME_ZONE);
            var reportCollectionDataSet = (_a = {},
        ...
        it('sorts chats by pinned / GBR > draft > rest', function () {
            ...
            (0, Report_1.addComment)(report4.reportID, report4.reportID, 'Hi, this is a comment', CONST_1.default.DEFAULT_TIME_ZONE);
