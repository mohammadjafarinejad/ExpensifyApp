...
describe('StringUtils', function () {
    ...
    describe('startsWithVowel', function () {
        it('returns true for strings starting with lowercase vowels', function () {
            expect(StringUtils_1.default.startsWithVowel('apple')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('elephant')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('igloo')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('orange')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('umbrella')).toBe(true);
        });
        it('returns true for strings starting with uppercase vowels', function () {
            expect(StringUtils_1.default.startsWithVowel('Apple')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('Elephant')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('Igloo')).toBe(true);
            expect(StringUtils_1.default.startsWithVowel('Orange')).toBe(true);
        ...
        it('returns false for strings starting with other letters', function () {
            expect(StringUtils_1.default.startsWithVowel('banana')).toBe(false);
            expect(StringUtils_1.default.startsWithVowel('cat')).toBe(false);
            expect(StringUtils_1.default.startsWithVowel('dog')).toBe(false);
            expect(StringUtils_1.default.startsWithVowel('zebra')).toBe(false);
            expect(StringUtils_1.default.startsWithVowel('123')).toBe(false);
            expect(StringUtils_1.default.startsWithVowel('@example')).toBe(false);
        });
    });
});
