...
var AMOUNT_OWED = 100;
var stripeCustomerId = TestHelper_1.STRIPE_CUSTOMER_ID;
...
describe('SubscriptionUtils', function () {
    describe('calculateRemainingFreeTrialDays', function () {
        ...
        it('should return 0 if the Onyx key is not set', function () {
            expect((0, SubscriptionUtils_1.calculateRemainingFreeTrialDays)(undefined)).toBe(0);
        });
        ...
        it('should return 1 if the current date is on the same day of the free trial end date, but some minutes earlier', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addMinutes)(new Date(), 30), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL, lastDayFreeTrial)];
                    case 1:
                        _a.sent();
                        expect((0, SubscriptionUtils_1.calculateRemainingFreeTrialDays)(lastDayFreeTrial)).toBe(1);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return the remaining days if the current date is before the free trial end date', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 5), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL, lastDayFreeTrial)];
                    case 1:
                        _a.sent();
                        expect((0, SubscriptionUtils_1.calculateRemainingFreeTrialDays)(lastDayFreeTrial)).toBe(5);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('isUserOnFreeTrial', function () {
        ...
        it('should return false if the Onyx keys are not set', function () {
            expect((0, SubscriptionUtils_1.isUserOnFreeTrial)(undefined, undefined)).toBeFalsy();
        });
        it('should return false if the current date is before the free trial start date', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 2), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.isUserOnFreeTrial)(firstDayFreeTrial, undefined)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return false if the current date is after the free trial end date', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 4), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
        ...
        it('should return true if the current date is on the same date of free trial start date', function () { return __awaiter(void 0, void 0, void 0, function () {
            var firstDayFreeTrial, lastDayFreeTrial;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)(new Date(), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 3), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                                _a[ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL] = lastDayFreeTrial,
                                _a))];
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.isUserOnFreeTrial)(firstDayFreeTrial, lastDayFreeTrial)).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return true if the current date is on the same date of free trial end date, but some minutes earlier', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 2), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addMinutes)(new Date(), 30), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                                _a[ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL] = lastDayFreeTrial,
        ...
        it('should return true if the current date is between the free trial start and end dates', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 1), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 3), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                                _a[ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL] = lastDayFreeTrial,
    ...
    describe('hasUserFreeTrialEnded', function () {
        ...
        it('should return false if the Onyx key is not set', function () {
            expect((0, SubscriptionUtils_1.hasUserFreeTrialEnded)(undefined)).toBeFalsy();
        });
        ...
        it('should return true if the current date is after the free trial end date', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 2), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL, lastDayFreeTrial)];
                    case 1:
                        _a.sent();
                        expect((0, SubscriptionUtils_1.hasUserFreeTrialEnded)(lastDayFreeTrial)).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('doesUserHavePaymentCardAdded', function () {
        ...
        it('should return false if the Onyx key is not set', function () {
            expect((0, SubscriptionUtils_1.doesUserHavePaymentCardAdded)(undefined)).toBeFalsy();
        });
        it('should return true if the Onyx key is set', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        expect((0, SubscriptionUtils_1.doesUserHavePaymentCardAdded)(8010)).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('getSubscriptionStatus', function () {
        ...
        it('should return undefined by default', function () {
            var stripeCustomerIdForDefault = {};
        ...
        it('should return POLICY_OWNER_WITH_AMOUNT_OWED status', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.getSubscriptionStatus)(stripeCustomerId, false, undefined, undefined)).toEqual({
        ...
        it('should return BILLING_DISPUTE_PENDING status', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.getSubscriptionStatus)(stripeCustomerId, false, 1, undefined)).toEqual({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                            ...
                            _a[ONYXKEYS_1.default.NVP_PRIVATE_STRIPE_CUSTOMER_ID] = TestHelper_1.STRIPE_CUSTOMER_ID,
                            _a))];
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.getSubscriptionStatus)(stripeCustomerId, false, 0, undefined)).toEqual({
        ...
        it('should return CARD_EXPIRED status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var stripeCustomerIdForCardExpired;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                    ...
                    case 1:
                        _b.sent();
                        stripeCustomerIdForCardExpired = {
                            paymentMethodID: '1',
                            intentsID: '2',
                            currency: 'USD',
                        };
        ...
        it('should return CARD_EXPIRE_SOON status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var stripeCustomerIdForCardExpireSoon;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                    ...
                    case 1:
                        _b.sent();
                        stripeCustomerIdForCardExpireSoon = {
                            paymentMethodID: '1',
                            intentsID: '2',
                            currency: 'USD',
                        };
        ...
        it('should return RETRY_BILLING_SUCCESS status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var stripeCustomerIdForRetryBillingSuccess;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                    ...
                    case 1:
                        _b.sent();
                        stripeCustomerIdForRetryBillingSuccess = {
                            paymentMethodID: '1',
                            intentsID: '2',
                            currency: 'USD',
                        };
                        // @ts-expect-error - This is a test case
                        expect((0, SubscriptionUtils_1.getSubscriptionStatus)(stripeCustomerIdForRetryBillingSuccess, true)).toEqual({
        ...
        it('should return RETRY_BILLING_ERROR status', function () { return __awaiter(void 0, void 0, void 0, function () {
            var stripeCustomerIdForRetryBillingError;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                    ...
                    case 1:
                        _b.sent();
                        stripeCustomerIdForRetryBillingError = {
                            paymentMethodID: '1',
                            intentsID: '2',
                            currency: 'USD',
                        };
                        // @ts-expect-error - This is a test case
                        expect((0, SubscriptionUtils_1.getSubscriptionStatus)(stripeCustomerIdForRetryBillingError, false, undefined, true)).toEqual({
        ...
        it('should return false if the user is not on a free trial', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldShowDiscountBanner)(true, 'corporate', undefined, undefined, undefined)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
        it("should return false if user has already added a payment method", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldShowDiscountBanner)(true, 'corporate', undefined, undefined, 8010)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return false if the user is on Team plan', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldShowDiscountBanner)(true, 'team', firstDayFreeTrial, undefined, undefined)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return true if the date is before the free trial end date or within the 8 days from the trial start date', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 1), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 10), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.SESSION] = { accountID: ownerAccountID },
                                _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(policyID)] = __assign(__assign({}, (0, policies_1.default)(Number(policyID))), { ownerAccountID: ownerAccountID, type: CONST_1.default.POLICY.TYPE.CORPORATE }),
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldShowDiscountBanner)(true, 'corporate', firstDayFreeTrial, lastDayFreeTrial, undefined)).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
        it("should return false if user's trial is during the discount period but has no workspaces", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldShowDiscountBanner)(true, 'corporate', firstDayFreeTrial, undefined, undefined)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('getEarlyDiscountInfo', function () {
        ...
        it('should return the discount info if the user is on a free trial and trial was started less than 24 hours before', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addMinutes)((0, date_fns_1.subDays)(new Date(TEST_DATE), 1), 12), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.getEarlyDiscountInfo)(firstDayFreeTrial)).toEqual({
                            discountType: 50,
                            days: 0,
                            hours: 0,
                            minutes: 12,
        ...
        it('should return the discount info if the user is on a free trial and trial was started more than 24 hours before', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(TEST_DATE), 2), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                                _a[ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL] = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(TEST_DATE), 10), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING),
                                _a))];
        ...
        it('should return null if the user is not on a free trial', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.getEarlyDiscountInfo)(undefined)).toBeNull();
                        return [2 /*return*/];
                }
            });
        }); });
    });
    describe('shouldShowPreTrialBillingBanner', function () {
        it('should return true if the user is NOT on a free trial and trial has not ended', function () { return __awaiter(void 0, void 0, void 0, function () {
            var firstDayFreeTrial, introSelected;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 5), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                    ...
                    case 2:
                        _a.sent();
                        introSelected = {
                            choice: CONST_1.default.ONBOARDING_CHOICES.MANAGE_TEAM,
                        };
                        expect((0, SubscriptionUtils_1.shouldShowPreTrialBillingBanner)(introSelected, firstDayFreeTrial, undefined)).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return false if the free trial has ended', function () { return __awaiter(void 0, void 0, void 0, function () {
            var firstDayFreeTrial, lastDayFreeTrial, introSelected;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        firstDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 20), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        lastDayFreeTrial = (0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 5), CONST_1.default.DATE.FNS_DATE_TIME_FORMAT_STRING);
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a[ONYXKEYS_1.default.NVP_FIRST_DAY_FREE_TRIAL] = firstDayFreeTrial,
                                _a[ONYXKEYS_1.default.NVP_LAST_DAY_FREE_TRIAL] = lastDayFreeTrial,
                                _a))];
                    case 1:
                        ...
                        expect((0, SubscriptionUtils_1.shouldShowPreTrialBillingBanner)(introSelected, firstDayFreeTrial, lastDayFreeTrial)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
    });
    describe('shouldCalculateBillNewDot', function () {
        var testUserAccountID = 1; // A consistent account ID for tests
        var paidPolicyID = '12345';
        var freePolicyID = '67890';
        var secondPaidPolicyID = '98765';
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        // Clear Onyx and set up session for each test
                        _b.sent();
                        return [4 /*yield*/, react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { email: 'test@example.com', accountID: testUserAccountID })];
                    case 2:
                        _b.sent();
        ...
        it('should return false if canDowngrade is false (default or explicitly passed)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: 
                    ...
                    return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                            _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(paidPolicyID)] = __assign(__assign({}, (0, policies_1.default)(Number(paidPolicyID))), { ownerAccountID: testUserAccountID, type: CONST_1.default.POLICY.TYPE.CORPORATE }),
                            _a))];
                    case 1:
                        // Set up a policy that would normally count as owned and paid
                        _b.sent();
                        // Test with canDowngrade as false (explicitly)
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(false)).toBeFalsy();
                        // Test with canDowngrade as undefined (defaults to false in the function signature)
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(undefined)).toBeFalsy();
                        // Test without passing canDowngrade (defaults to false)
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)()).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return false if the user owns zero paid policies', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: 
                    ...
                    return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                            _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(freePolicyID)] = __assign(__assign({}, (0, policies_1.default)(Number(freePolicyID))), { ownerAccountID: testUserAccountID, type: CONST_1.default.POLICY.TYPE.PERSONAL }),
                            _a))];
                    case 1:
                        // Only free policies or no policies at all
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(true)).toBeFalsy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return false if the user owns more than one paid policy', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                            _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(paidPolicyID)] = __assign(__assign({}, (0, policies_1.default)(Number(paidPolicyID))), { ownerAccountID: testUserAccountID, type: CONST_1.default.POLICY.TYPE.CORPORATE }),
                            _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(secondPaidPolicyID)] = __assign(__assign({}, (0, policies_1.default)(Number(secondPaidPolicyID))), { ownerAccountID: testUserAccountID, type: CONST_1.default.POLICY.TYPE.TEAM }),
                            _a))];
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(true)).toBeFalsy();
        ...
        it('should return true if canDowngrade is true and the user owns exactly one paid policy', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                    ...
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(true)).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
        it('should return false if the user owns exactly one paid policy but is not the owner', function () { return __awaiter(void 0, void 0, void 0, function () {
            var thirdUserAccountID;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        thirdUserAccountID = 2;
                        return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                                _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(paidPolicyID)] = __assign(__assign({}, (0, policies_1.default)(Number(paidPolicyID))), { ownerAccountID: thirdUserAccountID, type: CONST_1.default.POLICY.TYPE.CORPORATE }),
                                _a))];
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(true)).toBeFalsy();
        ...
        it('should return true if canDowngrade is true and the single paid policy is a team policy', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
                            _a["".concat(ONYXKEYS_1.default.COLLECTION.POLICY).concat(paidPolicyID)] = __assign(__assign({}, (0, policies_1.default)(Number(paidPolicyID))), { ownerAccountID: testUserAccountID, type: CONST_1.default.POLICY.TYPE.TEAM }),
                            _a))];
                    case 1:
                        _b.sent();
                        expect((0, SubscriptionUtils_1.shouldCalculateBillNewDot)(true)).toBeTruthy();
        ...
        it('should return true if canDowngrade is true and the single paid policy is a corporate policy', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, react_native_onyx_1.default.multiSet((_a = {},
