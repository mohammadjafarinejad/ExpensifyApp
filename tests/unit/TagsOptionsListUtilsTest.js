...
describe('TagsOptionsListUtils', function () {
    ...
    it('getTagListSections()', function () {
        ...
        var smallResult = (0, TagsOptionsListUtils_1.getTagListSections)({ searchValue: emptySearch, tags: smallTagsList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(smallResult).toStrictEqual(smallResultList);
        var smallSearchResult = (0, TagsOptionsListUtils_1.getTagListSections)({ searchValue: search, tags: smallTagsList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(smallSearchResult).toStrictEqual(smallSearchResultList);
        var employeeSearchResult = (0, TagsOptionsListUtils_1.getTagListSections)({ searchValue: employeeSearch, tags: smallTagsList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(employeeSearchResult).toStrictEqual(employeeSearchResultList);
        var smallWrongSearchResult = (0, TagsOptionsListUtils_1.getTagListSections)({ searchValue: wrongSearch, tags: smallTagsList, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(smallWrongSearchResult).toStrictEqual(smallWrongSearchResultList);
        var largeResult = (0, TagsOptionsListUtils_1.getTagListSections)({ searchValue: emptySearch, selectedOptions: selectedOptions, tags: largeTagsList, recentlyUsedTags: recentlyUsedTags, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
        expect(largeResult).toStrictEqual(largeResultList);
        var largeSearchResult = (0, TagsOptionsListUtils_1.getTagListSections)({ searchValue: search, selectedOptions: selectedOptions, tags: largeTagsList, recentlyUsedTags: recentlyUsedTags, localeCompare: TestHelper_1.localeCompare, translate: TestHelper_1.translateLocal });
