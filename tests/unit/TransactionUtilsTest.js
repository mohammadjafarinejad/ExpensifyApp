...
var CURRENT_USER_EMAIL = 'test@example.com';
...
var reportCollectionDataSet = (_a = {},
    ...
    _a);
var defaultDistanceRatePolicyID1 = {
    customUnitRateID1: {
        currency: 'USD',
...
var distanceRateTransactionID1 = {
    customUnitID: 'customUnitID1',
    customUnitRateID: 'customUnitRateID1',
    distanceUnit: 'mi',
    name: 'Distance',
};
var distanceRateTransactionID2 = {
    customUnitID: 'customUnitID2',
    customUnitRateID: 'customUnitRateID2',
    distanceUnit: 'mi',
    name: 'Distance',
};
var defaultCustomUnitPolicyID1 = {
    customUnitID1: {
        attributes: {
            unit: 'mi',
        },
...
describe('TransactionUtils', function () {
    beforeAll(function () {
        ...
        react_native_onyx_1.default.init({
            ...
            initialKeyStates: __assign((_a = {}, _a[ONYXKEYS_1.default.SESSION] = { accountID: CURRENT_USER_ID, email: 'test@example.com' }, _a), reportCollectionDataSet),
        });
    ...
    describe('getUpdatedTransaction', function () {
        ...
        it('should update transaction when distance is changed', function () {
            var _a, _b;
            // Given: a policy with a mileage rate
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: {
                    distance: {
            ...
            var newDistance = 20; // change distance to 20 miles
            ...
            expect((_b = (_a = updatedTransaction.comment) === null || _a === void 0 ? void 0 : _a.customUnit) === null || _b === void 0 ? void 0 : _b.quantity).toBe(newDistance);
            ...
            expect(updatedTransaction.modifiedCurrency).toBe(CONST_1.default.CURRENCY.USD);
    ...
    describe('getMerchant', function () {
        ...
        it('should return distance merchant if transaction is distance expense and pending create', function () {
            ...
            var policy = __assign(__assign({}, (0, policies_1.default)(10)), { role: CONST_1.default.POLICY.ROLE.ADMIN, customUnits: {} });
            var merchant = TransactionUtils.getMerchant(transaction, policy);
    ...
    describe('isUnreportedAndHasInvalidDistanceRateTransaction', function () {
        it('should be false when transaction is null', function () {
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: defaultCustomUnitPolicyID1 });
            var result = TransactionUtils.isUnreportedAndHasInvalidDistanceRateTransaction(null, fakePolicy);
            expect(result).toBe(false);
        });
        it('should be false when transaction is not distance type transaction', function () {
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: defaultCustomUnitPolicyID1 });
            var transaction = __assign(__assign({}, generateTransaction()), { iouRequestType: CONST_1.default.IOU.REQUEST_TYPE.MANUAL });
            var result = TransactionUtils.isUnreportedAndHasInvalidDistanceRateTransaction(transaction, fakePolicy);
            expect(result).toBe(false);
        });
        it('should be false when transaction is reported', function () {
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: defaultCustomUnitPolicyID1 });
            var transaction = __assign(__assign({}, generateTransaction()), { iouRequestType: CONST_1.default.IOU.REQUEST_TYPE.DISTANCE, reportID: '1' });
            var result = TransactionUtils.isUnreportedAndHasInvalidDistanceRateTransaction(transaction, fakePolicy);
            expect(result).toBe(false);
        });
        it('should be false when transaction is unreported and has valid rate', function () {
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: defaultCustomUnitPolicyID1 });
            var transaction = __assign(__assign({}, generateTransaction()), { iouRequestType: CONST_1.default.IOU.REQUEST_TYPE.DISTANCE, reportID: '0', comment: {
        ...
        it('should be false when transaction is unreported, has invalid rate but policy has default rate', function () {
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: defaultCustomUnitPolicyID1 });
            var transaction = __assign(__assign({}, generateTransaction()), { iouRequestType: CONST_1.default.IOU.REQUEST_TYPE.DISTANCE, reportID: '0', comment: {
        ...
        it('should be true when transaction is unreported, has invalid rate and policy has no default rate', function () {
            var fakePolicy = __assign(__assign({}, (0, policies_1.default)(0)), { customUnits: {} });
            var transaction = __assign(__assign({}, generateTransaction()), { iouRequestType: CONST_1.default.IOU.REQUEST_TYPE.DISTANCE, reportID: '0', comment: {
                    customUnit: distanceRateTransactionID2,
                    type: 'customUnit',
    ...
    describe('isViolationDismissed', function () {
        it('should return true when violation is dismissed for current user', function () {
            var _a, _b;
            var transaction = generateTransaction({
                comment: {
                    dismissedViolations: (_a = {},
                        _a[CONST_1.default.VIOLATIONS.DUPLICATED_TRANSACTION] = (_b = {},
                            _b[CURRENT_USER_EMAIL] = DateUtils_1.default.getDBTime(),
                            _b),
                        _a),
                },
            });
            var violation = { type: CONST_1.default.VIOLATION_TYPES.VIOLATION, name: CONST_1.default.VIOLATIONS.DUPLICATED_TRANSACTION };
            var result = TransactionUtils.isViolationDismissed(transaction, violation);
            expect(result).toBe(true);
        });
    });
    describe('shouldShowViolation', function () {
        it('should return false for auto approval limit violation when report is not open/processing report', function () {
            var iouReport = __assign(__assign({}, (0, reports_1.createRandomReport)(0, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, statusNum: CONST_1.default.REPORT.STATUS_NUM.APPROVED, stateNum: CONST_1.default.REPORT.STATE_NUM.APPROVED, ownerAccountID: 2 });
            var policy = __assign(__assign({}, (0, policies_1.default)(0, CONST_1.default.POLICY.TYPE.TEAM)), { role: CONST_1.default.POLICY.ROLE.ADMIN });
            expect(TransactionUtils.shouldShowViolation(iouReport, policy, CONST_1.default.VIOLATIONS.OVER_AUTO_APPROVAL_LIMIT, 'test@example.com')).toBe(false);
        });
    });
});
