...
var TripAirReservationData_1 = require("../data/TripAirReservationData");
...
describe('TripReservationUtils', function () {
    describe('getAirReservations', function () {
        it('should return air reservations in the correct order', function () {
            var _a, _b;
            var result = (0, TripReservationUtils_1.getAirReservations)(TripAirReservationData_1.airReservationPnrData, TripAirReservationData_1.airReservationTravelers);
            ...
            expect((_a = result.at(0)) === null || _a === void 0 ? void 0 : _a.reservation.legId).toBe(0);
            expect((_b = result.at(1)) === null || _b === void 0 ? void 0 : _b.reservation.legId).toBe(1);
        });
    });
