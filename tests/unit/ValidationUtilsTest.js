...
describe('ValidationUtils', function () {
    describe('isValidDate', function () {
        ...
        test('Should return false for a invalid date format', function () {
            var validDate = '2025-07';
            var isValid = (0, ValidationUtils_1.isValidDate)(validDate);
            expect(isValid).toBe(false);
        });
    });
    ...
    describe('getAgeRequirementError', function () {
        ...
        test('Should return an error message for a date before the minimum age requirement', function () {
            ...
            expect(error).toEqual((0, TestHelper_1.translateLocal)('privatePersonalDetails.error.dateShouldBeBefore', { dateString: (0, date_fns_1.format)((0, date_fns_1.startOfDay)((0, date_fns_1.subYears)(new Date(), 18)), CONST_1.default.DATE.FNS_FORMAT_STRING) }));
        });
        test('Should return an error message for a date after the maximum age requirement', function () {
            ...
            var error = (0, ValidationUtils_1.getAgeRequirementError)(invalidDate, 18, 150);
            expect(error).toEqual((0, TestHelper_1.translateLocal)('privatePersonalDetails.error.dateShouldBeAfter', { dateString: (0, date_fns_1.format)((0, date_fns_1.startOfDay)((0, date_fns_1.subYears)(new Date(), 150)), CONST_1.default.DATE.FNS_FORMAT_STRING) }));
        });
        test('Should return an error message for an invalid date', function () {
            var invalidDate = '2023-07-32'; // Invalid date
            var error = (0, ValidationUtils_1.getAgeRequirementError)(invalidDate, 18, 150);
            expect(error).toBe((0, TestHelper_1.translateLocal)('common.error.dateInvalid'));
        });
    });
    ...
    describe('isValidRegistrationNumber', function () {
        describe('EU countries', function () {
            test.each([
                ['AT', 'FN123456', true],
                ['AT', 'FN654321a', true],
                ['AT', '123456', false],
                ...
                ['ES', 'B87654321', true],
                ['ES', '12345678A', false],
            ])('validates EU country registration number', function (country, value, expected) {
                expect((0, ValidationUtils_1.isValidRegistrationNumber)(value, country)).toBe(expected);
            });
        });
        describe('Non-EU countries', function () {
            test.each([
                ['AU', '51824753556', true],
                ['AU', '004085616', true],
                ['AU', '123456789', false],
            ...
            ])('validates Non-EU country registration number', function (country, value, expected) {
                expect((0, ValidationUtils_1.isValidRegistrationNumber)(value, country)).toBe(expected);
            });
        });
    });
