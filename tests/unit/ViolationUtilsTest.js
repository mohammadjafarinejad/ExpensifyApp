...
describe('getViolationsOnyxData', function () {
    ...
    describe('per diem rate validation', function () {
        (0, globals_1.beforeEach)(function () {
            var _a;
            var _b, _c;
            transactionViolations = [customUnitOutOfPolicyViolation];
            var customUnitRateID = 'per_diem_rate_id';
            transaction.comment = __assign(__assign({}, transaction.comment), { customUnit: __assign(__assign({}, ((_c = (_b = transaction === null || transaction === void 0 ? void 0 : transaction.comment) === null || _b === void 0 ? void 0 : _b.customUnit) !== null && _c !== void 0 ? _c : {})), { customUnitRateID: customUnitRateID }) });
            transaction.iouRequestType = CONST_1.default.IOU.REQUEST_TYPE.PER_DIEM;
            policy.customUnits = {
                perDiemUnitId: {
        ...
        it('should remove the customUnitOutOfPolicy violation if the per diem rate is valid for the policy', function () {
            var result = ViolationsUtils_1.default.getViolationsOnyxData(transaction, transactionViolations, policy, policyTags, policyCategories, false, false);
            expect(result.value).not.toContainEqual(customUnitOutOfPolicyViolation);
        });
    });
    ...
    describe('policyRequiresCategories', function () {
        ...
        it('should not add categoryOutOfPolicy violation when category is Uncategorized', function () {
            transaction.category = 'Uncategorized';
            var result = ViolationsUtils_1.default.getViolationsOnyxData(transaction, transactionViolations, policy, policyTags, policyCategories, false, false);
            expect(result.value).not.toContainEqual(categoryOutOfPolicyViolation);
        });
        it('should not add categoryOutOfPolicy violation when category is none', function () {
...
describe('getViolationTranslation', function () {
    it('should return the correct message for broken card connection violation', function () {
        var testPolicyID = 'test-policy-123';
        var companyCardPageURL = "workspaces/".concat(testPolicyID, "/company-cards");
        var brokenCardConnectionViolationExpected = (0, TestHelper_1.translateLocal)('violations.rter', {
            brokenBankConnection: true,
            isAdmin: true,
            rterType: CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION,
        ...
        expect(ViolationsUtils_1.default.getViolationTranslation(brokenCardConnectionViolation, TestHelper_1.translateLocal)).toBe(brokenCardConnectionViolationExpected);
        var brokenCardConnection530ViolationExpected = (0, TestHelper_1.translateLocal)('violations.rter', {
            brokenBankConnection: true,
            isAdmin: false,
            rterType: CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION_530,
            isTransactionOlderThan7Days: false,
        ...
        expect(ViolationsUtils_1.default.getViolationTranslation(brokenCardConnection530Violation, TestHelper_1.translateLocal)).toBe(brokenCardConnection530ViolationExpected);
    });
});
describe('getRBRMessages', function () {
    ...
    it('should return all violations and missing field error', function () {
        ...
        var result = ViolationsUtils_1.default.getRBRMessages(mockTransaction, mockViolations, TestHelper_1.translateLocal, missingFieldError, []);
        var expectedResult = "Missing required field. ".concat((0, TestHelper_1.translateLocal)('violations.missingCategory'), ". ").concat((0, TestHelper_1.translateLocal)('violations.missingTag'), ".");
        expect(result).toBe(expectedResult);
    });
    it('should filter out empty strings', function () {
        var result = ViolationsUtils_1.default.getRBRMessages(mockTransaction, mockViolations, TestHelper_1.translateLocal, undefined, []);
        var expectedResult = "".concat((0, TestHelper_1.translateLocal)('violations.missingCategory'), ". ").concat((0, TestHelper_1.translateLocal)('violations.missingTag'), ".");
        expect(result).toBe(expectedResult);
    });
});
describe('hasVisibleViolationsForUser', function () {
    var submitterAccountID = 12345;
    var testReportID = 'test-report-123';
    var testTransactionID = 'test-transaction-123';
    var testPolicyID = 'test-policy-123';
    var mockReport = {
    ...
    (0, globals_1.beforeEach)(function () {
        react_native_onyx_1.default.set(ONYXKEYS_1.default.SESSION, { accountID: submitterAccountID });
    });
    it('should return false when report is null', function () {
        var _a;
        var violations = (_a = {},
            _a["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(testTransactionID)] = [missingCategoryViolation],
            _a);
        var result = ViolationsUtils_1.default.hasVisibleViolationsForUser(undefined, violations, '', mockPolicy, [mockTransaction]);
        expect(result).toBe(false);
    });
    it('should return false when violations is null', function () {
        var result = ViolationsUtils_1.default.hasVisibleViolationsForUser(mockReport, undefined, '', mockPolicy, [mockTransaction]);
        expect(result).toBe(false);
    });
    it('should return false when transactions is null', function () {
        var _a;
        var violations = (_a = {},
            _a["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(testTransactionID)] = [missingCategoryViolation],
            _a);
        var result = ViolationsUtils_1.default.hasVisibleViolationsForUser(mockReport, violations, '', mockPolicy);
        expect(result).toBe(false);
    });
    it('should return false when no violations exist for transactions', function () {
        var violations = {};
        var result = ViolationsUtils_1.default.hasVisibleViolationsForUser(mockReport, violations, '', mockPolicy, [mockTransaction]);
        expect(result).toBe(false);
    });
    it('should return true when violations are visible to submitter', function () {
        var _a;
        var violations = (_a = {},
            _a["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(testTransactionID)] = [missingCategoryViolation],
            _a);
    ...
    it('should return false when violations are hidden from submitter', function () {
        var _a;
        var violations = (_a = {},
            _a["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(testTransactionID)] = [
                {
        ...
        jest.spyOn(require('@src/libs/TransactionUtils'), 'shouldShowViolation').mockImplementation(function (report, policy, violationName) {
    ...
    it('should return true when at least one violation is visible', function () {
        var _a;
        var violations = (_a = {},
            _a["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(testTransactionID)] = [
                {
        ...
        jest.spyOn(require('@src/libs/TransactionUtils'), 'shouldShowViolation').mockImplementation(function (report, policy, violationName) {
            ...
            if (violationName === CONST_1.default.VIOLATIONS.MISSING_CATEGORY) {
                return true;
            }
            return true;
        });
    ...
    it('should handle multiple transactions correctly', function () {
        var _a;
        var secondTransactionID = 'test-transaction-456';
        ...
        var violations = (_a = {},
            ...
            _a["".concat(ONYXKEYS_1.default.COLLECTION.TRANSACTION_VIOLATIONS).concat(secondTransactionID)] = [missingCategoryViolation],
            _a);
        jest.spyOn(require('@src/libs/TransactionUtils'), 'shouldShowViolation').mockImplementation(function (report, policy, violationName) {
            if (violationName === CONST_1.default.VIOLATIONS.RECEIPT_NOT_SMART_SCANNED) {
                return false;
        ...
        var result = ViolationsUtils_1.default.hasVisibleViolationsForUser(mockReport, violations, '', mockPolicy, [mockTransaction, secondTransaction]);
        expect(result).toBe(true);
    });
});
