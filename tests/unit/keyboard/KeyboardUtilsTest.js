...
describe('Keyboard utils: general native', function () {
    ...
    beforeEach(function () {
        ...
        utils = require('@src/utils/keyboard').default;
    });
    ...
    describe('dismissKeyboardAndExecute', function () {
        ...
        it('should execute callback immediately when platform is not Android', function () { return __awaiter(void 0, void 0, void 0, function () {
            var callback;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
