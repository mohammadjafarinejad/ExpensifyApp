...
describe('navigateAfterOnboarding', function () {
    ...
    it('should navigate to the admin room report if onboardingAdminsChatReportID is provided', function () {
        ...
        (0, navigateAfterOnboarding_1.navigateAfterOnboarding)(false, true, undefined, ONBOARDING_ADMINS_CHAT_REPORT_ID, ((_a = testSession === null || testSession === void 0 ? void 0 : testSession.email) !== null && _a !== void 0 ? _a : '').includes('+'));
    ...
    it('should not navigate to last accessed report if it is selfDM chat on small screens', function () {
        var lastAccessedReport = { reportID: REPORT_ID, chatType: CONST_1.default.REPORT.CHAT_TYPE.SELF_DM };
        mockFindLastAccessedReport.mockReturnValue(lastAccessedReport);
        mockShouldOpenOnAdminRoom.mockReturnValue(false);
        (0, navigateAfterOnboarding_1.navigateAfterOnboarding)(true, true, ONBOARDING_POLICY_ID, ONBOARDING_ADMINS_CHAT_REPORT_ID);
        expect(Navigation_1.default.navigate).not.toHaveBeenCalledWith(ROUTES_1.default.REPORT_WITH_ID.getRoute(REPORT_ID));
    ...
    it('should navigate to Concierge room if user uses a test email', function () {
        ...
        (0, navigateAfterOnboarding_1.navigateAfterOnboarding)(true, true, ONBOARDING_POLICY_ID, ONBOARDING_ADMINS_CHAT_REPORT_ID, ((_a = testSession === null || testSession === void 0 ? void 0 : testSession.email) !== null && _a !== void 0 ? _a : '').includes('+'));
        expect(navigate).toHaveBeenCalledWith(ROUTES_1.default.REPORT_WITH_ID.getRoute(REPORT_ID));
    });
