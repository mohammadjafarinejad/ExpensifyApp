...
describe('usePermissions', function () {
    ...
    it('should handle explicit only and exclusion betas correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var explicitOnlyBeta, exclusionBeta, betaConfiguration, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    explicitOnlyBeta = CONST_1.default.BETAS.CUSTOM_REPORT_NAMES;
                    exclusionBeta = CONST_1.default.BETAS.PREVENT_SPOTNANA_TRAVEL;
                    betaConfiguration = {
