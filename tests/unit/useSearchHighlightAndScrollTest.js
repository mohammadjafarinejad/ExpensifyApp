...
describe('useSearchHighlightAndScroll', function () {
    ...
    it('should return multiple new search result keys when there are multiple new expenses', function () {
        var _a;
        var _b = (0, react_native_1.renderHook)(function (props) { return (0, useSearchHighlightAndScroll_1.default)(props); }, {
            initialProps: baseProps,
        }), rerender = _b.rerender, result = _b.result;
        var updatedProps = __assign(__assign({}, baseProps), { searchResults: __assign(__assign({}, baseProps.searchResults), { data: {
                    transactions_1: {
                        transactionID: '1',
                    },
                    transactions_2: {
        ...
        // @ts-expect-error
        rerender(updatedProps);
        expect((_a = result.current.newSearchResultKeys) === null || _a === void 0 ? void 0 : _a.size).toBe(2);
    });
    it('should return multiple new search result keys when there are multiple new chats', function () {
        var _a;
        var chatProps = __assign(__assign({}, baseProps), { queryJSON: __assign(__assign({}, baseProps.queryJSON), { type: 'chat' }), reportActions: {
                reportActions_1: {
                    '1': { actionName: 'EXISTING', reportActionID: '1' },
        ...
        var updatedProps = __assign(__assign({}, chatProps), { searchResults: __assign(__assign({}, baseProps.searchResults), { data: {
                    reportActions_1: {
                        '1': { actionName: 'EXISTING', reportActionID: '1' },
                    },
                    reportActions_2: {
