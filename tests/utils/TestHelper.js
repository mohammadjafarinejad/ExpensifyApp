...
exports.getNvpDismissedProductTraining = getNvpDismissedProductTraining;
...
function getNvpDismissedProductTraining() {
    var _a;
    return _a = {},
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.ACCOUNT_SWITCHER] = {
            timestamp: DateUtils_1.default.getDBTime(new Date().valueOf()),
            dismissedMethod: 'click',
        },
        _a[CONST_1.default.MIGRATED_USER_WELCOME_MODAL] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.CONCIERGE_LHN_GBR] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
        ...
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.SCAN_TEST_TOOLTIP_MANAGER] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.SCAN_TEST_CONFIRMATION] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.OUTSTANDING_FILTER] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.SCAN_TEST_DRIVE_CONFIRMATION] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
        _a[CONST_1.default.PRODUCT_TRAINING_TOOLTIP_NAMES.MULTI_SCAN_EDUCATIONAL_MODAL] = {
            timestamp: '',
            dismissedMethod: 'click',
        },
...
function translateLocal(phrase) {
    ...
    return Localize_1.translate.apply(void 0, __spreadArray([currentLocale, phrase], parameters, false));
}
function getNavigateToChatHintRegex() {
    var hintTextPrefix = translateLocal('accessibilityHints.navigatesToChat');
