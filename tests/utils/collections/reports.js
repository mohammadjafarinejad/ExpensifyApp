 ...
 */
function createRandomReport(index, chatType) {
    return {
...
function createPolicyExpenseChat(index, isOwnPolicyExpenseChat) {
    ...
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT)), { isOwnPolicyExpenseChat: isOwnPolicyExpenseChat, type: CONST_1.default.REPORT.TYPE.CHAT, 
...
function createWorkspaceThread(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.POLICY_ROOM)), { type: CONST_1.default.REPORT.TYPE.CHAT, parentReportID: "".concat((0, falso_1.randNumber)()), parentReportActionID: "".concat((0, falso_1.randNumber)()) });
}
/**
...
function createExpenseRequestReport(index, parentReportID, parentReportActionID) {
    ...
    return __assign(__assign({}, createRandomReport(index, undefined)), { type: CONST_1.default.REPORT.TYPE.IOU, parentReportID: parentReportID, parentReportActionID: parentReportActionID, isOwnPolicyExpenseChat: false });
}
/**
 * Creates an expense report
 */
function createExpenseReport(index) {
    return __assign(__assign({}, createRandomReport(index, undefined)), { type: CONST_1.default.REPORT.TYPE.EXPENSE, parentReportID: "".concat((0, falso_1.randNumber)()), parentReportActionID: "".concat((0, falso_1.randNumber)()), isOwnPolicyExpenseChat: false });
}
/**
...
function createWorkspaceTaskReport(index, accountIDs, parentReportID) {
    if (parentReportID === void 0) { parentReportID = "".concat((0, falso_1.randNumber)()); }
    return __assign(__assign({}, createRandomReport(index, undefined)), { type: CONST_1.default.REPORT.TYPE.TASK, policyID: "policy".concat(index), participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)(accountIDs), parentReportID: parentReportID, 
...
function createInvoiceRoom(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.INVOICE)), { type: CONST_1.default.REPORT.TYPE.CHAT });
}
/**
 * Creates an invoice report
 */
function createInvoiceReport(index) {
    return __assign(__assign({}, createRandomReport(index, undefined)), { type: CONST_1.default.REPORT.TYPE.INVOICE });
}
/**
 * Creates a group chat
 */
function createGroupChat(index, accountIDs) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.GROUP)), { type: CONST_1.default.REPORT.TYPE.CHAT, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)(accountIDs) });
}
/**
 * Creates a self DM
 */
function createSelfDM(index, currentUserAccountID) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.SELF_DM)), { type: CONST_1.default.REPORT.TYPE.CHAT, participants: (0, ReportUtils_1.buildParticipantsFromAccountIDs)([currentUserAccountID]) });
}
/**
 * Creates an admin room
 */
function createAdminRoom(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.POLICY_ADMINS)), { type: CONST_1.default.REPORT.TYPE.CHAT, reportName: '#admins' });
}
/**
 * Creates an announce room
 */
function createAnnounceRoom(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.POLICY_ANNOUNCE)), { type: CONST_1.default.REPORT.TYPE.CHAT, reportName: '#announce' });
}
/**
 * Creates a domain room
 */
function createDomainRoom(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.DOMAIN_ALL)), { type: CONST_1.default.REPORT.TYPE.CHAT, reportName: '#domain' });
}
/**
 * Creates a regular task report (non-workspace)
 */
function createRegularTaskReport(index, currentUserAccountID) {
    return __assign(__assign({}, createRandomReport(index, undefined)), { type: CONST_1.default.REPORT.TYPE.TASK, 
...
function createRegularChat(index, accountIDs) {
    return __assign(__assign({}, createRandomReport(index, undefined)), { type: CONST_1.default.REPORT.TYPE.CHAT, 
...
function createPolicyExpenseChatThread(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT)), { isOwnPolicyExpenseChat: true, parentReportID: "".concat((0, falso_1.randNumber)()), parentReportActionID: "".concat((0, falso_1.randNumber)()) });
}
/**
 * Creates a policy expense chat that is also a task report (edge case)
 */
function createPolicyExpenseChatTask(index) {
    return __assign(__assign({}, createRandomReport(index, CONST_1.default.REPORT.CHAT_TYPE.POLICY_EXPENSE_CHAT)), { type: CONST_1.default.REPORT.TYPE.TASK, isOwnPolicyExpenseChat: true });
}
