...
exports.createRandomDistanceRequestTransaction = void 0;
...
var createRandomDistanceRequestTransaction = function (index) {
    return __assign(__assign({}, createRandomTransaction(index)), { iouRequestType: CONST_1.default.IOU.REQUEST_TYPE.DISTANCE });
};
exports.createRandomDistanceRequestTransaction = createRandomDistanceRequestTransaction;
